...
Task *gTaskPtrs[MAX_TASK_NUM] ALIGNED(16) = {};
...
GraphicsData gVramGraphicsCopyQueueBuffer[32] = {};
#endif // PORTABLE
#if ((ENGINE == ENGINE_1) || (ENGINE == ENGINE_2))
GraphicsData *gVramGraphicsCopyQueue[32] ALIGNED(16) = {};
#else
// NOT here in SA3
