...
const u16 gUnknown_080DF968[][4] = {
    { 128, 16, 12, 256 }, { 0, 32, 12, 304 },   { 768, 32, 12, 352 }, { 512, 48, 12, 400 },
    { 256, 48, 12, 448 }, { 900, 48, 12, 496 }, { 256, 64, 12, 544 },
};
...
const s16 gUnknown_080DF9D8[][3] = {
    { 96, 96, 640 }, { 300, 300, 512 }, { 230, 230, 640 }, { 220, 220, 900 }, { 540, 540, 256 }, { 100, 400, 768 }, { 960, 800, 0 },
};
