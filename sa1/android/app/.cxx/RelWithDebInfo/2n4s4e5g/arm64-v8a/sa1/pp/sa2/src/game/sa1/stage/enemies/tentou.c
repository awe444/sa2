# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/tentou.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/tentou.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/tentou.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/tentou.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/tentou.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/tentou.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/tentou.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/tentou.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/tentou.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/tentou.c" 2
...
void CreateEntity_Tentou(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    tentou->qUnk3C = -((s32)((0.625)*256));
    tentou->qUnk40 = ((s32)((0)*256));
    tentou->unk44 = 0;
    tentou->unk46 = 0;
    tentou->unk48 = 0;
    ...
    if (((int)((gPlayer.qWorldX) >> 8)) >= ((tentou->shared.base.meX)*8 + (tentou->shared.base.regionX)*256)) {
        tentou->qUnk3C = +((s32)((0.625)*256));
        tentou->unk48 |= 0x400;
    }
...
void Task_TentouMain(void)
{
    ...
    tentou = (void *)((gCurTask)->data);
    s = &tentou->shared.s;
    me = tentou->shared.base.me;

    worldX = ((tentou->shared.base.meX)*8 + (tentou->shared.base.regionX)*256);
    worldY = ((me->y)*8 + (tentou->shared.base.regionY)*256);

    worldX2 = worldX;
    worldY2 = worldY;

    dtUnk50 = tentou->unk50;
    tentou->unk50 = ((s32)((me->d.uData[2] * 8) << 8)) * (gSineTable[((tentou->unk58 * (tentou->unk4E & 0x7F)) & (1024 - 1))]) >> 14;
    dtUnk50Shift = tentou->unk50 - dtUnk50;

    dtUnk54 = tentou->unk54;
    tentou->unk54 = ((s32)((me->d.uData[3] * 8) << 8)) * (gSineTable[((tentou->unk5A * (tentou->unk4E & 0x3F)) & (1024 - 1)) + 256]) >> 14;
    ...
    if ((s->y = ({((0x40) != 0) ? ((s32)(dtUnk54Shift >> 4) % (s32)(0x40)) : 0;})) != 0x3F) {
        s->y = worldY2 - gCamera.y - ({((0x40) != 0) ? ((s32)(dtUnk54Shift >> 4) % (s32)(0x40)) : 0;});
...
{
    Tentou *tentou = (void *)((gCurTask)->data);
    Sprite *s = &tentou->shared.s;
    ...
    tentou->unk50 = ((s32)((me->d.uData[2] * 8) << 8)) * (gSineTable[((tentou->unk58 * ((tentou->unk4E - 1) & 0x7F)) & (1024 - 1))]) >> 14;
    prevUnk54 = tentou->unk54;
    tentou->unk54 = ((s32)((me->d.uData[3] * 8) << 8)) * (gSineTable[((tentou->unk5A * ((tentou->unk4E - 1) & 0x3F)) & (1024 - 1)) + 256]) >> 14;
...
void sub_8074928(void)
{
    ...
    dtPlayerEnX = (((int)((gPlayer.qWorldX) >> 8)) - gCamera.x) - s->x;
    dtPlayerEnX = ((dtPlayerEnX) * (dtPlayerEnX));

    dtPlayerEnY = (((int)((gPlayer.qWorldY) >> 8)) - gCamera.y) - s->y;
    dtPlayerEnY = ((dtPlayerEnY) * (dtPlayerEnY));

    if (dtPlayerEnX + dtPlayerEnY < ((80) * (80))) {
        tentou->unk46 = 0;
        s->variant = 2;
...
void sub_8074C50(void)
{
    TentouProj *proj = (void *)((gCurTask)->data);
    Sprite *s = &proj->s;
    ...
    proj->unk38 += ((s32)((40. / 256.)*256));
    s->y += ((int)((proj->unk38) >> 8));
    oldWorldX = s->x;
    oldWorldY = s->y;
