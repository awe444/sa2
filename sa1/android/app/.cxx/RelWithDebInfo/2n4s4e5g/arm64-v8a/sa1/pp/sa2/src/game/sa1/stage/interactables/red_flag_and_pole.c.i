# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/red_flag_and_pole.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/red_flag_and_pole.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/red_flag_and_pole.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/red_flag_and_pole.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/red_flag_and_pole.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/red_flag_and_pole.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/red_flag_and_pole.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/red_flag_and_pole.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/red_flag_and_pole.c" 2
...
void CreateEntity_RedFlag(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    s->graphics.dest = VramMalloc(((24 / 8) * (32 / 8)));
    s->graphics.anim = 469;
    s->variant = 0;
    s->oamFlags = ((18) << 6);
    s->graphics.size = 0;
...
void Task_RedFlag(void)
{
    ...
    worldX = ((pole->base.meX)*8 + (pole->base.regionX)*256);
    worldY = ((me->y)*8 + (pole->base.regionY)*256);
...
void Task_8077760(void)
{
    RedFlagPole *pole = (void *)((gCurTask)->data);
    Sprite *s = &pole->s;
    MapEntity *me = pole->base.me;
    CamCoord worldX, worldY;
    ...
    {
        Player *p = &(*(((pole->tuggingPlayerIndex) != 0) ? &gPartner : &gPlayer));
        if ((!(gPlayer.moveState & 0x00000080))) {
            if (pole->unk3D > 6) {
                if (pole->unk3D == 7) {
                    if (s->frameFlags & ((1) << (10))) {
                        p->qWorldX -= ((s32)((10)*256));
                    } else {
                        p->qWorldX += ((s32)((10)*256));
                    }
                } else {
                    if (s->frameFlags & ((1) << (10))) {
                        p->qWorldX -= ((s32)((7.5)*256));
                    } else {
                        p->qWorldX += ((s32)((7.5)*256));
                    }
                }
            ...
            if (++pole->unk3D > 13) {
                ...
                if (!(p->moveState & 0x00000001)) {
                    ...
                    if (p->qSpeedGround < +((s32)((10.5)*256))) {
                        p->qSpeedGround = +((s32)((10.5)*256));
                        p->qSpeedAirX = +((s32)((10.5)*256));
                    }
                } else {
                    if (p->charState == 9) {
                        p->charState = 4;
...
void Task_8077D1C(void)
{
...

    {
        ...
        if ((!(gPlayer.moveState & 0x00000080))) {
            if (pole->unk3D > 6) {
                p->qWorldY -= ((s32)((arr[pole->unk3D])*256));
            } else {
                p->qWorldY += ((s32)((arr[pole->unk3D])*256));
            }
...

{
    ...
    do {
        ...
        if (!(res & 0x80000) || (p->moveState & 0x00000002)) {
            continue;
        }

        if (!(p->moveState & 0x00000004) && (p->qSpeedGround >= -((s32)((3)*256)))) {
            continue;
        } else if ((p->moveState & 0x00000004) && (p->qSpeedGround >= -((s32)((5.25)*256)))) {
            continue;
        }
...

{
    ...
    do {
        ...
        if (!(p->moveState & 0x00000004) && (p->qSpeedGround <= +((s32)((3)*256)))) {
            if ((p->qSpeedGround > ((s32)((5.25)*256))) && !(p->moveState & 0x00000001)) {
                Player_TransitionCancelFlyingAndBoost(p);
                m4aSongNumStart(175);
                p->qWorldX = qWorldX;
            } else {
...

{
    ...
    do {
        ...
        if (!(res & 0x80000) || ((p->character == CHARACTER_TAILS || p->character == CHARACTER_KNUCKLES) && (p->sa2__unk61 != 0))) {
            continue;
        }
