# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/time_attack.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/time_attack.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/time_attack.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/time_attack.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/time_attack.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/time_attack.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/time_attack.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/time_attack.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/time_attack.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/time_attack.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/time_attack.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/time_attack.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/text.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/time_attack.c" 2
...
const AnimId gUnknown_080BB35C[2] = { 882, 881 };
const u8 gUnknown_080BB360[2][2] = { { 1, 1 }, { 0, 0 } };
...
void CreateTimeAttackMenu(void)
{
    ...
    t = TaskCreate(Task_TimeAttackMenu, sizeof(TimeAttackMenu), 0x2000U, 0U, ((void*)0));
    menu = (void *)((t)->data);
    menu->unk70 = 0;
    menu->unk6C = 0;
    menu->unk74 = 0;
...
void Task_TimeAttackMenu(void)
{
    ...
    TimeAttackMenu *menu = (void *)((gCurTask)->data);
    ...
    menu->s.variant = gUnknown_080BB360[menu->unk74][(&gLoadedSaveGame)->uiLanguage];
    UpdateSpriteAnimation(s);

    for (var_r5 = ((int)((menu->unk70) >> 8)) - 128; ((224 - var_r5) > 0); var_r5 += 128) {
        s->x = 224 - var_r5;
        DisplaySprite(s);
    }
