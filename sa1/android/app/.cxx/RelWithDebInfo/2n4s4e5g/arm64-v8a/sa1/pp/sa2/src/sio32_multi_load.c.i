# 1 "/home/awaszczak/git/sa2/sa1/../src/sio32_multi_load.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/sio32_multi_load.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../include/multi_sio.h" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/sio32_multi_load.c" 2
    ...
    switch (gSio32MultiLoadArea.state) {
        ...
        case 1:
            if (gSio32MultiLoadArea.type == 0x0001) {
                ...
                (*(reg_u16 *)(REG_BASE + 0x128)) = 0x1000;
            (*(reg_u32 *)(REG_BASE + 0x120)) = 0;
            (*(reg_u16 *)(REG_BASE + 0x202)) = (1 << 7) | ((1 << 3) << 3);
            if (gSio32MultiLoadArea.type == 0x0001) {
                (*(reg_u16 *)(REG_BASE + 0x128)) |= 0x0080;
                (*(vu32 *)((REG_BASE + 0x100) + (3 * 4))) = ((((16 * 1024 * 1024) / (256 * 1024) * 32 + 1000 + 256) > 0x10000) ? 0x10000 - 0x10000 : 0x10000 - ((16 * 1024 * 1024) / (256 * 1024) * 32 + 1000 + 256)) | ((0x00 | 0x40 | 0x80) << 16);
                (*(reg_u16 *)(REG_BASE + 0x208)) = 0;
                (*(reg_u16 *)(REG_BASE + 0x200)) |= ((1 << 3) << 3);
                (*(reg_u16 *)(REG_BASE + 0x208)) = 1;
            } else {
                (*(reg_u16 *)(REG_BASE + 0x128)) |= 0x4000 | 0x0080;
                (*(reg_u16 *)(REG_BASE + 0x208)) = 0;
        ...
        case 3:
            ...
            *(vu32 *)(REG_BASE + 0x128) = 0x2000 | 0x0003;
            *(vu64 *)(REG_BASE + 0x120) = 0;
            if (gSio32MultiLoadArea.type)
                (*(vu32 *)((REG_BASE + 0x100) + (3 * 4))) = 0;
            (*(reg_u16 *)(REG_BASE + 0x202)) = (1 << 7) | ((1 << 3) << 3);
            if (!gSio32MultiLoadArea.type)
                return 1;
            gSio32MultiLoadArea.frameCounter = 0;
...
void Sio32MultiLoadIntr(void)
{
    ...
    u32 recvTmp = (*(reg_u32 *)(REG_BASE + 0x120));
    ...
    if (gSio32MultiLoadArea.type == 0x0001) {
        ...
        if (gSio32MultiLoadArea.dataCounter < 0)
            (*(reg_u32 *)(REG_BASE + 0x120)) = 0xfefefefe;
        else if (gSio32MultiLoadArea.dataCounter < 0x8000 / 4)

            (*(reg_u32 *)(REG_BASE + 0x120)) = gSio32MultiLoadArea.datap[gSio32MultiLoadArea.dataCounter];
        else
            (*(reg_u32 *)(REG_BASE + 0x120)) = gSio32MultiLoadArea.checkSum;
    } else {
...
void Sio32MultiLoadInit(u32 type, void *datap)
{
    ...
    *(vu32 *)(REG_BASE + 0x128) = 0x2000 | 0x0003;
    ...
    if (type) {
        ...
        (*(reg_u16 *)(REG_BASE + 0x128)) = 0x1000;
        (*(reg_u16 *)(REG_BASE + 0x128)) = 0x1000 | 0x0001 | 0x0000;
    }
}
