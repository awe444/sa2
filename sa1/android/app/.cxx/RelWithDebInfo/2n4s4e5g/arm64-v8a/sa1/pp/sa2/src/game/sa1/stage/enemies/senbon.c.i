# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/senbon.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/senbon.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/senbon.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/senbon.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/senbon.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/senbon.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/senbon.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/senbon.c" 2
...
void Task_SenbonInit(void)
{
    Senbon *senbon = (void *)((gCurTask)->data);
    Sprite *s = &senbon->shared.s;
    MapEntity *me = senbon->shared.base.me;
    s16 worldX, worldY;
    s16 offsetWorldX;

    worldX = ((senbon->shared.base.meX)*8 + (senbon->shared.base.regionX)*256);
    worldY = ((me->y)*8 + (senbon->shared.base.regionY)*256);

    senbon->qUnk40 += senbon->qUnk48;
    offsetWorldX = worldX + ((int)((senbon->qUnk40) >> 8));
    ...
    if (((int)((senbon->qUnk40) >> 8)) <= ((me->d.sData[0] + 1) * 8)) {
        senbon->qUnk48 = +((s32)((0.625)*256));
        s->frameFlags |= ((1) << (10));
    } else if (((int)((senbon->qUnk40) >> 8)) >= ((me->d.sData[0] + me->d.uData[2] - 1) * 8)) {
        senbon->qUnk48 = -((s32)((0.625)*256));
        s->frameFlags &= ~((1) << (10));
        ...
        if (s->frameFlags & ((1) << (10))) {
            if ((((int)((gPlayer.qWorldX) >> 8)) >= offsetWorldX)
                && ((offsetWorldX + 80) >= ((int)((gPlayer.qWorldX) >> 8)))) {
                senbon->unk44 = 0;
...
void Task_8070CB4(void)
{
    ...
    worldX32 = ((senbon->shared.base.meX)*8 + (senbon->shared.base.regionX)*256);
    worldY32 = ((me->y)*8 + (senbon->shared.base.regionY)*256);
    worldX = (CamCoord)worldX32;
    worldY = (CamCoord)worldY32;
    screenX = worldX + ((int)((senbon->qUnk40) >> 8));
