# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/interactables.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring.c" 2
...
const s16 sData0Accel[4] = { ((s32)((7.5)*256)), ((s32)((9.0)*256)), ((s32)((10.5)*256)), ((s32)((12.0)*256)) };
...
void CreateEntity_Spring_Normal_Up(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    if (!(me->d.sData[0] & 0x2)) {
        DmaSet(3, &gRefSpriteTables->palettes[288 * sizeof(u16)], &gObjPalette[8 * 16], (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((16 * sizeof(u16))/(32/8))));
        gFlags |= 0x2;
        s->frameFlags = (((2) << (12)) | ((1) << (18)));
        s->palId = 1;
    } else {
        s->frameFlags = (((2) << (12)) | ((0) << (18)));
    }
...
void Task_Spring_Normal_Up(void)
{
    SpringA *spring = (void *)((gCurTask)->data);
    Sprite *s = &spring->s;
    ...
    do {
        ...
        if (!(gStageFlags & 0x0080)) {
            res = sub_8022640(s, me, spring, &(*(((i) != 0) ? &gPartner : &gPlayer)));
        } else {
            res = sub_8022804(s, me, spring, &(*(((i) != 0) ? &gPartner : &gPlayer)));
        }
...
void Task_Spring_Horizontal(void)
{
    ...
    do {
        ...
        res = sub_80228D0(s, me, spring, &(*(((i) != 0) ? &gPartner : &gPlayer)));
...
void Task_80220FC(void)
{
    ...
    do {
        ...
        sub_80228D0(s, me, spring, &(*(((i) != 0) ? &gPartner : &gPlayer)));
...
void Task_Spring_Big_Up(void)
{
    SpringB *spring = (void *)((gCurTask)->data);
    Sprite *s = &spring->s;
    MapEntity *me = spring->base.me;
    s32 i;
    ...
    do {
        ...
        res = sub_8022AB4(s, me, spring, &(*(((i) != 0) ? &gPartner : &gPlayer)));
...
void Task_8022354(void)
{
    ...
    do {
        ...
        sub_8022AB4(s, me, spring, &(*(((i) != 0) ? &gPartner : &gPlayer)));
...
void Task_Spring_Small_Up(void)
{
    ...
    do {
        ...
        res = sub_8022E14(s, me, spring, &(*(((i) != 0) ? &gPartner : &gPlayer)));
...
void Task_8022594(void)
{
    ...
    do {
        ...
        sub_8022E14(s, me, spring, &(*(((i) != 0) ? &gPartner : &gPlayer)));
...

{
    ...
    if (!(p->moveState & 0x00400000) || r6) {


        if (!(Coll_Player_Platform(s, worldX, worldY, p) & 0x00000008)) {
        ...
        if (me->d.sData[0] >= (s32)(sizeof(sData0Accel) / sizeof((sData0Accel)[0]))) {
...
bool32 sub_8022AB4(Sprite *s, MapEntity *me, SpringB *spring, Player *p)
{
    ...
    if (hitWithHammer || (((((worldX) + s->hitboxes[1].b.left) <= ((((int)((p->qWorldX) >> 8))) + (*((Rect8 *)&arr)).left) && ((((worldX)) + (s->hitboxes[1].b).left) + ((s->hitboxes[1].b).right - (s->hitboxes[1].b).left)) >= ((((int)((p->qWorldX) >> 8))) + (*((Rect8 *)&arr)).left)) || (((worldX) + s->hitboxes[1].b.left) >= ((((int)((p->qWorldX) >> 8))) + (*((Rect8 *)&arr)).left) && ((((((int)((p->qWorldX) >> 8)))) + ((*((Rect8 *)&arr))).left) + (((*((Rect8 *)&arr))).right - ((*((Rect8 *)&arr))).left)) >= ((worldX) + s->hitboxes[1].b.left))) && (((((worldY)) + s->hitboxes[1].b.top) <= (((((int)((p->qWorldY) >> 8)))) + (*((Rect8 *)&arr)).top) && ((((worldY)) + s->hitboxes[1].b.top) + ((s->hitboxes[1].b).bottom - (s->hitboxes[1].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + (*((Rect8 *)&arr)).top)) || ((((worldY)) + s->hitboxes[1].b.top) >= (((((int)((p->qWorldY) >> 8)))) + (*((Rect8 *)&arr)).top) && ((((((int)((p->qWorldY) >> 8)))) + (*((Rect8 *)&arr)).top) + (((*((Rect8 *)&arr))).bottom - ((*((Rect8 *)&arr))).top)) >= (((worldY)) + s->hitboxes[1].b.top))))) {
        iaIndex = 12;
        ...
        if ((iaIndex == me->index) && (hitWithHammer || (worldX - ({ ((int)((p->qWorldX) >> 8)) + 20; })) > 0)) {
            if (gGameMode == 3 || gGameMode == 5) {
                p->timerInvulnerability = 2;
            }
            ...
            return 1;
        } else if (hitWithHammer || worldX - ((int)((p->qWorldX) >> 8)) + 20 < 0) {
            if (gGameMode == 3 || gGameMode == 5) {
                p->timerInvulnerability = 2;
            }
