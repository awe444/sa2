# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_2.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_2.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_2.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_2.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_2.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_2.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_2.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_2.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_2.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_2.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_2.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_2.c" 2
# 25 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_2.c"
bool32 sa2__sub_800DD54(Player *p)
{
...
{
    bool16 gravityInverted = (gStageFlags & 0x0080);
    ...
    if (!(((((x) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + (*rectPlayer).left) && ((((x)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + (*rectPlayer).left)) || (((x) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + (*rectPlayer).left) && ((((((int)((p->qWorldX) >> 8)))) + ((*rectPlayer)).left) + (((*rectPlayer)).right - ((*rectPlayer)).left)) >= ((x) + s->hitboxes[0].b.left))) && (((((y)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + (*rectPlayer).top) && ((((y)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + (*rectPlayer).top)) || ((((y)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + (*rectPlayer).top) && ((((((int)((p->qWorldY) >> 8)))) + (*rectPlayer).top) + (((*rectPlayer)).bottom - ((*rectPlayer)).top)) >= (((y)) + s->hitboxes[0].b.top))))) {
        return 0;
    }

    if (!gravityInverted) {
        if (((int)((p->qWorldY) >> 8)) > middleY) {
            s32 whole = ((s32)((s->hitboxes[0].b.bottom + y - rectPlayer->top)*256));
        ...
        test:
            if (!gravityInverted) {
                p->qWorldY = ((u8)(p->qWorldY)) + ((s32)((s->hitboxes[0].b.top + y - rectPlayer->bottom)*256));
            } else {
                p->qWorldY = ((u8)(p->qWorldY)) + ((s32)((s->hitboxes[0].b.bottom + y + rectPlayer->bottom)*256));
            }
            ...
            if (p->qWorldY >= ((s32)((gCamera.maxY)*256))) {
                p->qWorldY = ((s32)((gCamera.maxY)*256));
                return 0;
            }
            ...
            if (!(p->moveState & 0x00000002) && (((p->rotation + 0x20) & 0x40) != 0)) {
                p->qSpeedGround = ((s32)((0)*256));
            }

            p->moveState |= 0x00000008;
            *moveState |= 0x00000008;

            if (p->character == CHARACTER_KNUCKLES) {
                if (p->sa2__unk61 == 1 || p->sa2__unk61 == 3) {
                    goto lbl;
                }
            }
            if ((p->character != CHARACTER_AMY) || !(p->moveState & 0x04000000) || (p->sa2__unk62 == 0)) {
                p->moveState &= ~0x00000002;
            }
        lbl:
            p->stoodObj = s;
            ...
            p->qWorldY = ((u8)(p->qWorldY)) + ((s32)((s->hitboxes[0].b.top + y + rectPlayer->top)*256));
        }
    }
...
bool32 sub_800CBBC(Sprite *s, s32 x, s32 y, Rect8 *rectPlayer, u32 __attribute__((unused)) param4, Player *p, u32 *param6)
{
    ...
    if (((int)((p->qWorldX) >> 8)) <= shbMiddleH) {
        ...
        if (!(p->moveState & 0x00000002) && p->qSpeedGround > 0) {
            p->qSpeedGround = 0;
        }
        p->qWorldX = ((s32)((x + shbLeft - rectPlayer->right)*256));
        *param6 |= 0x00020000;

        if (!(p->moveState & 0x00000002)) {
            p->moveState = (p->moveState | 0x00000020) & ~0x00000004;
            *param6 = (*param6 | 0x00000020) & ~0x00000004;
        ...
        p->qWorldX = ((s32)((x + shbRight - rectPlayer->left + 1)*256));
        *param6 |= 0x00040000;
...
# 382 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_2.c"
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p)
{
