# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui_z.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui_z.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui_z.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui_z.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui_z.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui_z.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui_z.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui_z.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui_z.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/stage/mp_hud.h" 1




void CreateChaoHuntHUD(void);
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui_z.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui_z.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui_z.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui_z.c" 2


# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui_z.c" 2
...
void LoadStageIntroGraphics(StrcStack *param0)
{
    ...
    sp00.uiGfxID = 6 + gSelectedCharacter;
    sp00.unk2B = 6;
    ...
    sp00.uiGfxID = 10;
    sp00.unk2B = 7;
    sp00.tiles = gUiGraphics[10].tiles + (gSelectedCharacter * 0x800);
    sp00.palette = gUiGraphics[10].palette;
    sp00.tilesSize = 0x800;
    sp00.paletteSize = 32;
    sp00.unk28 = 15;
    sp00.vramC = ((void *)&VRAM[0x10000] + 0x0800);
    sp00.unk2A = 13;
    sp00.unk0.unk4 = gUiGraphics[10].unk8;
    sp00.unk0.unk8 = gUiGraphics[10].unkC;
    sp00.unk0.unk9 = gUiGraphics[10].unk10;
    sp00.unk0.unkA = gUiGraphics[10].unk14;
    sp00.unk0.unkB = gUiGraphics[10].unk18;
    sub_80528AC(&sp00);

    sp00.uiGfxID = 16;
    sp00.unk2B = 8;
    sp00.tiles = gUiGraphics[16].tiles;
    sp00.palette = gUiGraphics[16].palette;
    sp00.tilesSize = 0x200;
    sp00.paletteSize = 32;
    sp00.unk28 = 6;
    sp00.vramC = param0->vram0;
    sp00.unk2A = 13;
    sp00.unk0.unk4 = gUiGraphics[16].unk8;
    sp00.unk0.unk8 = gUiGraphics[16].unkC;
    sp00.unk0.unk9 = gUiGraphics[16].unk10;
    sp00.unk0.unkA = gUiGraphics[16].unk14;
    sp00.unk0.unkB = gUiGraphics[16].unk18;
    sub_80528AC(&sp00);

    if (gCurrentLevel <= ((6)*(2)) + (1)) {
        sp00.uiGfxID = 17;
        sp00.unk2B = 9;
        sp00.tiles = gUiGraphics[17].tiles + (49 * 32);
        sp00.palette = gUiGraphics[17].palette;
        sp00.tilesSize = (12 - gUnknown_08688378[gCurrentLevel]) * 32;
        sp00.paletteSize = 32;
        sp00.unk28 = 6;
        sp00.vramC = param0->vram8;
        sp00.unk2A = 13;
        sp00.unk0.unk4 = gUiGraphics[17].unk8;
        sp00.unk0.unk8 = gUiGraphics[17].unkC;
        sp00.unk0.unk9 = gUiGraphics[17].unk10;
        sp00.unk0.unkA = gUiGraphics[17].unk14;
        sp00.unk0.unkB = gUiGraphics[17].unk18;
        sub_80528AC(&sp00);

        sp00.uiGfxID = 17;
        sp00.unk2B = 9;
        sp00.tiles = gUiGraphics[17].tiles + 8 * 32;
        sp00.palette = gUiGraphics[17].palette;
        sp00.tilesSize = 0x80;
        sp00.paletteSize = 32;
        sp00.unk28 = 6;
        ...
        sp00.uiGfxID = 17;
        sp00.unk2B = 9;
        sp00.tiles = gUiGraphics[17].tiles + gUnknown_08688386[gCurrentLevel] * 32;
        sp00.palette = gUiGraphics[17].palette;
        sp00.tilesSize = gUnknown_08688378[gCurrentLevel] * 32;
        sp00.paletteSize = 32;
        sp00.unk28 = 6;
        sp00.vramC = param0->vram8 + (12 - gUnknown_08688378[gCurrentLevel]) * 32;
        sp00.unk2A = 13;
        sp00.unk0.unk4 = gUiGraphics[17].unk8;
        sp00.unk0.unk8 = gUiGraphics[17].unkC;
        sp00.unk0.unk9 = gUiGraphics[17].unk10;
        ...
        sp00.uiGfxID = 17;
        sp00.unk2B = 9;
        sp00.tiles = gUiGraphics[17].tiles + 0x100;
        sp00.palette = gUiGraphics[17].palette;
        sp00.tilesSize = 32;
        sp00.paletteSize = 32;
        sp00.unk28 = 6;
        ...
        sp00.uiGfxID = 18;
        sp00.unk2B = 9;
        sp00.tiles = gUiGraphics[sp00.uiGfxID].tiles + (gCurrentLevel - 14) * (16 * 32);
        sp00.palette = gUiGraphics[sp00.uiGfxID].palette;
        sp00.tilesSize = 0x200;
        sp00.paletteSize = 32;
        sp00.unk28 = 6;
    ...
    sp00.uiGfxID = 15;
    sp00.unk2B = 10;
    tiles = (gUiGraphics[15].tiles + 0x100);
    sp00.tiles = tiles + act * 0x80;

    sp00.tilesSize = 0x80;
    sp00.vramC = param0->vram10 + (8 * 32);
    sp00.unk2A = 9;
    sp00.unk0.unk4 = gUiGraphics[15].unk8;
    sp00.unk0.unk8 = gUiGraphics[15].unkC;
    sp00.unk0.unk9 = gUiGraphics[15].unk10;
    sp00.unk0.unkA = gUiGraphics[15].unk14;
    sp00.unk0.unkB = gUiGraphics[15].unk18;
    sub_80528AC(&sp00);

    sp00.uiGfxID = 15;
    sp00.unk2B = 10;
    sp00.tiles = gUiGraphics[15].tiles;
    sp00.palette = gUiGraphics[15].palette;
    ...
    sp00.unk2B = 2;
    sp00.tiles = gUiGraphics[sp00.uiGfxID].tiles;
    sp00.palette = gUiGraphics[19].palette;
...
struct Task *sub_80550F8(void)
{
    ...
    if ((gCurrentLevel <= ((6)*(2)) + (0)) && ((gCurrentLevel & 0x1) != 0) && (gFinalBossActive != gCurrentLevel)
        && (!((gCurrentLevel) == ((6)*(2)) + (1)))) {
        for (i = 0; i < 8; i++) {
            OamData *oam = OamMalloc(1);
    ...
    ui_24->unk20 = 1;
    ui_24->unk1A = 0;
    ui_24->unk0.qUnkA = -((s32)((80. / 256.)*256));
    ui_24->unk0.unkC = 0;
    ui_24->unk0.unkE = 3;
    ui_24->unk0.unk8 = 24;
    ui_24->unk0.unk10 = 6;
    ...
    tt = TaskCreate(Task_8055798, sizeof(Strc_Ui_24), 0x2120, 0, ((void*)0));
    sp04.task20 = tt;
    ui_24 = (void *)((tt)->data);
    ui_24->unk18 = 0;
    ui_24->unk20 = 0;
    ui_24->unk1A = 1;
    ui_24->unk0.qUnkA = +((s32)((20. / 256.)*256));
    ui_24->unk0.unkE = 1;
    ui_24->unk0.unk8 = 24;
    ui_24->unk0.unk10 = 7;
    ui_24->unk0.unk12 = 15;
    ...
    ui_24->unk20 = 1;
    ui_24->unk1A = 0;
    ui_24->unk0.qUnkA = +((s32)((180. / 256.)*256));
    ui_24->unk0.unkC = 160;
    ui_24->unk0.unkE = 6;
    ui_24->unk0.unk10 = 10;
    ui_24->unk0.unk12 = 6;
    ...
    if (((gCurrentLevel & 0x1) != 0) && (gFinalBossActive != gCurrentLevel) && (!((gCurrentLevel) == ((6)*(2)) + (1)))) {
        ui_24->unk0.qUnkA = -((s32)((16. / 256.)*256));
        ui_24->unk0.unkC = +42;

    } else {
        ui_24->unk0.qUnkA = +((s32)((240. / 256.)*256));
        ui_24->unk0.unkC = 126;
    }
    ...
    ui_24->unk20 = 1;
    ui_24->unk1A = 0;
    ui_24->unk0.qUnkA = +((s32)((360. / 256.)*256));
    ui_24->unk0.unkC = 114;
    ui_24->unk0.unkE = 4;
    ui_24->unk0.unk10 = 9;
    ui_24->unk0.unk12 = 6;
...
void Task_8055458(void)
{
    Strc_Ui_28 *strcMain = (void *)((gCurTask)->data);
    Strc_Ui_24 *strc1 = (void *)((strcMain->taskC)->data);
    Strc_Ui_24 *strc2 = (void *)((strcMain->task10)->data);
    Strc_Ui_24 *strc3 = (void *)((strcMain->task14)->data);
    Strc_Ui_24 *strc4 = (void *)((strcMain->task18)->data);
    Strc_Ui_24 *strc5 = (void *)((strcMain->task1C)->data);
    Strc_Ui_24 *strc6 = (void *)((strcMain->task20)->data);

    if ((gPressedKeys & (0x0001 | 0x0002 | 0x00F0)) && ((gGameMode == 0) || (gGameMode == 1))) {
        if ((strcMain->unk24 > 35) && (strcMain->unk24 < 215)) {
            strcMain->unk24 = 215;

            strcMain->unk0.unk8 = ({((10) != 0) ? ((s32)(0x2000 - strcMain->unk0.unk6) / (s32)(10)) : 0;});
    ...
    if (++strcMain->unk24 > 225) {
        ...
        if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
            u32 i;
            for (i = 0; (i < 4) && (gMultiplayerPlayerTasks[i] != ((void*)0)); i++) {
                MultiplayerPlayer *mpp = (void *)((gMultiplayerPlayerTasks[i])->data);
                mpp->unk5C &= ~0x2;
            }

            gPlayer.timerInvulnerability = (int)(((0 * 60.) + 2) * 60);
        }


        gStageFlags &= ~0x0001;
        gPlayer.moveState &= ~0x00200000;
        gPartner.moveState &= ~0x00200000;
        ...
        if (gCurrentLevel == ((3)*(2)) + (0) || gCurrentLevel == ((3)*(2)) + (1)) {
            LoadPalette423Anim();
            InitWaterPalettes();
        }
        ...
        if (((gCurrentLevel) == ((6)*(2)) + (1))) {
            sub_804A5D8(((s32)(((320 / 2))*256)), ((s32)(((240 / 2))*256)));
        }
    } else if (gCurrentLevel == ((3)*(2)) + (0) || gCurrentLevel == ((3)*(2)) + (1)) {
...
void Task_8055730(void)
{
    Strc_Ui_24 *strc = (void *)((gCurTask)->data);

    if (strc->unk18 > 215) {
        strc->unk0.qUnkA -= ((s32)((8. / 256.)*256));
...
void Task_8055798(void)
{
    ...
    if (strc->unk18 > 215) {
        s32 r5 = 0;
        s16 r6 = -({((10) != 0) ? ((s32)((strc->unk18 - 215) << 7) / (s32)(10)) : 0;});
        s16 r8 = r6;
        ...
        for (; r5 < 4; r8 += 0x20, r6 += 0x20, r7++, r5++) {
            ...
            if (r8 >= -32) {
                if (((strc->unk18 >= 0) && (strc->unk18 <= 105)) || !strc->unk20 || (strc->unk21 != 0)) {
                    sub_8052F78(r7, (void *)strc);
                } else {
                    sub_80530CC(r7, (void *)strc);
                }
            }
        ...
        for (; r5 < 4; r6++, r5++) {
            ...
            if (((strc->unk18 >= 0) && (strc->unk18 <= 105)) || !strc->unk20 || (strc->unk21 != 0)) {
                sub_8052F78(r6, (void *)strc);
            } else {
                sub_80530CC(r6, (void *)strc);
            }
        }
    } else if (strc->unk18 > 25) {


        s32 r8 = (({((6) != 0) ? ((s32)((strc->unk18 - 215) << 7) / (s32)(6)) : 0;}) - 176) & 0x1FF;
        ...
        for (; r5 < 4; r2 += 0x20, r6 += 0x20, r5++) {
            if (r8 > 421) {
                ...
                if (r2 >= -0x20) {
                    if (((strc->unk18 >= 0) && (strc->unk18 <= 105)) || !strc->unk20 || (strc->unk21 != 0)) {
                        sub_8052F78((const char *)&gUnknown_08688394[r5], (void *)strc);
                    } else {
                        sub_80530CC((const char *)&gUnknown_08688394[r5], (void *)strc);
                    }
                }
            }
        }
...
void Task_8055904(void)
{
    ...
    if (strc->unk18 > 215) {
        ...
        strc->unk0.qUnkA = ((s32)((180. / 256.)*256));
        strc->unk0.unkC = 144;
        strc->unk0.unkE = 6;
    ...
    if (gCurrentLevel <= ((5)*(2)) + (1)) {
        if (((strc->unk18 >= 0) && (strc->unk18 <= 105)) || !strc->unk20 || (strc->unk21 != 0)) {
            sub_8052F78((const char *)&gUnknown_086883B0[0], (void *)strc);
        } else {
            sub_80530CC((const char *)&gUnknown_086883B0[0], (void *)strc);
        }
    }
}
...
void Task_8055998(void)
{
    ...
    if (strc->unk18 > 215) {
        if (strc->unk0.qUnkA < -0x20) {
            strc->unk0.qUnkA += ((s32)((32. / 256.)*256));
        ...
        strc->unk0.qUnkA -= ((s32)((26. / 256.)*256));
    } else if (strc->unk18 > 25) {
        strc->unk0.qUnkA = -((s32)((16. / 256.)*256));
        ...
        if (((gCurrentLevel) == ((6)*(2)) + (1))) {
            ...
            if (strc->unk0.qUnkA < -((s32)((16. / 256.)*256))) {
                strc->unk0.qUnkA = -((s32)((16. / 256.)*256));
            }
        } else if ((gCurrentLevel < ((6)*(2)) + (1)) && ((gCurrentLevel & 0x1) != 0)
                   && ((gFinalBossActive) != gCurrentLevel)) {
...
void Task_8055AA0()
{
    ...
    if (strc->unk18 > 215) {
        ...
        strc->unk0.qUnkA = ((s32)((112 / 256.)*256));


    } else if ((u16)strc->unk18 > 15) {
        strc->unk0.qUnkA -= ((s32)((26. / 256.)*256));

        if (strc->unk0.qUnkA < ((s32)((112. / 256.)*256))) {
            strc->unk0.qUnkA = ((s32)((112. / 256.)*256));
        }
    }
...
void Task_8055B18()
{
...

    {
        ...
        if (strc->unk18 > 215) {
            ...
            strc->unk0.qUnkA -= ((s32)((28. / 256.)*256));

            if (strc->unk0.qUnkA < -((s32)((31. / 256.)*256))) {
                strc->unk0.unkE--;
                strc->unk0.qUnkA = qInitialUnkA + ((s32)((4. / 256.)*256));
                strc->unk1A = ({((7) != 0) ? ((s32)(strc->unk1A + 1) % (s32)(7)) : 0;});
            }
            ...
            u16 qInitialUnkA = strc->unk0.qUnkA;
            strc->unk0.qUnkA = qInitialUnkA - ((s32)((2. / 256.)*256));
            strc->unk0.unkE = 9;

            if (strc->unk0.qUnkA < -((s32)((31. / 256.)*256))) {
                strc->unk0.qUnkA = qInitialUnkA + ((s32)((30. / 256.)*256));
                strc->unk1A = ({((7) != 0) ? ((s32)(strc->unk1A + 1) % (s32)(7)) : 0;});
            }
            ...
            if (strc->unk0.qUnkA < ((s32)((240. / 256.)*256))) {
...
{
    Strc_Ui_24 *strc = (void *)((t)->data);

    if (strc->unk1C != ((void*)0))
