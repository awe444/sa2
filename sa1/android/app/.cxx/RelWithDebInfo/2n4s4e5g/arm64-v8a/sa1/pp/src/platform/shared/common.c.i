# 1 "/home/awaszczak/git/sa2/sa1/src/platform/shared/common.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/src/platform/shared/common.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/src/platform/shared/common.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/lib/agb_flash/flash_internal.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../include/lib/agb_flash/flash_internal.h"
extern u8 FLASH_BASE[131072 * 16];
...
# 3 "/home/awaszczak/git/sa2/sa1/src/platform/shared/common.c" 2

__attribute__((aligned(256))) uint8_t EWRAM_START[0x40000] = { 0 };
__attribute__((aligned(256))) uint8_t IWRAM_START[0x7E00] = { 0 };

__attribute__((aligned(256))) uint8_t REG_BASE[0x400] = { 0 };
__attribute__((aligned(256))) ColorRaw PLTT[32 * 16u] = { 0 };
__attribute__((aligned(256))) uint8_t VRAM[(0x18000 + (0x800 * (14)))] = { 0 };
__attribute__((aligned(256))) uint8_t OAM[(128*0xC)] = { 0 };
__attribute__((aligned(256))) uint8_t FLASH_BASE[131072 * 16] = { 0 };
...
void IntrMain(void)
{
# 30 "/home/awaszczak/git/sa2/sa1/src/platform/shared/common.c"
    u16 flags = (*(reg_u16 *)(REG_BASE + 0x200)) & (*(reg_u16 *)(REG_BASE + 0x202));
    u16 flag;

    u32 index = 0;
    { flag = flags & ((1 << 6) | (1 << 7)); if (flag) { goto found_instr; } index++; };
    { flag = flags & (1 << 0); if (flag) { goto found_instr; } index++; };
    { flag = flags & (1 << 1); if (flag) { goto found_instr; } index++; };
    { flag = flags & (1 << 2); if (flag) { goto found_instr; } index++; };
    { flag = flags & (1 << 3); if (flag) { goto found_instr; } index++; };
    { flag = flags & (1 << 4); if (flag) { goto found_instr; } index++; };
    { flag = flags & (1 << 5); if (flag) { goto found_instr; } index++; };
    { flag = flags & (1 << 8); if (flag) { goto found_instr; } index++; };
    { flag = flags & (1 << 9); if (flag) { goto found_instr; } index++; };
    { flag = flags & (1 << 10); if (flag) { goto found_instr; } index++; };
    { flag = flags & (1 << 11); if (flag) { goto found_instr; } index++; };
    { flag = flags & (1 << 12); if (flag) { goto found_instr; } index++; };
    { flag = flags & (1 << 13); if (flag) { goto found_instr; } index++; };

found_instr:
    (*(reg_u16 *)(REG_BASE + 0x202)) = flag;
