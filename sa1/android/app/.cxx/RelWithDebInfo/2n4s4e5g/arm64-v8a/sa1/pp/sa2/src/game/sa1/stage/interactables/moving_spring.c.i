# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/moving_spring.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/moving_spring.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/moving_spring.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/moving_spring.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/moving_spring.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/moving_spring.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/moving_spring.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/moving_spring.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/moving_spring.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/moving_spring.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/moving_spring.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/moving_spring.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/moving_spring.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 19 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/moving_spring.c" 2
...
void CreateEntity_MovingSpring(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    MovingSpring *spring = (void *)((t)->data);
    Sprite *s = &spring->s;
    ...
    if (zone == 3) {
        s->graphics.dest = VramMalloc(((32 / 8) * (56 / 8)));
        s->graphics.anim = 526;
        s->variant = 1;
...
void Task_MovingSpringMain(void)
{
    ...
    MovingSpring *spring = (void *)((gCurTask)->data);
    Sprite *s = &spring->s;
    MapEntity *me = spring->base.me;

    if (spring->unk48 != 0) {
        spring->qUnk40 = ((me->d.uData[2] << 11) * (gSineTable[((spring->unk48 * ((gStageTime + spring->unk3C) & 0xFF)) & (1024 - 1))])) >> 14;
    }

    if (spring->unk4A != 0) {
        spring->qUnk44 = ((me->d.uData[3] << 11) * (gSineTable[((spring->unk4A * ((gStageTime + spring->unk3C) & 0xFF)) & (1024 - 1))])) >> 14;
    }

    worldX = ((spring->base.meX)*8 + (spring->base.regionX)*256);
    worldY = ((me->y)*8 + (spring->base.regionY)*256);

    s->x = worldX - gCamera.x + ((int)((spring->qUnk40) >> 8));
    s->y = worldY - gCamera.y + ((int)((spring->qUnk44) >> 8));
...
bool32 sub_808B7A0(MovingSpring *spring, Sprite *s, s32 worldX, s32 worldY)
{
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            ...
            s32 r5 = Coll_AmyHammer_Spring(s, worldX + ((int)((spring->qUnk40) >> 8)), worldY + ((int)((spring->qUnk44) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer)));
            s32 qPrevPlayerX;

            if ((((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000008) && ((*(((i) != 0) ? &gPartner : &gPlayer)).stoodObj == s)) || r5) {
                u8 zone = ((gCurrentLevel) >> 1);

                Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000002;
                (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 17;
                (*((i != 0) ? &gPartnerBodyPSI : &gPlayerBodyPSI)).s.prevVariant = -1;
                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = -((s32)((7.5)*256));

                if (r5) {
                    if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000008)) {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY += (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY >> 1;
                    }
                }
            ...
            qPrevPlayerX = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX;

            sub_808BB44(s, worldX + ((int)((spring->qUnk40) >> 8)), worldY + ((int)((spring->qUnk44) >> 8)), (Rect8 *)arr, &(*(((i) != 0) ? &gPartner : &gPlayer)));

            {
                s32 r5 = Coll_Player_Platform(s, worldX + ((int)((spring->qUnk40) >> 8)), worldY + ((int)((spring->qUnk44) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer)));

                if ((*(((i) != 0) ? &gPartner : &gPlayer)).charState == 17) {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = qPrevPlayerX;
                }

                if ((r5 & (0x00100000 | 0x00040000 | 0x00020000 | 0x00010000)) && sub_80549FC()) {
                    Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                ...
                if (!(r5 & 0x00000020)) {
                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000020) {
...
bool32 sub_808BB44(Sprite *s, s32 worldX, s32 worldY, Rect8 *rect, Player *p)
{
    ...
    if ((((((worldX) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + (*rect).left) && ((((worldX)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + (*rect).left)) || (((worldX) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + (*rect).left) && ((((((int)((p->qWorldX) >> 8)))) + ((*rect)).left) + (((*rect)).right - ((*rect)).left)) >= ((worldX) + s->hitboxes[0].b.left))) && (((((worldY)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + (*rect).top) && ((((worldY)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + (*rect).top)) || ((((worldY)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + (*rect).top) && ((((((int)((p->qWorldY) >> 8)))) + (*rect).top) + (((*rect)).bottom - ((*rect)).top)) >= (((worldY)) + s->hitboxes[0].b.top))))) {
        ...
        res = sa2__sub_801E4E4(((int)((p->qWorldY) >> 8)) + 9, ((int)((r1) >> 8)), p->layer, +8, ((void*)0), sa2__sub_801EE64);
