# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/party_balloon.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/party_balloon.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/party_balloon.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/party_balloon.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/party_balloon.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/party_balloon.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/stage/interactables/party_balloon.h" 1
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/party_balloon.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/party_balloon.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/party_balloon.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/party_balloon.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/party_balloon.c" 2
...
void CreateEntity_PartyBalloon(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    PartyBalloon *balloon = (void *)((t)->data);
    Sprite *s = &balloon->s;
    ...
    s->graphics.dest = VramMalloc(((24 / 8) * (48 / 8)));
    s->oamFlags = ((18) << 6);
    s->graphics.size = 0;
    ...
    s->variant = 0;
    s->animCursor = 0; s->qAnimDelay = ((s32)((0)*256)); s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = 0; s->hitboxes[0].index = -1;;
    s->frameFlags = ((2) << (12));
...
void Task_PartyBalloon(void)
{
    PartyBalloon *balloon = (void *)((gCurTask)->data);
    Sprite *s = &balloon->s;
    ...
    worldX = ((balloon->base.meX)*8 + (balloon->base.regionX)*256);
    worldY = ((me->y)*8 + (balloon->base.regionY)*256);
    ...
    loopJmp:
        ...
        if (Coll_Player_Entity_Intersection(s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
            ...
            if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00400000)) {
                ...
                (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 21;
