# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_hud.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_hud.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_hud.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_hud.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_hud.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_hud.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_hud.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_hud.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/text.h" 1
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_hud.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/tilemaps.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_hud.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/zones.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_hud.c" 2
...
const u8 sa2__gUnknown_080E0234[] = {
...
void CreateChaoHuntHUD(void)
{
    ...
    ChaoHuntHUD *hud = (void *)((TaskCreate(Task_ChaoHuntHUD, sizeof(ChaoHuntHUD), 0x2000U, 0U, TaskDestructor_ChaoHuntHUD))->data);
    ...
    for (i = 0; i < 11; i++) {
        ...
        if (i == 0) {
            ...
            s->graphics.dest = hud->spritesA[0].graphics.dest + (i * (2 * 32));
        }
        s->oamFlags = 0x100;
        s->graphics.size = 0;
        s->graphics.anim = 907;
        ...
        if (i == 0) {
            ...
            s->graphics.dest = hud->spritesB[0].graphics.dest + (i * (2 * 32));
        }
        s->oamFlags = 0x100;
        s->graphics.size = 0;
        s->graphics.anim = 907;
...
void Task_ChaoHuntHUD(void)
{
    ...
    hud = (void *)((gCurTask)->data);


    if (((u32)gCourseTime < (int)(((1 * 60.) + 0) * 60)) && (gCourseTime & 2)) {
        timerSprites = hud->spritesB;
    } else {
        timerSprites = hud->spritesA;
    }
    if (!(1 & gStageFlags) && (gCourseTime < (int)(((1 * 60.) + 0) * 60)) && (({((60) != 0) ? ((s32)(gCourseTime) % (s32)(60)) : 0;}) == 0)) {
        m4aSongNumStart(139);
    }
    s = &timerSprites[10];
    s->y = 32;
    ...
    s->x = 0x30;
    DisplaySprite(s);
    temp_r5 = ({((60) != 0) ? ((s32)(gCourseTime) / (s32)(60)) : 0;});
    var_r4 = sa2__gUnknown_080E0234[gCourseTime - (temp_r5 * 60)];
    ...
    s->y = 32;
    DisplaySprite(s);
    var_r4 = ({((60) != 0) ? ((s32)(temp_r5) / (s32)(60)) : 0;});
    ...
    s->y = 32;
    DisplaySprite(s);
    s = &timerSprites[0xF & Base10DigitsToHexNibbles((var_r4 - (({((60) != 0) ? ((s32)(var_r4) / (s32)(60)) : 0;}) * 60)))];
    s->x = 16;
    s->y = 32;
    DisplaySprite(s);
    ...
    for (var_r5 = 0; var_r5 < 4; var_r5++) {
        Sprite *timerSprites;
        if (!(((gMultiplayerConnections) >> (var_r5)) & 1) || (gGameMode == 5 && var_r5 == 2)) {
            break;
        }
        timerSprites = hud->spritesA;
        s0 = &hud->s0;
        ...
        if (gGameMode == 5) {
            ...
            for (var_r2_2 = 0; var_r2_2 < 4; var_r2_2++) {
                if (gMultiplayerPlayerTasks[var_r2_2] == ((void*)0)) {
                    break;
                }

                if (var_r5 == (((gMultiplayerConnections) & ((1 << ((0x10 << var_r2_2))))) >> (var_r2_2 + 4))) {
