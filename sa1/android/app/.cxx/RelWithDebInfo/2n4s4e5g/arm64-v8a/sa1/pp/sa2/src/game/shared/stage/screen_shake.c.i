# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/screen_shake.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/screen_shake.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/screen_shake.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/screen_shake.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/screen_shake.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/screen_shake.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/screen_shake.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/screen_shake.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/screen_shake.c" 2
...
void Task_ScreenShake(void)
{
    ScreenShake *shake = (void *)((gCurTask)->data);
    ...
    if (shake->p3 == 0 || shake->p0 <= 0) {
        ...
        if (shake->flags & 0x10) {
            factor = ((u32)(({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) << 15) >> 23) - 0xFF;
        } else {
            factor = ((int)(((gSineTable[(shake->unk14)])) >> 6));
        }
        ...
        shake->unk14 = (shake->unk14 + shake->p2) & (1024 - 1);
    }
}
