# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/conveyor_belt_object.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/conveyor_belt_object.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/conveyor_belt_object.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/conveyor_belt_object.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/conveyor_belt_object.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/conveyor_belt_object.c" 2
...
void CreateEntity_ConveyorBeltObject(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    ConveyorBeltObject *belt = (void *)((t)->data);
    Sprite *s = &belt->s;
    ...
    if ((gCurrentLevel & 0x1) != 0) {
        if (me->d.sData[0] == 0) {
            s->graphics.dest = VramMalloc(((96 / 8) * (24 / 8)));
            s->graphics.anim = 604;
            s->variant = 0;
            ...
            s->graphics.dest = VramMalloc(((72 / 8) * (24 / 8)));
            s->graphics.anim = 603;
            s->variant = 0;
...
void Task_ConveyorBeltObject(void)
{
    ConveyorBeltObject *belt = (void *)((gCurTask)->data);
    Sprite *s = &belt->s;
    MapEntity *me = belt->base.me;
    s16 worldX, worldY;

    worldX = ((belt->base.meX)*8 + (belt->base.regionX)*256);
    worldY = ((me->y)*8 + (belt->base.regionY)*256);
