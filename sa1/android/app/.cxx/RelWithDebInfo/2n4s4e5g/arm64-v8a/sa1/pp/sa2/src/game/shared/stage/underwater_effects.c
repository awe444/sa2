# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/underwater_effects.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/underwater_effects.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/underwater_effects.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/underwater_effects.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/underwater_effects.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/underwater_effects.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/underwater_effects.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/underwater_effects.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/underwater_effects.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/underwater_effects.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/underwater_effects.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/underwater_effects.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/underwater_effects.c" 2
...
{
    MultiplayerSpriteTask *ts = (void *)((gCurTask)->data);
    Sprite *s = &ts->s;
    SpriteTransform *transform = &ts->transform;

    s32 r2;

    transform->x = ((int)((ts->x) >> 8));
    transform->y = ((int)((ts->y) >> 8));

    r2 = ((ts->unk10 + 1) << 3);
    r2 = (((r2) < (0x100)) ? (r2) : (0x100));
    ...
    if ((transform->x < -32 || transform->x > 320 + 32) || (transform->y < -32 || transform->y > 240 + 32)
        || (ts->unk10 > 0x80)) {
        TaskDestroy(gCurTask);
        return;
    } else if (ts->unk10 <= 0x40) {
        ts->y += (-((int)(((gSineTable[(ts->unk10 * 4) + 256])) >> 6)) * ts->unkA) >> 8;
    }
...
struct Task *SpawnDrowningCountdownNum(Player *p, s32 countdown)
{
    ...
    ts->x = p->qWorldX - ((s32)((cam->x)*256));
    ts->y = p->qWorldY - ((s32)((cam->y)*256));
    ts->unk8 = 0;
    ts->unkA = 0x120;
    ts->unk10 = 0;
...
struct Task *SpawnAirBubbles(s32 x, s32 y, s32 p2, s32 p3)
{
    if ((s8)gSmallAirBubbleCount > 11) {
        ...
        if (p3 == 0) {
            ...
            ts->unk14 = (((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x30000) >> 16);
        }
...
bool32 RandomlySpawnAirBubbles(Player *p)
{
    ...
    if ((gStageTime % 8u) == 0) {
        rand = ((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x300);
        if (!rand) {
            randX = (((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0xF00) >> 8);
            randY = (((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0xF00) >> 8) - 8;

            if (!(p->moveState & 0x00000001))
                randX = -randX;

            SpawnAirBubbles(p->qWorldX - randX, p->qWorldY - randY, p->qSpeedAirX, ((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x100) >> 8);
...
static void Task_SpawnAirBubbles(void)
{
    ...
    r1 += (gSineTable[((unk10 & 0xFF) * 4)]) >> 4;
    {
        struct Camera *cam = &gCamera;
        transform->x = ((int)((r1) >> 8)) - cam->x;
        transform->y = ((int)((r4) >> 8)) - cam->y;
    }
    ...
    if ((transform->x < -32 || transform->x > 320 + 32) || (transform->y < -32 || transform->y > 240 + 32)
        ...
        || (gWater.currentWaterLevel < 0) || (((int)((r4) >> 8)) - 3 < gWater.currentWaterLevel) || (ts->unk10 > 0x1E0)) {
        TaskDestroy(gCurTask);
        return;
    } else {
        ts->x += ts->unk8;
...
{
    DrownBubbles *db = (void *)((gCurTask)->data);
    Player *p = db->p;
    ...
    if ((!((p)->moveState & 0x00000080))) {
        ...
        if ((({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x300) == 0) {
            s32 r4 = ((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x100) >> 8;

            do {

                u32 r3, r2, r1 = ((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x7FF00) >> 8;
                r1 -= 0x400;

                r2 = ((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x7FF00) >> 8;
                r2 -= 0x400;

                r3 = ((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x100) >> 8;
...
struct Task *SpawnBubblesAfterDrowning(Player *p)
{
    struct Task *t = TaskCreate(Task_SpawnBubblesAfterDrowning, sizeof(Player **), 0x4001, 0, ((void*)0));

    DrownBubbles *db = (void *)((t)->data);
    db->p = p;
