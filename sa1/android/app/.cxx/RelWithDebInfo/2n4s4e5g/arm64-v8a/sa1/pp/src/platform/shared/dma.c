# 1 "/home/awaszczak/git/sa2/sa1/src/platform/shared/dma.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/src/platform/shared/dma.c" 2
# 1 "/home/awaszczak/Android/Sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/stdio.h" 1 3 4
# 41 "/home/awaszczak/Android/Sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/stdio.h" 3 4
...
# 42 "/home/awaszczak/Android/Sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/stdio.h" 2 3 4
...
# 2 "/home/awaszczak/git/sa2/sa1/src/platform/shared/dma.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/src/platform/shared/dma.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/include/platform/shared/dma.h" 1
...
# 4 "/home/awaszczak/git/sa2/sa1/src/platform/shared/dma.c" 2
...
void RunDMAs(u32 type)
{
    for (int dmaNum = 0; dmaNum < 4; dmaNum++) {
        ...
        u32 dmaCntReg = (&(*(reg_u32 *)(REG_BASE + ((((((((((((0x40 + sizeof(winreg_t) * 6) + 4) + 2) + 2) + 2 + 10 + 0x50 + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)))))[dmaNum];
...
{
    if (dmaNum >= 4) {
        fprintf((&__sF[2]), "DmaSet with invalid DMA number: dmaNum=%d, src=%p, dest=%p, control=%d\n", dmaNum, src, dest, control);
        return;
    }
# 97 "/home/awaszczak/git/sa2/sa1/src/platform/shared/dma.c"
    ...
    (&(*(reg_u32 *)(REG_BASE + ((((((((((((0x40 + sizeof(winreg_t) * 6) + 4) + 2) + 2) + 2 + 10 + 0x50 + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)))))[dmaNum] = (size_t)control;
...
void DmaStop(int dmaNum)
{
    ...
    (&(*(reg_u32 *)(REG_BASE + ((((((((((((0x40 + sizeof(winreg_t) * 6) + 4) + 2) + 2) + 2 + 10 + 0x50 + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)))))[dmaNum] &= ~((0x8000 | 0x3000 | 0x0800 | 0x0200) << 16);
...
{
    vu32 *ctrlRegs = &(*(reg_u32 *)(REG_BASE + ((((((((((((0x40 + sizeof(winreg_t) * 6) + 4) + 2) + 2) + 2 + 10 + 0x50 + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t))));
