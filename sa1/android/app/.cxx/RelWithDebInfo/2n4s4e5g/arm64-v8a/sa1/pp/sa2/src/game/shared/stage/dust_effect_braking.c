# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_braking.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_braking.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_braking.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_braking.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_braking.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_braking.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_braking.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_braking.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_braking.c" 2





DustEffectBraking __attribute__((aligned(8))) gDustEffectBrakingTask = {};
...
# 32 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_braking.c"
struct Task *CreateBrakingDustEffect(s32 x, s32 y)
{
    if (gDustEffectBrakingTask.t == ((void*)0) || gDustEffectBrakingTask.unk0 == 0) {
        return ((void*)0);
    } else {
        struct Task *t;
        BrakeDustEffect *bde;
        ...
        t = TaskCreate(Task_BrakingDustEffect, sizeof(BrakeDustEffect), 0x4001, 0, ((void*)0));
        ...
        s = &bde->s;
        p = &gPlayer;
# 63 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_braking.c"
        {
            s->graphics.dest = ((void *)&VRAM[0x10000] + 0x2100);
            ...
            s->frameFlags |= ((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & (((1) << (11)) | ((1) << (10))));
        }
# 91 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_braking.c"
        return t;
    }
}
...
void Task_BrakingDustEffect(void)
{
    ...
    BrakeDustEffect *bde = (void *)((gCurTask)->data);
    Sprite *s = &bde->s;

    if (unk->t == 0 || (s->frameFlags & ((1) << (14)))) {
        unk->unk0++;
...
void CreateBrakingDustEffectRelatedTask(void)
{
    if (gDustEffectBrakingTask.t == ((void*)0)) {
...
void TaskDestructor_BrakingDustEffectRelated(struct Task *t) { gDustEffectBrakingTask.t = ((void*)0); }
