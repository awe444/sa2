# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/carousel.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/carousel.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/carousel.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/carousel.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/carousel.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/carousel.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/carousel.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/carousel.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/carousel.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/carousel.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/carousel.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/carousel.c" 2
...
void CreateEntity_Carousel(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
...

    {
        ...
        s1->x = ((me->x)*8 + (regionX)*256);
        s1->y = ((me->y)*8 + (regionY)*256);

        { s32 negativeTwo; s16 forMatching; negativeTwo = (-2); forMatching = negativeTwo; me->x = forMatching; };

        s1->graphics.dest = VramMalloc(((96 / 8) * (40 / 8)));
        s1->oamFlags = ((18) << 6);
        s1->graphics.size = 0;
        s1->graphics.anim = 487;
        s1->variant = 0;
        s1->animCursor = 0;
        s1->qAnimDelay = ((s32)((0)*256));
        s1->prevVariant = -1;
        s1->animSpeed = ((int)((float)(1.0)*0x10));
        s1->palId = 0;
    ...
    {
        s2->graphics.dest = VramMalloc(((16 / 8) * (40 / 8)));
        s2->graphics.anim = 583;
        s2->variant = 0;
        s2->oamFlags = ((18) << 6);
        s2->graphics.size = 0;
        s2->animCursor = 0;
        s2->qAnimDelay = ((s32)((0)*256));
        s2->prevVariant = -1;
...
void Task_CarouselIdle(void)
{
    Carousel *carousel = (void *)((gCurTask)->data);
    Sprite *s1 = &carousel->s1;
    Sprite *s2 = &carousel->s2;
    CamCoord worldX, worldY;
    ...
    worldX = ((carousel->base.meX)*8 + (carousel->base.regionX)*256);
    worldY = ((me->y)*8 + (carousel->base.regionY)*256);
    ...
    if (((worldX) > gCamera.x + (320 + (256 / 2)) || (worldX) < gCamera.x - (256 / 2) || (worldY) > gCamera.y + ((240) + ((256) / 2)) || (worldY) < gCamera.y - (256 / 2)) && (((u16)(s1->x + (256 / 2)) > 320 + 256) || (s1->y + (256 / 2) < 0) || (s1->y > 240 + (256 / 2)))) {

        { me->x = carousel->base.meX; };
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            if ((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_KNUCKLES) {
                ...
                if (((*(((i) != 0) ? &gPartner : &gPlayer)).charState == 70) || ((*(((i) != 0) ? &gPartner : &gPlayer)).charState == 71) || ((*(((i) != 0) ? &gPartner : &gPlayer)).charState == 72)
                    || ((*(((i) != 0) ? &gPartner : &gPlayer)).charState == 73) || ((*(((i) != 0) ? &gPartner : &gPlayer)).charState == 74)
                    || ((*(((i) != 0) ? &gPartner : &gPlayer)).charState == 75)) {
                    continue;
                }
            }


            Coll_Player_PlatformCrumbling(s1, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)));

            if ((worldX - 8 <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldX + 8 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldY - 48 <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))
                && (worldY + 12 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) {

                s32 tempX;
                (carousel->unk79) |= (1 << (i));

                carousel->unk6E = (((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX) < 0 ? -((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX) : ((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX)) << 2;

                carousel->unk6C = (({((0x60) != 0) ? ((s32)(((s32)((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) - worldX + 48)*256)) << 1) / (s32)(0x60)) : 0;}) < 0)
                    ? (0x300 - ({((0x60) != 0) ? ((s32)(((s32)((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) - worldX + 48)*256)) << 1) / (s32)(0x60)) : 0;})) & 0x3FF
                    : (0x300 + ({((0x60) != 0) ? ((s32)(((s32)((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) - worldX + 48)*256)) << 1) / (s32)(0x60)) : 0;})) & 0x3FF;
                ...
                if ((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround > ((s32)((0)*256))) {
                    carousel->unk78 = 1;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = +((s32)((7.5)*256));
                } else {
                ...
                (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 33;
...
void Task_RidingCarousel(void)
{
    ...
    do {
        ...
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080) && (((carousel->unk79) >> (i)) & 1)) {

            (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = ((s32)((worldX)*256));
            (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((worldY + (carousel->unk70 >> 13))*256));
        }

        if (!(((carousel->unk79) >> (i)) & 1)) {

            s32 yVal = worldY + ((carousel->unk70 << 3) >> 16);
            u32 res = Coll_Player_PlatformCrumbling(s1, worldX, yVal, &(*(((i) != 0) ? &gPartner : &gPlayer)));
            if ((res & 0x00000008) && !(((carousel->unk79) >> (i)) & 1)) {
                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((yVal)*256));
            } else {


                if (!Coll_Player_Entity_Intersection(s1, worldX, yVal, &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                    if (!(((carousel->unk79) >> (i)) & 1)) {
    ...
    if (carousel->unk70 >= 0x3C2A58) {
        ...
        do {
            ...
            if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
                if ((((carousel->unk79) >> (i)) & 1)) {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = ({((3) != 0) ? ((s32)((((carousel->unk6E >> 2) - 0x7D0) << 1)) / (s32)(3)) : 0;});
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = ({((3) != 0) ? ((s32)((((carousel->unk6E >> 2) - 0x7D0) << 1)) / (s32)(3)) : 0;});
                }
            }
        } while (++i < gNumSingleplayerCharacters);
    } else {
    ...
    s1->animSpeed = ({((0xA000) != 0) ? ((s32)(carousel->unk6E * 35) / (s32)(0xA000)) : 0;});

    if (s1->animSpeed > ((int)((float)(1.0)*0x10))) {
        s1->animSpeed = ((int)((float)(1.0)*0x10));
    }
    ...
    do {
        ...
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080) && (((carousel->unk79) >> (i)) & 1)) {
            if (carousel->unk70 >= 0x3C2A58) {
                ...
                if (carousel->unk76 >= 300 || (*(((i) != 0) ? &gPartner : &gPlayer)).heldInput & (0x0020 | 0x0010)) {

                    s32 qSpeed;
                    carousel->unk76 = 300;

                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).heldInput & 0x0020) {
                        if ((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround > 0) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround *= -1;
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround;
                        } else {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround;
                        }
                    }
                    ...
                    }
                    {
                        ...
                        (*(((i) != 0) ? &gPartner : &gPlayer)).itemEffect &= ~0x80;
                        {
                            PlayerSpriteInfo **psi = &(*(((i) != 0) ? &gPartner : &gPlayer)).spriteInfoBody;
                            (*psi)->s.oamFlags = ((16) << 6);
                        }
                    }
                }
            }
        } else if ((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080) {
    ...
    if (carousel->unk6E < ((s32)((50)*256))) {
        if (carousel->unk6E != ((s32)((0)*256))) {
            if (({((25) != 0) ? ((s32)(carousel->unk74) % (s32)(25)) : 0;}) == 0) {
                m4aSongNumStart(209);
            }
        }
    } else if (carousel->unk6E < ((s32)((75)*256))) {
        if (({((16) != 0) ? ((s32)(carousel->unk74) % (s32)(16)) : 0;}) == 0) {
            m4aSongNumStart(210);
        }
    } else {
        if (({((8) != 0) ? ((s32)(carousel->unk74) % (s32)(8)) : 0;}) == 0) {
            m4aSongNumStart(211);
        }
    }
...
void Task_ExitCarousel(void)
{
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            Coll_Player_PlatformCrumbling(s1, worldX, worldY + (carousel->unk70 >> 13), &(*(((i) != 0) ? &gPartner : &gPlayer)));
        }
    } while (++i < gNumSingleplayerCharacters);
