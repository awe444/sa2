# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/air_bubbles.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/air_bubbles.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/air_bubbles.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/air_bubbles.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/air_bubbles.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/air_bubbles.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/air_bubbles.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/air_bubbles.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/air_bubbles.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/air_bubbles.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/air_bubbles.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/air_bubbles.c" 2
...
void CreateEntity_AirBubbles(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    AirBubbles *bubbles = (void *)((t)->data);
    Sprite *s = &bubbles->s;
...
void Task_AirBubbles(void)
{
    AirBubbles *bubbles = (void *)((gCurTask)->data);
    Sprite *s = &bubbles->s;
    MapEntity *me = bubbles->base.me;
    CamCoord worldX, worldY;

    worldX = ((bubbles->base.meX)*8 + (bubbles->base.regionX)*256);
    worldY = ((me->y)*8 + (bubbles->base.regionY)*256);
    ...
    if (--bubbles->unk3E == 0) {
        ...
        bubbles->unk40 = ((bubbles->unk40 + 1) % (sizeof(gUnknown_086CEE60) / sizeof((gUnknown_086CEE60)[0])));
    }

    if (--bubbles->unk3C == 0) {
        sub_80914F8(worldX, (worldY - 4), (bubbles->unk3E >> 3) + gStageTime);
        bubbles->unk3C = ({((2) != 0) ? ((s32)(gUnknown_086CEE60[gStageTime % (sizeof(gUnknown_086CEE60) / sizeof((gUnknown_086CEE60)[0]))]) / (s32)(2)) : 0;});
    }

    if ((((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
        { me->x = bubbles->base.meX; };
...
void CreateBubbleContainingAir(CamCoord worldX, CamCoord worldY, u8 param2)
{
    ...
    AirBubbleBig *bubbles = (void *)((t)->data);
    Sprite *s = &bubbles->s;
    MapEntity *me = bubbles->base.me;
    ...
    s->graphics.dest = VramMalloc(((24 / 8) * (24 / 8)));
    s->graphics.anim = 532;
    s->variant = 0;
    s->oamFlags = ((15) << 6);
    s->graphics.size = 0;
...
void Task_BubbleContainingAir(void)
{
    AirBubbleBig *bubbles = (void *)((gCurTask)->data);
    Sprite *s = &bubbles->s;

    s->x = bubbles->worldX - gCamera.x + ((gSineTable[((bubbles->unk3E * 3) & (1024 - 1))]) >> 11);
    s->y = bubbles->worldY - gCamera.y - (bubbles->unk3E >> 1);

    if ((((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2))) || (gWater.currentWaterLevel < 0)
    ...
    if ((bubbles->unk3C == 4) && (bubbles->unk3E >= 80)) {
        ...
        i = 0;
        do {
            if (Coll_Player_Entity_Intersection(s, s->x + gCamera.x, s->y + gCamera.y, &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 27;


                if ((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000004) {
                    ...
                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000002) {
                        ...
                        { (&(*(((i) != 0) ? &gPartner : &gPlayer)))->spriteOffsetX = 6; (&(*(((i) != 0) ? &gPartner : &gPlayer)))->spriteOffsetY = 14; };
                    } else {
                ...
                (*(((i) != 0) ? &gPartner : &gPlayer)).framesUntilDrownCountDecrement = 60;
                (*(((i) != 0) ? &gPartner : &gPlayer)).secondsUntilDrown = 30;

                if ((*(((i) != 0) ? &gPartner : &gPlayer)).playerID == 0) {
                    m4aSongNumStop(27);
                }
                m4aSongNumStart(191);
...
void Task_809141C(void)
{
    ...
    if ((((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2))) || (--bubbles->unk3D < 0) || (gWater.currentWaterLevel < 0)
        || (bubbles->worldY - (bubbles->unk3E >> 1) < gWater.currentWaterLevel)) {
        TaskDestroy(gCurTask);
        return;
    }
...
void sub_80914F8(CamCoord worldX, CamCoord worldY, u8 param2)
{
    ...
    if (param2 & 0x1) {
        s->graphics.dest = (void *)(&VRAM[0x10000] + 0x2AA0);
        s->graphics.anim = 754;
        s->variant = 0;
    } else {
        s->graphics.dest = (void *)(&VRAM[0x10000] + 0x2A20);
        s->graphics.anim = 753;
        s->variant = 0;
    }
...
void Task_80915F0(void)
{
    ...
    s->x = bubbles->worldX - gCamera.x + ((gSineTable[((bubbles->unk3E * 3) & (1024 - 1))]) >> 11) + bubbles->unk3C;
    s->y = bubbles->worldY - gCamera.y - (bubbles->unk3E >> 1);
