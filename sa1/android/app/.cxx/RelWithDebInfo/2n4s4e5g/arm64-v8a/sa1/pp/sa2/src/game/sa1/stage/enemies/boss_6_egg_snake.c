# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_6_egg_snake.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_6_egg_snake.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_6_egg_snake.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_6_egg_snake.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_6_egg_snake.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_6_egg_snake.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_6_egg_snake.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_6_egg_snake.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_6_egg_snake.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_6_egg_snake.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_6_egg_snake.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_6_egg_snake.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_6_egg_snake.c" 2
...
PlayerSpeedState sPlayerSpeedState;
...
{
    EggSnake *boss = (void *)((gCurTask)->data);
    Sprite *s = &boss->s;
    Sprite *s2 = &boss->s2;
...
void sub_8031ED0(void)
{
    ...
    if (boss->unk9C != 0) {
        if ((--boss->unk9C > 0x10) && !(boss->unk9C & 2) && (!(gPlayer.moveState & 0x00000080))) {
            s->frameFlags |= 0x100;
            gDispCnt |= 0x8000;
            gWinRegs[5] = 0x3F1F;
...

{
    ...
    boss = (void *)((TaskCreate(Task_EggSnakeInit, sizeof(EggSnake), 0x2100U, 0U, TaskDestructor_8034208))->data);
    s = &boss->s;
    ...
    s2 = &boss->s2;
    s2->x = ((me->x)*8 + (regionX)*256);
    s2->y = ((me->y)*8 + (regionY)*256);
    { s32 negativeTwo; s16 forMatching; negativeTwo = (-2); forMatching = negativeTwo; me->x = forMatching; };
    ...
    Bosses_SetCamBounds(s->y - (240 - 32), s->y + 32, s->x - 144, s->x + 176);

}



void Task_EggSnakeInit()
{
    MapEntity *me;
    Sprite *s2;
    s32 var_r2;
    ...
    worldX = ((boss->base.meX)*8 + (boss->base.regionX)*256) + ((int)((boss->qUnk78) >> 8)) + var_r2;
    temp_r2 = (var_r2 + 0x90);
    if (temp_r2 >= 0) {
        var_r2 = temp_r2 + 0x1F;
    } else {
    ...
    worldY += ((me->y)*8 + (boss->base.regionY)*256) + ((int)((boss->qUnk7C) >> 8));
...
void Task_8032370()
{
    ...
    strc60 = (void *)((boss->t)->data);
    boss->unkA2 += boss->unkA4;
    boss->unkA0 = (boss->unkA0 - ((int)((boss->unkA2) >> 8)));
    boss->unkA0 &= 0x3FF;
    temp_r7 = gSineTable[boss->unkA0];
    temp_r7 = (s32)(temp_r7 * 15) >> 11;
    worldX = (((boss->base.meX)*8 + (boss->base.regionX)*256) + ((int)((boss->qUnk78) >> 8)) + temp_r7);
    ...
    worldY = temp_r2_3 + (((me->y)*8 + (boss->base.regionY)*256) + ((int)((boss->qUnk7C) >> 8)));
    boss->unk90 = temp_r7;
    ...
    if (boss->unk9A > 7) {
        ...
        switch (boss->unkA9) {
            ...
            case 1:
                ...
                s->prevVariant = -1;
                boss->unkAA = 0;
                boss->unk98 = gUnknown_084ACF08[(({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) + gStageTime) & 3];
...
void sub_80327C4()
{
    ...
    boss->qUnk78 += ((s32)((boss->unk90)*256));
    boss->qUnk7C += ((s32)((boss->unk92)*256));
    worldX = ((boss->base.meX)*8 + (boss->base.regionX)*256) + ((int)((boss->qUnk78) >> 8));
    worldY = ((me->y)*8 + (boss->base.regionY)*256) + ((int)((boss->qUnk7C) >> 8));
    boss->s2.variant = 2;
    boss->qUnk9E = -0x80;
    ...
    {
        proj = (void *)((sub_80168F0(worldX, worldY, 4U, 661, 0U))->data);
        proj->qUnk46 = -((s32)((2)*256));
        proj->unk48 = 0;
        proj->unk42 = 0x100;
    ...
    {
        proj = (void *)((sub_80168F0(worldX + 16, worldY + 16, 4U, 661, 0U))->data);
        proj->qUnk46 = -((s32)((2)*256));
        proj->unk48 = 0;
        proj->unk42 = 0x200;
        if (s->frameFlags & 0x400) {
    ...
    CreatePreBossCameraPan(gCamera.maxY - 240, gCamera.maxY + 240);
    gStageFlags |= 3;
...
void Task_8032AF8(void)
{
    ...
    if ((boss->unk98 & 0x7) == 0) {
        ...
        bolts->qUnk34 = ((s32)((worldY + 32)*256));
        sprBolts->frameFlags = ((2) << (12));
        sprBolts->oamFlags = ((17) << 6);
...
void sub_8032D44(void)
{
    ...
    me = boss->base.me;
    if (--boss->unk98 == 0) {
        EggSnakeSegmentManager *strc60 = (void *)((boss->t)->data);
        strc60->unk58 = -1;
        gPlayer.moveState &= ~8;
        gCamera.maxY = 2208 + 240;
        gMusicManagerState.unk1 = 0x33;
        boss->unk94 = ((boss->base.meX)*8 + (boss->base.regionX)*256) + ((int)((boss->qUnk78) >> 8));
        boss->unk96 = ((me->y)*8 + (boss->base.regionY)*256) + ((int)((boss->qUnk7C) >> 8));
        boss->qUnk78 = 0;
        boss->qUnk7C = 0;
        boss->unk80 = 0;
        boss->unk84 = -0x80;
        ...
        CamCoord worldX = ((boss->base.meX)*8 + (boss->base.regionX)*256) + ((int)((boss->qUnk78) >> 8));
        CamCoord worldY = ((me->y)*8 + (boss->base.regionY)*256) + ((int)((boss->qUnk7C) >> 8));
        s->x = worldX - gCamera.x;
        s->y = worldY - gCamera.y;
...
void sub_8032F58(void)
{
    ...
    worldX = ((int)((boss->qUnk78) >> 8)) + boss->unk94;
    worldY = ((int)((boss->qUnk7C) >> 8)) + boss->unk96;
    ...
    switch (boss->unkA9) {
        case 0:
            if (!(0xA & gPlayer.moveState)) {
                if (!(gPlayer.moveState & 0x200000)) {
                    ...
                    if (worldX > ((int)((gPlayer.qWorldX) >> 8))) {
                        gPlayer.heldInput = 0x0010;
                    } else {
                        gPlayer.heldInput = 0x0020;
                    }
            ...
            if (boss->qUnk7C < -((s32)((90)*256))) {
                boss->qUnk7C = -((s32)((90)*256));
                boss->unk84 = 0;
            }
        ...
        case 4:
            if (((int)((gPlayer.qWorldX) >> 8)) < (worldX - 0x60)) {
                gPlayer.heldInput = 0x0010;
            }

            if ((float)((int)((gPlayer.qWorldX) >> 8)) > ((float)gCamera.x + (float)(320 + 120))) {
            ...
            if ((float)(worldX - gCamera.x) > (float)(320 + 120)) {
                boss->unkA9++;
                boss->unk98 = 0xB4;
        ...
        case 5:
            if (((int)((gPlayer.qWorldX) >> 8)) < (worldX - 96)) {
                gPlayer.heldInput = 0x0010;
            }
...
void sub_803330C()
{
    ...
    EggSnakeProjectile *proj = (void *)((t)->data);
    Sprite *s;
    Sprite *s2;
    void *vram;
...
{
    EggSnakeProjectile *proj = (void *)((gCurTask)->data);
    Sprite *sprStrc = &proj->s;
    EggSnake *boss = (void *)(((struct Task *)((gCurTask)->parent))->data);
    Sprite *s2 = &boss->s;
    s16 x, y;
...
void CreateProjectile()
{
    ...
    EggSnake *boss;
    EggSnakeProjectile *newProj = (void *)((gCurTask)->data);
    MapEntity *me;

    newProj = (void *)((TaskCreate(Task_8033730, sizeof(EggSnakeProjectile), 0x2300U, 0U, TaskDestructor_8034224))->data);
    boss = (void *)(((struct Task *)((gCurTask)->parent))->data);
    me = boss->base.me;
    newProj->originX = ((boss->base.meX)*8 + (boss->base.regionX)*256);
    newProj->originY = ((me->y)*8 + (boss->base.regionY)*256);
    newProj->unk64 = ((s32)((boss->unk90 + 16)*256));
    newProj->unk68 = ((s32)((boss->unk92)*256));
    temp_r3 = ((int)((gPlayer.qWorldX) >> 8)) - (newProj->originX + ((int)((newProj->unk64) >> 8)));
    temp_r1 = ((int)((gPlayer.qWorldY) >> 8)) - (newProj->originY + ((int)((newProj->unk68) >> 8)));
    angle = sa2__sub_8004418(temp_r1 / 2, temp_r3 / 2);
    newProj->unk6C = ((int)(((gSineTable[(angle) + 256])) >> 6));
    newProj->unk6E = ((int)(((gSineTable[(angle)])) >> 6));
    newProj->s.x = 0;
    newProj->s.y = 0;
    newProj->s.graphics.dest = VramMalloc(((16 / 8) * (16 / 8)));
    newProj->s.oamFlags = 0x3C0;
    newProj->s.graphics.size = 0;
    newProj->s.graphics.anim = 664;
    newProj->s.variant = 0;
...
{
    EggSnakeProjectile *proj = (void *)((gCurTask)->data);
    EggSnakeProjectile *prevProj = (void *)(((struct Task *)((gCurTask)->parent))->data);
    EggSnake *boss = (void *)(((struct Task *)(((struct Task *)((gCurTask)->parent))->parent))->data);
    Sprite *s = &proj->s;
    CamCoord worldX, worldY;
    s32 bossAnim;
    ...
    worldX = proj->originX + ((int)((proj->unk64) >> 8));
    worldY = proj->originY + ((int)((proj->unk68) >> 8));
    s->x = worldX - gCamera.x;
    s->y = worldY - gCamera.y;

    if ((s->y < -32) || (s->y > (240 + 16))) {
        if (proj->unk6C >= 0) {
            if (s->x > (320 + 16)) {
                TaskDestroy(gCurTask);
                return;
...
void Task_8033924()
{
    EggSnakeSegmentManager *mgr = (void *)((gCurTask)->data);
    Sprite *s = &mgr->s;
    mgr->unk54 = 0;
    mgr->unk57 = 0;
    mgr->unk55 = 0;
    ...
    { u16 tmp = (u16)(0); DmaSet(3, &tmp, gUnknown_03005870, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((sizeof(gUnknown_03005870))/(16/8)))); };
    UpdateSpriteAnimation(s);
...
void sub_80339BC(EggSnakeSegmentManager *mgr)
{
    ...
    for (i = 0; i < 9; i++) {
        mgr->tasks[i] = TaskCreate(Task_8034098, sizeof(EggSnakeSegment), (i + 0x2001), 0U, ((void*)0));
        segment = (void *)((mgr->tasks[i])->data);
        segment->unk30 = ((boss->base.meX)*8 + (boss->base.regionX)*256);
        segment->unk32 = ((me->y)*8 + (boss->base.regionY)*256);
...
void Task_8033AA0(void)
{
    ...
    standOnIndex = 0;
    mgr = (void *)((gCurTask)->data);
    sp0 = 0;

    DmaSet(3, gUnknown_03005870, gUnknown_03005890, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(gUnknown_03005890))/(16/8))));
    mgr->unk5E++;
    if (mgr->unk58 == 0) {
        for (i = 0; i < 9; i++) {
            segment = (void *)((mgr->tasks[i])->data);
            sprSegment = &segment->s;
            worldX = (segment->unk30 + ((int)((segment->unk38) >> 8)));
            worldY = (segment->unk32 + ((int)((segment->unk3C) >> 8))) + gUnknown_03005870[i];
    ...
    } else if (!(gPlayer.moveState & (0x00000008 | 0x00000002))) {
        TaskDestroy(gCurTask);
    ...
    if (sp0 != 0) {
        ...
        if ((sPlayerSpeedState.moveState & 2) && (sPlayerSpeedState.qSpeedAirY > ((s32)((4)*256)))) {
            mgr->unk54 = 2;
            ...
            for (i = 0; i < 9; i++) {
                if (i == standOnIndex) {
                    mgr->unk5C = ((int)((sPlayerSpeedState.qSpeedAirY) >> 8));
        ...
        gPlayer.qWorldY += ((s32)((1)*256)) + ((s32)((gUnknown_03005870[standOnIndex] - gUnknown_03005890[standOnIndex])*256));
    } else {
        if (mgr->unk54 == 2) {
    ...
    if ((gNumSingleplayerCharacters == 2) && (mgr->unk58 == 0)) {
        for (i = 0; i < 9; i++) {
            segment = (void *)((mgr->tasks[i])->data);
            sprSegment = &segment->s;
            worldX = (((int)((segment->unk38) >> 8)) + segment->unk30);
            worldY = ((int)((segment->unk3C) >> 8)) + segment->unk32 + gUnknown_03005870[i];
...
void Task_8034098(void)
{
    ...
    segment = (void *)((gCurTask)->data);
    mgr = (void *)(((struct Task *)((gCurTask)->parent))->data);
    s = &mgr->s;
    dimensions = s->dimensions;
    worldX = (((int)((segment->unk38) >> 8)) + segment->unk30);
    worldY = (((int)((segment->unk3C) >> 8)) + segment->unk32) + gUnknown_03005870[segment->unk52];
    ...
    if ((mgr->unk58 == 0) || !(1 & mgr->unk5E)) {
        if ((segment->unk52 == 0) || (s->oamBaseIndex == 0xFF)) {
            ...
            if (iwram_end != oamAllocated) {
                DmaSet(3, oamData, oamAllocated, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(OamDataShort))/(16/8))));
...
void TaskDestructor_8034238(struct Task *t)
{
    EggSnakeSegmentManager *mgr = (void *)((t)->data);
