# 1 "/home/awaszczak/git/sa2/sa1/../src/lib/agb_flash/agb_flash_le_512k.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/lib/agb_flash/agb_flash_le_512k.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/lib/agb_flash/agb_flash_le_512k.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/lib/agb_flash/agb_flash_le_512k.c" 2
...
u16 EraseFlashChip_LE(void)
{
    ...
    (*(reg_u16 *)(REG_BASE + 0x204)) = ((*(reg_u16 *)(REG_BASE + 0x204)) & ~(3 << 0)) | gFlash->wait[0];
...
u16 ProgramFlashSector_LE(u16 sectorNum, void *src)
{
    ...
    if (sectorNum > 15)
        return 0x80FF;
# 140 "/home/awaszczak/git/sa2/sa1/../src/lib/agb_flash/agb_flash_le_512k.c"
