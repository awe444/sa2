# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_recv_mgr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_recv_mgr.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_recv_mgr.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_recv_mgr.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_recv_mgr.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_recv_mgr.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_recv_mgr.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_recv_mgr.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_recv_mgr.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_recv_mgr.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_recv_mgr.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_recv_mgr.c" 2
...
{
    if (gEntitiesManagerTask != ((void*)0)) {
        EntitiesManager *em = (void *)((gEntitiesManagerTask)->data);
        ...
        if (offset != 0) {
            ...
            if ((msioData->pat4.unk12 == 0) || ((msioData->pat4.unk12 == 1) && ((s8)cursor->x == (-2)))) {
                *(s8 *)(&cursor->x) = (-3);
            }
        }
    }
...
void ReceiveRoomEvent_ItemBoxBreak(union MultiSioData *msioData, u8 __attribute__((unused)) someId)
{
    if (gEntitiesManagerTask != ((void*)0)) {
        EntitiesManager *em = (void *)((gEntitiesManagerTask)->data);
...
void ReceiveRoomEvent_EnemyDestroyed(union MultiSioData *msioData, u8 __attribute__((unused)) someId)
{
    if (gEntitiesManagerTask != ((void*)0)) {
        EntitiesManager *em = (void *)((gEntitiesManagerTask)->data);
...
void ReceiveRoomEvent_PlayerRingLoss(union MultiSioData *msioData, u8 __attribute__((unused)) someId)
{
    InitScatteringRings(msioData->pat4.x, msioData->pat4.y, msioData->pat4.numRings);
}

void ReceiveRoomEvent_MysteryItemBoxBreak(union MultiSioData *msioData, u8 __attribute__((unused)) someId)
{
    if (gEntitiesManagerTask != ((void*)0)) {
        EntitiesManager *em = (void *)((gEntitiesManagerTask)->data);
...
void ReceiveRoomEvent_8(union MultiSioData *msioData, u8 __attribute__((unused)) someId)
{
    if (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id == msioData->pat5.sioId) {

        if (msioData->pat5.unk10 != 0) {
            gPlayer.moveState |= 0x00010000;
        } else {
            gPlayer.moveState &= ~0x00010000;
        }
...
{
    Chao *chao = (void *)((gChaoTasks[msioData->pat5.sioId])->data);
    MultiplayerPlayer *mpp;

    chao->playerIdA = msioData->pat5.unk10;
    mpp = (void *)((gMultiplayerPlayerTasks[mppId])->data);
    mpp->unk5C &= ~(0x10000 << msioData->pat5.sioId);

    mpp = (void *)((gMultiplayerPlayerTasks[msioData->pat5.unk10])->data);
    mpp->unk5C |= (0x10000 << msioData->pat5.sioId);
