# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_lobby.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_lobby.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_lobby.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_lobby.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_lobby.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_lobby.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_lobby.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_lobby.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_lobby.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_lobby.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_lobby.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_lobby.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/text.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_lobby.c" 2
...
extern AnimId gUnknown_0868B684[4][2];
extern u8 gUnknown_0868B694[4][2];
...
void CreateTimeAttackLobbyScreen(void)
{
    ...
    for (i = 0; i < (sizeof(lobby->sprites) / sizeof((lobby->sprites)[0])); i++) {
        s = &lobby->sprites[i];
...
static void Task_HandleInput(void)
{
    TimeAttackLobby *lobby = (void *)((gCurTask)->data);
    ...
    if (sub_805423C(temp_r6)) {
        if (gRepeatedKeys & 0x0080) {
            ...
            if (lobby->unk134 < ((sizeof(gUnknown_0868B6C4) / sizeof((gUnknown_0868B6C4)[0])) - 1)) {
                lobby->unk134++;
            } else {
                lobby->unk134 = 0;
            }
            ...
            if (lobby->unk134 != 0) {
                ...
                lobby->unk134 = ((sizeof(gUnknown_0868B6C4) / sizeof((gUnknown_0868B6C4)[0])) - 1);
            }
        }
...
void Task_806A508(void)
{
    ...
    if ((lobby->qUnk12C < ((s32)((240)*256))) && (lobby->unk134 != 3)) {
        lobby->qUnk130 += ((s32)((32. / 256.)*256));
...
void TaskDestructor_806A698(struct Task *t)
{
    TimeAttackLobby *lobby = (void *)((t)->data);
    u8 i;
