# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/gamigami.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/gamigami.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/gamigami.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/gamigami.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/gamigami.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/gamigami.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/gamigami.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/gamigami.c" 2
...
void CreateEntity_GamiGami(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    if (((int)((gPlayer.qWorldX) >> 8)) >= ((gamigami->shared.base.meX)*8 + (gamigami->shared.base.regionX)*256)) {
        gamigami->unk3C = 160;
...
void Task_GamiGamiInit(void)
{
    GamiGami *gamigami = (void *)((gCurTask)->data);
    Sprite *s = &gamigami->shared.s;
    MapEntity *me = gamigami->shared.base.me;
    u8 sp08;
    s32 prevWorldX, prevWorldY, worldX, worldY;

    worldX = ((gamigami->shared.base.meX)*8 + (gamigami->shared.base.regionX)*256);
    worldY = ((me->y)*8 + (gamigami->shared.base.regionY)*256);

    prevWorldX = worldX;
    prevWorldY = worldY;
    gamigami->unk40 += gamigami->unk3C;
    worldX += ({((0x100) != 0) ? ((s32)(gamigami->unk40) / (s32)(0x100)) : 0;});
    ...
    if (gamigami->meData3 != 0) {
        gamigami->unk44 += sa2__sub_801F07C(worldY, worldX, 1, 8, &sp08, sa2__sub_801EE64);
    } else {
        gamigami->unk44 += sa2__sub_801F07C(worldY, worldX, 0, 8, &sp08, sa2__sub_801EE64);
    }

    if (({((0x100) != 0) ? ((s32)(gamigami->unk40) / (s32)(0x100)) : 0;}) <= me->d.sData[0] * 8) {
    ...
    } else if (({((0x100) != 0) ? ((s32)(gamigami->unk40) / (s32)(0x100)) : 0;}) >= (me->d.sData[0] + me->d.uData[2]) * 8) {
        if (gamigami->unk48 & 0x400) {
            gamigami->unk3C = -160;
            gamigami->unk46 = 0;
            gamigami->unk48 &= ~0x400;
...
void CreateGamiGamiProjectiles(CamCoord worldX, CamCoord worldY)
{
    ...
    for (i = 0; i < 2; i++) {
        {
            struct Task *t = TaskCreate(Task_GamiGamiProjectile, sizeof(GamiGamiProjectile), 0x3000, 0, ((void*)0));
            GamiGamiProjectile *proj = (void *)((t)->data);
            Sprite *s = &proj->s;
...
void Task_GamiGamiProjectile(void)
{
    GamiGamiProjectile *proj = (void *)((gCurTask)->data);
    Sprite *s = &proj->s;
    ...
    proj->qUnk38 += ((s32)((40. / 256.)*256));
    s->y += ((int)((proj->qUnk38) >> 8));
    oldWorldX = proj->s.x;
    oldWorldY = proj->s.y;
