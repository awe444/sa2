# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/item_tasks.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/item_tasks.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/item_tasks.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/malloc_vram.h" 1
# 24 "/home/awaszczak/git/sa2/sa1/../include/malloc_vram.h"
void *VramMalloc(u32);
void VramResetHeapState(void);
void VramFree(void *);
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/item_tasks.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/item_tasks.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/item_tasks.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/item_tasks.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/item_tasks.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/item_tasks.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/item_tasks.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/item_tasks.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/item_tasks.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/item_tasks.c" 2
...
# 22 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/item_tasks.c" 2
...
# 24 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/item_tasks.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 25 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/item_tasks.c" 2
...
struct Task *CreateItemTask_Shield_Magnetic(s8 playerID)
{
    ...
    ItemTask *item = (ItemTask *)(void *)((t)->data);

    item->unk30 = playerID;

    {
        ItemTask *item2 = (ItemTask *)(void *)((t)->data);
        Sprite *s = &item2->s;
...
void Task_Item_Shield_Normal(void)
{
    s8 pid = ({ ItemTask *it = (void *)((gCurTask)->data); it->unk30; });
    s32 pid2;

    ItemTask *item = (void *)((gCurTask)->data);
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
        MultiplayerPlayer *mpp = (void *)((gMultiplayerPlayerTasks[pid])->data);
        ...
        item->s.frameFlags &= ~((3) << (12));
        item->s.frameFlags |= mpp->s.frameFlags & ((3) << (12));
    } else

    {

        p = &(*(((pid) != 0) ? &gPartner : &gPlayer));
        itemEffect = (p->itemEffect & (0x01));
        if (!itemEffect)
        ...
        if (!(p->itemEffect & 0x02)) {
            bool32 b;




            item->s.x = (((int)((p->qWorldX) >> 8)) - cam->x) + p->sa2__unk7C;
            item->s.y = (((int)((p->qWorldY) >> 8)) - cam->y);

            item->s.frameFlags &= ~((3) << (12));
            item->s.frameFlags |= p->spriteInfoBody->s.frameFlags & ((3) << (12));
# 270 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/item_tasks.c"
        }
...
# 307 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/item_tasks.c"
void Task_Item_Shield_Magnetic(void)
{
    s8 pid = ({ ItemTask *it = (void *)((gCurTask)->data); it->unk30; });
    s32 pid2;
...
__attribute__((unused)) void Task_802ABC8(void)
{
    ItemTask *item = (void *)((gCurTask)->data);
    s8 pid = ({ ItemTask *it = (void *)((gCurTask)->data); it->unk30; });
    ...
    if (((gGameMode == 0) || (gGameMode == 1))) {
        ...
        Player *p = &(*(((pid) != 0) ? &gPartner : &gPlayer));



        screenX = ((int)((p->qWorldX) >> 8)) + p->sa2__unk7C;
        screenY = ((int)((p->qWorldY) >> 8));

        r2 |= p->spriteInfoBody->s.frameFlags & ((3) << (12));
    }
...
void Task_Item_Invincibility(void)
{
    s32 pid = ({ ItemTask *it = (void *)((gCurTask)->data); it->unk30; });
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
        MultiplayerPlayer *mpp = (void *)((gMultiplayerPlayerTasks[(s8)pid])->data);

        if (mpp->unk57 & 0x02) {
            screenX = mpp->pos.x;
            screenY = mpp->pos.y;
            priority = mpp->s.frameFlags & ((3) << (12));
        } else {
            TaskDestroy(gCurTask);
            return;
        }
        ...
        screenX = ((int)((p->qWorldX) >> 8)) + p->sa2__unk7C;
        screenY = ((int)((p->qWorldY) >> 8));
        priority = p->spriteInfoBody->s.frameFlags & ((3) << (12));
    }
    ...
    if ((gStageTime & 0x7) == 0) {
        ...
        Sprite *sprInvin;
# 502 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/item_tasks.c"
        s16 randA, randB;
        randA = ((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) >> 8) % 16u;
        randB = ((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) >> 8) % 256u;


        t = CreateMultiplayerSpriteTask(screenX + ((int)((((int)(((gSineTable[(randB * 4) + 256])) >> 6)) * randA) >> 8)), screenY + ((int)((((int)(((gSineTable[(randB * 4)])) >> 6)) * randA) >> 8)), 0, 0,
                                        Task_UpdateMpSpriteTaskSprite, TaskDestructor_MultiplayerSpriteTask);
        mpSprite = (void *)((t)->data);
        sprInvin = &mpSprite->s;
        sprInvin->graphics.dest = VramMalloc(((24 / 8) * (24 / 8)));
        sprInvin->graphics.anim = 752;
        sprInvin->variant = 1;
        sprInvin->oamFlags = ((8) << 6);
        sprInvin->frameFlags = ((2) << (12));
    }
...
void Task_Item_Confusion(void)
{
    s8 param = ({ ItemTask *it = (void *)((gCurTask)->data); it->unk30; });
    ItemTask *item = (void *)((gCurTask)->data);
    Sprite *s = &item->s;
    u32 b;
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
        MultiplayerPlayer *mpp = (void *)((gMultiplayerPlayerTasks[param])->data);
        ...
        s->y = mpp->pos.y - cam->y;
        s->frameFlags &= ~((3) << (12));
        s->frameFlags |= mpp->s.frameFlags & ((3) << (12));

        if ((gStageFlags & 0x0080)) {
            s->frameFlags |= 0x00000800;
        } else {
            s->frameFlags &= ~0x00000800;
        }
