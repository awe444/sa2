# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/demo_manager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/demo_manager.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/demo_manager.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/demo_manager.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/demo_manager.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/demo_manager.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/demo_manager.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/demo_manager.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/demo_manager.c" 2
...
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/demo_manager.c" 2
...
# 19 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/demo_manager.c" 2
# 37 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/demo_manager.c"
typedef struct {
               Sprite textPressStart;
               Sprite textDemoPlay;
               u16 fadeBlendFactor;
               u16 tFadeout;
               bool8 playerPressedStart;
...
void CreateDemoManager(void)
{
    ...
    s->graphics.size = 0;
    s->graphics.anim = arr[(&gLoadedSaveGame)->uiLanguage];
    s->variant = 0;
    ...
    s->graphics.dest = VramMalloc(((24 / 8) * (8 / 8)));
    s->graphics.size = 0;
    s->graphics.anim = 721;
    s->variant = 0;
...
void Task_DemoManagerMain(void)
{
    DemoManager *dm = (void *)((gCurTask)->data);

    if (gPhysicalInput & 0x0008) {
        gPlayer.moveState |= 0x00200000;
        gPlayer.heldInput = 0;

        gDestroySpotlights = 1;

        dm->playerPressedStart = 1;
    ...
    } else if (gCheckpointTime > (u32)(int)(((0 * 60.) + 30) * 60)) {
        dm->playerPressedStart = 0;
...

    {
        ...
        if (gBldRegs.bldY != 0) {
            dm->textDemoPlay.frameFlags |= ((1) << (7));
        } else {
            dm->textDemoPlay.frameFlags &= ~((3) << (7));
        }
...
void Task_DemoManagerEndFadeout(void)
{
    DemoManager *dm = (void *)((gCurTask)->data);
    dm->tFadeout++;
# 236 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/demo_manager.c"
    if (dm->tFadeout >= 48) {
...
{
    DemoManager *dm = (void *)((gCurTask)->data);
    dm->fadeBlendFactor += ((s32)((0.25)*256));

    gBldRegs.bldY = dm->fadeBlendFactor >> 8;

    if (dm->fadeBlendFactor >= ((s32)((16.0)*256))) {
