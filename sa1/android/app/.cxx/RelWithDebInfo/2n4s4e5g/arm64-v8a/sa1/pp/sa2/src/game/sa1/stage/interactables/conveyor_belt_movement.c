# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/conveyor_belt_movement.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/conveyor_belt_movement.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/conveyor_belt_movement.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/conveyor_belt_movement.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/conveyor_belt_movement.c" 2
...
void Task_ConveyorBeltMvt(void)
{
    ConveyorBeltMvt *mvt = (void *)((gCurTask)->data);
    CamCoord x, y;
    ...
    x = ((mvt->base.meX)*8 + (mvt->base.regionX)*256);
    y = ((me->y)*8 + (mvt->base.regionY)*256);
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            if ((x <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (x + me->d.uData[2] * 8 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (y <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))
                && (y + me->d.uData[3] * 8 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8))) && !((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000002)) {
                if (mvt->type != 0) {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX += ((s32)(((0.625))*256));
                    ...
                    if (res < 0) {
                        qRes = ((s32)((sa2__sub_801F100(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) + 8, ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)), (*(((i) != 0) ? &gPartner : &gPlayer)).layer, +8, sa2__sub_801EB44))*256));

                        (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX += qRes;
                    }
                } else {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX -= ((s32)(((0.625))*256));
                }

                res = (sa2__sub_801F100(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) - 8, ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)), (*(((i) != 0) ? &gPartner : &gPlayer)).layer, -8, sa2__sub_801EB44));
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            if ((x <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (x + me->d.uData[2] * 8 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (y <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))
                ...
                s32 qSpeed = ({((100) != 0) ? ((s32)((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround * 95) / (s32)(100)) : 0;});
                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = qSpeed;
            }
        }
    } while (++i < gNumSingleplayerCharacters);
...
void CreateEntity_ConveyorBelt(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    if (zone == 3) {
        t = TaskCreate(Task_SlowingSnow, sizeof(ConveyorBeltMvt), 0x2000, 0, ((void*)0));
    } else {
        t = TaskCreate(Task_ConveyorBeltMvt, sizeof(ConveyorBeltMvt), 0x2000, 0, ((void*)0));
    }
