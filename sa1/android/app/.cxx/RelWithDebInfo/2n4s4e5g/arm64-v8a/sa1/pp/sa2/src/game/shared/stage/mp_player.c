# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c" 2
...
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c" 2
...
# 20 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/stage/mp_chao.h" 1
...
# 22 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c" 2
...
# 23 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c" 2
...
# 25 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 26 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 28 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c" 2
# 59 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c"
...
void sa2__sub_8016D20(void);
void sa2__sub_801707C(void);
void sa2__sub_8017670(void);
void sa2__sub_8017C28(void);
void sa2__sub_8017F34(void);
void sa2__sub_8018120(void);
u32 sa2__sub_80181E0(void);
bool32 sa2__sub_8018300(void);
...
void CreateMultiplayerPlayer(u8 id)
{
    ...
    MultiplayerPlayer *mpp = (void *)((t)->data);
    Sprite *s;
    SpriteTransform *tf;
    u16 *p;
    u32 pid;
    ...
    if (id != ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) {
        mpp->unk60 = 30;
    } else {
        mpp->unk60 = 0;
    }
    ...
    if (((gGameMode == 0) || (gGameMode == 1)) || gGameMode == 2 || gGameMode == 3) {
        ...
        u32 pid = ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id;
        mpp->pos.x = gSpawnPositions_Modes_4_and_5[gCurrentLevel - 14][pid][0];
        mpp->pos.y = gSpawnPositions_Modes_4_and_5[gCurrentLevel - 14][pid][1];
    } else if (gGameMode == 5) {
        pid = ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id;
        if (gCurrentLevel == 16) {
            mpp->pos.x = gSpawnPositions_Modes_4_and_5[gCurrentLevel - 14][((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id][0];
            mpp->pos.y = gSpawnPositions_Modes_4_and_5[gCurrentLevel - 14][((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id][1];
        } else {
            u32 r4;
            u32 i;
            ...
            mpp->pos.x = gSpawnPositions_Modes_4_and_5[gCurrentLevel - 14][outerBit][0] + r4 * 24;
            mpp->pos.y = gSpawnPositions_Modes_4_and_5[gCurrentLevel - 14][outerBit][1];
        }
    } else
# 161 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c"
    {
...
# 201 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c"
        }
    }
    ...
    if (mpp->unk56 != ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) {
    ...
    tf->qScaleY = 256;
# 249 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c"
...
void Task_CreateMultiplayerPlayer()
{
    ...
    MultiplayerPlayer *mpp = (void *)((gCurTask)->data);
    Sprite *s = &mpp->s;
    ...
    if ((gMultiSioStatusFlags & (1 << mpp->unk56)) && (send_recv->pat0.unk0 == 0x1000)) {
        ...
        if ((((mpp->unk44) >= 0 ? (mpp->unk44) : -(mpp->unk44)) > 0x40) || (((mpp->unk48) >= 0 ? (mpp->unk48) : -(mpp->unk48)) > 0x40)) {
            mpp->unk66 = 0;
            mpp->unk68 = 0;
        } else {
        ...
        if (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id != mpp->unk56) {
            mpp->unk64 = (u8)((u32)(0x600 & send_recv->pat0.unk8[0]) >> 9);
        } else {
            if (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id != mpp->unk64) {
                temp_r5 = (void *)((gMultiplayerPlayerTasks[mpp->unk64])->data);
                if (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id == temp_r5->unk64) {
                    mpp->unk64 = (u8)((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id;
                    gPlayer.moveState &= ~8;
        ...
        if (gGameMode == 6) {
            ...
            gMultiplayerCharRings[mpp->unk56] = ((int)((unk6) >> 8));
...
block_57:
    ...
    sp4 = (void *)((gMultiplayerPlayerTasks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id])->data);
    if (((gGameMode == 3) || (gGameMode == 5)) && (gMultiplayerRanks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] == -1)) {
        var_sl = 1;
        for (var_r4 = 0; var_r4 < 4 && (gMultiplayerPlayerTasks[var_r4] != ((void*)0)); var_r4++) {
            u32 connection = gMultiplayerConnections;
            sp14 = (void *)((gMultiplayerPlayerTasks[var_r4])->data);
            if ((((s32)((0x10 << var_r4) & connection) >> (var_r4 + 4))
                 == ((s32)((0x10 << ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) & connection) >> (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id + 4)))
                && !(0x100 & sp14->unk54)) {
                var_sl = 0;
            }
        }
    ...
    if (!(1 & gStageFlags) && !(4 & mpp->unk54) && !(0x80 & sp4->unk57)) {
        ...
        if (!(0x80 & mpp->unk57) && !(sp4->unk5C & 1) && (gPlayer.timerInvulnerability == 0) && !(gPlayer.moveState & 0x80)) {
            if (gGameMode != 6) {
                temp_r1_5 = mpp->unk56;
                if (temp_r1_5 != ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) {
            ...
            } else if (mpp->unk56 != ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) {
                sa2__sub_8018120();
            }
        } else {
            goto block_101;
    ...
    s->frameFlags |= (((0x30 & mpp->unk54) >> 4) << 12);
            ...
            if ((((gGameMode != 3) && (gGameMode != 5))
                 || (connection = gMultiplayerConnections,
                     (((0x10 << mpp->unk56) & connection) >> (mpp->unk56 + 4))
                         != ((s32)(connection & (0x10 << ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id)) >> (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id + 4))))
...
# 1008 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c"
void sa2__sub_8016D20(void)
{
    ...
    if (((gGameMode == 3 || gGameMode == 5) && !(((gMultiplayerConnections & ((1 << 4) << (mpp->unk56))) >> ((mpp->unk56) + 4)) == ((gMultiplayerConnections & ((1 << 4) << (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id))) >> ((((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) + 4)))) || (gGameMode != 3 && gGameMode != 5))
    ...
    if (mpp->unk60 == 0) {
        if (sa2__sub_80181E0() != 0) {
            ...
            if (gPlayer.sa2__unk61 != 0 && (gPlayer.character == CHARACTER_TAILS || gPlayer.character == CHARACTER_KNUCKLES)) {
                return;
            }

            val = sa2__sub_800D0A0(s, mpp->pos.x, mpp->pos.y, mpp->unk66, mpp->unk68, mpp->unk54 >> 7 & 1, 1);
        ...
        val = sa2__sub_800D0A0(s, mpp->pos.x, mpp->pos.y, mpp->unk66, mpp->unk68, mpp->unk54 >> 7 & 1, 0);
...
void sa2__sub_801707C(void)
{
    ...
    if (gPlayer.sa2__unk61 != 0 && gPlayer.character == CHARACTER_KNUCKLES) {
        return;
    }
    ...
    if (mpp->unk60 == 0 || (mpp->unk5C & 4)) {
        ...
        if ((s->graphics.anim != ((58) + CHARACTER_TAILS * (99)) && s->graphics.anim != ((57) + CHARACTER_TAILS * (99)) && s->graphics.anim != ((56) + CHARACTER_TAILS * (99)))) {
            if (sa2__sub_80181E0()) {
                if (!(mpp->unk4C & 0x20)) {
                    return;
                }
        ...
        if ((s->graphics.anim != ((58) + CHARACTER_TAILS * (99)) && s->graphics.anim != ((57) + CHARACTER_TAILS * (99)) && s->graphics.anim != ((56) + CHARACTER_TAILS * (99))) && ((playerSprite->hitboxes[1]).index != -1) && ((s->hitboxes[1]).index != -1)) {
            return;
        }
        ...
        if (!(mpp->unk5C & 4)) {
            if ((someOtherBool || someBool) && (val & 0x10028 && !(s->graphics.anim != ((58) + CHARACTER_TAILS * (99)) && s->graphics.anim != ((57) + CHARACTER_TAILS * (99)) && s->graphics.anim != ((56) + CHARACTER_TAILS * (99))) && (!!(gStageFlags & 0x0080) != !(mpp->unk54 & 8)))) {

                s32 y;
                if (!(gStageFlags & 0x0080)) {
                    result = sa2__sub_801E4E4((((((int)((gPlayer.qWorldY) >> 8))) > (mpp->pos.y)) ? (((int)((gPlayer.qWorldY) >> 8))) : (mpp->pos.y)) + gPlayer.spriteOffsetY, ((int)((gPlayer.qWorldX) >> 8)),
                                                    gPlayer.layer, 8, &unusedByte, sa2__sub_801EE64);
                } else {
                    result = sa2__sub_801E4E4((((((int)((gPlayer.qWorldY) >> 8))) < (mpp->pos.y)) ? (((int)((gPlayer.qWorldY) >> 8))) : (mpp->pos.y)) - gPlayer.spriteOffsetY, ((int)((gPlayer.qWorldX) >> 8)),
                                                    gPlayer.layer, -8, &unusedByte, sa2__sub_801EE64);
                }
        ...
        if (Player_TryJump(&gPlayer)) {
            ...
            if ((s->graphics.anim != ((58) + CHARACTER_TAILS * (99)) && s->graphics.anim != ((57) + CHARACTER_TAILS * (99)) && s->graphics.anim != ((56) + CHARACTER_TAILS * (99))) || ((int)((gPlayer.qWorldX) >> 8)) <= gCamera.minX || ((int)((gPlayer.qWorldX) >> 8)) >= gCamera.maxX
                ...
                if (gPlayer.moveState & 0x00000008) {
                    ...
                    if (!invertedGravity) {
                        ...
                        y = ((s32)((mpp->pos.y + (s->hitboxes[0].b.bottom) + 17)*256));



                        result = sa2__sub_801E4E4(((int)((gPlayer.qWorldY) >> 8)) + gPlayer.spriteOffsetY, ((int)((gPlayer.qWorldX) >> 8)), gPlayer.layer, 8,
                                                        &unusedByte, sa2__sub_801EE64);
                        ...
                        y = ((s32)((mpp->pos.y + (s->hitboxes[0].b.top) - 17)*256));
                    ...
                    gPlayer.qWorldY = y;
                    if (mpp->unk5C & 4) {
# 1382 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c"
...

{
    ...
    if (gPlayer.sa2__unk61 != 0 && gPlayer.character == CHARACTER_TAILS) {
        return;
    }

    if (mpp->unk60 == 0 || (mpp->unk5C & 4)) {
        mpp->unk60 = 0;
        if ((s->graphics.anim != ((62) + CHARACTER_KNUCKLES * (99)) && s->graphics.anim != ((63) + CHARACTER_KNUCKLES * (99)) && s->graphics.anim != ((64) + CHARACTER_KNUCKLES * (99)))) {
            if (sa2__sub_80181E0()) {
                if (!(mpp->unk4C & 0x20)) {
                    return;
                }
            ...
            if ((s->graphics.anim != ((62) + CHARACTER_KNUCKLES * (99)) && s->graphics.anim != ((63) + CHARACTER_KNUCKLES * (99)) && s->graphics.anim != ((64) + CHARACTER_KNUCKLES * (99))) && ((playerSprite->hitboxes[1]).index != -1) && ((s->hitboxes[1]).index != -1)) {
                return;
            }
        }

        {
            ...
            if (Coll_Player_Entity_RectIntersection(s, mpp->pos.x, mpp->pos.y, &gPlayer, (Rect8 *)rect)) {
                ...
                if ((temp == gPlayer.layer) && !(s->graphics.anim != ((62) + CHARACTER_KNUCKLES * (99)) && s->graphics.anim != ((63) + CHARACTER_KNUCKLES * (99)) && s->graphics.anim != ((64) + CHARACTER_KNUCKLES * (99))) && !(gStageFlags & 0x0080) == !(mpp->unk54 & 8)) {
                    if ((!(gStageFlags & 0x0080) && ((int)((gPlayer.qWorldY) >> 8)) > mpp->pos.y)
            ...
            if ((s->graphics.anim != ((62) + CHARACTER_KNUCKLES * (99)) && s->graphics.anim != ((63) + CHARACTER_KNUCKLES * (99)) && s->graphics.anim != ((64) + CHARACTER_KNUCKLES * (99))) || ((int)((gPlayer.qWorldX) >> 8)) <= gCamera.minX || ((int)((gPlayer.qWorldX) >> 8)) >= gCamera.maxX
                || (!(gStageFlags & 0x0080) != !(mpp->unk54 & 8) || !(mpp->unk5C & 0x100) != !(gStageFlags & 0x0080)) || moveStateVal != 0) {
                gPlayer.moveState &= ~0x00400000;
                mpp->unk5C &= ~4;
                gPlayer.charState = 0;
            ...
            }
            {
                ...
                if (!(gravityInverted)) {
                    ...
                    y = ((s32)(((mpp->pos.y + (s->hitboxes[0].b.top)) - rect[3]) << 8));
                    result = sa2__sub_801F100((mpp->pos.y + (s->hitboxes[0].b.top) - rect[3]) - playerUnk17, ((int)((x) >> 8)), gPlayer.layer, -8,
                                                    sa2__sub_801EC3C);
                    ...
                    y = ((s32)((mpp->pos.y + (s->hitboxes[0].b.bottom) + rect[3]) << 8));
                    result = sa2__sub_801F100(((mpp->pos.y + (s->hitboxes[0].b.bottom) + rect[3]) + playerUnk17), ((int)((x) >> 8)), gPlayer.layer,
                                                    8, sa2__sub_801EC3C);
...
void sa2__sub_8017C28(void)
{
    ...
    if (mpp->unk60 == 0) {
        if (!((s->hitboxes[1]).index != -1)) {
            ...
            val = sa2__sub_800DA4C(s, mpp->pos.x, mpp->pos.y, mpp->unk66, mpp->unk68, (mpp->unk54 >> 7) & 1);
            if ((val & 2) && !(gPlayer.moveState & 0x00000002) && gPlayer.rotation == 0) {

                if (s->graphics.anim == ((51) + CHARACTER_AMY * (99)))
                ...
                if (s->graphics.anim == ((56) + CHARACTER_AMY * (99)))
...
# 1817 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c"
    ...
    if (mpp->unk48 < 0) {
        result = sa2__sub_801F100(((int)((gPlayer.qWorldY) >> 8)) - gPlayer.spriteOffsetY, ((int)((gPlayer.qWorldX) >> 8)), gPlayer.layer, -8,
                                        sa2__sub_801EC3C);
        if (result < 0) {
    ...
    if (mpp->unk44 < 0) {
        result = sa2__sub_801F100(((int)((gPlayer.qWorldX) >> 8)) - gPlayer.spriteOffsetX, ((int)((gPlayer.qWorldY) >> 8)), gPlayer.layer, -8,
                                        sa2__sub_801EB44);
        if (result < 0) {
...
# 1892 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c"
bool32 sa2__sub_80181E0(void)
{
    Sprite *sprPlayer = &gPlayer.spriteInfoBody->s;
    MultiplayerPlayer *mpp = (void *)((gCurTask)->data);
    Sprite *s = &mpp->s;
    ...
    if (((sprPlayer->hitboxes[1]).index != -1) && ((s->hitboxes[1]).index != -1)) {
        ...
        if ((val & 1)) {
            if (gPlayer.sa2__unk61 == 0 && (val & 0x20000)) {
                if (gPlayer.qSpeedAirX > 0) {
                    gPlayer.qSpeedAirX = -gPlayer.qSpeedAirX;
                    gPlayer.qSpeedGround = -gPlayer.qSpeedGround;
                }
            } else if (gPlayer.sa2__unk61 == 0 && (val & 0x40000)) {
                if (gPlayer.qSpeedAirX < 0) {
                    gPlayer.qSpeedAirX = -gPlayer.qSpeedAirX;
                    gPlayer.qSpeedGround = -gPlayer.qSpeedGround;
                }
...
bool32 sa2__sub_8018300(void)
{
    ...
    otherMPP = (void *)((gMultiplayerPlayerTasks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id])->data);


    if (mpp->unk60 == 0) {
        u32 val2 = sa2__sub_800DA4C(s, mpp->pos.x, mpp->pos.y, mpp->unk66, mpp->unk68, (mpp->unk54 >> 7) & 1);
# 1960 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c"
        if (val2 & 1) {
            if (gPlayer.sa2__unk61 == 0 && (val2 & 0x20000)) {
                if (gPlayer.qSpeedAirX > 0) {
                    gPlayer.qSpeedAirX = -gPlayer.qSpeedAirX;
                    gPlayer.qSpeedGround = -gPlayer.qSpeedGround;
                }
            } else if (gPlayer.sa2__unk61 == 0 && (val2 & 0x40000)) {
                if (gPlayer.qSpeedAirX < 0) {
                    gPlayer.qSpeedAirX = -gPlayer.qSpeedAirX;
                    gPlayer.qSpeedGround = -gPlayer.qSpeedGround;
                }
        ...
        if (val2 & 2) {
            ...
            if ((gGameMode == 3) || (gGameMode == 5)) {
                if (gMultiplayerCharacters[mpp->unk56] == 3) {
                    if (s->graphics.anim == ((51) + CHARACTER_AMY * (99)) || s->graphics.anim == ((56) + CHARACTER_AMY * (99))) {
                        gPlayer.itemEffect |= 0x10;
                        gPlayer.timerSpeedup = (int)(((0 * 60.) + 10) * 60);
                        gPlayer.itemEffect &= ~0x04;
                        CreateItemTask_Confusion(gPlayer.character);
                        m4aMPlayTempoControl(&gMPlayInfo_BGM, ((s32)((0.5)*256)));
                    }
                }
            }
            ...
            if ((gGameMode == 4) || (gGameMode == 5)) {
                if (otherMPP->unk5C & 0x70000) {
                    u32 i;
                    for (i = 0; i < (sizeof(gChaoTasks) / sizeof((gChaoTasks)[0])); i++) {
                    ...
                    {
                        Chao *chao = (void *)((gChaoTasks[i])->data);
        ...
        if (!((sprPlayer->hitboxes[1]).index != -1) && !((s->hitboxes[1]).index != -1)) {
            ...
            val = sa2__sub_800D0A0(s, mpp->pos.x, mpp->pos.y, mpp->unk66, mpp->unk68, (mpp->unk54 >> 7) & 1, 0);
# 2067 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c"
            if (mpp->unk4C & 0x20 && !(val & 0x20)) {
                gPlayer.moveState &= ~0x00000020;
            }
            mpp->unk4C = val;
    ...
    val = sa2__sub_800D0A0(s, mpp->pos.x, mpp->pos.y, mpp->unk66, mpp->unk68, mpp->unk54 >> 7 & 1, 0);
# 2109 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c"
    if (mpp->unk4C & 0x20 && !(val & 0x20)) {
        gPlayer.moveState &= ~0x00000020;
    }
    mpp->unk4C = val;
...
void Task_HandleLaunchPlayer(void)
{
    ...
    if (gPlayer.charState != 42) {
        gPlayer.moveState &= ~0x00200000;
        gPlayer.moveState &= ~0x00800000;
        TaskDestroy(gCurTask);
    }
}
# 2171 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c"
...
void LaunchPlayer(s16 airSpeedY)
{
    ...
    s16 *airSpeed = (void *)((t)->data);
    *airSpeed = airSpeedY;
    gPlayer.moveState |= 0x00200000;
    gPlayer.heldInput = 0;
    gPlayer.charState = 42;
    gPlayer.moveState |= 0x00800000;
}
...
void sa2__sub_8018120(void)
{
    ...
    if (gPlayer.moveState & 0x00000008 && gPlayer.stoodObj == s) {
        ...
        gPlayer.qWorldX += ((s32)((mpp->unk44)*256));
        gPlayer.qWorldY += ((s32)((mpp->unk48)*256)) + ((s32)((1)*256));
# 2212 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_player.c"
    }

    if (sa2__sub_8018300() && (mpp->unk4C & 0x20)) {
        gPlayer.moveState &= ~0x00000020;
        mpp->unk4C = 0;
    }
}
