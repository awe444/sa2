# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results.c" 2
...
extern void LinkCommunicationError(void);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/text.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results.c" 2
...
const AnimId gUnknown_080BB488[2] = { 895, 894 };
...
void sub_8018538(void)
{
    ...
    gBldRegs.bldCnt = 0;
    gBldRegs.bldY = 0;
    strc = (void *)((TaskCreate(Task_801874C, sizeof(MPResults), 0x2000U, 0U, ((void*)0)))->data);
    strc->unk200 = 0;
    strc->unk203 = 0;
    strc->unk1FC = 0;
    strc->unk213 = 0;
    ...
    s->oamFlags = 0x3C0;
    s->graphics.size = 0;
    s->graphics.anim = gUnknown_080BB488[(&gLoadedSaveGame)->uiLanguage];
    s->variant = 0;
    s->animCursor = 0;
    s->qAnimDelay = 0;
    s->prevVariant = -1;
    ...
    s->x = 0;
    s->y = 64;
    s->graphics.dest = (void *)&VRAM[0x10000] + 0x2C0;
    s->oamFlags = 0x400;
    s->graphics.size = 0;
    s->graphics.anim = 860;
    s->variant = 0;
    ...
    strc->bg.graphics.dest = (void *)&VRAM[0];
    strc->bg.graphics.anim = 0;
    strc->bg.layoutVram = (u16 *)(&VRAM[0] + 0xF000);
    strc->bg.unk18 = 0;
    strc->bg.unk1A = 0;
    strc->bg.tilemapId = (&gLoadedSaveGame)->uiLanguage + 0x54;
    strc->bg.unk1E = 0;
    strc->bg.unk20 = 0;
    strc->bg.unk22 = 0;
    strc->bg.unk24 = 0;
...
void Task_801874C()
{
    ...
    MPResults *strc = (void *)((gCurTask)->data);
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
        for (var_r3 = 0; var_r3 < 4; var_r3++) {
            ...
            if (((gMultiSioStatusFlags) & ((1 << (var_r3)))) == 0) {
    ...
    if (gMultiSioRecv->pat0.unk0 == 0x30) {
        ...
        if (strc->unk203 == 0) {
            ...
            CreateCharacterSelectionScreen((({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) + ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) % 4u);
        } else {
            gGameMode = 4;
            TaskDestroy(gCurTask);
            CreateCharacterSelectionScreen((({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) + ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) % 4u);
    ...
    if (gMultiSioStatusFlags & 0x80) {
        ...
        if (((var_r8 != 0) && (0x0001 & gPressedKeys)) || (strc->unk213 != 0)) {
            strc->unk213 = 1;
    ...
    strc->unk1FC += 0x80;
    if (strc->unk1FC > ((s32)((temp_r7)*256))) {
        strc->unk1FC -= ((s32)((temp_r7)*256));
    }
    s->y = (strc->unk203 * 24) + 64;
    s->variant = strc->unk203;
    UpdateSpriteAnimation(s);

    offsetX = ((int)((strc->unk1FC) >> 8)) - temp_r7;
    while ((232 - offsetX) > 0) {
        s->x = 232 - offsetX;
        DisplaySprite(s);
        offsetX += temp_r7;
