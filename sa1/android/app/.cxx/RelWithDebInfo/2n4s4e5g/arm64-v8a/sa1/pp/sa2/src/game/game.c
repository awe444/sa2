# 1 "/home/awaszczak/git/sa2/sa1/../src/game/game.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2
...
void GameInit(void);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 25 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/game/decomp_credits.h" 1



extern void CreateDecompCreditsScreen(bool32 hasProfile);
# 27 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2
...
# 28 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2
...
# 31 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2
...
# 32 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2
...
# 33 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2
...
# 39 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2
...
# 40 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2
...
# 47 "/home/awaszczak/git/sa2/sa1/../src/game/game.c" 2
...
void GameInit(void)
{
    ...
    gStageFlags = gPrevStageFlags = 0x0000;
    ...
    gDustEffectBrakingTask.t = ((void*)0);
    gWater.t = ((void*)0);
...
# 127 "/home/awaszczak/git/sa2/sa1/../src/game/game.c"
    if (gFlags & 0x200) {
        ShowSinglePakResults();
        return;
    }
# 149 "/home/awaszczak/git/sa2/sa1/../src/game/game.c"
    CreateDecompCreditsScreen(hasProfile);
# 207 "/home/awaszczak/git/sa2/sa1/../src/game/game.c"
}
# 244 "/home/awaszczak/git/sa2/sa1/../src/game/game.c"
void CreateEmptySaveGame(void)
{
    u32 i;

    { u32 tmp = (u32)(0); DmaSet(3, &tmp, (&gLoadedSaveGame), (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(*(&gLoadedSaveGame)))/(32/8)))); };
    (&gLoadedSaveGame)->unk4 = 0;
    (&gLoadedSaveGame)->unk420 = 50000;
    (&gLoadedSaveGame)->difficultyLevel = 0;

    for (i = 0; i < (sizeof((&gLoadedSaveGame)->unlockedLevels) / sizeof(((&gLoadedSaveGame)->unlockedLevels)[0])); i++) {
        (&gLoadedSaveGame)->unlockedLevels[i] = 0;
    }

    for (i = 0; i < 10; i++) {
        u32 charIndex;

        (&gLoadedSaveGame)->multiplayerScores[i].data.split.wins |= 0xFF;
        for (charIndex = 0; charIndex < (s32)(sizeof((&gLoadedSaveGame)->multiplayerScores[i].data.split.playerName) / sizeof(((&gLoadedSaveGame)->multiplayerScores[i].data.split.playerName)[0])); charIndex++) {
            (&gLoadedSaveGame)->multiplayerScores[i].data.split.playerName[charIndex] = ' ';
        }
    }

    { u32 tmp = (u32)(((int)(((10 * 60.) + 0) * 60))); DmaSet(3, &tmp, &(&gLoadedSaveGame)->timeRecords, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof((&gLoadedSaveGame)->timeRecords))/(32/8)))); };

    (&gLoadedSaveGame)->uiLanguage = 1;
    (&gLoadedSaveGame)->language = 1;
    (&gLoadedSaveGame)->timeLimitDisabled = 0;
    (&gLoadedSaveGame)->btnConfig = 0;
