# 1 "/home/awaszczak/git/sa2/sa1/../src/core.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/core.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/core.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/core.c" 2
...
void EwramFree(void *);
# 4 "/home/awaszczak/git/sa2/sa1/../src/core.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/core.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 11 "/home/awaszczak/git/sa2/sa1/../src/core.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/lib/agb_flash/agb_flash.h" 1
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/core.c" 2
...
struct Task gTasks[128] = {};
u16 gSpriteTransformScaleX __attribute__((aligned(4))) = 0;
Vec2_16 gSpriteOffset __attribute__((aligned(4))) = {};
Background *gBackgroundsCopyQueue[16] __attribute__((aligned(16))) = {};
u32 gFlags = 0;
u8 gOamMallocOrders_StartIndex[32] __attribute__((aligned(16))) = {};
...
u16 gSpriteTransformRotation __attribute__((aligned(4))) = 0;
u8 gNumVBlankIntrs __attribute__((aligned(4))) = 0;
s16 gSpriteTransformX __attribute__((aligned(4))) = 0;
...
struct Task *gTaskPtrs[128] __attribute__((aligned(16))) = {};
int_vcount gBgOffsetsBuffer[2][240][4] = {};
ColorRaw gObjPalette[16 * 16u] = {};
...
u8 gOamMallocCopiedOrder[128] __attribute__((aligned(16))) = {};
...
struct GraphicsData *gVramGraphicsCopyQueue[32] __attribute__((aligned(16))) = {};
# 117 "/home/awaszczak/git/sa2/sa1/../src/core.c"
s16 gSpriteTransformY = 0;
s16 gBgScrollRegs[4][2] __attribute__((aligned(16))) = {};
u16 gDispCnt = 0;
...
ColorRaw gBgPalette[16 * 16u] __attribute__((aligned(16))) = {};
...
u16 sa2__gUnknown_03002A8C __attribute__((aligned(4))) = 0;
...
Sprite *gBgSprites[16] __attribute__((aligned(16))) = {};
u8 gNumVBlankCallbacks __attribute__((aligned(4))) = 0;



u16 sa2__gUnknown_03004D58 __attribute__((aligned(4))) = 0;
u8 gVramGraphicsCopyCursor __attribute__((aligned(4))) = 0;



u8 gOamMallocOrders_EndIndex[0x20] __attribute__((aligned(16))) = {};
u8 gBgSprites_Unknown1[16] = {};
OamData gOamBuffer[128] __attribute__((aligned(16))) = {};
u16 gVramHeapState[((0x18000 + (0x800 * (14))) - 0x10000) / (4 * 32)] = {};
u8 gBgSpritesCount __attribute__((aligned(4))) = 0;
u16 gSpriteTransformScaleY __attribute__((aligned(4))) = 0;
u16 gSpriteTransformScaleUnknown __attribute__((aligned(4))) = 0;
IntrFunc gVBlankIntrs[4] __attribute__((aligned(16))) = {};
...
# 247 "/home/awaszczak/git/sa2/sa1/../src/core.c"
void EngineInit(void)

{
    ...
    (*(reg_u16 *)(REG_BASE + 0x204)) = (1 << 14) | (1 << 4) | (1 << 2);
    gFlags = 0;
    gFlagsPreVBlank = 0;
    ...
    if (((*(reg_u16 *)(REG_BASE + 0x134)) & 0xC000) != 0x8000) {
        gFlags = 0x200;


        DmaSet(3, (void *)&VRAM[0x10000], EWRAM_START + 0x3B000, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x5000)/(16/8))));
    ...
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, (void *)VRAM, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | (((0x18000 + (0x800 * (14))))/(32/8)))); };




    { u32 tmp = (u32)(0); DmaSet(3, &tmp, (void *)OAM, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | (((128*0xC))/(32/8)))); };



    { u32 tmp = (u32)(0); DmaSet(3, &tmp, (void *)PLTT, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((0x400)/(32/8)))); };
...
# 320 "/home/awaszczak/git/sa2/sa1/../src/core.c"
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, gBgSprites_Unknown2, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gBgSprites_Unknown2))/(32/8)))); };
    ...
    *(u32 *)gBgSprites_Unknown1 = 0;
    ...
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, gBgScrollRegs, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gBgScrollRegs))/(32/8)))); };
    ...
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, gVramGraphicsCopyQueue, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gVramGraphicsCopyQueue))/(32/8)))); };
    ...
    { u16 tmp = (u16)(0x200); DmaSet(3, &tmp, gOamBuffer, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((sizeof(gOamBuffer))/(16/8)))); };



    { u16 tmp = (u16)(0x200); DmaSet(3, &tmp, gOamMallocBuffer, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((sizeof(gOamMallocBuffer))/(16/8)))); };



    { u32 tmp = (u32)(~0); DmaSet(3, &tmp, gOamMallocOrders_StartIndex, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gOamMallocOrders_StartIndex))/(32/8)))); };



    { u32 tmp = (u32)(~0); DmaSet(3, &tmp, gOamMallocOrders_EndIndex, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gOamMallocOrders_EndIndex))/(32/8)))); };



    { u32 tmp = (u32)(0); DmaSet(3, &tmp, gObjPalette, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gObjPalette))/(32/8)))); };



    { u32 tmp = (u32)(0); DmaSet(3, &tmp, gBgPalette, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gBgPalette))/(32/8)))); };
    ...
    gInputRecorder.mode = 0;
    gPhysicalInput = 0;
    gInputPlaybackData = ((void*)0);

    gFrameCount = 0;


    for (i = 0; i < (sizeof(gIntrTableTemplate) / sizeof((gIntrTableTemplate)[0])); i++)
    ...
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, &gBgOffsetsBuffer, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gBgOffsetsBuffer))/(32/8)))); };
    ...
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, gHBlankCallbacks, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gHBlankCallbacks))/(32/8)))); };



    { u32 tmp = (u32)(0); DmaSet(3, &tmp, gHBlankIntrs, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gHBlankCallbacks))/(32/8)))); };
    ...
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, gVBlankCallbacks, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gVBlankCallbacks))/(32/8)))); };



    { u32 tmp = (u32)(0); DmaSet(3, &tmp, gVBlankIntrs, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gVBlankIntrs))/(32/8)))); };
    ...
    gVramHeapMaxTileSlots = 156 * ((4 * 32) / 32);
    gVramHeapStartAddr = &VRAM[0x14000] - (112 * 32);
...
# 510 "/home/awaszczak/git/sa2/sa1/../src/core.c"
    INTR_VECTOR = IntrMain;



    (*(reg_u16 *)(REG_BASE + 0x208)) = (1 << 0);
    (*(reg_u16 *)(REG_BASE + 0x200)) = (1 << 0);
    (*(reg_u16 *)(REG_BASE + 0x4)) = 0x0010 | 0x0008;
    ...
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, &gMultiSioSend, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gMultiSioSend))/(32/8)))); };



    { u32 tmp = (u32)(0); DmaSet(3, &tmp, gMultiSioRecv, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gMultiSioRecv))/(32/8)))); };
...
# 617 "/home/awaszczak/git/sa2/sa1/../src/core.c"
        while (0 && ((*(reg_u16 *)(REG_BASE + 0x4)) & 0x0001))
            ;
    };
}
...
{
    u8 i, j = 0;
    (*(reg_u16 *)(REG_BASE + 0x0)) = gDispCnt;
    DmaSet(3, gBgCntRegs, (void *)(REG_BASE + 0x8), (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((sizeof(gBgCntRegs))/(32/8))));

    if (gFlags & 0x1) {
        DmaSet(3, gBgPalette, (void *)((ColorRaw*)&PLTT[0]), (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((sizeof(gBgPalette))/(32/8))));
        gFlags ^= 0x1;
    }

    if (gFlags & 0x2) {
        DmaSet(3, gObjPalette, (void *)((ColorRaw*)&PLTT[0x200/sizeof(uint16_t)]), (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((sizeof(gObjPalette))/(32/8))));
        gFlags ^= 0x2;
    }

    DmaSet(3, gWinRegs, (void *)(REG_BASE + (0x40 + sizeof(winreg_t) * 0)), (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((sizeof(gWinRegs))/(32/8))));
    DmaSet(3, &gBldRegs, (void *)(REG_BASE + ((0x40 + sizeof(winreg_t) * 6) + 4)), (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((6)/(16/8))));
# 649 "/home/awaszczak/git/sa2/sa1/../src/core.c"
    DmaSet(3, gBgScrollRegs, (void *)(REG_BASE + 0x10), (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(gBgScrollRegs))/(16/8))));
    DmaSet(3, &gBgAffineRegs, (void *)(REG_BASE + 0x20), (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((sizeof(gBgAffineRegs))/(32/8))));

    if (gFlags & 0x8) {
        (*(reg_u16 *)(REG_BASE + 0x200)) |= (1 << 1);
        { u32 tmp = (u32)(0); DmaSet(3, &tmp, gHBlankIntrs, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gHBlankIntrs))/(32/8)))); };
        if (gNumHBlankCallbacks != 0) {
            DmaSet(3, gHBlankCallbacks, gHBlankIntrs, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((gNumHBlankCallbacks * sizeof(HBlankIntrFunc))/(32/8))));
        }
    ...
    if (gFlags & 0x4) {
        ...
        DmaSet(3, gBgOffsetsHBlankPrimary, gHBlankCopyTarget, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((gHBlankCopySize)/(16/8))));
    }

    if (sLastCalledVblankFuncId == 0xFF) {
        ProcessOamBuffers();
        DmaSet(3, gOamBuffer + (128 / 4) * 0, (void *)OAM + (128 * (12 / 4) * 0), (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | (((128*0xC) / 4)/(16/8))));

        DmaSet(3, gOamBuffer + (128 / 4) * 1, (void *)OAM + (128 * (12 / 4) * 1), (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | (((128*0xC) / 4)/(16/8))));

        DmaSet(3, gOamBuffer + (128 / 4) * 2, (void *)OAM + (128 * (12 / 4) * 2), (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | (((128*0xC) / 4)/(16/8))));

        DmaSet(3, gOamBuffer + (128 / 4) * 3, (void *)OAM + (128 * (12 / 4) * 3), (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | (((128*0xC) / 4)/(16/8))));

    }

    for (i = 0; i < gNumVBlankIntrs; i++) {

        if (gVBlankIntrs[i] != ((void*)0))
    ...
    if (gFlags & 0x10) {
        ...
        if (gNumVBlankCallbacks != 0) {
            DmaSet(3, gVBlankCallbacks, gVBlankIntrs, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((gNumVBlankCallbacks * sizeof(IntrFunc))/(32/8))));
        }
...
# 749 "/home/awaszczak/git/sa2/sa1/../src/core.c"
    }
    gFlags &= ~0x4;
    { u16 tmp = (u16)(0x200); DmaSet(3, &tmp, gOamBuffer + (128 / 4) * 0, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | (((128*0xC) / 4)/(16/8)))); };
    { u16 tmp = (u16)(0x200); DmaSet(3, &tmp, gOamBuffer + (128 / 4) * 1, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | (((128*0xC) / 4)/(16/8)))); };
    { u16 tmp = (u16)(0x200); DmaSet(3, &tmp, gOamBuffer + (128 / 4) * 2, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | (((128*0xC) / 4)/(16/8)))); };
    { u16 tmp = (u16)(0x200); DmaSet(3, &tmp, gOamBuffer + (128 / 4) * 3, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | (((128*0xC) / 4)/(16/8)))); };
...
void UpdateScreenCpuSet(void)
{
    u8 i, j = 0;
    (*(reg_u16 *)(REG_BASE + 0x0)) = gDispCnt;
    CpuSet(gBgCntRegs, (void *)(REG_BASE + 0x8), 0x04000000 | ((sizeof(gBgCntRegs))/(32/8) & 0x1FFFFF));

    if (gFlags & 0x1) {
        CpuFastSet(gBgPalette, (void *)((ColorRaw*)&PLTT[0]), ((sizeof(gBgPalette))/(32/8) & 0x1FFFFF));
        gFlags ^= 0x1;
    }

    if (gFlags & 0x2) {
        CpuFastSet(gObjPalette, (void *)((ColorRaw*)&PLTT[0x200/sizeof(uint16_t)]), ((sizeof(gObjPalette))/(32/8) & 0x1FFFFF));
        gFlags ^= 0x2;
    }

    CpuSet(gWinRegs, (void *)(REG_BASE + (0x40 + sizeof(winreg_t) * 0)), 0x04000000 | ((sizeof(gWinRegs))/(32/8) & 0x1FFFFF));
    CpuSet(&gBldRegs, (void *)(REG_BASE + ((0x40 + sizeof(winreg_t) * 6) + 4)), 0x00000000 | ((6)/(16/8) & 0x1FFFFF));
# 788 "/home/awaszczak/git/sa2/sa1/../src/core.c"
    CpuSet(gBgScrollRegs, (void *)(REG_BASE + 0x10), 0x00000000 | ((sizeof(gBgScrollRegs))/(16/8) & 0x1FFFFF));
    CpuSet(&gBgAffineRegs, (void *)(REG_BASE + 0x20), 0x04000000 | ((sizeof(gBgAffineRegs))/(32/8) & 0x1FFFFF));

    if (gFlags & 0x8) {
        (*(reg_u16 *)(REG_BASE + 0x200)) |= (1 << 1);
        { volatile uintptr_t tmp = (volatile uintptr_t)(((void*)0)); CpuFastSet((void *)&tmp, gHBlankIntrs, 0x01000000 | ((sizeof(gHBlankIntrs))/(32/8) & 0x1FFFFF)); };
        if (gNumHBlankCallbacks != 0) {
    ...
    if (sLastCalledVblankFuncId == 0xFF) {
        ProcessOamBuffers();
        CpuFastSet(gOamBuffer, (void *)OAM, (((128*0xC))/(32/8) & 0x1FFFFF));
    }
    ...
    if (gFlags & 0x10) {
        { volatile uintptr_t tmp = (volatile uintptr_t)(((void*)0)); CpuFastSet((void *)&tmp, gVBlankIntrs, 0x01000000 | ((sizeof(gVBlankIntrs))/(32/8) & 0x1FFFFF)); };
        if (gNumVBlankCallbacks != 0) {
...
void VBlankIntr(void)
{
    ...
    if (gFlagsPreVBlank & 0x4) {
        ...
        DmaSet(0, gBgOffsetsHBlankPrimary, gHBlankCopyTarget, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((gHBlankCopySize)/(16/8))));
        DmaSet(0, gBgOffsetsHBlankPrimary + gHBlankCopySize, gHBlankCopyTarget,
               ((0x8000 | 0x2000 | 0x0200 | 0x0060) << 16) | (gHBlankCopySize >> 1));
    ...
    if (gFlagsPreVBlank & 0x40) {
        (*(reg_u16 *)(REG_BASE + 0x4)) |= 0x0020;
        (*(reg_u16 *)(REG_BASE + 0x4)) &= 0xff;
        (*(reg_u16 *)(REG_BASE + 0x4)) |= gVCountSetting << 8;
        (*(reg_u16 *)(REG_BASE + 0x4)) &= ~0x0004;
        (*(reg_u16 *)(REG_BASE + 0x4)) |= 0x0020;
        (*(reg_u16 *)(REG_BASE + 0x200)) |= (1 << 2);
    } else {
        (*(reg_u16 *)(REG_BASE + 0x4)) &= ~0x0004;
        (*(reg_u16 *)(REG_BASE + 0x4)) &= ~0x0020;
        (*(reg_u16 *)(REG_BASE + 0x200)) &= ~(1 << 2);
    ...
    if (!(gFlagsPreVBlank & 0x8000)) {
        keys = ~(*(reg_u16 *)(REG_BASE + 0x130)) & (0x0008 | 0x0004 | 0x0002 | 0x0001);
        if (keys == (0x0008 | 0x0004 | 0x0002 | 0x0001)) {
            gFlags |= 0x8000;
            (*(reg_u16 *)(REG_BASE + 0x200)) = 0;
            (*(reg_u16 *)(REG_BASE + 0x208)) = 0;
            (*(reg_u16 *)(REG_BASE + 0x4)) = 0x0000;
            ...
            for (offset = 0; graphics->size > 0; offset += 1024) {
                if (graphics->size > 1024) {
...

                    {
                        ...
                        DmaSet(3, (void *)(graphics->src + offset), (void *)(graphics->dest + offset), (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((1024)/(16/8))));
...

                    {
                        ...
                        DmaSet(3, (void *)(graphics->src + offset), (void *)(graphics->dest + offset), (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((graphics->size)/(16/8))));
...
void GetInput(void)
{
    ...
    gInput = (~(*(reg_u16 *)(REG_BASE + 0x130)) & 0x03FF);
...
# 1063 "/home/awaszczak/git/sa2/sa1/../src/core.c"
static void HBlankIntr(void)
{
    u8 i;
    int_vcount vcount = *(volatile int_vcount *)&(*(reg_u16 *)(REG_BASE + 0x6));
    ...
    (*(reg_u16 *)(REG_BASE + 0x202)) = (1 << 1);
}

static void VCountIntr(void) { (*(reg_u16 *)(REG_BASE + 0x202)) = (1 << 2); }
static void Dma0Intr(void) { (*(reg_u16 *)(REG_BASE + 0x202)) = (1 << 8); }
static void Dma1Intr(void) { (*(reg_u16 *)(REG_BASE + 0x202)) = (1 << 9); }
static void Dma2Intr(void) { (*(reg_u16 *)(REG_BASE + 0x202)) = (1 << 10); }
static void Dma3Intr(void) { (*(reg_u16 *)(REG_BASE + 0x202)) = (1 << 11); }
static void Timer0Intr(void) { (*(reg_u16 *)(REG_BASE + 0x202)) = (1 << 3); }
static void Timer1Intr(void) { (*(reg_u16 *)(REG_BASE + 0x202)) = (1 << 4); }
static void Timer2Intr(void) { (*(reg_u16 *)(REG_BASE + 0x202)) = (1 << 5); }



static void KeypadIntr(void) { (*(reg_u16 *)(REG_BASE + 0x202)) = (1 << 12); }
static void GamepakIntr(void) { (*(reg_u16 *)(REG_BASE + 0x202)) = (1 << 13); }
...
static void ClearOamBufferCpuSet(void)
{
    ...
    gFlags &= ~0x4;
    { volatile uintptr_t tmp = (volatile uintptr_t)(0x200); CpuFastSet((void *)&tmp, gOamBuffer, 0x01000000 | ((sizeof(gOamBuffer))/(32/8) & 0x1FFFFF)); };
    gNumVBlankCallbacks = 0;
    gFlags &= ~0x10;
}
