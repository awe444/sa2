# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/oct.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/oct.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/oct.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/oct.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/oct.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/oct.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/oct.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/oct.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/oct.c" 2
...
void Task_OctInit(void)
{
    ...
    worldX = ((oct->shared.base.meX)*8 + (oct->shared.base.regionX)*256);
    worldY = ((me->y)*8 + (oct->shared.base.regionY)*256);
    ...
    if ((worldX - 120 < ((int)((gPlayer.qWorldX) >> 8))) && (worldX + 120 > ((int)((gPlayer.qWorldX) >> 8)))) {
        s->variant = 0;
...
void sub_807033C(void)
{
    ...
    if (((int)((oct->qUnk3C) >> 8)) <= (me->d.sData[0]) * 8) {
        if (oct->unk46 == 0) {
            oct->unk46 = 1;
            oct->qUnk40 = +((s32)((0.75)*256));
            oct->unk42 = 0;
    ...
    } else if (((int)((oct->qUnk3C) >> 8)) >= (me->d.sData[0] + me->d.uData[2]) * 8) {
        if (oct->unk46 == 0) {
            oct->unk46 = 1;
            oct->qUnk40 = -((s32)((0.75)*256));
            oct->unk42 = 0;
...
void sub_807051C(void)
{
    ...
    if (oct->qUnk40 < 0) {
        oct->qUnk3C += ({((55) != 0) ? ((s32)((gSineTable[((({((30) != 0) ? ((s32)(0x400) / (s32)(30)) : 0;}) * oct->unk42))])) / (s32)(55)) : 0;});
    } else {
        oct->qUnk3C -= ({((55) != 0) ? ((s32)((gSineTable[((({((30) != 0) ? ((s32)(0x400) / (s32)(30)) : 0;}) * oct->unk42))])) / (s32)(55)) : 0;});
    }
...
void CreateOctProjectile(CamCoord worldX, CamCoord worldY)
{
    struct Task *t = TaskCreate(Task_OctProjectile, sizeof(OctProjectile), 0x3000, 0, ((void*)0));
    OctProjectile *proj = (void *)((t)->data);
    Sprite *s = &proj->s;

    proj->qUnk30 = ((s32)((worldX)*256));
    proj->qUnk34 = ((s32)((worldY)*256));
    proj->qSpeedY = ((s32)((2)*256));
...
void Task_OctProjectile(void)
{
    OctProjectile *proj = (void *)((gCurTask)->data);
    Sprite *s = &proj->s;
