# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/pause_menu.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/pause_menu.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/pause_menu.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/pause_menu.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/pause_menu.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/pause_menu.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/pause_menu.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/pause_menu.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa2/animations.h" 1
...
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa2/anim_sizes.h" 1
# 8 "/home/awaszczak/git/sa2/sa1/../include/constants/sa2/animations.h" 2
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/pause_menu.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa2/songs.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/pause_menu.c" 2
# 26 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/pause_menu.c"
...
# 27 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/pause_menu.c" 2
...
# 54 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/pause_menu.c"
...
void CreatePauseMenu(void)
{
    ...
    PauseMenu *pm;
    Sprite *s;
# 71 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/pause_menu.c"
    if ((gStageFlags & 0x0020)) {
        return;
    }
# 82 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/pause_menu.c"
    t = TaskCreate(Task_PauseMenuInit, sizeof(PauseMenu), -2, 0x0004, TaskDestructor_PauseMenu);
    pm = (void *)((t)->data);
    ...
    if (gGameMode == 1) {
        ...
        s = &pm->s;
        s->graphics.dest = VramMalloc(((128 / 8) * (48 / 8)));
        s->oamFlags = ((1) << 6);
        s->graphics.size = 0;
        s->graphics.anim = 809;
        s->variant = 0;
        ...
        s = &pm->s2;
        s->graphics.dest = VramMalloc(((128 / 8) * (32 / 8)));
        s->oamFlags = ((1) << 6);
        s->graphics.size = 0;
        s->graphics.anim = 718;
        s->variant = 0;
        ...
        s = &pm->s;
        s->graphics.dest = VramMalloc(((96 / 8) * (32 / 8)));
        s->oamFlags = ((1) << 6);
        s->graphics.size = 0;
        s->graphics.anim = 720;
        s->variant = 0;
        ...
        s = &pm->s2;
        s->graphics.dest = VramMalloc(((80 / 8) * (16 / 8)));
        s->oamFlags = ((1) << 6);
        s->graphics.size = 0;
        s->graphics.anim = 718;
        s->variant = 0;
...
# 188 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/pause_menu.c"
}

void Task_PauseMenuUpdate(void)
{
    PauseMenu *pm = (void *)((gCurTask)->data);
    ...
    if ((gGameMode == 1) && (gPressedKeys & 0x0001)) {
        gFlags &= ~0x400;
        m4aSongNumStart(106);
    ...
    if (gBldRegs.bldY > 0) {
        pm->s2.frameFlags |= ((1) << (7));
        pm->s.frameFlags |= ((1) << (7));
    } else {
        pm->s2.frameFlags &= ~((3) << (7));
        pm->s.frameFlags &= ~((3) << (7));
    }
    ...
    if (gGameMode == 1) {
        if (++pm->frames >= 60) {
            ...
            if (pm->s2.graphics.anim == 718) {
                pm->s2.graphics.anim = 810;
                pm->s2.variant = (&gLoadedSaveGame)->uiLanguage;
            } else {
                pm->s2.graphics.anim = 718;
                pm->s2.variant = 0;
            }
    ...
    DisplaySprite(&pm->s2);
# 312 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/pause_menu.c"
    DisplaySprite(&pm->s);
}
