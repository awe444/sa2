# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_tails.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_tails.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_tails.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_tails.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_tails.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_tails.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_tails.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_tails.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_tails.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_tails.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_tails.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_tails.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_tails.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_tails.c" 2
...
{
    if (p->sa2__unk62 == 0) {
        if ((gGameMode == 6) || (Player_Tails_8047B04(p) == 0)) {
...
{
    if ((!(p->moveState & 0x00000400)) && (((p->rotation + ((s32)((0.25)*256))) << 24) > 0) && !(p->moveState & 0x00000020)
...
void Player_Tails_8047A3C(Player *p)
{
    ...
    if (p->sa2__unk61 != 1) {
        ...
        if (p->moveState & 0x00010000) {
            p->qSpeedAirY += ((s32)((16. / 256.)*256));
        } else {
            p->qSpeedAirY += ((s32)((8. / 256.)*256));
        }
    }
...
void Task_8047D04(void)
{
    ...
    if ((p->character != CHARACTER_TAILS) || (p->charState != 32) || (p->sa2__unk99[0] == 0x7F)) {
        TaskDestroy(gCurTask);
        return;
    }

    tf->x = (((int)((p->qWorldX) >> 8)) - cam->x) + p->sa2__unk7C;
    tf->y = (((int)((p->qWorldY) >> 8)) - cam->y);
...
void Player_Tails_InitFlying(Player *p)
{
    ...
    p->w.tf.flyingDuration = (int)(((0 * 60.) + 4) * 60);
    Player_Tails_8047990(p);
}
...
struct Task *Player_Tails_InitGfx_TailSwipe(Player *p)
{
    ...
    s->graphics.dest = VramMalloc(((40 / 8) * (24 / 8)));
    s->graphics.anim = 777;
    s->variant = 0;
    s->oamFlags = ((8) << 6);
    s->frameFlags = ((2) << (12));
