# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_spindash.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_spindash.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_spindash.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_spindash.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_spindash.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_spindash.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_spindash.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_spindash.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_spindash.c" 2
...
void Task_SpindashDustEffect(void)
{
    ...
    if (p->spriteTask == ((void*)0) || (p->moveState & (0x00000400 | 0x00000080)) != 0x00000400) {
        TaskDestroy(gCurTask);
        return;
    } else {
        DustEffect *sde = (void *)((gCurTask)->data);
        Sprite *s = &sde->s;

        if (p->qSpindashAccel > ((s32)((2.0)*256))) {
...
# 89 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_spindash.c"
        {
            s->x = ((int)((p->qWorldX) >> 8)) - cam->x;
            s->y = (((int)((p->qWorldY) >> 8)) + offY) - cam->y;
        }
...
# 150 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_effect_spindash.c"
        {
            s->x = ((int)((p->qWorldX) >> 8)) - cam->x;
            s->y = (((int)((p->qWorldY) >> 8)) + offY) - cam->y;
        }
