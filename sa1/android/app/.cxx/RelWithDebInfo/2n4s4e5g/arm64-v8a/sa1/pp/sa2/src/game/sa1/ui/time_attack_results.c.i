# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_results.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_results.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_results.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_results.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_results.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_results.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_results.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_results.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_results.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_results.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_results.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_results.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_results.c" 2
...
void sub_8069994(u8 *vram)
{
    ...
    sp00.paletteSize = 0x20;
    sp00.unk28 = 12;
    sp00.vramC = &VRAM[0x10000] + 0x1000;
    sp00.unk2A = 13;
    sp00.unk0.unk4 = gUiGraphics[sp00.uiGfxID].unk8;
    sp00.unk0.unk8 = gUiGraphics[sp00.uiGfxID].unkC;
    sp00.unk0.unk9 = gUiGraphics[sp00.uiGfxID].unk10;
    ...
    if (gCurrentLevel & 0x1) {
        sp00.tiles = (gUiGraphics[sp00.uiGfxID].tiles + (80 * 32));
    } else {
        sp00.tiles = (gUiGraphics[sp00.uiGfxID].tiles);
    }
    sp00.palette = gUiGraphics[sp00.uiGfxID].palette;
    ...
    sp00.vramC = &VRAM[0x10000] + 0x1800;
    sp00.unk2A = 13;
    sp00.unk0.unk4 = gUiGraphics[sp00.uiGfxID].unk8;
    sp00.unk0.unk8 = gUiGraphics[sp00.uiGfxID].unkC;
    sp00.unk0.unk9 = gUiGraphics[sp00.uiGfxID].unk10;
    ...
    sp00.unk28 = 11;
    sp00.vramC = &VRAM[0x10000] + 0x1200;
    sp00.unk2A = 13;
    sp00.unk0.unk4 = gUiGraphics[sp00.uiGfxID].unk8;
    sp00.unk0.unk8 = gUiGraphics[sp00.uiGfxID].unkC;
    sp00.unk0.unk9 = gUiGraphics[sp00.uiGfxID].unk10;
...
void Task_8069E50()
{
    ...
    Game2_5 *strc = (void *)((gCurTask)->data);
...
void sub_8069EE4(u32 unk0)
{
    ...
    if (temp_r5->qUnkA < -0x1F) {
        temp_r5->qUnkA += 0x20;
        strc->unkC0 = ({((8) != 0) ? ((s32)(strc->unkC0 + 1) % (s32)(8)) : 0;});
    }
    if (unk0 != 0) {
...
void sub_806A02C(TimeRecord record, struct Task *t)
{
    ...
    if (record >= 36000) {
        ...
        r5 = ({((60) != 0) ? ((s32)(record) / (s32)(60)) : 0;});
        temp_r0_2 = ({((60) != 0) ? ((s32)(r5) / (s32)(60)) : 0;});
