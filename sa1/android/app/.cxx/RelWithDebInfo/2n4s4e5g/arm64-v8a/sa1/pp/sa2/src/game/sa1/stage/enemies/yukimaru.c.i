# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/yukimaru.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/yukimaru.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/yukimaru.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/yukimaru.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/yukimaru.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/yukimaru.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/yukimaru.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/yukimaru.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/yukimaru.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/yukimaru.c" 2
...
void CreateEntity_Yukimaru(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    yukimaru->qUnk78 = -((s32)((0.625)*256));
    yukimaru->qUnk7A = +((s32)((0)*256));
    yukimaru->qUnk7C = +((s32)((0)*256));
    yukimaru->qUnk7E = +((s32)((0)*256));
    yukimaru->unk80 = +((s32)((0)*256));
    ...
    s->graphics.dest = VramMalloc((((32 / 2) / 8) * (32 / 8)));
    s->oamFlags = ((0) << 6);
    s->graphics.size = 0;
    s->graphics.anim = 422;
    s->variant = 1;
...
void Task_YukimaruGroundInit(void)
{
    Yukimaru *yukimaru = (void *)((gCurTask)->data);
    Sprite *s = &yukimaru->s;
    ...
    worldX = ((yukimaru->base.meX)*8 + (yukimaru->base.regionX)*256);
    worldY = ((me->y)*8 + (yukimaru->base.regionY)*256);

    yukimaru->qUnk7A += yukimaru->qUnk78;

    deltaX = worldX + ((int)((yukimaru->qUnk7A) >> 8));
    deltaY = worldY - 6;
    ...
    yukimaru->qUnk7C += sa2__sub_801F07C(deltaY, deltaX, 1, +8, ((void*)0), sa2__sub_801EE64);

    if (((int)((yukimaru->qUnk7A) >> 8)) <= (me->d.sData[0]) * 8) {
        yukimaru->qUnk78 = +((s32)((0.625)*256));
    } else if (((int)((yukimaru->qUnk7A) >> 8)) >= (me->d.sData[0] + me->d.uData[2]) * 8) {
        yukimaru->qUnk78 = -((s32)((0.625)*256));
    } else if (yukimaru->unk80 != 0) {
        yukimaru->unk80--;
    } else {
        if ((((int)((gPlayer.qWorldY) >> 8)) <= deltaY) && (((int)((gPlayer.qWorldX) >> 8)) <= deltaX + 8) && (deltaX - 8 <= ((int)((gPlayer.qWorldX) >> 8)))) {
            yukimaru->unk80 = 60;
            yukimaru->qUnk7E = ((s32)((0)*256));
            s->variant = 0;
            s2->variant = 0;
...
void Task_8071BFC(void)
{
    ...
    yukimaru->qUnk7C += sa2__sub_801F07C(deltaY, deltaX, 1, +8, &sp08, sa2__sub_801EE64);
...
{
    struct Task *t = TaskCreate(Task_Snowball, sizeof(Snowball), 0x3000, 0, ((void*)0));
    Snowball *snowball = (void *)((t)->data);
    Sprite *s = &snowball->s;
    s32 speed = worldX * 4;

    snowball->qUnk34 = -((s32)((5)*256));
    snowball->qUnk32 = +((s32)((0)*256));
...
void Task_Snowball(void)
{
    Snowball *proj = (void *)((gCurTask)->data);
    Sprite *s = &proj->s;
    ...
    proj->qUnk34 += ((s32)((40. / 256.)*256));
    s->y += ((int)((proj->qUnk34) >> 8));
    oldWorldX = s->x;
    oldWorldY32 = s->y;
...
void CreateEntity_Yukimaru_Wall(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    }
    {
        ...
        s = &yukimaru->s2;
        s->graphics.dest = VramMalloc(((32 / 8) * ((32 / 2) / 8)));
        yukimaru->base2.regionX = regionX;
        yukimaru->base2.regionY = regionY;
        yukimaru->base2.me = me;
        yukimaru->base2.meX = me->x;
...
void Task_YukimaruWallInit(void)
{
    ...
    deltaY = worldY + ((int)((yukimaru->qUnk7C) >> 8));
    ...
    yukimaru->qUnk7A += sa2__sub_801F07C(deltaX, deltaY, 1, +8, ((void*)0), sa2__sub_801ED24);

    if (((int)((yukimaru->qUnk7C) >> 8)) <= (me->d.sData[1]) * 8) {
        yukimaru->qUnk78 = +((s32)((0.625)*256));
    } else if (((int)((yukimaru->qUnk7C) >> 8)) >= (me->d.sData[1] + me->d.uData[3]) * 8) {
        yukimaru->qUnk78 = -((s32)((0.625)*256));
    } else if (yukimaru->unk80 != 0) {
        yukimaru->unk80--;
    } else {
        if ((((int)((gPlayer.qWorldX) >> 8)) <= deltaX) && (((int)((gPlayer.qWorldY) >> 8)) <= deltaY + 8) && (deltaY - 8 <= ((int)((gPlayer.qWorldY) >> 8)))) {
            yukimaru->unk80 = 60;
            yukimaru->qUnk7E = ((s32)((0)*256));
            s->variant = 0;
            s2->variant = 0;
...
{
    struct Task *t = TaskCreate(Task_Snowball2, sizeof(Snowball), 0x3000, 0, ((void*)0));
    Snowball *snowball = (void *)((t)->data);
    Sprite *s = &snowball->s;
