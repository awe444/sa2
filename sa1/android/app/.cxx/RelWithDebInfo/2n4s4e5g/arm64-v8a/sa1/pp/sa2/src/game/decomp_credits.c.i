# 1 "/home/awaszczak/git/sa2/sa1/../src/game/decomp_credits.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/decomp_credits.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/decomp_credits.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/flags.h" 1
# 23 "/home/awaszczak/git/sa2/sa1/../include/flags.h"
extern u32 gFlags;
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/decomp_credits.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/decomp_credits.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/decomp_credits.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/decomp_credits.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/decomp_credits.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/game.h" 1
...
void GameInit(void);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/decomp_credits.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/decomp_credits.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/decomp_credits.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/decomp_credits.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/decomp_credits.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/decomp_credits.c" 2
# 27 "/home/awaszczak/git/sa2/sa1/../src/game/decomp_credits.c"
typedef struct {
    Sprite sprSonic;
    Sprite sprTails;
    Sprite sprLogoOllie;
...
{
    s32 qTime = (({((((s32)((60)*256))) != 0) ? ((s32)((((s32)((frameNum)*256)) << 8)) / (s32)(((s32)((60)*256)))) : 0;}));

    s32 qNum = ((s32)((1)*256));
    s32 qDenom = ((((((((qTime * qTime) >> 8) * qTime) >> 8) * qTime) >> 8) * qTime) >> 8) + ((s32)((1)*256));
    return ({((qDenom) != 0) ? ((s32)((qNum << 8)) / (s32)(qDenom)) : 0;});
}
...
void CreateDecompCreditsScreen(bool32 hasProfile)
{
    ...
    cred->frames = 0;
    cred->logoFrameT0 = 0;
    cred->qSpeedSonic = +((s32)((5)*256));
    cred->qSpeedTails = -((s32)((0.5)*256));

    s = &cred->sprSonic;
    s->x = -508;
    s->y = (240 / 2) - 16;
    s->graphics.dest = VramMalloc(64); s->graphics.anim = ((9) + CHARACTER_SONIC * (91)); s->variant = 4; s->oamFlags = ((18) << 6); s->graphics.size = 0;; s->animCursor = 0; s->qAnimDelay = ((s32)((0)*256)); s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = 0; s->hitboxes[0].index = -1;;; s->frameFlags = (((2) << (12)) | (((1) << (10))));;;
    s->animSpeed = ((int)((float)(4)*0x10));
    cred->qSonicScreenX = ((s32)((s->x)*256));

    s = &cred->sprTails;
    s->x = 320 + 64 + 32;
    s->y = 240 - 48;
    s->graphics.dest = VramMalloc(64); s->graphics.anim = ((9) + CHARACTER_TAILS * (91)); s->variant = 0; s->oamFlags = ((18) << 6); s->graphics.size = 0;; s->animCursor = 0; s->qAnimDelay = ((s32)((0)*256)); s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = 0; s->hitboxes[0].index = -1;;; s->frameFlags = (((2) << (12)) | (0));;;
    s->palId = 1;
    cred->sprTails.animSpeed = ((int)((float)(1.5)*0x10));
    cred->qTailsScreenX = ((s32)((s->x)*256));
    ...
    cred->qLogoOllieScreenX = ((s32)((s->x)*256));
    ...
    cred->qLogoJaceScreenX = ((s32)((s->x)*256));


    gDispCnt |= (0x1000 | 0x0040);
    gDispCnt &= ~0x0080;

    cred->prevHBlank = gIntrTable[2];
    gIntrTable[2] = customHBlank;
...
void UpdateSprites(DCCredits *cred)
{
    ...
    s->x = ((int)((cred->qSonicScreenX) >> 8));

    s = &cred->sprTails;
    UpdateSpriteAnimation(s);
    DisplaySprite(s);
    cred->qTailsScreenX += cred->qSpeedTails;
    s->x = ((int)((cred->qTailsScreenX) >> 8));
    tailsIsCheering = (s->graphics.anim == ((33) + CHARACTER_TAILS * (91))) ? 1 : 0;
    ...
    s->x = ((int)((cred->qLogoOllieScreenX) >> 8));
    ...
    s->x = ((int)((cred->qLogoJaceScreenX) >> 8));
...
void Task_DecompCreditsFirst()
{
    DCCredits *cred = (void *)((gCurTask)->data);
    Sprite *s;

    UpdateSprites(cred);


    if (cred->sprLogoJace.x <= ((320 / 2) + 24)) {
        cred->sprTails.graphics.anim = ((33) + CHARACTER_TAILS * (91));
        cred->sprTails.variant = 0;
        cred->qSpeedTails = 0;
        cred->sprTails.animSpeed = ((int)((float)(1.0)*0x10));
    }

    if (cred->sprSonic.x > (cred->sprLogoOllie.x - (64 / 3))) {
        if (cred->logoFrameT0 == 0) {
            cred->logoFrameT0 = cred->frames;
            (&cred->sprLogoOllie)->frameFlags &= ~(((1) << (10)));
            m4aSongNumStart(232);
            cred->sprSonic.graphics.anim = ((8) + CHARACTER_SONIC * (91));
            cred->sprSonic.variant = 0;
        }

        if (cred->qSpeedSonic > 0) {
            cred->qSpeedSonic -= ((s32)((20.0 / 256.0)*256));

        } else {
            m4aSongNumStop(232);

            cred->sprSonic.graphics.anim = ((9) + CHARACTER_SONIC * (91));
            cred->sprSonic.variant = 2;
            cred->sprSonic.animSpeed = ((int)((float)(1.5)*0x10));
            (&cred->sprSonic)->frameFlags &= ~(((1) << (10)));
            cred->qSpeedSonic = -((s32)((1.5)*256));
        }
    ...
    if ((cred->qSpeedSonic <= 0) && cred->sprSonic.x < (320 / 2) + 16) {
        cred->qSpeedSonic = ((s32)((0)*256));

        cred->sprSonic.graphics.anim = ((34) + CHARACTER_SONIC * (91));
        cred->sprSonic.variant = 0;
        cred->sprSonic.animSpeed = ((int)((float)(1.0)*0x10));
...
void Task_SonicArrived(void)
{
    ...
    if (cred->sonicArrivedT0 > 7 * 60) {
        cred->sprSonic.graphics.anim = ((1) + CHARACTER_SONIC * (91));
        cred->sprSonic.variant = 0;
    }
    ...
    if (gFlags & 0x100) {
        ...
        CreateSegaLogo();
        {
            ...
            for (i = 0; i < NUM_CHARACTERS; i++) {
                (&gLoadedSaveGame)->unlockedLevels[i] = 0xF;
            }
        }
...
# 332 "/home/awaszczak/git/sa2/sa1/../src/game/decomp_credits.c"
    if (gFlags & 0x1000) {
...
void customHBlank(void)
{
    ...
    int_vcount vcount = (*(reg_u16 *)(REG_BASE + 0x6));
    if ((vcount >= 240 - 16 - 1) && (vcount < 240 - 1)) {

        ((u16 *)((ColorRaw*)&PLTT[0]))[0] = ((31) | ((31) << 5) | ((31) << 10));
    } else if ((vcount >= (240 / 2) - 1) && (vcount < 240 - 1)) {

        ((u16 *)((ColorRaw*)&PLTT[0]))[0] = ((u16 *)((ColorRaw*)&PLTT[0x200/sizeof(uint16_t)]))[3 * 16u];
    } else {

        ((u16 *)((ColorRaw*)&PLTT[0]))[0] = ((u16 *)((ColorRaw*)&PLTT[0x200/sizeof(uint16_t)]))[2 * 16u];
    }
}
