# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/player_data.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/player_data.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/player_data.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/player_data.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/player_data.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/player_data.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/player_data.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/player_data.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/player_data.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/player_data.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/player_data.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/player_data.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/text.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/player_data.c" 2
...
typedef struct PlayerDataMenu {
               Sprite s;
               Sprite s2[PDM_OPTION_COUNT + 1];
               StrcUi_805423C strcF0;
               GameOverB unkFC;
                u16 pressedKeys;
                u16 unk116;
                u8 unk118;
...
const AnimId sPlayerDataMenuAnims[2] = { 869, 868 };
...
const AnimId gPressStartTiles[2] = { 778, 779 };
...
void Task_PlayerDataMenuInit()
{
    ...
    PlayerDataMenu *menu = (void *)((gCurTask)->data);
...
void sub_8011C94()
{
    ...
    for (i = 0; i < 6; i++) {
        ...
        sub_8052F78((const char *)&(&gLoadedSaveGame)->playerName[i], &menu->unkFC);
    }
}
...
void TaskDestructor_PlayerDataMenu(struct Task *t)
{
    ...
    for (i = 0; i < (sizeof(menu->s2) / sizeof((menu->s2)[0])); i++) {
