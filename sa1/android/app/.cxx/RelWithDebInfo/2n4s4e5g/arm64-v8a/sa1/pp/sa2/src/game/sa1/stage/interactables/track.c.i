# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/track.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/track.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/track.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/track.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/track.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/track.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/track.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/track.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/track.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/track.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/track.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/track.c" 2
...
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/track.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 19 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/track.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/interactables.h" 1
# 20 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/track.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 21 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/track.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 22 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/track.c" 2
...
{
    struct Task *t = TaskCreate(Task_Track, sizeof(Track), me->d.uData[3] | 0x2000, 0, ((void*)0));
    Track *track = (void *)((t)->data);
    ...
    track->unk54 = me->d.sData[0] * 8;
    track->unk58 = me->d.sData[1] * 8;
...
void Task_Track(void)
{
    ...
    s16 screenX, screenY;
    Track *track = (void *)((gCurTask)->data);
    MapEntity *me = track->base.me;
    s32 i;

    worldX = ((track->base.meX)*8 + (track->base.regionX)*256);
    worldY = ((me->y)*8 + (track->base.regionY)*256);
    ...
    do {
        if ((((track->unk6C) >> (i)) & 1)) {
            if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
                if ((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] == track->unk3C[i]) {
                    s32 resA, resB;
                    resA = ({((track->unk3E) != 0) ? ((s32)(track->unk3F[i] * track->unk54) / (s32)(track->unk3E)) : 0;});
                    resB = ({((track->unk3E) != 0) ? ((s32)(track->unk3F[i] * track->unk58) / (s32)(track->unk3E)) : 0;});

                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = ((s32)((track->unk44[i] + resA)*256));
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((track->unk4C[i] + resB)*256));
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY - track->unk64[i];
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX - track->unk5C[i];
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround;
                    track->unk3F[i]++;

                    if ((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) == track->unk44[i] + track->unk54)
                        && (((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) == track->unk4C[i] + track->unk58)) {
                        if ((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] == track->unk3C[i]) {
                    ...
                    track->unk5C[i] = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX;
                    track->unk64[i] = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY;

                } else {
                    (track->unk6C) &= ~(1 << (i));
                }
            } else {
                (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00100000;
                (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00400000;
            ...
            if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
                if ((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] < track->unk3C[i] || track->unk3C[i] == 0) {
                    if ((worldX - 10 <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldX + 10 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)))
                        ...
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((worldY)*256));
                        ...
                        (*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] = track->unk3C[i];
                        (*(((i) != 0) ? &gPartner : &gPlayer)).itemEffect |= 0x80;
                    }
                }
            } else {
