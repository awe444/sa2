# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/half_pipe.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/half_pipe.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/half_pipe.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/half_pipe.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/half_pipe.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/half_pipe.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/half_pipe.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/half_pipe.c" 2
...
void Task_HalfPipeStart(void)
{
    HalfPipe *halfpipe = (void *)((gCurTask)->data);
    s32 i;
    ...
    do {
        ...
        oldWorldX = ((int)((p->qWorldX) >> 8));
        oldWorldY = ((int)((p->qWorldY) >> 8));

        if ((halfpipe->worldX > gCamera.x + 320 + 128) || (halfpipe->worldX < gCamera.x - 800)
            || (halfpipe->worldY > gCamera.y + 240 + 128) || (halfpipe->worldY < gCamera.y - 128)) {
        ...
        if ((halfpipe->left <= oldWorldX) && (oldWorldX < halfpipe->right) && (halfpipe->top <= oldWorldY)
            ...
            if (p->qSpeedAirX > +((s32)((2.25)*256))) {
                if (!(p->moveState & 0x00000002) && (p->sa2__unk62 == 0)) {
                    p->moveState |= 0x00008000;
                    halfpipe->qOffsetY = p->qWorldY + ((s32)((p->spriteOffsetY)*256));
                } else {
                    p->moveState &= ~0x00008000;
                }
            } else {
            ...
            if ((p->moveState & 0x00008000) && (halfpipe->right <= oldWorldX)) {
                s16 qSpeed;
                if (!(!((p)->moveState & 0x00000080))) {
                    return;
                }

                qSpeed = p->qSpeedAirX + ((s32)((2.25)*256)) - 1;
                if ((qSpeed >= ((s32)((0)*256)) && qSpeed < ((s32)((4.5)*256)) - 1) || (p->frameInput & gPlayerControls.jump)) {
                    p->moveState &= ~0x00008000;

                    if (p->charState == 24 || p->charState == 25
                        || p->charState == 26) {
                        p->charState = 4;
                    }

                } else if ((p->qSpeedAirX >= +((s32)((2.25)*256)))) {
...
void Task_HalfPipeEnd(void)
{
    ...
    do {
        ...
        if ((halfpipe->worldX > gCamera.x + 320 + 800) || (halfpipe->worldX < gCamera.x - 128)
            || (halfpipe->worldY > gCamera.y + 240 + 128) || (halfpipe->worldY < gCamera.y - 128)) {
            p->moveState &= ~0x00008000;
        ...
        if ((halfpipe->left <= oldWorldX) && (oldWorldX < halfpipe->right) && (halfpipe->top <= oldWorldY)
            ...
            if ((p->moveState & 0x00008000) && (oldWorldX < halfpipe->left)) {
                s16 qSpeed;
                if (!(!((p)->moveState & 0x00000080))) {
                    return;
                }
                ...
                if ((qSpeed >= ((s32)((0)*256)) && qSpeed < ((s32)((4.5)*256)) - 1) || (p->frameInput & gPlayerControls.jump)) {
                    ...
                    sub_804D4A0(oldWorldX - halfpipe->left + ((s32)((2.625)*256)), halfpipe->qOffsetY, p);
                }
            }
        }
    } while (++i < gNumSingleplayerCharacters);
...

{
    ...
    if (param0 >= 0 && param0 < 0x2A0) {
        s16 qSpeedAirX = (((p->qSpeedAirX) >= 0 ? (p->qSpeedAirX) : -(p->qSpeedAirX)) - ((s32)((2.25)*256))) >> 2;

        if (qSpeedAirX >= ((s32)((0)*256))) {
            if (qSpeedAirX > ((s32)((1)*256))) {
                qSpeedAirX = ((s32)((1)*256));
            }
        } else {
            qSpeedAirX = 0;
        }

        r6 = ((int)(((gSineTable[((u16)qSpeedAirX)])) >> 6));
        ...
        if (param0 < 0x150) {
            ...
            divParam0 = ((param0 - ((s32)((2.625)*256))) << 15);
        }
        ...
        r1 = -(gSineTable[(theta) + 256]);

        r0 = ((r1 * 3 >> 2) + ((s32)((48)*256)));
        r0 *= r6;
        r0 = ((int)((r0) >> 8));
        r6 = r0;
    }
    ...
    if (!(p->moveState & 0x00000004)) {
        ...
        if (p->sa2__unk62 == 0) {
            if (p->charState == 4
                || (p->charState == 24 || p->charState == 25
                    || p->charState == 26)) {
                if (r6 < ((s32)((8)*256))) {
                    p->charState = 4;
                } else if (r6 < ((s32)((24)*256))) {
                    p->charState = 24;
                } else if (r6 < ((s32)((48)*256))) {
                    p->charState = 25;
                } else {
                    p->charState = 26;
                }
...
{
    struct Task *t = TaskCreate(Task_HalfPipeStart, sizeof(HalfPipe), 0x2000, 0, ((void*)0));
    HalfPipe *halfpipe = (void *)((t)->data);
    s32 worldX, worldY;
    ...
    worldX = ((regionX)*256 + (me->x)*8);
    worldY = ((regionY)*256 + (me->y)*8);

    halfpipe->worldX = worldX;
    halfpipe->worldY = worldY;

    halfpipe->left = worldX + me->d.sData[0] * 8;
    halfpipe->top = worldY + me->d.sData[1] * 8;
    halfpipe->right = halfpipe->left + me->d.uData[2] * 8;
    halfpipe->bottom = halfpipe->top + me->d.uData[3] * 8;
...
{
    struct Task *t = TaskCreate(Task_HalfPipeEnd, sizeof(HalfPipe), 0x2000, 0, ((void*)0));
    HalfPipe *halfpipe = (void *)((t)->data);
    s32 worldX, worldY;
