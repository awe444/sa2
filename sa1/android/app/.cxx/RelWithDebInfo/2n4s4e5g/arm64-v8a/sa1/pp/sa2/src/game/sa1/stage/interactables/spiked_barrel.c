# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spiked_barrel.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spiked_barrel.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spiked_barrel.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spiked_barrel.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spiked_barrel.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spiked_barrel.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spiked_barrel.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spiked_barrel.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spiked_barrel.c" 2
...
void CreateEntity_SpikedBarrel(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    SpikedBarrel *barrel = (void *)((t)->data);
    Sprite *s = &barrel->s;
...
void Task_SpikedBarrel(void)
{
    ...
    if (barrel->unk50 != 0) {
        r8 = barrel->unk48;
        r3 = ((s32)((me->d.uData[2] * 8)*256));
        theta = ({ s16 clamped = (barrel->unk50 * ((gStageTime + barrel->unk44) & 0xFF)) & (1024 - 1); clamped; });
        barrel->unk48 = (r3 * (gSineTable[(theta)])) >> 14;
    ...
    if (barrel->unk52 != 0) {
        r6 = barrel->unk4C;
        r3 = ((s32)((me->d.uData[3] * 8)*256));
        theta = ({ s16 clamped = (barrel->unk52 * ((gStageTime + barrel->unk44) & 0xFF)) & (1024 - 1); clamped; });
        barrel->unk4C = (r3 * (gSineTable[(theta)])) >> 14;
        r6 = barrel->unk4C - r6;
        qSp10 = r6;
    } else {
    ...
    worldX = ((barrel->base.meX)*8 + (barrel->base.regionX)*256);
    worldY = ((me->y)*8 + (barrel->base.regionY)*256);

    s->x = worldX - gCamera.x + ({((0x100) != 0) ? ((s32)(barrel->unk48) / (s32)(0x100)) : 0;});
    s->y = worldY - gCamera.y + ({((0x100) != 0) ? ((s32)(barrel->unk4C) / (s32)(0x100)) : 0;});
    ...
    do {
        ...
        if ((p->moveState & 0x00000008) && (p->stoodObj == s)) {
            p->qWorldX += qSp0C;
            p->qWorldY += ((s32)((1)*256)) + qSp10;
        }


        Coll_Player_PlatformCrumbling(s, ((int)((barrel->unk48) >> 8)) + worldX, ((int)((barrel->unk4C) >> 8)) + worldY, p);
        ...
        if ((barrel->unk56 == 0) || (barrel->unk56 == 2)) {
            if (s->hitboxes[1].index != -1) {
                ...
                if ((((((worldX + ({((0x100) != 0) ? ((s32)(barrel->unk48) / (s32)(0x100)) : 0;})) + (&s->hitboxes[1].b)->left) <= ((((int)((p->qWorldX) >> 8))) + (&p->spriteInfoBody->s.hitboxes[0].b)->left) && (((worldX + ({((0x100) != 0) ? ((s32)(barrel->unk48) / (s32)(0x100)) : 0;})) + (&s->hitboxes[1].b)->left) + ((&s->hitboxes[1].b)->right - (&s->hitboxes[1].b)->left)) >= ((((int)((p->qWorldX) >> 8))) + (&p->spriteInfoBody->s.hitboxes[0].b)->left)) || (((worldX + ({((0x100) != 0) ? ((s32)(barrel->unk48) / (s32)(0x100)) : 0;})) + (&s->hitboxes[1].b)->left) >= ((((int)((p->qWorldX) >> 8))) + (&p->spriteInfoBody->s.hitboxes[0].b)->left) && (((((int)((p->qWorldX) >> 8))) + (&p->spriteInfoBody->s.hitboxes[0].b)->left) + ((&p->spriteInfoBody->s.hitboxes[0].b)->right - (&p->spriteInfoBody->s.hitboxes[0].b)->left)) >= ((worldX + ({((0x100) != 0) ? ((s32)(barrel->unk48) / (s32)(0x100)) : 0;})) + (&s->hitboxes[1].b)->left))) && (((((worldY + ({((0x100) != 0) ? ((s32)(barrel->unk4C) / (s32)(0x100)) : 0;}))) + (&s->hitboxes[1].b)->top) <= (((((int)((p->qWorldY) >> 8)))) + (&p->spriteInfoBody->s.hitboxes[0].b)->top) && ((((worldY + ({((0x100) != 0) ? ((s32)(barrel->unk4C) / (s32)(0x100)) : 0;}))) + (&s->hitboxes[1].b)->top) + ((&s->hitboxes[1].b)->bottom - (&s->hitboxes[1].b)->top)) >= (((((int)((p->qWorldY) >> 8)))) + (&p->spriteInfoBody->s.hitboxes[0].b)->top)) || ((((worldY + ({((0x100) != 0) ? ((s32)(barrel->unk4C) / (s32)(0x100)) : 0;}))) + (&s->hitboxes[1].b)->top) >= (((((int)((p->qWorldY) >> 8)))) + (&p->spriteInfoBody->s.hitboxes[0].b)->top) && ((((((int)((p->qWorldY) >> 8)))) + (&p->spriteInfoBody->s.hitboxes[0].b)->top) + ((&p->spriteInfoBody->s.hitboxes[0].b)->bottom - (&p->spriteInfoBody->s.hitboxes[0].b)->top)) >= (((worldY + ({((0x100) != 0) ? ((s32)(barrel->unk4C) / (s32)(0x100)) : 0;}))) + (&s->hitboxes[1].b)->top))))) {
    ...
    if (((worldX) > gCamera.x + (320 + (256 / 2)) || (worldX) < gCamera.x - (256 / 2) || (worldY) > gCamera.y + ((240) + ((256) / 2)) || (worldY) < gCamera.y - (256 / 2)) && (((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
        { me->x = barrel->base.meX; };
        TaskDestroy(gCurTask);
        return;
    } else if (((gPlayer.moveState & 0x00000008) && (gPlayer.stoodObj == s))
               || ((gNumSingleplayerCharacters == 2) && ((gPartner.moveState & 0x00000008) && (gPartner.stoodObj == s)))) {
    ...
    s->y += ((gSineTable[(barrel->unk54)]) >> 12);
