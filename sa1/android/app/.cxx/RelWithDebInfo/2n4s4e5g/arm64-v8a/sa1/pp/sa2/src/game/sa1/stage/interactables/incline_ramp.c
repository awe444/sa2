# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/incline_ramp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/incline_ramp.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/incline_ramp.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/incline_ramp.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/incline_ramp.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/incline_ramp.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/incline_ramp.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/incline_ramp.c" 2
...
# 28 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/incline_ramp.c"
void Task_InclineRamp(void)
{
    InclineRamp *ramp = (void *)((gCurTask)->data);
    MapEntity *me = *(MapEntity * *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(InclineRamp, me));
    u8 meX = *(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(InclineRamp, meX));

    u16 regionX = *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(InclineRamp, regionX));
    u16 regionY = *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(InclineRamp, regionY));
    u8 incline = *(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(InclineRamp, incline));
    s16 worldX, worldY;
    s16 screenX, screenY;
    s32 i;

    worldX = ((meX)*8 + (regionX)*256);
    worldY = ((me->y)*8 + (regionY)*256);

    i = 0;
    do {

        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            if (worldX > ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) {
                continue;
            }


            if (worldX + me->d.uData[2] * 8 < ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) {
                continue;
            }

            if (worldY > ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8))) {
                continue;
            }

            if (worldY + me->d.uData[3] * 8 < ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8))) {
                continue;
            }

            if (incline != 0) {
                if ((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX > ((s32)((4)*256))) {
                    ...
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = -((s32)((8)*256));
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX += +((s32)((4)*256));

                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX > ((s32)((17)*256))) {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = ((s32)((17)*256));
                    }
            ...
            } else if ((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX < -((s32)((4)*256))) {
...
{
    struct Task *t = TaskCreate(Task_InclineRamp, sizeof(InclineRamp), 0x2000, 0, ((void*)0));



    *(u16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(InclineRamp, regionX)) = (regionX);;
    *(u16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(InclineRamp, regionY)) = (regionY);;
    *(MapEntity * *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(InclineRamp, me)) = (me);;
    *(u8 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(InclineRamp, incline)) = (me->d.sData[0]);;
    *(u8 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(InclineRamp, meX)) = (me->x);;
