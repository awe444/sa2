# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/spot_lights_manager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/spot_lights_manager.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/spot_lights_manager.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/spot_lights_manager.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/spot_lights_manager.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/spot_lights_manager.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/spot_lights_manager.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/spot_lights_manager.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/spot_lights_manager.c" 2


# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/parameters/stage.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/spot_lights_manager.c" 2
...
bool32 CreateSpotlightsManager(void)
{
...

    {
        ...
        beam = (void *)((manager->spotlightTaskA)->data);
        beam->unk6 = 60;
        beam->unk8 = 200;
        beam->unk0 = 0;
        ...
        beam = (void *)((manager->spotlightTaskB)->data);
        beam->unk6 = 200;
        beam->unk8 = 240;
        beam->unk0 = 0;
        ...
        gBldRegs.bldCnt = ((3 << 6) | ((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11) | (1 << 12) | (1 << 13)) | (((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3) | (1 << 4) | (1 << 5)) & ~(1 << 5)));
        gBldRegs.bldY = ((int)((manager->qBlend) >> 8));
...
void Task_SpotlightsManagerMain(void)
{
    SpotlightsManager *manager = (void *)((gCurTask)->data);
# 145 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/spot_lights_manager.c"
    gDispCnt |= (0x2000 | 0x4000);


    gWinRegs[4] = ((((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3)) | (1 << 4) | (1 << 5)) & ~(1 << 5)) | ((((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11)) | (1 << 12) | (1 << 13)) & ~(1 << 13));
    ...
    manager->qBlend -= ((s32)((0.25)*256));

    if (manager->qBlend < ((s32)((8.0)*256))) {
        manager->qBlend = ((s32)((8.0)*256));
    }
    ...
    if (((gPlayer.moveState & 0x00000080) && (1 == 1)) || gDestroySpotlights) {
...
void Task_801796C(void)
{
    ...
    if ((((int)((gPlayer.qWorldX) >> 8)) > 1488) || !(!(gPlayer.moveState & 0x00000080)) || gDestroySpotlights) {
        TaskDestroy(manager->spotlightTaskA);
        TaskDestroy(manager->spotlightTaskB);
        TaskDestroy(gCurTask);
        return;
...
# 247 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/spot_lights_manager.c"
