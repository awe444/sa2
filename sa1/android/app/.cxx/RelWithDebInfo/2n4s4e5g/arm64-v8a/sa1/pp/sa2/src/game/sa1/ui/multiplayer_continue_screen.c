# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/multiplayer_continue_screen.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/multiplayer_continue_screen.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/multiplayer_continue_screen.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/multiplayer_continue_screen.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/multiplayer_continue_screen.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/multiplayer_continue_screen.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/multiplayer_continue_screen.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/multiplayer_continue_screen.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/multiplayer_continue_screen.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/multiplayer_continue_screen.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/multiplayer_continue_screen.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/text.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/multiplayer_continue_screen.c" 2
...
extern u16 gUnknown_0868B76C[3][2];
extern u8 gUnknown_0868B778[3][2];
extern AnimId gUnknown_0868B782[2];
extern AnimId gUnknown_0868B786[2];
...
void CreateMultiplayerContinueScreen(void)
{
    ...
    uiLang = (&gLoadedSaveGame)->uiLanguage;
    ...
    screen = (void *)((TaskCreate(Task_MultiplayerContinueScreen, sizeof(ContinueScreen), 0x2000U, 0U, TaskDestructor_MultiplayerContinueScreen))->data);
    ...
    s->graphics.anim = gUnknown_0868B782[1];
    s->variant = gUnknown_0868B786[1];
    s->x = 101;
    s->y = 81;
    s->graphics.size = 0;
    s->animCursor = 0;
...
void Task_MultiplayerContinueScreen()
{
    ...
    ContinueScreen *screen = (void *)((gCurTask)->data);
    union MultiSioData *recv_send;

    strc160 = &screen->strc160;
    if (screen->unk16E > 120) {
        if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
            for (var_r3 = 0; var_r3 < 4 && (((gMultiplayerConnections) >> (var_r3)) & 1); var_r3++) {
            ...
            if (screen->unk170 == 0) {
                ...
                if (0x0001 & gPressedKeys) {
                    ...
                    for (var_r2_2 = 0; var_r2_2 < 4; var_r2_2++) {
                        if (var_r2_2 != ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) {
                            struct MultiSioData_0_0 *pat0;
                            if (!(((gMultiplayerConnections) >> (var_r2_2)) & 1)) {
                                break;
                            }
...
void TaskDestructor_MultiplayerContinueScreen(struct Task *t)
{
    ContinueScreen *screen = (void *)((t)->data);
    u8 i;
