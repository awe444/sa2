# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/rhinotank.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/rhinotank.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/rhinotank.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/rhinotank.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/rhinotank.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/rhinotank.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/rhinotank.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/rhinotank.c" 2
...
void CreateEntity_Rhinotank(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    Rhinotank *rhinotank = (void *)((t)->data);
    ...
    rhinotank->qSpeedX = -((s32)((0.625)*256));
    rhinotank->qUnk40 = 0;
    rhinotank->unk3C = ((s32)((0)*256));
    rhinotank->unk44 = 0;
    rhinotank->doTackle = 0;
    rhinotank->unk49 = 0;
...
void Task_RhinotankInit(void)
{
    Rhinotank *rhinotank = (void *)((gCurTask)->data);
    Sprite *s = &rhinotank->shared.s;
    ...
    worldX = ((rhinotank->shared.base.meX)*8 + (rhinotank->shared.base.regionX)*256);
    worldY = ((me->y)*8 + (rhinotank->shared.base.regionY)*256);
    ...
    worldX += ({((0x100) != 0) ? ((s32)(rhinotank->qUnk40) / (s32)(0x100)) : 0;});
    ...
    if (((worldX2) > gCamera.x + (320 + (256 / 2)) || (worldX2) < gCamera.x - (256 / 2) || (worldY2) > gCamera.y + ((240) + ((256) / 2)) || (worldY2) < gCamera.y - (256 / 2)) && (((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
        { me->x = rhinotank->shared.base.meX; };
        ...
        rhinotank->unk3C += sa2__sub_801F07C(worldY, worldX, 1, +8, &sp08, sa2__sub_801EE64);

        if (((int)((rhinotank->qUnk40) >> 8)) <= (me->d.sData[0] + 1) * 8) {
            if (~s->frameFlags & ((1) << (10))) {
                if (rhinotank->doTackle) {
                    rhinotank->qUnk40 += ((s32)((3)*256));
                }
        ...
        } else if (((int)((rhinotank->qUnk40) >> 8)) >= ((me->d.sData[0] + me->d.uData[2]) - 1) * 8) {
            if (s->frameFlags & ((1) << (10))) {
                if (rhinotank->doTackle) {
                    rhinotank->qUnk40 -= ((s32)((3)*256));
                }
        ...
        } else if (!rhinotank->doTackle && ((int)((gPlayer.qWorldY) >> 8)) <= (worldY + 8) && (worldY - 32 <= ((int)((gPlayer.qWorldY) >> 8)))) {

            if (s->frameFlags & ((1) << (10))) {
                if ((((int)((gPlayer.qWorldX) >> 8)) >= worldX) && (worldX + 80 >= ((int)((gPlayer.qWorldX) >> 8)))) {
                    rhinotank->doTackle = 1;
                    rhinotank->unk44 = 0;
                    rhinotank->qSpeedX = +((s32)((3)*256));
                    s->variant = 1;
...
void Task_806C9A0(void)
{
    ...
    worldX = worldX2 + ((int)((rhinotank->qUnk40) >> 8));
    ...
    if (((worldX2) > gCamera.x + (320 + (256 / 2)) || (worldX2) < gCamera.x - (256 / 2) || (worldY2) > gCamera.y + ((240) + ((256) / 2)) || (worldY2) < gCamera.y - (256 / 2)) && (((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
        ...
        if (s->frameFlags & ((1) << (10))) {
            rhinotank->qUnk40 += ({((divisor) != 0) ? ((s32)((gSineTable[(rhinotank->unk44 * 21) + 256])) / (s32)(divisor)) : 0;});
        } else {
            rhinotank->qUnk40 -= ({((divisor) != 0) ? ((s32)((gSineTable[(rhinotank->unk44 * 21) + 256])) / (s32)(divisor)) : 0;});
        }
