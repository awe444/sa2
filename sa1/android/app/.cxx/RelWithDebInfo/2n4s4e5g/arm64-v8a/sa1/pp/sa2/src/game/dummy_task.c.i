# 1 "/home/awaszczak/git/sa2/sa1/../src/game/dummy_task.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/dummy_task.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/dummy_task.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/dummy_task.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/dummy_task.c" 2

struct Task *gDummyTask = ((void*)0);

static void Task_DummyFunc(void);
static void DummyTaskOnDestroy(struct Task *);

__attribute__((unused)) void CreateDummyTask(void) { gDummyTask = TaskCreate(Task_DummyFunc, 0, 0x100, 0, DummyTaskOnDestroy); }

__attribute__((unused)) static void DestroyDummyTask(void)
{
...
__attribute__((unused)) static void DummyTaskOnDestroy(struct Task *task) { gDummyTask = ((void*)0); }
