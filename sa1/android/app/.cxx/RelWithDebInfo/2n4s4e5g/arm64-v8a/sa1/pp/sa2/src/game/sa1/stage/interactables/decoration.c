# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/decoration.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/decoration.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/decoration.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/decoration.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/decoration.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/decoration.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/decoration.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/decoration.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/decoration.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/decoration.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/decoration.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/decoration.c" 2
...
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/decoration.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 19 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/decoration.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/interactables.h" 1
# 20 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/decoration.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 21 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/decoration.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 22 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/decoration.c" 2
...
void Task_DecorationMain(void)
{
    Decoration *deco = (void *)((gCurTask)->data);
    Sprite *s = &deco->shared.s;
    MapEntity *me = deco->shared.base.me;
    CamCoord worldX, worldY;

    worldX = ((deco->shared.base.meX)*8 + (deco->shared.base.regionX)*256);
    worldY = ((me->y)*8 + (deco->shared.base.regionY)*256);
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1)))) && ((s8)me->x == (-3))) {
        ...
        if (sub_800C394(s, worldX, worldY, &gPlayer)
            ...
            || ((gNumSingleplayerCharacters == 2) && sub_800C394(s, worldX, worldY, &gPartner))) {
            CreateDustCloud(worldX, worldY);
...
void CreateDecorationDebris(s16 vecX, s16 vecY)
{
    ...
    DecorationDebris *debris = (void *)((t)->data);
    Sprite *s = &debris->s1;
    ...
    DmaSet(3, s, &debris->s2, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(debris->s2))/(16/8))));
    s = &debris->s2;
    DmaSet(3, tf, &debris->transform2, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(debris->transform2))/(16/8))));
    ...
    DmaSet(3, tf, &debris->transform3, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(*tf))/(16/8))));
    ...
    DmaSet(3, s, &debris->s4, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(debris->s4))/(16/8))));
    s = &debris->s4;
    DmaSet(3, tf, &debris->transform4, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(debris->transform4))/(16/8))));
    ...
    s->frameFlags = ((1) << (5)) | ((1) << (6)) | ((19) << (0));
    tf->y = vecY - 16;
}

void Task_DecorationDebrisMain(void)
{
    DecorationDebris *debris = (void *)((gCurTask)->data);
    Sprite *s = &debris->s1;
    SpriteTransform *tf;
