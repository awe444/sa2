# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/egg_rocket_transitions.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/egg_rocket_transitions.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/egg_rocket_transitions.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/egg_rocket_transitions.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/egg_rocket_transitions.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/egg_rocket_transitions.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/egg_rocket_transitions.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/egg_rocket_transitions.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/egg_rocket_transitions.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/egg_rocket_transitions.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/egg_rocket_transitions.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/egg_rocket_transitions.c" 2


# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/egg_rocket_transitions.c" 2
...
{
    struct Task *t = TaskCreate(Task_8028CE4, sizeof(EggRocketScreenShake), 0x4000, 0, ((void*)0));
    EggRocketScreenShake *shake = (void *)((t)->data);
    ...
    gCamera.maxY = worldY + 240;
}


void Task_8028CE4(void)
{
    EggRocketScreenShake *shake = (void *)((gCurTask)->data);
    u32 i;

    if (++gCamera.shiftY >= shake->worldY - gCamera.y + (240 / 2)) {
        ...
        for (i = 0; i < 3; i++) {
            s32 index = ({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) % 8u;
            s32 index2;
            ...
            nuts->qUnk30 = ((s32)((prevCamX + (({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0xFF))*256));
            nuts->qUnk34 = ((s32)((prevCamY)*256));

            nuts->s.frameFlags = 0x3000;
            nuts->s.oamFlags = ((31) << 6);
            nuts->qUnk3E = ((s32)((40. / 256.)*256));
            nuts->qUnk40 = ((s32)((1)*256));

            index2 = ({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x1FF;
            nuts->qUnk3A = ((gSineTable[(index2)]) >> 6);

            nuts->qUnk3A = ((nuts->qUnk3A) >= 0 ? (nuts->qUnk3A) : -(nuts->qUnk3A));

            nuts->qUnk38 = -((gSineTable[(index2) + 256]) << 8) >> 14;
        }
        ...
        for (i = 0; i < 3; i++) {
            ...
            nuts->qUnk30 = ((s32)((prevCamX + (({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) % 256u))*256));
            nuts->qUnk34 = ((s32)((prevCamY)*256));

            nuts->s.frameFlags = 0x0000;
            nuts->s.oamFlags = ((16) << 6);
            nuts->qUnk3E = ((s32)((40. / 256.)*256));
            nuts->qUnk40 = ((s32)((1)*256));

            index2 = (({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) % 512u);
            nuts->qUnk3A = ((gSineTable[(index2)]) >> 5);
            nuts->qUnk3A = ((nuts->qUnk3A) >= 0 ? (nuts->qUnk3A) : -(nuts->qUnk3A));

            nuts->qUnk38 = -((gSineTable[(index2) + 256]) << 9) >> 14;
        }
...
void Task_8028F20(void)
{
    ...
    shake->qUnk6 += ((s32)((8. / 256.)*256));
    shake->qUnk8 += ((s32)((16. / 256.)*256));

    ip = shake->worldY + ((int)((shake->qUnk6) >> 8)) - gCamera.y;
    r7 = shake->worldY + ((int)((shake->qUnk8) >> 8)) - gCamera.y;

    if ((shake->qUnk6 >= ((s32)((4)*256))) && ((gBossIndex == 2) || ((-(gStageTime * 2) & 0x1FF) == 0x102))) {
        ...
        if (shake->worldY - gCamera.y > 0) {
            sa2__sub_80078D4(2, 0, shake->worldY - gCamera.y, gBgScrollRegs[2][0], gBgScrollRegs[2][1]);

            sa2__sub_8007858(2, shake->worldY - gCamera.y, r7, gBgScrollRegs[2][0], (240 + 80));
        } else {
            sa2__sub_8007858(2, 0, r7, gBgScrollRegs[2][0], (240 + 80));
        }
        sa2__sub_80078D4(2, r7, 240, gBgScrollRegs[2][0], gBgScrollRegs[2][1] - ((int)((shake->qUnk8) >> 8)));
    } else {
        gFlags &= ~0x4;
    }
}
...
void Task_8029194(void)
{
    ...
    shake->qUnk8 += ((s32)((2)*256));
    shake->qUnk6 += ((s32)((1)*256));
    shake->unkA--;
    ...
    if ((shake->unkC++ & 0xF) == 0) {
        ...
        for (i = 0; i < 3; i++) {
            s32 index2;
            index = ((({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & ((-0) + (7))) + (0));

            t = CreateNutsAndBoltsTask(0x2000, VramMalloc(gUnknown_080BB434[index]), gUnknown_080BB41C[index], gUnknown_080BB42C[index],
                                       TaskDestructor_NutsAndBolts);
            nuts = (void *)((t)->data);

            nuts->qUnk30 = ((s32)((((({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & ((-prevCamX) + (prevCamX + 255))) + (prevCamX)))*256));
            nuts->qUnk34 = ((s32)((prevCamY)*256));
        ...
        for (i = 0; i < 3; i++) {
            ...
            index2 = ((({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & ((-0) + (511))) + (0));
            nuts->qUnk3A = ((gSineTable[(index2)]) >> 5);
            nuts->qUnk3A = ((nuts->qUnk3A) >= 0 ? (nuts->qUnk3A) : -(nuts->qUnk3A));
...
void Task_80294A8(void)
{
    ...
    if ((shake->unkC++ & 0xF) == 0) {
        ...
        for (i = 0; i < 3; i++) {
            s32 index = ((({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & ((-0) + (7))) + (0));
            s32 index2;
    ...
    if (gCamera.y <= shake->worldY - 240) {
        ...
        sa2__sub_80078D4(2, 0, shake->worldY - gCamera.y, gBgScrollRegs[2][0], gBgScrollRegs[2][1]);
        sa2__sub_8007858(2, shake->worldY - gCamera.y, 240, gBgScrollRegs[2][0], (240 + 80));
    } else {
        sa2__sub_8007858(2, 0, 240, gBgScrollRegs[2][0], (240 + 80));
    }
}
...
{
    struct Task *t = TaskCreate(Task_80298C0, sizeof(EggRocketScreenShake), 0x4000, 0, ((void*)0));
    EggRocketScreenShake *shake = (void *)((t)->data);

    shake->unkC = (int)(((0 * 60.) + 1) * 60);

    CreateScreenShake(0x800, 8, 16, 10, 0x80);
...
void Task_80298C0()
{
    ...
    if (--shake->unkC == 0) {
        shake->unkC = (int)(((0 * 60.) + 5) * 60);
        CreateScreenShake(0x800, 8, 16, 300, (0x80 | 0x10));
