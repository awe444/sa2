# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/pipe.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/pipe.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/pipe.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/pipe.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/pipe.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/pipe.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/pipe.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/pipe.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/pipe.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/pipe.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/pipe.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/pipe.c" 2
...
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/pipe.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 19 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/pipe.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/interactables.h" 1
# 20 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/pipe.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 21 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/pipe.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 22 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/pipe.c" 2
...
void CreateEntity_PipeEntrance(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    do {
        ...
        pipe->unk48 = me->d.sData[0] * 8;
        pipe->unk4C = me->d.sData[1] * 8;
        ...
        if (pipe->unk59 == 0 || pipe->unk59 == 1) {
            ...
            if ((((gCurrentLevel) >> 1) == 5) || (gCurrentLevel == (14 + 3))) {
                if ((gCurrentLevel & 0x1) != 0) {
                    s->graphics.dest = (i == 0) ? VramMalloc(((56 / 8) * (88 / 8))) : ((void*)0);
                    s->graphics.anim = 591;
                    ...
                    s->graphics.dest = (i == 0) ? VramMalloc(((56 / 8) * (80 / 8))) : ((void*)0);
                    s->graphics.anim = 584;
            ...
            if ((((gCurrentLevel) >> 1) == 5) || (gCurrentLevel == (14 + 3))) {
                if ((gCurrentLevel & 0x1) != 0) {
                    s->graphics.dest = (i == 0) ? VramMalloc(((104 / 8) * (56 / 8))) : ((void*)0);
                    s->graphics.anim = 590;

                    s->variant = 0;
                } else {
                    s->graphics.dest = (i == 0) ? VramMalloc(((80 / 8) * (56 / 8))) : ((void*)0);
                    s->graphics.anim = 586;
...
void Task_PipeEntrance(void)
{
    ...
    u32 mask;
    u32 res;
    pipe = (void *)((gCurTask)->data);
    me = pipe->base.me;
    s = &pipe->s;
    p = &(*(((pipe->unk3C) != 0) ? &gPartner : &gPlayer));

    worldX = ((pipe->base.meX)*8 + (pipe->base.regionX)*256);
    worldY = ((me->y)*8 + (pipe->base.regionY)*256);
...
void Task_8095D28(void)
{
    PipeEntrance *pipe = (void *)((gCurTask)->data);
    MapEntity *me = pipe->base.me;
    Sprite *s = &pipe->s;
    Player *p = &(*(((pipe->unk3C) != 0) ? &gPartner : &gPlayer));
    ...
    if ((!((p)->moveState & 0x00000080))) {
        if (pipe->unk3F != 0) {
            if (p->qWorldY != ((s32)((worldY)*256))) {
                if (p->qWorldY < ((s32)((worldY)*256))) {
                    p->qWorldY += ((s32)((1.5)*256));

                    if (p->qWorldY > ((s32)((worldY)*256))) {
                        p->qWorldY = ((s32)((worldY)*256));
                    }
                } else {
                    p->qWorldY -= ((s32)((1.5)*256));
            ...
            if (p->qWorldX != ((s32)((worldX)*256))) {
                if (p->qWorldX < ((s32)((worldX)*256))) {
                    p->qWorldX += ((s32)((1.5)*256));

                    if (p->qWorldX > ((s32)((worldX)*256))) {
                        p->qWorldX = ((s32)((worldX)*256));
                    }
                } else {
                    p->qWorldX -= ((s32)((1.5)*256));
...
void Task_8095E90(void)
{
    ...
    if (pipe->unk58) {
        if ((!((p)->moveState & 0x00000080))) {
            if (p->sa2__unk99[0] == pipe->unk3D) {
                s32 r6 = ({((pipe->unk3E) != 0) ? ((s32)(pipe->unk48 * pipe->unk3F) / (s32)(pipe->unk3E)) : 0;});
                s32 res2 = ({((pipe->unk3E) != 0) ? ((s32)(pipe->unk4C * pipe->unk3F) / (s32)(pipe->unk3E)) : 0;});

                p->qWorldX = ((s32)((pipe->unk40 + r6)*256));
                p->qWorldY = ((s32)((pipe->unk44 + res2)*256));
                ...
                if ((((int)((p->qWorldX) >> 8)) == pipe->unk40 + pipe->unk48) && (((int)((p->qWorldY) >> 8)) == pipe->unk44 + pipe->unk4C)) {
                    if (p->sa2__unk99[0] == pipe->unk3D) {
                        p->moveState &= ~0x00400000;
...
void Task_809656C(void)
{
    PipeExit *pipe = (void *)((gCurTask)->data);
    MapEntity *me = pipe->base.me;
    Sprite *s = &pipe->s;
    Player *p = &(*(((pipe->unk3C) != 0) ? &gPartner : &gPlayer));
    CamCoord worldX, worldY;
