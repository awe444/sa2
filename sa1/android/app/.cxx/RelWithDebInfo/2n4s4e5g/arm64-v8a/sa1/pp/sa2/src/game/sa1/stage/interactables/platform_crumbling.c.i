# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_crumbling.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_crumbling.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_crumbling.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_crumbling.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_crumbling.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_crumbling.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_crumbling.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_crumbling.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_crumbling.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_crumbling.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_crumbling.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_crumbling.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/interactables.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_crumbling.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_crumbling.c" 2
...
const AnimId sPlatformCrumblingAnims[18] = {
    906,
    906,
    502,
    502,
...
void CreateEntity_PlatformCrumbling(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    PlatformCrumbling *platform = (void *)((t)->data);
    ...
    s->graphics.dest = VramMalloc(((64 / 8) * (32 / 8)));



    s->graphics.anim = sPlatformCrumblingAnims[gCurrentLevel % (sizeof(sPlatformCrumblingAnims) / sizeof((sPlatformCrumblingAnims)[0]))];
...
void Task_PlatformCrumbling(void)
{
    PlatformCrumbling *platform = (void *)((gCurTask)->data);
    Sprite *s = &platform->s;
    ...
    if ((worldX > gCamera.x + 320 + (256 / 2) || (worldX < gCamera.x - (256 / 2))
         || (worldY > gCamera.y + 240 + (256 / 2)) || (worldY < gCamera.y - (256 / 2)))
        && ((((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2))))) {
...
void Task_8025190(void)
{
    ...
    oam = &oam_ptr[s->dimensions->oamIndex * (10 / sizeof(short))];
    ...
    for (y = 0; y < 4; y++) {
        for (x = 0; x < 8; r6++, x++) {
            ...
            if (value > 0) {
                if (r6 == 0 && value == 1) {
                    if ((gPlayer.moveState & 0x00000008) && gPlayer.stoodObj == s) {
                        gPlayer.moveState = ((gPlayer.moveState & (~0x00000008)) | 0x00000002);
                    }

                    if (gNumSingleplayerCharacters == 2) {
                        if ((gPartner.moveState & 0x00000008) && (gPartner.stoodObj == s)) {
                            gPartner.moveState = ((gPartner.moveState & (~0x00000008)) | 0x00000002);
                        }
                    }
            ...
            pointer = OamMalloc(((((s)->oamFlags) & 0x7C0) >> 6));
            if (iwram_end == pointer)
                return;

            (pointer)->split.y = ((r4 + ((y * 8) + s->y)));;
            ...
            if (s->frameFlags & ((1) << (10))) {
                (pointer)->split.x = ((s->x - x * 8 - 8)); (pointer)->split.matrixNum = ((1) ? 0x08 : 0);;
            } else {
                (pointer)->split.x = ((s->x + x * 8)); (pointer)->split.matrixNum = ((0) ? 0x08 : 0);;
            }
            ...
            pointer->split.paletteNum = (oam[(10 / sizeof(short)) - 1] >> 12) + s->palId;
            pointer->split.priority = (((s)->frameFlags & (((3) << (12)))) >> ((12)));
            pointer->split.tileNum = (((uintptr_t)((s->graphics.dest)) - (uintptr_t)&VRAM[0x10000]) / (32)) + r6;
