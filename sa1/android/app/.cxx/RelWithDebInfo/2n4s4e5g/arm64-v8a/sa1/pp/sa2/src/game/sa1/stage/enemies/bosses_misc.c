# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/bosses_misc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/bosses_misc.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/bosses_misc.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/bosses_misc.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/bosses_misc.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/bosses_misc.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/bosses_misc.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/bosses_misc.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/bosses_misc.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/bosses_misc.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/bosses_misc.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/bosses_misc.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/bosses_misc.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 19 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/bosses_misc.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 20 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/bosses_misc.c" 2
...
void CreateBossCapsule(CamCoord worldX, CamCoord worldY)
{
    ...
    s->x = worldX;
    s->y = worldY;
    s->graphics.dest = VramMalloc(((72 / 8) * (72 / 8)));
    s->oamFlags = ((19) << 6);
    s->graphics.size = 0;
    s->graphics.anim = 578;
    s->variant = 0;
    ...
    s->x = worldX;
    s->y = worldY;
    s->graphics.dest = VramMalloc(((24 / 8) * (16 / 8)));
    s->oamFlags = ((20) << 6);
    s->graphics.size = 0;
    s->graphics.anim = 576;
    s->variant = 0;
...
{
    BossCapsule *matchCapsule = (void *)((gCurTask)->data);
    ...
    capsule->unk74 -= 0x10;
    capsule->offsetY += ((int)((capsule->unk74) >> 8));
...
void Task_801623C()
{
    ...
    BossCapsule *capsule = (void *)((gCurTask)->data);
    ...
    capsule->worldX = gCamera.x + (320 / 2);
    ...
    do {
        ...
        if ((Coll_Player_Entity_Intersection(s, capsule->worldX, capsule->worldY, p) & 0x80000)
            ...
            if (((int)((p->qWorldX) >> 8)) < gCamera.x + (320 / 2)) {
                p->qSpeedAirX = -((s32)((2)*256));
                sideX = (capsule->worldX + s->hitboxes[0].b.left) - p->spriteOffsetX;
                if (((int)((p->qWorldX) >> 8)) > sideX) {
                    p->qWorldX = ((s32)((sideX)*256));
                }
            } else {
                p->qSpeedAirX = +((s32)((2)*256));
...
void Task_BossCapsuleUpdate(void)
{
...

    {
        s32 i = 0;
        do {
            Player *p = &(*(((i) != 0) ? &gPartner : &gPlayer));

            if (p->charState != 15) {
                CamCoord prevPlayerY = ((int)((gPlayer.qWorldY) >> 8));
                Coll_Player_Platform(s, capsule->worldX, capsule->worldY, p);

                if ((!(gPlayer.moveState & 0x00000080)) && ((prevPlayerY < ((int)((gPlayer.qWorldY) >> 8))) || (capsule->worldY < ((int)((gPlayer.qWorldY) >> 8))))) {
                    p->qWorldX = ((s32)(((capsule->worldX + s->hitboxes[0].b.left) - p->spriteOffsetX)*256));
                    p->qWorldY = ((s32)((capsule->worldY - p->spriteOffsetY)*256));
                }
...
void Task_8016650(void)
{
    ...
    if (acmdRes == ACMD_RESULT__ENDED) {
        ...
        do {
            ...
            if ((p->moveState & 0x00000008) && (p->stoodObj == s2)) {
                p->moveState &= ~0x00000008;
                p->moveState |= 0x00000002;
            }
        } while (++i < gNumSingleplayerCharacters);
        ...
        strcA = (void *)((sub_80168F0(capsule->worldX, capsule->worldY, 0x40, 0x241, 0U))->data);
        strcA->qUnk44 = -((s32)((1)*256));
        strcA->qUnk46 = -((s32)((2)*256));
        strcA->unk48 = 0;
        strcA->unk42 = 4;
        strcA->unk40 = 0x3C;

        strcB = (void *)((sub_80168F0(capsule->worldX, capsule->worldY, 0x40, 0x241, 0U))->data);
        strcB->qUnk44 = +((s32)((1)*256));
        strcB->qUnk46 = -((s32)((2)*256));
        strcB->unk48 = 0;
        strcB->unk42 = 4;
        strcB->transform.qScaleX = -((s32)((1)*256));
        strcB->unk40 = 0x3C;
...
struct Task *sub_80168F0(CamCoord worldX, CamCoord worldY, u16 numTiles, AnimId anim, u8 variant)
{
    ...
    strc->unk3C = worldX;
    strc->unk3E = worldY;
    strc->qUnk44 = +((s32)((1)*256));
    strc->qUnk46 = -((s32)((2)*256));
    strc->unk48 = 8;
    spC = temp_r2;
    sp10 = 0;
    strc->s.graphics.dest = VramMalloc(numTiles);
    strc->s.oamFlags = ((20) << 6);
    ...
    strc->s.animSpeed = ((int)((float)(1.0)*0x10));
    strc->s.palId = 0;
    strc->s.frameFlags = 0x70;
    temp_r2->rotation = 0;
    temp_r2->qScaleX = ((s32)((1)*256));
    temp_r2->qScaleY = ((s32)((1)*256));
    temp_r2->x = worldX;
    temp_r2->y = worldY;
...
void Task_8016A14()
{
    Strc_sub_80168F0 *strc = (void *)((gCurTask)->data);
    SpriteTransform *tf;
    ...
    strc->qUnk46 += ((s32)((40. / 256.)*256));

    strc->unk3C += ((int)((strc->qUnk44) >> 8));
    strc->unk3E += ((int)((strc->qUnk46) >> 8));
    tf->x = strc->unk3C - gCamera.x;
    tf->y = strc->unk3E - gCamera.y;

    if (strc->qUnk44 > 0) {
        tf->rotation = (tf->rotation + strc->unk42) & 0x3FF;
        if (tf->qScaleX > -((s32)((2)*256))) {
...
void Task_8016B6C(void)
{
    ...
    strc = (void *)((gCurTask)->data);

    if ((strc->unk4++ & 0x3) == 0) {
        if (strc->unk4 != 5) {
            strc44 = (void *)((sub_8016D80(strc->unk0, strc->unk2 - 32, gUnknown_080BB43C[((gCurrentLevel) >> 1)][0], 0))->data);
            var_r4 = ({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; });
        ...
        strc44 = (void *)((sub_8016D80(strc->unk0, strc->unk2 - 32, gUnknown_080BB43C[((gCurrentLevel) >> 1)][1], 0))->data);
        var_r4 = ({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; });
        strc44->qUnk3E += var_r4 & 0xFF;
        if (!(1 & strc->unk8)) {
            strc44->qUnk3E = -strc44->qUnk3E;
        ...
        strc44->qUnk40 = strc44->qUnk3C;
        if (strc->unk4 != 5) {
            strc54 = (void *)((sub_8016F44(strc->unk0, strc->unk2 - 32, 0x1C0, 0))->data);
            var_r4 = ({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; });
        ...
        strc54 = (void *)((sub_8016F44(strc->unk0, strc->unk2 - 32, 0x1BA, 0))->data);
        var_r4 >>= 8;
        strc54->unk52 += ((var_r4)&7);
        if (1 & strc->unk8) {
            strc54->unk52 = -strc54->unk52;
        ...
        strc54->unk4E = ((int)((gPlayer.qWorldY) >> 8)) - 32;
        strc->unk8++;
    }
    if (strc->unk4 > 12) {
        strc->unk4 = 0;
...
struct Task *sub_8016D80(s16 worldX, s16 worldY, u16 anim, u8 variant)
{
    ...
    strc->qUnk3C = -((s32)((4)*256));
    strc->qUnk40 = -((s32)((4)*256));
    strc->qUnk3E = ((s32)((1)*256));
    strc->qUnk34 = 0;
    strc->qUnk30 = 0;
...
void sub_8016E54()
{
    Strc_sub_8016D80 *strc = (void *)((gCurTask)->data);
    Sprite *s = &strc->s;

    strc->qUnk3C += ((s32)((40. / 256.)*256));
    strc->qUnk34 += strc->qUnk3C;
    strc->qUnk30 += strc->qUnk3E;

    if ((strc->qUnk3C > 0)
        && (sa2__sub_801F100(strc->unk3A + ((int)((strc->qUnk34) >> 8)), strc->unk38 + ((int)((strc->qUnk30) >> 8)), 1, 8, sa2__sub_801EC3C) < 0)) {
        strc->qUnk3C = strc->qUnk40;

        if ((((int)((strc->qUnk30) >> 8)) < -32) && (strc->qUnk3E < 0)) {
            strc->qUnk3E = -strc->qUnk3E;
        } else if ((((int)((strc->qUnk30) >> 8)) > 32) && (strc->qUnk3E > 0)) {
            strc->qUnk3E = -strc->qUnk3E;
        }
    }
    ...
    s->x = (((int)((strc->qUnk30) >> 8)) + strc->unk38) - gCamera.x;
    s->y = (((int)((strc->qUnk34) >> 8)) + strc->unk3A) - gCamera.y;
    UpdateSpriteAnimation(s);
    DisplaySprite(s);
}
...
void sub_8017054()
{
    ...
    sinA = (gSineTable[(strc->unk4C)]);
    strc->unk40 = sinA >> 2;
    strc->unk3C = (gSineTable[(strc->unk50)]);
    cosA = (gSineTable[(strc->unk50) + 256]);
    cosB = (cosA >> 8) + ((s32)((1)*256));
    tf->qScaleY = cosB;

    if (tf->qScaleY > ((s32)((1)*256))) {
        s->oamFlags = 0x3C0;
    } else {
        s->oamFlags = 0x440;
    }
    ...
    tf->x = (strc->unk44 + ((int)((strc->unk3C) >> 8))) - gCamera.x;
    tf->y = (strc->unk46 + ((int)((strc->unk40) >> 8))) - gCamera.y;
    s->frameFlags &= ~0x1F;
...
struct Task *Bosses_SetCamBounds(CamCoord minY, CamCoord maxY, CamCoord minX, CamCoord maxX)
{
    ...
    t = TaskCreate(Task_8017244, 8U, 0x2000U, 0U, ((void*)0));
    temp_r2 = (void *)((t)->data);
    temp_r2->unk0 = minY;
    temp_r2->unk2 = maxY;
    temp_r2->unk4 = minX;
...
void Task_8017244()
{
    CameraPanning *strc = (void *)((gCurTask)->data);
...
void Task_8017334()
{
    ...
    Strc_sub_801766C *strc = (void *)((gCurTask)->data);

    p = strc->p;
    screenX = ((int)((p->qWorldX) >> 8)) - gCamera.x;
...
struct Task *sub_801749C(s16 worldX, s16 worldY)
{
    struct Task *t;
    Strc_sub_801749C *strc;
    t = TaskCreate(Task_8016B6C, sizeof(Strc_sub_801749C), 0x2000U, 0U, ((void*)0));
    strc = (void *)((t)->data);
    strc->unk4 = 0;
    strc->unk8 = 0;
    strc->unk0 = worldX;
...
struct Task *CreatePreBossCameraPan(s16 yMin, s16 yMax)
{
    ...
    t = TaskCreate(Task_PreBossCameraPan, 8U, 0x2000U, 0U, ((void*)0));
    pan = (void *)((t)->data);
...
struct Task *sub_8017540(s32 qParam0, s32 qParam1)
{
    ...
    t = CreateNutsAndBoltsTask(0x2000U, (void *)(&VRAM[0x10000] + 0x1000), 0x263U, 0U, ((void*)0));
    bolts = (void *)((t)->data);
    s = &bolts->s;
    ...
    s->frameFlags = 0x2000;
    s->oamFlags = 0x500;
    s->frameFlags |= ((({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0xC00) | 0x2000);
    return t;
}

void TaskDestructor_BossCapsule(struct Task *t)
{
    BossCapsule *capsule = (void *)((t)->data);
...
void TaskDestructor_sub_80168F0(struct Task *t)
{
    Strc_sub_80168F0 *strc = (void *)((t)->data);
...
void TaskDestructor_sub_8017658(struct Task *t)
{
    Strc_sub_8016D80 *strc = (void *)((t)->data);
    VramFree(strc->s.graphics.dest);
}

void sub_801766C(Player *p)
{
    struct Task *t = TaskCreate(Task_8017334, sizeof(Strc_sub_801766C), 0x2000, 0, ((void*)0));
    Strc_sub_801766C *strc = (void *)((t)->data);
    strc->unk0 = 0;
    strc->p = p;
}
