# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/pen_mk1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/pen_mk1.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/pen_mk1.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/pen_mk1.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/pen_mk1.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/pen_mk1.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/pen_mk1.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/pen_mk1.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/pen_mk1.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/pen_mk1.c" 2
...
void Task_PenMk1Main(void)
{
    ...
    worldX = ((pen->shared.base.meX)*8 + (pen->shared.base.regionX)*256);
    worldY = ((me->y)*8 + (pen->shared.base.regionY)*256);
    ...
    pen->unk40 += sa2__sub_801F07C(worldY, worldX, 1, +8, ((void*)0), sa2__sub_801EE64);

    xSquared = ((int)((gPlayer.qWorldX) >> 8)) - worldX;
    xSquared = xSquared * xSquared;
    ySquared = ((int)((gPlayer.qWorldY) >> 8)) - worldY;
    ySquared = ySquared * ySquared;

    if (((int)((pen->qUnk3C) >> 8)) <= (me->d.sData[0] + 1) * 8) {
        if (~s->frameFlags & ((1) << (10))) {
            (s)->frameFlags |= (((1) << (10)));
            pen->qUnk44 = +((s32)((0.625)*256));
        }
    } else if (((int)((pen->qUnk3C) >> 8)) >= (me->d.sData[0] + me->d.uData[2]) * 8) {
        if (s->frameFlags & ((1) << (10))) {
            (s)->frameFlags &= ~(((1) << (10)));
            pen->qUnk44 = -((s32)((0.625)*256));
        }
...
void Task_8073CC4(void)
{
    ...
    pen->unk40 += sa2__sub_801F07C(worldY, worldX, 1, +8, &sp08, sa2__sub_801EE64);
    pen->unk46++;
...
void CreatePenMk1Snowball(CamCoord worldX, CamCoord worldY, u8 dir)
{
    struct Task *t = TaskCreate(Task_PenMk1Snowball, sizeof(PenMk1Snowball), 0x3000, 0, ((void*)0));
    PenMk1Snowball *proj = (void *)((t)->data);
    Sprite *s = &proj->s;
    u8 sp08;
    ...
    proj->qUnk38 += sa2__sub_801F07C(worldY, worldX, 1, +8, &sp08, sa2__sub_801EE64);


    s->x = worldX;
    s->y = worldY;

    s->graphics.dest = (void *)(&VRAM[0x10000] + 0x25A0);
    s->oamFlags = ((9) << 6);
    s->graphics.size = 0;
    s->graphics.anim = 428;
    s->variant = 0;
...
void Task_PenMk1Snowball(void)
{
    PenMk1Snowball *proj = (void *)((gCurTask)->data);
    Sprite *s = &proj->s;
    ...
    s->x = proj->unk3C + ((int)((proj->qUnk34) >> 8));
    s->y = proj->unk44 + ((int)((proj->qUnk38) >> 8));

    oldWorldX = proj->s.x;
    oldWorldY = proj->s.y;

    divRes = ({((1000) != 0) ? ((s32)((gSineTable[(proj->unk4A * 4)])) / (s32)(1000)) : 0;});


    if ((divRes < 0) && ((s32)(divRes + proj->qUnk30) > (u16)-2)) {
        proj->qUnk30 = -1;
    } else {
        proj->qUnk30 += ({((1000) != 0) ? ((s32)((gSineTable[((proj->unk4A * 4) & (1024 - 1))])) / (s32)(1000)) : 0;});
    }


    proj->qUnk38 += ({((1000) != 0) ? ((s32)((gSineTable[(proj->unk4A * 4) + 256])) / (s32)(1000)) : 0;});
    ...
    res = sa2__sub_801F07C(oldWorldY, oldWorldX, 1, +8, &sp08, sa2__sub_801EE64);
    ...
    if (res >= -5 && res <= 0) {
        ...
        if ((((u16)(s->x + (120 / 2)) > 320 + 120) || (s->y + (120 / 2) < 0) || (s->y > 240 + 140))) {
            TaskDestroy(gCurTask);
            return;
        }
    }
...
void CreatePenMk1SnowballDebris(CamCoord worldX, CamCoord worldY)
{
    struct Task *t = TaskCreate(Task_SnowballDebris, sizeof(PenMk1Debris), 0x3000, 0, ((void*)0));
    PenMk1Debris *proj = (void *)((t)->data);
    Sprite *s = &proj->s;

    proj->qUnk30 = -((s32)((1)*256));
    proj->qUnk32 = -((s32)((3.75)*256));
    proj->qUnk34 = 0;
    proj->qUnk38 = 0;
    proj->qWorldX = ((s32)((worldX)*256));
    proj->qUnk40 = proj->qWorldX;
    proj->qWorldY = ((s32)((worldY)*256));
    proj->unk4B = 0;

    proj->qUnk38 += sa2__sub_801F07C(worldY, worldX, 1, +8, ((void*)0), sa2__sub_801EE64);


    s->x = worldX;
    s->y = worldY;

    s->graphics.dest = (void *)(&VRAM[0x10000] + 0x2620);
    s->oamFlags = ((9) << 6);
    s->graphics.size = 0;
    s->graphics.anim = 429;
    s->variant = 0;
...
void Task_SnowballDebris(void)
{
    PenMk1Debris *proj = (void *)((gCurTask)->data);
    Sprite *s = &proj->s;


    proj->qWorldX += proj->qUnk30;
    proj->qUnk40 -= proj->qUnk30;
    s->x = ((int)((proj->qWorldX) >> 8));

    proj->qUnk32 += ((s32)((60. / 256.)*256));
    proj->qWorldY += proj->qUnk32;
    s->y = ((int)((proj->qWorldY) >> 8));
# 475 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/pen_mk1.c"
    s->x -= gCamera.x;
    s->y -= gCamera.y;
    ...
    s->x = ((int)((proj->qUnk40) >> 8)) - gCamera.x;
    DisplaySprite(s);
}
