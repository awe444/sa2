# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/marble_track.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/marble_track.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/marble_track.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/marble_track.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/marble_track.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/marble_track.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/marble_track.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/stage/stage_ui.h" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/stage/stage_ui.h" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/marble_track.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/marble_track.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/marble_track.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/marble_track.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/marble_track.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/marble_track.c" 2
...
{
    struct Task *t = TaskCreate(Task_MarbleTrack_Dir, sizeof(MarbleTrackDir), 0x2000 | me->d.uData[3], 0, ((void*)0));
    MarbleTrackDir *dir = (void *)((t)->data);
    s32 i;
...
void Task_MarbleTrack_Dir(void)
{
    ...
    s16 screenX, screenY;
    MapEntity *me;
    MarbleTrackDir *dir = (void *)((gCurTask)->data);
    s32 i;
    me = dir->base.me;

    worldX = ((dir->base.meX)*8 + (dir->base.regionX)*256);
    worldY = ((me->y)*8 + (dir->base.regionY)*256);
    ...
    i = 0;
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            if ((((dir->unk68) >> (i)) & 1)) {
                if ((((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] == dir->unk3C))) {
                    s32 x, y;

                    x = ({((dir->unk3D) != 0) ? ((s32)(dir->unk50[0] * dir->unk3E[i]) / (s32)(dir->unk3D)) : 0;});
                    y = ({((dir->unk3D) != 0) ? ((s32)(dir->unk50[1] * dir->unk3E[i]) / (s32)(dir->unk3D)) : 0;});

                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = ((s32)((dir->unk40[i] + x)*256));
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((dir->unk48[i] + y)*256));

                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX - dir->unk58[i];
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY - dir->unk60[i];

                    if ((++dir->unk3E[i] >= dir->unk3D) || ((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] > dir->unk3C)) {
                        if (((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] == dir->unk3C)) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00200000;
                            (*(((i) != 0) ? &gPartner : &gPlayer)).heldInput |= (gPlayerControls.jump | gPlayerControls.attack);
                            (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00400000;
                            (*(((i) != 0) ? &gPartner : &gPlayer)).itemEffect &= ~0x80;
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = 0;
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = 0;
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = +((s32)((0)*256));
                        }
                        (dir->unk68) &= ~(1 << (i));
                    } else {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00200000;
                        ...
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = +((s32)((0)*256));
                        (*(((i) != 0) ? &gPartner : &gPlayer)).heldInput = 0;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).frameInput = 0;
                        { Player_HandleSpriteYOffsetChange(&(*(((i) != 0) ? &gPartner : &gPlayer)), 14); { (&(*(((i) != 0) ? &gPartner : &gPlayer)))->spriteOffsetX = 6; (&(*(((i) != 0) ? &gPartner : &gPlayer)))->spriteOffsetY = 14; } };
                        (dir->unk68) |= (1 << (i));
                    }

                    dir->unk58[i] = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX;
                    dir->unk60[i] = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY;
                } else {
                    (dir->unk68) &= ~(1 << (i));
                }
            } else {

                if ((((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00400000) && ((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] < dir->unk3C)) || !dir->unk3C) {
                    if ((worldX - 8 <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldX + 8 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)))
                        && (worldY - 10 <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8))) && (worldY + 10 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) {
                        dir->unk3E[i] = 0;

                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000004;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00200000;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00400000;

                        dir->unk40[i] = ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8));
                        dir->unk48[i] = ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8));

                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = -((s32)((0)*256));
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = +((s32)((0)*256));
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = +((s32)((0)*256));
                        (*(((i) != 0) ? &gPartner : &gPlayer)).heldInput = +((s32)((0)*256));
                        (*(((i) != 0) ? &gPartner : &gPlayer)).frameInput = +((s32)((0)*256));
                        ...
                        (*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] = dir->unk3C;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).itemEffect |= 0x80;
                    }
                }
            }
    ...
    if (!(dir->unk68 & 0x3)) {
        if ((((u16)(screenX + (256 / 2)) > 320 + 256) || (screenY + (256 / 2) < 0) || (screenY > 240 + (256 / 2)))) {
            { me->x = dir->base.meX; };
...
{
    struct Task *t = TaskCreate(Task_MarbleTrack_Unk, sizeof(SecretBasePipe), 0x2000 + me->d.sData[1], 0, ((void*)0));
    SecretBasePipe *basePipe = (void *)((t)->data);
...
void Task_MarbleTrack_Unk(void)
{
    ...
    s16 screenY, screenX;
    s16 sp0C;
    SecretBasePipe *basePipe = (void *)((gCurTask)->data);
    MapEntity *me = basePipe->base.me;
    s32 i;

    worldX = ((basePipe->base.meX)*8 + (basePipe->base.regionX)*256);
    worldY = ((me->y)*8 + (basePipe->base.regionY)*256);
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            if ((((basePipe->unk4C) >> (i)) & 1)) {
                s8 zone;
                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY += ((s32)((42. / 256.)*256));

                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY += (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY;
                basePipe->unk3C[i] += (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY;

                if ((((gCurrentLevel) >> 1) == 1) || (gCurrentLevel == 15)) {
                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX < ((s32)((worldX)*256))) {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX += ((s32)((0.5)*256));

                        if ((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX > ((s32)((worldX)*256))) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = ((s32)((worldX)*256));
                        }
                    } else {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX -= ((s32)((0.5)*256));
                ...
                if ((((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] > basePipe->unk4D))
                    || ((++basePipe->unk44[i] >= basePipe->unk48) || (((int)((basePipe->unk3C[i]) >> 8)) > basePipe->unk4A))) {
                    if (((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] == basePipe->unk4D)) {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] = 0x7F;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00400000;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).itemEffect &= ~0x80;
                    }
                    (basePipe->unk4C) &= ~(1 << (i));
                ...
                if (((((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00400000) && ((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] < basePipe->unk4D))
                     || !basePipe->unk4D)) {
                    if ((worldX - 12 <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldX + 12 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)))
                        && (worldY - 12 <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8))) && (worldY + 12 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) {
                        basePipe->unk44[i] = 0;
                        basePipe->unk3C[i] = 0;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000004;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00400000;
                        ...
                        (*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] = basePipe->unk4D;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).itemEffect |= 0x80;
                    }
                }
            }
...
void CreateEntity_MarbleTrack_Entrance(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    MarbleTrackEntrance *entrance = (void *)((t)->data);
    Sprite *s = &entrance->s;
...
void Task_MarbleTrack_Entrance(void)
{
    ...
    s16 screenY, screenX;
    s16 sp0C;
    MarbleTrackEntrance *entrance = (void *)((gCurTask)->data);
    Sprite *s = &entrance->s;
    MapEntity *me = entrance->base.me;
    s32 i;

    worldX = ((entrance->base.meX)*8 + (entrance->base.regionX)*256);
    worldY = ((me->y)*8 + (entrance->base.regionY)*256);
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            s32 sp1C;
            if ((((entrance->unk3E) >> (i)) & 1)) {
                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY += ((s32)((42. / 256.)*256));

                sp1C = ((s32)((worldX + ({((entrance->unk3F) != 0) ? ((s32)(entrance->unk4A * entrance->unk3C[i]) / (s32)(entrance->unk3F)) : 0;}))*256));

                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY += (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY;
                entrance->unk40[i] = entrance->unk40[i] + (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY;
                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = sp1C;
                (*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk80 += 4;

                if ((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk80 > 0x100) {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk80 = 0x100;
                }

                (*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk82 = (*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk80;

                if (entrance->unk3C[i] == 25) {
                    Player_Tails_InitGfxMarbleTrack(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                }

                if ((++entrance->unk3C[i] >= entrance->unk3F) || (((int)((entrance->unk40[i]) >> 8)) > entrance->unk48)
                    || (((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] != 0x7F) && (*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] > me->d.uData[3])) {
                    (entrance->unk3E) &= ~(1 << (i));
                } else {
                    Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00400000;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = +((s32)((0)*256));
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = +((s32)((0)*256));
                    (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 32;
                    { Player_HandleSpriteYOffsetChange(&(*(((i) != 0) ? &gPartner : &gPlayer)), 14); { (&(*(((i) != 0) ? &gPartner : &gPlayer)))->spriteOffsetX = 6; (&(*(((i) != 0) ? &gPartner : &gPlayer)))->spriteOffsetY = 14; } };
                    (entrance->unk3E) |= (1 << (i));
                }
            } else {

                sp1C = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX;

                if (sub_80549FC() && ((*(((i) != 0) ? &gPartner : &gPlayer)).charState != 73)) {
                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY > ((s32)((worldY)*256)) + ((s32)((12)*256))) {
                        if (Coll_Player_Platform(s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer))) & 0x10000) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((worldY + 23)*256));
                        }
                    }
                } else if (((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] == 0x7F) && Coll_Player_Platform(s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer))) & 0x8) {
                    entrance->unk3C[i] = 0;
                    entrance->unk40[i] = 0;
                    Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000004;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00000008;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00400000;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] = me->d.uData[3];
                    ...
                    (*(((i) != 0) ? &gPartner : &gPlayer)).heldInput = 0;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 32;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk80 = 0xB0;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk82 = 0xB0;
...
# 494 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/marble_track.c"
                }
            }
        }
    } while (++i < gNumSingleplayerCharacters);
    ...
    if (!(entrance->unk3E & 0x3)) {
        if ((((u16)(screenX + (256 / 2)) > 320 + 256) || (screenY + (256 / 2) < 0) || (screenY > 240 + (256 / 2)))) {
            ...
            do {
                if ((((entrance->unk3E) >> (i)) & 1)) {
                    if (me->d.uData[3] == (*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0]) {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00400000;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).itemEffect &= ~0x80;
                    }
                }
...
void CreateEntity_MarbleTrack_Exit(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    MarbleTrackExit *exit = (void *)((t)->data);
    Sprite *s = &exit->s;
...
void Task_MarbleTrack_Exit(void)
{
    ...
    s16 screenX, screenY;
    s16 sp0C;
    MarbleTrackExit *exit = (void *)((gCurTask)->data);
    Sprite *s = &exit->s;
    MapEntity *me = exit->base.me;
    s32 i;

    worldX = ((exit->base.meX)*8 + (exit->base.regionX)*256);
    worldY = ((me->y)*8 + (exit->base.regionY)*256);
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            ...
            if ((((exit->unk40) >> (i)) & 1)) {
                ...
                exit->unk4C[i] += (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY;
                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = exit->unk4C[i];
                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = exit->unk44[i];

                (*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk80 -= 4;


                if ((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk80 < 0xB0) {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk80 = 0xB0;
                }
                ...
                if ((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY > ((s32)((0)*256))) {


                    Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                    (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 5;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00200000;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).heldInput |= (gPlayerControls.jump | gPlayerControls.attack);
                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00400000;
                    ...
                    (exit->unk40) &= ~(1 << (i));
                    (*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk80 = 0x100;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk82 = 0x100;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).itemEffect &= ~0x80;
                }
            } else {


                if ((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] != 0x7F) {

                    if ((worldX + sp0C <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldX + sp0C + 24 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)))
                        && (worldY - 24 <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8))) && (worldY + 24 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) {

                        if (!(((exit->unk40) >> (i)) & 1)) {
                            exit->unk44[i] = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX;
                            exit->unk4C[i] = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY;
                        }

                        Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));

                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00000100;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000010;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000004;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000002;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00200000;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00400000;

                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = -((s32)((5)*256));
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = +((s32)((0)*256));
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = +((s32)((0)*256));
                        (*(((i) != 0) ? &gPartner : &gPlayer)).heldInput = +((s32)((0)*256));
                        (*(((i) != 0) ? &gPartner : &gPlayer)).frameInput = +((s32)((0)*256));
                        ...
                        if (i != 0) {
                            gPartner.itemEffect |= gPartner.itemEffect | 0x80;
                        } else {
                            gPlayer.itemEffect |= gPlayer.itemEffect | 0x80;
                        }
                ...
                if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00200000)) {
                    Coll_Player_Platform(s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)));
                }
            }
        }
    } while (++i < gNumSingleplayerCharacters);
