# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_4_egg_spider.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_4_egg_spider.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_4_egg_spider.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_4_egg_spider.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/malloc_vram.h" 1
# 24 "/home/awaszczak/git/sa2/sa1/../include/malloc_vram.h"
void *VramMalloc(u32);
void VramResetHeapState(void);
void VramFree(void *);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_4_egg_spider.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_4_egg_spider.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_4_egg_spider.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_4_egg_spider.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_4_egg_spider.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_4_egg_spider.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_4_egg_spider.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_4_egg_spider.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_4_egg_spider.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_4_egg_spider.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_4_egg_spider.c" 2
...
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_4_egg_spider.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 20 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_4_egg_spider.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 21 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_4_egg_spider.c" 2
...
# 22 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_4_egg_spider.c" 2
...
{
    EggSpider *boss = (void *)((gCurTask)->data);
    Sprite *s2 = &boss->s2;

    if ((s2->variant != 0) && (s2->frameFlags & ((1) << (14)))) {
        s2->variant = 0U;
        s2->prevVariant = 0xFF;
    }
}
    ...
    if (boss->unk87 != 0 && --boss->unk87 > 0) {
        if (!(boss->unk87 & 2)) {
            if ((!(gPlayer.moveState & 0x00000080))) {
                s->frameFlags |= 0x100;
                gDispCnt |= 0x8000;
                gWinRegs[5] = (((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11)) | (1 << 12) | (1 << 13)) | ((((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3)) | (1 << 4) | (1 << 5)) & ~(1 << 5));
...
void CreateEntity_EggSpider(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    TaskCreate(InitWaterPalettes, 0U, 0xFFFDU, 0U, ((void*)0));
    ...
    boss->unk8A = 0;
    boss->unk8C = 0;
    boss->qUnk6C = ((s32)((48)*256));
    boss->qUnk70 = ((s32)((16)*256));
    boss->unk74 = 0;
    boss->unk78 = 0;
    ...
    Bosses_SetCamBounds(s->y, s->y + 240, s->x - 320, s->x);
...
void Task_EggSpiderInit(void)
{
    ...
    worldX = ((boss->base.meX)*8 + (boss->base.regionX)*256) + ((int)((boss->qUnk6C) >> 8));
    worldY = ((me->y)*8 + (boss->base.regionY)*256) + ((int)((boss->qUnk70) >> 8));
...
void sub_8030EE4()
{
    ...
    switch (boss->unk8C) {
        case 0: {
            ...
            s->variant = 0;
            temp_r0_7 = (u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) % 9U;
            boss->unk80 = ((s32)((gUnknown_084ACEC6[temp_r0_7])*256));
            if (boss->qUnk6C == boss->unk80) {
                boss->unk80 = ((s32)((gUnknown_084ACEC6[((temp_r0_7 + 5) % 9)])*256));
            }
            if (boss->qUnk6C <= boss->unk80) {
                boss->unk74 = +0x100;
                boss->unk8C = 1;
        ...
        case 3: {
            if (--boss->unk84 == 0) {
                ...
                boss->unk8A = 120;
                s->variant = 2;
            } else if (((boss->unk84 % gUnknown_084ACEB4[boss->unk86]) == 0) && (!(gPlayer.moveState & 0x00000080))) {
...
void sub_80311D4(void)
{
    ...
    {
        strc = (void *)((sub_80168F0(worldX, worldY, 0x10, 0x273, 0U))->data);
        strc->qUnk46 = 0;
        strc->unk48 = 0;
        strc->unk42 = 0x80;
    ...
    {
        strc = (void *)((sub_80168F0(worldX + 16, worldY + 16, 0xC, 0x273, 1U))->data);
        strc->qUnk46 = 0;
        strc->unk48 = 0;
        strc->unk42 = 0x80;
    ...
    worldX = gCamera.minY;
    worldY = gCamera.maxY;
    CreatePreBossCameraPan(gCamera.maxY - 240, (u16)gCamera.maxY);
    gCamera.minY = worldX;
    gCamera.maxY = worldY;

    gWater.targetWaterLevel += 240;
...
void CreateIciclePlatform(EggSpider *boss)
{
    ...
    me = boss->base.me;
    t = TaskCreate(sub_8031AB4, sizeof(IciclePlatform), 0x2200U, 0U, ((void*)0));
    icicle = (void *)((t)->data);
    s = &icicle->s;
    icicle->worldX = ((boss->base.meX)*8 + (boss->base.regionX)*256);
    icicle->worldY = ((me->y)*8 + (boss->base.regionY)*256);

    r7 = ((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) >> 1);
    r7 &= 0xF;
    icicle->unk4C = ((s32)((-(((r7 << 2) + r7) << 2) - 10)*256));
    icicle->unk50 = -((s32)((32)*256));
    icicle->unk54 = 0;
    icicle->unk58 = 0xA;
    ({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; });
    icicle->unk58 = ((({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; })) & 0xF) + 10;

    s->x = 0;
    s->y = 0;
    s->graphics.dest = (void *)(&VRAM[0x10000] + 0x2720);
    s->oamFlags = ((20) << 6);
    s->graphics.size = 0;
    s->graphics.anim = 630;
...
void sub_8031AB4(void)
{
    ...
    sp4 = 0;
    icicle = (void *)((gCurTask)->data);
    boss = (void *)(((struct Task *)((gCurTask)->parent))->data);
    s = &icicle->s;
    temp_r2 = icicle->unk50;
    if (((icicle->worldY + ((int)((icicle->unk50) >> 8))) - 17) < gWater.currentWaterLevel) {
    ...
    if (icicle->unk50 > ((s32)((208)*256))) {
        TaskDestroy(gCurTask);
        return;
    }

    worldX = icicle->worldX + ((int)((icicle->unk4C) >> 8));
    worldY = icicle->worldY + ((int)((icicle->unk50) >> 8));
    UpdateSpriteAnimation(s);
    s->x = worldX - gCamera.x;
    s->y = worldY - gCamera.y;

    if ((boss != (((void*)0))) && (boss->unk86 <= 7)) {
    ...
    if ((8 & gPlayer.moveState) && (gPlayer.stoodObj == s)) {
        if (icicle->unk50 > ((s32)((196)*256))) {
            gPlayer.moveState &= ~8;
        } else {
            gPlayer.qWorldY += ((s32)((1)*256)) + var_sl;
        }
    }
    if ((s8)(u8)gNumSingleplayerCharacters == 2) {
        ...
        if ((8 & gPartner.moveState) && (gPartner.stoodObj == s)) {
            if (icicle->unk50 > ((s32)((196)*256))) {
                ...
                gPartner.qWorldY += ((s32)((1)*256)) + var_sl;
            }
        }
    }
    DisplaySprite(s);
