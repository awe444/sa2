# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/mp_mode_select.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/mp_mode_select.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/mp_mode_select.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/mp_mode_select.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/multi_boot.h" 1
# 25 "/home/awaszczak/git/sa2/sa1/../include/multi_boot.h"
extern void MultiBootInit(struct MultiBootParam *mp);
# 38 "/home/awaszczak/git/sa2/sa1/../include/multi_boot.h"
extern s32 MultiBootMain(struct MultiBootParam *mp);
# 63 "/home/awaszczak/git/sa2/sa1/../include/multi_boot.h"
extern void MultiBootStartProbe(struct MultiBootParam *mp);
# 73 "/home/awaszczak/git/sa2/sa1/../include/multi_boot.h"
extern void MultiBootStartMaster(struct MultiBootParam *mp, const u8 *srcp, s32 length, u8 palette_color, s8 palette_speed);
# 98 "/home/awaszczak/git/sa2/sa1/../include/multi_boot.h"
extern s32 MultiBootCheckComplete(struct MultiBootParam *mp);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/mp_mode_select.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/mp_mode_select.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/mp_mode_select.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/mp_mode_select.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/mp_mode_select.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/mp_mode_select.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/mp_mode_select.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/mp_mode_select.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/tilemaps.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/mp_mode_select.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/text.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/mp_mode_select.c" 2
# 24 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/mp_mode_select.c"
...
const AnimId gUnknown_080BB348[2] = { 901, 897 };
const AnimId gUnknown_080BB34C[2] = { 892, 891 };
const AnimId gUnknown_080BB350[2] = { 893, 890 };
const VoidFn sModeInitProcs[PM_COUNT] = { ModeSelect_InitMultiPak, ModeSelect_InitSinglePak };

extern u8 gUnknown_03005008[4];
...
void CreateMultiplayerModeSelectScreen(void)
{
    ...
    gDispCnt = 0x1141;
    gBgCntRegs[0] = 0x1E03;
    modeSelect = (void *)((TaskCreate(Task_MultiplayerModeSelectScreenInit, sizeof(ModeSelect), 0x2000U, 0U, ((void*)0)))->data);
    modeSelect->unk200 = 0;
    modeSelect->mode = PM_MULTI_PAK;
    modeSelect->qUnk1FC = ((s32)((0)*256));
    modeSelect->qUnk208 = ((s32)((16)*256));
    ...
    s->oamFlags = ((15) << 6);
    s->graphics.size = 0;
    s->graphics.anim = gUnknown_080BB348[(&gLoadedSaveGame)->uiLanguage];
    s->variant = 0;
    s->animCursor = 0;
    s->qAnimDelay = 0;
    s->prevVariant = -1;
    ...
    s->x = 0;
    s->y = 64;
    s->graphics.dest = (void *)(&VRAM[0x10000] + 0x840);
    s->oamFlags = 0x400;
    s->graphics.size = 0;
    s->graphics.anim = 860;
    s->variant = 0;
    ...
    bg = &modeSelect->bg;
    bg->graphics.dest = (void *)&VRAM[0];
    bg->graphics.anim = 0;
    bg->layoutVram = (void *)(&VRAM[0] + 0xF000);
    bg->unk18 = 0;
    bg->unk1A = 0;
    bg->tilemapId = (s16)((&gLoadedSaveGame)->uiLanguage + 0x4C);
    bg->unk1E = 0;
    bg->unk20 = 0;
    bg->unk22 = 0;
    bg->unk24 = 0;
...
void Task_800E648()
{
    ModeSelect *modeSelect = (void *)((gCurTask)->data);

    if (0x0040 & gRepeatedKeys) {
        m4aSongNumStart(108);
...
void sub_800E798()
{
    ...
    modeSelect->qUnk1FC += ((s32)((0.5)*256));
    if (modeSelect->qUnk1FC > ((s32)((200)*256))) {
        modeSelect->qUnk1FC -= ((s32)((200)*256));
    }
    ...
    UpdateSpriteAnimation(s);
    var_r4 = ((int)((modeSelect->qUnk1FC) >> 8)) - 200;
...
void Task_800E868()
{
    ...
    modeSelect->qUnk208 += ((s32)((0.5)*256));
    if (modeSelect->qUnk208 >= ((s32)((16)*256))) {
        modeSelect->qUnk208 = ((s32)((16)*256));
        ...
        gBldRegs.bldY = ((int)((modeSelect->qUnk208) >> 8));
        sub_800E798();
    }
}
...
void ModeSelect_InitMultiPak()
{
    ...
    s32 i;
    ModeSelect *modeSelect;
    u8 *vram = &VRAM[0x10000];

    m4aSongNumStart(5);
    modeSelect = (void *)((gCurTask)->data);
    modeSelect->frameCount = (s32)((&gLoadedSaveGame)->unk4 + gFrameCount);
    ...
    s->oamFlags = 0x3C0;
    s->graphics.size = 0;
    s->graphics.anim = gUnknown_080BB34C[(&gLoadedSaveGame)->uiLanguage];
    s->variant = 0;
    s->animCursor = 0;
    s->qAnimDelay = 0;
    s->prevVariant = -1;
    ...
    s->oamFlags = ((15) << 6);
    s->graphics.size = 0;
    s->graphics.anim = gUnknown_080BB350[(&gLoadedSaveGame)->uiLanguage];
    s->variant = 0;
    s->animCursor = 0;
    s->qAnimDelay = 0;
    s->prevVariant = -1;
    ...
    bg->graphics.dest = (void *)&VRAM[0];
    bg->graphics.anim = 0;
    bg->layoutVram = (u16 *)(&VRAM[0] + 0xF000);
    bg->unk18 = 0;
    bg->unk1A = 0;
    bg->tilemapId = 80;
    bg->unk1E = 0;
...
void Task_MultiPak()
{
    ...
    if (0x81 & gMultiSioStatusFlags) {
        if (!(gMultiSioStatusFlags & (0x0001 << (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id)))) {
            if (gMultiplayerMissingHeartbeats[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id]++ >= 0xB5) {
            ...
            gMultiplayerMissingHeartbeats[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] = 0;
        }
    }
    ...
    for (i = 0; i < 4; i++) {
        ...
        if ((i == ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) || (((gMultiSioStatusFlags) & ((1 << (i)))) && (send_recv->pat0.unk0 >= 0x10))) {
            r2 |= 1;
            modeSelect->unk20B[0][i] = r2;
            sp0 += 1;
            var_sl |= 1 << i;
            ...
            r0 = ((vu16 *)&(*(reg_u32 *)(REG_BASE + 0x120)))[i];
            r2 = r0;



            sp8 = 1;
            if (!((gMultiSioStatusFlags) & ((1 << (i)))) && (r2 == 0)) {
                var_sb = 1;
                ...
                var_sb = 1;
                spC = 0;
            } else if (((gMultiSioStatusFlags) & ((1 << (i)))) && (send_recv->pat0.unk0 < 0x10)) {
                var_sb = 1;
                spC = 0;
            }
        }
    ...
    if ((var_sb == 0) && (send_recv->pat0.unk0 == 0x11) && (modeSelect->unk218 != 0)) {
        ...
        for (i = 3; i >= 0; i--) {
            ...
            } else if (((gMultiSioStatusFlags) & ((1 << (i))))) {
    ...
    if (gMultiSioStatusFlags & 0x80) {
        ...
        if (gMultiSioStatusFlags & 0x80) {
            if (((var_sb == 0) && (sp0 > 1) && (0x0008 & gPressedKeys))
                || ((modeSelect->unk206 != 0) && (var_sb == 0) && (sp0 > 1))) {
                send_recv = &gMultiSioSend;
                send_recv->pat0.unk0 = 0x11;
                send_recv->pat0.unk2 = var_sl;
                send_recv->pat0.unk4 = (&gLoadedSaveGame)->unk4;
                DmaSet(3, &(&gLoadedSaveGame)->playerName[0], send_recv->pat0.unk8, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((sizeof((&gLoadedSaveGame)->playerName))/(32/8))));
                send_recv->pat0.unk4 = (&gLoadedSaveGame)->unk4;
...
void Task_800F058(void)
{
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
        for (var_r3 = 0; var_r3 < 4; var_r3++) {
            if (!(((gMultiplayerConnections) >> (var_r3)) & 1)) {
                break;
            }

            if (!((gMultiSioStatusFlags) & ((1 << (var_r3))))) {
    ...
    if (send_recv_r2->pat0.unk0 == 0x10) {
        ...
        *gBgSprites_Unknown1 = 0;
        ...
        for (var_r5 = 0; var_r5 < 4; var_r5++) {
            ...
            if ((((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id == var_r5) || (send_recv_r2->pat0.unk0 > 0x10U)) {
                var_r7 |= 1 << var_r5;
            }
        ...
        if (gMultiSioStatusFlags & 0x80) {
            ...
            DmaSet(3, &(&gLoadedSaveGame)->playerName[0], send_recv_r6->pat0.unk8, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((sizeof((&gLoadedSaveGame)->playerName))/(32/8))));

            for (var_r5 = 0, gMultiplayerConnections; var_r5 < 4; var_r5++) {
                if (!(((gMultiplayerConnections) >> (var_r5)) & 1) || var_r5 == 0) {
                    continue;
                }

                if (!((gMultiSioStatusFlags) & ((1 << (var_r5)))) || (send_recv_r2 = &gMultiSioRecv[var_r5])->pat0.unk0 != 0x11) {
                    goto lbl;
                }
            }
            return;
...
void ModeSelect_InitSinglePak()
{
    ...
    if (*(u8 *)&(*(reg_u16 *)(REG_BASE + 0x128)) & 0x30) {
        TasksDestroyInPriorityRange(0, 0xFFFF);
        gBackgroundsCopyQueueCursor = gBackgroundsCopyQueueIndex;;
        gBgSpritesCount = 0;
        gVramGraphicsCopyCursor = gVramGraphicsCopyQueueIndex;;
...
void Task_SinglePak()
{
    ...
    for (var_r5 = 1; var_r5 < 4; var_r5++) {
        if ((((((s32)gMultiBootParam.response_bit) >> (var_r5)) & 1)) && ((((s32)gMultiBootParam.client_bit) >> (var_r5)) & 1)) {
            var_r6++;
        } else {
            break;
        }
    ...
    if ((gMultiBootParam.probe_count == 0) && (gMultiBootParam.client_bit != 0) && (8 & gPressedKeys)) {
        ...
        m4aSoundVSyncOff();
        {
# 943 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/mp_mode_select.c"
            (*(reg_u16 *)(REG_BASE + ((((((((((((((0x40 + sizeof(winreg_t) * 6) + 4) + 2) + 2) + 2 + 10 + 0x50 + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + 0) + sizeof(uint16_t)))) &= 0xC5FF;
            (*(reg_u16 *)(REG_BASE + ((((((((((((((0x40 + sizeof(winreg_t) * 6) + 4) + 2) + 2) + 2 + 10 + 0x50 + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + 0) + sizeof(uint16_t)))) &= 0x7FFF;
            (*(reg_u16 *)(REG_BASE + (((((((((((((((((0x40 + sizeof(winreg_t) * 6) + 4) + 2) + 2) + 2 + 10 + 0x50 + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + 0) + sizeof(uint16_t)) + sizeof(uint16_t)) + 0) + sizeof(uint16_t)))) &= 0xC5FF;
            (*(reg_u16 *)(REG_BASE + (((((((((((((((((0x40 + sizeof(winreg_t) * 6) + 4) + 2) + 2) + 2 + 10 + 0x50 + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + 0) + sizeof(uint16_t)) + sizeof(uint16_t)) + 0) + sizeof(uint16_t)))) &= 0x7FFF;
            (*(reg_u16 *)(REG_BASE + ((((((((((((((((((((0x40 + sizeof(winreg_t) * 6) + 4) + 2) + 2) + 2 + 10 + 0x50 + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + 0) + sizeof(uint16_t)) + sizeof(uint16_t)) + 0) + sizeof(uint16_t)) + sizeof(uint16_t)) + 0) + sizeof(uint16_t)))) &= 0xC5FF;
            (*(reg_u16 *)(REG_BASE + ((((((((((((((((((((0x40 + sizeof(winreg_t) * 6) + 4) + 2) + 2) + 2 + 10 + 0x50 + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + 0) + sizeof(uint16_t)) + sizeof(uint16_t)) + 0) + sizeof(uint16_t)) + sizeof(uint16_t)) + 0) + sizeof(uint16_t)))) &= 0x7FFF;
            (*(reg_u16 *)(REG_BASE + (((((((((((((((((((((((0x40 + sizeof(winreg_t) * 6) + 4) + 2) + 2) + 2 + 10 + 0x50 + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + 0) + sizeof(uint16_t)) + sizeof(uint16_t)) + 0) + sizeof(uint16_t)) + sizeof(uint16_t)) + 0) + sizeof(uint16_t)) + sizeof(uint16_t)) + 0) + sizeof(uint16_t)))) &= 0xC5FF;
            (*(reg_u16 *)(REG_BASE + (((((((((((((((((((((((0x40 + sizeof(winreg_t) * 6) + 4) + 2) + 2) + 2 + 10 + 0x50 + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + sizeof(uintptr_t)) + 0) + sizeof(uint16_t)) + sizeof(uint16_t)) + 0) + sizeof(uint16_t)) + sizeof(uint16_t)) + 0) + sizeof(uint16_t)) + sizeof(uint16_t)) + 0) + sizeof(uint16_t)))) &= 0x7FFF;
    ...
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, &gBgPalette[32], 0x00000000 | 0x01000000 | ((0x20)/(16/8) & 0x1FFFFF)); };
    gCurTask->main = sa2__sub_8081C50;
