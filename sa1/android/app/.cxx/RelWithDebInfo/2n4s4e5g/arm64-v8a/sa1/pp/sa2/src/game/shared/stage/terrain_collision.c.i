# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/terrain_collision.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/terrain_collision.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/terrain_collision.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/terrain_collision.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/terrain_collision.h" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/terrain_collision.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/terrain_collision.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/terrain_collision.c" 2
...
s32 sa2__sub_801EF94(s32 p0, s32 p1, s32 layer);
# 66 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/terrain_collision.c"
...
const Collision *const gCollisionTable[18] = {
...
# 149 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/terrain_collision.c"
s32 sa2__sub_801E4E4(s32 p0, s32 p1, s32 p2, s32 p3, u8 *data, Func801F07C func)
{
    u8 dummy[4];
    u8 *dummy_p;
    u8 *data1;
...
# 476 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/terrain_collision.c"
s32 sa2__sub_801EB44(s32 p0, s32 p1, s32 layer)
{
    u32 r0;
    s32 yPixel;
    s32 mtTileIndex;
    ...
    tile = sa2__sub_801EF94(p0, p1, layer & 0x01);
...
s32 sa2__sub_801EC3C(s32 p0, s32 p1, s32 layer)
{
    u32 r0;
    s32 xPixel;
    s32 mtTileIndex;
    ...
    tile = sa2__sub_801EF94(p1, p0, layer & 0x01);
    mtTileIndex = tile & 0x03FF;
...
s32 sa2__sub_801ED24(s32 p0, s32 p1, s32 p2, u8 *p3)
{
    u32 r0;
    s32 r3;
    s32 mtTileIndex;
    ...
    res = sa2__sub_801EF94(p0, p1, p2 & 0x1);
...
s32 sa2__sub_801EE64(s32 p0in, s32 p1in, s32 p2in, u8 *p3in)
{



    typedef s32 r0r1_t;
# 696 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/terrain_collision.c"
    r0r1_t r0;
    r0r1_t r1;
    s32 r3;
    s32 p0 = p0in;
    ...
    p0 = sa2__sub_801EF94(p1, p0, p2 & sb);
    r7 = 0x3FF;
    r7 &= p0;
...
{
    s32 r0;
# 830 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/terrain_collision.c"
    s32 r1;
    s32 r3;
    s32 r4;
    s32 r5;
    ...
    if (gUnknown_3000410[0] == r4) {
        ...
        s32 divRes = ({((12) != 0) ? ((s32)(r4) / (s32)(12)) : 0;});
        r1 = r4 - (divRes * 12);
...
void sa2__sub_801F044(void)
{
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, &gUnknown_3000410, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gUnknown_3000410))/(32/8)))); };
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, &gUnknown_3000420, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gUnknown_3000420))/(32/8)))); };
}

s32 sa2__sub_801F07C(s32 p0, s32 p1, s32 p2, s32 p3, u8 *data, Func801F07C func)
{
    u8 dummy[4];
    u8 *dummy_p;
...
s32 sa2__sub_801F100(s32 p0, s32 p1, s32 p2, s32 p3, Func801F100 func)
{
    s32 result;
