# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/multiplayer/chao_message.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/multiplayer/chao_message.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/multiplayer/chao_message.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/multiplayer/chao_message.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/multiplayer/chao_message.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/multiplayer/chao_message.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/multiplayer/chao_message.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/multiplayer/chao_message.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/multiplayer/chao_message.c" 2
...
extern void LinkCommunicationError(void);
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/multiplayer/chao_message.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/multiplayer/chao_message.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/multiplayer/chao_message.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/multiplayer/chao_message.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/multiplayer/chao_message.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/text.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/multiplayer/chao_message.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/tilemaps.h" 1
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/multiplayer/chao_message.c" 2
...
void CreateMultiplayerResultsScreen(u8 mode)
{
    ...
    for (var_r2 = 0; var_r2 < 4; var_r2++) {
        if ((((gMultiplayerConnections) >> (var_r2)) & 1)) {
            gUnknown_030058B4 += 1;
        }
    };

    message = (void *)((TaskCreate(Task_ChaoMessageInit, sizeof(ChaoMessage), 0x2000U, 0U, ((void*)0)))->data);
    bg = &message->bg;
    message->mode = mode;
    ...
    gDispCnt = 0x3140;
    gBgCntRegs[0] = (0x4000) | 0x0800 | 0x0003;
    ...
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, &VRAM[0] + 0x1FE0, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((0x40)/(32/8)))); };
    ...
    bg->layoutVram = (u16 *)(&VRAM[0] + 0x4000);
    bg->unk18 = 0;
    bg->unk1A = 0;
    bg->tilemapId = 0x58;
    bg->unk1E = 0;
        ...
        case 0:
            ...
            for (i = 0; i < message->unk54; i++) {
                ...
                if (i != (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id)) {
                    if (unk5008 < 10) {
                        gUnknown_030058A8[i][0] = (&gLoadedSaveGame)->multiplayerScores[unk5008].data.split.wins;
                        gUnknown_030058A8[i][1] = (&gLoadedSaveGame)->multiplayerScores[unk5008].data.split.losses;
                    } else {
            ...
            if (sp0 > sp4) {
                message->unk40[1][((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] = 1;
                message->unk40[0][((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] = 1;
            } else if (sp0 < sp4) {
                message->unk40[1][((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] = 6;
                message->unk40[0][((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] = 6;
            } else {
                message->unk40[1][((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] = 0;
                message->unk40[0][((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] = 0;
            }
            break;
        case 1:
            if ((gUnknown_030058B4 == 2) || (gGameMode == 3) || (gGameMode == 5)) {
                for (i = 0; i < message->unk54; i++) {
                    switch (gMultiplayerRanks[i]) {
                        case 0:
                            ...
                            } else if (gMultiplayerRanks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] == 0) {
                                if ((gGameMode != 3) && (gGameMode != 5)) {
                                    ++(&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.draws;
                                    if ((&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.draws > 99) {
                                        (&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.draws = 99;
                                    }
                                }
                            } else {
                                ++(&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.losses;
                                if ((&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.losses > 99) {
                                    (&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.losses = 99;
                                }
                            }
                            break;
                        default:
                        case 1:
                            ...
                            message->unk40[0][i] = 3;
                            if (i != (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id)) {
                                if (gMultiplayerRanks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] == 0) {
                                    ++(&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.wins;
                                    if ((&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.wins > 99) {
                                        (&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.wins = 99;
                                    }
                            ...
                            if ((i != (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id))
                                && (((gGameMode != 3) && (gGameMode != 5))
                                    || (((s32)(gMultiplayerConnections & (0x10 << i)) >> (i + 4))
                                        != ((s32)(gMultiplayerConnections & (0x10 << (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id)))
                                            >> ((((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) + 4))))) {
                                ++(&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.draws;
                                if ((&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.draws > 99) {
                                    (&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.draws = 99;
                                }
                ...
                if (gMultiplayerRanks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] == 0) {
                    message->unk56 = 0;
                    if (++(&gLoadedSaveGame)->unk425 > 99) {
                        (&gLoadedSaveGame)->unk425 = 99;
                    }
                } else {
                    if ((gMultiplayerRanks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] == 4)) {
                        message->unk56 = 2;
                        if (++(&gLoadedSaveGame)->unk427 > 99) {
                            (&gLoadedSaveGame)->unk427 = 99;
                        }
                    } else {
                        message->unk56 = 1;
                        if (++(&gLoadedSaveGame)->unk426 > 99) {
                            (&gLoadedSaveGame)->unk426 = 99;
                        }
                    }
                }
            } else if (gGameMode == 4) {
                ...
                if (var_r2_3 == 1) {
                    for (i = 0; i < message->unk54; i++) {
                        if (gMultiplayerRanks[i] == 0) {
                            ...
                            if ((i != (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id)) && (gMultiplayerRanks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] == 0)) {
                                ++(&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.wins;
                                if ((&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.wins > 99) {
                                    (&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.wins = 99;
                                }
                ...
                if (var_r6 == message->unk54) {
                    ...
                    for (i = 0; i < message->unk54; i++) {
                        ...
                        if (i != ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) {
                            if (gMultiplayerRanks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] < gMultiplayerRanks[i]) {
                                ++(&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.wins;
                                if ((&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.wins > 99) {
                                    (&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.wins = 99;
                                }
                            } else if (gMultiplayerRanks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] == gMultiplayerRanks[i]) {
                                ++(&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.draws;
                                if ((&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.draws > 99) {
                                    (&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.draws = 99;
                                }
                ...
                if (gMultiplayerRanks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] == 0) {
                    message->unk56 = 0;
                    ++(&gLoadedSaveGame)->unk425;
                    if ((&gLoadedSaveGame)->unk425 > 99) {
                        (&gLoadedSaveGame)->unk425 = 99;
                    }
                } else if ((gMultiplayerRanks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] != 4) || (var_r6 != message->unk54)) {
                    message->unk56 = 1;
                    ++(&gLoadedSaveGame)->unk426;
                    if ((&gLoadedSaveGame)->unk426 > 99) {
                        (&gLoadedSaveGame)->unk426 = 99;
                    }
                } else {
                    message->unk56 = 2;
                    ++(&gLoadedSaveGame)->unk427;
                    if ((&gLoadedSaveGame)->unk427 > 99) {
                        (&gLoadedSaveGame)->unk427 = 99;
                    }
                }
...
void Task_ChaoMessageInit(void)
{
    ...
    message = (void *)((gCurTask)->data);
    for (i = 0; i < message->unk54; i++) {
        msgSprite = (void *)((TaskCreate(Task_803C130, sizeof(ChaoMsgSprite), 0x2100U, 0U, TaskDestructor_803C184))->data);
...
void sub_803B944()
{
    ...
    if (message->mode != 1) {
        ...
        if ((0x0001 & gPressedKeys) || (message->unk52 > 0x707U) || (var_r6 != 0)) {
            gCurTask->main = sub_803BAD4;
            message->unk52 = 0;
            if (var_r6 == 0) {
...
void sub_803BC64()
{
    ChaoMessage *message = (void *)((gCurTask)->data);
    u32 mode;
    ...
    if (mode == 0) {
    ...
    } else if (message->mode == 1) {
        {
            ...
            gFlags |= 0x8000;
            irqEnable = (*(reg_u16 *)(REG_BASE + 0x200));
            irqMasterEnable = (*(reg_u16 *)(REG_BASE + 0x208));
            dispStat = (*(reg_u16 *)(REG_BASE + 0x4));
            ...
            (*(reg_u16 *)(REG_BASE + 0x200)) = irqEnable;
            (*(reg_u16 *)(REG_BASE + 0x200));
            (*(reg_u16 *)(REG_BASE + 0x208)) = irqMasterEnable;
            (*(reg_u16 *)(REG_BASE + 0x208));
            (*(reg_u16 *)(REG_BASE + 0x4)) = dispStat;
            (*(reg_u16 *)(REG_BASE + 0x4));
...
void sub_803BE0C()
{
    ...
    if (message->unk50 != 0) {
        sa2__sub_80078D4(0U, 0U, var_r4, 320, 0U);
    }
    ...
    for (var_r6 = 0; var_r6 < message->unk54; var_r6++) {
        ...
        sa2__sub_80078D4(0U, var_r4, var_r4 + 0x28, ~message->unk48[var_r6] & mask, (-message->unk50));
        var_r4 += 0x28;

    }

    if (var_r4 < 240) {
        sa2__sub_80078D4(0U, var_r4, 240, 320, 0U);
    }
}
...
void sub_803BEB8(void)
{
    ...
    strc68 = (void *)((TaskCreate(sub_803BFE8, sizeof(ChaoMsg68), 0x2200U, 0U, TaskDestructor_803C198))->data);
    gfx.uiGfxID = 0;
    gfx.unk2B = 1;
...
void sub_803BFE8()
{
    ChaoMsg68 *strc68 = (void *)((gCurTask)->data);
    ChaoMessage *parent = (void *)(((struct Task *)((gCurTask)->parent))->data);
    u8 charIndex;
    u8 i;
    ...
    for (i = 0; i < parent->unk54; i++) {
        for (charIndex = 0; charIndex < 6; charIndex++) {
            ...
            if (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id == i) {
                if ((u8)((&gLoadedSaveGame)->playerName[charIndex] - 0x70) < 26) {
                    overB->unkC += 8;
                }
                sub_8052F78((const char *)&(&gLoadedSaveGame)->playerName[charIndex], overB);
            } else {
                if ((u8)((&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.playerName[charIndex] - 0x70) < 26) {
                    overB->unkC += 8;
                }
                sub_8052F78((const char *)&(&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[i]].data.split.playerName[charIndex], overB);
            }
        }
    }
}
...
void Task_803C130(void)
{
    ChaoMsgSprite *msgSprite = (void *)((gCurTask)->data);
    Sprite *s = &msgSprite->s;

    ChaoMessage *message = (void *)(((struct Task *)((gCurTask)->parent))->data);
...
void TaskDestructor_803C184(struct Task *t)
{
    ChaoMsgSprite *msgSprite = (void *)((t)->data);
    VramFree(msgSprite->s.graphics.dest);
}

void TaskDestructor_803C198(struct Task *t)
{
    ChaoMsg68 *strc68 = (void *)((t)->data);
