# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/skating_stone.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/skating_stone.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/skating_stone.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/skating_stone.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/skating_stone.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/skating_stone.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/skating_stone.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/skating_stone.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/skating_stone.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/skating_stone.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/skating_stone.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/skating_stone.c" 2
...
void CreateEntity_SkatingStone(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    SkatingStone *stone = (void *)((t)->data);
    Sprite *s = &stone->s;
    ...
    if (((gCurrentLevel) >> 1) == 3) {
        s->graphics.dest = VramMalloc(((48 / 8) * (32 / 8)));
        s->graphics.anim = 529;
        s->variant = 0;
    } else {
        s->graphics.dest = VramMalloc(((48 / 8) * (32 / 8)));
...
{
    bool32 sl = 0;
    SkatingStone *stone = (void *)((gCurTask)->data);
    Sprite *s = &stone->s;
    CamCoord worldX, worldY;
    MapEntity *me = stone->base.me;
    s32 i;

    worldX = ((stone->base.meX)*8 + (stone->base.regionX)*256);
    worldY = ((me->y)*8 + (stone->base.regionY)*256);
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            if (sub_80549FC()) {
                if ((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY > ((s32)((worldY)*256))) {
                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).charState != 73) {
                        if (Coll_Player_SkatingStone(s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer))) & 0x00010000) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((worldY + 6)*256));
                        }
                    }
                } else {
                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).charState != 72) {
                        Coll_Player_SkatingStone(s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)));
                    }
                }
            } else {
                if (Coll_Player_SkatingStone(s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer))) & 0x00000008) {
                    ...
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((worldY)*256)) - ((s32)((44)*256));
    ...
    if ((((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
        { me->x = stone->base.meX; };
...
void Task_SkatingStone2(void)
{
    ...
    s->y = ((int)((stone->qUnkAC) >> 8)) + worldY - gCamera.y;
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            ...
            if ((((stone->unkB2) >> (i)) & 1)) {
                if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & (0x00000400 | 0x00000004))) {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((worldY)*256)) + stone->qUnkAC - ((s32)((46)*256));
                } else {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((worldY)*256)) + stone->qUnkAC - ((s32)((42)*256));
                }
            }
        }
    } while (++i < gNumSingleplayerCharacters);
    ...
    if (stone->unkB0 != 0) {
        res = sa2__sub_801F07C(worldY + ((int)((stone->qUnkAC) >> 8)), worldX + ((int)((stone->qUnkA8) >> 8)), layer, +8, ((void*)0), sa2__sub_801EE64);

        if (res >= 0) {
            stone->qUnkA4 += ((s32)((32. / 256.)*256));
        } else {
            stone->qUnkA4 = ((s32)((0)*256));
            ...
            if (stone->unkB1 != 0) {
                ...
                s32 i = 0;
                do {
                    if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080) && (((stone->unkB2) >> (i)) & 1)) {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = -((s32)((3)*256));
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = stone->qUnkA0;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = stone->qUnkA0;

                        Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));

                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00000008;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000002;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).stoodObj = ((void*)0);

                        if ((*(((i) != 0) ? &gPartner : &gPlayer)).character != CHARACTER_AMY) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 5;
                        } else {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 85;
                        }
                ...
                CreateSkatingStoneDebris(worldX + ((int)((stone->qUnkA8) >> 8)) - s->x, worldY + ((int)((stone->qUnkAC) >> 8)) - 20 - s->y);
        ...
        res = sa2__sub_801E4E4(worldY + ((int)((stone->qUnkAC) >> 8)), worldX + ((int)((stone->qUnkA8) >> 8)), layer, +8, &sp08, sa2__sub_801EE64);

        if (res > 5) {
            m4aSongNumStop(198);

            if (((gCurrentLevel) >> 1) != 3) {
                stone->qUnkA4 += -((({((5) != 0) ? ((s32)(stone->qUnkA0 * 3) / (s32)(5)) : 0;})) < 0 ? -(({((5) != 0) ? ((s32)(stone->qUnkA0 * 3) / (s32)(5)) : 0;})) : (({((5) != 0) ? ((s32)(stone->qUnkA0 * 3) / (s32)(5)) : 0;})));
            } else {
                stone->qUnkA4 += +((({((5) != 0) ? ((s32)(stone->qUnkA0 * 2) / (s32)(5)) : 0;})) < 0 ? -(({((5) != 0) ? ((s32)(stone->qUnkA0 * 2) / (s32)(5)) : 0;})) : (({((5) != 0) ? ((s32)(stone->qUnkA0 * 2) / (s32)(5)) : 0;})));
            }
            stone->unkB0 = 1;
        } else {
            s32 i = 0;
            do {
                if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080) && (((stone->unkB2) >> (i)) & 1)) {
                    if (stone->unkB3 != 0) {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX += ({((6070) != 0) ? ((s32)((gSineTable[(sp08 * 4) + 256])) / (s32)(6070)) : 0;});
                    } else {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX -= ({((6070) != 0) ? ((s32)((gSineTable[(sp08 * 4) + 256])) / (s32)(6070)) : 0;});
                    }
                }
            ...
            if (stone->unkB3 != 0) {
                stone->qUnkA0 -= ({((1440) != 0) ? ((s32)((gSineTable[(sp08 * 4) + 256])) / (s32)(1440)) : 0;});
            } else {
                stone->qUnkA0 += ({((1440) != 0) ? ((s32)((gSineTable[(sp08 * 4) + 256])) / (s32)(1440)) : 0;});
            }

            stone->qUnkAC += ((s32)((res + 3)*256));
        }
    }

    {
        s32 res = sa2__sub_801F07C(worldX + ((int)((stone->qUnkA8) >> 8)) + 18, worldY + ((int)((stone->qUnkAC) >> 8)) - 30, layer, +8, &sp08,
                                         sa2__sub_801ED24);
        ...
        _0808D2B2:
                ...
                if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
                    if ((((stone->unkB2) >> (i)) & 1)) {
                        if ((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000002) {
                            ...
                            res = sa2__sub_801F07C(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)), ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)), (*(((i) != 0) ? &gPartner : &gPlayer)).layer, +8, ((void*)0),
                                                         sa2__sub_801ED24);
                            ...
                            if (res < 0) {
                                ...
                                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX += ((s32)((res)*256));
                            }
                            ...
                            if (Coll_Player_Entity_Intersection(s, worldX + ((int)((stone->qUnkA8) >> 8)), worldY + ((int)((stone->qUnkAC) >> 8)) - 12, &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX += stone->qUnkA0 * 2;

                                res = sa2__sub_801E4E4(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX + stone->qUnkA0 * 2) >> 8)), ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)),
                                                             (*(((i) != 0) ? &gPartner : &gPlayer)).layer, +8, ((void*)0), sa2__sub_801ED24);
                                ...
                                if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & (0x00000400 | 0x00000004))) {
                                    s->y = ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) - gCamera.y + 46;
                                } else {
                                    s->y = ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) - gCamera.y + 42;
                                }
                            } else {
                                Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                        ...
                        u32 collRes = Coll_Player_PlatformCrumbling(s, worldX + ((int)((stone->qUnkA8) >> 8)), worldY + ((int)((stone->qUnkAC) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer)));

                        if (collRes & 0x00000008) {
            ...
            s->x = worldX + ((int)((stone->qUnkA8) >> 8)) - gCamera.x;
...
void CreateSkatingStoneDebris(CamCoord worldX, CamCoord worldY)
{
    ...
    SkatingStoneDebris *debris = (void *)((t)->data);
    Sprite *s = &debris->s[0];
    SpriteTransform *tf = &debris->transform[0];

    debris->unkF0 = 0;
    debris->qUnkF2 = -((s32)((2)*256));

    if (((gCurrentLevel) >> 1) == 3) {
        s->graphics.dest = VramMalloc(((8 / 8) * (8 / 8)));
        s->graphics.anim = 554;
        s->variant = 0;
    } else {
        s->graphics.dest = VramMalloc(((8 / 8) * (8 / 8)));
    ...
    s->animSpeed = ((int)((float)(1.0)*0x10));
    s->palId = 0;
    s->frameFlags = (((1) << (5)) | ((1) << (6)) | ((12) << (0)));

    tf->rotation = 0;
    tf->qScaleX = ((s32)((0.75)*256));
    tf->qScaleY = ((s32)((0.75)*256));
    tf->x = worldX;
    tf->y = worldY;

    UpdateSpriteAnimation(s);
# 534 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/skating_stone.c"
    DmaSet(3, s, (s + 1), (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(*s))/(16/8))));
    s = (s + 1);
    DmaSet(3, tf, (tf + 1), (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(*tf))/(16/8))));
    tf = (tf + 1);

    s->frameFlags = (((1) << (5)) | ((1) << (6)) | ((13) << (0)));
...
void Task_SkatingStoneDebris(void)
{
    SkatingStoneDebris *debris = (void *)((gCurTask)->data);
    Sprite *s = &debris->s[0];
    SpriteTransform *tf;
    s16 oldTfX, oldTfY;
    s16 qScaleX;
    ...
    debris->qUnkF2 += ((s32)((40. / 256.)*256));

    {
        tf = &debris->transform[0];
        tf->y += ((int)((debris->qUnkF2) >> 8));
        oldTfX = tf->x;
        oldTfY = tf->y;
        tf->x = tf->x - gCamera.x;
        tf->y = tf->y - gCamera.y;
        ...
        qScaleX = tf->qScaleX + ((s32)((8. / 256.)*256));
        if (qScaleX > ((s32)((2)*256))) {
            qScaleX = ((s32)((2)*256));
        }

        tf->qScaleX = qScaleX;
        tf->qScaleY = qScaleX;
        tf->rotation = (tf->rotation - ((s32)((42. / 256.)*256))) & (1024 - 1);

        (s)->frameFlags &= ~(((0x1F) << (0)));
        (s)->frameFlags |= ((gOamMatrixIndex++) << (0));

        sa2__sub_8004E14(s, tf);
...

    {
        ...
        tf->qScaleX = qScaleX;
        tf->qScaleY = qScaleX;
        tf->rotation = (tf->rotation + ((s32)((14. / 256.)*256))) & (1024 - 1);
