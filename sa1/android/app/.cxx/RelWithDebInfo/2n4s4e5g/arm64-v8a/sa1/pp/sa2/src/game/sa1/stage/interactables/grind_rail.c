# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/grind_rail.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/grind_rail.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/grind_rail.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/grind_rail.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/grind_rail.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/grind_rail.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/grind_effect_1.h" 1
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/grind_rail.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/grind_rail.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/grind_rail.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/grind_rail.c" 2
...
# 32 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/grind_rail.c"
...
void Task_GrindRailStart(void)
{
    ...
    rail = (void *)((gCurTask)->data);

    me = rail->me;
    meX = *(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(GrindRail, meX));
    regionX = *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(GrindRail, regionX));
    regionY = *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(GrindRail, regionY));
    ...
    if ((!(gPlayer.moveState & 0x00000080))) {
        ...
        if ((worldX <= ((int)((gPlayer.qWorldX) >> 8)))
            && (worldX + me->d.uData[2] * 8 >= ((int)((gPlayer.qWorldX) >> 8)))
            && (worldY <= ((int)((gPlayer.qWorldY) >> 8)))
            && (worldY + me->d.uData[3] * 8 >= ((int)((gPlayer.qWorldY) >> 8)))
            && !(gPlayer.moveState & 0x01000000) && (gPlayer.qSpeedAirY >= ((s32)((0)*256))) && (gPlayer.qSpeedAirX > ((s32)((0)*256))))
        {
            gPlayer.qSpeedAirX = (((((s32)((0.5)*256))) > (gPlayer.qSpeedAirX)) ? (((s32)((0.5)*256))) : (gPlayer.qSpeedAirX));

            gPlayer.moveState |= 0x01000000;
            gPlayer.layer ^= 1;
...
void Task_GrindRailEnd(void)
{
    ...
    if ((!(gPlayer.moveState & 0x00000080))) {
        ...
        if ((worldX <= ((int)((gPlayer.qWorldX) >> 8)))
            ...
            && (gPlayer.moveState & 0x01000000))
        {
            if (((int)((gPlayer.qWorldX) >> 8)) > worldX + ((me->d.uData[2] * 8) >> 1)) {
                ...
                gPlayer.charState = 17;
                gPlayer.moveState |= 0x00000002;
                gPlayer.moveState &= ~0x01000000;
                gPlayer.layer ^= 1;
                gPlayer.itemEffect &= ~0x80;
                gPlayerBodyPSI.s.frameFlags &= ~((3) << (12));
                gPlayerBodyPSI.s.frameFlags |= ((2) << (12));
            } else if (gInput & gPlayerControls.jump) {
                gPlayer.qSpeedAirY = -((s32)(((7.0))*256));
...
{
    struct Task *t = TaskCreate(Task_8023EFC, sizeof(GrindRailUnk), 0x2000, 0, ((void*)0));
    *(u16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(GrindRailUnk, frameCount)) = (0);;
}

void Task_8023EFC(void)
{
    GrindRailUnk *unk = (void *)((gCurTask)->data);
...
{
    struct Task *t = TaskCreate(Task_GrindRailStart, sizeof(GrindRail), 0x2000, 0, ((void*)0));

    *(u16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(GrindRail, regionX)) = (regionX);;
    *(u16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(GrindRail, regionY)) = (regionY);;
    *(MapEntity * *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(GrindRail, me)) = (me);;
    *(u8 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(GrindRail, meX)) = (me->x);;
...
{
    struct Task *t = TaskCreate(Task_GrindRailEnd, sizeof(GrindRail), 0x900, 0, ((void*)0));
