# 1 "/home/awaszczak/git/sa2/sa1/../src/lib/agb_flash/agb_flash.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/lib/agb_flash/agb_flash.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/lib/agb_flash/agb_flash.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/lib/agb_flash/agb_flash.c" 2
...
u16 SetFlashTimerIntr(u8 timerNum, void (**intrFunc)(void));
extern u16 (*EraseFlashSector)(u16);
# 4 "/home/awaszczak/git/sa2/sa1/../src/lib/agb_flash/agb_flash.c" 2
...
u16 (*WaitForFlashWrite)(u8 phase, u8 *addr, u8 lastData) = ((void*)0);
u16 (*ProgramFlashSector)(u16 sectorNum, void *src) = ((void*)0);
const struct FlashType *gFlash = ((void*)0);
u16 gFlashNumRemainingBytes = 0;
u16 (*EraseFlashChip)() = ((void*)0);
u16 (*EraseFlashSector)(u16 sectorNum) = ((void*)0);




void SetReadFlash1(u16 *dest);
# 58 "/home/awaszczak/git/sa2/sa1/../src/lib/agb_flash/agb_flash.c"
u16 ReadFlashId(void)
{
    u16 flashId;
    ...
    ((*(vu8 *)(FLASH_BASE + (0x5555))) = (0xAA));
    ((*(vu8 *)(FLASH_BASE + (0x2AAA))) = (0x55));
    ((*(vu8 *)(FLASH_BASE + (0x5555))) = (0x90));
...
u16 IdentifyFlash(void)
{
    ...
    (*(reg_u16 *)(REG_BASE + 0x204)) = ((*(reg_u16 *)(REG_BASE + 0x204)) & ~(3 << 0)) | (3 << 0);
...
u16 SetFlashTimerIntr(u8 timerNum, void (**intrFunc)(void))
{
    ...
    sTimerNum = timerNum;
    gTimerReg = &(*(reg_u16 *)((REG_BASE + 0x100) + ((sTimerNum) * 4)));
...
void StartFlashTimer(u8 phase)
{
    ...
    gSavedIme = (*(reg_u16 *)(REG_BASE + 0x208));
    (*(reg_u16 *)(REG_BASE + 0x208)) = 0;
    gTimerReg[1] = 0;
    (*(reg_u16 *)(REG_BASE + 0x200)) |= ((1 << 3) << sTimerNum);
    gFlashTimeoutFlag = 0;
    sTimerCount = *maxTime++;
    *gTimerReg++ = *maxTime++;
    *gTimerReg-- = *maxTime++;
    (*(reg_u16 *)(REG_BASE + 0x202)) = ((1 << 3) << sTimerNum);
...
void StopFlashTimer(void)
{
    ...
    *gTimerReg-- = 0;
    (*(reg_u16 *)(REG_BASE + 0x200)) &= ~((1 << 3) << sTimerNum);
    (*(reg_u16 *)(REG_BASE + 0x208)) = gSavedIme;
}
...
void ReadFlash(u16 sectorNum, u32 offset, void *dest, u32 size)
{
    ...
    (*(reg_u16 *)(REG_BASE + 0x204)) = ((*(reg_u16 *)(REG_BASE + 0x204)) & ~(3 << 0)) | (3 << 0);
# 246 "/home/awaszczak/git/sa2/sa1/../src/lib/agb_flash/agb_flash.c"
...
u32 VerifyFlashSector(u16 sectorNum, u8 *src)
{
    ...
    (*(reg_u16 *)(REG_BASE + 0x204)) = ((*(reg_u16 *)(REG_BASE + 0x204)) & ~(3 << 0)) | (3 << 0);
# 297 "/home/awaszczak/git/sa2/sa1/../src/lib/agb_flash/agb_flash.c"
...
u32 VerifyFlashSectorNBytes(u16 sectorNum, u8 *src, u32 n)
{
    ...
    u8 *tgt;
    u32 (*verifyFlashSector_Core)(u8 *, u8 *, u32);
# 337 "/home/awaszczak/git/sa2/sa1/../src/lib/agb_flash/agb_flash.c"
    (*(reg_u16 *)(REG_BASE + 0x204)) = ((*(reg_u16 *)(REG_BASE + 0x204)) & ~(3 << 0)) | (3 << 0);
