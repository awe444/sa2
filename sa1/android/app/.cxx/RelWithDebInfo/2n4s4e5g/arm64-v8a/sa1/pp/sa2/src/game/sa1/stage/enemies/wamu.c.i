# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/wamu.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/wamu.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/wamu.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/wamu.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/wamu.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/wamu.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/wamu.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/wamu.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/wamu.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/wamu.c" 2
...
void CreateEntity_Wamu(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    wamu->qUnkBE = -((s32)((0.625)*256));
    wamu->qUnkB4 = ((s32)((0)*256));
    wamu->unkB8 = 0;
    wamu->unkBC = 100;
    wamu->unk1C0 = 1;
...
void Task_Wamu(void)
{
    ...
    sp0C = 0;
    wamu = (void *)((gCurTask)->data);
    s = &wamu->s;
    s2 = &wamu->s2;
    s3 = &wamu->s3;
    me = wamu->base.me;

    worldX = ((wamu->base.meX)*8 + (wamu->base.regionX)*256);
    worldY = ((me->y)*8 + (wamu->base.regionY)*256);

    worldX2 = worldX;
    worldY2 = worldY;

    wamu->qUnkB4 += ({((80 - me->d.uData[3] * (8 / 2)) != 0) ? ((s32)((gSineTable[(wamu->unkBC & (1024 - 1)) + 256])) / (s32)(80 - me->d.uData[3] * (8 / 2))) : 0;});
    worldX += ((int)((wamu->qUnkB4) >> 8));
    wamu->unkB8 += ({((80) != 0) ? ((s32)((gSineTable[(wamu->unkBC & (1024 - 1))])) / (s32)(80)) : 0;});
    worldY += ((int)((wamu->unkB8) >> 8));
    ...
    if (s->frameFlags & ((1) << (10))) {
        ...
        if (wamu->unk1C0) {
            ...
            if ((u16)((wamu->unkBC & (1024 - 1)) - 101) < 823) {
                wamu->unkBC = 100;
                wamu->unk1C0 = 0;
                sp0C = 1;
            }
    ...
    {
        wamu->worldXs[(++wamu->unk1C1) % (sizeof(wamu->worldXs) / sizeof((wamu->worldXs)[0]))] = worldX;
        wamu->worldYs[(wamu->unk1C1) % (sizeof(wamu->worldYs) / sizeof((wamu->worldYs)[0]))] = worldY;

        if (((worldX2) > gCamera.x + (320 + (256 / 2)) || (worldX2) < gCamera.x - (256 / 2) || (worldY2) > gCamera.y + ((240) + ((256) / 2)) || (worldY2) < gCamera.y - (256 / 2)) && (((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
            { me->x = wamu->base.meX; };
        ...
        if (((int)((wamu->qUnkB4) >> 8)) <= (me->d.sData[0] * 8)) {
            if ((~s->frameFlags & ((1) << (10))) && sp0C) {
                wamu->qUnkBE = +((s32)((0.625)*256));
                (s)->frameFlags |= (((1) << (10)));
                (s2)->frameFlags |= (((1) << (10)));
                (s3)->frameFlags |= (((1) << (10)));
        ...
        } else if (((int)((wamu->qUnkB4) >> 8)) >= ((me->d.sData[0] + me->d.uData[2]) * 8)) {
        ...
        s3->x = s->x - (wamu->worldXs[(wamu->unk1C1 - 24) % (sizeof(wamu->worldXs) / sizeof((wamu->worldXs)[0]))] - gCamera.x);
        v = (s3->x >> 1);

        s3->x = (wamu->worldXs[(wamu->unk1C1 - 24) % (sizeof(wamu->worldXs) / sizeof((wamu->worldXs)[0]))] - (s3->x >> 1)) - gCamera.x;
        s3->y = wamu->worldYs[(wamu->unk1C1 - 40) % (sizeof(wamu->worldYs) / sizeof((wamu->worldYs)[0]))] - gCamera.y;

        UpdateSpriteAnimation(s3);
        DisplaySprite(s3);

        if (((s3->hitboxes[0]).index != -1)) {
            if ((((((worldX) + s3->hitboxes[0].b.left) <= ((((int)((gPlayer.qWorldX) >> 8))) + gPlayerBodyPSI.s.hitboxes[0].b.left) && ((((worldX)) + (s3->hitboxes[0].b).left) + ((s3->hitboxes[0].b).right - (s3->hitboxes[0].b).left)) >= ((((int)((gPlayer.qWorldX) >> 8))) + gPlayerBodyPSI.s.hitboxes[0].b.left)) || (((worldX) + s3->hitboxes[0].b.left) >= ((((int)((gPlayer.qWorldX) >> 8))) + gPlayerBodyPSI.s.hitboxes[0].b.left) && ((((((int)((gPlayer.qWorldX) >> 8)))) + (gPlayerBodyPSI.s.hitboxes[0].b).left) + ((gPlayerBodyPSI.s.hitboxes[0].b).right - (gPlayerBodyPSI.s.hitboxes[0].b).left)) >= ((worldX) + s3->hitboxes[0].b.left))) && (((((worldY)) + s3->hitboxes[0].b.top) <= (((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].b.top) && ((((worldY)) + s3->hitboxes[0].b.top) + ((s3->hitboxes[0].b).bottom - (s3->hitboxes[0].b).top)) >= (((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].b.top)) || ((((worldY)) + s3->hitboxes[0].b.top) >= (((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].b.top) && ((((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].b.top) + ((gPlayerBodyPSI.s.hitboxes[0].b).bottom - (gPlayerBodyPSI.s.hitboxes[0].b).top)) >= (((worldY)) + s3->hitboxes[0].b.top))))) {
    ...
    {
        s3->x = s->x - (wamu->worldXs[(wamu->unk1C1 - 19) % (sizeof(wamu->worldXs) / sizeof((wamu->worldXs)[0]))] - gCamera.x);
        v = (s3->x >> 1);
        s3->x = (wamu->worldXs[(wamu->unk1C1 - 19) % (sizeof(wamu->worldXs) / sizeof((wamu->worldXs)[0]))] - v) - gCamera.x;
        s3->y = (wamu->worldYs[(wamu->unk1C1 - 30) % (sizeof(wamu->worldYs) / sizeof((wamu->worldYs)[0]))]) - gCamera.y;
    ...
    {
        s2->x = s->x - (wamu->worldXs[(wamu->unk1C1 - 14) % (sizeof(wamu->worldXs) / sizeof((wamu->worldXs)[0]))] - gCamera.x);
        v = (s2->x >> 1);
        s2->x = (wamu->worldXs[(wamu->unk1C1 - 14) % (sizeof(wamu->worldXs) / sizeof((wamu->worldXs)[0]))] - v) - gCamera.x;
        s2->y = (wamu->worldYs[(wamu->unk1C1 - 20) % (sizeof(wamu->worldYs) / sizeof((wamu->worldYs)[0]))] - gCamera.y);
        ...
        if (((s2->hitboxes[0]).index != -1)) {
            if ((((((worldX) + s2->hitboxes[0].b.left) <= ((((int)((gPlayer.qWorldX) >> 8))) + gPlayerBodyPSI.s.hitboxes[0].b.left) && ((((worldX)) + (s2->hitboxes[0].b).left) + ((s2->hitboxes[0].b).right - (s2->hitboxes[0].b).left)) >= ((((int)((gPlayer.qWorldX) >> 8))) + gPlayerBodyPSI.s.hitboxes[0].b.left)) || (((worldX) + s2->hitboxes[0].b.left) >= ((((int)((gPlayer.qWorldX) >> 8))) + gPlayerBodyPSI.s.hitboxes[0].b.left) && ((((((int)((gPlayer.qWorldX) >> 8)))) + (gPlayerBodyPSI.s.hitboxes[0].b).left) + ((gPlayerBodyPSI.s.hitboxes[0].b).right - (gPlayerBodyPSI.s.hitboxes[0].b).left)) >= ((worldX) + s2->hitboxes[0].b.left))) && (((((worldY)) + s2->hitboxes[0].b.top) <= (((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].b.top) && ((((worldY)) + s2->hitboxes[0].b.top) + ((s2->hitboxes[0].b).bottom - (s2->hitboxes[0].b).top)) >= (((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].b.top)) || ((((worldY)) + s2->hitboxes[0].b.top) >= (((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].b.top) && ((((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].b.top) + ((gPlayerBodyPSI.s.hitboxes[0].b).bottom - (gPlayerBodyPSI.s.hitboxes[0].b).top)) >= (((worldY)) + s2->hitboxes[0].b.top))))) {
                Coll_DamagePlayer(&gPlayer);
            }
        }

        s2->x = s->x - (wamu->worldXs[(wamu->unk1C1 - 7) % (sizeof(wamu->worldXs) / sizeof((wamu->worldXs)[0]))] - gCamera.x);
        v = (s2->x >> 1);
        s2->x = ((wamu->worldXs[(wamu->unk1C1 - 7) % (sizeof(wamu->worldXs) / sizeof((wamu->worldXs)[0]))]) - v) - gCamera.x;
        s2->y = wamu->worldYs[(wamu->unk1C1 - 10) % (sizeof(wamu->worldYs) / sizeof((wamu->worldYs)[0]))] - gCamera.y;
