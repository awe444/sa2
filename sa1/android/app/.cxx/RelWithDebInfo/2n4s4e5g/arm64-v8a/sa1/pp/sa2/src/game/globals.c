# 1 "/home/awaszczak/git/sa2/sa1/../src/game/globals.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/globals.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/globals.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/globals.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/globals.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/globals.c" 2

u8 gSpikesUnknownTimer = 0;
u32 gCheckpointTime = 0;
u8 gMultiplayerCharRings[4] = {};




u16 __attribute__((aligned(4))) gRingCount = 0;
struct Task *__attribute__((aligned(4))) gChaoTasks[3] = {};
...
u8 __attribute__((aligned(4))) gActiveCollectRingEffectCount = 0;




u8 __attribute__((aligned(4))) gRoomEventQueueSendPos = 0;
u16 __attribute__((aligned(4))) gStageFlags = 0;


u8 __attribute__((aligned(4))) gUnknown_03005008[4] = {};

u8 __attribute__((aligned(4))) gMPRingCollectWins[4] = {};
# 44 "/home/awaszczak/git/sa2/sa1/../src/game/globals.c"
u32 gMultiplayerPseudoRandom = 0;
u8 __attribute__((aligned(4))) gRoomEventQueueWritePos = 0;
s8 __attribute__((aligned(4))) sa2__gUnknown_0300543C = 0;



s8 __attribute__((aligned(4))) gTrappedAnimalVariant = 0;

u8 __attribute__((aligned(4))) gFinalBossActive = 0;


u8 __attribute__((aligned(4))) gNumLives = 0;

u16 __attribute__((aligned(4))) gUnknown_03005028 = 0;

u16 __attribute__((aligned(4))) gPrevStageFlags = 0;
s32 gLevelScore = 0;
...
MusicManagerState __attribute__((aligned(8))) gMusicManagerState = {};



s8 __attribute__((aligned(4))) gMultiplayerRanks[4] = {};
u8 __attribute__((aligned(4))) gOamMatrixIndex = 0;


s8 __attribute__((aligned(4))) gTailsEnabled = 0;
...
u8 __attribute__((aligned(4))) gDemoPlayCounter = 0;


u16 __attribute__((aligned(4))) gSpecialStageReturnX = 0;


u8 __attribute__((aligned(4))) gGameMode = 0;





u8 __attribute__((aligned(4))) gMultiplayerMissingHeartbeats[4] = {};

u16 __attribute__((aligned(4))) gSpecialStageReturnY = 0;



struct Task *__attribute__((aligned(4))) gEntitiesManagerTask = ((void*)0);





u8 __attribute__((aligned(4))) gDestroySpotlights = 0;


u16 __attribute__((aligned(4))) gUnknown_03005070 = 0;


u8 __attribute__((aligned(4))) gRandomItemBox = 0;

u16 __attribute__((aligned(4))) gSpecialStageCollectedRings = 0;
u16 __attribute__((aligned(4))) gUnknown_0300507C = 0;

u8 __attribute__((aligned(4))) gDifficultyLevel = 0;

s8 __attribute__((aligned(4))) gSelectedCharacter = 0;


s8 __attribute__((aligned(4))) gNumSingleplayerCharacters = 0;





s8 __attribute__((aligned(4))) gUsedSaveSectorID = 0;
...
s8 __attribute__((aligned(4))) gMultiplayerCharacters[4] = {};
RoomEvent __attribute__((aligned(16))) gRoomEventQueue[16] = {};
u32 gStageTime = 0;


s8 __attribute__((aligned(4))) gMultiplayerCurrentLevel = 0;
# 160 "/home/awaszczak/git/sa2/sa1/../src/game/globals.c"
struct Task *gMultiplayerPlayerTasks[4] __attribute__((aligned(16))) = {};



u8 __attribute__((aligned(4))) gUnknown_03005140 = 0;


u8 __attribute__((aligned(8))) gBossIndex = 0;

s8 __attribute__((aligned(4))) gCurrentLevel = 0;
u8 __attribute__((aligned(4))) gMultiplayerConnections = 0;
