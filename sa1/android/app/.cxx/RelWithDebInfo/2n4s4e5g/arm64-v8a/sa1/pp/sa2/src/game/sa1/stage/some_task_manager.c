# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/some_task_manager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/some_task_manager.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/some_task_manager.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/some_task_manager.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/some_task_manager.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/some_task_manager.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/some_task_manager.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/move_states.h" 1
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/some_task_manager.c" 2
...
{
    SomeTaskManager_60 *taskData = (void *)((gCurTask)->data);
    Sprite *s = &taskData->s;
    SpriteTransform *transform = &taskData->transform;
    Camera *cam = &gCamera;
    s32 screenX, screenY;

    screenX = ((int)((taskData->qUnk50) >> 8)) - cam->x;
    screenY = ((int)((taskData->qUnk54) >> 8)) - cam->y;


    if ((screenX < -32 || screenX >= 320 + 32) || (screenY >= 240 + 64)) {
...
void TaskDestructor_SomeTaskManager_60_Common(struct Task *t)
{
    SomeTaskManager_60 *taskData = (void *)((t)->data);
    Sprite *s = &taskData->s;
