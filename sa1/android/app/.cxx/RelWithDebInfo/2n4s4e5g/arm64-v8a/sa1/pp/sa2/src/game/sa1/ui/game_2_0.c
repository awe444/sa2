# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_0.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_0.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_0.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_0.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_0.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_0.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_0.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_0.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_0.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_0.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_0.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_0.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_0.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_0.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_0.c" 2
...
void sub_805BC94(u16 arg0)
{
    ...
    if ((({((100) != 0) ? ((s32)(arg0) / (s32)(100)) : 0;}) << 0x18) != 0) {
        sp38 = 3;
    } else {
        temp_r0_2 = ({((10) != 0) ? ((s32)(arg0) / (s32)(10)) : 0;});
    ...
    sp00.tilesSize = 80 * 32;
    sp00.paletteSize = 0x20;
    sp00.unk28 = 6;
    sp00.vramC = &VRAM[0x10000] + 0x5DA0;
    sp00.unk2A = 13;
    ...
    sp00.tilesSize = 16 * 32;
    sp00.paletteSize = 0x20;
    sp00.unk28 = 6;
    sp00.vramC = &VRAM[0x10000] + 0x77A0;
    sp00.unk2A = 13;
    ...
    sp00.paletteSize = 0x20;
    sp00.unk28 = 6;
    sp00.vramC = &VRAM[0x10000] + 0x67A0;
    sp00.unk2A = 13;
    sp00.unk0.unk4 = gUiGraphics[sp00.uiGfxID].unk8;
    sp00.unk0.unk8 = gUiGraphics[sp00.uiGfxID].unkC;
    sp00.unk0.unk9 = gUiGraphics[sp00.uiGfxID].unk10;
    ...
    switch (sp38) {
        case 3: {
            sp34 = 1;
            temp_r5 = (u8)({((100) != 0) ? ((s32)(arg0) / (s32)(100)) : 0;});
            arg0 = (s32)(u16)({((100) != 0) ? ((s32)(arg0) % (s32)(100)) : 0;});
            if (temp_r5 != 0) {
                sp34 = 0;
                sp00.uiGfxID = 32;
                sp00.unk2B = sp38;
                sp00.tiles = *(&gUiGraphics[32].tiles) + (temp_r5 << 7);
                sp00.palette = *(&gUiGraphics[32].palette);
                sp00.vramC = &VRAM[0x10000] + 0x69E0;
                sp00.tilesSize = 0x40;
                sp00.paletteSize = 0x20;
                sp00.unk28 = 6;
                sp00.unk2A = 13;
                sp00.unk0.unk4 = *(&gUiGraphics[32].unk8);
                sp00.unk0.unk8 = *(&gUiGraphics[32].unkC);
                sp00.unk0.unk9 = *(&gUiGraphics[32].unk10);
                sp00.unk0.unkA = *(&gUiGraphics[32].unk14);
                sp00.unk0.unkB = *(&gUiGraphics[32].unk18);
                sub_80528AC(&sp00);

                sp00.uiGfxID = 32;
                sp00.unk2B = sp38;
                sp00.tiles = *(&gUiGraphics[32].tiles) + (temp_r5 << 7) + 0x40;
                sp00.palette = *(&gUiGraphics[32].palette);
                sp00.vramC = &VRAM[0x10000] + 0x6A60;
                sp00.tilesSize = 2 * 32;
                sp00.paletteSize = 0x20;
                sp00.unk28 = 6;
                sp00.unk2A = 13;
            ...
            temp_r5 = (u8)({((10) != 0) ? ((s32)(arg0) / (s32)(10)) : 0;});
            arg0 = (s32)(u16)({((10) != 0) ? ((s32)(arg0) % (s32)(10)) : 0;});
            if ((temp_r5 != 0) || (sp34 == 0)) {
                sp34 = 0;
                sp00.uiGfxID = 32;
                sp00.unk2B = sp38;
                sp00.tiles = *(&gUiGraphics[32].tiles) + (temp_r5 << 7);
                sp00.palette = *(&gUiGraphics[32].palette);
                sp00.vramC = &VRAM[0x10000] + 0x6BA0;
                sp00.tilesSize = 2 * 32;
                sp00.paletteSize = 0x20;
                sp00.unk28 = 6;
                sp00.unk2A = 13;
                ...
                sp00.tiles = *(&gUiGraphics[32].tiles) + (temp_r5 << 7) + 0x40;
                sp00.palette = *(&gUiGraphics[32].palette);
                sp00.vramC = &VRAM[0x10000] + 0x6C20;
                sp00.tilesSize = 2 * 32;
                sp00.paletteSize = 0x20;
                sp00.unk28 = 6;
                sp00.unk2A = 13;
            ...
            if ((temp_r5 != 0) || (sp34 == 0)) {
                ...
                sp00.tiles = *(&gUiGraphics[32].tiles) + (temp_r5 << 7);
                sp00.palette = *(&gUiGraphics[32].palette);
                sp00.vramC = &VRAM[0x10000] + 0x6BE0;
                sp00.tilesSize = 2 * 32;
                sp00.paletteSize = 0x20;
                sp00.unk28 = 6;
                sp00.unk2A = 13;
                ...
                sp00.tiles = gUiGraphics[32].tiles + (temp_r5 << 7) + 0x40;
                sp00.palette = gUiGraphics[32].palette;
                sp00.vramC = &VRAM[0x10000] + 0x6C60;
                sp00.tilesSize = 2 * 32;
                sp00.paletteSize = 0x20;
                sp00.unk28 = 6;
                sp00.unk2A = 13;
        ...
        case 2: {
            temp_r5 = ({((0xA) != 0) ? ((s32)(arg0) / (s32)(0xA)) : 0;});
            arg0 = ({((0xA) != 0) ? ((s32)(arg0) % (s32)(0xA)) : 0;});
            ...
            sp00.uiGfxID = 32;
            sp00.unk2B = 3;
            sp00.tiles = *(&gUiGraphics[32].tiles) + (arg0 << 7);
            sp00.palette = *(&gUiGraphics[32].palette);
            sp00.vramC = &VRAM[0x10000] + 0x6BA0;
            sp00.tilesSize = 0x40;
            sp00.paletteSize = 0x20;
            ...
            sp00.uiGfxID = 32;
            sp00.unk2B = 3;
            sp00.tiles = *(&gUiGraphics[32].tiles) + (arg0 << 7) + 0x40;
            sp00.palette = *(&gUiGraphics[32].palette);
            sp00.vramC = &VRAM[0x10000] + 0x6c20;
            sp00.tilesSize = 0x40;
            sp00.paletteSize = 0x20;
        ...
        default: {
            ...
            sp00.uiGfxID = 32;
            sp00.unk2B = 3;
            sp00.tiles = *(&gUiGraphics[32].tiles) + (v << 7);
            sp00.palette = *(&gUiGraphics[32].palette);
            sp00.vramC = &VRAM[0x10000] + 0x69E0;
            sp00.tilesSize = 0x40;
            sp00.paletteSize = 0x20;
            ...
            sp00.uiGfxID = 32;
            sp00.unk2B = 3;
            sp00.tiles = *(&gUiGraphics[32].tiles) + (v << 7) + 0x40;
            sp00.palette = *(&gUiGraphics[32].palette);
            sp00.vramC = &VRAM[0x10000] + 0x6A60;
            sp00.tilesSize = 0x40;
            sp00.paletteSize = 0x20;
...
void sub_805C448(u8 arg0)
{
    struct Task *t2 = ((void*)0);
    struct Task *t1 = ((void*)0);
    struct Task *t3 = ((void*)0);
    Game_2_0_Sub *sub = ((void*)0);
    Game_2_0 *strc = ((void*)0);

    sub_80535FC();
    UiGfxStackInit();
    t1 = TaskCreate(Task_805C6B0, sizeof(Game_2_0_Sub), 0x2120U, 0U, ((void*)0));
    sub = (void *)((t1)->data);
    sub->unk18 = 0;
    sub->unk1A = 0;
    ...
    t2 = TaskCreate(Task_805C740, sizeof(Game_2_0_Sub), 0x2120U, 0U, ((void*)0));
    sub = (void *)((t2)->data);
    sub->unk18 = 0;
    sub->unk1A = 0;
    ...
    if (arg0 != 0) {
        Strc_8052C84 *strc0;
        t3 = TaskCreate(Task_805C83C, sizeof(Game_2_0_Sub), 0x2120U, 0U, ((void*)0));
        sub = (void *)((t3)->data);
        strc0 = &sub->u.strc0;
        sub->unk18 = 0;
        sub->unk1A = 0;
    ...
    strc = (void *)((TaskCreate(Task_805C594, sizeof(Game_2_0), 0x2100U, 0U, TaskDestructor_nullsub_805C8FC))->data);
    strc->unk18 = 0;
    strc->unk1A = arg0;
    strc->task10 = t1;
    strc->task14 = t2;
...
void Task_805C594(void)
{
    ...
    Game_2_0_Sub *subR3 = ((void*)0);




    strc = (void *)((gCurTask)->data);
    subA = (void *)((strc->task10)->data);
    subB = (void *)((strc->task14)->data);
    if (strc->unk1A != 0) {
        subR3 = (void *)((strc->taskC)->data);
    }
...
void Task_805C6B0()
{
    ...
    Game_2_0_Sub *sub = (void *)((gCurTask)->data);
...
{
    Game_2_0_Sub *sub;
# 532 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_0.c"
    ...
    if (sub->unk18 > 0xF5) {
        ...
        if (sub->u.overB.qUnkA < -0x1F) {
            ...
            sub->unk1A = ({((7) != 0) ? ((s32)(sub->unk1A + 1) % (s32)(7)) : 0;});
