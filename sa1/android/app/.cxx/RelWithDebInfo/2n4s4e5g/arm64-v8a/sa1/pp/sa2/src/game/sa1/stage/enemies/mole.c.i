# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/mole.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/mole.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/mole.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/mole.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/mole.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/mole.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/mole.c" 2
...
void Task_Mole(void)
{
    Mole *mole = (void *)((gCurTask)->data);
    Sprite *s = &mole->shared.s;
    MapEntity *me = mole->shared.base.me;
    s16 worldX, worldY;

    worldX = ((mole->shared.base.meX)*8 + (mole->shared.base.regionX)*256);
    worldY = ((me->y)*8 + (mole->shared.base.regionY)*256);

    s->x = worldX - gCamera.x;
    s->y = worldY - gCamera.y;

    if ((((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
        { me->x = mole->shared.base.meX; };
        TaskDestroy(gCurTask);
        return;
    }

    if (++mole->frames >= (int)(((0 * 60.) + 1) * 60)) {
        mole->frames = 0;
        s->variant = 1;
