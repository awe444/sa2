# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/034.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/034.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/034.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/034.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/034.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/camera.h" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/034.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/034.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/034.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/034.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/034.c" 2
...
void Task_Interactable034(void)
{
    ...
    do {
        ...
        if (((ia->worldX) > gCamera.x + (320 + (256 / 2)) || (ia->worldX) < gCamera.x - (256 / 2) || (ia->worldY) > gCamera.y + ((240) + ((256) / 2)) || (ia->worldY) < gCamera.y - (256 / 2))) {
        ...
        if ((ia->left <= playerX) && (playerX < ia->right) && (ia->top <= playerY) && (playerY < ia->bottom)) {
            ...
            p->moveState |= 0x00000200 | 0x00000004;
...
{
    struct Task *t = TaskCreate(Task_Interactable034, sizeof(IA034), 0x2000, 0, ((void*)0));
    IA034 *ia = (void *)((t)->data);
    s32 worldX, worldY;
    ...
    worldX += (me->d.sData[0] * 8);
    ia->left = worldX;
    worldY += (me->d.sData[1] * 8);
    ia->top = worldY;
    worldX += (me->d.uData[2] * 8);
    ia->right = worldX;
    worldY += (me->d.uData[3] * 8);
    ia->bottom = worldY;
