# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_2_egg_press.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_2_egg_press.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_2_egg_press.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_2_egg_press.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/malloc_vram.h" 1
# 24 "/home/awaszczak/git/sa2/sa1/../include/malloc_vram.h"
void *VramMalloc(u32);
void VramResetHeapState(void);
void VramFree(void *);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_2_egg_press.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_2_egg_press.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_2_egg_press.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_2_egg_press.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_2_egg_press.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_2_egg_press.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_2_egg_press.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_2_egg_press.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_2_egg_press.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_2_egg_press.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_2_egg_press.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 19 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_2_egg_press.c" 2
...
{
    EggPress *boss = (void *)((gCurTask)->data);
    Sprite *s2 = &boss->s2;
...
void sub_802D870(void)
{
    ...
    Sprite *s = &*(Sprite *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(EggPress, s));
    Sprite *s2 = &*(Sprite *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(EggPress, s2));
    s8 *unkAF = &*(s8 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(EggPress, unkAF));

    if (*unkAF != 0) {
        if ((--(*unkAF) > 0x10) && !((*unkAF) & 2) && (!(gPlayer.moveState & 0x00000080))) {
            s->frameFlags |= ((2) << (7));
            gDispCnt |= 0x8000;
...
void CreateEntity_EggPress(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    s->graphics.dest = VramMalloc(((48 / 8) * (72 / 8)));
    s->oamFlags = ((21) << 6);
    s->graphics.size = 0;
    s->graphics.anim = 620;
    s->variant = 1;
    ...
    Bosses_SetCamBounds(s->y - (240 - 16), s->y + 16, (int)((float)s->x - 320), s->x);
...
void Task_EggPressMain(void)
{
    ...
    if (boss->unkAC++ > 120) {
        ...
        boss->qUnk94 = -((s32)((60)*256));
        boss->qUnk98 = -((s32)((144)*256));
        boss->qUnkA0 = 0;

        worldX = ((boss->base.meX)*8 + (boss->base.regionX)*256) + ((int)((boss->qUnk94) >> 8));
        worldY = ((me->y)*8 + (boss->base.regionY)*256) + ((int)((boss->qUnk98) >> 8));
        s->x = worldX - gCamera.x;
        s->y = worldY - gCamera.y;
        s2->x = s->x;
        s2->y = s->y;
...
void Task_802DEFC(void)
{
    ...
    if (boss->unkAE > 7) {
        ...
        if (sprOuter->frameFlags & ((1) << (14))) {
            if ((boss->unkB0 & 0x3) == 1) {
                boss->qUnk9C = 0;
                boss->qUnkA0 = -((s32)((10)*256));
                gCurTask->main = Task_802E500;
            } else {
                boss->qUnk9C = (gPlayer.qWorldX - ((s32)((worldX)*256))) / 72;
                boss->qUnkA0 = -((s32)((4.5)*256));
                boss->unkA4 = 0x20;
                ...
                if (boss->qUnk9C < 0) {
                    sprOuter->frameFlags &= ~((1) << (10));
                    spr2Outer->frameFlags &= ~((1) << (10));
                } else {
                    sprOuter->frameFlags |= ((1) << (10));
                    spr2Outer->frameFlags |= ((1) << (10));
                }
...
void Task_802E500(void)
{
    ...
    if (boss->qUnk98 < -((s32)((200)*256))) {
        boss->qUnk94 = gPlayer.qWorldX - ((s32)((((boss->base.meX)*8 + (boss->base.regionX)*256))*256));
    }
    ...
    if (boss->qUnk98 >= 0) {
        ...
        if (!(gPlayer.moveState & 0x00000002) || (gPlayer.charState == 65)
            || ((gPlayer.moveState & 0x04000000) && ((gPlayer.anim != 374) || (gPlayer.variant != 0)))) {
            Coll_DamagePlayer(&gPlayer);
            s2->variant = 1;
            s2->frameFlags = s2->frameFlags & ~((1) << (14));
        }
        if ((gNumSingleplayerCharacters == 2) && !(gPartner.moveState & 0x00000002)) {
            Coll_DamagePlayer(&gPlayer);
            s2->variant = 1;
            s2->frameFlags &= ~((1) << (14));
        }
...
void sub_802E868(void)
{
    ...
    s = &boss->s;
    boss->qUnk98 -= ((s32)((48)*256));

    worldX = ((boss->base.meX)*8 + (boss->base.regionX)*256) + ((int)((boss->qUnk94) >> 8));
    worldY = ((me->y)*8 + (boss->base.regionY)*256) + ((int)((boss->qUnk98) >> 8));

    s2->variant = 2;
    boss->qUnkB2 = -((s32)((2)*256));
    m4aSongNumStart(144);
    boss->unkAC = 0;
    s->graphics.anim = 621;
    s->variant = 0;
    ...
    {
        tSub0 = (void *)((sub_80168F0(worldX, worldY, 8, 619, 0))->data);
        tSub0->qUnk46 = -((s32)((2)*256));
        tSub0->unk48 = 0;
        tSub0->unk42 = 0x80;

        if (s->frameFlags & ((1) << (10))) {
            tSub0->transform.qScaleX = -((s32)((1)*256));
            tSub0->qUnk44 = +((s32)((4)*256));
        } else {
            tSub0->qUnk44 = -((s32)((4)*256));
        }
        tSub0->unk40 = 60;
    ...
    {
        tSub0 = (void *)((sub_80168F0(worldX, worldY + 32, 8, 617, 0))->data);
        tSub0->qUnk46 = -((s32)((2)*256));
        tSub0->unk48 = 0;
        tSub0->unk42 = 0x180;
...
void Task_802EA8C(void)
{
    ...
    if (res < 0) {
        boss->qUnk98 += ((s32)((res)*256));
        boss->qUnkB2 = (boss->qUnkB2 >> 2) - boss->qUnkB2;
        if (boss->qUnkB2 > -((s32)((1)*256))) {
            boss->qUnkB2 = 0U;
    ...
    if ((boss->unkAC & 7) == 0) {
        ...
        sub_8017540(((s32)(((worldX + (0x3F & rnd)) - 32)*256)), ((s32)((worldY - ((rnd & 0x3F0000) >> 0x10))*256)));
    }
