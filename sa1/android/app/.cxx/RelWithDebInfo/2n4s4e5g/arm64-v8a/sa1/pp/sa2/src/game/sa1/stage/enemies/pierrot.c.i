# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/pierrot.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/pierrot.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/pierrot.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/pierrot.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/pierrot.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/pierrot.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/pierrot.c" 2
...
void Task_Pierrot(void)
{
    Pierrot *pierrot = (void *)((gCurTask)->data);
    ...
    worldX32 = ((pierrot->shared.base.meX)*8 + (pierrot->shared.base.regionX)*256);
    worldY32 = ((me->y)*8 + (pierrot->shared.base.regionY)*256);

    worldX = worldX32;
    worldY = worldY32;

    pierrot->qUnk44 += pierrot->qUnk48;
    worldX += ((int)((pierrot->qUnk44) >> 8));
    worldY += pierrot->unk4A;
    worldY -= ((s32)((0.1875)*256));
    ...
    if ((!(gPlayer.moveState & 0x00000080))) {
        if (s->hitboxes[1].index != -1) {
            ...
            if ((((((worldX) + s->hitboxes[1].b.left) <= ((((int)((gPlayer.qWorldX) >> 8))) + gPlayerBodyPSI.s.hitboxes[0].b.left) && ((((worldX)) + (s->hitboxes[1].b).left) + ((s->hitboxes[1].b).right - (s->hitboxes[1].b).left)) >= ((((int)((gPlayer.qWorldX) >> 8))) + gPlayerBodyPSI.s.hitboxes[0].b.left)) || (((worldX) + s->hitboxes[1].b.left) >= ((((int)((gPlayer.qWorldX) >> 8))) + gPlayerBodyPSI.s.hitboxes[0].b.left) && ((((((int)((gPlayer.qWorldX) >> 8)))) + (gPlayerBodyPSI.s.hitboxes[0].b).left) + ((gPlayerBodyPSI.s.hitboxes[0].b).right - (gPlayerBodyPSI.s.hitboxes[0].b).left)) >= ((worldX) + s->hitboxes[1].b.left))) && (((((worldY)) + s->hitboxes[1].b.top) <= (((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].b.top) && ((((worldY)) + s->hitboxes[1].b.top) + ((s->hitboxes[1].b).bottom - (s->hitboxes[1].b).top)) >= (((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].b.top)) || ((((worldY)) + s->hitboxes[1].b.top) >= (((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].b.top) && ((((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].b.top) + ((gPlayerBodyPSI.s.hitboxes[0].b).bottom - (gPlayerBodyPSI.s.hitboxes[0].b).top)) >= (((worldY)) + s->hitboxes[1].b.top))))) {
                if (gPlayer.moveState & 0x00000004) {
                    ...
                    ({ s32 temp = gPlayer.qSpeedGround; gPlayer.qSpeedGround = -temp; });
                    ({ s32 temp = gPlayer.qSpeedAirX; gPlayer.qSpeedAirX = -temp; });
                } else {
    ...
    pierrot->unk4A += sa2__sub_801F07C(worldY, worldX, 1, 8, sp08, sa2__sub_801EE64);

    if (((int)((pierrot->qUnk44) >> 8)) <= me->d.sData[0] * 8) {
        pierrot->qUnk48 = +((s32)((0.625)*256));
        (s)->frameFlags |= (((1) << (10)));
    } else if (((int)((pierrot->qUnk44) >> 8)) >= (me->d.sData[0] + me->d.uData[2]) * 8) {
