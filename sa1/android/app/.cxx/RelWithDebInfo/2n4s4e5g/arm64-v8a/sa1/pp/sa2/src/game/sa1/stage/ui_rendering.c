# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/ui_rendering.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/ui_rendering.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/ui_rendering.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/ui_rendering.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/ui_rendering.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/ui_rendering.c" 2
...
struct Task *gTask_03006240 = ((void*)0);
...
struct Strc_30063F0 *gUnknown_030063F0 = ((void*)0);
...
void sub_80528AC(Strc_80528AC *param0)
{
    ...
    Task_3006240 *strc = (void *)((gTask_03006240)->data);
    ...
    if (param0->unk2A & 0x8) {
        ...
        if (param0->unk2A & 0x4) {
            DmaSet(3, param0->palette, &gObjPalette[param0->unk28 * 16], (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((param0->paletteSize)/(16/8))));
            gFlags |= 0x2;
        }

        strc0->unk0 = (((uintptr_t)(param0->vramC) - (uintptr_t)&VRAM[0x10000]) / (32));
    } else {
        void *vram = (param0->uiGfxID & 0x80) ? (&VRAM[0] + ((gBgCntRegs[param0->unk29] & ((0x3) << 2)) << 12)) + 0
                                              : (&VRAM[0] + ((gBgCntRegs[param0->unk29] & ((0x3) << 2)) << 12)) + 32;

        void *layout = ((u8 *)&VRAM[0] + ((gBgCntRegs[param0->unk29] & 0x3F00) << 3));
        ...
        if (param0->unk2A & 0x4) {
            DmaSet(3, param0->palette, &gBgPalette[param0->unk28 * 16], (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((param0->paletteSize)/(16/8))));
            gFlags |= 0x1;
        }
    }
}
...
void sub_8052AA4(void)
{
    ...
    gUnknown_030063C0.next = ((void*)0);
}


void unused_8052B84(s32 param0, u16 param1, u16 param2, u8 param3) { }
...
void sub_8052C84(const char *param0, Strc_8052C84 *param1)
{
    ...
    if (((u16)param1->unk4 == 0) && (param1->unk0 == ((s32)((1)*256)) && param1->unk2 == ((s32)((1)*256)))) {
        r8 = 0;
        r0 = 0;
    } else {
        sa2__sub_80047A0(param1->unk4, param1->unk0, param1->unk2, param1->unk6);
        r8 = param1->unk6;
        r0 = 3;
    }
...
void sub_8052D64(u8 *param0, Strc_8052C84 *param1)
{
...

    {
        ...
        for (i = 0, oamStack2 = &sp00; i < param1->byteCount; i++) {
            ...
            OAM_SET_GBA_ATTR1(oam, ((strc0->unk8 << 14) | (r8 << 9)) | ((((strc0->unkA * i) << 3) + param1->unkA) & 0x1FF));
            OAM_SET_GBA_ATTR2(oam, OAM_GET_GBA_ATTR2(oamStack2) + strc0->unk4 * ((param0[i])-32));
        }
    }
}
...
void sub_8052E40(u8 *param0, Strc_8052C84 *param1)
{
...

    {
        ...
        for (i = 0; i < param1->byteCount; i++) {
            ...
            r2 = (param1->unk12 << 12);
            r2 += strc0->unk0 + strc0->unk4 * ((param0[i])-32);
...
void sub_8052EF0(s32 param0, Strc_8052C84 *param1)
{
    s32 byteCount = 0;
    char sp00[10];
    s32 i;
    ...
    for (i = (s32)(sizeof(sp00) / sizeof((sp00)[0])) - 1; i >= 0; i--) {
        s16 remainder = ({((10) != 0) ? ((s32)(param0) / (s32)(10)) : 0;});
        sp00[i] = (param0 - ((remainder << 3) + (remainder << 1))) + 0x30;
        param0 = remainder;
        param1->byteCount++;
    }

    for (i = 0; (i < (s32)(sizeof(sp00) / sizeof((sp00)[0]))) && (sp00[i] == 0x30); i++) {
        byteCount++;
        param1->byteCount--;
    }
...
void sub_8052F78(const char *param0, GameOverB *param1)
{
    Strc0 *strc0;
    u32 u8;
    OamData sp00;
    ...
    if (param1->unk16 != 0) {
        ...
        for (i = 0; i < param1->unkE; i++) {
            ...
            OAM_SET_GBA_ATTR2(oam, OAM_GET_GBA_ATTR2(&sp00) + ((param0[i])-32) * strc0->unk4);
        }
    } else {
        s32 i = 0;
        for (i = 0; i < param1->unk14; i++) {
            ...
            while (w < param1->unkE) {
                ...
                OAM_SET_GBA_ATTR2(oam, OAM_GET_GBA_ATTR2(&sp00) + ((param0[w])-32) * strc0->unk4);
                w++;
            }
...
void sub_80530CC(const char *param0, GameOverB *param1)
{
    Strc0 *strc0;
    u32 u8;
    OamData sp00;
...
void sub_805321C(u8 *param0, GameOverB *param1)
{
    Strc0 *strc0;
    u32 u8;
    OamData sp00;
...
void sub_8053370(u8 *param0, GameOverB *param1)
{
    Strc0 *strc0;
    u32 u8;
    OamData sp00;
...
void sub_80535FC(void)
{
    if (gTask_03006240 == ((void*)0)) {
        ...
        struct Strc_3006250 *second = &gUnknown_03006250[(sizeof(gUnknown_03006250) / sizeof((gUnknown_03006250)[0])) - 1];
        struct Strc_3006250 *curr = &gUnknown_03006250[(sizeof(gUnknown_03006250) / sizeof((gUnknown_03006250)[0])) - 2];
        void *nullPtr;
        ...
        nullPtr = ((void*)0);
        gUnknown_03006250[(sizeof(gUnknown_03006250) / sizeof((gUnknown_03006250)[0])) - 1].next = nullPtr;
...
IwramData UiGfxStackInit(void)
{
    ...
    for (i = 0; i < (s32)(sizeof(strc->gfxList) / sizeof((strc->gfxList)[0])) - 2; curr++, next++, i++) {
...
void TaskDestructor_80536D8(struct Task *t) { gTask_03006240 = ((void*)0); }
