# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/iron_ball.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/iron_ball.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/iron_ball.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/iron_ball.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/iron_ball.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/iron_ball.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/iron_ball.c" 2
...
void Task_IronBallMain(void)
{
    IronBall *ball = (void *)((gCurTask)->data);
    Sprite *s = &ball->s;
    s16 worldX, worldY;
    ...
    if (ball->unk48 != 0) {
        ...
        ball->unk40 = (r2 * (gSineTable[((ball->unk48 * ((gStageTime + ball->unk3C) & 0xFF)) & (1024 - 1))])) >> 14;
    }

    if (ball->unk4A != 0) {
        s32 r2 = ((s32)((me->d.uData[3] * 8)*256));
        ball->unk44 = (r2 * (gSineTable[((ball->unk4A * ((gStageTime + ball->unk3C) & 0xFF)) & (1024 - 1))])) >> 14;
    }

    worldX = ((ball->base.meX)*8 + (ball->base.regionX)*256);
    worldY = ((me->y)*8 + (ball->base.regionY)*256);

    s->x = (worldX - gCamera.x) + ((int)((ball->unk40) >> 8));
    s->y = (worldY - gCamera.y) + ((int)((ball->unk44) >> 8));

    i = 0;
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            if (Coll_Player_Entity_Intersection(s, worldX + ((int)((ball->unk40) >> 8)), worldY + ((int)((ball->unk44) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
