# 1 "/home/awaszczak/git/sa2/sa1/../src/input_recorder.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/input_recorder.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/input_recorder.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/input_recorder.c" 2
...
void EwramFree(void *);
# 5 "/home/awaszczak/git/sa2/sa1/../src/input_recorder.c" 2
# 21 "/home/awaszczak/git/sa2/sa1/../src/input_recorder.c"
struct InputRecorder gInputRecorder __attribute__((aligned(8))) = { 0 };
u16 *gInputRecorderTapeBuffer = ((void*)0);
...
void InputRecorderLoadTape(void)
{
    ...
    gInputRecorderTapeBuffer = EwramMalloc(0x800 * sizeof(u16));
...
u16 InputRecorderRead(void)
{
    if (gInputRecorder.playbackHead < 0x800) {
        u16 val = gInputRecorderTapeBuffer[gInputRecorder.playbackHead++];
# 78 "/home/awaszczak/git/sa2/sa1/../src/input_recorder.c"
        return val;
    }
...
{
    if (gInputRecorder.recordHead < 0x800) {
