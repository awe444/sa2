# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kuraa.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kuraa.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kuraa.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kuraa.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kuraa.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kuraa.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kuraa.c" 2
...
void CreateEntity_Kuraa(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    kuraa->qUnk40 = -((s32)((0.25)*256));
    kuraa->qUnk3C = ((s32)((0)*256));
    kuraa->unk44 = 0;
    kuraa->unk42 = 0;
    kuraa->unk46 = 0;
...
void Task_KuraaInit(void)
{
    Kuraa *kuraa = (void *)((gCurTask)->data);
    Sprite *s = &kuraa->shared.s;
    ...
    worldX = ((kuraa->shared.base.meX)*8 + (kuraa->shared.base.regionX)*256);
    worldY = ((me->y)*8 + (kuraa->shared.base.regionY)*256);
    ...
    worldX = worldX + ((int)((kuraa->qUnk3C) >> 8));
    ...
    if (((int)((kuraa->qUnk3C) >> 8)) <= me->d.sData[0] * 8) {
        kuraa->qUnk40 = +((s32)((0.25)*256));
    } else if (((int)((kuraa->qUnk3C) >> 8)) >= (me->d.sData[0] + me->d.uData[2]) * 8) {
        kuraa->qUnk40 = -((s32)((0.25)*256));
...
void Task_80737A8(void)
{
    ...
    offsetWorldX = worldX + ((int)((kuraa->qUnk3C) >> 8));
