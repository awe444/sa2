# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/mp_event_mgr.h" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c" 2
...
# 19 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/stage/mp_results.h" 1
# 10 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/stage/mp_results.h"
void CreateMultiplayerResultsScreen(u8 mode);
# 20 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c" 2
...
# 22 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/text.h" 1
# 23 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c" 2
# 46 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c"
typedef struct {
    Sprite s;
    u8 unk30;
    u8 unk31;
...
void sa2__Task_801A04C(void);
void Task_TransitionToResultsScreen(void);

void sa2__Task_8019E70(void);
void sa2__TaskDestructor_8019EF4(struct Task *);
...
# 103 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c"
void CreateMultiplayerFinishResult(u8 sioId, u8 count)
{
    u32 i = 0;
    ...
    {
        struct Task *t = TaskCreate(sa2__Task_8019E70, sizeof(MpFinish1), 0x2010, 0, sa2__TaskDestructor_8019EF4);
        MpFinish1 *finish = (void *)((t)->data);
        struct Task **mpt = &gMultiplayerPlayerTasks[0];
        Sprite *s;

        for (; i < (sizeof(gMultiplayerPlayerTasks) / sizeof((gMultiplayerPlayerTasks)[0])); i++) {
            if (*mpt == ((void*)0))
                break;
            else
                mpt++;
        ...
        if (count == 5) {
            ...
            s->variant = 2;
            s->graphics.dest = VramMalloc(12);
        } else if ((i == 2) || (gGameMode == 4) || (gGameMode == 3)
                   || (gGameMode == 5)) {
            s->variant = count;
            s->graphics.dest = VramMalloc(12);
        } else {
...
# 170 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c"
        s->prevVariant = -1;
        s->oamFlags = ((0) << 6);
        s->qAnimDelay = 0;
...
void sa2__Task_8019E70(void)
{
    MpFinish1 *finish = (void *)((gCurTask)->data);
    Sprite *s = &finish->s;
    MultiplayerPlayer *mpp = (void *)((gMultiplayerPlayerTasks[finish->unk30])->data);
...
void sa2__TaskDestructor_8019EF4(struct Task *t)
{
    MpFinish1 *finish = (void *)((t)->data);
    Sprite *s = &finish->s;
...
void CreateMultiplayerFinishHandler(void)
{
    ...
    {
        struct Task *mpt;
        struct Task *t = TaskCreate(sa2__Task_801A04C, sizeof(Finish2), 0x2000, 0, ((void*)0));
        Finish2 *f2 = (void *)((t)->data);
        ...
        if (gGameMode == 4) {
            *((u32 *)arr2) = *((u32 *)gMultiplayerCharRings);
            ...
            for (i = 0; i < (sizeof(arr2) / sizeof((arr2)[0])); i++) {
                ...
                for (j = 0; j < (3 - i); j++) {
                    if (arr2[j + 0] < arr2[j + 1]) {
                        arr2[j + 0] ^= (u8)arr2[j + 1]; arr2[j + 1] ^= (u8)arr2[j + 0]; arr2[j + 0] = ((u8)arr2[j + 1] ^ (u8)arr2[j + 0]);;
                        arr[j + 0] ^= (u8)arr[j + 1]; arr[j + 1] ^= (u8)arr[j + 0]; arr[j + 0] = ((u8)arr[j + 1] ^ (u8)arr[j + 0]);;
                    }
                }
            }
            ...
            for (i = 0; i < (sizeof(gMultiplayerPlayerTasks) / sizeof((gMultiplayerPlayerTasks)[0])); i++) {
                if (gMultiplayerPlayerTasks[i] != ((void*)0)) {
                    CreateMultiplayerFinishResult(i, (u8)gMultiplayerRanks[i]);
                }
            }
        } else if (gGameMode == 5) {
            for (i = 0; i < (sizeof(gMultiplayerPlayerTasks) / sizeof((gMultiplayerPlayerTasks)[0])) && (gMultiplayerPlayerTasks[i] != ((void*)0)); i++) {
            ...
            if ((u32)arr2[0] < (u32)arr2[1]) {
                ...
                arr[0] ^= (u8)arr[1]; arr[1] ^= (u8)arr[0]; arr[0] = ((u8)arr[1] ^ (u8)arr[0]);
            }
            if (arr2[0] == arr2[1]) {
                for (i = 0; i < 4; i++) {
                    if (gMultiplayerPlayerTasks[i] != ((void*)0)) {
            ...
            if (((u32)gCourseTime > ((int)(((10 * 60.) + 0) * 60))) || ((0x0004 & gStageFlags) && (gCourseTime == 0))) {
                u32 r2 = 0;
                u8 r5;
                u32 j;
                if ((gGameMode != 3) && (gGameMode != 5)) {
                    for (j = 0; j < (sizeof(gMultiplayerPlayerTasks) / sizeof((gMultiplayerPlayerTasks)[0])) && (gMultiplayerPlayerTasks[j] != ((void*)0)); j++) {
                ...
                for (j = 0; j < (sizeof(gMultiplayerPlayerTasks) / sizeof((gMultiplayerPlayerTasks)[0])) && (gMultiplayerPlayerTasks[j] != ((void*)0)); j++) {
                    if ((gMultiplayerRanks[j] == -1) || (gGameMode == 3) || (gGameMode == 5)) {
                        CreateMultiplayerFinishResult(j, r5);
                    }
                }
            }
        }
# 394 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c"
    }
}
...
void sa2__Task_801A04C(void)
{
    ...
    if (gRoomEventQueueWritePos == gRoomEventQueueSendPos) {
        if (f2->unk0++ > x) {
            gBldRegs.bldCnt = ((2 << 6) | ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3) | (1 << 4) | (1 << 5)));
            gBldRegs.bldY = 0;
...
void Task_TransitionToResultsScreen(void)
{
    ...
    Finish2 *f2 = (void *)((gCurTask)->data);
    f2->unk0 += ((s32)((0.25)*256));

    gBldRegs.bldY = ((int)((f2->unk0) >> 8));
        ...
        if (gGameMode == 6) {
            ...
            *((u32 *)sp04) = *((u32 *)gMultiplayerCharRings);
            ...
            for (i = 0; i < 4; i++) {
                ...
                for (m = 0; m < (3 - i); m++) {
                    if (sp04[m] < sp04[m + 1]) {
                        sp04[m] ^= (u8)sp04[m + 1]; sp04[m + 1] ^= (u8)sp04[m]; sp04[m] = ((u8)sp04[m + 1] ^ (u8)sp04[m]);;
                        sp00[m] ^= (u8)sp00[m + 1]; sp00[m + 1] ^= (u8)sp00[m]; sp00[m] = ((u8)sp00[m + 1] ^ (u8)sp00[m]);;
                    }
                }
            }
...
# 516 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c"
        }
# 555 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_finish.c"
        ...
        if (gGameMode != 6) {
            { u32 tmp = (u32)(0); DmaSet(3, &tmp, &gMultiSioSend, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(struct MultiSioData_0_0))/(32/8)))); };
