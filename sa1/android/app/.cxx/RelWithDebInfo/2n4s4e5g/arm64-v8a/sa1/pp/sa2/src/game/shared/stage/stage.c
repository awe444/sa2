# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/pause_menu.h" 1



void CreatePauseMenu(void);
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/rings_manager.h" 1
# 49 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/rings_manager.h"
extern const u8 *const gSpritePosData_rings[18];

void CreateStageRingsManager(void);
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2



# 1 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/mp_finish.h" 1
...
# 20 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/mp_indicators.h" 1
...
# 21 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
...
# 22 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
...
# 23 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
...
# 24 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
...
# 27 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
...
# 28 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/ui/time_attack_lobby.h" 1
...
# 29 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/ui/time_over.h" 1



void CreateTimeOver();
# 30 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
...
# 31 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
...
# 32 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/parameters/stage.h" 1
# 33 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2


# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 36 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c" 2
# 55 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c"
struct Task *gGameStageTask = ((void*)0);
...
const VoidFn sStageInitProcs[18] = {
...
# 208 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c"
void GameStageStart(void)
{
    ...
    gCheckpointTime = (int)(((0 * 60.) + 0) * 60);


    if ((gGameMode == 6) || (gGameMode == 4)) {
        gCourseTime = (int)(((3 * 60.) + 0) * 60);
    } else if (gGameMode == 5) {
        gCourseTime = (int)(((5 * 60.) + 0) * 60);
    } else {
        gCourseTime = (int)(((0 * 60.) + 0) * 60);
    }
# 262 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c"
    CreateGameStage();
}
...
void CreateGameStage(void)
{
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
        ...
        if (gNumSingleplayerCharacters == 2) {
            CreatePlayer(CHARACTER_TAILS, gCurrentLevel, &gPartner);
        }
    }
    ...
    if (gGameMode != 6) {
        ...
        if (gCurrentLevel == ((1)*(2)) + (0)) {
            if (CreateSpotlightsManager()) {

                if (someTask != ((void*)0))

                {
                    Struct_sub_80550F8 *strc = (void *)((someTask)->data);
                    strc->screenBlank = 1;
                }
            }
        }
...
# 414 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c"
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
        ...
        if (gGameMode == 4 || gGameMode == 5) {
            for (j = 0; j < (sizeof(gChaoTasks) / sizeof((gChaoTasks)[0])); j++) {
...
# 487 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c"
}

void Task_GameStage(void)
{
    u16 sioId = ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id;
    u32 timeStep;

    if (((gGameMode == 0) || (gGameMode == 1))) {
# 509 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c"
        if (!(gStageFlags & 0x0020) && (gPressedKeys & 0x0008) && !(gStageFlags & 0x0040)) {
            CreatePauseMenu();
        }
        gStageTime++;
        timeStep = 1;
...

    {
        ...
        if (((gGameMode != 0) && (gGameMode != 1) && (gGameMode != 2) && (gGameMode != 3))) {
            if ((framesSinceStageStart & ~(0x1FF)) != ((framesSinceStageStart - timeStep) & ~(0x1FF))) {
                u32 mask, rand;
                u32 temp = ({ gMultiplayerPseudoRandom = (gMultiplayerPseudoRandom * 0x196225) + 0x3C6EF35F; gMultiplayerPseudoRandom; });
        ...
        if (gCamera.sa2__unk50 & 4) {

            if ((gInput & (0x0200 | 0x0100)) == (0x0200 | 0x0100)) {
                if (sioId != 3) {
                    gCamera.spectatorTarget = 3;
                } else {
                    gCamera.spectatorTarget = 2;
                }
            } else if (gInput & 0x0200) {
                if (sioId == 0) {
                    gCamera.spectatorTarget = 1;
                } else {
                    gCamera.spectatorTarget = 0;
                }
            } else if (gInput & 0x0100) {
                if (sioId < 2) {
                    gCamera.spectatorTarget = 2;
                } else {
                    gCamera.spectatorTarget = 1;
        ...
        if (!(gMultiplayerConnections & ((1 << 0) << (gCamera.spectatorTarget)))) {
            gCamera.spectatorTarget = sioId;
        }
    ...
    if (gStageFlags & 0x0004) {
        ...
        if (((gGameMode == 0) || (gGameMode == 1))) {
            ...
            if (gPlayer.moveState & 0x00000040) {
                gPlayer.qSpeedAirY = -((s32)((2.625)*256));
            } else {
                gPlayer.qSpeedAirY = -((s32)((4.875)*256));
            }


            if (gCurrentLevel == ((5)*(2)) + (0))
            ...
            {
                CreateScreenShake(0x800, 8, 16, -1, (0x80 | 0x40 | 0x10));
            }
            gPlayer.moveState |= 0x00000080;
            m4aSongNumStart(166);
        }
        ...
        if (((gGameMode == 0) || (gGameMode == 1))) {
            ...
            if ((&gLoadedSaveGame)->timeLimitDisabled && (gGameMode == 0 || (!(((gGameMode == 0) || (gGameMode == 1)))))) {
                return;
            }
...
# 700 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c"
void HandleLifeLost(void)
{
    gStageFlags |= 0x0020;
    ...
    if ((gGameMode == 1)) {
        ...
        if (((gGameMode == 0) || (gGameMode == 1)) && (--gNumLives == 0))
...

        {
            ...
            if (sa2__gUnknown_0300543C > 0) {
                sa2__gUnknown_0300543C--;
...
# 862 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c"
void StageInit_Zone3Act1(void)
{
...
# 934 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c"
void StageInit_Zone6Act1(void)
{
...
# 998 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c"
}
# 1056 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c"
void StageInit_PinballChaoGarden(void)
{
    CreatePaletteLoaderTask(0x2000, 816, 0, 0);
    CreatePaletteLoaderTask(0x2000, 817, 0, 0);
...
void ApplyGameStageSettingsAndStart(void)
{
    ...
    if ((gGameMode == 1 || (gGameMode == 2) || (gGameMode == 3))
        || (gStageFlags & 0x0040)) {
        gDifficultyLevel = (&gLoadedSaveGame)->difficultyLevel;
        (&gLoadedSaveGame)->difficultyLevel = 0;
    }
...
# 1157 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c"
void TaskDestructor_GameStage(struct Task *t)
{
...
# 1240 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c"
void StageInit_Zone4Act1(void)
{
...
# 1295 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c"
void StageInit_Zone6Act2(void)
{
...
void StageInit_Zone7Act1(void) { m4aSongNumStart(24); }

void StageInit_Zone7Act2(void) { m4aSongNumStart(26); }
# 1342 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/stage.c"
void StageInit_ForestChaoGarden(void)
{
    CreatePaletteLoaderTask(0x2000, 814, 0, 0);
    CreatePaletteLoaderTask(0x2000, 815, 0, 0);
