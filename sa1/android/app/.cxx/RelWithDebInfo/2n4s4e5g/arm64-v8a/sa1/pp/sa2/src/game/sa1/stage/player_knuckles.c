# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_knuckles.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_knuckles.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_knuckles.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_knuckles.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_knuckles.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_knuckles.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_knuckles.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_knuckles.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_knuckles.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_knuckles.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_knuckles.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_knuckles.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_knuckles.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_knuckles.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_knuckles.c" 2
...
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_knuckles.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 19 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_knuckles.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 20 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_knuckles.c" 2


extern void sa2__sub_8022318(Player *p);
extern void sa2__sub_8022838(Player *p);
void sub_80472B8(Player *p);
...
void Player_Knuckles_InitGlide(Player *p)
{
    ...
    { (p)->spriteOffsetX = 6; (p)->spriteOffsetY = 6; };
...
void sub_8048230(Player *p)
{
    ...
    if (!(flags & 2)) {
        ...
        if ((((p->rotation + ((s32)((0.125)*256))) & -((s32)((0.25)*256))) << 24) != 0) {
        ...
        if (p->w.kf.sa2__unkAE >= 0) {

            if (((u8)p->w.kf.shift + 0x40) << 24 <= 0) {
                p->moveState |= 0x00000001;
                r6 = sa2__sub_8029A28(p, ((void*)0), &sp08);
                ...
                if (r6 == sp08) {
                    ...
                    if (r6 != 0) {
                        if ((gStageFlags & 0x0080)) {
                            s32 worldX, worldY;
                            worldY = (((int)((p->qWorldY) >> 8)) - 1);
                            worldY -= p->spriteOffsetY;
                            worldX = (((int)((p->qWorldX) >> 8)) - 1);
                            worldX -= p->spriteOffsetX;

                            if (sa2__sub_801E4E4(worldY, worldX, p->layer, -8, ((void*)0), sa2__sub_801EE64) < 0) {
                                p->sa2__unk61 = mask;
                                goto _08048454;
                            } else {
                                goto lbl0;
...
void sub_8048524(Player *inPlayer)
{
    ...
    offsetY = sa2__sub_8029B88(p, &rot, &sp04);
    if (offsetY < 12) {
        if ((gStageFlags & 0x0080)) {
            offsetY = -offsetY;
        }
...
s32 sub_8048650(Player *p)
{
    ...
    if (p->moveState & 0x00000001) {
        s32 worldX, worldY;
        worldX = ((int)((p->qWorldX) >> 8)) - 2;
        worldX -= p->spriteOffsetX;
        worldY = ((int)((p->qWorldY) >> 8));
        result = sa2__sub_801E4E4(worldX, worldY, p->layer, -8, &arr, sa2__sub_801ED24);
...
void sub_80486E8(Player *p)
{
    ...
    if (p->heldInput & 0x0040) {
        ...
        offsetY = ((s32)((p->spriteOffsetY)*256));
        ...
        if (res > 2) {
            ...
            p->qWorldY -= offsetY;
            res = sa2__sub_8029AC0(p, &sp00, ((void*)0));
            p->qWorldY += offsetY;
        ...
        res = sa2__sub_8029B0C(p, &sp00, ((void*)0));
...
_080488CA:
    if (p->frameInput & gPlayerControls.jump) {
        ...
        { (p)->spriteOffsetX = 6; (p)->spriteOffsetY = 9; };
        v = 0;
        p->charState = 5;
        p->sa2__unk61 = v;
    }
...
void sub_8048980(Player *p)
{
    s32 qSpeedGround = ((p->qSpeedGround) >= 0 ? (p->qSpeedGround) : -(p->qSpeedGround));
    s8 shift = p->w.kf.shift;

    if (p->sa2__unk61 == 1) {
        if (qSpeedGround < ((s32)((3)*256))) {
            qSpeedGround += ((s32)((6. / 256.)*256));
        } else if ((qSpeedGround < ((s32)((18)*256))) && ((shift & 0x7F) == 0)) {
            qSpeedGround += ((s32)((3. / 256.)*256));
        ...
        if (p->moveState & 0x00000040) {
            s32 qSpeedCap = ((s32)((3)*256));
            if (qSpeedGround > qSpeedCap) {
                qSpeedGround -= ((s32)((9. / 256.)*256));
        ...
        p->qSpeedAirX = ((((int)(((gSineTable[((u8)shift << 2) + 256])) >> 6)) * qSpeedGround) >> 8);

        if (p->qSpeedAirY < ((s32)((0.5)*256))) {
            p->qSpeedAirY += ((s32)((24. / 256.)*256));
        } else {
            p->qSpeedAirY -= ((s32)((24. / 256.)*256));
        }
    }
...
{
    if ((p->moveState & 0x00000400) || ((s8)(p->rotation + ((s32)((0.25)*256))) <= ((s32)((0)*256))) || (p->moveState & 0x00000020)
        || !(p->frameInput & gPlayerControls.attack)) {
        return 0;
    } else {
        s32 qSpeed = ((s32)((3)*256));
        if (p->moveState & 0x00000001) {
            qSpeed = -qSpeed;
        }
...
bool32 sub_8048B38(Player *p)
{
    ...
    if (sa2__sub_8022F58(rot + ((s32)((0.5)*256)), p) < 4) {
        sa2__sub_8021BE0(p);
        return 0;
    }
...
{
    if (p->sa2__unk62 == 0) {
        if ((gGameMode == 6) || (sub_8048C3C(p) == 0)) {
        ...
        sa2__sub_8029CA0(p);
        if ((gGameMode != 6) && (sub_8048C3C(p) != 3)) {
            s32 qSpeed = p->qSpeedGround;

            if (qSpeed > ((s32)((0)*256))) {
                if ((qSpeed - ((s32)((96. / 256.)*256))) < ((s32)((0)*256))) {
                    qSpeed = 0;
                } else {
...
void Player_Knuckles_SwimFloat_8048D74(Player *p)
{
    ...
    if (p->heldInput & 0x0080) {
        ...
        s32 qOldSpeed = (u16)p->qSpeedAirY - ((s32)((24. / 256.)*256));
        p->qSpeedAirY -= ((s32)((24. / 256.)*256));
        r3 = qOldSpeed;
        qSpeed = qOldSpeed;
    ...
    if (((int)((p->qWorldY) >> 8)) - 4 < water->currentWaterLevel) {
        p->qWorldY = ((s32)((water->currentWaterLevel + 4)*256));
        p->qSpeedAirY = 0;
...
void sub_8048E34(Player *p)
{
    if (p->sa2__unk61 == 0) {
        ...
        if (p->sa2__unk62 == 0) {
            ...
            if (p->moveState & 0x00001000) {
                if ((p->moveState & 0x00000040) && (p->qSpeedAirY >= ((s32)((0)*256)))) {
                    p->sa2__unk61 = 9;
                    p->moveState &= ~(0x00000004 | 0x00000010);
                    p->charState = 82;
                    Player_Knuckles_InitGfx_FloatSplash(p);
                }
            }
...
{
    switch (p->moveState & (0x00000002 | 0x00000004)) {
        case 0: {
            {
                sub_8048CB0(p);
            }
...
void Task_KnucklesFloatSplash(void)
{
    ...
    MultiplayerSpriteTask *mps = (void *)((gCurTask)->data);
    ...
    s->x = (((int)((p->qWorldX) >> 8)) - cam->x) + p->sa2__unk7C;
    s->y = (((int)((p->qWorldY) >> 8)) - ({ (u16) cam->y + 4; }));
    ...
    if (water->currentWaterLevel >= 0) {
        if (((int)((p->qWorldY) >> 8)) - 6 < water->currentWaterLevel) {
            DisplaySprite(s);
        }
    }
}
...
struct Task *Player_Knuckles_InitGfx_UppercutFlame(Player *p)
{
    ...
    MultiplayerSpriteTask *mps = (void *)((t)->data);
    Sprite *s = &mps->s;

    s->graphics.dest = VramMalloc(((32 / 8) * (48 / 8)));
    s->graphics.anim = ((52) + CHARACTER_KNUCKLES * (99));
    s->variant = 3;
    s->oamFlags = ((8) << 6);
    s->frameFlags = ((2) << (12));
...
void sub_8049348(Player *p)
{
    ...
    p->charState = 63;
    { (p)->spriteOffsetX = 6; (p)->spriteOffsetY = 14; };
# 1168 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_knuckles.c"
    p->w.kf.flags |= 2;
