# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/options.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/options.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/options.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/options.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/options.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/options.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/options.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/options.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/options.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/options.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/options.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/options.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/options.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/text.h" 1
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/options.c" 2
...
const AnimId gUnknown_080BB378[2] = { 865, 864 };
...
const winreg_t gUnknown_080BB38E[4][2] = {
    { (((80) << 16) | (110)), (((86) << 16) | (102)) },
    { (((122) << 16) | (158)), (((86) << 16) | (102)) },
    { (((83) << 16) | (116)), (((86) << 16) | (102)) },
    { (((130) << 16) | (156)), (((86) << 16) | (102)) },
};
...
void CreateOptionsMenu()
{
    ...
    menu = (void *)((TaskCreate(Task_OptionsMenuMain, 0x344U, 0x2000U, 0U, TaskDestructor_OptionsMenu))->data);
    menu->unk33F = 0;
    menu->unk33C = 0;
    menu->unk33E = 0;
    menu->filler340[0] = 1;
    ...
    for (i = 0; i < (sizeof(menu->sprites30) / sizeof((menu->sprites30)[0])); i++) {
        s = &menu->sprites30[i];
        s->x = 25;
        s->y = 38 + (i * 0x10);
    ...
    s->oamFlags = ((15) << 6);
    s->graphics.size = 0;
    if ((&gLoadedSaveGame)->language > 1U) {
        s->graphics.anim = 878;
        s->variant = (&gLoadedSaveGame)->language - 2;
    } else {
        s->graphics.anim = gUnknown_080BB36C[(&gLoadedSaveGame)->uiLanguage];
        s->variant = 10;
    }
    ...
    s->graphics.size = 0;
    s->graphics.anim = 877;
    s->variant = gUnknown_080BB38A[(&gLoadedSaveGame)->uiLanguage];
    s->animCursor = 0;
    s->qAnimDelay = 0;
    s->prevVariant = -1;
    s->animSpeed = 0x10;
    ...
    s->oamFlags = 0;
    s->graphics.size = 0;
    s->graphics.anim = gUnknown_080BB378[(&gLoadedSaveGame)->uiLanguage];
    s->variant = 0;
    s->animCursor = 0;
    s->qAnimDelay = 0;
    s->prevVariant = -1;
...
void Task_OptionsMenuMain()
{
    ...
    OptionsMenu *menu = (void *)((gCurTask)->data);
...
void sub_8010E90(void)
{
    if (gRepeatedKeys & 0x0020) {
        m4aSongNumStart(108);
        (&gLoadedSaveGame)->difficultyLevel = 1;
...
void sub_8010F00(void)
{
    if (gRepeatedKeys & 0x0020) {
        m4aSongNumStart(108);
        (&gLoadedSaveGame)->timeLimitDisabled = 1;
    } else if (gRepeatedKeys & 0x0010) {
        m4aSongNumStart(108);
...
void OptionsSelectDeleteGameData()
{
    ...
    gBldRegs.bldY = 12;
    gWinRegs[1] = gUnknown_080BB38E[(&gLoadedSaveGame)->uiLanguage * 2 + 1][0];
    gWinRegs[3] = gUnknown_080BB38E[(&gLoadedSaveGame)->uiLanguage * 2 + 1][1];
    gWinRegs[4] = 0x3F00;
    gWinRegs[5] = 0x1F;
...
void sub_8011104()
{
    ...
    gWinRegs[1] = gUnknown_080BB38E[(menu->unk33F - 1) + ((&gLoadedSaveGame)->uiLanguage * 2)][0];
    gWinRegs[3] = gUnknown_080BB38E[(menu->unk33F - 1) + ((&gLoadedSaveGame)->uiLanguage * 2)][1];
    ...
    if (0x0002 & gPressedKeys) {
        ...
        if (0x0001 & gPressedKeys) {
            ...
            lbl:
                ...
                s32 uiLanguage = (&gLoadedSaveGame)->uiLanguage;
                ...
                m4aSongNumStart(106);
                CreateEmptySaveGame();
                (&gLoadedSaveGame)->uiLanguage = uiLanguage;
                gDispCnt &= ~(0x2000 | 0x4000 | 0x8000);
                gBldRegs.bldCnt = 0;
                gBldRegs.bldY = 0;
                menu->unk33F = 0;
