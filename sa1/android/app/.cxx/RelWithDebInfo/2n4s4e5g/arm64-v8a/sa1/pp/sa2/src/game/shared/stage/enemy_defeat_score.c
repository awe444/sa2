# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/enemy_defeat_score.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/enemy_defeat_score.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/enemy_defeat_score.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/enemy_defeat_score.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/enemy_defeat_score.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/enemy_defeat_score.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/enemy_defeat_score.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/enemy_defeat_score.c" 2
...
void CreateEnemyDefeatScore(s16 x, s16 y)
{
    ...
    EnemyDefeatScore *score = (void *)((t)->data);
    Sprite *s = &score->s;
    ...
    s->graphics.dest = VramMalloc(((16 / 8) * (8 / 8)));
...
void Task_CreateEnemyDefeatScore_MoveUp(void)
{
    EnemyDefeatScore *score = (void *)((gCurTask)->data);
    Sprite *s = &score->s;
