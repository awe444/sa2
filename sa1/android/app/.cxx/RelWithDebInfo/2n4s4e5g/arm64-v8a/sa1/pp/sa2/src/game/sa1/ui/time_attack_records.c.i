# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_records.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_records.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_records.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_records.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_records.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_records.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_records.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_records.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_records.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_records.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_records.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_records.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_records.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/text.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_records.c" 2
...
extern u16 gUnknown_0868B814[6][3];
extern u16 gUnknown_0868B838[2][3];
extern u16 gUnknown_0868B844[2][12][3];
...
void CreateTimeAttackRecords()
{
    ...
    s = &recs->sprites[0];
    s->graphics.dest = VramMalloc(gUnknown_0868B814[((gCurrentLevel) >> 1)][0]);
    s->graphics.anim = gUnknown_0868B814[((gCurrentLevel) >> 1)][1];
    s->variant = gUnknown_0868B814[((gCurrentLevel) >> 1)][2];
    s->x = 25;
    s->y = 24;
    s->graphics.size = 0;
    s->animCursor = 0;
    ...
    s = &recs->sprites[1];
    s->graphics.dest = VramMalloc(gUnknown_0868B838[((gCurrentLevel) & ((2) - 1))][0]);
    s->graphics.anim = gUnknown_0868B838[((gCurrentLevel) & ((2) - 1))][1];
    s->variant = gUnknown_0868B838[((gCurrentLevel) & ((2) - 1))][2];
    s->x = 93;
    s->y = 27;
    s->graphics.size = 0;
    s->animCursor = 0;
    ...
    s = &recs->s3;
    s->graphics.dest = VramMalloc(gUnknown_0868B844[(&gLoadedSaveGame)->uiLanguage][gCurrentLevel][0]);
    s->graphics.anim = gUnknown_0868B844[(&gLoadedSaveGame)->uiLanguage][gCurrentLevel][1];
    s->variant = gUnknown_0868B844[(&gLoadedSaveGame)->uiLanguage][gCurrentLevel][2];
    recs->qUnkY = -((s32)((90)*256));
    s->x = -90;
    s->y = 48;
    s->graphics.size = 0;
    s->animCursor = 0;
...
void Task_806BBC0()
{
    ...
    s8 var_r4 = 0;
    s32 temp_sb = 0;
    TimeAttackRecords *recs = (void *)((gCurTask)->data);
...
void sub_806BDC4(u8 rankIndex, struct Task *t)
{
    ...
    TimeAttackRecords *recs = (void *)((t)->data);

    temp_r6 = (&gLoadedSaveGame)->timeRecords.table[gSelectedCharacter][gCurrentLevel][rankIndex];
    if (temp_r6 >= ((int)(((10 * 60.) + 0) * 60))) {
        ...
        temp_r4 = ({((60) != 0) ? ((s32)(temp_r6) / (s32)(60)) : 0;});
        temp_r0_2 = ({((60) != 0) ? ((s32)(temp_r4) / (s32)(60)) : 0;});
...
{
    TimeAttackRecords *recs = (void *)((gCurTask)->data);
    recs->qUnkY -= ((s32)((2)*256));

    if (recs->qUnkY < -((s32)((200)*256))) {
        recs->qUnkY += ((s32)((200)*256));
    }
}
