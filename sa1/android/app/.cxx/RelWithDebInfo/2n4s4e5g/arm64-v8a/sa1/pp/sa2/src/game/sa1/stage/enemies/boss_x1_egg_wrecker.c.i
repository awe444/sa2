# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x1_egg_wrecker.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x1_egg_wrecker.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x1_egg_wrecker.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x1_egg_wrecker.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x1_egg_wrecker.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x1_egg_wrecker.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x1_egg_wrecker.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x1_egg_wrecker.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x1_egg_wrecker.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x1_egg_wrecker.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x1_egg_wrecker.c" 2
...
{
    EggWrecker_44 *boss_44 = (void *)((gCurTask)->data);
    Sprite *s = &boss_44->s;
    ...
    if ((collPlayer == 2) || (collPartner == 2)) {
        EggWrecker *boss = (void *)(((struct Task *)((gCurTask)->parent))->data);
        Sprite *s2 = &boss->s2;
...
{
    EggWrecker *boss = (void *)((gCurTask)->data);
    Sprite *s2 = &boss->s2;
...
void sub_80343E0(void)
{
    ...
    if (boss->unk87 != 0) {
        if ((--boss->unk87 > 0x10) && !(boss->unk87 & 2) && (!(gPlayer.moveState & 0x00000080))) {
            s->frameFlags |= 0x100;
            gDispCnt |= 0x8000;
            gWinRegs[5] = 0x3F1F;
...
void CreateEntity_EggWrecker(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    boss->unk88 = 0;
    boss->unk8A = 0;
    boss->worldX = ((me->x)*8 + (regionX)*256);
    boss->worldY = ((me->y)*8 + (regionY)*256);
...
void Task_EggWreckerInit(void)
{
    ...
    switch (boss->unk8D) {
        case 0: {
            if (boss->worldX - (320 / 2) <= gCamera.x) {
                gCamera.minX = boss->worldX - (320 / 2);
                gCamera.maxX = gCamera.minX + 320;
                boss->unk8D = 1;
            }
        } break;
        ...
        case 1: {
            if (boss->worldY - 64 <= gCamera.y) {
                CreatePreBossCameraPan(boss->worldY, (boss->worldY + 240));
                boss->unk8D = 2;
            }
        } break;
    }

    if ((gCamera.minX == (boss->worldX - (320 / 2))) && (gCamera.maxY == (boss->worldY + 240))) {
        boss->unk8D = 0;
        boss->unk78 = 0x100;
...
void Task_8034718(void)
{
    ...
    worldX = boss->worldX + ((int)((boss->unk6C) >> 8));
    worldY = boss->worldY + ((int)((boss->unk70) >> 8));
    boss->unk80 = worldX;
    boss->unk82 = worldY;
    ...
    switch (boss->unk8D) {
        case 0: {
            if (boss->unk70 >= ((s32)((32)*256))) {
                boss->unk70 = ((s32)((32)*256));
                boss->unk74 = -((s32)((1)*256));
                boss->unk78 = -((s32)((16. / 256.)*256));
                boss->unk8D++;
            }
        } break;
        ...
        case 1: {
            if (boss->unk6C <= 0) {
                boss->unk6C = ((s32)((0)*256));
                boss->unk74 = ((s32)((0)*256));
                boss->unk78 = ((s32)((0)*256));
                boss->unk84 = 4;
                boss->unk8D++;
            }
        } break;
        ...
        case 3: {
            ...
            if ((s2->variant == 0) && (boss->unk84 == 0)) {
                ...
                CreatePreBossCameraPan(gCamera.minY - (240 / 2), gCamera.maxY);
            }
        } break;
    }
}
...
void Task_803491C(void)
{
    ...
    var_r1 = (((gSineTable[(((boss->unk88 + 0x100) * 2) & 0x3FF) + 256]) >> 13));
    worldX = (boss->worldX + ((int)((boss->unk6C) >> 8)));
    worldY = var_r1 + (boss->worldY + ((int)((boss->unk70) >> 8)));
    boss->unk80 = worldX;
    boss->unk82 = worldY;

    var_r1 = ((int)(((gSineTable[(boss->unk88) + 256])) >> 6));
    if (var_r1 > 0xFF) {
        var_r1 = 0xFF;
    }
    var_r1 += ((s32)((3)*256));
...
void sub_8034B7C(void)
{
    ...
    boss->unk70 += ((s32)(((gSineTable[((theta)) + 256]) >> 0xD)*256));
    boss->s2.variant = 2;
...
void Task_8034CA0()
{
    ...
    boss->unk6C += boss->unk74;
    boss->unk70 += boss->unk78;
    worldX = (((int)((boss->unk6C) >> 8)) + boss->worldX);
    worldY = (((int)((boss->unk70) >> 8)) + boss->worldY);
    boss->unk80 = worldX;
    boss->unk82 = worldY;
...
void sub_8035010(void)
{
    ...
    strc_44 = (void *)((t)->data);
    strc_44->unk3C = boss->worldX + ((int)((boss->unk6C) >> 8));
    strc_44->unk3E = boss->worldY + ((int)((boss->unk70) >> 8));
    strc_44->unk30 = 0x40;
    s = &strc_44->s;
...
void Task_80352C0()
{
    ...
    if (boss->unk86 > 3) {
        sub_8017540(((s32)((worldX)*256)), ((s32)((worldY + 20)*256)));
        TaskDestroy(gCurTask);
        return;
    }
}
...
void Task_8035354()
{
    ...
    if (--boss_44->unk30 != 0) {
        ...
        var_r2 = (var_r2 - (((((var_r2 + 21) * ((s32)((s32)((boss_44->unk30)*256)) >> 6)) << 8) >> 16) - 35));
    } else {
...
void Task_803540C(void)
{
    ...
    asm("" ::"r"(temp_r1_2));
    worldX = (((gSineTable[(boss->unk8A) + 256]) * temp_r1_2 * 4) >> 0x10) + boss->unk80;
    boss_44->unk3C = boss->unk80;
    boss_44->unk3E = boss->unk82;
    worldY = boss->unk82 + ((((gSineTable[(0x1FF & boss->unk8A)]) * temp_r1_2 * 4) >> 0x10));
    worldY + 22;
    s->x = worldX - gCamera.x;
    s->y = worldY - gCamera.y;
    UpdateSpriteAnimation(s);
...
void Task_8035588(void)
{
    ...
    temp_r2 = boss->unk8A;
    boss_44->unk3C = boss->unk80;
    worldX = boss->unk80 + (((gSineTable[(boss->unk8A) + 256]) * 0x4D) >> 0xE);
    boss_44->unk3E = boss->unk82;
    worldY = boss->unk82 + ((((gSineTable[(0x1FF & boss->unk8A)]) * 0x4D) >> 0xE) + 22);
    ...
    if (boss->unk86 > 3) {
        if (!(7 & boss_44->unk30)) {
            temp_r1_2 = ({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; });
...
void TaskDestructor_8035818(struct Task *t)
{
    EggWrecker_44 *boss_44 = (void *)((t)->data);
