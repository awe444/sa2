# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/grind_effect_1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/grind_effect_1.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/grind_effect_1.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/grind_effect_1.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/grind_effect_1.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/grind_effect_1.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/grind_effect_1.c" 2
...
void Task_GrindEffect(void)
{
    ...
    if (p->spriteTask == ((void*)0) || !(p->moveState & 0x01000000)) {
        TaskDestroy(gCurTask);
        return;

    } else if ((p->anim == 44) && (p->variant == 1)) {



        GrindEffect *spark = (void *)((gCurTask)->data);
        Sprite *s = &spark->s;
        struct Camera *cam = &gCamera;
        s->x = ((int)((p->qWorldX) >> 8)) - cam->x;
        s->y = (((int)((p->qWorldY) >> 8)) + p->spriteOffsetY) - cam->y;
