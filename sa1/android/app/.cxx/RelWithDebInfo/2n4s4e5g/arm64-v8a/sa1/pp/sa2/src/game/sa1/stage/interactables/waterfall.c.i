# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/waterfall.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/waterfall.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/waterfall.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/waterfall.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/waterfall.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/waterfall.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/waterfall.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/waterfall.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/waterfall.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/waterfall.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/waterfall.c" 2
...
extern AnimId gUnknown_086CED28[18];
...
void CreateEntity_Waterfall(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    if (((gCurrentLevel) >> 1) == 4) {
        t = TaskCreate(Task_WaterfallZone5, sizeof(Waterfall), 0x2000, 0, TaskDestructor_Waterfall);
    } else {
        t = TaskCreate(Task_Waterfall, sizeof(Waterfall), 0x2000, 0, TaskDestructor_Waterfall);
    }

    *(u16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Waterfall, regionX)) = (regionX);;
    *(u16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Waterfall, regionY)) = (regionY);;
    *(u16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Waterfall, unk38)) = (0);;
    *(u16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Waterfall, unk3A)) = (0);;
    *(u16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Waterfall, unk3A)) = (0);;
    *(u16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Waterfall, unk3A)) = (0);;
    *(MapEntity * *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Waterfall, me)) = (me);;

    s = &*(Sprite *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Waterfall, s));
    *(u8 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Waterfall, unk3D)) = (0);;
    *(u8 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Waterfall, unk3E)) = (0);;
    *(u8 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Waterfall, meX)) = (me->x);;

    { s32 negativeTwo; s16 forMatching; negativeTwo = (-2); forMatching = negativeTwo; me->x = forMatching; };


    s->graphics.dest = VramMalloc(((48 / 8) * (24 / 8)));
...
void Task_Waterfall(void)
{
    ...
    me = *(MapEntity * *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Waterfall, me));
    meX = *(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Waterfall, meX));
    regionX = *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Waterfall, regionX));
    regionY = *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Waterfall, regionY));
    s = &*(Sprite *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Waterfall, s));
    unk3D = *(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Waterfall, unk3D));
    unk3E = *(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Waterfall, unk3E));


    x = ((meX)*8 + (regionX)*256);
    y = ((me->y)*8 + (regionY)*256);


    x -= gCamera.x;
    y -= gCamera.y;

    if ((((u16)(x + (256 / 2)) > 320 + 256) || (y + (256 / 2) < 0) || (y > 240 + (256 / 2)))) {
        s32 i = 0;
        do {
            if (*(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Waterfall, unk3A[i])) == 1) {
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            ...
            if ((x <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (x + me->d.uData[2] * 8 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)))
                && (y + me->d.sData[1] * 8 <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))
                && (y + me->d.sData[1] * 8 + me->d.uData[3] * 8) >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8))) {
                if (!sub_80549FC()) {
                    ...
                    {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY += ((s32)((16 / 256.)*256));
                    }
                }

                s->x = ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) - gCamera.x;
                s->y = ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) - gCamera.y + 10;

                UpdateSpriteAnimation(s);
                DisplaySprite(s);

                *(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Waterfall, unk3A[i])) = (*(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Waterfall, unk38[i])));;
            } else {
                *(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Waterfall, unk38[i])) = (0);;
                *(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Waterfall, unk3A[i])) = (*(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Waterfall, unk38[i])));;
            }
        }
    } while (++i < gNumSingleplayerCharacters);

    *(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Waterfall, unk3D)) = (unk3D);;
    *(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Waterfall, unk3E)) = (unk3E);;
}
...
void Task_WaterfallZone5(void)
{
    ...
    if ((((u16)(x + (256 / 2)) > 320 + 256) || (y + (256 / 2) < 0) || (y > 240 + (256 / 2)))) {
        s32 i = 0;
        do {
            if (*(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Waterfall, unk3A)) == 1) {
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            ...
            if ((x <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (x + me->d.uData[2] * 8 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)))
                && (y + me->d.sData[1] * 8 <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))
                && (y + me->d.sData[1] * 8 + me->d.uData[3] * 8) >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8))) {
                if (((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY >= 0) && (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080))) {
                    {
                        if (unk3D == 0) {
                            unk3D = 1;
                            m4aSongNumStart(201);
                        ...
                        if ((*(((i) != 0) ? &gPartner : &gPlayer)).frameInput & gPlayerControls.jump) {
                            ...
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = -(((s32)((4.875)*256)) >> 1);

                        } else {


                            if ((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_KNUCKLES) {
                                if ((*(((i) != 0) ? &gPartner : &gPlayer)).charState == 62) {
                                    (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 4;
                                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = ((s32)((0)*256));
                                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = ((s32)((0)*256));

                                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000001) {

                                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState = 0x00000001;
                                    } else {
                                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState = 0;
                                    }
                                }

                                if (((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000002)) {
                                    if (((*(((i) != 0) ? &gPartner : &gPlayer)).frameInput & gPlayerControls.attack)) {
                                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = ((s32)((0)*256));
                                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = ((s32)((0)*256));
                                    }
                                } else {
                            ...
                            (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 4;
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY += ((s32)((0.6875)*256));
                            ...
                            if ((*(((i) != 0) ? &gPartner : &gPlayer)).heldInput & 0x0020) {
                                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround += ((s32)((4. / 256.)*256));
                            } else if ((*(((i) != 0) ? &gPartner : &gPlayer)).heldInput & 0x0010) {
                                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround -= ((s32)((4. / 256.)*256));
                            } else {
                                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround -= ({((20) != 0) ? ((s32)((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround) / (s32)(20)) : 0;});
                            }
                        }
                    }
                }
...
void TaskDestructor_Waterfall(struct Task *t) { VramFree((&*(Sprite *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Waterfall, s)))->graphics.dest); }
