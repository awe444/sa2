# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kerokero.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kerokero.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kerokero.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kerokero.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kerokero.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kerokero.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kerokero.c" 2
...
void CreateEntity_KeroKero(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    kerokero->qUnk40 = -((s32)((1)*256));
    kerokero->qUnk3C = ((s32)((0)*256));
    kerokero->unk42 = 0;
    kerokero->qUnk44 = ((s32)((0)*256));
    kerokero->unk46 = 0;
    kerokero->unk47 = 0;
    kerokero->unk48 = 0;
...
void Task_KeroKeroInit(void)
{
    ...
    KeroKero *kerokero = (void *)((gCurTask)->data);
    Sprite *s = &kerokero->shared.s;
    ...
    worldX = ((kerokero->shared.base.meX)*8 + (kerokero->shared.base.regionX)*256);
    worldY = ((me->y)*8 + (kerokero->shared.base.regionY)*256);

    worldX2 = worldX;
    worldY2 = worldY;

    worldX = worldX + ((int)((kerokero->qUnk3C) >> 8));
    ...
    if (kerokero->unk4A != 0) {
        kerokero->unk42 += sa2__sub_801F07C(worldY, worldX, 1, +8, &sp10, sa2__sub_801EE64);
    } else {
        kerokero->unk42 += sa2__sub_801F07C(worldY, worldX, 0, +8, &sp10, sa2__sub_801EE64);
    }
    ...
    if (kerokero->unk48 > 250) {
        ...
        if (s->frameFlags & ((1) << (10))) {
            if ((((int)((kerokero->qUnk3C) >> 8)) <= (me->d.sData[0] + me->d.uData[2] - 8) * 8) && (((int)((gPlayer.qWorldX) >> 8)) >= worldX)
                && (worldX + 80 >= ((int)((gPlayer.qWorldX) >> 8)))) {
                kerokero->qUnk44 = -((s32)((5)*256));
                s->variant = 0;
        ...
        } else if (((int)((kerokero->qUnk3C) >> 8)) >= ((me->d.sData[0] + 8) * 8) && (((int)((gPlayer.qWorldX) >> 8)) <= worldX)
                   && (worldX - 80 <= ((int)((gPlayer.qWorldX) >> 8)))) {
            {
                kerokero->qUnk44 = -((s32)((5)*256));
                s->variant = 0;
...
void Task_806D2B8(void)
{
    ...
    kerokero->qUnk44 += ((s32)((0.25)*256));
    kerokero->unk42 += ({((((s32)((1)*256))) != 0) ? ((s32)(kerokero->qUnk44) / (s32)(((s32)((1)*256)))) : 0;});

    if (s->frameFlags & ((1) << (10))) {
        kerokero->qUnk3C += ((s32)((1)*256));
    } else {
        kerokero->qUnk3C -= ((s32)((1)*256));
    }
    ...
    if (kerokero->unk4A != 0) {
        res = sa2__sub_801F07C(worldY, worldX, 1, +8, &sp10, sa2__sub_801EE64);
    } else {
        res = sa2__sub_801F07C(worldY, worldX, 0, +8, &sp10, sa2__sub_801EE64);
    }
