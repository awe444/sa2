# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/torch.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/torch.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/torch.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/malloc_vram.h" 1
# 24 "/home/awaszczak/git/sa2/sa1/../include/malloc_vram.h"
void *VramMalloc(u32);
void VramResetHeapState(void);
void VramFree(void *);
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/torch.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/torch.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/torch.c" 2
...
static void Task_TorchMain(void)
{
    Torch *torch = (void *)((gCurTask)->data);
    Sprite *s = &torch->s;
    MapEntity *me = torch->base.me;

    s16 screenX, screenY;
    screenX = ((torch->base.meX)*8 + (torch->base.regionX)*256);
    screenY = ((me->y)*8 + (torch->base.regionY)*256);
