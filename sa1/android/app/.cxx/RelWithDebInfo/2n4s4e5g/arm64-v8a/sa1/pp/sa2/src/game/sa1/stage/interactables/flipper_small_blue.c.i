# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flipper_small_blue.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flipper_small_blue.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flipper_small_blue.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flipper_small_blue.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flipper_small_blue.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flipper_small_blue.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flipper_small_blue.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flipper_small_blue.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flipper_small_blue.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flipper_small_blue.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flipper_small_blue.c" 2
...
void CreateEntity_Flipper_SmallBlue(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    BlueFlipper *flipper = (void *)((t)->data);
    Sprite *s = &flipper->s;
    s32 i;
...
void Task_Flipper_SmallBlue(void)
{
    ...
    BlueFlipper *flipper = (void *)((gCurTask)->data);
    Sprite *s = &flipper->s;
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            if ((((flipper->unk3C) >> (i)) & 1)) {
                ...
                flipper->qUnk40[i] += ((s32)((42. / 256.)*256));
                flipper->qUnk48[i] += flipper->qUnk40[i];
                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = flipper->qUnk48[i];
                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = flipper->qUnk50[i];
                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = flipper->qUnk40[i];
                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = 0;
                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = 0;

                if (++flipper->unk58[i] >= flipper->unk3D) {
                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] == flipper->unk3E) {
                ...
                } else if ((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00400000) {
                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] < flipper->unk3E) {
                        if (Coll_Player_Entity_Intersection(s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                            ...
                            (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00400000;
                            (*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk99[0] = flipper->unk3E;
                            flipper->qUnk48[i] = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY;
                            flipper->qUnk50[i] = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX;
                            flipper->qUnk40[i] = -((s32)((12.5625)*256));
    ...
    if (((flipper->unk3C & 0x3) == 0) && (((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
        s32 i = 0;
        do {
            if ((((flipper->unk3C) >> (i)) & 1) & 0x1) {
                (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00400000;
            }
        } while (++i < gNumSingleplayerCharacters);
