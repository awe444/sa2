# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/sound_test.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/sound_test.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/sound_test.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/sound_test.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/sound_test.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/sound_test.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/sound_test.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/sound_test.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/sound_test.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/sound_test.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/sound_test.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/sound_test.c" 2
# 28 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/sound_test.c"
...
{
    SoundTestState *state = (void *)((gCurTask)->data);
    SoundTest114 *strc114 = (void *)((state->task10)->data);
...
void CreateSoundTest(void)
{
    ...
    state = (void *)((TaskCreate(Task_SoundTestInit, sizeof(SoundTestState), 0x2000U, 0U, ((void*)0)))->data);
    strc0 = &state->strc0;
    state->unk24 = 0;
    state->unk28 = 0;
    state->unk29 = 0;
    ...
    t = TaskCreate(sub_805F950, sizeof(SoundTest114), 0x2020U, 0U, ((void*)0));
    temp_r1_2 = (void *)((t)->data);
    temp_r1_2->unk108 = 0;
    temp_r1_2->unk10C = 0;
    temp_r1_2->unk110 = 0;
    temp_r1_2->unk10D = 0;
    ...
    s = &temp_r1_2->s;
    s->graphics.dest = (void *)&VRAM[0x10000] + 0x0020;
    s->graphics.anim = 0x357;
    s->variant = 0;
    s->graphics.size = 0;
    s->x = 180;
    ...
    t = TaskCreate(sub_805FAD4, sizeof(SoundTest114), 0x2020U, 0U, ((void*)0));
    temp_r4 = (void *)((t)->data);
    s = &temp_r4->s;
    temp_r4->unk108 = 0;
    temp_r4->unk10C = 0;
    ...
    s->graphics.dest = (void *)&VRAM[0x10000] + 0x0C80;
    ...
    tf->x = 0x4C;
    tf->y = 0x5C;
    UpdateSpriteAnimation(s); TransformSprite(s, tf); DisplaySprite(s);;
    ...
    t = TaskCreate(Task_805FEAC, sizeof(SoundTest114), 0x2020U, 0U, ((void*)0));
    temp_r1_2 = (void *)((t)->data);
    s = &temp_r1_2->s;
    temp_r1_2->unk108 = 0;
    temp_r1_2->unk10C = 0;
    ...
    temp_r1_2->unk110 = 0;
    state->task20 = t;
    s->graphics.dest = (void *)&VRAM[0x10000] + 0x1C80;
    ...
    t = TaskCreate(sub_805FDE4, sizeof(SoundTest114), 0x2020U, 0U, ((void*)0));
    temp_r1_2 = (void *)((t)->data);
    temp_r1_2->unk108 = 0;
    temp_r1_2->unk10C = 0;
    temp_r1_2->unk10D = 0;
    ...
    s = &temp_r1_2->s;
    s->graphics.dest = (void *)&VRAM[0x10000] + 0x2040;
    s->graphics.anim = 0x366;
    s->variant = 0;
    s->graphics.size = 0;
    s->x = 0x62;
    ...
    t = TaskCreate(sub_805FC88, sizeof(SoundTest114), 0x2040U, 0U, ((void*)0));
    temp_r1_2 = (void *)((t)->data);
    temp_r1_2->unk108 = 0;
    temp_r1_2->unk10C = 0;
    temp_r1_2->unk10D = 0;
    ...
    t = TaskCreate(sub_805FE48, sizeof(SoundTest114), 0x2020U, 0U, ((void*)0));
    temp_r4 = (void *)((t)->data);
    s = &temp_r4->s;
    temp_r4->unk108 = 0;
    temp_r4->unk10C = 0;
    ...
    s->graphics.dest = (void *)&VRAM[0x10000] + 0x2600;
    ...
    s = &temp_r4->s2;
    s->graphics.dest = (void *)&VRAM[0x10000] + 0x3200;
    ...
    s = &temp_r4->s3;
    s->graphics.dest = (void *)&VRAM[0x10000] + 0x1CC0;
    ...
    s = &temp_r4->s4;
    s->graphics.dest = (void *)&VRAM[0x10000] + 0x2380;
...
void Task_SoundTestInit(void)
{
    ...
    t = state->taskC;
    sp0 = (void *)((t)->data);
    sp4 = (void *)((state->task10)->data);
    sp8 = (void *)((state->task14)->data);
    spC = (void *)((state->task18)->data);
    sp10 = (void *)((state->task1C)->data);
    sp14 = (void *)((state->task20)->data);
    var_r7 = state->unk24;
    var_r7++;
    ...
    if (0x20 & gRepeatedKeys) {
        ...
        var_r5 = (u8)({((var_r1) != 0) ? ((s32)(var_r0) % (s32)(var_r1)) : 0;});
        state->unk2B = 1;
        sp0->unk110 = 1;
        sp0->unk10E = 0;
    }
    ...
    if (sub_805423C(&state->strc0) && (0x0001 & gPressedKeys) && (var_r7 <= 0x78U) && !(0x0002 & gPressedKeys)) {
        SoundTestState *state;
        Sprite *s;
        var_r7 = 0x79;
    ...
    if (0x0002 & gPressedKeys) {
        ...
        if ((0x0002 & gPressedKeys) && (state->strc0.unk4 != 1) && (state->unk29 != 0)) {
            if (state->unk2C == 0) {
                for (var_r4 = 0; var_r4 < 4; var_r4++) {
                    if (var_r4 == 0) {
                        if ((((state->unk2A) >> (var_r4)) & 1)) {
                            state->unk2C = 0xA;
                            m4aMPlayFadeOut(&gMPlayInfo_BGM, 1U);
                        }
                    } else if (var_r4 == 1) {
...
void sub_805F950()
{
    ...
    SoundTest114 *strc114 = (void *)((gCurTask)->data);

    temp_r6 = strc114->unk108;
    if ((strc114->unk10D == 0) || ((u32)temp_r6 < 120)) {
        strc114->s.x = 180;
        strc114->s.y = 120;
        strc114->s.graphics.anim = 853;
        strc114->s.variant = 0;
        if (temp_r6 == 0x77) {
            strc114->s.prevVariant = 0xFF;
            strc114->unk10D = 1;
            strc114->s.graphics.anim = 854;
            strc114->s.variant = 0;
        }
        ...
        if (({((250) != 0) ? ((s32)(temp_r6) % (s32)(250)) : 0;}) <= 0x77) {
            strc114->s.x = 164;
            strc114->s.y = 120;
            strc114->s.graphics.anim = 855;
            strc114->s.variant = 0;
            strc114->s.frameFlags &= ~0x400;
        } else if ((({((250) != 0) ? ((s32)(temp_r6) % (s32)(250)) : 0;}) > 124) && (({((250) != 0) ? ((s32)(temp_r6) % (s32)(250)) : 0;}) < 245)) {
            strc114->s.x = 196;
            strc114->s.y = 120;
            strc114->s.graphics.anim = 855;
            strc114->s.variant = 0;
...
void sub_805FAD4()
{
    ...
    tf->rotation = 0;
    tf->qScaleX = ((int)(((gSineTable[(strc114->unk10E)])) >> 8)) + ((s32)((1)*256));
    tf->qScaleY = ((int)(((gSineTable[(strc114->unk10E)])) >> 8)) + ((s32)((1)*256));
    tf->x = 76;
    s->x = 76;
    tf->y = 92;
    s->y = 92;
...
void sub_805FC88()
{
    ...
    if ((u32)temp_r5 > 0x63U) {
        subroutine_arg0 = ({((100) != 0) ? ((s32)((s32)temp_r5) / (s32)(100)) : 0;}) + 0x20;
    ...
    overB = &strc114->overB;
    if ((u32)temp_r5 > 9U) {
        subroutine_arg0 = (s8)(({((0xA) != 0) ? ((s32)(({((100) != 0) ? ((s32)(temp_r5) % (s32)(100)) : 0;})) / (s32)(0xA)) : 0;}) + 0x20);
        *temp_r6 = 74 - var_r8;
        sub_805321C(&subroutine_arg0, overB);
    }
    subroutine_arg0 = (s8)(({((0xA) != 0) ? ((s32)(temp_r5) % (s32)(0xA)) : 0;}) + 0x20);
    *temp_r6 = 84 - var_r8;
    sub_805321C(&subroutine_arg0, overB);
}
...
void Task_805FEAC(void)
{
    ...
    s->frameFlags &= ~0x400;
    baseX = gUnknown_0868B0CC[(unk108 >> 3) % (sizeof(gUnknown_0868B0CC) / sizeof((gUnknown_0868B0CC)[0]))];
    s->x = baseX + 102;
    DisplaySprite(s);
    s->frameFlags |= 0x400;
    s->x = 52 - baseX;
