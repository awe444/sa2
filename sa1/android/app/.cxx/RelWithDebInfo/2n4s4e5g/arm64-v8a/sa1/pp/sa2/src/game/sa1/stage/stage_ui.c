# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui.c" 2
...
# 57 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui.c"
...
void Task_StageUIMain(void)
{
    ...
    ui = (void *)((gCurTask)->data);

    if (gRingCount > 999) {
        ui->digitsRings[0] = ((9) + 32);
        ui->digitsRings[1] = ((9) + 32);
        ui->digitsRings[2] = ((9) + 32);
    } else {
        remainder = gRingCount;

        for (i = 0; i < 3; i++) {
            remainder0 = ({((10) != 0) ? ((s32)(remainder) / (s32)(10)) : 0;});


            ui->digitsRings[2 - i] = ((remainder - ((remainder0 << 3) + (remainder0 << 1))) + 32);
    ...
    *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(StageUI, ringCount)) = (gRingCount);;

    (&*(StageUI_10 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(StageUI, unk10)))->unk9 = 0;
    ...
    for (i = 8; i >= 0; i--) {
        ...
        ((u8 *)&ui->unk10)[i] = ((remainder - ((remainder0 << 3) + (remainder0 << 1))) + 32);
    ...
    ptr = &*(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(StageUI, digitLives));
    if (gNumLives > 9) {
        digitLives = ((9) + 32);
    } else if (gNumLives != 0) {
        digitLives = ((gNumLives - 1) + 32);
    } else {
        digitLives = ((0) + 32);
    }
    *ptr = digitLives;
    ...
    if (((&gLoadedSaveGame)->timeLimitDisabled != 1) || (gGameMode != 0)) {
        if (gStageFlags & 0x0004) {
            if (gCourseTime < ((int)(((0 * 60.) + 20) * 60))) {
                if ((({((60) != 0) ? ((s32)(gCourseTime) % (s32)(60)) : 0;}) == 0) && (gCourseTime != 0)) {
                    m4aSongNumStart(139);
                }
            }
        } else {
            if (gCourseTime > (((int)(((10 * 60.) + 0) * 60)) - ((int)(((0 * 60.) + 20) * 60)))) {
                if ((({((60) != 0) ? ((s32)(gCourseTime) % (s32)(60)) : 0;}) == 0) && (gCourseTime < ((int)(((10 * 60.) + 0) * 60)))) {
                    m4aSongNumStart(139);
                }
            }
        }
...
void sub_80538BC(void)
{
    ...
    gfx = &gUiGraphics[0];
    sp00.tiles = gfx->tiles + 224 * 32;
    sp00.palette = gfx->palette;
    sp00.vramC = ((void *)&VRAM[0x10000] + 0x0D40);
    sp00.tilesSize = 22 * 32;
    sp00.paletteSize = 32;
    sp00.unk28 = 6;
    sp00.unk2A = 13;
    ...
    sp00.uiGfxID = 0;
    sp00.unk2B = 0;
    sp00.tiles = gfx->tiles + 32 * 32;
    sp00.palette = gfx->palette;
    sp00.vramC = ((void *)&VRAM[0x10000] + 0x0A80);
    sp00.tilesSize = 22 * 32;
    sp00.paletteSize = 32;
    sp00.unk28 = 6;
    sp00.unk2A = 9;
    ...
    sp00.uiGfxID = 5;
    sp00.unk2B = 3;
    sp00.tiles = gUiGraphics[5].tiles;
    sp00.palette = gUiGraphics[5].palette;
    sp00.tilesSize = (4 * 4) * 32;
    sp00.paletteSize = 32;
    sp00.unk28 = 6;
    sp00.vramC = ((void *)&VRAM[0x10000] + 0x0880);
    sp00.unk2A = 9;
    sp00.unk0.unk4 = gUiGraphics[5].unk8;
    sp00.unk0.unk8 = gUiGraphics[5].unkC;
    sp00.unk0.unk9 = gUiGraphics[5].unk10;
    sp00.unk0.unkA = gUiGraphics[5].unk14;
    sp00.unk0.unkB = gUiGraphics[5].unk18;
    sub_80528AC(&sp00);
}

void StageUI_DrawTimer(u32 courseTime)
{
    StageUI *ui = (void *)((gCurTask)->data);
    ...
    if (gStageFlags & 0x0004) {
        if ((gCourseTime < (int)(((1 * 60.) + 0) * 60)) && (gStageTime & 0x10)) {
            redOffset = 11;
        } else {
            redOffset = 0;
        }
    } else {
        if ((gCourseTime > (int)(((9 * 60.) + 0) * 60)) && (gStageTime & 0x10)) {
            redOffset = 11;
        } else {
            redOffset = 0;
        }
    ...
    if (courseTime >= ((int)(((10 * 60.) + 0) * 60))) {

        unk20->unk6 = ((redOffset + 9) + 32);
        unk20->unk5 = ((redOffset + 9) + 32);


        unk20->unk3 = ((redOffset + 9) + 32);
        unk20->unk2 = ((redOffset + 5) + 32);


        unk20->unk0 = ((redOffset + 9) + 32);
    } else {
        s32 seconds = ({((60) != 0) ? ((s32)(courseTime) / (s32)(60)) : 0;});
        s32 minutes = ({((60) != 0) ? ((s32)(seconds) / (s32)(60)) : 0;});
        s32 r2;
...
# 300 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/stage_ui.c"
    ...
    unk20->unk1 = ((redOffset + 10) + 32);
    unk20->unk4 = ((redOffset + 10) + 32);
}
...
void sub_8053BAC(void)
{
    ...
    if (gRingCount <= 9) {
        ...
        if (gRingCount == 0) {
            ...
            *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(StageUI, unk48)) = (r4);;
        } else {
...
void Task_SpecialStageUIMain(void)
{
    ...
    if (sb >= 10 && sb < 30) {
        overB.unkC = ({((20) != 0) ? ((s32)((sb - 10) << 6) / (s32)(20)) : 0;}) - 70;
    } else if (sb >= 30) {
        overB.unkC = -6;
    } else {
        overB.unkC = -70;
    ...
    if (gSpecialStageCollectedRings > 999) {
        ...
        for (i = 0; i < (s32)(sizeof(ui->digitsRings) / sizeof((ui->digitsRings)[0])); i++) {
            remainder0 = ({((10) != 0) ? ((s32)(remainder) / (s32)(10)) : 0;});
    ...
    *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(StageUI, ringCount)) = (gSpecialStageCollectedRings);;

    if (sb >= 20 && sb < 40) {
        overB.unkC = ({((20) != 0) ? ((s32)((sb - 20) << 6) / (s32)(20)) : 0;}) - 64;
    } else if (sb >= 40) {
        overB.unkC = 0;
    } else {
        overB.unkC = -64;
    ...
    if (gSpecialStageCollectedRings < 10) {
        ...
        if (gSpecialStageCollectedRings == 0) {
            ...
            r7 %= 32u;
            *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(StageUI, unk48)) = (r7);;
        } else {
            sub_80530CC((const char *)&ui->digitsRings[2], &overB);
        }
    ...
    unk10 = &*(StageUI_10 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(StageUI, unk10));
    ...
    if (gSpecialStageTargetRings > 999) {
        ...
        for (i = 0; i < (s32)(sizeof(unk10->unk0) / sizeof((unk10->unk0)[0])); i++) {
            remainder0 = ({((10) != 0) ? ((s32)(remainder) / (s32)(10)) : 0;});

            unk10->unk0[2 - i] = ((remainder - ((remainder0 << 3) + (remainder0 << 1))) + 32);
    ...
    *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(StageUI, ringCount)) = (gSpecialStageTargetRings);;

    if (sb >= 15 && sb < 35) {
        overB.unkC = ({((20) != 0) ? ((s32)((sb - 15) << 6) / (s32)(20)) : 0;}) - 52;
    } else if (sb >= 35) {
        overB.unkC = 12;
    } else {
        overB.unkC = -52;
...
void sub_8054068(void)
{
    ...
    gfx = &gUiGraphics[0];
    sp00.tiles = gfx->tiles + 124 * 32;
    sp00.palette = gfx->palette;
    sp00.vramC = ((void *)&VRAM[0x10000] + 0x78A0);
    sp00.tilesSize = 6 * 32;
    sp00.paletteSize = 32;
    sp00.unk28 = 6;
    sp00.unk2A = 9;
    ...
    sp00.tiles = gfx->tiles + 32 * 32;
    sp00.palette = gfx->palette;
    sp00.vramC = ((void *)&VRAM[0x10000] + 0x75E0);
    sp00.tilesSize = 22 * 32;
    sp00.paletteSize = 32;
    sp00.unk28 = 6;
    sp00.unk2A = 13;
    ...
    sp00.uiGfxID = 46;
    sp00.unk2B = 3;
    sp00.tiles = gUiGraphics[46].tiles;
    sp00.palette = gUiGraphics[46].palette;
    sp00.tilesSize = (8 * 4) * 32;
    sp00.paletteSize = 32;
    sp00.unk28 = 10;
    sp00.vramC = ((void *)&VRAM[0x10000] + 0x7BE0);
    sp00.unk2A = 13;
    sp00.unk0.unk4 = gUiGraphics[46].unk8;
    sp00.unk0.unk8 = gUiGraphics[46].unkC;
    sp00.unk0.unk9 = gUiGraphics[46].unk10;
    sp00.unk0.unkA = gUiGraphics[46].unk14;
    sp00.unk0.unkB = gUiGraphics[46].unk18;
    sub_80528AC(&sp00);
}
...
bool8 sub_805423C(StrcUi_805423C *param0)
{
    ...
    if (param0->unkA & 0x1) {
        gBldRegs.bldCnt = ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3) | (1 << 4) | (1 << 5)) | ((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11) | (1 << 12) | (1 << 13));
        gBldRegs.bldAlpha = 16;
    } else if (param0->unkA & 0x10) {
        gBldRegs.bldCnt = (1 << 13) | ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3) | (1 << 4) | (1 << 5));
        gBldRegs.bldAlpha = 0;
    } else if ((u8)param0->unkA == 0) {
        gBldRegs.bldCnt = (1 << 0) | (1 << 1) | (1 << 2) | (1 << 3);
        gBldRegs.bldAlpha = 0;
    ...
    if (param0->unk2 != 0) {
        gWinRegs[1] = (((0) << 16) | (320));
        gWinRegs[3] = (((0) << 16) | (240));
        gWinRegs[4] |= (((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11)) | (1 << 12) | (1 << 13));
    ...
    if (param0->unk0 != 0) {
        ...
        if (param0->unk6 >= ((s32)((32)*256))) {
            param0->unk6 = ((s32)((32)*256));
            return 1;
        }
