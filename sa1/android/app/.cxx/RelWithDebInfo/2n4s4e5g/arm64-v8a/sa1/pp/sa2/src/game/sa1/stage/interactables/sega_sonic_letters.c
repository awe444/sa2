# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/sega_sonic_letters.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/sega_sonic_letters.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/sega_sonic_letters.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/sega_sonic_letters.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/sega_sonic_letters.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/sega_sonic_letters.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/sega_sonic_letters.c" 2
...
__attribute__((aligned(8))) const u16 gUnknown_086CED90[] = { 500, 0x190, 0x12C };
...
void Task_SegaSonicLetter(void)
{
    ...
    letter = (void *)((gCurTask)->data);
    s = &letter->s;
    me = letter->base.me;

    worldX = ((letter->base.meX)*8 + (letter->base.regionX)*256);
    worldY = ((me->y)*8 + (letter->base.regionY)*256);

    s->x = worldX - gCamera.x;
    s->y = worldY - gCamera.y;

    if ((((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
        { me->x = letter->base.meX; };
    ...
    r1 = ({((arr[letter->duration]) != 0) ? ((s32)(gStageTime - letter->delay) % (s32)(arr[letter->duration])) : 0;});
    ...
    if (r1 < 58) {
        ...
        i = 0;
        do {
            u32 res = Coll_Player_Entity_Intersection(s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)));
            if (res != 0) {
