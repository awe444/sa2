# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/small_fall_block.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/small_fall_block.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/small_fall_block.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/small_fall_block.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/small_fall_block.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/small_fall_block.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/small_fall_block.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/small_fall_block.c" 2
...
void CreateEntity_SmallFallBlock(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    block->base.me = me;
    block->base.meX = me->x;
# 52 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/small_fall_block.c"
    block->base.id = id;
...
void Task_SmallFallBlockMain(void)
{
    SmallFallBlock *block = (void *)((gCurTask)->data);
    Sprite *s = &block->s;
    ...
    if ((res & 0x00000008) && (gPlayer.stoodObj == s)) {
    ...
    if (((gPlayer.moveState & 0x00000008) && (gPlayer.stoodObj == s))
        || ((gNumSingleplayerCharacters == 2)
            && ((gPartner.moveState & 0x00000008) && (gPartner.stoodObj == s)))) {
...
void Task_SmallFallBlock2(void)
{
    ...
    s->x = worldX - gCamera.x;
    s->y = worldY - gCamera.y + ((int)((block->qUnk44) >> 8));
    block->unk3C++;
    ...
    do {
        ...
        if ((p->moveState & 0x00000008) && (p->stoodObj == s)) {
            if (block->unk3C > 32) {
                ...
                p->qWorldY += ((s32)((1)*256)) + block->qUnk4A;
            }
        }

        if (block->unk3C < 32) {
            Coll_Player_PlatformCrumbling(s, worldX, worldY + ((int)((block->qUnk44) >> 8)), p);
        }
...
void TaskDestructor_SmallFallBlock(struct Task *t)
{
    SmallFallBlock *block = (void *)((t)->data);
