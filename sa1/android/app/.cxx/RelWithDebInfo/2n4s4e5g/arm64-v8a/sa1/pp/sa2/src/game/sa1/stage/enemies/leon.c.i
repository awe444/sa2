# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/leon.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/leon.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/leon.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/leon.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/leon.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/leon.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/leon.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/leon.c" 2
...
void CreateEntity_Leon(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    if ((((gCurrentLevel) >> 1) != 4) || ((&gLoadedSaveGame)->difficultyLevel == 0)) {
        ...
        leon->qUnk48 = -((s32)((0.625)*256));
        leon->qUnk44 = ((s32)((0)*256));
        leon->unk4C = 0;
        leon->unk4A = 0;
        ...
        s->graphics.dest = VramMalloc(((64 / 8) * (24 / 8)));
        s->oamFlags = ((18) << 6);
        s->graphics.size = 0;
        s->graphics.anim = 430;
        s->variant = 0;
...
void Task_LeonInit(void)
{
    ...
    worldX = ((leon->shared.base.meX)*8 + (leon->shared.base.regionX)*256);
    worldY = ((me->y)*8 + (leon->shared.base.regionY)*256);
    ...
    leon->unk4C += sa2__sub_801F07C(worldY + 3, worldX, 1, +8, &sp08, sa2__sub_801EE64);

    if (((int)((leon->qUnk44) >> 8)) <= me->d.sData[0] * 8) {
    ...
    } else if (((int)((leon->qUnk44) >> 8)) >= (me->d.sData[0] + me->d.uData[2]) * 8) {
        if (s->frameFlags & ((1) << (10))) {
            leon->qUnk48 = -((s32)((0.625)*256));
            leon->unk4A = 0;
            s->variant = 2;
        ...
        if (leon->unk4E == 0) {
            if ((((int)((gPlayer.qWorldY) >> 8)) <= worldY + 8) && (worldY - 32 <= ((int)((gPlayer.qWorldY) >> 8)))) {
                if (s->frameFlags & ((1) << (10))) {
                    if (((int)((gPlayer.qWorldX) >> 8)) >= worldX && (worldX + 80 >= ((int)((gPlayer.qWorldX) >> 8)))) {
                        leon->unk4E = 60;
                        leon->unk4A = 0;
                        s->variant = 1;
...
void Task_806ED3C(void)
{
    ...
    worldX = worldX2 + ((int)((leon->qUnk44) >> 8));
