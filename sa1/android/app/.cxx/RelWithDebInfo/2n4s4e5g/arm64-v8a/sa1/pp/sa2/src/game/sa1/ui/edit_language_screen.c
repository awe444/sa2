# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/edit_language_screen.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/edit_language_screen.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/edit_language_screen.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/edit_language_screen.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/edit_language_screen.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/edit_language_screen.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/edit_language_screen.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/edit_language_screen.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/edit_language_screen.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/edit_language_screen.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/tilemaps.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/edit_language_screen.c" 2
...
extern const AnimId gUnknown_0868B6D4[6][2];
extern const AnimId gUnknown_0868B6EC[][3][2];
extern const u8 gUnknown_0868B704[6][2];
extern const u8 gUnknown_0868B710[2][3][2];
extern const u8 gUnknown_0868B71C[6];
extern const u8 gUnknown_0868B722[2][3];
extern const CoordELS gUnknown_0868B728[6][2];
extern const CoordELS gUnknown_0868B734[][3][2];
...
void CreateEditLanguageScreen(u8 param0)
{
    ...
    screen->unk28D = (&gLoadedSaveGame)->language;
    screen->spr250.graphics.dest = ((void*)0);
    ...
    for (; i < 6 + 3; i++) {
        s = &screen->sprites[i];
        s->graphics.dest = VramMalloc(gUnknown_0868B722[screen->unk28C][i - 6]);
        s->graphics.anim = gUnknown_0868B6EC[screen->unk28C][i - 6][(screen->unk28D != 0) ? 1 : 0];
        s->variant = gUnknown_0868B710[screen->unk28C][i - 6][(screen->unk28D != 0) ? 1 : 0];
        s->x = gUnknown_0868B734[screen->unk28C * 3][i - 6][0];
        s->y = gUnknown_0868B734[screen->unk28C * 3][i - 6][1];
        s->graphics.size = 0;
        s->animCursor = 0;
        s->qAnimDelay = ((s32)((0)*256));
        s->prevVariant = -1;
...
void Task_EditLanguageScreenInit(void)
{
    EditLanguageScreen *screen = (void *)((gCurTask)->data);
    ...
    inputMask = (screen->unk28C != 0) ? (0x0001 | 0x0008) : 0x0001;
    ...
    if (gPressedKeys & inputMask) {
        ...
        if (screen->unk28D > 0) {
            ...
            (&gLoadedSaveGame)->uiLanguage = 0;
        }

        (&gLoadedSaveGame)->language = screen->unk28D;

        if (screen->unk28D > 1) {
            Sprite *s = &screen->spr250;
            s->x = (320 / 2);
            s->y = (240 / 2);
            s->graphics.dest = VramMalloc(((208 / 8) * (40 / 8)));
            s->oamFlags = ((0) << 6);
            s->graphics.size = 0;
            s->graphics.anim = 879;
    ...
    } else if ((gPressedKeys & 0x0002) && (screen->unk28C == 0)) {
        m4aSongNumStart(107);
...
void TaskDestructor_EditLanguageScreen(struct Task *t)
{
    EditLanguageScreen *screen = (void *)((t)->data);
    Sprite *s;
    u8 i;

    for (i = 0; i < (s32)(sizeof(screen->sprites) / sizeof((screen->sprites)[0])); i++) {
