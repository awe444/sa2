# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/water_bridge_splash.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/water_bridge_splash.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/water_bridge_splash.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/malloc_vram.h" 1
# 24 "/home/awaszczak/git/sa2/sa1/../include/malloc_vram.h"
void *VramMalloc(u32);
void VramResetHeapState(void);
void VramFree(void *);
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/water_bridge_splash.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/water_bridge_splash.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/water_bridge_splash.c" 2
...
void CreateEntity_WaterBridgeSplash(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    WaterBridgeSplash *splash = (void *)((t)->data);
    Sprite *s;
    s32 worldX, worldY;
    ...
    s = &splash->s;
    s->graphics.dest = VramMalloc(((56 / 8) * (56 / 8)));
    s->graphics.size = 0;
    s->graphics.anim = 473;
    s->variant = 0;
    s->prevVariant = -1;
...
void Task_WaterBridgeSplash(void)
{
    WaterBridgeSplash *splash = (void *)((gCurTask)->data);
    Sprite *s = &splash->s;

    if (((splash->worldX) > gCamera.x + (320 + (256 / 2)) || (splash->worldX) < gCamera.x - (256 / 2) || (splash->worldY) > gCamera.y + ((240) + ((256) / 2)) || (splash->worldY) < gCamera.y - (256 / 2))) {
        { splash->me->x = splash->meX; };
