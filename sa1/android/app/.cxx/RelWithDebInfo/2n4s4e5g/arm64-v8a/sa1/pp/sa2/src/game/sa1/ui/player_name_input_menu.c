# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/player_name_input_menu.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/player_name_input_menu.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/player_name_input_menu.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/player_name_input_menu.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/player_name_input_menu.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/player_name_input_menu.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/player_name_input_menu.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/stage/ui_rendering.h" 1
# 10 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/stage/ui_rendering.h"
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/player_name_input_menu.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/player_name_input_menu.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/player_name_input_menu.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/menus/mp_mode_select.h" 1
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/player_name_input_menu.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/player_name_input_menu.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/player_name_input_menu.c" 2
...
{
    PlayerNameMenu *menu = (void *)((gCurTask)->data);
    ++menu->unkFC;
}


void CreatePlayerNameInputMenu(void)
{
    Strc_80528AC sp4;
    struct Task *t;
    s32 temp_r3;
    ...
    sub_80535FC();
    t = TaskCreate(sub_8058830, sizeof(PlayerNameMenu), 0x2000U, 0U, ((void*)0));
    *(s16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(PlayerNameMenu, unk24)) = 0;
    *(s16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(PlayerNameMenu, unk28)) = 0;
    *(s16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(PlayerNameMenu, unk2C)) = 0;
    *(s16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(PlayerNameMenu, unk30)) = 0;
    *(s16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(PlayerNameMenu, unk54)) = 0;
    *(s16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(PlayerNameMenu, unkFC)) = 0;

    unk0 = &*(Strc_8052C84 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(PlayerNameMenu, unk0));
    unk0->unkA = 0x1E;
    unk0->unkC = 0x1E;
    unk0->byteCount = 1;
    unk0->unk8 = 0;
    ...
    strc18 = &*(StrcUi_805423C *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(PlayerNameMenu, strc18));
    strc18->unk0 = 0;
    strc18->unk2 = 1;
    strc18->unk4 = 2;
    strc18->unk6 = 0;
    ...
    for (i = 0; i < (s32)(sizeof((&gLoadedSaveGame)->playerName) / sizeof(((&gLoadedSaveGame)->playerName)[0])); i++) {
        temp_r3_2 = &(&gLoadedSaveGame)->playerName[i];
        if (((&gLoadedSaveGame)->playerName[i] >= 0x20) && (&gLoadedSaveGame)->playerName[i] <= 0x89U) {
            *(s16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[i][0])) = (gUnknown_08688492[*temp_r3_2 - 0x20] + 0x1001);
            *(s16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[i][1])) = (gUnknown_08688492[*temp_r3_2 - 0x20] + 0x1002);
            *(s16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(PlayerNameMenu, unkE0[i][0])) = (gUnknown_08688492[*temp_r3_2 - 0x20] + 0x1015);
            *(s16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(PlayerNameMenu, unkE0[i][1])) = (gUnknown_08688492[*temp_r3_2 - 0x20] + 0x1016);
        } else {
    ...
    var_r8_2 = 5;
    while ((var_r8_2 >= 0) && ((&gLoadedSaveGame)->playerName[var_r8_2] == 0x20)) {
        var_r8_2 -= 1;
    }
...
void sub_8058830()
{
    ...
    sp30 = &*(StrcUi_805423C *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, strc18));

    menu->unk2C++;
    if (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk2C)) > 0x20) {
        menu->unk2C = 0;
    }

    menu->unk30++;
    if (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk30)) > 0x2E) {
        menu->unk30 = 0;
    }

    menu->unkFC++;
    if (*(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk30)) < 60) {
        sub_805423C((StrcUi_805423C *)sp30);
    } else {
        *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk30)) = (60);;
    }

    if (gInput & 0x10) {
        *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk58)) = (*(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk58)) + 1);;
    } else {
        *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk58)) = (0);;
    }

    if (0x20 & gInput) {
        *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk5C)) = (*(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk5C)) + 1);;
    } else {
        *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk5C)) = (0);;
    }

    if (0x40 & gInput) {
        *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk64)) = (*(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk64)) + 1);;
    } else {
        *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk64)) = (0);;
    }

    if (0x80 & gInput) {
        *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk60)) = (*(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk60)) + 1);;
    } else {
        *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk60)) = (0);;
    }

    temp_sb = *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk24));
    temp_sl = *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk28));
    temp_r8 = *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk54));

    if ((0x0010 & gPressedKeys) || (*(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk58)) > 0xF)) {
        m4aSongNumStart(108);
        temp_r1_15 = *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk58));
        *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk58)) = (temp_r1_15 - 5);;
        *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk24)) = (*(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk24)) + 1);;

        if (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk24)) > 9) {
            *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk24)) = (0);;
        }

        pressedKeys |= 0x0010;
    } else if ((0x0020 & gPressedKeys) || (*(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk5C)) > 0xF)) {
        m4aSongNumStart(108);
        temp_r1_17 = *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk5C));
        *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk5C)) = (temp_r1_17 - 5);;

        *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk24)) = (*(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk24)) - 1);;

        if (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk24)) < 0) {
            *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk24)) = (9);;
        }

        pressedKeys |= 0x0020;
    }

    if ((0x0080 & gPressedKeys) || ((*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk60)) > 0xF))) {
        m4aSongNumStart(108);
        *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk60)) = *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk60)) - 5;

        *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk28)) = (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk28)) + 1);;
        if (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk28)) > 5) {
            *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk28)) = 5;

            *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk60)) = (*(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk60)) + 1);;

            if (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk54)) > 2) {
                *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk28)) = 0;
                *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk54)) = 0;
            }
        }

        pressedKeys |= 0x0080;
    } else if ((0x0040 & gPressedKeys) || (*(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk64)) > 0xF)) {
        m4aSongNumStart(108);

        *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk64)) = (*(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk64)) - 5);;

        *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk28)) = *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk28)) - 1;

        if (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk28)) < 0) {
            *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk28)) = (0);;

            *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk54)) = *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk54)) - 1;

            if (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk54)) < 0) {
                *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk28)) = (5);;
                *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk54)) = (2);;
            }
        }
    ...
    temp_r4_2 = &*(Strc_8052C84 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk0));
    temp_r0_3 = *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk2C));
    if (temp_r0_3 < 0x10) {
        temp_r4_2->unk0 = (s16)(((0x10 - temp_r0_3) * 6) + 0x100);
        temp_r4_2->unk2 = ((0x10 - *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk2C))) * 6) + 0x100;
    } else {
        temp_r4_2->unk0 = (((*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk2C)) - 15) * 6) + 0x100);
        temp_r4_2->unk2 = ((*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk2C)) - 0xF) * 6) + 0x100;
    }

    temp_r2 = (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk24)) * 0x10) + 0x20;
    temp_r4_2->unkA = temp_r2;
    temp_r4_2->unkA = (s16)(temp_r2 - (((u16)temp_r4_2->unk0 - 240) >> 7));
    temp_r4_2->unkC = (s16)(((*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk28)) * 0x10) + 0x28) - (((u16)temp_r4_2->unk2 - 0xF0) >> 7));
    temp_r4_2->unk4 = 0;
    temp_r4_2->unk6 = 2;
    ...
    if ((gPrevInput | pressedKeys) & 0xF9) {
        sp34 = gCurTask;
        gfx = &*(GraphicsData *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, gfx80));
        temp_r2_2 = (temp_sb << 2);
    ...
    temp_r6
        = ((u16)((0x70000 & (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk54)) + *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk28))))
                 * 20)
           + *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk24)))
        * 2;
    if ((gPressedKeys == 0) && (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)) < 6)) {
        gfx = &*(GraphicsData *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, gfx68));
        temp_r2_4 = (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk24)) * 4) + 10;
        temp_r2_5
            = (temp_r2_4
               + ((*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk28)) + *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk54))) << 7))
            & 0x7FF;
        gfx->src = &gUnknown_0868653C[(temp_r2_5 & 0x3FF)];
        gfx->dest = (void *)(&VRAM[0] + temp_r2_5 + ((0x1F00 & gBgCntRegs[1]) * 8));
        gfx->size = 4;
        gVramGraphicsCopyQueue[gVramGraphicsCopyQueueIndex] = gfx;
        gVramGraphicsCopyQueueIndex = (gVramGraphicsCopyQueueIndex + 1) & 0x1F;
        gfx = &*(GraphicsData *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, gfx74));
# 465 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/player_name_input_menu.c"
    }
    if (0x300 & gPressedKeys) {
        if (0x200 & gPressedKeys) {
            if (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)) != 0) {
                *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)) = (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)) - 1);;
            }
        } else {
            if (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)) < 5) {
                *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)) = (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)) + 1);;
            }
        }
    }

    if ((0x0001 & gPressedKeys) && !(0x0002 & gPressedKeys)) {
        switch (temp_r6) {
            case 0x126:
                if (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)) != 0) {
                    *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)) = *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)) - 1;
            ...
            case 0x12A:
                ...
                for (i = 0; i < 6; i++) {
                    if ((*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[i][0])) - ((s32)((16)*256))) != 0x10DB) {
                        var_r1_3 |= 1;
                    }
                }
                ...
                if (var_r1_3 != 0) {
                    sp30->unk6 = 0;
                    sp30->unk4 = 1;
                    *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkFC)) = 0;
                    gCurTask->main = Task_80595DC;
                }
                break;
            default:
                if (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)) < 6) {
                    *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)) = *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)) + 1;
                    *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[temp_r2_6 + 0][0])) = temp_r6 + 0x2001;
                    *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[temp_r2_6 + 0][1])) = temp_r6 + 0x2002;
                    *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[temp_r2_6 + 2][0])) = temp_r6 + 0x2015;
                    *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[temp_r2_6 + 2][2])) = temp_r6 + 0x2016;
                }
                break;
        }
        m4aSongNumStart(106);
    ...
    if ((0x0008 & gPressedKeys) || ((0x0001 & gPressedKeys) && (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)) == 6))) {
        temp_r6_2 = 7 & *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk54));
        if (temp_r6_2 < 2) {
            *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk54)) = 2U;
            *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk24)) = 9;
            *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk28)) = 5;
        } else {
            *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk24)) = 9;
            *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk28)) = (s16)(7 - temp_r6_2);
        }
    }

    if (((0x0001 | 0x0002) & gPressedKeys) == 0x0002) {
        if (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)) > 0) {
            *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)) = *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)) - 1;
            for (i = *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)); i < 5; i++) {
                *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[i + 0][0]))
                    = *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[i + 1][0]));
                *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[i + 0][1]))
                    = *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[i + 1][1]));
                *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[i + 2][0]))
                    = *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[i + 3][0]));
                *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[i + 2][1]))
                    = *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[i + 3][1]));
            }

            *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[i + 0][0])) = 0x20DB;
            *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[i + 0][1])) = 0x20DC;
            *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[i + 2][0])) = 0x20EF;
            *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[i + 2][1])) = 0x20F0;
            m4aSongNumStart(107);
        }
    }
    UiGfxStackInit();
    temp_r0_9 = *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk30));
    if (temp_r0_9 <= 0x16) {
        var_r0_5 = 0x17 - temp_r0_9;
    } else {
        var_r0_5 = *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk30)) - 0x17;
    }
    ...
    for (i = 0; i < 16; i++) {
        temp_r5 = i * 2;
        sp48 = temp_r5;
        temp_r4_4 = ({((0x20) != 0) ? ((s32)(var_r7_2 * ((gUiGraphics[28].palette[i] & 0x7C00) >> 10)) / (s32)(0x20)) : 0;});
        temp_r5_2 = ({((0x20) != 0) ? ((s32)(var_r7_2 * ((gUiGraphics[28].palette[i] & 0x3E0) >> 5)) / (s32)(0x20)) : 0;});
        *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk34[i]))
            = (s16)((temp_r4_4 << 10) + (temp_r5_2 << 5) + ({((0x20) != 0) ? ((s32)(var_r7_2 * (0x1F & gUiGraphics[28].palette[i])) / (s32)(0x20)) : 0;}));
    }

    subroutine_arg0.uiGfxID = 0x25;
    subroutine_arg0.unk2B = 1;
    subroutine_arg0.palette = &*(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk34));
    ...
    if (((s16)*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)) <= 5)
        && ((((u16)(((0x70000
                      & ((*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk54)) + *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk28)))
                         << 0x10))
                     >> 0x10)
                    * 0x14)
              + *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk24)))
             << 0x11)
            != 0x012A0000)) {
        temp_r4_5 = &*(GameOverB *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk0));
        (&*(Strc_8052C84 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk0)))->unkA
            = (s16)((*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkF8)) * 0x10) + 0x78);

        if (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk2C)) > 0x10) {
            var_r1_4 = 16 - *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk2C));
        } else {
            var_r1_4 = *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk2C)) - 16;
        }
        (&*(Strc_80528AC *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk0)))->layoutSize = (s16)(0xD - (var_r1_4 >> 2));
        sub_805321C(&gUnknown_0868856C[0], temp_r4_5);
    }

    gfx = &*(GraphicsData *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, gfx98));
    gfx->src = &*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[0][0]));
    temp_r1_41 = (((*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk54)) - 2) << 7) + 0x1E) & 0x7FF;
    gfx->dest = (void *)((uintptr_t)gfx->dest + VRAM + ((0x1F00 & gBgCntRegs[1]) * 8));
    gfx->size = 0x18;
    gVramGraphicsCopyQueue[gVramGraphicsCopyQueueIndex] = gfx;
    gVramGraphicsCopyQueueIndex = (gVramGraphicsCopyQueueIndex + 1) & 0x1F;
    gfx = &*(GraphicsData *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, gfxA4));
    gfx->src = &*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkE0[0][0]));
    temp_r1_42 = (((*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk54)) - 2) << 7) + 0x5E) & 0x7FF;
    gfx->dest = (void *)(&VRAM[0] + temp_r1_42 + ((0x1F00 & gBgCntRegs[1]) * 8));
    gfx->size = sizeof(menu->unkE0);
    gVramGraphicsCopyQueue[gVramGraphicsCopyQueueIndex] = gfx;
    gVramGraphicsCopyQueueIndex = (gVramGraphicsCopyQueueIndex + 1) & 0x1F;

    if (temp_r8 != *(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk54))) {
        gfx = &*(GraphicsData *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, gfxB0));
        temp_r6_3 = (temp_r8 + 6) << 7;
        gfx->src = &gUnknown_08685D3C[15 + (temp_r6_3 & 0x7FF)];
        temp_r4_6 = ((temp_r8 - 2) << 7);
        temp_r1_44 = (temp_r4_6 + 0x1E) & 0x7FF;
        gfx->dest = (void *)(temp_r1_44 + &VRAM[0] + ((0x1F00 & gBgCntRegs[1]) * 8));
        gfx->size = 0x18;
        gVramGraphicsCopyQueue[gVramGraphicsCopyQueueIndex] = gfx;
        gVramGraphicsCopyQueueIndex = (gVramGraphicsCopyQueueIndex + 1) & 0x1F;
        gfx = &*(GraphicsData *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, gfxBC));
        if (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk28)) == 0) {
            var_r0_6 = temp_r4_6;
        } else {
            var_r0_6 = temp_r6_3;
    ...
    gBgScrollRegs[1][1] = ((*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unk54)) * 0x10) - 0x30) & 0x1FF;
}
...
void Task_80595DC(void)
{
    ...
    if (*(s16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(PlayerNameMenu, unkFC)) > 60) {
        for (i = 0; i < 6; i++) {
            temp_r5 = (*(s16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(PlayerNameMenu, unkC8[i][2])) - ((s32)((32)*256)) - 1);
            j = ((temp_r5 / 40u) * 10) + ((temp_r5 % 40u) / 2);

            if ((&gLoadedSaveGame)->playerName[i] != gUnknown_08688444[j]) {
                var_r7 = 1;
                (&gLoadedSaveGame)->playerName[i] = gUnknown_08688444[j];
            }
        }

        if (var_r7 != 0) {
            (&gLoadedSaveGame)->unk4 = (s32)gFrameCount;
            {
