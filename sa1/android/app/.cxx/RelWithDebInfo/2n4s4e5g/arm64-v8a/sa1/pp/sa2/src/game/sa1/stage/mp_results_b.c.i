# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results_b.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results_b.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results_b.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results_b.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results_b.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results_b.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results_b.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results_b.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results_b.c" 2
...
extern void LinkCommunicationError(void);
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results_b.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results_b.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results_b.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results_b.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/text.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results_b.c" 2
...
void sub_8018AE0()
{
    ...
    gBgCntRegs[0] = 0x1E03;
    gBgCntRegs[1] = 0x1F06;
    strc = (void *)((TaskCreate(Task_8018ECC, sizeof(MPResultsB), 0x2000U, 0U, ((void*)0)))->data);
    bg = &strc->bg;
    strc->unk234 = 0;
    strc->unk236 = 0;
    strc->unk238 = 0;
    ...
    bg = &strc->bg2;
    bg->graphics.dest = (void *)(&VRAM[0] + 0x4000);
    bg->graphics.anim = 0;
    bg->layoutVram = (void *)(&VRAM[0] + 0xF800);
    bg->unk18 = 0;
    bg->unk1A = 0;
    bg->tilemapId = 82;
    bg->unk1E = 0;
...
void Task_8018ECC(void)
{
    ...
    MPResultsB *strc = (void *)((gCurTask)->data);
    ...
    strc->unk23A = (strc->unk236 * ((int)(((gSineTable[(strc->unk238) + 256])) >> 6))) >> 8;
    strc->unk23C = (strc->unk236 * ((int)(((gSineTable[(strc->unk238)])) >> 6))) >> 8;
    ...
    strc->unk230 += 0x80;
    if (strc->unk230 > ((s32)((136)*256))) {
        strc->unk230 -= ((s32)((136)*256));
    }

    s = &strc->s;
    var_r4_2 = ((int)((-strc->unk230) >> 8));
    while (var_r4_2 < 320) {
        s->x = (s16)var_r4_2;
        var_r4_2 += 136;
        DisplaySprite(s);
...
{
    Sprite *s;
    u8 *vram = (u8 *)&VRAM[0x10000];

    MPResultsB *strc = (void *)((gCurTask)->data);

    strc->unk246 = 1 & ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id;
    strc->unk247 = 0;
    s = &strc->s;
    s->x = 0;
    s->y = 25;
...
void Task_80196FC(void)
{
    ...
    if (strc->unk247 == 0) {
        if (0x0010 & gRepeatedKeys) {
            if (strc->unk246 == 0) {
                m4aSongNumStart(0x6CU);
            }
            strc->unk246 = spC;
        } else if (0x0020 & gRepeatedKeys) {
            if (strc->unk246 == 1) {
                m4aSongNumStart(0x6CU);
            }
            strc->unk246 = 0;
...
block_18:
    for (var_r6 = 0; var_r6 < 4; var_r6++) {
        if (!(((gMultiplayerConnections) >> (var_r6)) & 1)) {
            break;
        }
        var_sl = 0xE0;
...
# 715 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_results_b.c"
    temp_r1_4 = gHBlankCopySize * 0x10;
    for (var_r6 = 0x0; var_r6 <= 0x80; var_r6 += 0x10) {
        DmaSet(3, gBgOffsetsHBlankPrimary, &((u8 *)gBgOffsetsHBlankPrimary)[temp_r1_4], (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | (((gHBlankCopySize << 4))/(32/8))));
        temp_r1_4 += gHBlankCopySize * var_r6;
    }


    strc->unk238 = (strc->unk238 + 1) & 0x3FF;
    temp_r2_2 = (((strc->unk236 * ((int)(((gSineTable[(strc->unk238) + 256])) >> 6)))) << 8) >> 16;
    temp_r1_3 = (((strc->unk236 * ((int)(((gSineTable[(strc->unk238)])) >> 6)))) << 8) >> 16;
    ...
    if ((!((0x0020 | 0x0010) & gInput) && (0x0001 & gPressedKeys)
    ...
    if (temp_r1_4 > ((s32)((164)*256))) {
        strc->unk230 -= ((s32)((164)*256));
    }

    var_r5 = ((int)((-strc->unk230) >> 8));
    temp_r0_3 = var_r5;
    temp_r6 = &strc->s2;
    while (var_r5 < 320) {
