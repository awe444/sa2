# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collect_ring_effect.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collect_ring_effect.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collect_ring_effect.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collect_ring_effect.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collect_ring_effect.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collect_ring_effect.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collect_ring_effect.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collect_ring_effect.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collect_ring_effect.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collect_ring_effect.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collect_ring_effect.c" 2
...
void CreateCollectRingEffect(s16 x, s16 y)
{
    if (gActiveCollectRingEffectCount < 8) {
        struct Task *t = TaskCreate(Task_CollectRingEffect, sizeof(RingEffect), 0x2000, 0, ((void*)0));
        RingEffect *re = (void *)((t)->data);
        Sprite *s = &re->s;
...
void Task_CollectRingEffect(void)
{
    RingEffect *re = (void *)((gCurTask)->data);
    Sprite *s = &re->s;
