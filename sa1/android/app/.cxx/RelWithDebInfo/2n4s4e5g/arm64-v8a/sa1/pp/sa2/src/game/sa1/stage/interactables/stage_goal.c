# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/stage_goal.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/stage_goal.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/stage_goal.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/stage_goal.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/stage_goal.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/stage_goal.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/stage_goal.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/stage_goal.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/stage_goal.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/stage_goal.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/stage_goal.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/stage_goal.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/stage_goal.c" 2
...
void Task_StageGoal(void)
{
    ...
    goal = (void *)((gCurTask)->data);
    s = &goal->shared.s;
    me = goal->shared.base.me;

    worldX = ((goal->shared.base.meX)*8 + (goal->shared.base.regionX)*256);
    worldY = ((me->y)*8 + (goal->shared.base.regionY)*256);
    ...
    if (gGameMode == 3 || gGameMode == 5) {
        ...
        if (((int)((gPlayer.qWorldX) >> 8)) > worldX) {


            if ((gCurrentLevel != ((3)*(2)) + (1)) || ((int)((gPlayer.qWorldY) >> 8)) <= worldY - (240 / 2)) {

                if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
                    if ((gCurrentLevel == ((5)*(2)) + (0)) && (((int)((gPlayer.qWorldY) >> 8)) < worldY)) {
                        goto _0801F3D2;
                    } else {
                        goto _0801F3C4;
                    }
                    ...
                    if ((gCurrentLevel != ((5)*(2)) + (0))
                        || (((((int)((gPlayer.qWorldX) >> 8))) + (&gPlayer.spriteInfoBody->s.hitboxes[0].b)->left) > worldX)
                        || ((((((int)((gPlayer.qWorldX) >> 8))) + (&gPlayer.spriteInfoBody->s.hitboxes[0].b)->left) + ((&gPlayer.spriteInfoBody->s.hitboxes[0].b)->right - (&gPlayer.spriteInfoBody->s.hitboxes[0].b)->left)) < worldX)
                        || (((((int)((gPlayer.qWorldY) >> 8))) + (&gPlayer.spriteInfoBody->s.hitboxes[0].b)->top) > worldY)
                        || ((((((int)((gPlayer.qWorldY) >> 8))) + (&gPlayer.spriteInfoBody->s.hitboxes[0].b)->top) + ((&gPlayer.spriteInfoBody->s.hitboxes[0].b)->bottom - (&gPlayer.spriteInfoBody->s.hitboxes[0].b)->top)) < worldY)) {
                    _0801F3C4:
                        if ((gCurrentLevel == ((3)*(2)) + (1)) || (gCurrentLevel == ((5)*(2)) + (0))) {
        ...
        _0801F3D2:
            ...
            if (gMultiplayerPlayerTasks[i] != ((void*)0)) {
                for (i = 0; i < 4 && gMultiplayerPlayerTasks[i] != ((void*)0); i++) {
                    ...
                    if (i != ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) {
                        ...
                        r3 = (gMultiplayerConnections & (0x10 << ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id)) >> (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id + 4);
            ...
            if (sp08) {
                if (gMultiplayerRanks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] != -1) {
    ...
    } else if (((int)((gPlayer.qWorldX) >> 8)) > worldX) {


        if ((gCurrentLevel == ((3)*(2)) + (1) && (((int)((gPlayer.qWorldY) >> 8)) > worldY - (240 / 2)))
            || ((((!(((gGameMode == 0) || (gGameMode == 1)))) && (gCurrentLevel == ((5)*(2)) + (0) && ((int)((gPlayer.qWorldY) >> 8)) < worldY))
                 || (((gGameMode == 0) || (gGameMode == 1))
                     && ((gCurrentLevel == ((5)*(2)) + (0))
                         && ((((((int)((gPlayer.qWorldX) >> 8))) + (&gPlayer.spriteInfoBody->s.hitboxes[0].b)->left) <= worldX)
                             && ((((((int)((gPlayer.qWorldX) >> 8))) + (&gPlayer.spriteInfoBody->s.hitboxes[0].b)->left) + ((&gPlayer.spriteInfoBody->s.hitboxes[0].b)->right - (&gPlayer.spriteInfoBody->s.hitboxes[0].b)->left)) >= worldX)
                             && (((((int)((gPlayer.qWorldY) >> 8))) + (&gPlayer.spriteInfoBody->s.hitboxes[0].b)->top) <= worldY)
                             && ((((((int)((gPlayer.qWorldY) >> 8))) + (&gPlayer.spriteInfoBody->s.hitboxes[0].b)->top) + ((&gPlayer.spriteInfoBody->s.hitboxes[0].b)->bottom - (&gPlayer.spriteInfoBody->s.hitboxes[0].b)->top)) >= worldY))))))
            || !((gCurrentLevel == ((3)*(2)) + (1)) || (gCurrentLevel == ((5)*(2)) + (0)))) {
            if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
                if (gMultiplayerRanks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] != -1) {
                    goto _30C;
                }
...
void Task_StageGoal2(void)
{
    StageGoal *goal = (void *)((gCurTask)->data);
    Sprite *s = &goal->shared.s;
    ...
    if (((gGameMode == 0) || (gGameMode == 1))) {
        ...
        if (gCurrentLevel != ((5)*(2)) + (0)) {
            ...
            if (gPlayer.qSpeedGround > ((s32)(((4.5))*256)))
                gPlayer.qSpeedGround = ((s32)(((4.5))*256));
        ...
        if ((gCurrentLevel != ((5)*(2)) + (0)) && (goal->unk3C > 30) && (goal->unk3E == 0)) {
            goal->unk3E = 1;
            TaskCreate(Task_ShowResults, 0, 0x2000, 0, ((void*)0));
        }

        gMultiplayerRanks[0] = 0;

        if (goal->unk3C++ > 120) {
            if ((gPlayer.charState == 28) || (gCurrentLevel == ((5)*(2)) + (0))) {
                TaskDestroy(gCurTask);
        ...
        MultiplayerPlayer *mpp = (void *)((gMultiplayerPlayerTasks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id])->data);
        gPlayer.itemEffect &= ~(0x40);
        gPlayer.timerConfusion = count;

        for (i = 0; i < 4 && gMultiplayerPlayerTasks[i]; i++) {
            MultiplayerPlayer *mppLoop = (void *)((gMultiplayerPlayerTasks[i])->data);
        ...
        CreateMultiplayerFinishResult(((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id, count);
        mpp->unk5C |= 0x1;
...
void Task_StageGoal3(void)
{
    ...
    if (me->d.sData[0] != 0) {
        if ((!(((gGameMode == 0) || (gGameMode == 1)))) && ((worldX + 32) <= ((int)((gPlayer.qWorldX) >> 8)))) {
            s->variant = 2;
        }
...
void Task_StageGoal4(void)
{
    ...
    sioId = ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id;
    sp04 = 0;
    goal = (void *)((gCurTask)->data);
    s = &goal->shared.s;
    me = goal->shared.base.me;
    ...
    if (gGameMode == 3 || gGameMode == 5) {
        ...
        for (i = 0; i < 4 && gMultiplayerPlayerTasks[i] && i != sioId; i++) {
            mpp = (void *)((gMultiplayerPlayerTasks[i])->data);
    ...
    if (me->d.sData[0] != 0) {
        if (worldX + 32 <= ((int)((gPlayer.qWorldX) >> 8))) {
            s->variant = 2;
        }
    ...
    if (gPlayer.qSpeedAirX > ((s32)((0)*256))) {
        MultiplayerPlayer *mpp;
        s32 zero;
        gPlayer.heldInput = 0x0010;

        if (worldX + r4 < ((int)((gPlayer.qWorldX) >> 8))) {
            gPlayer.qWorldX = ((s32)((worldX + r4)*256));
            ...
            gPlayer.sa2__unk61 = zero;
            gPlayer.sa2__unk62 = gPlayer.sa2__unk61;
            ...
            if (sp04 >= (i - 1) || gGameMode == 3 || gGameMode == 5) {
                u32 j;
                for (j = 0; j < 4 && gMultiplayerPlayerTasks[j]; j++) {
                    ...
                    if (!(mpp->unk5C & 0x1) && (gGameMode != 3) && (gGameMode != 5)) {
...
void Task_ShowResults(void)
{
    if (!(gPlayer.moveState & 0x00000002) && gPlayer.qSpeedGround >= ((s32)((2.25)*256))) {
        sa2__sub_8021BE0(&gPlayer);
        gPlayer.charState = 28;
        gPlayer.moveState |= 0x00800000;
        TaskDestroy(gCurTask);
        return;
    }
