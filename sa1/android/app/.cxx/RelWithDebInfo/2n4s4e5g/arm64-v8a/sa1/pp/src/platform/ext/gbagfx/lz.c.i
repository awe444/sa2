# 1 "/home/awaszczak/git/sa2/sa1/src/platform/ext/gbagfx/lz.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/src/platform/ext/gbagfx/lz.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/src/platform/ext/gbagfx/lz.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/src/platform/ext/gbagfx/lz.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/include/platform/ext/gbagfx/global.h" 1
# 6 "/home/awaszczak/git/sa2/sa1/src/platform/ext/gbagfx/lz.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/src/platform/ext/gbagfx/lz.c" 2
  ...
  for (int i = 0; i < 8; i++) {
   if (flags & 0x80) {
    ...
    if (destPos + blockSize > destSize) {
     ...
     fprintf((&__sF[2]), "Destination buffer overflow.\n");
    }
...
fail:
 do { fprintf((&__sF[2]), "Fatal error while decompressing LZ file.\n"); exit(1); } while (0);
}
...
fail:
 do { fprintf((&__sF[2]), "Fatal error while compressing LZ file.\n"); exit(1); } while (0);
}
