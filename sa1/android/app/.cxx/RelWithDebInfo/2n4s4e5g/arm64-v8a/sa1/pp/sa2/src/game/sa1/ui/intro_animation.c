# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/intro_animation.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/intro_animation.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/intro_animation.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/intro_animation.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/intro_animation.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/intro_animation.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/ui_graphics.h" 1
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/intro_animation.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/intro_animation.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/intro_animation.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/intro_animation.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/spot_light_beam_task.h" 1
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/intro_animation.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/intro_animation.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/intro_animation.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/intro_animation.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/intro_animation.c" 2
...
typedef struct Intro_54 {
    ...
    struct Task *taskC;
    struct Task *beamTasks[2];
    struct Task *tasks18[NUM_CHARACTERS];
    u8 filler28[0x24];
    s16 unk4C;
    u8 unk4E;
    u16 unk50;
...
const LocalTileInfo gUnknown_0868B28C[6] = {
    { 770, 0, &VRAM[0x10000] + 0x2840 },
    { 770, 1, &VRAM[0x10000] + 0x2B40 },
    { 770, 2, &VRAM[0x10000] + 0x2F40 },
    { 770, 3, &VRAM[0x10000] + 0x3240 },
    { 770, 4, &VRAM[0x10000] + 0x3440 },
    { 770, 5, &VRAM[0x10000] + 0x3740 },
};
const LocalTileInfo gUnknown_0868B2D4[6] = {
    { 771, 0, &VRAM[0x10000] + 0x6440 },
    { 771, 1, &VRAM[0x10000] + 0x6740 },
    { 771, 2, &VRAM[0x10000] + 0x6B40 },
    { 771, 3, &VRAM[0x10000] + 0x6D40 },
    { 771, 4, &VRAM[0x10000] + 0x7040 },
    { 771, 5, &VRAM[0x10000] + 0x7440 },
};
...
const u16 gUnknown_0868B3B8[2][2] = { { 722, 0 }, { 722, 1 } };

const u16 gUnknown_0868B3C0[2][2] = { { 722, 2 }, { 722, 3 } };

const u16 gUnknown_0868B3C8[2][2] = { { 722, 4 }, { 722, 5 } };

const u16 gUnknown_0868B3D0[2][2] = { { 722, 6 }, { 722, 7 } };
...
void CreateIntroAnimation(void)
{
    ...
    gBgScrollRegs[2][0] = 0;
    gBgScrollRegs[2][1] = 0;
    t = TaskCreate(Task_IntroChaosEmeraldUpdate, sizeof(IntroSprite), 0x2120U, 0U, ((void*)0));
    emerald = (void *)((t)->data);
    s = &emerald->s;
    emerald->unk30 = 0;
    qVal = -((s32)((36)*256));
    ...
    for (i = 0; i < 8; i++) {
        s32 chunkOffset;
        t2 = TaskCreate(Task_8065058, sizeof(IntroSprite), (i * 2) | 0x6800, 0U, ((void*)0));
        introSpr = (void *)((t2)->data);
        s = &introSpr->s;
        ...
        introSpr->qUnk40 = ((s32)((2.25)*256));
        chunkOffset = (i * (4 * 32));
        s->graphics.dest = (chunkOffset + &VRAM[0x10000] + (31 * 32));
        s->graphics.anim = 775;
        s->variant = 0;
        s->x = (320 / 2) + ({((650) != 0) ? ((s32)((gSineTable[(i << 6)])) / (s32)(650)) : 0;});
        s->y = -36;
        s->oamFlags = 0;
        s->graphics.size = 0;
        s->animCursor = 0;
    ...
    strc54->unk4E = 1;
    strc54->taskC = t;
    strc54->beamTasks[0] = ((void*)0);
    strc54->beamTasks[1] = ((void*)0);
    strc54->tasks18[CHARACTER_SONIC] = ((void*)0);
    strc54->tasks18[CHARACTER_TAILS] = ((void*)0);
    strc54->tasks18[CHARACTER_KNUCKLES] = ((void*)0);
    strc54->tasks18[CHARACTER_AMY] = ((void*)0);
    strc54->unk50 = 0;
    strc54->unk52 = 0;
...
void sub_8063E8C(u16 arg0)
{
    ...
    if (arg0 == 0) {
        for (i = 0; i < 8; i++) {
            t = TaskCreate(Task_806515C, sizeof(IntroSprite), (i * 2) | 0x6801, 0U, ((void*)0));
            introSpr = (void *)((t)->data);
            ...
            s = &introSpr->s;
            chunkOffset = (i * (4 * 32));
            s->graphics.dest = (&VRAM[0x10000] + 0xBE0 + chunkOffset);
            s->graphics.anim = 775;
            s->variant = 1;
            s->x = (({((650) != 0) ? ((s32)((gSineTable[(i << 6)])) / (s32)(650)) : 0;}) + 120);
            s->y = -36;
            s->oamFlags = 0x180;
            s->graphics.size = 0;
            s->animCursor = 0;
...
static inline u32 maskColor(u32 c) { return ({((40) != 0) ? ((s32)(c) / (s32)(40)) : 0;}) & 0x1F; }

static inline u32 maskRedColor(u32 c)
{
# 575 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/intro_animation.c"
    return (c % 32u);
...
void Task_80640C8()
{
    ...
    Intro_54 *strc54 = (void *)((gCurTask)->data);
    IntroSprite *introSpr = (void *)((strc54->taskC)->data);

    introSpr->unk30 = (u16)strc54->unk4C;
    if ((0x0001 | 0x0002 | 0x0008) & gPressedKeys) {
    ...
    if (strc54->unk4C > 0x97) {
        ...
        for (colorIndex = 0; colorIndex < 32; colorIndex++) {
            ...
            g = ((color & ((0) | ((31) << 5) | ((0) << 10))) >> 5);
            b = ((color & ((0) | ((0) << 5) | ((31) << 10))) >> 10);

            {
                r = maskColor(r * var_r7);
                g = maskColor(g * var_r7);
                b = maskColor(b * var_r7);
                gBgPalette[colorIndex] = ((r) | ((g) << 5) | ((b) << 10));
            }
            gFlags |= 0x1;
        }
    }
...
void sub_8064244()
{
    ...
    if (++strc54->unk4C >= 506) {
        ...
        gBgCntRegs[0] = 0x1D86;
        gBgCntRegs[1] = 0x1883;
        t = TaskCreate(Task_RenderSonic, sizeof(Intro_C8), 0x2210U, 0U, ((void*)0));
        strc54->tasks18[CHARACTER_SONIC] = t;
        temp_r0_7 = (void *)((t)->data);
        temp_r0_7->unkB4 = 0;

        for (i = 0; i < 2; i++) {
            s = &temp_r0_7->sprites[i];
            if (i != 0) {
                s->graphics.dest = &VRAM[0x10000] + 0x4000;
            } else {
                s->graphics.dest = &VRAM[0x10000] + 0x1440;
            }
        ...
        for (i = 0; i < 6; i++) {
            IntroSprite *introSpr;
            t = TaskCreate(Task_806562C, sizeof(IntroSprite), 0x6820U, 0U, ((void*)0));
            introSpr = (void *)((t)->data);
            s = &introSpr->s;
            introSpr->unk30 = 0;
            introSpr->unk32 = 0;
        ...
        if ((s32)strc54->unk4C > 0xE0) {
            ...
            beam = (void *)((strc54->beamTasks[0])->data);
            beam->unk0 = (s16)((0x18 - ({((25) != 0) ? ((s32)(temp_r4) % (s32)(25)) : 0;})) * 6);
            if (((u32)temp_r4 <= 0x3FU) && (({((6) != 0) ? ((s32)(temp_r4) % (s32)(6)) : 0;}) == 0)) {
                beam->unkB++;
            }
            beam = (void *)((strc54->beamTasks[1])->data);
            beam->unk0 = (s16)(((0x18 - ({((0x19) != 0) ? ((s32)(temp_r4) % (s32)(0x19)) : 0;})) * 6) + 0x370);
            if (((u32)temp_r4 <= 0x3FU) && (({((6) != 0) ? ((s32)(temp_r4) % (s32)(6)) : 0;}) == 0)) {
                beam->unkB++;
            }
        } else {
...
void sub_80645E4()
{
    ...
    strcC8 = (void *)((strc54->tasks18[CHARACTER_SONIC])->data);
    temp_r4 = strc54->unk4C;
    strcC8->unkB4 = temp_r4;
    strc54->unk50 -= 0x20;
    strc54->unk52 += 0x20;

    gBgScrollRegs[0][0] = ((int)((strc54->unk50) >> 8));
    gBgScrollRegs[0][1] = ((int)((strc54->unk52) >> 8));
    ...
    if (++strc54->unk4C >= 414) {
        ...
        t = TaskCreate(Task_IntroRenderTails, sizeof(Intro_C8), 0x2280U, 0U, ((void*)0));
        ...
        for (i = 0; i < 3; i++) {
            s = &strcC8->sprites[i];
            if (i == 2) {
                s->graphics.dest = &VRAM[0x10000] + 0x3280;
            } else if (i == 1) {
                s->graphics.dest = &VRAM[0x10000] + 0x1980;
            } else {
                s->graphics.dest = &VRAM[0x10000] + 0x400;
            }
            s->graphics.anim = 0x301;
            s->variant = 1;
            s->x = 48;
        ...
        for (i = 0; i < 6; i++) {
            IntroSprite *introSpr;
            t = TaskCreate(sub_80656A4, sizeof(IntroSprite), 0x6820U, 0U, ((void*)0));
            introSpr = (void *)((t)->data);
            s = &introSpr->s;
            introSpr->unk30 = 0;
            introSpr->unk32 = 0;
...
void sub_80648D4()
{
    ...
    strcC8 = (void *)((strc54->tasks18[CHARACTER_TAILS])->data);
    temp_r4 = strc54->unk4C;
    strcC8->unkB4 = temp_r4;
    strc54->unk50 += 0x20;
    strc54->unk52 -= 0x20;
    ...
    if (++strc54->unk4C >= 414) {
        ...
        t = TaskCreate(Task_IntroRenderKnuckles, sizeof(Intro_C8), 0x2230U, 0U, ((void*)0));
        ...
        for (i = 0; i < 3; i++) {
            ...
            if (i == 2) {
                ...
                s->graphics.dest = &VRAM[0x10000] + 0x80;
            }
            s->graphics.anim = 0x301;
            s->variant = 2;
            s->x = 48;
        ...
        for (i = 0; i < 9; i++) {
            IntroSprite *introSpr;
            t = TaskCreate(sub_806571C, sizeof(IntroSprite), 0x6820U, 0U, ((void*)0));
            introSpr = (void *)((t)->data);
            s = &introSpr->s;
            introSpr->unk30 = 0;
            introSpr->unk32 = 0;
...
void sub_8064BB4()
{
    ...
    strcC8 = (void *)((strc54->tasks18[CHARACTER_KNUCKLES])->data);
    temp_r4 = strc54->unk4C;
    strcC8->unkB4 = temp_r4;
    strc54->unk50 += 0x00;
    strc54->unk52 += 0x20;
    ...
    if (++strc54->unk4C >= 414) {
        ...
        t = TaskCreate(Task_IntroRenderAmy, sizeof(Intro_C8), 0x2230U, 0U, ((void*)0));
        ...
        for (i = 0; i < 2; i++) {
            s = &strcC8->sprites[i];
            if (i != 0) {
                s->graphics.dest = &VRAM[0x10000] + 0x6400;
            } else {
                s->graphics.dest = &VRAM[0x10000] + 0x1440;
            }
            s->graphics.anim = 0x301;
        ...
        for (i = 0; i < (sizeof(gUnknown_0868B388) / sizeof((gUnknown_0868B388)[0])); i++) {
            IntroSprite *introSpr;
            t = TaskCreate(sub_8065794, sizeof(IntroSprite), 0x6820U, 0U, ((void*)0));
            introSpr = (void *)((t)->data);
            s = &introSpr->s;
            introSpr->unk30 = 0;
            introSpr->unk32 = 0;
...
void sub_8064E84()
{
    ...
    strcC8 = (void *)((strc54->tasks18[CHARACTER_AMY])->data);
    temp_r4 = strc54->unk4C;
    strcC8->unkB4 = temp_r4;
    strc54->unk50 -= 0x20;
    strc54->unk52 -= 0x20;
...
void Task_8065058(void)
{
    ...
    IntroSprite *introSpr = (void *)((gCurTask)->data);
    Sprite *s = &introSpr->s;
    ...
    if (introSpr->qUnk3C > ((s32)((180)*256))) {
        introSpr->qUnk3C = ((s32)((180)*256));
    }
    ...
    introSpr->qUnk38 -= ({((24) != 0) ? ((s32)((gSineTable[((0x100 - (introSpr->unk34 * 6)) % 256u)])) / (s32)(24)) : 0;});
    s->x = ({((650) != 0) ? ((s32)((gSineTable[(((introSpr->unk34 * 12) + (unk30 << 5)) & 0x3FF)])) / (s32)(650)) : 0;}) + 120;
    s->y = ((int)((introSpr->qUnk38) >> 8));
...
void Task_806515C(void)
{
    ...
    if (unk30 == 0xE9) {
        introSpr->qUnk40 = ((s32)((1.25)*256));
    }

    if (introSpr->qUnk3C > ((s32)((212)*256))) {
        introSpr->qUnk3C = ((s32)((212)*256));
    }
    ...
    introSpr->qUnk38 -= ({((24) != 0) ? ((s32)((gSineTable[((introSpr->unk34 * 6))])) / (s32)(24)) : 0;});
    s->x = 120 - ({((650) != 0) ? ((s32)((gSineTable[(((introSpr->unk34 * 12) + (unk30 << 5)) & 0x3FF)])) / (s32)(650)) : 0;});
    s->y = ((int)((introSpr->qUnk38) >> 8));
...
void Task_RenderSonic(void)
{
    Intro_C8 *strcC8 = (void *)((gCurTask)->data);
...
void Task_IntroRenderTails(void)
{
    ...
    for (var_r6 = 0; var_r6 < count; var_r6++) {
        ...
        if (temp_r0 == 0x1E) {
            if (var_r6 == 2) {
                s->graphics.dest = (void *)&VRAM[0x10000] + 0x3280;
            } else if (var_r6 == 1) {
                s->graphics.dest = (void *)&VRAM[0x10000] + 0x1980;
            } else {
                s->graphics.dest = (void *)&VRAM[0x10000] + 0x80;
            }
            s->prevVariant = 0xFF;
...
void Task_IntroChaosEmeraldUpdate()
{
    ...
    if (unk30 < 90) {
        introSpr->qUnk40 -= ((s32)((6. / 256.)*256));
        if (introSpr->qUnk40 < ((s32)((0)*256))) {
            introSpr->qUnk40 = ((s32)((0)*256));
        }
    }
