# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c" 2
...
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c" 2
...
# 19 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c" 2
...
# 21 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 22 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/text.h" 1
# 23 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/tilemaps.h" 1
# 24 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c" 2
# 37 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c"
...
static const u16 sTilemapIds[2] = { 78, 79 };
static const u16 sResultSongs[2] = { 301, 302 };
# 92 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c"
void CreateMultipackOutcomeScreen(u8 outcome)
{
    u8 i;
    u8 count;
    ...
    t = TaskCreate(Task_MultipackOutcomeScreen, sizeof(struct CommunicationOutcomeScreen), 0x2000, 0, ((void*)0));
    outcomeScreen = (void *)((t)->data);
    ...
    s->x = 93;
    s->y = 85;
    s->graphics.dest = (void *)&VRAM[0x10000] + 0x300;
    s->oamFlags = ((15) << 6);
    s->graphics.size = 0;
...
# 161 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c"
    ...
    s->frameFlags = ((2) << (12));
    UpdateSpriteAnimation(s);
# 194 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c"
    s = &outcomeScreen->spr70;
    s->x = 0;
    s->y = 21;
    s->graphics.dest = (void *)&VRAM[0x10000] + 0x180;
    s->oamFlags = ((16) << 6);
    s->graphics.size = 0;
    s->graphics.anim = 860;
    s->variant = 0;
    ...
    s->frameFlags = ((2) << (12));
    UpdateSpriteAnimation(s);
# 226 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c"
    background = &outcomeScreen->unk0;
    background->graphics.dest = (void *)(((u8*)&VRAM[0]) + (0x800 * (0)));
    background->graphics.anim = 0;
    background->layoutVram = (void *)(((u8*)&VRAM[0]) + (0x800 * (8)));
    background->unk18 = 0;
    background->unk1A = 0;
    background->unk1E = 0;
    background->unk20 = 0;
...
{
    Sprite *s;
    struct CommunicationOutcomeScreen *outcomeScreen = (void *)((gCurTask)->data);
    u32 i;
...
# 298 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c"
    } else {

        DisplaySprite(s);
# 312 "/home/awaszczak/git/sa2/sa1/../src/game/shared/multiplayer/communication_outcome.c"
    }
...

    {
        ...
        if (outcomeScreen->unk1FC > ((s32)((unk203)*256))) {
            outcomeScreen->unk1FC -= ((s32)((unk203)*256));
        }
        s = &outcomeScreen->spr40;
        UpdateSpriteAnimation(s);

        v0 = ((int)((outcomeScreen->unk1FC) >> 8)) - unk203;
        while (251 - v0 > -11) {
            s->x = 251 - v0;
            DisplaySprite(s);
            v0 += unk203;
