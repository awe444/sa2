# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/magnetic_ring.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/magnetic_ring.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/magnetic_ring.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/magnetic_ring.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/magnetic_ring.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/magnetic_ring.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/magnetic_ring.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/magnetic_ring.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/magnetic_ring.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/magnetic_ring.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/magnetic_ring.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/magnetic_ring.c" 2
...
{
    struct Task *t = TaskCreate(Task_MagneticRing, sizeof(StageRing), 0x2000, 0, ((void*)0));
    StageRing *ring = (void *)((t)->data);
    Sprite *s;
    ...
    s->animSpeed = 0x10;
    s->palId = 0;
    s->frameFlags = (((1) << (19)) | ((1) << (18)) | ((2) << (12)));
}

void Task_MagneticRing(void)
{
    StageRing *ring = (void *)((gCurTask)->data);
    Player *p = &gPlayer;
    s32 ringToPlayerX = ((int)((p->qWorldX) >> 8)) - (u16)ring->s.x;
    s32 ringToPlayerY = ((int)((p->qWorldY) >> 8)) - (u16)ring->s.y;

    s16 sinVal = sa2__sub_8004418(ringToPlayerY, ringToPlayerX);
    s16 ringX, ringY;

    ring->speed += ((s32)((0.25)*256));

    ring->s.x += (ring->speed * (gSineTable[(sinVal) + 256])) >> 22;
    ring->s.y += (ring->speed * (gSineTable[(sinVal)])) >> 22;

    ringY = ring->s.y;
    ringX = ring->s.x;

    if (((((ringX - 8) <= (((((int)((gPlayer.qWorldX) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].b.left) && (ringX + 8) >= (((((int)((gPlayer.qWorldX) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].b.left)) || ((ringX - 8) >= (((((int)((gPlayer.qWorldX) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].b.left) && (((((((int)((gPlayer.qWorldX) >> 8))))) + (gPlayerBodyPSI.s.hitboxes[0].b).left) + ((gPlayerBodyPSI.s.hitboxes[0].b).right - (gPlayerBodyPSI.s.hitboxes[0].b).left)) >= (ringX - 8))) && ((((ringY - (8 * 2)) <= (((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].b.top) && ringY >= (((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].b.top)) || ((ringY - (8 * 2)) >= (((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].b.top) && ((((((int)((gPlayer.qWorldY) >> 8)))) + gPlayerBodyPSI.s.hitboxes[0].b.top) + ((gPlayerBodyPSI.s.hitboxes[0].b).bottom - (gPlayerBodyPSI.s.hitboxes[0].b).top)) >= (ringY - (8 * 2))))))) {
