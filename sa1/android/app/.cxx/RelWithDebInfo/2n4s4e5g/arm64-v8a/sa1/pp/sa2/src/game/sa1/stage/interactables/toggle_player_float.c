# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_float.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_float.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_float.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_float.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_float.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_float.c" 2




# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_float.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_float.c" 2
...
void Task_PlayerFloatMain(void)
{
    ...
    toggle = (void *)((gCurTask)->data);
    me = toggle->me;
    meX = toggle->meX;
    regionX = *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(TogglePlayerFloat, regionX));
    regionY = *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(TogglePlayerFloat, regionY));
    unk3D = *(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(TogglePlayerFloat, unk3D));
    unk3E = *(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(TogglePlayerFloat, unk3E));
    ...
    if ((((u16)(x + (256 / 2)) > 320 + 256) || (y + (256 / 2) < 0) || (y > 240 + (256 / 2)))) {
        ...
        i = 0;
        do {
            if (*(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(TogglePlayerFloat, unk3A[i])) == 1) {
    ...
    i = 0;
    do {
        if ((*(((i) != 0) ? &gPartner : &gPlayer)).charState != 37) {
            if (unk3D != 0) {
        ...
        if ((x <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (x + me->d.uData[2] * 8 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (y <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))
            && (y + me->d.uData[3] * 8 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) {
            if (unk3D == 0) {
                if ((*(((i) != 0) ? &gPartner : &gPlayer)).charState != 37) {
                    if (me->d.sData[0] == 0) {
                        unk3D = 1;
            ...
            if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY -= ((s32)(((104. / 256.))*256));
            }

            if ((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY < -((s32)(((2.25))*256))) {
                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = -((s32)(((2.25))*256));
            }
            (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000002;

            if (me->d.sData[0] == 0) {
                Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 37;
            } else {
                Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));
            ...
            if ((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_AMY) {
                (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x02000000;
            }

            res = sa2__sub_801F100(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)), ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)), (*(((i) != 0) ? &gPartner : &gPlayer)).layer, 8, sa2__sub_801EC3C);
            ...
            *(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(TogglePlayerFloat, unk3A[i])) = (*(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(TogglePlayerFloat, unk38[i])));;
        } else {
            *(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(TogglePlayerFloat, unk38[i])) = (0);;
            *(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(TogglePlayerFloat, unk3A[i])) = (*(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(TogglePlayerFloat, unk38[i])));;
        }

    } while (++i < gNumSingleplayerCharacters);

    *(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(TogglePlayerFloat, unk3D)) = (unk3D);;
    *(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(TogglePlayerFloat, unk3E)) = (unk3E);;
}

void CreateEntity_Toggle_PlayerFloat(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    struct Task *t = TaskCreate(Task_PlayerFloatMain, sizeof(TogglePlayerFloat), 0x2000, 0, ((void*)0));

    *(u16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(TogglePlayerFloat, regionX)) = (regionX);;
    *(u16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(TogglePlayerFloat, regionY)) = (regionY);;




    *(u8 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(TogglePlayerFloat, unk38[0])) = (0);;
    *(u8 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(TogglePlayerFloat, unk38[1])) = (0);;
    *(u8 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(TogglePlayerFloat, unk3A[0])) = (0);;
    *(u8 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(TogglePlayerFloat, unk3A[1])) = (0);;

    *(MapEntity * *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(TogglePlayerFloat, me)) = (me);;
    *(u8 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(TogglePlayerFloat, unk3D)) = (0);;
    *(u8 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(TogglePlayerFloat, unk3E)) = (0);;
    *(u8 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(TogglePlayerFloat, meX)) = (me->x);;
