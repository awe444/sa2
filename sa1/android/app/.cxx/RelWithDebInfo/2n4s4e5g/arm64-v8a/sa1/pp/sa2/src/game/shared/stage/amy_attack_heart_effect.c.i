# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/amy_attack_heart_effect.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/amy_attack_heart_effect.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/amy_attack_heart_effect.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/amy_attack_heart_effect.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/amy_attack_heart_effect.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/amy_attack_heart_effect.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/amy_attack_heart_effect.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/amy_attack_heart_effect.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/amy_attack_heart_effect.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/amy_attack_heart_effect.c" 2
...

{
...

    {
        ...
        AmyAtkHearts *hearts = (void *)((t)->data);



        hearts->unk100 = gPlayer.charState;
        hearts->kind = gPlayer.charState - 87;
# 129 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/amy_attack_heart_effect.c"
        hearts->unk106 = 0;
        hearts->unk108 = 0;
        hearts->unk10A = 0;

        for (i = 0; i < (sizeof(hearts->params) / sizeof((hearts->params)[0])); i++) {
...
void Task_AmyAttackHeartEffect(void)
{
...

    {
...

        {
            ...
            for (i = 0; i < (sizeof(hearts->sprHearts) / sizeof((hearts->sprHearts)[0])); i++) {
                ...
                if (hearts->params[i].count != 0) {
                    ...
                    u16 camX, camY;
# 213 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/amy_attack_heart_effect.c"
                    s = &hearts->sprHearts[i];

                    x = ((s32)((hearts->params[i].x)*256));
                    y = ((s32)((hearts->params[i].y)*256));
...
{
    AmyAtkHearts *hearts = (void *)((gCurTask)->data);
    u8 i = 0;

    while (hearts->params[i].count != 0) {
        if (++i >= (sizeof(hearts->params) / sizeof((hearts->params)[0]))) {
            return;
        }
    }
    ...
    if (i < (sizeof(hearts->params) / sizeof((hearts->params)[0]))) {
        ...
        s->palId = 0;
        s->frameFlags = ((2) << (12));
# 287 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/amy_attack_heart_effect.c"
    }
}
