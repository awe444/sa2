# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/stage_results.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/stage_results.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/stage_results.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/stage_results.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/stage_results.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/stage_results.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/ui/collect_chaos_emeralds_msg.h" 1



void CreateGetAllChaosEmeraldsMessage(void);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/stage_results.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/stage_results.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/stage_results.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/stage_results.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/player.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/player.h"
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/stage_results.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/stage_results.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/stage_results.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/stage_results.c" 2


# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/stage_results.c" 2
...
extern __attribute__((aligned(4))) u8 gUnknown_08688404[11];
extern __attribute__((aligned(4))) u8 gUnknown_0868840F[11];
extern __attribute__((aligned(4))) u8 gUnknown_0868841C[12];
extern __attribute__((aligned(4))) u8 gUnknown_08688428[0x19];
...
void sub_8056FE4(VramPtrs *arg0)
{
    ...
    sp00.tilesSize = (8 * 2) * 32;
    sp00.paletteSize = 32;
    sp00.unk28 = 6;
    sp00.vramC = (void *)&VRAM[0] + 0x11000;
    sp00.unk2A = 13;
    ...
    sp00.vramC = (void *)arg0->vram0 + 0x600;
    sp00.unk2A = 0xD;
    ...
    sp00.uiGfxID = gSelectedCharacter + 11;
    sp00.unk2B = 2;
    sp00.tiles = gUiGraphics[sp00.uiGfxID].tiles;
    sp00.palette = gUiGraphics[sp00.uiGfxID].palette;
    sp00.tilesSize = (8 * 6) * 32;
    sp00.paletteSize = 12;
    sp00.unk28 = 12;
    sp00.vramC = (void *)arg0->vram0;
    sp00.unk2A = 0xD;
    sp00.unk0.unk4 = gUiGraphics[sp00.uiGfxID].unk8;
    sp00.unk0.unk8 = (gUiGraphics[sp00.uiGfxID].unkC);
    sp00.unk0.unk9 = (gUiGraphics[sp00.uiGfxID].unk10);
    ...
    sp00.paletteSize = 32;
    sp00.unk28 = 0x6;
    sp00.vramC = (void *)arg0->vram4 + 0x240;
    sp00.unk2A = 0xD;
    sp00.unk0.unk4 = gUiGraphics[sp00.uiGfxID].unk8;
    sp00.unk0.unk8 = (gUiGraphics[sp00.uiGfxID].unkC);
    sp00.unk0.unk9 = (gUiGraphics[sp00.uiGfxID].unk10);
...
u32 CreateStageResults(u32 ringCount, u32 courseTime)
{
    ...
    (&gLoadedSaveGame)->score += ringCount2;
    gStageFlags |= 0x20;
    ...
    isInFinalStage = 0;
    if ((gSelectedCharacter == CHARACTER_SONIC) && (gCurrentLevel >= ((6)*(2)) + (0))
        && ((&gLoadedSaveGame)->chaosEmeralds == ((1 << (0)) | (1 << (1)) | (1 << (2)) | (1 << (3)) | (1 << (4)) | (1 << (5)) | (1 << (6)))) && ((&gLoadedSaveGame)->unlockedLevels[0] > 12)
        && ((&gLoadedSaveGame)->unlockedLevels[1] > 12) && ((&gLoadedSaveGame)->unlockedLevels[2] > 12) && ((&gLoadedSaveGame)->unlockedLevels[3] > 12)
        && (((&gLoadedSaveGame)->unlockedLevels[0] != 0xF) || (gMultiplayerCurrentLevel != ((6)*(2)) + (0)))) {
        isInFinalStage = 1;
    }

    sp1C = isInFinalStage;
    if (isInFinalStage == 0) {
        temp_r2 = (&gLoadedSaveGame)->unlockedLevels[gPlayer.character];
        var_r0 = gCurrentLevel + 1;

        if (var_r0 < temp_r2) {
            var_r0 = temp_r2;
        }
        (&gLoadedSaveGame)->unlockedLevels[gPlayer.character] = var_r0;
    }

    if (gCurrentLevel == ((5)*(2)) + (0)) {
        const s32 countDown = (int)(((3 * 60.) + 0) * 60);
    ...
    if (courseTime >= (int)(((6 * 60.) + 0) * 60)) {
        timeScore = 0;
    } else if (courseTime >= (int)(((5 * 60.) + 0) * 60)) {
        timeScore = 500;
    } else if (courseTime >= (int)(((4 * 60.) + 0) * 60)) {
        timeScore = 1000;
    } else if (courseTime >= (int)(((3 * 60.) + 0) * 60)) {
        timeScore = 2000;
    } else if (courseTime >= (int)(((2 * 60.) + 0) * 60)) {
        timeScore = 3000;
    } else if (courseTime >= (int)(((1 * 60.) + 30) * 60)) {
        timeScore = 4000;
    } else if (courseTime >= (int)(((1 * 60.) + 0) * 60)) {
        timeScore = 5000;
    } else if (courseTime >= (int)(((0 * 60.) + 50) * 60)) {
        timeScore = 10000;
    } else if (courseTime >= (int)(((0 * 60.) + 30) * 60)) {
        timeScore = 50000;
    } else {
        timeScore = 80000;
    }
    ...
    if (ringScore > timeScore) {
        sp10 = ({((100) != 0) ? ((s32)(ringScore) / (s32)(100)) : 0;}) + 75;
    } else {
        sp10 = ({((100) != 0) ? ((s32)(timeScore) / (s32)(100)) : 0;}) + 75;
    }
    ...
    for (temp_r2_3 = 15; temp_r2_3 >= 0; temp_r2_3--) {
        temp_r0_11 = ({((10) != 0) ? ((s32)(ringScore) / (s32)(10)) : 0;});
    ...
    for (var_r5_6 = 15; var_r5_6 >= 0; var_r5_6--) {
        temp_r0_11 = ({((10) != 0) ? ((s32)(timeScore) / (s32)(10)) : 0;});
...
void Task_8057888(void)
{
    ...
    arg0 = (void *)((gCurTask)->data);

    task14 = (void *)((arg0->task14)->data);
    task18 = (void *)((arg0->task18)->data);
    task10 = (void *)((arg0->task10)->data);
    taskC = (void *)((arg0->taskC)->data);
    ...
    if (arg0->unk24 < 135) {
        for (i = 0; i < 12; i++) {
            if (i != 0) {
                sa2__sub_80047A0(0U, 0x100, ({((12) != 0) ? ((s32)(i << 8) / (s32)(12)) : 0;}), i + 20);
            } else {
                sa2__sub_80047A0(0U, 0x100, 1, 20);
            }
        }
    }
    ...
    if (arg0->unk24 >= 0xB5) {
        if (arg0->unk2C == 0) {
            ...
            arg0->unk2C -= 100;
            { s32 divResA, divResB; s32 oldScore = gLevelScore; gLevelScore += 100; divResA = ({((50000) != 0) ? ((s32)(gLevelScore) / (s32)(50000)) : 0;}); divResB = ({((50000) != 0) ? ((s32)(oldScore) / (s32)(50000)) : 0;}); if ((divResA != divResB) && (gGameMode == 0)) { u16 lives = divResA - divResB; lives += gNumLives;; ({ if ((lives) > 255) (lives) = 255; gNumLives = (lives); }); if (0) gMusicManagerState.unk3 = 0x10 | 0x0; } };
        ...
        if (arg0->unk2C == 0 && arg0->unk30 == 0) {
            ...
            if (gSelectedCharacter == 0) {
                if ((arg0->unk36 == 0) && (gCurrentLevel >= ((6)*(2)) + (0))) {
                    arg0->unk34 = 0x87;
                } else {
                    arg0->unk34 = 0x2D;
                }
            ...
            m4aSongNumStart(141);
        } else if (({((4) != 0) ? ((s32)(gStageTime) % (s32)(4)) : 0;}) == 0) {
...
blk_else : {
    ...
    if (((u32)((int)((p->qWorldX) >> 8)) - cam->x) + 0x40 > (320 + 128)) {
        gPlayer.qSpeedAirX = 0;
        gPlayer.qSpeedGround = 0;

        if (gNumSingleplayerCharacters == 2) {
            if ((((int)((gPartner.qWorldX) >> 8)) - cam->x) > (320 + 64)) {
                gPartner.moveState |= 0x00400000;
    ...
    if (arg0->unk28 + 320 < (u32)arg0->unk24) {
        if (!((((gCurrentLevel) == ((6)*(2)) + (0))) || (((gCurrentLevel) == ((6)*(2)) + (1))))) {
...
void Task_8057B74(void)
{
    s16 temp_r0;
    s16 temp_r1;
    StrcStgResults_34 *arg0 = (void *)((gCurTask)->data);
    ...
    if ((u32)(arg0->unk30 + 320) < arg0->unk1C) {
...
# 606 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/stage_results.c"
    ...
    if ((u32)temp_r1 > (arg0->unk30 + 0xE6)) {
        arg0->unk0.qUnkA -= ((s32)((28. / 256.)*256));
        ...
        if (arg0->unk0.qUnkA < -0x1F) {
            ...
            arg0->unk1E = ({((8) != 0) ? ((s32)(arg0->unk1E + 1) % (s32)(8)) : 0;});
        }
        sub_80530CC((const char *)&arr[arg0->unk1E], &arg0->unk0);
    } else if (temp_r1 >= 50) {
        arg0->unk0.unkC = 0x2C;
        arg0->unk0.qUnkA -= ((s32)((2. / 256.)*256));
        ...
        if (arg0->unk0.qUnkA < 320) {
            arg0->unk0.unkE = 9 - (arg0->unk0.qUnkA >> 5);
            if (arg0->unk0.qUnkA < -0x1F) {
                arg0->unk0.qUnkA += ((s32)((32. / 256.)*256));
                arg0->unk1E = ({((8) != 0) ? ((s32)(arg0->unk1E + 1) % (s32)(8)) : 0;});
            }
            sub_80530CC((const char *)&arr[arg0->unk1E], &arg0->unk0);
        }
...
void Task_8057D30(void)
{
    ...
    if (arg0->unk1C > 0x85U) {
        for (var_r6 = 15; var_r6 >= 0; var_r6--) {
            temp_r0_3 = ({((10) != 0) ? ((s32)(var_r7) / (s32)(10)) : 0;});
    ...
    if (sp0 > 0x96) {
        ...
        s32 var_sb = (u8)({((2) != 0) ? ((s32)(sp0) / (s32)(2)) : 0;});
        if ((u32)var_sb > 16) {
            var_sb = 16;
        }
                ...
                do {
                    ...
                    if (var_r7_2 > 0xC) {
                        ...
                        if ((var_r6 < 11) || (arg0->unk20[var_r6] != 0x2B)) {
                            arg0->unk0.unkE = 1;
                            arg0->unk0.unkC = ({((0x23) != 0) ? ((s32)(0x100 - (var_r7_2 * 0x15)) / (s32)(0x23)) : 0;}) + 0x5E;
                            if (var_r7_2 == 0xC) {
            ...
            if (var_sl < var_sb) {
                do {
                    ...
                    if (var_r7_2 > 0xB) {
                        ...
                        if ((var_r6 < 11) || (arg0->unk20[var_r6] != 0x2B)) {
                            arg0->unk0.unkE = 1;
                            arg0->unk0.unkC = ({((0x23) != 0) ? ((s32)(0x100 - (var_r7_2 * 0x15)) / (s32)(0x23)) : 0;}) + 0x48;
...
void TaskDestructor_8058344(struct Task *t)
{
    StrcStgResults_38 *results = (void *)((t)->data);
