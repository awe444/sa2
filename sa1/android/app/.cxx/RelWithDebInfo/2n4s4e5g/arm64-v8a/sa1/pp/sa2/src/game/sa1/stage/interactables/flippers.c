# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flippers.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flippers.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flippers.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flippers.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flippers.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flippers.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flippers.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flippers.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flippers.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/flippers.c" 2
...
void CreateEntity_Flipper(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    if (me->d.sData[0] == 0) {
        s->frameFlags = ((2) << (12)) | ((1) << (10));
    } else {
        s->frameFlags = ((2) << (12)) | ((0) << (10));
    }
...
void Task_Flipper_Horizontal()
{
    ...
    flipper = (void *)((gCurTask)->data);

    s = &flipper->s;
    me = flipper->base.me;
    worldX = ((flipper->base.meX)*8 + (flipper->base.regionX)*256);
    worldY = ((me->y)*8 + (flipper->base.regionY)*256);
    ...
    do {
        if (s->frameFlags & ((1) << (10))) {
            px = worldX - ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8));
        } else {
            px = ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) - worldX;
        }
        pxHalf = (s32)(u16)(px >> 1);
        if (Coll_Player_Entity_Intersection(s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
            if (((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_KNUCKLES)
                && (((*(((i) != 0) ? &gPartner : &gPlayer)).charState == 70) || ((*(((i) != 0) ? &gPartner : &gPlayer)).charState == 71) || ((*(((i) != 0) ? &gPartner : &gPlayer)).charState == 72)
                ...
                if ((*(((i) != 0) ? &gPartner : &gPlayer)).charState != 73) {
                    ...
                    if (((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 8) && ((*(((i) != 0) ? &gPartner : &gPlayer)).stoodObj == s)) {
                        Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));

                        (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 5;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~8;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 4;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 2;

                        if (s->frameFlags & ((1) << (10))) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 1;
                        } else {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~1;
                        }
                    }
                ...
                if ((((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY >= 0) || (((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000008) && ((*(((i) != 0) ? &gPartner : &gPlayer)).stoodObj == s)))
                    && ((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY < ((s32)((worldY)*256)) + ((s32)((19)*256))) && ((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 2)) {
                    if ((gPressedKeys & gPlayerControls.jump) && (((flipper->unk41) >> (i)) & 1)) {
                        (flipper->unk41) &= ~(1 << (i));
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x8;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 2;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x100;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 4;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x10;
                        if (0x0020 & gInput) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000001;
                        } else if (0x0010 & gInput) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00000001;
                        }
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = 0xFFFFF840 - (px * 16);
                        if (s->frameFlags & ((1) << (10))) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = -(px * 32);
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = -(px * 32);
                        } else {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = +(px * 32);
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = +(px * 32);
                        }
                        ...
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= 0xFFDFFFFF;
                        ...
                        if ((s->frameFlags & ((1) << (10)))) {
                            if ((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY > ((s32)((worldY + (s16)pxHalf - 17)*256))) {
                                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((worldY + (s16)pxHalf - 17)*256)) + 1;
                                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = 0;
                                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = -((s32)((0.3125)*256));
                                (flipper->unk41) |= (1 << (i));
                                (*(((i) != 0) ? &gPartner : &gPlayer)).heldInput = 0;
                                (*(((i) != 0) ? &gPartner : &gPlayer)).frameInput = 0;
                                (*(((i) != 0) ? &gPartner : &gPlayer)).rotation = 0;
                                Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                                (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x200000;
                                (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 4;
                                { Player_HandleSpriteYOffsetChange(&(*(((i) != 0) ? &gPartner : &gPlayer)), 9); { (&(*(((i) != 0) ? &gPartner : &gPlayer)))->spriteOffsetX = 6; (&(*(((i) != 0) ? &gPartner : &gPlayer)))->spriteOffsetY = 9; } };
                                (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 5;
                            } else {
                                if ((((flipper->unk41) >> (i)) & 1)) {
                                    Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 2;
                                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x100;
                                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 4;
                    ...
                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY <= ((s32)((worldY)*256))) {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 2;
                    } else if ((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY < ((s32)((worldY)*256)) + ((s32)((24)*256))) {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((worldY)*256)) + ((s32)((24)*256));
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = 10;
            ...
            if ((((flipper->unk41) >> (i)) & 1)) {
                ...
                (*(((i) != 0) ? &gPartner : &gPlayer)).heldInput |= (gPlayerControls.jump | gPlayerControls.attack);
                if (s->frameFlags & ((1) << (10))) {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = -((s32)((1)*256));
                } else {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = +((s32)((1)*256));
                }
            }
...
void Task_Flipper_Horizontal_2(void)
{
    Flipper *flipper = (void *)((gCurTask)->data);
    Sprite *s = &flipper->s;
...
void CreateEntity_Flipper_Vertical(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    s->graphics.dest = VramMalloc(((40 / 8) * (48 / 8)));
    s->oamFlags = ((18) << 6);
    s->graphics.size = 0;
    s->graphics.anim = 478;
    s->variant = 2;
...
void Task_Flipper_Vertical(void)
{
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            if (((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000002) || (((flipper->unk41) >> (i)) & 1)) {
                if (Coll_Player_Platform(s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer))) & 0x00000008) {
                    (flipper->unk41) |= (1 << (i));
                ...
                if (((s32)((worldY)*256)) < (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) {
                    if (((s32)((worldX)*256)) > (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) {
                        if (Coll_Player_Entity_Intersection(s, worldX - 6, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000001;
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = -((s32)((10)*256));
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = -((s32)((10)*256));
                        ...
                        if (Coll_Player_Entity_Intersection(s, worldX + 7, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00000001;
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = +((s32)((10)*256));
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = +((s32)((10)*256));
