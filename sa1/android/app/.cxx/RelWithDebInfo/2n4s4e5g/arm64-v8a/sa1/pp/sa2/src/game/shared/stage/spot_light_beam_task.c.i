# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/spot_light_beam_task.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/spot_light_beam_task.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/spot_light_beam_task.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/spot_light_beam_task.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/spot_light_beam_task.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/spot_light_beam_task.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/spot_light_beam_task.c" 2
...
struct Task *CreateSpotlightBeamTask(void)
{
    ...
    SpotlightBeam *beam = (void *)((t)->data);
...

{
    ...
    SpotlightBeam *beam = (void *)((gCurTask)->data);
    ...
    if ((gSineTable[(temp_r5) + 256]) == 0) {
        return;
    }
    sp18 = 0x3FF;
    temp_r0_3 = beam->unk6 - ((int)((({((((int)(((gSineTable[(temp_r5) + 256])) >> 6))) != 0) ? ((s32)((((int)(((gSineTable[(temp_r5)])) >> 6)) << 8)) / (s32)(((int)(((gSineTable[(temp_r5) + 256])) >> 6)))) : 0;}) * beam->unk8) >> 8));
    sp10.unk0 = temp_r0_3;
    temp_r0_4 = temp_r0_3;
    if ((s32)temp_r0_4 <= 0) {
        sp10.unk0 = 0;
        if (temp_r5 > 0xFFU) {
            ...
            var_r0_2 = ({((((int)(((gSineTable[(temp_r1_2) + 256])) >> 6))) != 0) ? ((s32)((((int)(((gSineTable[(temp_r1_2)])) >> 6)) << 8)) / (s32)(((int)(((gSineTable[(temp_r1_2) + 256])) >> 6)))) : 0;});
            var_r1 = beam->unk6;
            goto block_16;
        }
        temp_r1_3 = (0x100 - temp_r5) & 0x3FF;
        sp10.unk2 = (s16)(beam->unk8 - ((int)((({((((int)(((gSineTable[(temp_r1_3) + 256])) >> 6))) != 0) ? ((s32)((((int)(((gSineTable[(temp_r1_3)])) >> 6)) << 8)) / (s32)(((int)(((gSineTable[(temp_r1_3) + 256])) >> 6)))) : 0;}) * beam->unk6) >> 8)));
    } else if ((s32)temp_r0_4 > (320 - 1)) {
        sp10.unk0 = 320;
        if (temp_r5 > 0xFFU) {
        ...
        var_r0_2 = ({(((s32)((u16)gSineTable[temp_r1_4 + 0x100] << 0x10) >> 0x16) != 0) ? ((s32)(((s32)((u16)gSineTable[temp_r1_4] << 0x10) >> 0x16) << 8) / (s32)((s32)((u16)gSineTable[temp_r1_4 + 0x100] << 0x10) >> 0x16)) : 0;});
        var_r1 = 320 - beam->unk6;
    block_16:
    ...
    sp8.unk2 = (u8)((u8)beam->unk6
                    - ((s32)((beam->unk8 - 240)
                             * (s16)({(((s32)((u16)gSineTable[temp_r5 + 0x100] << 0x10) >> 0x16) != 0) ? ((s32)(((s32)((u16)gSineTable[temp_r5] << 0x10) >> 0x16) << 8) / (s32)((s32)((u16)gSineTable[temp_r5 + 0x100] << 0x10) >> 0x16)) : 0;}))

                       >> 8));
    sp8.unk3 = 240;
    temp_r5_2 = (0x400 - ((u16)beam->unk0 - beam->unkB)) & 0x3FF;
    temp_r0_5 = ((s32)(beam->unk8
                       * (s16)({(((s32)((u16)gSineTable[temp_r5_2 + 0x100] << 0x10) >> 0x16) != 0) ? ((s32)(((s32)((u16)gSineTable[temp_r5_2] << 0x10) >> 0x16) << 8) / (s32)((s32)((u16)gSineTable[temp_r5_2 + 0x100] << 0x10) >> 0x16)) : 0;}))
    ...
    if ((s32)temp_r0_6 <= 0) {
        ...
        sp14.unk2 = (s16)((u16)beam->unk8
                          - ((s32)((s16)({(((s32)((u16)gSineTable[temp_r1_5 + 0x100] << 0x10) >> 0x16) != 0) ? ((s32)(((s32)((u16)gSineTable[temp_r1_5] << 0x10) >> 0x16) << 8) / (s32)((s32)((u16)gSineTable[temp_r1_5 + 0x100] << 0x10) >> 0x16)) : 0;})

                                   * beam->unk6)
                             >> 8));
    } else if ((s32)temp_r0_6 > (320 - 1)) {
        sp14.unk0 = 320;
        if (temp_r5_2 > 0xFFU) {
        ...
        sp14.unk2 = (s16)((u16)beam->unk8
                          - ((s32)((s16)({(((s32)((u16)gSineTable[temp_r1_6 + 0x100] << 0x10) >> 0x16) != 0) ? ((s32)(((s32)((u16)gSineTable[temp_r1_6] << 0x10) >> 0x16) << 8) / (s32)((s32)((u16)gSineTable[temp_r1_6 + 0x100] << 0x10) >> 0x16)) : 0;})
    ...
    if (beam->unk0 <= 0x1FFU) {
        ...
        if (sp10.unk2 > (240 - 1)) {
            if (1 & beam->bg) {
                gWinRegs[3] = (((sp8.unk5) << 16) | (240));
            } else {
                gWinRegs[2] = (((sp8.unk5) << 16) | (240));
            }
            sa2__sub_8006228(beam->bg, sp8.unk4, sp8.unk5, sp8.unk6, sp8.unk7, 0);
            return;
        }
        if (1 & beam->bg) {
            gWinRegs[3] = (((sp8.unk5) << 16) | (240));
    ...
    if (sp10.unk2 <= (240 - 1)) {
        if (sp14.unk2 > (240 - 1)) {
            if (beam->bg & 0x1) {
                gWinRegs[3] = (((sp8.unk1) << 16) | (240));
            } else {
                gWinRegs[2] = (((sp8.unk1) << 16) | (240));
            }

            sa2__sub_80064A8(beam->bg, sp8.unk0, sp8.unk1, sp8.unk2, (s32)sp8.unk3, 0);
        } else {
            if (beam->bg & 0x1) {
                gWinRegs[3] = (((sp8.unk1) << 16) | (240));
            } else {
...
void TaskDestructor_SpotlightBeam(struct Task *t) { gFlags &= ~0x4; }
