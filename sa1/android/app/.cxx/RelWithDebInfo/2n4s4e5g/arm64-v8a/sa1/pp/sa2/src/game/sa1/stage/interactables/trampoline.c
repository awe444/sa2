# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/trampoline.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/trampoline.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/trampoline.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/trampoline.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/trampoline.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/trampoline.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/trampoline.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/trampoline.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/trampoline.c" 2
...
void CreateEntity_Trampoline(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    Trampoline *trampoline = (void *)((t)->data);
    ...
    if ((((gCurrentLevel) >> 1) == 1) || (gCurrentLevel == (14 + 1))) {
        s->graphics.dest = VramMalloc(((48 / 8) * (40 / 8)));
        s->graphics.anim = 505;
    } else if ((((gCurrentLevel) >> 1) == 5) || (gCurrentLevel == (14 + 3))) {
        s->graphics.dest = VramMalloc(((48 / 8) * (40 / 8)));
        s->graphics.anim = 505;
    } else {
...
void Task_Trampoline(void)
{
    Trampoline *trampoline = (void *)((gCurTask)->data);
    Sprite *s = &trampoline->s;
    MapEntity *me = trampoline->base.me;
    CamCoord worldX, worldY;

    worldX = ((trampoline->base.meX)*8 + (trampoline->base.regionX)*256);
    worldY = ((me->y)*8 + (trampoline->base.regionY)*256);
...
bool32 sub_8074FB0(Sprite *s, s16 worldX, s16 worldY)
{
    ...
    do {
        ...
        if (res & 0x8) {
            ...
            if (p->qSpeedAirY < -((s32)((10.9921875)*256))) {
                p->qSpeedAirY = -((s32)((10.9921875)*256));
            }

            if (p->qSpeedAirY > -((s32)((3.75)*256))) {
                p->qSpeedAirY = -((s32)((3.75)*256));
            }
