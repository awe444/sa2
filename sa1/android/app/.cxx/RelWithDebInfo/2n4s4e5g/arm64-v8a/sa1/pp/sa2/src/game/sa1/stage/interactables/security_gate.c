# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/security_gate.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/security_gate.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/security_gate.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/security_gate.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/security_gate.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/security_gate.c" 2
...

{
    ...
    s->graphics.dest = VramMalloc(((16 / 8) * (48 / 8)));
    s->graphics.anim = 534;
    s->variant = 0;
    s->oamFlags = ((18) << 6);
    s->graphics.size = 0;
...
void Task_SecurityGateMain(void)
{
    SecurityGate *gate = (void *)((gCurTask)->data);
    ...
    if ((!(gPlayer.moveState & 0x00000080)) && ((worldX - gate->unk3E) <= ((int)((gPlayer.qWorldX) >> 8)))
        && ((worldX - gate->unk3E + me->d.uData[2] * 8) >= ((int)((gPlayer.qWorldX) >> 8))) && ((worldY) <= ((int)((gPlayer.qWorldY) >> 8)))
