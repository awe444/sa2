# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/course_select.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/course_select.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/course_select.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/course_select.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/course_select.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/course_select.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/course_select.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/course_select.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/course_select.c" 2
...
extern void LinkCommunicationError(void);
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/course_select.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/course_select.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/course_select.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/course_select.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/menus/time_attack.h" 1



void CreateTimeAttackMenu(void);
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/course_select.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/course_select.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/course_select.c" 2
...
const StaticTileInfo gUnknown_0868B10C[15] = {
    { &VRAM[0x10000] + 0x0020, 0x000002D4, 0x00000000 }, { &VRAM[0x10000] + 0x03E0, 0x000002D4, 0x00000001 },
    { &VRAM[0x10000] + 0x07A0, 0x000002D4, 0x00000002 }, { &VRAM[0x10000] + 0x0B60, 0x000002D4, 0x00000003 },
    { &VRAM[0x10000] + 0x0F20, 0x000002D4, 0x00000004 }, { &VRAM[0x10000] + 0x12E0, 0x000002D4, 0x00000005 },
    { &VRAM[0x10000] + 0x16A0, 0x000002D4, 0x00000006 }, { &VRAM[0x10000] + 0x1A60, 0x000002D4, 0x00000007 },
    { &VRAM[0x10000] + 0x1E20, 0x000002D4, 0x00000008 }, { &VRAM[0x10000] + 0x21E0, 0x000002D4, 0x00000009 },
    { &VRAM[0x10000] + 0x25A0, 0x000002D4, 0x0000000A }, { &VRAM[0x10000] + 0x2960, 0x000002D4, 0x0000000B },
    { &VRAM[0x10000] + 0x2D20, 0x000002D4, 0x0000000C }, { &VRAM[0x10000] + 0x30E0, 0x000002D4, 0x0000000D },
    { &VRAM[0x10000] + 0x34A0, 0x000002D4, 0x0000000E },
};

const StaticTileInfo gUnknown_0868B1C0[8] = {
    { &VRAM[0x10000] + 0x3860, 0x000002D5, 0 }, { &VRAM[0x10000] + 0x3CE0, 0x000002D6, 0 }, { &VRAM[0x10000] + 0x4160, 0x000002D7, 0 },
    { &VRAM[0x10000] + 0x45E0, 0x000002E6, 0 }, { &VRAM[0x10000] + 0x4A60, 0x000002E7, 0 }, { &VRAM[0x10000] + 0x4EE0, 0x000002E8, 0 },
    { &VRAM[0x10000] + 0x5360, 0x000002D9, 0 }, { &VRAM[0x10000] + 0x57E0, 0x000002D8, 0 },
};
...
void CreateCourseSelect(bool8 arg0)
{
    ...
    if (arg0 == 1) {
        ...
        if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
            ...
            unlockedLevelCount = (&gLoadedSaveGame)->unlockedLevels[gSelectedCharacter] + 2;
        }
        ...
        if (gSelectedCharacter == CHARACTER_SONIC) {
            ...
            } else if ((&gLoadedSaveGame)->unlockedLevels[0] == 0xD) {
    ...
    task1 = TaskCreate(Task_8062E18, sizeof(CourseSelect_54), 0x2030U, 0U, ((void*)0));
    strc54 = (void *)((task1)->data);
    strc54->unk48 = 0;
    strc54->unk4C = 0;
    strc54->unk4E = 0;
    strc54->unk4F = 0;
    ...
    task2 = TaskCreate(Task_8062A80, sizeof(CourseSelect_2DC), 0x2030U, 0U, ((void*)0));
    strc2DC = (void *)((task2)->data);
    strc2DC->unk2D0 = 0;
    strc2DC->unk2D4 = 0;
    strc2DC->unk2D6 = 0;
    strc2DC->unk2D7 = 0;
    ...
    for (; i < (s32)(sizeof(strc2DC->sprites) / sizeof((strc2DC->sprites)[0])); i++) {
        s = &strc2DC->sprites[i];
        s->graphics.dest = ((void*)0);
    }
    state->task10 = task2;

    task2 = TaskCreate(Task_8062C28, sizeof(CourseSelect_2DC), 0x2030U, 0U, ((void*)0));
    strc2DC_2 = (void *)((task2)->data);
    strc2DC_2->unk2D0 = 0;
    strc2DC_2->unk2D4 = 0;
    strc2DC_2->unk2D6 = 0;
    strc2DC_2->unk2D7 = 0;
    ...
    for (; i < (s32)(sizeof(strc2DC_2->sprites) / sizeof((strc2DC_2->sprites)[0])); i++) {
        s = &strc2DC_2->sprites[i];
        s->graphics.dest = ((void*)0);
    }
    state->task14 = task2;
...
void Task_CourseSelectInit()
{
    ...
    u8 var_r5 = 0;
    CourseSelectState *state = (void *)((gCurTask)->data);
    CourseSelect_2DC *unk2DC = (void *)((state->task10)->data);
    CourseSelect_2DC *unk2DC_2 = (void *)((state->task14)->data);
    CourseSelect_54 *strc54 = (void *)((state->task18)->data);
    ...
    state->unk50 += ({((10) != 0) ? ((s32)(((s16)state->unk52 - state->unk50) * 2) / (s32)(10)) : 0;});
    ...
    gFlags |= 4;
    gHBlankCopyTarget = (void *)&(*(reg_u16 *)(REG_BASE + 0x10));
    gHBlankCopySize = 4;
    ...
    for (var_r2 = 0; var_r5 < 240; var_r5++, var_r2) {
        var_r3 = 0;
        sp3C = var_r2 * 2;
        ++var_r2;
        for (; var_r3 < (0x40 - temp_r8) && (var_r5 < 240); var_r5++, var_r3++) {
            *var_r1++ = 0;
            *var_r1++ = (0 - var_r5) & 0x1FF;
        }

        var_r3 = ((((sp3C + var_r2) * 8) - var_r5) + 0x20);
        for (var_r2 = 0; (var_r2 < 0x18) && (var_r5 < 240); var_r5++, var_r2++) {
            *var_r1++ = 0;
            *var_r1++ = (s16)var_r3;
        }
    }

    if ((temp_r8 == 0x3F) || (0x0001 & gPressedKeys)) {
        gBgScrollRegs[0][1] = 0x14;
        state->unk4C = 0x3F;
        unk2DC->unk2D0 = 0x3F;
...
void Task_8062140()
{
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
        ...
        if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
            ...
            if ((gMultiSioStatusFlags & 0x0080) == 0x0000) {
    ...
    temp_r8++;
    if (((gMultiSioStatusFlags & 0x0080) == 0x0080) || (((gGameMode == 0) || (gGameMode == 1)))) {
        if (state->unk58 > 1U) {
            if (0x0080 & gRepeatedKeys) {
                if (state->level < (temp_r0_2 - 1)) {
                    m4aSongNumStart(108);
                    state->level++;
                }
            } else if (0x0040 & gRepeatedKeys) {
                if (state->level > 1U) {
                    m4aSongNumStart(108);
                    state->level--;
                }
    ...
    if (state->level > (({((24) != 0) ? ((s32)(state->unk52) / (s32)(24)) : 0;}) + 5)) {
        if (((gSelectedCharacter != 0) || (gCurrentLevel < 12) || ((&gLoadedSaveGame)->chaosEmeralds != ((1 << (0)) | (1 << (1)) | (1 << (2)) | (1 << (3)) | (1 << (4)) | (1 << (5)) | (1 << (6))))
             || ((&gLoadedSaveGame)->unlockedLevels[0] <= 12) || ((&gLoadedSaveGame)->unlockedLevels[1] <= 12) || ((&gLoadedSaveGame)->unlockedLevels[2] <= 12)
             || ((&gLoadedSaveGame)->unlockedLevels[3] <= 12) || (((&gLoadedSaveGame)->unlockedLevels[0] == 0xF) && (gMultiplayerCurrentLevel == 12)))
        ...
        if (state->level <= ({((0x18) != 0) ? ((s32)(state->unk52) / (s32)(0x18)) : 0;})) {
            var_r1 = state->level;
    ...
    unk2DC_2->unk2D7 = state->level;
    strc54->unk4F = state->level;
    state->unk50 += ({((10) != 0) ? ((s32)((state->unk52 - state->unk50) * 2) / (s32)(10)) : 0;});
    unk2DC->unk2D4 = state->unk50;
    ...
    if (state->strc0.unk6 > 0x1800) {
        if (state->strc0.unk4 == 2) {
            if (((gGameMode == 0) || (gGameMode == 1))) {
                ...
                if (((gMultiSioStatusFlags & 0x0080) == 0x0080) && (0x0001 & gPressedKeys)) {
                    send_recv = &gMultiSioSend;
...
void Task_80628A4()
{
    ...
    if ((gMultiSioStatusFlags & 0x0080) == 0x0080) {
        for (j = 1; j < 4; j++) {
            if ((((gMultiplayerConnections) >> (j)) & 1)) {
...
void Task_8062A80()
{
    ...
    CourseSelect_2DC *strc2DC = (void *)((gCurTask)->data);
...
void Task_8062B38()
{
    ...
    spriteIndex_32 = (({((24) != 0) ? ((s32)(strc2DC->unk2D4) / (s32)(24)) : 0;}) - 1);
    spriteIndex_32 <<= 24;
    var_r7 = 0;
...
void Task_8062CB4()
{
    ...
    if (strc2DC->unk2D4 > 0x2FU) {
        u32 v = ({((0x30) != 0) ? ((s32)(strc2DC->unk2D4) / (s32)(0x30)) : 0;}) - 1;
        v <<= 24;
        var_r7 = 1;
        i = v >>= 24;
        ...
        u32 v = ({((48) != 0) ? ((s32)(strc2DC->unk2D4) / (s32)(48)) : 0;});
        v <<= 24;
        var_r7 = 1;
        i = v >>= 24;
...
void Task_8062E18()
{
    CourseSelect_54 *strc54 = (void *)((gCurTask)->data);
    Sprite *s = &strc54->s;
