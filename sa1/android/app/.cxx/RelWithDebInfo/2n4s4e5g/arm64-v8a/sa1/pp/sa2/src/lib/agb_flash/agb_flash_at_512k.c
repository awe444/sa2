# 1 "/home/awaszczak/git/sa2/sa1/../src/lib/agb_flash/agb_flash_at_512k.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/lib/agb_flash/agb_flash_at_512k.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/lib/agb_flash/agb_flash_at_512k.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/lib/agb_flash/agb_flash_at_512k.c" 2

const u16 AT29LV512MaxTime[] = {
    10, 65469, 0x80 | 0x40 | 0x02, 40, 65469, 0x80 | 0x40 | 0x02, 0, 0, 0,
...
u16 EraseFlashChip_AT(void)
{
    ...
    (*(reg_u16 *)(REG_BASE + 0x204)) = ((*(reg_u16 *)(REG_BASE + 0x204)) & ~(3 << 0)) | gUnknown_087BF778.type.wait[0];

    ((*(vu8 *)(FLASH_BASE + (0x5555))) = (0xAA));
    ((*(vu8 *)(FLASH_BASE + (0x2AAA))) = (0x55));
    ((*(vu8 *)(FLASH_BASE + (0x5555))) = (0x80));
    ((*(vu8 *)(FLASH_BASE + (0x5555))) = (0xAA));
    ((*(vu8 *)(FLASH_BASE + (0x2AAA))) = (0x55));
    ((*(vu8 *)(FLASH_BASE + (0x5555))) = (0x10));
...
u16 EraseFlashSector_AT_2(u16 sectorNum)
{
    ...
    ime = (*(reg_u16 *)(REG_BASE + 0x208));
    (*(reg_u16 *)(REG_BASE + 0x208)) = 0;

    ((*(vu8 *)(FLASH_BASE + (0x5555))) = (0xAA));
    ((*(vu8 *)(FLASH_BASE + (0x2AAA))) = (0x55));
    ((*(vu8 *)(FLASH_BASE + (0x5555))) = (0xA0));
    ...
    (*(reg_u16 *)(REG_BASE + 0x208)) = ime;

    result = WaitForFlashWrite(1, addr, 0xFF);

    if (result)
        result = (result & 0xFF00) | (2 << 0);
...
# 191 "/home/awaszczak/git/sa2/sa1/../src/lib/agb_flash/agb_flash_at_512k.c"
...
u16 ProgramFlashSector_AT(u16 sectorNum, void *src)
{
    ...
    (*(reg_u16 *)(REG_BASE + 0x204)) = ((*(reg_u16 *)(REG_BASE + 0x204)) & ~(3 << 0)) | 3;
    return result;
}
