# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/mini_loop_boost.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/mini_loop_boost.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/mini_loop_boost.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/mini_loop_boost.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/mini_loop_boost.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/mini_loop_boost.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/mini_loop_boost.c" 2
...
void Task_MiniLoop_Base(void)
{
    MiniLoopBoost *boost = (void *)((gCurTask)->data);
    ...
    do {
        ...
        if (((boost->worldX) > gCamera.x + (320 + (256 / 2)) || (boost->worldX) < gCamera.x - (256 / 2) || (boost->worldY) > gCamera.y + ((240) + ((256) / 2)) || (boost->worldY) < gCamera.y - (256 / 2))) {
            p->moveState &= ~0x00008000;
            { boost->me->x = boost->meX; };
...
{
    struct Task *t = TaskCreate(Task_MiniLoop_Base, sizeof(MiniLoopBoost), 0x2000, 0, ((void*)0));
    MiniLoopBoost *ia = (void *)((t)->data);
    s32 worldX, worldY;
