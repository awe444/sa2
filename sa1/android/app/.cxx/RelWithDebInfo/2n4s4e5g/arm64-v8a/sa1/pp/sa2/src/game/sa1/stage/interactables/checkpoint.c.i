# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/checkpoint.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/checkpoint.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/checkpoint.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/checkpoint.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/checkpoint.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/checkpoint.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/stage/egg_rocket_transitions.h" 1
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/checkpoint.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/checkpoint.c" 2
...
void Task_CheckpointMain(void)
{
    Checkpoint *checkpoint = (void *)((gCurTask)->data);
    Sprite *s = &checkpoint->shared.s;
    MapEntity *me = checkpoint->shared.base.me;
    s16 worldX, worldY;

    worldX = ((checkpoint->shared.base.meX)*8 + (checkpoint->shared.base.regionX)*256);
    worldY = ((me->y)*8 + (checkpoint->shared.base.regionY)*256);

    s->x = worldX - gCamera.x;
    s->y = worldY - gCamera.y;

    if (((gCurrentLevel != ((5)*(2)) + (0)) && (((worldX) + checkpoint->shared.s.hitboxes[0].b.left) <= ((int)((gPlayer.qWorldX) >> 8)))
         && (((((worldX)) + (checkpoint->shared.s.hitboxes[0].b).left) + ((checkpoint->shared.s.hitboxes[0].b).right - (checkpoint->shared.s.hitboxes[0].b).left)) >= ((int)((gPlayer.qWorldX) >> 8)))
         && (((worldY) + checkpoint->shared.s.hitboxes[0].b.top) <= ((int)((gPlayer.qWorldY) >> 8)))
         && ((((worldY) + checkpoint->shared.s.hitboxes[0].b.top) + ((checkpoint->shared.s.hitboxes[0].b).bottom - (checkpoint->shared.s.hitboxes[0].b).top)) >= ((int)((gPlayer.qWorldY) >> 8))))
        || ((gCurrentLevel == ((5)*(2)) + (0))
            && (((me->d.sData[0] == 1) && (((int)((gPlayer.qWorldX) >> 8)) > worldX))
                || ((me->d.sData[0] != 1) && (((int)((gPlayer.qWorldY) >> 8)) + gPlayer.spriteOffsetY < worldY + 4))))) {
        if (!(gPlayer.moveState & 0x00400000)) {
            ...
            if (gCurrentLevel == ((5)*(2)) + (0)) {
                ...
                if (gBossIndex == 2) {
                    ...
                    CreateEggRocketStageSeparation((58 * (12 * 8)) - 1);
                }
                ...
                if (gBossIndex == 3) {
                    ...
                    CreateEggRocketStageSeparation((34 * (12 * 8)) - 1);
                }
            }
        }
    }
    ...
    if ((((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
        { me->x = checkpoint->shared.base.meX; };
...
void Task_Checkpoint1(void)
{
    ...
    if (gCurrentLevel == ((5)*(2)) + (0) || UpdateSpriteAnimation(s) == ACMD_RESULT__ENDED) {
        s->variant = 2;
