# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swing_rope.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swing_rope.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swing_rope.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swing_rope.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swing_rope.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swing_rope.c" 2


# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swing_rope.c" 2
...
void Task_SwingRope(void)
{
    SwingRope *rope = (void *)((gCurTask)->data);
    CamCoord x, y;
    MapEntity *me = rope->base.me;
    s32 i;


    x = ((rope->base.meX)*8 + (rope->base.regionX)*256);
    y = ((me->y)*8 + (rope->base.regionY)*256);
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            ...
            if ((((rope->unk3C) >> (i)) & 1)) {
                ...
                if (rope->unk40[i] < ((s32)((0.90625)*256))) {
                    rope->unk40[i] += ((s32)((0.0625)*256));
                }

                if (rope->unk40[i] > ((s32)((9)*256))) {
                    rope->unk40[i] = ((s32)((9)*256));
                }


                rope->unk48[i] += rope->unk40[i];

                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((y)*256)) + ((s32)((1)*256));

                if ((x + me->d.sData[0] * 8) <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))
                    && (x + me->d.sData[0] * 8 + me->d.uData[2] * 8) >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) {
                    s8 res;

                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX += rope->unk40[i];

                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).heldInput & 0x0010) {
                        rope->unk40[i] += 0x10;
                    } else if ((*(((i) != 0) ? &gPartner : &gPlayer)).heldInput & 0x0020) {
                        if (rope->unk40[i] > ((s32)((0.90625)*256))) {
                            rope->unk40[i] -= 0x10;
                        }
                    }

                    res = sa2__sub_801F100(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) - 8, ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)), (*(((i) != 0) ? &gPartner : &gPlayer)).layer, -8,
                                                 sa2__sub_801EB44);
                ...
                if ((*(((i) != 0) ? &gPartner : &gPlayer)).frameInput & gPlayerControls.jump) {
                    if (rope->unk40[i] < 0) {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = ((s32)((x + (me->d.sData[0] * 8) + 2)*256));
                        rope->unk40[i] = 0;
                        return;
                    }
                    ...
                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).heldInput & (0x0080 | 0x0040)) {
                        if ((*(((i) != 0) ? &gPartner : &gPlayer)).heldInput & 0x0040) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = -((s32)((6.75)*256));
                        } else {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = +((s32)((6.75)*256));
                        }

                    } else {
                        if (({((15) != 0) ? ((s32)(rope->unk50[i]) / (s32)(15)) : 0;}) != 0) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = +((s32)((6.75)*256));
                        } else {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = -((s32)((6.75)*256));
                        }
                    ...
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((y)*256)) + ((s32)((9)*256));
                    ...
                    (&(*(((i) != 0) ? &gPartner : &gPlayer)))->spriteInfoBody->s.frameFlags &= ~0x3000;
                    (&(*(((i) != 0) ? &gPartner : &gPlayer)))->spriteInfoBody->s.frameFlags |= 0x2000;
                }
                ...
                if (rope->unk3D[i] > 0) {
                    ...
                    if ((x + me->d.sData[0] * 8) <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))
                        ...
                        rope->unk40[i] = (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround >> 1;
                        ...
                        if ((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX > ((s32)((x)*256))) {

                            rope->unk48[i] = ((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX - ((s32)((x)*256)));
                        } else {

                            rope->unk48[i] = (((s32)((x)*256)) - (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX);
                        }
                        ...
                        (rope->unk3C) |= (1 << (i));
                        (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 34;
...
{
    struct Task *t = TaskCreate(Task_SwingRope, sizeof(SwingRope), 0x2000, 0, ((void*)0));
    SwingRope *rope = (void *)((t)->data);
    s32 i;
