# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/drisame.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/drisame.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/drisame.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/drisame.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/drisame.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/drisame.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/drisame.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/drisame.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/drisame.c" 2
...
void CreateEntity_Drisame(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    s->graphics.dest = VramMalloc(((40 / 8) * (16 / 8)));
    s->oamFlags = ((11) << 6);
    s->graphics.size = 0;
    s->graphics.anim = 424;
    s->variant = 0;
...
void Task_DrisameInit(void)
{
    Drisame *drisame = (void *)((gCurTask)->data);
    Sprite *s = &drisame->shared.s;
    ...
    worldX = ((drisame->shared.base.meX)*8 + (drisame->shared.base.regionX)*256);
    worldY = ((me->y)*8 + (drisame->shared.base.regionY)*256);
    ...
    if (((worldX2) > gCamera.x + (320 + (256 / 2)) || (worldX2) < gCamera.x - (256 / 2) || (worldY2) > gCamera.y + ((240) + ((256) / 2)) || (worldY2) < gCamera.y - (256 / 2)) && (((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
        { me->x = drisame->shared.base.meX; };
        TaskDestroy(gCurTask);
        return;
    }

    res = ({ s16 clamped = (sa2__sub_8004418(((int)((gPlayer.qWorldY) >> 8)) - worldY, ((int)((gPlayer.qWorldX) >> 8)) - worldX)) & (1024 - 1); clamped; });

    if (res >= 385 && res < 640) {
        some = ((int)((gPlayer.qWorldY) >> 8)) - worldY;
        someY = some * some;
        some = ((int)((gPlayer.qWorldX) >> 8)) - worldX;
        someX = some * some;
        someY += someX;

        if (someY < ((80) * (80))) {
            IceBlock *iceBlock = (void *)((drisame->iceBlock)->data);
            iceBlock->shattered = 1;

            (s)->frameFlags &= ~(((1) << (10)));

            if (({((35) != 0) ? ((s32)((gSineTable[(res) + 256])) / (s32)(35)) : 0;}) < 0) {
                drisame->unk3C = +({((35) != 0) ? ((s32)((gSineTable[(res) + 256])) / (s32)(35)) : 0;});
            } else {
                drisame->unk3C = -({((35) != 0) ? ((s32)((gSineTable[(res) + 256])) / (s32)(35)) : 0;});
            }
            drisame->unk40 = +({((35) != 0) ? ((s32)((gSineTable[(res)])) / (s32)(35)) : 0;});
            drisame->unk44 = 0;
            drisame->unk48 = 0;
...
void sub_8072E68(void)
{
    ...
    worldX += ((int)((drisame->unk44) >> 8));
    worldY += ((int)((drisame->unk48) >> 8));
    ...
    if (((drisame->worldX) > gCamera.x + (320 + (256 / 2)) || (drisame->worldX) < gCamera.x - (256 / 2) || (drisame->worldY) > gCamera.y + ((240) + ((256) / 2)) || (drisame->worldY) < gCamera.y - (256 / 2)) && (((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2))))
...
struct Task *CreateIceBlock(s16 worldX, s16 worldY)
{
    ...
    iceBlock->unkBC = 0;
    iceBlock->shattered = 0;


    for (i = 0; i < (s32)((sizeof(iceBlock->unkAC) / sizeof((iceBlock->unkAC)[0])) / 2); i++) {
        iceBlock->qUnkB4[i] = -((s32)((1)*256));
    ...
    for (; i < (sizeof(arr) / sizeof((arr)[0])); i++) {
        iceBlock->qUnkB4[i] = -((s32)((1.3125)*256));
    ...
    s3->y = worldY;
    s3->x = worldX;
    s3->graphics.dest = VramMalloc(((56 / 8) * (32 / 8)));
    s3->oamFlags = ((10) << 6);
    s3->graphics.size = 0;
    s3->graphics.anim = 573;
    s3->variant = 0;
    s3->animCursor = 0;
...
void Task_IceBlockInit(void)
{
    ...
    if (((screenX) > gCamera.x + (320 + (256 / 2)) || (screenX) < gCamera.x - (256 / 2) || (screenY) > gCamera.y + ((240) + ((256) / 2)) || (screenY) < gCamera.y - (256 / 2)) && (((u16)(s3->x + (256 / 2)) > 320 + 256) || (s3->y + (256 / 2) < 0) || (s3->y > 240 + (256 / 2)))) {
        TaskDestroy(gCurTask);
        return;
    }
    ...
    if (iceBlock->unkBC & 0x2) {
        for (i = 0; i < 4; i++) {
            if (i & 0x1) {
                ...
                iceBlock->qUnkB4[i] += ((s32)((20. / 256.)*256));
                iceBlock->unk9C[i] += ((int)((iceBlock->qUnkB4[i]) >> 8));
