# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/maze_air_corner.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/maze_air_corner.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/maze_air_corner.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/maze_air_corner.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/maze_air_corner.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/maze_air_corner.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/maze_air_corner.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/maze_air_corner.c" 2
...
{
    struct Task *t = TaskCreate(Task_TrackAirCorner, sizeof(TrackAirCorner), 0x2000, 0, ((void*)0));
    TrackAirCorner *ia = (void *)((t)->data);
    Sprite *s = &ia->s;
...
void Task_TrackAirCorner(void)
{
    TrackAirCorner *ia = (void *)((gCurTask)->data);
    Sprite *s = &ia->s;
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00400000)) {
                u32 res = Coll_Player_PlatformCrumbling(s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)));
