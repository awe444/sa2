# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_square.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_square.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_square.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_square.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_square.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_square.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_square.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_square.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_square.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_square.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_square.c" 2
...
void CreateEntity_Platform_Square(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    if ((zone == 2) || (gCurrentLevel == (14 + 2))) {
        s->graphics.dest = VramMalloc(((48 / 8) * (48 / 8)));
        s->graphics.anim = 494;
        s->variant = 0;
    } else if ((zone == 5) || (gCurrentLevel == (14 + 3))) {
        if (((gCurrentLevel & 0x1) != 0) || (gCurrentLevel == (14 + 3))) {

            if (platform->unk50) {
                s->graphics.dest = VramMalloc(((80 / 8) * (32 / 8)));
                s->graphics.anim = 600;
                s->variant = 0;
            } else {
                s->graphics.dest = VramMalloc(((48 / 8) * (48 / 8)));
        ...
        if (platform->unk50) {
            ...
            s->graphics.dest = VramMalloc(((32 / 8) * (80 / 8)));
            s->graphics.anim = 536;
            s->variant = 0;
        }
    } else if (zone == 3) {
...
void Task_Platform_Square(void)
{
    ...
    if (platform->unk4A != 0) {
        ...
        r0 = ((r3 * (gSineTable[(((platform->unk4A * ((gStageTime + platform->unk48) & 0xFF)) & (1024 - 1)))])) >> 14);
        platform->qUnk40 = r0;
    ...
    if (platform->unk4C != 0) {
        ...
        r0 = (r3 * (gSineTable[(((platform->unk4C * ((gStageTime + platform->unk48) & 0xFF)) & (1024 - 1)))])) >> 14;
        platform->qUnk44 = r0;
        prevUnk44 = r6 = r0 -= prevUnk44;
        sp24 = prevUnk44;
    }

    worldX = ((platform->base.meX)*8 + (platform->base.regionX)*256);
    worldY = ((me->y)*8 + (platform->base.regionY)*256);

    s->x = screenX = worldX - gCamera.x + ((int)((platform->qUnk40) >> 8));
    s->y = screenY = worldY - gCamera.y + ((int)((platform->qUnk44) >> 8));
    ...
    do {
        ...
        if ((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00400000) {
            continue;
        }

        qPrevWorldX = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX;

        if ((((platform->unk4E) >> (i)) & 1)) {
            (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX += sp20;
            (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY += sp24 + ((s32)((1)*256));

            if (sp20 > ((s32)((0)*256))) {
                r4 = sa2__sub_801E4E4(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) + ((*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetX + 2), ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)), (*(((i) != 0) ? &gPartner : &gPlayer)).layer, +8,
                                            ((void*)0), sa2__sub_801ED24);

                res2 = sa2__sub_801E4E4(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) + ((*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetX + 2),
                                              ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) - (*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetY, (*(((i) != 0) ? &gPartner : &gPlayer)).layer, +8, ((void*)0),
                                              sa2__sub_801ED24);
                ...
                if (res2 < 0) {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX += ((s32)((res2)*256));
                }
            } else {
                r4 = sa2__sub_801E4E4(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) - ((*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetX + 2), ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)), (*(((i) != 0) ? &gPartner : &gPlayer)).layer, -8,
                                            ((void*)0), sa2__sub_801ED24);
            ...
            r4 = sa2__sub_801E4E4(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) - (*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetY, ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) - (*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetX,
                                        (*(((i) != 0) ? &gPartner : &gPlayer)).layer, -8, ((void*)0), sa2__sub_801EE64);

            res2 = sa2__sub_801E4E4(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) - (*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetY, ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) + (*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetX,
                                          (*(((i) != 0) ? &gPartner : &gPlayer)).layer, -8, ((void*)0), sa2__sub_801EE64);
            ...
            if (res2 < 0) {
                if (platform->unk4C != 0) {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = qPrevWorldX;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00000020;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000080;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00400000;
                }
            } else {
                if (!Coll_Player_Entity_Intersection(s, worldX + ((int)((platform->qUnk40) >> 8)), worldY + ((int)((platform->qUnk44) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                    (platform->unk4E) &= ~(1 << (i));
                }
            }
        } else {

            s8 arr[4] = { -((*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetX + 5), (1 - (*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetY), +((*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetX + 5),
                          ((*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetY - 1) };

            qPrevWorldX = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX;
            sp2C = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY;
            ...
            if (res2 < 0) {
                sub_807E914(s, worldX + ((int)((platform->qUnk40) >> 8)), worldY + ((int)((platform->qUnk44) >> 8)), (Rect8 *)&arr, &(*(((i) != 0) ? &gPartner : &gPlayer)));
            } else {
                sp28 = Coll_Player_Platform(s, worldX + ((int)((platform->qUnk40) >> 8)), worldY + ((int)((platform->qUnk44) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer)));
            }
            if (sp28 & 0x170000) {
                (platform->unk4F) |= (1 << (i));
                ...
                if (sp28 & 0x40000) {
                    if (platform->unk4A != 0) {
                        res2 = sa2__sub_801E4E4(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) + (*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetX, ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)), (*(((i) != 0) ? &gPartner : &gPlayer)).layer,
                                                      +8, ((void*)0), sa2__sub_801ED24);
                        ...
                        if (res2 <= 0) {
                            ...
                            if ((*(((i) != 0) ? &gPartner : &gPlayer)).heldInput & 0x0020) {
                                if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000002)) {
                                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX -= ((s32)((1)*256));
                                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000020;
                                }
                            }
                        }
                    ...
                    if (platform->unk4A != 0) {
                        ...
                        if (res2 < 0) {
                            ...
                            if ((*(((i) != 0) ? &gPartner : &gPlayer)).heldInput & 0x0010) {
                                if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000002)) {
                                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX += ((s32)((1)*256));
                                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000020;
                                }
                    ...
                    if (platform->unk4C != 0) {
                        r4 = sa2__sub_801E4E4(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) + (*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetY,
                                                    ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) - (*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetX, (*(((i) != 0) ? &gPartner : &gPlayer)).layer, +8, ((void*)0),
                                                    sa2__sub_801EE64);

                        res2 = sa2__sub_801E4E4(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) + (*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetY,
                                                      ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) + (*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetX, (*(((i) != 0) ? &gPartner : &gPlayer)).layer, +8, ((void*)0),
                                                      sa2__sub_801EE64);
                        ...
                        if (res2 <= 0) {
                            s32 y = worldY + ((int)((platform->qUnk44) >> 8)) + s->hitboxes[0].b.bottom;

                            if (y < ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8))) {
                                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = qPrevWorldX;
                                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = sp2C;
                                (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00000020;
                                (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000080;
                                (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00400000;
                            }
                ...
                if ((((platform->unk4F) >> (i)) & 1)) {
                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).charState == 14) {
                        (platform->unk4F) &= ~(1 << (i));
                        ...
                        if ((*(((i) != 0) ? &gPartner : &gPlayer)).charState == 14) {
                            if ((*(((i) != 0) ? &gPartner : &gPlayer)).character != CHARACTER_AMY) {
                                if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000002)) {
                                    (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 4;
                                } else {
        ...
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            if ((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY >= ((s32)((0)*256))) {
                if (worldY + ((int)((platform->qUnk44) >> 8)) > ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8))) {
                    s8 arr[4] = { -((*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetX + 5), (1 - (*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetY), +((*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetX + 5),
                                  ((*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetY - 1) };

                    sub_807E914(s, worldX + ((int)((platform->qUnk40) >> 8)), worldY + ((int)((platform->qUnk44) >> 8)), (Rect8 *)&arr[0], &(*(((i) != 0) ? &gPartner : &gPlayer)));
                    ...
                    if (sp28 & 0x8) {
                        (platform->unk4E) |= (1 << (i));
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY += ((s32)((1)*256));
                    } else if (sp28 & 0x10000) {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = qPrevWorldX;
                    }
                }
    ...
    if (((worldX) > gCamera.x + (320 + (256 / 2)) || (worldX) < gCamera.x - (256 / 2) || (worldY) > gCamera.y + ((240) + ((256) / 2)) || (worldY) < gCamera.y - (256 / 2)) && (((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
...
void CreateEntity_BarrelOfDoomMini(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    s->graphics.dest = VramMalloc(((32 / 8) * (40 / 8)));
    s->graphics.anim = 493;
    s->variant = 0;
...
void Task_BarrelOfDoomMini(void)
{
    PlatformSq *platform = (void *)((gCurTask)->data);
    Sprite *s = &platform->s;
    ...
    if (platform->qUnk44 != ((s32)((0)*256))) {
        if (platform->qUnk44 < 0) {
            platform->qUnk3C += ((s32)((48. / 256.)*256));
        } else {
            platform->qUnk3C -= ((s32)((48. / 256.)*256));
        }
    }
    ...
    s->y = worldY - gCamera.y + ((int)((platform->qUnk44) >> 8));

    i = 0;
    do {

        qSpeedsY[i] = (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY;

        if (((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000008) && ((*(((i) != 0) ? &gPartner : &gPlayer)).stoodObj == s)) {

            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = ((s32)((0)*256));
            (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY += platform->qUnk3C;

            if (((*(((i) != 0) ? &gPartner : &gPlayer)).frameInput & gPlayerControls.attack) && ((*(((i) != 0) ? &gPartner : &gPlayer)).heldInput & 0x0080)) {

                if ((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_AMY) {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00000008;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = -((s32)((6)*256));
                }
            } else if (((*(((i) != 0) ? &gPartner : &gPlayer)).frameInput & gPlayerControls.jump) && ((*(((i) != 0) ? &gPartner : &gPlayer)).heldInput & 0x0080)) {

                if ((*(((i) != 0) ? &gPartner : &gPlayer)).character != CHARACTER_AMY) {
                    { Player_HandleSpriteYOffsetChange(&(*(((i) != 0) ? &gPartner : &gPlayer)), 9); { (&(*(((i) != 0) ? &gPartner : &gPlayer)))->spriteOffsetX = 6; (&(*(((i) != 0) ? &gPartner : &gPlayer)))->spriteOffsetY = 9; } };
                } else {
                ...
                if ((*(((i) != 0) ? &gPartner : &gPlayer)).frameInput & gPlayerControls.jump) {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = (platform->qUnk3C >> 1) - ((s32)((4)*256));
                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00000008;
                } else {

                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY += ((s32)((8)*256));
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = 1;

                    if (!Coll_Player_PlatformCrumbling(s, worldX + ((int)((platform->qUnk40) >> 8)), worldY + ((int)((platform->qUnk44) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00000008;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY -= ((s32)((8)*256));
                    }
            ...
            if (Coll_Player_PlatformCrumbling(s, worldX + ((int)((platform->qUnk40) >> 8)), worldY + ((int)((platform->qUnk44) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer))) & 0x00000008) {
                platform->qUnk3C += ({((10) != 0) ? ((s32)(qSpeedsY[i] * 6) / (s32)(10)) : 0;});
            }
        }
    } while (++i < gNumSingleplayerCharacters);
    ...
    platform->qUnk3C = ({((10000) != 0) ? ((s32)(platform->qUnk3C * 9900) / (s32)(10000)) : 0;});

    if ((platform->qUnk3C > -48 && platform->qUnk3C < +48) && ((platform->qUnk44 > -((s32)((3)*256)))) && ((platform->qUnk44 < +((s32)((3)*256))))) {
        {
            platform->qUnk3C = ((s32)((0)*256));
        }
    }
...
{
    if ((((((worldX) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + (*rect).left) && ((((worldX)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + (*rect).left)) || (((worldX) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + (*rect).left) && ((((((int)((p->qWorldX) >> 8)))) + ((*rect)).left) + (((*rect)).right - ((*rect)).left)) >= ((worldX) + s->hitboxes[0].b.left))) && (((((worldY)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + (*rect).top) && ((((worldY)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + (*rect).top)) || ((((worldY)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + (*rect).top) && ((((((int)((p->qWorldY) >> 8)))) + (*rect).top) + (((*rect)).bottom - ((*rect)).top)) >= (((worldY)) + s->hitboxes[0].b.top))))) {
        ...
        if (playerY > (worldY + s->hitboxes[0].b.top - rect->bottom + 2)) {
            ...
            s32 playerX = ((int)((p->qWorldX) >> 8));
            s32 qPlayerX;

            if (playerX <= val) {
                p->qWorldX = qPlayerX = ((s32)((worldX + (s->hitboxes[0].b.left) - rect->right)*256));

                res = sa2__sub_801E4E4(playerY + 9, ((int)((p->qWorldX) >> 8)), p->layer, +8, ((void*)0), sa2__sub_801EE64);

                if (res < 0) {
                    p->qWorldY += ((s32)((res)*256));
                }

                res = sa2__sub_801E4E4(((int)((p->qWorldY) >> 8)), ((int)((p->qWorldX) >> 8)), p->layer, -8, ((void*)0), sa2__sub_801EE64);
