# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c" 2
...
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c" 2


# 1 "/home/awaszczak/git/sa2/sa1/../include/data/sa1/sprite_data.h" 1
# 10 "/home/awaszczak/git/sa2/sa1/../include/data/sa1/sprite_data.h"
...
# 20 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c" 2
...
# 22 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 24 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c" 2
# 34 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c"
typedef struct {
               s32 x;
               s32 y;
               u8 filler0[0x14];
...
static void sa2__sub_8011A4C(void);
static void sa2__VCountIntr_8011ACC(void);
...
Water gWater = {};
# 95 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c"
static inline void MaskPaletteWithUnderwaterColor_inline(u32 *dst, u32 *src, u32 mask, s32 size)
{
    u32 k = (size >> 4);
    while (k-- > 0) {
        *dst++ = ({ u32 temp1, temp2; temp1 = (*src++); temp2 = temp1; temp2 = ((temp2 & ((0x7BDE << 16) | 0x7BDE)) + (((temp1 & ((0x739C << 16) | 0x739C)) + (((0x739C << 16) | 0x739C) & (mask))) >> 1)); temp2 >>= 1; });
        *dst++ = ({ u32 temp1, temp2; temp1 = (*src++); temp2 = temp1; temp2 = ((temp2 & ((0x7BDE << 16) | 0x7BDE)) + (((temp1 & ((0x739C << 16) | 0x739C)) + (((0x739C << 16) | 0x739C) & (mask))) >> 1)); temp2 >>= 1; });
        *dst++ = ({ u32 temp1, temp2; temp1 = (*src++); temp2 = temp1; temp2 = ((temp2 & ((0x7BDE << 16) | 0x7BDE)) + (((temp1 & ((0x739C << 16) | 0x739C)) + (((0x739C << 16) | 0x739C) & (mask))) >> 1)); temp2 >>= 1; });
        *dst++ = ({ u32 temp1, temp2; temp1 = (*src++); temp2 = temp1; temp2 = ((temp2 & ((0x7BDE << 16) | 0x7BDE)) + (((temp1 & ((0x739C << 16) | 0x739C)) + (((0x739C << 16) | 0x739C) & (mask))) >> 1)); temp2 >>= 1; });
        *dst++ = ({ u32 temp1, temp2; temp1 = (*src++); temp2 = temp1; temp2 = ((temp2 & ((0x7BDE << 16) | 0x7BDE)) + (((temp1 & ((0x739C << 16) | 0x739C)) + (((0x739C << 16) | 0x739C) & (mask))) >> 1)); temp2 >>= 1; });
...
void InitWaterPalettes(void)
{
    ...
    Water *water = &gWater;
    WaterData *wd = (void *)((water->t)->data);
...
# 166 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c"
}
...
void CreateStageWaterTask(s32 waterLevel, u32 p1, u32 mask)
{
    ...
    if (waterLevel >= 0) {
        Sprite *s = &gWater.s;
        s->graphics.dest = (void *)(&VRAM[0x10000] + 0x2660);
        s->graphics.size = 0;
...
static void Task_StageWaterTask(void)
{
    ...
    bool32 active;
    Sprite *s;
# 238 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c"
    if (gStageTime & 1) {
    ...
    if (water->currentWaterLevel <= cam->y) {
        water->sa2__unk2 = 0;
    } else if (water->currentWaterLevel < cam->y + 240) {
        water->sa2__unk2 = water->currentWaterLevel - cam->y;
    } else {
        water->sa2__unk2 = -1;
    }

    gVBlankCallbacks[gNumVBlankCallbacks++] = sa2__sub_8011A4C;
    gFlags |= 0x10;

    if (water->sa2__unk1 > 0 && water->sa2__unk1 < 240) {
        s = &water->s;
        s->x = -((cam->x + ((gStageTime + 1) >> 2)) & 15);
        s->y = water->sa2__unk2 + 1;
        s->frameFlags |= (((1) << (19)) | ((1) << (18)));
        UpdateSpriteAnimation(s);
    ...
    if (water->sa2__unk2 > 0 && water->sa2__unk2 < 240) {
        gIntrTable[3] = sa2__VCountIntr_8011ACC;
        gVCountSetting = water->sa2__unk2 - 1;
        gFlags |= 0x40;
    } else {
    ...
    if (water->sa2__unk2 >= 240) {
        ...
        u32 r5, i;
        s32 r3 = ({ s16 clamped = (((gStageTime * 4) + (((gBgScrollRegs[3][1] + water->sa2__unk2) % 32u) << 6))) & (1024 - 1); clamped; });

        sa2__sub_8007738
        (3, 0, 32, r3, 2, 64, (((gStageTime * 2 + (((gBgScrollRegs[3][1] + water->sa2__unk2) % 32u) << 5))) + 0x100) & (1024 - 1), 10,
         32, gBgScrollRegs[3][0], gBgScrollRegs[3][1]);

        for (r5 = 32, i = 1; r5 < 240; i++, r5 += 32) {
            DmaSet(3, gBgOffsetsHBlankPrimary, gBgOffsetsHBlankPrimary + ((gHBlankCopySize << 5) * i), (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | (((gHBlankCopySize << 5))/(32/8))));
        }
...
# 358 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c"
...
struct Task *CreateWaterfallSurfaceHitEffect(s32 x, s32 y)
{
    ...
    MultiplayerSpriteTask *ts = (void *)((t)->data);
    Sprite *s = &ts->s;
...
# 406 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/water_effects.c"
static void TaskDestructor_WaterSurface(struct Task *t)
{
    ...
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, sPaletteBuffer, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((60 * 16)/(32/8)))); };
...
static void sa2__sub_8011A4C(void)
{
    ...
    {
        WaterData *wd = (void *)((water->t)->data);
        u32 unk2 = water->sa2__unk2;
        water->sa2__unk1 = unk2;
        water->unk8 &= ~0x1;
        ...
        if (!unk2) {
            ...
            DmaSet(3, &sPaletteBuffer[16 * 16], ((ColorRaw*)&PLTT[0]), (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((29 * 16)/(32/8))));
            DmaSet(3, &sPaletteBuffer, ((ColorRaw*)&PLTT[0x200/sizeof(uint16_t)]), (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((0x200)/(32/8))));
...
static void sa2__VCountIntr_8011ACC(void)
{
...

    {
        ...
        DmaSet(0, &sPaletteBuffer[16 * 16], ((ColorRaw*)&PLTT[0]), (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((29 * 16)/(32/8))));
        DmaSet(0, &sPaletteBuffer, ((ColorRaw*)&PLTT[0x200/sizeof(uint16_t)]), (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((0x200)/(32/8))));
        ...
        DmaSet(0, gBgOffsetsHBlankSecondary, (void *)&(*(reg_u16 *)(REG_BASE + 0x1c)),
               ((0x8000 | 0x2000 | 0x0200 | 0x0060) << 16) | (gHBlankCopySize >> 1));

        (*(reg_u16 *)(REG_BASE + 0x202)) = (1 << 2);
    }
}



__attribute__((unused)) void MaskPaletteWithUnderwaterColor(u32 *dst, u32 *src, u32 mask, s32 size)
{
    u32 k = (size >> 4);
    while (k-- > 0) {
        *dst++ = ({ u32 temp1, temp2; temp1 = (*src++); temp2 = temp1; temp2 = ((temp2 & ((0x7BDE << 16) | 0x7BDE)) + (((temp1 & ((0x739C << 16) | 0x739C)) + (((0x739C << 16) | 0x739C) & (mask))) >> 1)); temp2 >>= 1; });
