# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2
...
# 21 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/stage/tilemap_table.h" 1
...
# 22 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/menus/mp_mode_select_2.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/menus/mp_mode_select_2.h"
void sa2__sub_8081200(void);
void ShowSinglePakResults(void);
# 23 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/data/sa1/sprite_tables.h" 1
...
# 25 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/data/sa1/collect_rings.h" 1





extern const u8 gCollectRingsTilemaps[0xC000];

extern const u8 gCollectRingsTextTiles[];

extern const u8 gCollectRingsBgStageTileset[];

extern const u8 gCollectRingsAnimations_Cream_Compressed[0x6A7C];
extern const u8 gCollectRingsAnimations_Tails_Compressed[0x6fe4];
extern const u8 gCollectRingsAnimations_Knuckles_Compressed[0x6a44];

extern const u8 gCollectRingsRom_Compressed[];
# 26 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2
...
# 28 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 29 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/text.h" 1
# 30 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/tilemaps.h" 1
# 31 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c" 2
# 120 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c"
typedef struct {
    Sprite unk0;
    u8 filler30[8];
...
typedef struct {
    ...
    u8 filler439[3];
    u32 unk43C;
} MultiplayerSinglePakResultsScreen;

void Task_MultiplayerSinglePakResultsScreenInit(void);
void sa2__sub_80823FC(void);
void sa2__Task_8082630(void);
void sa2__sub_808267C(void);
void sa2__sub_8082788(void);
void sa2__sub_8082AA8(void);
# 160 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c"
...
void CreateMultiplayerSinglePakResultsScreen(u32 a)
{
    ...
    gFlags &= ~0x8000;
    CpuFastSet(gCollectRingsTilemaps, (void *)&VRAM[0], ((0x8000)/(32/8) & 0x1FFFFF));
    CpuFastSet(gCollectRingsBgStageTileset, (void *)EWRAM_START + 0x33000, ((0x40000 - 0x33000)/(32/8) & 0x1FFFFF));
...
# 230 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c"
    gDispCnt = 0x0040; gBgCntRegs[3] = 0x5E0B; gBgCntRegs[2] = 0x1C0C; gBgSprites_Unknown1[2] = 0x7F; gBgSprites_Unknown2[2][0] = 0; gBgSprites_Unknown2[2][1] = 0; gBgSprites_Unknown2[2][2] = 0xFF; gBgSprites_Unknown2[2][3] = 0x20; gBgSprites_Unknown1[3] = -1; gBgSprites_Unknown2[3][0] = 0; gBgSprites_Unknown2[3][1] = 0; gBgSprites_Unknown2[3][2] = -1; gBgSprites_Unknown2[3][3] = 0x40; { u32 tmp = (u32)(0); DmaSet(3, &tmp, VRAM + 0x9FE0, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((0x40)/(32/8)))); }; { u32 tmp = (u32)(0); DmaSet(3, &tmp, VRAM + 0xFE0 + ({ s32 r8 = (3); r8 << 14; }), (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((0x40)/(32/8)))); };;
    ({ resultsScreen = (void *)((TaskCreate(Task_MultiplayerSinglePakResultsScreenInit, sizeof(MultiplayerSinglePakResultsScreen), 0x2000, 0, ((void*)0)))->data); resultsScreen->mode = (a); resultsScreen->unk430 = 0; resultsScreen->actor = 0; });
    resultsScreen->unk43C = (&gLoadedSaveGame)->unk4 + gFrameCount;
    ({ Background *bg = &(resultsScreen->unk0); bg->graphics.dest = (void *)(((u8*)&VRAM[0]) + (0x800 * (16))); bg->graphics.anim = 0; bg->layoutVram = (void *)(((u8*)&VRAM[0]) + (0x800 * (30))); bg->unk18 = 0; bg->unk1A = 0; bg->tilemapId = (4); bg->unk1E = 0; bg->unk20 = 0; bg->unk22 = 0; bg->unk24 = 0; bg->targetTilesX = 0x1E; bg->targetTilesY = 0x19; bg->paletteOffset = 0; bg->flags = (3); DrawBackground(bg); });

    for (i = 0; i < (s32)(sizeof(resultsScreen->unk80) / sizeof((resultsScreen->unk80)[0])); i++) {
        s = &resultsScreen->unk80[i].unk0;

        s->x = (120); s->y = (0x14 + (i * 0x28)); s->graphics.dest = (&VRAM[0x10000] + (i << 0xB)); s->oamFlags = (((16) << 6)); s->graphics.size = 0; s->graphics.anim = (gPlayerCharacterIdleAnims[i]); s->variant = (0); s->animCursor = 0; s->qAnimDelay = 0; s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = (0); s->frameFlags = (0x1000); UpdateSpriteAnimation(s);;
    }

    for (i = 0; i < (s32)(sizeof(resultsScreen->unk160) / sizeof((resultsScreen->unk160)[0])); i++) {
        void *vram = &VRAM[0x10000] + 0x2000 + (i * 0x80);
        u32 oamFlags = ((4) << 6);

        s = &resultsScreen->unk160[i];
        s->x = (0); s->y = (0); s->graphics.dest = (vram); s->oamFlags = (oamFlags); s->graphics.size = 0; s->graphics.anim = (0x380); s->variant = ((i + 3)); s->animCursor = 0; s->qAnimDelay = 0; s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = (0); s->frameFlags = (0x1000); UpdateSpriteAnimation(s);;
    }

    if (resultsScreen->mode != 0) {
        for (i = 0; i < (s32)(sizeof(resultsScreen->unk370) / sizeof((resultsScreen->unk370)[0])); i++) {
            s = &resultsScreen->unk370[i];

            s->graphics.dest = (void *)(&VRAM[0x10000] + 0x2500 + (i * 0x1C0));
            s->x = 0;
            s->y = 0;
            s->oamFlags = ((4) << 6);
            s->graphics.size = 0;
        ...
        s->x = (0); s->y = (0); s->graphics.dest = ((void *)&VRAM[0x10000] + 0x2500); s->oamFlags = (((4) << 6)); s->graphics.size = 0; s->graphics.anim = (0x380); s->variant = (13); s->animCursor = 0; s->qAnimDelay = 0; s->prevVariant = -1; s->animSpeed = ((int)((float)(1.0)*0x10)); s->palId = (0); s->frameFlags = (0x1000); UpdateSpriteAnimation(s);;
    }
    ...
    gBldRegs.bldY = 0x10;
# 300 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c"
}
# 324 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c"
void Task_MultiplayerSinglePakResultsScreenInit(void)
{
    u32 i;
    Sprite *s;
    ...
    MultiplayerSinglePakResultsScreen *resultsScreen;
    gDispCnt |= 0x1800;
    gMultiplayerConnections = ((gMultiSioStatusFlags & ((0x0100 << (0)) | (0x0100 << (1)) | (0x0100 << (2)) | (0x0100 << (3)))) >> 8);
    ({ if ((!(((gGameMode == 0) || (gGameMode == 1))))) { u32 i; for (i = 0; i < 4 && (gMultiplayerConnections & ((1 << 0) << (i))); i++) { if (!(gMultiSioStatusFlags & (0x0001 << (i)))) { if (gMultiplayerMissingHeartbeats[i]++ > 180) { TasksDestroyInPriorityRange(0, 0xFFFF); gBackgroundsCopyQueueCursor = gBackgroundsCopyQueueIndex;; gBgSpritesCount = 0; gVramGraphicsCopyCursor = gVramGraphicsCopyQueueIndex; LinkCommunicationError(); return; } } else { gMultiplayerMissingHeartbeats[i] = 0; } } } });

    gMultiSioSend.pat0.unk0 = (0x10);

    if ((gMultiSioStatusFlags & 0x0080) == 0x0080) {
        gMultiSioSend.pat0.unk3 = (&gLoadedSaveGame)->uiLanguage;
    }
    ...
    resultsScreen = (void *)((gCurTask)->data);
    ...
    if (++resultsScreen->unk430 > 0xF0) {
        ...
        if (resultsScreen->mode) {
            for (i = 0; i < 3; i++) {
                ...
                s->oamFlags = ((4) << 6);
                s->graphics.size = 0;
# 385 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c"
                switch ((&gLoadedSaveGame)->uiLanguage) {
                    case 0:
                        s->graphics.anim = 900;
                        break;
...
# 414 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c"
                s->variant = i;
                s->animCursor = 0;
                s->qAnimDelay = 0;
                s->prevVariant = -1;
...
# 468 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c"
            s->variant = 0;
            s->animCursor = 0;
            s->qAnimDelay = 0;
            s->prevVariant = -1;
        ...
        gCurTask->main = sa2__sub_80823FC;
        sa2__sub_80823FC();
    } else {
# 494 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c"
        for (i = 0; i < 4; i++) {
            if (!(gMultiSioStatusFlags & (0x0001 << (i + 8)))) {
                if (gMultiplayerRanks[i] & 1) {
                    sa2__sub_80078D4(3, i * 40, (i + 1) * 40, 320 - resultsScreen->unk430, 240 - i * 40);
                } else {
                    sa2__sub_80078D4(3, i * 40, (i + 1) * 40, resultsScreen->unk430 - 320, 240 - i * 40);
                }
            } else {
                if (gMultiplayerRanks[i] & 1) {
                    sa2__sub_80078D4
                    (3, gMultiplayerRanks[i] * 40, (gMultiplayerRanks[i] + 1) * 40, 320 - resultsScreen->unk430,
                     (i * 5 - gMultiplayerRanks[i] * 5) * 8);
                } else {
                    sa2__sub_80078D4
                    (3, gMultiplayerRanks[i] * 40, (gMultiplayerRanks[i] + 1) * 40, resultsScreen->unk430 - 320,
                     (i * 5 - gMultiplayerRanks[i] * 5) * 8);
                }
            }
        }
...
void sa2__sub_80823FC(void)
{
    ...
    s32 val2 = 0;
    u8 val = 0;
    MultiplayerSinglePakResultsScreen *resultsScreen = (void *)((gCurTask)->data);
    union MultiSioData *packet;

    gMultiplayerConnections = ((gMultiSioStatusFlags & ((0x0100 << (0)) | (0x0100 << (1)) | (0x0100 << (2)) | (0x0100 << (3)))) >> 8);
    packet = &gMultiSioRecv[0];
    if (packet->pat0.unk0 == (0x12)) {
        ...
        if (!resultsScreen->mode) {
            ...
            background->tilemapId = (((((0)*(2)) + (1))*3) + 2);
            background->unk1E = 0;
            background->unk20 = (&gLoadedSaveGame)->uiLanguage * 4;
# 573 "/home/awaszczak/git/sa2/sa1/../src/game/shared/collect_rings/results.c"
            background->unk22 = 6;
            background->unk24 = 8;
        ...
        if (resultsScreen->mode) {
            gBldRegs.bldCnt = 0xFF;
            gCurTask->main = sa2__Task_8082630;
            sa2__Task_8082630();
        } else {
            gCurTask->main = sa2__sub_8082AA8;
            sa2__sub_8082AA8();
        }
    } else {
        sa2__sub_8082788();
        ...
        for (i = 0; i < 4 && (gMultiplayerConnections & ((1 << 0) << (i))); i++) {
            if (!((0x0001 << (i)) & gMultiSioStatusFlags)) {
                val = 1;
            } else {
                packet = &gMultiSioRecv[i];
                if (i == ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id || packet->pat0.unk0 == (0x10)) {
                    val2++;
                }
            }
        }
        packet = &gMultiSioSend;
        packet->pat0.unk0 = (0x10);
        if (gMultiSioStatusFlags & 0x0080) {
            packet->pat0.unk3 = (&gLoadedSaveGame)->uiLanguage;
        }

        if ((gMultiSioStatusFlags & 0x0080 && gPressedKeys & 0x0008 && !val && val2 > 1) || resultsScreen->actor) {
            resultsScreen->actor = 1;
            packet->pat0.unk0 = (0x12);
        }
    }
}
...
void sa2__Task_8082630(void)
{
    ...
    if (resultsScreen->unk430 > ((s32)((16)*256))) {
        resultsScreen->unk430 = ((s32)((16)*256));
        gBldRegs.bldY = 0x10;
        gCurTask->main = sa2__sub_808267C;
    }

    gBldRegs.bldY = ((int)((resultsScreen->unk430) >> 8));
}
...
void sa2__sub_808267C(void)
{
    ...
    sa2__sub_8082788();
    packet = &gMultiSioSend;
    packet->pat0.unk0 = (0x51);
    packet->pat0.unk2 = 0;

    if ((gMultiSioStatusFlags & 0x0080) == 0x0080) {
        u8 i;
        for (i = 0; i < 4; i++) {
            if ((gMultiplayerConnections & ((1 << 0) << (i)))) {
                packet = &gMultiSioRecv[i];
                if (packet->pat0.unk0 != (0x51)) {
                    return;
                }
            }
        }
        packet = &gMultiSioSend;
        packet->pat3.unk0 = (0x80);
...
void sa2__sub_8082788(void)
{
    ...
    for (i = 0; i < 4; i++) {
        if (!(gMultiSioStatusFlags & (0x0001 << (i + 8)))) {
            ...
            sa2__sub_80078D4(3, i * 40, (i + 1) * 40, 0, 240 - i * 40);
        } else {
            ...
            if ((i == ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) || send_recv->pat0.unk0 > 15)
