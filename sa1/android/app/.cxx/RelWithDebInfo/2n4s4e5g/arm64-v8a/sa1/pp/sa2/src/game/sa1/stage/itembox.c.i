# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/itembox.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/itembox.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/itembox.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/itembox.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/itembox.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/itembox.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/itembox.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/dust_cloud.h" 1



void CreateDustCloud(s16 x, s16 y);
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/itembox.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/itembox.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/itembox.c" 2
...
# 20 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/itembox.c" 2
...
# 21 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/itembox.c" 2
...
# 23 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/itembox.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 24 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/itembox.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/items.h" 1
# 25 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/itembox.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/player_transitions.h" 1
# 26 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/itembox.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 27 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/itembox.c" 2
...
typedef struct {
                    ...
                    u8 kind;
                    u8 frames;
# 50 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/itembox.c"
} ItemBox;
...
extern u8 gUnknown_080BB4D8[11];
...
void CreateEntity_ItemBox(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    sTemp = s;
    s = &itembox->sprItem;
    DmaSet(3, sTemp, s, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(*s))/(16/8))));
...
{
    bool32 sl = 0;
    ItemBox *itembox = (void *)((gCurTask)->data);
    Sprite *s = &itembox->s;
    MapEntity *me = itembox->base.me;

    s16 worldX = ((itembox->base.meX)*8 + (itembox->base.regionX)*256);
    s16 worldY = ((itembox->base.me->y)*8 + (itembox->base.regionY)*256);
    s32 screenX, screenY;

    if ((!(((gGameMode == 0) || (gGameMode == 1)))) && ((s8)me->x == (-3))) {
        m4aSongNumStart(167);
        ...
        if (itembox->unk70 != 0) {
            ...
            itembox->iconOffset += ((int)((itembox->qUnk6E) >> 8));
            itembox->qUnk6E += ((s32)((40. / 256.)*256));

            res = sa2__sub_801F07C(worldY + itembox->iconOffset, worldX, 1, 8, ((void*)0), sa2__sub_801EE64);
            if (res < 0) {
        ...
        if (!(gPlayer.moveState & 0x00400000) || sl) {
            ...
            if (((gPlayer.moveState & 0x00000008) && (gPlayer.stoodObj == s))
                || (gPlayer.spriteInfoBody->s.hitboxes[0].index == -1)) {
            ...
            if (res & 0x10000) {
                ...
                if ((gPartner.moveState & 0x00000008) && (gPartner.stoodObj == s)) {
                    gPartner.moveState &= ~0x00000008;
                    gPartner.moveState &= ~0x00000020;
                    gPartner.moveState |= 0x00000002;
                }
        ...
        if (((worldX) > gCamera.x + (320 + (256 / 2)) || (worldX) < gCamera.x - (256 / 2) || (worldY) > gCamera.y + ((240) + ((256) / 2)) || (worldY) < gCamera.y - (256 / 2)) && (((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + itembox->iconOffset + (256 / 2) < 0) || (s->y + itembox->iconOffset > 240 + (256 / 2)))) {
        ...
        if (gGameMode == 2 || gGameMode == 3) {
            if ((gStageTime >> 5) & 0x1) {
                u32 kind = gUnknown_080BB4F0[gMultiplayerPseudoRandom % (sizeof(gUnknown_080BB4F0) / sizeof((gUnknown_080BB4F0)[0]))];
                itembox->kind = kind;

                if ((((gCurrentLevel) >> 1) == 5) && (kind == 8)) {
                    itembox->kind = 10;
                }
            } else {

                itembox->kind = gUnknown_080BB4E8[((gStageTime >> 6) + me->index) % (sizeof(gUnknown_080BB4E8) / sizeof((gUnknown_080BB4E8)[0]))];
            }
...
void Task_Itembox2(void)
{
    ...
    worldY = ((me->y)*8 + (itembox->base.regionY)*256) + itembox->iconOffset;
    ...
    if (itembox->unk70 >= 60) {
        switch (itembox->kind) {
            ...
            case 1: {
                gPlayer.itemEffect |= 0x01;
                gPlayer.itemEffect &= ~0x08;
            ...
            case 3: {
                if (!(gPlayer.itemEffect & 0x02)) {
                    CreateItemTask_Invincibility(gPlayer.playerID);
                    gMusicManagerState.unk2 = 0x10 | 0x0;
                }

                gPlayer.itemEffect |= 0x02;
                gPlayer.timerInvincibility = (int)(((0 * 60.) + 20) * 60);
            } break;

            case 4: {
                gPlayer.itemEffect |= 0x04;
                gPlayer.timerSpeedup = (int)(((0 * 60.) + 20) * 60);

                m4aMPlayTempoControl(&gMPlayInfo_BGM, ((s32)((2.0)*256)));
            ...
            case 5: {
                s16 rings = ItemBox_RingAmountTable[(u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) % (sizeof(ItemBox_RingAmountTable) / sizeof((ItemBox_RingAmountTable)[0]))];
                { s32 prevLives, newLives; u16 oldRings = gRingCount; gRingCount = oldRings + (rings); if (!(((gCurrentLevel) == ((6)*(2)) + (1)))) { newLives = ({((100) != 0) ? ((s32)(gRingCount) / (s32)(100)) : 0;}); prevLives = ({((100) != 0) ? ((s32)(oldRings) / (s32)(100)) : 0;}); if ((newLives != prevLives) && (gGameMode == 0)) { u16 lives = gNumLives + 1; gNumLives = ({ if ((lives) > 255) (lives) = 255; gNumLives = (lives); }); gMusicManagerState.unk3 = 0x10 | 0x0; } } };
            ...
            case 6: {
                { s32 prevLives, newLives; u16 oldRings = gRingCount; gRingCount = oldRings + (5); if (!(((gCurrentLevel) == ((6)*(2)) + (1)))) { newLives = ({((100) != 0) ? ((s32)(gRingCount) / (s32)(100)) : 0;}); prevLives = ({((100) != 0) ? ((s32)(oldRings) / (s32)(100)) : 0;}); if ((newLives != prevLives) && (gGameMode == 0)) { u16 lives = gNumLives + 1; gNumLives = ({ if ((lives) > 255) (lives) = 255; gNumLives = (lives); }); gMusicManagerState.unk3 = 0x10 | 0x0; } } };
            ...
            case 7: {
                { s32 prevLives, newLives; u16 oldRings = gRingCount; gRingCount = oldRings + (10); if (!(((gCurrentLevel) == ((6)*(2)) + (1)))) { newLives = ({((100) != 0) ? ((s32)(gRingCount) / (s32)(100)) : 0;}); prevLives = ({((100) != 0) ? ((s32)(oldRings) / (s32)(100)) : 0;}); if ((newLives != prevLives) && (gGameMode == 0)) { u16 lives = gNumLives + 1; gNumLives = ({ if ((lives) > 255) (lives) = 255; gNumLives = (lives); }); gMusicManagerState.unk3 = 0x10 | 0x0; } } };
            ...
            case 8: {
                ...
                for (playerId = 0, mppTasks = gMultiplayerPlayerTasks; playerId < 4 && mppTasks[playerId] != ((void*)0);
                     playerId++) {
                    ...
                    u32 sioId = (((volatile struct SioMultiCnt *)(REG_BASE + 0x128)))->id;
                    if (playerId == sioId)
                        continue;

                    mpp = (void *)((mppTasks[playerId])->data);
                    boxToPlayerX = ((mpp->pos.x - ((int)((gPlayer.qWorldX) >> 8))) * (mpp->pos.x - ((int)((gPlayer.qWorldX) >> 8))));
                    boxToPlayerY = ((mpp->pos.y - ((int)((gPlayer.qWorldY) >> 8))) * (mpp->pos.y - ((int)((gPlayer.qWorldY) >> 8))));
