# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c" 2
...
# 19 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c" 2
...
# 20 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/stage/extra_stage.h" 1



extern void CreateExtraStageResults();
# 21 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c" 2
# 33 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c"
...
# 34 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c" 2
# 43 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c"
typedef struct {
    void *vram;
    u16 unk4;
    u8 levelId;
...
void CreateUnusedLevelSelect(void)
{
    ...
    struct Task *t = TaskCreate(Task_UnusedLevelSelectInit, sizeof(LevelSelect), 0x2000, 0, ((void*)0));
    ...
    {
        LevelSelect *levelSelect = (void *)((t)->data);

        gDispCnt = (0x0100 | 0x0040 | 0x0000);
        gBgCntRegs[0] = (((31) << 8) | 0x0000 | ((1) << 2) | (2));

        levelSelect->unk4 = 0;
        levelSelect->levelId = 0;
        levelSelect->vram = (void *)((((u8*)&VRAM[0]) + (0x4000 * (1))) + 1 * 32);
# 98 "/home/awaszczak/git/sa2/sa1/../src/game/shared/menus/unused_level_select.c"
    }
}
...
{
    u8 digits[5];
    LevelSelect *levelSelect = (void *)((gCurTask)->data);

    if (gPressedKeys & (0x0008 | 0x0001)) {
        m4aSongNumStart(106);
...
void Task_CreateMultiplayer(void)
{
    ...
    parent = gMultiSioStatusFlags & 0x0080;
    send = &gMultiSioSend;
    if (parent) {
        u8 j;

        for (j = 0; j < 4; j++) {
            if ((gMultiplayerConnections & ((1 << 0) << (j)))) {
...
{
    LevelSelect *levelSelect = (void *)((gCurTask)->data);
    gBgPalette[(0)*16u + (1)] = (((31) | ((31) << 5) | ((31) << 10)));;
    gFlags |= 0x1;
