# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_over.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_over.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_over.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_over.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_over.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_over.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_over.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_over.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_over.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_over.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_over.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_over.c" 2
...
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_over.c" 2
...
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_over.c" 2
...
# 19 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_over.c" 2
...
# 21 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_over.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 22 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_over.c" 2
...
void sub_8055C50(Strc_8055C50 *param0)
{
    ...
    sp00.uiGfxID = 32;
    sp00.unk2B = 4;
    sp00.tiles = gUiGraphics[32].tiles;
    sp00.palette = gUiGraphics[32].palette;
    sp00.tilesSize = 40 * 32;
    sp00.paletteSize = 32;
    sp00.unk28 = 6;
    ...
    sp00.uiGfxID = 33;
    sp00.unk2B = 5;
    sp00.tiles = gUiGraphics[33].tiles;
    sp00.palette = gUiGraphics[33].palette;
    sp00.tilesSize = 16 * 32;
    sp00.paletteSize = 32;
    sp00.unk28 = 6;
    sp00.vramC = param0->vram0;
    sp00.unk2A = 13;
    sp00.unk0.unk4 = gUiGraphics[33].unk8;
    sp00.unk0.unk8 = gUiGraphics[33].unkC;
    sp00.unk0.unk9 = gUiGraphics[33].unk10;
    sp00.unk0.unkA = gUiGraphics[33].unk14;
    sp00.unk0.unkB = gUiGraphics[33].unk18;
    sub_80528AC(&sp00);

    sp00.uiGfxID = 45;
    sp00.unk2B = 14;
    sp00.tiles = gUiGraphics[45].tiles;
    sp00.palette = gUiGraphics[45].palette;
    sp00.tilesSize = 16 * 32;
    sp00.paletteSize = 32;
    sp00.unk28 = 6;
    sp00.vramC = param0->vram8;
    sp00.unk2A = 13;
    sp00.unk0.unk4 = gUiGraphics[45].unk8;
    sp00.unk0.unk8 = gUiGraphics[45].unkC;
    sp00.unk0.unk9 = gUiGraphics[45].unk10;
    sp00.unk0.unkA = gUiGraphics[45].unk14;
    sp00.unk0.unkB = gUiGraphics[45].unk18;
    sub_80528AC(&sp00);
}
...
void CreateGameOverScreen(LostLifeCause lostLifeCause)
{
...

    {
        ...
        if ((lostLifeCause & 0x5) != 0) {
            t2 = TaskCreate(Task_8056F54, sizeof(GameOverB0), 0x2000, 0, ((void*)0));
            overB0 = (void *)((t2)->data);
            overB0->unk18 = 0;
            overB0->unk0.qUnkA = -((s32)((1)*256));
            overB0->unk0.unkC = 90;
            overB0->unk0.unkE = 8;
            ...
            t2 = TaskCreate(Task_8056FA0, sizeof(GameOverD), 0x2000, 0, ((void*)0));
            overD = (void *)((t2)->data);
            overD->unk24 = 0;
            overD->unk28 = 9;
            overD->vram2C = VramMalloc(40);
            overD->vram30 = VramMalloc(16);
            overD->unk1C = overB0;
            overD->unk18 = screen;
            overD->unk20 = overC;
            ...
            overC->unk0.unk8 = 96;
            overC->unk0.unkA = 1;
            strc.vram8 = VramMalloc(16);
            strc.vram0 = VramMalloc(16);
            strc.vram4 = VramMalloc(40);
            overC->unk14 = strc.vram8;
            overC->unkC = strc.vram0;
            overC->unk10 = strc.vram4;
        }
...
void Task_8056218(void)
{
    ...
    if (frames >= 217) {
        s16 r0;
        u16 r1;
        s2->frameFlags = ((1) << (7)) | ((1) << (5)) | gOamMatrixIndex++;
        s->frameFlags = ((1) << (7)) | ((1) << (5)) | gOamMatrixIndex++;

        r1 = frames - 248;
        r0 = (32 - (r1));

        transform.rotation = 0;
        transform.qScaleX = ((int)(((gSineTable[(r0 * 16) + 256])) >> 6));
        if (transform.qScaleX < ((s32)((10. / 256.)*256))) {
            transform.qScaleX = ((s32)((10. / 256.)*256));
        }
...
void Task_8056348(void)
{
    ...
    s->frameFlags = ((1) << (5)) | gOamMatrixIndex++;
    s->frameFlags |= ((1) << (7));

    transform.rotation = 0;
    transform.qScaleX = ((int)(((gSineTable[(r2 >> 16) + 256])) >> 6));
    if (transform.qScaleX < ((s32)((10. / 256.)*256))) {
        transform.qScaleX = ((s32)((10. / 256.)*256));
    }
    transform.qScaleY = ((s32)((1.0)*256));
...
void Task_805648C(void)
{
...

    {
        ...
        transform.qScaleX = ((int)(((gSineTable[(r0) + 256])) >> 6));
        ...
        s2->frameFlags = ((1) << (5)) | gOamMatrixIndex++;
        s2->frameFlags |= ((1) << (7));
...
{
    GameOverB0 *overB0 = (void *)((gCurTask)->data);
    s16 unk18 = overB0->unk18;
    overB0->unk18 = unk18 += 1;
    overB0->unk0.qUnkA += ((s32)((12. / 256.)*256));
    ...
    if (unk18 >= 182) {
        ...
        overB0->unk0.qUnkA = ((s32)((0)*256));
        overB0->unk18 = 0;
    }
}


void Task_805676C(void)
{
    GameOverD *overD = (void *)((gCurTask)->data);
    ...
    sp00.unk8 = 0;
    sp00.unk10 = 4;
    sp00.byteCount = (sizeof(arr) / sizeof((arr)[0]));
    sp00.unk16 = 1;
...
{
    GameOverScreen *screen = (void *)((gCurTask)->data);
    struct MP2KPlayerState *info = gMPlayTable[gSongTable[37].ms].info;
...
void Task_8056CE0(void)
{
    GameOverC *overC = (void *)((gCurTask)->data);
