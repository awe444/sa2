# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bowl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bowl.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bowl.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bowl.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bowl.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bowl.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bowl.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bowl.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bowl.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bowl.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bowl.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bowl.c" 2
...
const AnimId sBowlAnimations[18] = {
    486, 486,
    486, 486,
    486, 486,
    486, 486,
...
void CreateEntity_Bowl(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    s->graphics.dest = VramMalloc(((96 / 8) * (40 / 8)));
    s->oamFlags = ((5) << 6);
    s->graphics.size = 0;
...
void Task_Bowl(void)
{
    Bowl *bowl = (void *)((gCurTask)->data);
    Sprite *s = &bowl->s;
    MapEntity *me = bowl->base.me;
    CamCoord worldX, worldY;
    s32 i;

    worldX = ((bowl->base.meX)*8 + (bowl->base.regionX)*256);
    worldY = ((me->y)*8 + (bowl->base.regionY)*256);
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            ...
            if (((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) > worldX) {
                diff = +10;
            } else {
                diff = -10;
            }

            if (Coll_Player_Entity_Intersection(s, worldX - diff, worldY + 5, &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                (bowl->unk51) |= (1 << (i));
                bowl->unk40[i] = (((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX) < 0 ? -((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX) : ((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX)) << 2;

                bowl->unk3C[i] = (({((96) != 0) ? ((s32)((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) - worldX + (96 / 2)) << 9) / (s32)(96)) : 0;}) < 0)
                    ? (0x300 - ({((96) != 0) ? ((s32)((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) - worldX + (96 / 2)) << 9) / (s32)(96)) : 0;}))
                        & (1024 - 1)
                    : (0x300 + ({((96) != 0) ? ((s32)((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) - worldX + (96 / 2)) << 9) / (s32)(96)) : 0;}))
                        & (1024 - 1);
...
void Task_BowlRotating(void)
{
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            ...
            if (!(((bowl->unk51) >> (i)) & 1)) {
                ...
                if (Coll_Player_Entity_Intersection(s, worldX - diff, 13 + worldY + sp08, &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                    ...
                    (unk48 = ((int)((bowl->unk48[0]) >> 8)));
                    bowl->unk3C[i] = (({((96) != 0) ? ((s32)((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) - worldX + (96 / 2)) << 9) / (s32)(96)) : 0;}) < 0)
                        ? (unk48 + 0x300 - ({((96) != 0) ? ((s32)((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) - worldX + (96 / 2)) << 9) / (s32)(96)) : 0;}))
                            & (1024 - 1)
                        : (unk48 + 0x300 + ({((96) != 0) ? ((s32)((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) - worldX + (96 / 2)) << 9) / (s32)(96)) : 0;}))
                            & (1024 - 1);
    ...
    do {
        if (((((bowl->unk51) >> (i)) & 1))) {
            s16 diff;
            s32 theta = ((((int)((bowl->unk48[i]) >> 8)) + bowl->unk3C[i] + ((bowl->unk50 & 0xF) << 6)) & (1024 - 1));

            if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = ((s32)((worldX)*256)) + ({((bowl->unk50 * 4 + 50) != 0) ? ((s32)((gSineTable[(theta)]) * 25) / (s32)(bowl->unk50 * 4 + 50)) : 0;});
                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((worldY)*256)) - ((s32)((17)*256)) + (bowl->unk48[i] >> 5);
            }
        }
    } while (++i < gNumSingleplayerCharacters);
    ...
    do {
        if ((((bowl->unk51) >> (i)) & 1)) {
            if ((bowl->unk48[i] >= 885000)) {
                if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = ((bowl->unk40[i] >> 2) - 0x7D0) * 2;
                }
            } else {
                {
                    bowl->unk40[i] += ((s32)((0.25)*256));
                }
            }
            ...
            s->animSpeed = ({((0xA000) != 0) ? ((s32)(bowl->unk40[i] * 35) / (s32)(0xA000)) : 0;});
            if (s->animSpeed > ((int)((float)(1.0)*0x10))) {
                s->animSpeed = ((int)((float)(1.0)*0x10));
            }
    ...
    i = 0;
    do {
        if (((((bowl->unk51) >> (i)) & 1)) && (bowl->unk48[i] >= 885000)) {
            bowl->unk48[i] = 885000;

            if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
                if (bowl->unk50 < 16) {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY += bowl->unk50 * (((s32)((11.25)*256)) / 16);
                } else {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY += ((s32)((11.25)*256));
                }
            }
