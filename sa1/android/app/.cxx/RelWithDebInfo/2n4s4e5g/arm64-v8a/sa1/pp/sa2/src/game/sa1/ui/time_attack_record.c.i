# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_record.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_record.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_record.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_record.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_record.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_record.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_record.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_record.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_record.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_record.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_record.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_attack_record.c" 2
...
void sub_8060C88(void)
{
    ...
    gfx.uiGfxID = 32;
    gfx.unk2B = 2;
    gfx.tiles = gUiGraphics[32].tiles;
    gfx.palette = gUiGraphics[32].palette;
    gfx.tilesSize = 0x580;
    gfx.paletteSize = 0x20;
    gfx.unk28 = 2;
    gfx.vramC = (u8 *)&VRAM[0x10000] + 0x20;
    gfx.unk2A = 0xD;
    gfx.unk0.unk4 = gUiGraphics[32].unk8;
    gfx.unk0.unk8 = gUiGraphics[32].unkC;
    gfx.unk0.unk9 = gUiGraphics[32].unk10;
    gfx.unk0.unkA = gUiGraphics[32].unk14;
    gfx.unk0.unkB = gUiGraphics[32].unk18;
    sub_80528AC(&gfx);
}
...
void CreateTimeAttackRecord(u8 arg0)
{
    ...
    strcE4 = (void *)((TaskCreate(sub_8061144, sizeof(TimeAttackRecord_E4), 0x2000U, 0U, TaskDestructor_806182C))->data);
    strcE4->unkD4 = 0;
    strcE4->unkDE = 8;
    strcE4->unkD8 = 0;
    strcE4->strc0.unk0 = 0;
    ...
    s = &strcE4->s2;
    s->graphics.dest = &VRAM[0x10000] + 0x1900;
    ...
    s = &strcE4->s3;
    s->graphics.dest = &VRAM[0x10000] + 0x2580;
    s->graphics.anim = 884;
    s->variant = 2;
    s->graphics.size = 0;
    s->x = 21;
    ...
    s = &strcE4->s4;
    s->graphics.dest = &VRAM[0x10000] + 0x3200;
    s->graphics.anim = 857;
    s->variant = 0;
    s->graphics.size = 0;
    s->x = 20;
    ...
    t = TaskCreate(sub_8061480, sizeof(TimeAttackRecord_58), 0x2030U, 0U, ((void*)0));
    strc58 = (void *)((t)->data);
    strc58->unk4C = 0;
    ...
    t = TaskCreate(Task_8061830, sizeof(TimeAttackRecord_58), 0x2080U, 0U, ((void*)0));
    strc58 = (void *)((t)->data);
    strc58->unk4C = 0;
    strc58->unk48 = 0;
    strc58->unk50 = 0;
    ...
    s = &strc58->s;
    s->graphics.dest = &VRAM[0x10000] + 0x8E0;
...
void sub_8061144()
{
    ...
    TimeAttackRecord_E4 *strcE4 = (void *)((gCurTask)->data);

    temp_r0 = (void *)((strcE4->taskCC)->data);
    temp_r0_2 = (void *)((strcE4->taskD0)->data);
    ...
    *temp_r2 = temp_r1;
    ...
    gHBlankCopySize = 4;
    {
        ...
        for (var_r7; var_r7 < 240; var_r7++) {
            for (var_r1 = 0; var_r7 < 240 && var_r1 < 24; var_r1++) {
...
void sub_80613D0()
{
    ...
    temp_r0 = ({((10) != 0) ? ((s32)(strcE4->unkD4) / (s32)(10)) : 0;});
    s->frameFlags |= ((1) << (10));
...
void sub_8061480()
{
    ...
    for (var_r7_2 = 0; var_r7_2 < 3; var_r7_2++) {
        struct TimeRecords *records = &(&gLoadedSaveGame)->timeRecords;
        strc58->overB.unkE = 1;
        ...
        if (temp_r5_4 >= ((int)(((10 * 60.) + 0) * 60))) {
            ...
            temp_r0 = ({((60) != 0) ? ((s32)(temp_r5_4) / (s32)(60)) : 0;});
            temp_r0_2 = ({((60) != 0) ? ((s32)(temp_r0) / (s32)(60)) : 0;});
...
void Task_8061830()
{
    ...
    TimeAttackRecord_58 *strc58 = (void *)((gCurTask)->data);
    Sprite *s = &strc58->s;
