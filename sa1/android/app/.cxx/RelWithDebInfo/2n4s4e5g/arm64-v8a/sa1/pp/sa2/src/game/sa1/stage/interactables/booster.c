# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/booster.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/booster.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/booster.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/booster.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/booster.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/booster.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/booster.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/booster.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/booster.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/booster.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/booster.c" 2
...
void CreateEntity_Booster_SlightLeft(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    s->graphics.dest = VramMalloc(((32 / 8) * (24 / 8)));
    s->graphics.anim = 471;
    s->variant = 2;
...
void Task_Booster(void)
{
    ...
    booster = (void *)((gCurTask)->data);
    s = &booster->s;
    me = booster->base.me;

    worldX = ((booster->base.meX)*8 + (booster->base.regionX)*256);
    worldY = ((me->y)*8 + (booster->base.regionY)*256);
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            ...
            if ((((((worldX) + s->hitboxes[0].b.left) <= ((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) + (*((Rect8 *)&arr)).left) && ((((worldX)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) + (*((Rect8 *)&arr)).left)) || (((worldX) + s->hitboxes[0].b.left) >= ((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) + (*((Rect8 *)&arr)).left) && ((((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)))) + ((*((Rect8 *)&arr))).left) + (((*((Rect8 *)&arr))).right - ((*((Rect8 *)&arr))).left)) >= ((worldX) + s->hitboxes[0].b.left))) && (((((worldY)) + s->hitboxes[0].b.top) <= (((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) + (*((Rect8 *)&arr)).top) && ((((worldY)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) + (*((Rect8 *)&arr)).top)) || ((((worldY)) + s->hitboxes[0].b.top) >= (((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) + (*((Rect8 *)&arr)).top) && ((((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) + (*((Rect8 *)&arr)).top) + (((*((Rect8 *)&arr))).bottom - ((*((Rect8 *)&arr))).top)) >= (((worldY)) + s->hitboxes[0].b.top))))) {
                if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000002)) {
                    ...
                    if (s->frameFlags & ((1) << (10))) {
                        if ((*(((i) != 0) ? &gPartner : &gPlayer)).charState == 9) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 4;
                        }

                        if (((*(((i) != 0) ? &gPartner : &gPlayer)).charState != 5) && ((*(((i) != 0) ? &gPartner : &gPlayer)).charState != 6)
                            && ((*(((i) != 0) ? &gPartner : &gPlayer)).charState != 7)) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 4;
                        }
                        (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000001;
                        if ((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround > -((s32)((9)*256))) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = -((s32)((12)*256));
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = -((s32)((12)*256));
                        }

                        (*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk62 = 0;
                    } else {
                        if ((*(((i) != 0) ? &gPartner : &gPlayer)).charState == 9) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 4;
                        }
