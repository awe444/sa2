# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/buzzer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/buzzer.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/buzzer.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/buzzer.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/buzzer.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/buzzer.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/buzzer.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/buzzer.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/buzzer.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/buzzer.c" 2
...
void CreateEntity_Buzzer(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    if (((gCurrentLevel) >> 1) != 0 || (&gLoadedSaveGame)->difficultyLevel == 0) {
        ...
        buzzer->unk40 = 0;
        buzzer->unk41 = 0;
        buzzer->qUnk42 = -((s32)((1)*256));
        buzzer->qUnk3C = ((s32)((0)*256));
        buzzer->unk40 = 0;
        ...
        if (((int)((gPlayer.qWorldX) >> 8)) >= ((buzzer->shared.base.meX)*8 + (buzzer->shared.base.regionX)*256)) {
            buzzer->qUnk42 = ((s32)((1)*256));
            (s)->frameFlags |= (((1) << (10)));
        }
...
void Task_BuzzerInit(void)
{
    Buzzer *buzzer = (void *)((gCurTask)->data);
    Sprite *s = &buzzer->shared.s;
    MapEntity *me = buzzer->shared.base.me;
    CamCoord worldX, worldY;
    s32 worldX2, worldY2;

    worldX = ((buzzer->shared.base.meX)*8 + (buzzer->shared.base.regionX)*256);
    worldY = ((me->y)*8 + (buzzer->shared.base.regionY)*256);

    buzzer->qUnk3C += buzzer->qUnk42;

    worldX += ((int)((buzzer->qUnk3C) >> 8));
    ...
    if (((int)((buzzer->qUnk3C) >> 8)) <= me->d.sData[0] * 8) {
        buzzer->qUnk42 = +((s32)((1.00)*256));
        s->prevVariant = -1;
        s->variant = 2;
        gCurTask->main = Task_Buzzer_801E190;
        (s)->frameFlags |= (((1) << (10)));
    } else if (((int)((buzzer->qUnk3C) >> 8)) >= (me->d.sData[0] + me->d.uData[2]) * 8) {
        buzzer->qUnk42 = -((s32)((1.00)*256));
        s->prevVariant = -1;
        s->variant = 2;
        gCurTask->main = Task_Buzzer_801E190;
        ...
        if ((worldY <= ((int)((gPlayer.qWorldY) >> 8))) && (worldY + 96 >= ((int)((gPlayer.qWorldY) >> 8)))) {
            s16 r8 = ((int)((gPlayer.qWorldY) >> 8)) - worldY;
            s32 playerX = ((int)((gPlayer.qWorldX) >> 8));
            s16 r2;
            s16 r6;
...
void CreateBuzzerProjectile(CamCoord worldX, CamCoord worldY)
{
    ...
    struct Task *t = TaskCreate(Task_BuzzerProjectileMain, sizeof(BuzzerProjectile), 0x9000, 0, ((void*)0));
    BuzzerProjectile *proj = (void *)((t)->data);
    Sprite *s = &proj->s;
    s16 res;

    res = sa2__sub_8004418(((int)((gPlayer.qWorldY) >> 8)) - worldY, ((int)((gPlayer.qWorldX) >> 8)) - worldX);
    proj->qUnk38 = ({((38) != 0) ? ((s32)((gSineTable[(res) + 256])) / (s32)(38)) : 0;});
    proj->qUnk3A = ({((38) != 0) ? ((s32)((gSineTable[(res)])) / (s32)(38)) : 0;});

    proj->qUnk30 = ((s32)((worldX)*256));
    proj->qUnk34 = ((s32)((worldY)*256));
    s->x = worldX;
    s->y = worldY;
...
void Task_BuzzerProjectileMain(void)
{
    BuzzerProjectile *proj = (void *)((gCurTask)->data);
    Sprite *s = &proj->s;
    ...
    if ((((u16)(s->x + (80 / 2)) > 320 + 80) || (s->y + (80 / 2) < 0) || (s->y > 240 + 40))) {
        TaskDestroy(gCurTask);
        return;
    }
