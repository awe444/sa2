# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/water_bridge.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/water_bridge.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/water_bridge.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/water_bridge.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/water_bridge.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/water_bridge.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/water_bridge.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/water_bridge.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/water_bridge.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/water_bridge.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/water_bridge.c" 2
...
void CreateEntity_WaterBridge(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    WaterBridge *bridge = (void *)((t)->data);
    Sprite *s;
    s32 worldX, worldY;
    s32 width, height;
    ...
    width = me->d.uData[2] * 8;
    height = me->d.uData[3] * 8;

    bridge->worldX = worldX;
    bridge->worldY = worldY;
    bridge->left = worldX + me->d.sData[0] * 8;
    bridge->top = worldY + me->d.sData[1] * 8;
...
void Task_WaterBridge(void)
{
    WaterBridge *bridge = (void *)((gCurTask)->data);
    Sprite *s;
    Player *p;
    ...
    do {
        ...
        playerWorldX = ((int)((p->qWorldX) >> 8));
        playerWorldY = ((int)((p->qWorldY) >> 8)) + p->spriteOffsetY;

        if (((bridge->worldX) > gCamera.x + (320 + (256 / 2)) || (bridge->worldX) < gCamera.x - (256 / 2) || (bridge->worldY) > gCamera.y + ((240) + ((256) / 2)) || (bridge->worldY) < gCamera.y - (256 / 2))) {
        ...
        if ((bridge->left <= playerWorldX) && (playerWorldX < bridge->right) && (bridge->top <= playerWorldY)
            ...
            theta = (((s32)(((playerWorldX - bridge->left) * 2) << 8)) / bridge->width);
            ...
            y = (((int)(((gSineTable[(theta)])) >> 6)) * bridge->height);
            y = (((s32)((bridge->bottom) << 8)) - ((y))) >> 8;

            if ((playerWorldY >= y) && (playerWorldY <= y + 32)) {
                s32 qCos = ((int)(((gSineTable[(theta) + 256])) >> 6));
                s32 qSpeedX, qSpeedY;
                ...
                if (p->moveState & 0x00000002) {
                    qSpeedX = p->qSpeedAirX + ((s32)((0.25)*256));
                } else {
                    qSpeedX = p->qSpeedGround + ((s32)((0.25)*256));
                }

                if (qSpeedX < -((s32)((8)*256))) {
                    qSpeedX = -((s32)((8)*256));
                } else if (qSpeedX > ((s32)((8)*256))) {
                    qSpeedX = ((s32)((8)*256));
                }
                ...
                qSpeedY = (((-bridge->height * qCos) * qSpeedX) >> 16) - ((s32)((42. / 256.)*256));
                if (qSpeedY < -((s32)((8)*256))) {
                    qSpeedY = -((s32)((8)*256));
                } else if (qSpeedY > ((s32)((8)*256))) {
                    qSpeedY = ((s32)((8)*256));
                }
