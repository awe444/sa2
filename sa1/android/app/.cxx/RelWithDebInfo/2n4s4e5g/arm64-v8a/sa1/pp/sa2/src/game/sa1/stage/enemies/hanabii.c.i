# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/hanabii.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/hanabii.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/hanabii.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/hanabii.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/hanabii.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/hanabii.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/hanabii.c" 2
...
void CreateEntity_Hanabii(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    hanabii->qUnk44 = -((s32)((0.625)*256));
    hanabii->qUnk3C = ((s32)((0)*256));
    hanabii->unk40 = 0;
    hanabii->unk46 = 0;
    hanabii->unk48 = 0;
...
void Task_HanabiiInit(void)
{
    Hanabii *hanabii = (void *)((gCurTask)->data);
    Sprite *s = &hanabii->shared.s;
    ...
    worldX = ((hanabii->shared.base.meX)*8 + (hanabii->shared.base.regionX)*256);
    worldY = ((me->y)*8 + (hanabii->shared.base.regionY)*256);
    ...
    deltaX = worldX2 + ((int)((hanabii->qUnk3C) >> 8));
    ...
    hanabii->unk40 += sa2__sub_801F07C(deltaY, deltaX, 1, +8, ((void*)0), sa2__sub_801EE64);

    xSquared = ((int)((gPlayer.qWorldX) >> 8)) - deltaX;
    xSquared = xSquared * xSquared;
    ySquared = ((int)((gPlayer.qWorldY) >> 8)) - deltaY;
    ySquared = ySquared * ySquared;

    if (((int)((hanabii->qUnk3C) >> 8)) <= (me->d.sData[0] + 1) * 8) {
        if (~s->frameFlags & ((1) << (10))) {
            (s)->frameFlags |= (((1) << (10)));
            hanabii->qUnk44 = +((s32)((0.625)*256));
        }
    } else if (((int)((hanabii->qUnk3C) >> 8)) >= (me->d.sData[0] + me->d.uData[2]) * 8) {
        if (s->frameFlags & ((1) << (10))) {
            (s)->frameFlags &= ~(((1) << (10)));
            hanabii->qUnk44 = -((s32)((0.625)*256));
        }
...
void Task_806D804(void)
{
    ...
    hanabii->unk40 += sa2__sub_801F07C(deltaY, deltaX, 1, +8, &sp08, sa2__sub_801EE64);
...
void CreateHanabiiProjectile(CamCoord worldX, CamCoord worldY)
{
    ...
    HanabiiProjectile *proj = (void *)((t)->data);
    Sprite *s = &proj->s;

    proj->unk30 = worldX * 4;
    proj->qUnk34 = -((s32)((3.6875)*256));
    proj->unk36 = 0;
...
void Task_HanabiiProjectile(void)
{
    HanabiiProjectile *proj = (void *)((gCurTask)->data);
    Sprite *s = &proj->s;
...
void Task_HanabiiProjectile2(void)
{
    ...
    if ((((u16)(s->x + (120 / 2)) > 320 + 120) || (s->y + (120 / 2) < 0) || (s->y > 240 + 140) || ((u8)unk36 > 20))) {
        TaskDestroy(gCurTask);
        return;
    }
