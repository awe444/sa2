# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kiki.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kiki.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kiki.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kiki.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kiki.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kiki.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kiki.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kiki.c" 2
...
void CreateEntity_Kiki(MapEntity *me, u16 spriteRegionX, u16 spriteRegionY, u8 spriteY)
{
    ...
    s->x = ((me->x)*8 + (spriteRegionX)*256);
    s->y = ((me->y)*8 + (spriteRegionY)*256);
...
static void Task_KikiMain(void)
{
    Sprite_Kiki *kiki = (void *)((gCurTask)->data);
    Sprite *s = &kiki->s;
    MapEntity *me = kiki->base.me;
    s16 x, y;


    x = ((kiki->base.meX)*8 + (kiki->base.regionX)*256);



    y = ((me->y)*8 + (kiki->base.regionY)*256);
    ...
    } else if (((kiki->unk3D >= (me->d.sData[1] * 8 + me->d.uData[3] * 8)))) {
        kiki->unk3C = -1;
    }
    ...
    { {} }; UpdateSpriteAnimation(s); DisplaySprite(s);;
}
...
# 266 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kiki.c"
    UpdateSpriteAnimation(s);
...
static void CreateKikiProjectile(s16 x, s16 y)
{
    ...
    const TaskDestructor dtor = ((void*)0);
    ...
    proj->unk38 = x;
    if (((int)((gPlayer.qWorldX) >> 8)) < x) {
        proj->unk34 = -({((800) != 0) ? ((s32)((x - ((int)((gPlayer.qWorldX) >> 8))) * 400) / (s32)(800)) : 0;});
        if (proj->unk34 < -0x3C) {
            proj->unk34 = -60;
        }
    } else {
        proj->unk34 = ({((800) != 0) ? ((s32)((((int)((gPlayer.qWorldX) >> 8)) - x) * 400) / (s32)(800)) : 0;});
...
static void Task_KikiProjMain(void)
{
    Kiki_Proj *proj = (void *)((gCurTask)->data);
    Sprite *s = &proj->s;
    s16 x, y;
    ...
    s->x = proj->unk38 + ({((0x28) != 0) ? ((s32)(proj->unk36) / (s32)(0x28)) : 0;});
    s->y += ((int)((proj->unk32) >> 8));

    if (proj->unk32 && proj->unk32 > -1) {
        s32 delta = sa2__sub_801F07C(s->y, s->x, 1, 8, 0, sa2__sub_801EE64);
        if (delta < 0) {
            s->y += delta;
            if (proj->unk30 == 0) {
...
static void Task_ProjPieceMain(void)
{
    ...
    if ((s->hitboxes[0].index != -1) && (s2->hitboxes[0].index != -1)) {
        ...
        x2 = ((int)((gPlayer.qWorldX) >> 8)) + s2->hitboxes[0].b.left;
        if ((x1 <= x2 && x1 + (s->hitboxes[0].b.right - s->hitboxes[0].b.left) >= x2)
            ...
            y2 = ((int)((gPlayer.qWorldY) >> 8)) + s2->hitboxes[0].b.top;
...
# 478 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/kiki.c"
    }
    s->x -= gCamera.x;
    s->y -= gCamera.y;
