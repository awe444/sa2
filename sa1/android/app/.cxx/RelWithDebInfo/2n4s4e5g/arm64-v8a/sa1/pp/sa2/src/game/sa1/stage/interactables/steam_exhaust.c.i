# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/steam_exhaust.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/steam_exhaust.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/steam_exhaust.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/steam_exhaust.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/steam_exhaust.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/steam_exhaust.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/steam_exhaust.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/steam_exhaust.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/steam_exhaust.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/steam_exhaust.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/interactables.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/steam_exhaust.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/steam_exhaust.c" 2
...
void CreateEntity_SteamExhaust(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    SteamExhaust *exhaust = (void *)((t)->data);
    Sprite *s = &exhaust->s;
    ...
    s->graphics.dest = VramMalloc(((32 / 8) * (48 / 8)));
    s->graphics.anim = 501;
    s->variant = 0;
    s->oamFlags = ((18) << 6);
    s->graphics.size = 0;
    ...
    s2->graphics.dest = VramMalloc(((32 / 8) * (16 / 8)));
    s2->graphics.anim = 501;
    s2->variant = 2;
    s2->oamFlags = ((17) << 6);
    s2->graphics.size = 0;
    s2->animCursor = 0;
...
void Task_SteamExhaust(void)
{
    SteamExhaust *exhaust = (void *)((gCurTask)->data);
    ...
    worldX = ((exhaust->base.meX)*8 + (exhaust->base.regionX)*256);
    worldY = ((me->y)*8 + (exhaust->base.regionY)*256);
    ...
    i = 0;
    do {
        if (Coll_Player_Platform(s2, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer))) & 0x00000008) {
            (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY += ((s32)((1)*256));
            continue;
        } else {
            if ((((*(((i) != 0) ? &gPartner : &gPlayer)).stoodObj == s)


                 || ((*(((i) != 0) ? &gPartner : &gPlayer)).stoodObj == s2)
                ...
                {
                    s32 res = sa2__sub_801E4E4(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) - 19, ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)), (*(((i) != 0) ? &gPartner : &gPlayer)).layer, -8, ((void*)0),
                                                     sa2__sub_801EE64);

                    if (res < 0) {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY += ((s32)((res)*256));
                    }
                }
            } else {
                if (Coll_Player_Platform(s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                    s32 res = sa2__sub_801E4E4(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) - 19, ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)), (*(((i) != 0) ? &gPartner : &gPlayer)).layer, -8, ((void*)0),
                                                     sa2__sub_801EE64);
    ...
    if (((worldX) > gCamera.x + (320 + (256 / 2)) || (worldX) < gCamera.x - (256 / 2) || (worldY) > gCamera.y + ((240) + ((256) / 2)) || (worldY) < gCamera.y - (256 / 2)) && (((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
        { me->x = exhaust->base.meX; };
        TaskDestroy(gCurTask);
        return;
    }

    if (({((160) != 0) ? ((s32)(gStageTime) % (s32)(160)) : 0;}) == 0) {
        exhaust->unk84 = 0x66;
        exhaust->unk74 = 0;
        exhaust->qLidAcceleration = -((s32)((5)*256));
        exhaust->qLidOffsetY = +((s32)((0)*256));
        exhaust->unk80 = 3;
...
void Task_SteamExhaust2(void)
{
    ...
    exhaust->qLidAcceleration += ((s32)((37. / 256.)*256));
    exhaust->qLidOffsetY += exhaust->qLidAcceleration;

    s->x = worldX - gCamera.x;
    s->y = worldY - gCamera.y;
    s2->x = worldX - gCamera.x;
    s2->y = worldY - gCamera.y + ((int)((exhaust->qLidOffsetY) >> 8));

    i = 0;
    do {
        if ((((exhaust->unk74) >> (i)) & 1)) {
            (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY += exhaust->qLidAcceleration;

            if ((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000002) {
                (exhaust->unk74) &= ~(1 << (i));
            }

            if (!Coll_Player_Entity_Intersection(s2, worldX, worldY + ((int)((exhaust->qLidOffsetY) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                (exhaust->unk74) &= ~(1 << (i));
            }
        }

        if (Coll_Player_PlatformCrumbling(s2, worldX, worldY + ((int)((exhaust->qLidOffsetY) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
            (exhaust->unk74) |= (1 << (i));
    ...
    if (exhaust->qLidOffsetY >= 0) {
        if (--exhaust->unk80 != 0) {
            exhaust->qLidAcceleration = -({((5) != 0) ? ((s32)(exhaust->qLidAcceleration * 2) / (s32)(5)) : 0;});
            exhaust->unk74 = 0;
            exhaust->qLidOffsetY = 0;
        } else {
            s->prevVariant = -1;
    ...
    if (--exhaust->unk84 == 48) {
        ...
        s32 i = 0;
        do {
            Hitbox *hb = &(*((i != 0) ? &gPartnerBodyPSI : &gPlayerBodyPSI)).s.hitboxes[0];
            if (hb->index != -1
                && (((((worldX) + s->hitboxes[1].b.left) <= ((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) + (&(*((i != 0) ? &gPartnerBodyPSI : &gPlayerBodyPSI)).s.hitboxes[0])->b.left) && ((((worldX)) + (s->hitboxes[1].b).left) + ((s->hitboxes[1].b).right - (s->hitboxes[1].b).left)) >= ((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) + (&(*((i != 0) ? &gPartnerBodyPSI : &gPlayerBodyPSI)).s.hitboxes[0])->b.left)) || (((worldX) + s->hitboxes[1].b.left) >= ((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) + (&(*((i != 0) ? &gPartnerBodyPSI : &gPlayerBodyPSI)).s.hitboxes[0])->b.left) && ((((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)))) + ((&(*((i != 0) ? &gPartnerBodyPSI : &gPlayerBodyPSI)).s.hitboxes[0])->b).left) + (((&(*((i != 0) ? &gPartnerBodyPSI : &gPlayerBodyPSI)).s.hitboxes[0])->b).right - ((&(*((i != 0) ? &gPartnerBodyPSI : &gPlayerBodyPSI)).s.hitboxes[0])->b).left)) >= ((worldX) + s->hitboxes[1].b.left))) && (((((worldY)) + s->hitboxes[1].b.top) <= (((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) + (&(*((i != 0) ? &gPartnerBodyPSI : &gPlayerBodyPSI)).s.hitboxes[0])->b.top) && ((((worldY)) + s->hitboxes[1].b.top) + ((s->hitboxes[1].b).bottom - (s->hitboxes[1].b).top)) >= (((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) + (&(*((i != 0) ? &gPartnerBodyPSI : &gPlayerBodyPSI)).s.hitboxes[0])->b.top)) || ((((worldY)) + s->hitboxes[1].b.top) >= (((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) + (&(*((i != 0) ? &gPartnerBodyPSI : &gPlayerBodyPSI)).s.hitboxes[0])->b.top) && ((((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) + (&(*((i != 0) ? &gPartnerBodyPSI : &gPlayerBodyPSI)).s.hitboxes[0])->b.top) + (((&(*((i != 0) ? &gPartnerBodyPSI : &gPlayerBodyPSI)).s.hitboxes[0])->b).bottom - ((&(*((i != 0) ? &gPartnerBodyPSI : &gPlayerBodyPSI)).s.hitboxes[0])->b).top)) >= (((worldY)) + s->hitboxes[1].b.top))))) {
