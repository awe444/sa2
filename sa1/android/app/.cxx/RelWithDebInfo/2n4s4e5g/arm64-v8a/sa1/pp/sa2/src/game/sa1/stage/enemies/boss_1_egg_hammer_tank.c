# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_1_egg_hammer_tank.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_1_egg_hammer_tank.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_1_egg_hammer_tank.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_1_egg_hammer_tank.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/malloc_vram.h" 1
# 24 "/home/awaszczak/git/sa2/sa1/../include/malloc_vram.h"
void *VramMalloc(u32);
void VramResetHeapState(void);
void VramFree(void *);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_1_egg_hammer_tank.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_1_egg_hammer_tank.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_1_egg_hammer_tank.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_1_egg_hammer_tank.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_1_egg_hammer_tank.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_1_egg_hammer_tank.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_1_egg_hammer_tank.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_1_egg_hammer_tank.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_1_egg_hammer_tank.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_1_egg_hammer_tank.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_1_egg_hammer_tank.c" 2
...
typedef struct EggHammerTank {
               ...
               Hitbox reserved;
               Sprite s2;
               struct Task *taskHammer;
               struct Task *tasksArm[5];
               s32 qUnk8C;
               s32 qUnk90;
               s16 unk94;
               s16 unk96;
...
void Task_EggHammerTank_Intro(void)
{
    ...
    tank = (void *)((gCurTask)->data);
    base = &tank->base;
    s = &tank->s;
    s2 = &tank->s2;
    me = tank->base.me;

    worldX = ((base->meX)*8 + (base->regionX)*256);
    worldY = ((me->y)*8 + (base->regionY)*256);
    ...
    if (gCamera.x < (gCamera.maxX - 320)) {
        gCamera.minX = (u16)gCamera.x;
    } else {
        gCamera.minX = (u16)gCamera.maxX - 320;
    }

    if (worldX - gCamera.x <= 320 - 64) {
...
void Task_8025D80(void)
{
    ...
    if (acmdRes == ACMD_RESULT__ENDED) {
        ...
        s2->variant = 0;
        s2->frameFlags |= 0x400;
        CreatePreBossCameraPan((worldY - 48), (worldY + (240 - 48)));
    }
}
...
void Task_8025E6C(void)
{
    ...
    tank->qUnk8C += ((s32)((2)*256));

    worldX = ((base->meX)*8 + (base->regionX)*256) + ((int)((tank->qUnk8C) >> 8));
    worldY = ((me->y)*8 + (base->regionY)*256);
...
void CreateEntity_EggHammerTank(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    s->graphics.dest = VramMalloc(((80 / 8) * (56 / 8)));
    s->oamFlags = 0x4C0;
    s->graphics.size = 0;
    s->graphics.anim = 607;
    s->variant = 1;
    ...
    s->graphics.dest = VramMalloc(((32 / 8) * (16 / 8)));
    s->oamFlags = 0x480;
    s->graphics.size = 0;
    s->graphics.anim = 610;
    s->variant = 0;
    ...
    gCamera.minX = (((float)gCamera.maxX) - (320 * 1.5f));
...
void Task_802611C(void)
{
    ...
    if (s->frameFlags & ((1) << (10))) {
        tank->qUnk8C += ((s32)((1)*256));
    } else {
        tank->qUnk8C -= ((s32)((1)*256));
    }

    worldX = ((tank->base.meX)*8 + (tank->base.regionX)*256) + ((int)((tank->qUnk8C) >> 8));
    worldY = ((me->y)*8 + (tank->base.regionY)*256);
    s->frameFlags &= ~0x180;
    ...
    if (tank->unk9B != 0) {
        if (--tank->unk9B > 0x10) {
            if (!(tank->unk9B & 2) && (!(gPlayer.moveState & 0x00000080))) {
...
void Task_80264C8(void)
{
    ...
    if (tank->unk94 < -0x300) {
        tank->unk94 += 0x400;
        tank->qUnk8C -= (gSineTable[(56) + 256]) * 3;
    ...
    if ((tank->unk94 <= -568)) {
        ...
        sp08 = -((s32)(((gSineTable[(56) + 256]) - (gSineTable[(theta) + 256])) * 3) >> 9);
        sp0C = -((s32)(((gSineTable[(theta)]) - (gSineTable[(56)])) * 3) >> 9);
    ...
    worldX = ((tank->base.meX)*8 + (tank->base.regionX)*256) + ((int)((tank->qUnk8C) >> 8)) + sp08;
    worldY = ((me->y)*8 + (tank->base.regionY)*256) + sp0C;
    ...
    if (tank->unk9B == 0) {
        ...
        if ((collPlayer == HIT_ENEMY) || (collPartner == HIT_ENEMY)) {
            ...
            tank->qUnk8C += ((s32)((sp08)*256));
            tank->qUnk90 = ((s32)((sp0C)*256));
...

            {
                ...
                if (s->frameFlags & ((1) << (10))) {
                    strc->transform.qScaleX = -((s32)((1)*256));
                    strc->qUnk44 = +((s32)((4)*256));
                } else {
                    strc->qUnk44 = -((s32)((4)*256));
                }
...
void Task_8026C44(void)
{
    ...
    worldX = ((base->meX)*8 + (base->regionX)*256) + ((int)((tank->qUnk8C) >> 8));
    worldY = ((me->y)*8 + (base->regionY)*256) + ((int)((tank->qUnk90) >> 8));

    res = sa2__sub_801F100(worldY - 8, worldX, 1, 8, sa2__sub_801EC3C);
    if (res < 0) {
        tank->qUnk90 += ((s32)((res)*256));

        tank->qUnk9E = (tank->qUnk9E >> 2) - tank->qUnk9E;
        if (tank->qUnk9E > -((s32)((1)*256))) {
            tank->qUnk9E = 0U;
    ...
    if (!(tank->unk98 & 7)) {
        ...
        bolts->qUnk34 = ((s32)((worldY - 0x20)*256));
        sprBolts->frameFlags = 0x2000;
        sprBolts->oamFlags = 0x440;
        bolts->qUnk3E = ((s32)((40. / 256.)*256));
        ...
        a0 = ((s32)(((worldX + (0x3F & rnd)) - 0x20)*256));
        a1 = (((rnd & 0x3F0000) >> 0x10));
        a1 += 32;
        sub_8017540(a0, ((s32)((worldY)*256)) - ((s32)((a1)*256)));
    }
...
void Task_80271E4(void)
{
    ...
    arm = (void *)((gCurTask)->data);
    s = &arm->s;
    tf = &arm->transform;
    tf->rotation = 0;

    arm->unk3C = (((gSineTable[(gSpriteTransformRotation) + 256]) * 0x10 * arm->unk50) >> 0xE) + (gCamera.x + gSpriteTransformX);
    arm->unk3E = (((gSineTable[(gSpriteTransformRotation)]) * 0x10 * arm->unk50) >> 0xE) + (gCamera.y + gSpriteTransformY);

    if (arm->unk50) {
        arm->qUnk4C = +((s32)((2)*256));
    } else {
        arm->qUnk4C = -((s32)((2)*256));
    }

    arm->qUnk4E = -((s32)((6)*256));
    arm->qUnk44 = 0;
    arm->qUnk48 = 0;
    arm->unk40 = 0;
    s->frameFlags &= ~0x20;
...
void Task_80272D0(void)
{
    ...
    if (arm->qUnk4E > 0) {
        s32 res = sa2__sub_801F100(arm->unk3E + ((int)((arm->qUnk48) >> 8)), arm->unk3C + ((int)((arm->qUnk44) >> 8)), 1, 8, sa2__sub_801EC3C);
        if (res < 0) {
            arm->qUnk48 = arm->qUnk48 + ((s32)((res)*256));
            arm->qUnk4E = (arm->qUnk4E >> 2) - arm->qUnk4E;
        }
    }

    temp_r1_3 = arm->unk3C + ((int)((arm->qUnk44) >> 8));
    if ((temp_r1_3 > (s32)(gCamera.x + 320)) || (temp_r1_3 < gCamera.x)) {
        arm->qUnk4C = -arm->qUnk4C;
    }

    if (!(arm->unk40 & 0x7)) {
        sub_8017540(((s32)((arm->unk3C)*256)) + arm->qUnk44, ((s32)((arm->unk3E)*256)) + arm->qUnk48);
    }
...
void Task_EHTHammer(void)
{
    ...
    hammer = (void *)((gCurTask)->data);
    s = &hammer->s;
    tf = &hammer->transform;
    tank = (void *)(((struct Task *)((gCurTask)->parent))->data);
    sprTank = &tank->s2;
    tf->rotation = 0U;

    if (tank->unk94 < 0) {
        s16 temp_r1_2 = -tank->unk94 - ((s32)((2)*256));
        if (temp_r1_2 > 0) {
...

    {
        ...
        x32 = (gSineTable[(gSpriteTransformRotation) + 256]) * 3;
        y32 = (gSineTable[(gSpriteTransformRotation)]) * 3;
...
void Task_8027600(void)
{
    ...
    if (x < gCamera.x + (320 / 2)) {
        hammer->qUnk4C = +((s32)((2)*256));
    } else {
        hammer->qUnk4C = -((s32)((2)*256));
    }
    hammer->qUnk4E = -((s32)((6)*256));

    hammer->qUnk44 = ((s32)((0)*256));
    hammer->qUnk48 = ((s32)((0)*256));
    hammer->unk40 = 0;
    hammer->unk42 = 42;
...
void Task_8027714(void)
{
    ...
    EHTHammer *hammer = (void *)((gCurTask)->data);
    s = &hammer->s;
    tf = &hammer->transform;
    ...
    if (hammer->qUnk4E > 0) {
        s32 res = sa2__sub_801F100(hammer->unk3E + ((int)((hammer->qUnk48) >> 8)), hammer->unk3C + ((int)((hammer->qUnk44) >> 8)), 1, 8, sa2__sub_801EC3C);
        if (res < 0) {
            hammer->qUnk48 = hammer->qUnk48 + ((s32)((res)*256));
    ...
    if (!(hammer->unk40 & 0x7)) {
        sub_8017540(((s32)((hammer->unk3C)*256)) + hammer->qUnk44, ((s32)((hammer->unk3E)*256)) + hammer->qUnk48);
    }
...
{
    EggHammerTank *tank = (void *)((t)->data);
...
void Task_EggHammerTankMain(void)
{
    ...
    tank = (void *)((gCurTask)->data);
    if (tank->unk98++ > 120) {
        for (i = 0; i < (sizeof(tank->tasksArm) / sizeof((tank->tasksArm)[0])); i++) {
