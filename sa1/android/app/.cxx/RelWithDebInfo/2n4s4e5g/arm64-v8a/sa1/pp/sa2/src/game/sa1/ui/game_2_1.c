# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_1.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_1.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_1.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_1.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_1.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_1.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_1.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_1.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_1.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_1.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_1.c" 2


# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_1.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_1.c" 2
...
void sub_805C900(u8 arg0)
{
    ...
    for (var_r4 = 6; var_r4 >= 0; var_r4--) {
        ...
        temp_r0_2 = ({((10) != 0) ? ((s32)(var_r6) / (s32)(10)) : 0;});
...
void sub_805C994(u8 arg0)
{
    ...
    gfx.uiGfxID = 16;
    gfx.unk2B = 8;
    gfx.tiles = gUiGraphics[16].tiles;
    gfx.palette = gUiGraphics[16].palette;
    gfx.tilesSize = 0x200;
    gfx.paletteSize = 0x20;
    gfx.unk28 = 14;
    gfx.vramC = &VRAM[0x10000] + 0x77A0;
    gfx.unk2A = 13;
    gfx.unk0.unk4 = gUiGraphics[16].unk8;
    gfx.unk0.unk8 = gUiGraphics[16].unkC;
    gfx.unk0.unk9 = gUiGraphics[16].unk10;
    gfx.unk0.unkA = gUiGraphics[16].unk14;
    gfx.unk0.unkB = gUiGraphics[16].unk18;
    sub_80528AC(&gfx);
...
void sub_805D048(u8 arg0)
{
    ...
    if (gSpecialStageCollectedRings >= gSpecialStageTargetRings) {
        ...
        sp24 = 1;
        sp20 = 0x2710;
        if (((((&gLoadedSaveGame)->chaosEmeralds) >> (gUnknown_08487134[gCurrentLevel])) & 1)) {
            var_r8 = 1;
        } else {
            ((&gLoadedSaveGame)->chaosEmeralds) |= (1 << (gUnknown_08487134[gCurrentLevel]));
            var_r8 = 0;
        }
    } else {
        m4aSongNumStart(46);
    ...
    temp_sb = (&gLoadedSaveGame)->chaosEmeralds;
    temp_sl = gSpecialStageCollectedRings;
    temp_r0 = gUnknown_0300507C + var_r8;
    sa2__gUnknown_0300543C = sa2__gUnknown_0300543C + temp_r0;

    { s32 divResA, divResB; s32 oldScore = gLevelScore; gLevelScore += sp20 + temp_sl * 100; divResA = ({((50000) != 0) ? ((s32)(gLevelScore) / (s32)(50000)) : 0;}); divResB = ({((50000) != 0) ? ((s32)(oldScore) / (s32)(50000)) : 0;}); if ((divResA != divResB) && (gGameMode == 0)) { u16 lives = divResA - divResB; lives += gNumLives;; ({ if ((lives) > 255) (lives) = 255; gNumLives = (lives); }); if (0) gMusicManagerState.unk3 = 0x10 | 0x0; } };

    if (sp20 > (temp_sl * 100)) {
        var_r7 = ({((100) != 0) ? ((s32)(sp20) / (s32)(100)) : 0;});
    } else {
        var_r7 = temp_sl;
    }
    ...
    task1C = TaskCreate(Task_805D684, sizeof(Game_2_1_34), 0x2120U, 0U, ((void*)0));
    temp_r2 = (void *)((task1C)->data);
    temp_r2->unk20 = 0;
    ...
    task18 = TaskCreate(Task_805D720, sizeof(Game_2_1_34), 0x2120U, 0U, ((void*)0));
    temp_r2 = (void *)((task18)->data);
    temp_r2->unk20 = 0;
    temp_r2->unk22 = var_r7;
    temp_r2->unk24 = 0;
    ...
    taskC = TaskCreate(Task_805D8EC, sizeof(Game_2_1_34), 0x2120U, 0U, ((void*)0));
    ...
    task24 = TaskCreate(Task_805DB04, sizeof(Game_2_1_34), 0x2120U, 0U, ((void*)0));
    temp_r2 = (void *)((task24)->data);
    temp_r2->unk20 = 0;
    temp_r2->unk22 = var_r7;
    temp_r2->unk24 = 0;
    temp_r2->u.strc0.unk0 = 0x100;
    ...
    task10 = TaskCreate(Task_805DD10, sizeof(Game_2_1_34), 0x2120U, 0U, ((void*)0));
    ...
    task14 = TaskCreate(Task_805DF2C, sizeof(Game_2_1_34), 0x2120U, 0U, ((void*)0));
    temp_r2 = (void *)((task14)->data);
    temp_r2->unk20 = 0;
    temp_r2->unk22 = var_r7;
    temp_r2->unk24 = 0;
    temp_r2->u.strc0.unk0 = 0x100;
    ...
    task20 = TaskCreate(sub_805E018, sizeof(Game_2_1_34), 0x2120U, 0U, ((void*)0));
    temp_r2 = (void *)((task20)->data);
    temp_r2->unk20 = 0;
    temp_r2->unk22 = var_r7;
    temp_r2->unk24 = 0;
    ...
    temp_r0_10 = (void *)((TaskCreate(sub_805D4F0, sizeof(Game_2_1_2C), 0x2100U, 0U, TaskDestructor_805E1E4))->data);
    temp_r0_10->unk28 = 0;
...
void sub_805D4F0()
{
    ...
    Game_2_1_2C *strc2C = (void *)((gCurTask)->data);
    Game_2_1_34 *subA = (void *)((strc2C->task1C)->data);
    Game_2_1_34 *subB = (void *)((strc2C->task18)->data);
    Game_2_1_34 *subC = (void *)((strc2C->taskC)->data);
    Game_2_1_34 *subD = (void *)((strc2C->task24)->data);
    Game_2_1_34 *subE = (void *)((strc2C->task10)->data);
    Game_2_1_34 *subF = (void *)((strc2C->task14)->data);
    Game_2_1_34 *subG = (void *)((strc2C->task20)->data);
    ...
    if ((strc2C->unk28 > 0xAA) && (strc2C->unk28 < (strc2C->unk2A + 0xAA)) && (({((4) != 0) ? ((s32)(strc2C->unk28) % (s32)(4)) : 0;}) == 0)) {
...
void Task_805D720()
{
    ...
    if (unk20 > ((u16)strc34->unk22 + 0x221)) {
        ...
        if (strc34->u.overB.qUnkA < -0x1F) {
            ...
            strc34->unk24 = ({((10) != 0) ? ((s32)(strc34->unk24 + 1) % (s32)(10)) : 0;});
        }
        ...
        if (strc34->u.overB.qUnkA < -0x1F) {
            strc34->u.overB.qUnkA += 0x20;
            strc34->unk24 = ({((0xA) != 0) ? ((s32)(strc34->unk24 + 1) % (s32)(0xA)) : 0;});
        }
        ...
        if (strc34->u.overB.qUnkA < 0xF0) {
            ...
            if (strc34->u.overB.qUnkA < -0x1F) {
                strc34->u.overB.qUnkA += 0x20;
                strc34->unk24 = ({((0xA) != 0) ? ((s32)((u16)strc34->unk24 + 1) % (s32)(0xA)) : 0;});
            }
            sub_8052F78((const char *)&sp00[strc34->unk24], &strc34->u.overB);
        }
    }
...
void sub_805D81C(void)
{
    ...
    Game_2_1_34 *strc34 = (void *)((gCurTask)->data);
    ...
    if (strc34->unk20 <= (strc34->unk22 + 558)) {
        ...
        if (strc34->u.strc0.unk2 == 0x100) {
            ...
            s32 divResB = ({((25) != 0) ? ((s32)(strc34->u.strc0.unk2) / (s32)(25)) : 0;});
...
void sub_805D9E4()
{
    ...
    if (strc34->unk20 <= (strc34->unk22 + 558)) {
        ...
        if (strc34->u.strc0.unk2 == 0x100) {
            ...
            s32 divResB = ({((25) != 0) ? ((s32)((s32)strc34->u.strc0.unk2) / (s32)(25)) : 0;});
    ...
    if (temp_r1 > (strc34->unk22 + 545)) {
        ...
        for (i = 0; i < 7; i++) {
            ...
            if (var_r5 >= temp_r0) {
                ...
                temp_r4 = ({((80) != 0) ? ((s32)((gSineTable[(0) + 256])) / (s32)(80)) : 0;});
                strc34->u.overB.qUnkA = ((i << 5) + (temp_r4 + 5)) - ({((80) != 0) ? ((s32)((gSineTable[(var_r5 * 5)])) / (s32)(80)) : 0;});
                if ((strc34->unk29 >> i) & 1) {
                    strc34->u.overB.unk12 = (u16)(0xD - (i >> 1));
                    if (i & 1) {
                        sub_8052F78("!", &strc34->u.overB);
