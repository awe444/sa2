# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/panel_gate.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/panel_gate.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/panel_gate.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/panel_gate.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/panel_gate.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/panel_gate.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/panel_gate.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/panel_gate.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/panel_gate.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/panel_gate.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/panel_gate.c" 2
...
void CreateEntity_PanelGate_Vertical(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    s->graphics.dest = VramMalloc(((16 / 8) * (32 / 8)));
    s->oamFlags = ((18) << 6);
    s->graphics.size = 0;
    s->graphics.anim = 496;
    s->variant = 0;
...
void Task_PanelGate_Vertical(void)
{
    PanelGate *gate = (void *)((gCurTask)->data);
    Sprite *s = &gate->s;
    MapEntity *me = gate->base.me;
    CamCoord worldX, worldY;
    s32 i;

    worldX = ((gate->base.meX)*8 + (gate->base.regionX)*256);
    worldY = ((me->y)*8 + (gate->base.regionY)*256);
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            if (s->frameFlags & ((1) << (10))) {
                u32 res = Coll_Player_Entity_Intersection(s, worldX - 6, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)));
                if (res) {
                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX > ((s32)((0)*256))) {
                        Coll_Player_Gate(s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)), 0);
                    }
                }
            } else {
                u32 res = Coll_Player_Entity_Intersection(s, worldX + 6, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)));
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            if (s->frameFlags & ((1) << (11))) {
                u32 res = Coll_Player_Entity_Intersection(s, worldX, worldY + 5, &(*(((i) != 0) ? &gPartner : &gPlayer)));
                if (res) {
...
bool32 sub_8081C04(PanelGate *gate, Sprite *s, s32 worldX, s32 worldY)
{
    ...
    i = 0;
    do {
        qTempPlayerY = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY;

        if (s->frameFlags & ((1) << (10))) {
            if ((worldX <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldX + 32 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldY - 40 <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))
                && (worldY + 40 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) {
                if ((worldX <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldX + 32 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)))) {
                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX < ((s32)((0)*256))) {
                        gate->unk3C = 0x7D;
                        s->variant = 1;
            ...
            if ((worldX - 32 <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldX + 16 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldY - 40 <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))
                && (worldY + 40 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) {
                if ((worldX - 32 <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldX >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)))) {
                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX > ((s32)((0)*256))) {
                        gate->unk3C = 0x7D;
                        s->variant = 1;
        ...
        (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = qTempPlayerY;
    } while (++i < gNumSingleplayerCharacters);
...
bool32 sub_8081F50(PanelGate *gate, Sprite *s, s32 worldX, s32 worldY)
{
    ...
    do {
        ...
        if (s->frameFlags & ((1) << (11))) {
            if ((worldX <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldX + 32 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldY <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))
                && (worldY + 28 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) {
            ...
            if ((worldX <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldX + 32 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldY - 28 <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))
                && (worldY >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) {
