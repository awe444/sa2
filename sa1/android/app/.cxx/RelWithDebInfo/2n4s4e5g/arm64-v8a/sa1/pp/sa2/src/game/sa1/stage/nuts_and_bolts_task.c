# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/nuts_and_bolts_task.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/nuts_and_bolts_task.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/nuts_and_bolts_task.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/nuts_and_bolts_task.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/nuts_and_bolts_task.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/nuts_and_bolts_task.c" 2
...
struct Task *CreateNutsAndBoltsTask(u16 taskFlags, void *vramTiles, u16 anim, u8 variant, TaskDestructor dtor)
{
    ...
    nuts->s.animCursor = 0;
    nuts->s.qAnimDelay = ((s32)((0)*256));
    nuts->s.prevVariant = -1;
    nuts->s.animSpeed = ((int)((float)(1.0)*0x10));
    nuts->s.palId = 0;
    nuts->s.hitboxes[0].index = -1;
    nuts->s.frameFlags = ((0) << (12));
...
{
    struct Task **taskPtr = &gCurTask;
    NutsAndBolts *nuts = (void *)((*taskPtr)->data);
    Sprite *s = &nuts->s;
    ...
    s->x = ((int)((nuts->qUnk30) >> 8)) - gCamera.x;
    s->y = ((int)((nuts->qUnk34) >> 8)) - gCamera.y;

    if (nuts->qUnk40 != ((s32)((0)*256))) {
        nuts->qUnk40--;
    }


    if (((s->x < -(32)) || (s->x > 320 + (32)) || ((s->y) - (32) > 240))
        || ((UpdateSpriteAnimation(s) == ACMD_RESULT__ENDED) && (nuts->qUnk40 == ((s32)((0)*256))))) {
        TaskDestroy(*taskPtr);
        return;
    }
