# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_mgr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_mgr.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_mgr.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_mgr.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_mgr.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_mgr.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_mgr.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_mgr.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_mgr.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_mgr.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_mgr.c" 2


# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/stage/mp_unk_0.h" 1



typedef struct UnkMP0 {
    u16 unk0;
    s16 unk2;
    u16 unk4;
    u8 unk6;
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_mgr.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_mgr.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_mgr.c" 2
...
# 46 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_mgr.c"
const RoomEventHandler gRoomEventHandlers[] = {
    [1 - 1] = ReceiveRoomEvent_PlatformChange,
    [2 - 1] = ReceiveRoomEvent_ItemBoxBreak,
    [3 - 1] = ReceiveRoomEvent_EnemyDestroyed,
    [4 - 1] = ReceiveRoomEvent_PlayerRingLoss,
    [5 - 1] = ReceiveRoomEvent_MysteryItemBoxBreak,
    [6 - 1] = ReceiveRoomEvent_ItemEffect,

    [7 - 1] = ReceiveRoomEvent_ReachedStageGoal,
    [8 - 1] = ReceiveRoomEvent_8,


    [9 - 1] = ReceiveRoomEvent_CollectChao,
...
{
    u8 id = ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id;
    ...
    for (i = 0; i < 4 && (gMultiplayerConnections & ((1 << 0) << (i))); i++) {
        ...
        if (!(gMultiSioStatusFlags & (0x0001 << (i)))) {
            ...
            if (0x1000 == recv->unk0 && (something == 0) != (!(recv->unk8[0] & (0x1000 << id)))) {
                return;
            }
        }
    }
    ...
    if (gRoomEventQueueWritePos == gRoomEventQueueSendPos) {
        { u16 tmp = (u16)(0); DmaSet(3, &tmp, &gMultiSioSend.pat0.unk8[3], (u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((sizeof(RoomEvent) - 1)/(16/8)))); };
    } else {
        DmaSet(3, &gRoomEventQueue[gRoomEventQueueSendPos], &gMultiSioSend.pat0.unk8[3], (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(RoomEvent) - 1)/(16/8))));
...
void Task_MultiplayerEventMgr_Receive(void)
{
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (recv->pat0.unk0 == 0x1000 && (recv->pat0.unk8[0] & (0x1000 << i)) != (send->unk8[0] & (0x1000 << i))) {
            if (recv->pat0.unkE > 0 && recv->pat0.unkE < (sizeof(gRoomEventHandlers) / sizeof((gRoomEventHandlers)[0]))) {
...
void ReceiveRoomEvent_ItemEffect(union MultiSioData *recv, u8 i)
{
    ...
    MultiplayerPlayer *us = (void *)((gMultiplayerPlayerTasks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id])->data);

    if (!(us->unk5C & 1) && (!(gPlayer.moveState & 0x00000080)) && gMultiplayerRanks[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id] == -1) {
        switch (recv->pat0.unkF) {

            case 0: {
                if (!((gGameMode == 3) || (gGameMode == 5)) || !(((gMultiplayerConnections & ((1 << 4) << (i))) >> ((i) + 4)) == ((gMultiplayerConnections & ((1 << 4) << (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id))) >> ((((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) + 4)))) {
                    gPlayer.itemEffect |= 0x40;
                    gPlayer.timerConfusion = (int)(((0 * 60.) + 10) * 60);
            ...
            case 4: {
                if ((u8)recv->pat0.unk10 == ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id && !(gPlayer.itemEffect & 0x80)) {

                    u32 prevMoveState = gPlayer.moveState & (0x00200000 | 0x00400000);



                    if (!(prevMoveState)) {
                        InitializePlayer(&gPlayer);
                        gPlayer.qWorldX = ((s32)((mpp->pos.x) << 8));
                        gPlayer.qWorldY = ((s32)((mpp->pos.y - (s8)mpp->unk58[0]) << 8));
            ...
            case 2: {
# 208 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_mgr.c"
                break;
            }
# 221 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_mgr.c"
            case 5: {
                if (!((gGameMode == 3) || (gGameMode == 5)) || !(((gMultiplayerConnections & ((1 << 4) << (i))) >> ((i) + 4)) == ((gMultiplayerConnections & ((1 << 4) << (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id))) >> ((((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) + 4)))) {
...
# 245 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_mgr.c"
        }
    }
}
...

{
    ...
    s32 count = 0;
    bool8 somebool = 0;
    mpp = (void *)((gMultiplayerPlayerTasks[i])->data);

    for (j = 0; j < 4; j++) {

        MultiplayerPlayer *mpp2;
        if (gMultiplayerPlayerTasks[j] == ((void*)0)) {
            break;
        }
        count++;
        mpp2 = (void *)((gMultiplayerPlayerTasks[j])->data);
        if (!((gGameMode == 3) || (gGameMode == 5))) {
            ...
            if (!(((gMultiplayerConnections & ((1 << 4) << (j))) >> ((j) + 4)) == ((gMultiplayerConnections & ((1 << 4) << (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id))) >> ((((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) + 4))) && gMultiplayerRanks[j] == 0) {
                count2 = 1;
            }
        }
    }
    ...
    if (((gGameMode == 3) || (gGameMode == 5))) {
        for (j = 0; j < 4 && gMultiplayerPlayerTasks[j] != ((void*)0); j++) {
            if (j != i && gMultiplayerRanks[j] == -1 && (((gMultiplayerConnections & ((1 << 4) << (j))) >> ((j) + 4)) == ((gMultiplayerConnections & ((1 << 4) << (i))) >> ((i) + 4)))) {
    ...
    if (count2 == 0 && !(gStageFlags & 1)) {
        gStageFlags |= 4;
        gCourseTime = (int)(((1 * 60.) + 0) * 60);
    };

    if ((count3 + 1) >= (u32)(count - 1) || ((gGameMode == 3) || (gGameMode == 5))) {
        for (j = 0; j < 4; j++) {
            MultiplayerPlayer *mpp2;
            ...
            if (gMultiplayerRanks[j] == -1) {
                if (((gGameMode == 3) || (gGameMode == 5))) {
                    ...
                    gPlayer.moveState |= 0x00200000;
                    gPlayer.heldInput = 0;
# 373 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_event_mgr.c"
                }
            }
        }
...
struct Task *CreateMultiplayerSendEventMgr(void)
{
    struct Task *t = TaskCreate(Task_MultiplayerEventMgr_Send, 0, -2, 0, ((void*)0));
    ...
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, &gRoomEventQueue, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gRoomEventQueue))/(32/8)))); };
...
struct Task *CreateMultiplayerReceiveEventMgr(void)
{
    struct Task *t = TaskCreate(Task_MultiplayerEventMgr_Receive, 0, 1, 0, ((void*)0));
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, &gMultiSioSend, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gMultiSioSend))/(32/8)))); };
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, &gMultiSioRecv, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gMultiSioRecv))/(32/8)))); };
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, &gRoomEventQueue, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gRoomEventQueue))/(32/8)))); };
