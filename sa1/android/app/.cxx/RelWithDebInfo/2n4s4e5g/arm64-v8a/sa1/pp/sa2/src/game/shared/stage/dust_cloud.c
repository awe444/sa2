# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_cloud.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_cloud.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_cloud.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_cloud.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_cloud.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_cloud.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_cloud.c" 2
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/dust_cloud.c"
static void Task_CreateDustCloud(void);


void CreateDustCloud(s16 x, s16 y)
{
    struct Task *t = TaskCreate(Task_CreateDustCloud, sizeof(Sprite), 0x2000, 0, ((void*)0));
    Sprite *s = (void *)((t)->data);

    s->x = x;
    s->y = y;
    s->graphics.dest = (void *)(&VRAM[0x10000] + 0x1000);;
    s->oamFlags = ((15) << 6);
    s->graphics.size = 0;
