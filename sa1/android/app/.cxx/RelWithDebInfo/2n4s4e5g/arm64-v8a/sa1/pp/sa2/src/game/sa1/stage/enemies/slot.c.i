# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/slot.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/slot.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/slot.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/slot.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/slot.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/slot.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/slot.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/slot.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/slot.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/slot.c" 2
...
void CreateEntity_Slot(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    if ((((gCurrentLevel) >> 1) != 2) || ((&gLoadedSaveGame)->difficultyLevel == 0)) {
        ...
        slot->qUnk3E = -((s32)((0.625)*256));
        slot->qUnk3C = ((s32)((0)*256));
        slot->unk44 = 0;
        slot->unk40 = 0;
        slot->unk42 = 0;
        slot->unk46 = 0;
        ...
        s->graphics.dest = VramMalloc(((24 / 8) * (40 / 8)));
        s->oamFlags = ((18) << 6);
        s->graphics.size = 0;
        s->graphics.anim = 417;
        s->variant = 0;
...
void Task_SlotInit(void)
{
    ...
    worldX = ((slot->shared.base.meX)*8 + (slot->shared.base.regionX)*256);
    worldY = ((me->y)*8 + (slot->shared.base.regionY)*256);

    worldX2 = worldX;
    worldY2 = worldY;

    slot->unk46 = ((slot->unk46 + 1) & 0x1F);
    slot->unk44 = ({((800) != 0) ? ((s32)((gSineTable[(slot->unk46 * 16)])) / (s32)(800)) : 0;});
    slot->qUnk3C += slot->qUnk3E;

    worldX = worldX2 + ((int)((slot->qUnk3C) >> 8));
    ...
    if (((int)((slot->qUnk3C) >> 8)) <= (me->d.sData[0]) * 8) {
        slot->qUnk3E = +((s32)((0.625)*256));
    } else if (((int)((slot->qUnk3C) >> 8)) >= (me->d.sData[0] + me->d.uData[2]) * 8) {
        slot->qUnk3E = -((s32)((0.625)*256));
    } else if (slot->unk42 != 0) {
        slot->unk42--;
    } else {
        if ((((int)((gPlayer.qWorldX) >> 8)) <= worldX + 16) && (((int)((gPlayer.qWorldX) >> 8)) >= worldX - 16)) {
            slot->unk42 = 100;
            s->variant = 1;
...
void CreateSlotProjectile(s16 worldX, s16 worldY)
{
    struct Task *t = TaskCreate(Task_SlotProjectileMain, sizeof(SlotProjectile), 0x3000, 0, ((void*)0));
    SlotProjectile *proj = (void *)((t)->data);
    Sprite *s = &proj->s;

    proj->qUnk34[0] = ((s32)((worldX)*256));
    proj->qUnk4C[0] = 0;
...
void Task_SlotProjectileMain(void)
{
    SlotProjectile *proj = (void *)((gCurTask)->data);
    Sprite *s = &proj->s;
    ...
    s->x = ({((0x100) != 0) ? ((s32)(proj->qUnk34[0]) / (s32)(0x100)) : 0;});
    proj->qUnk4C[0] += ((s32)((40. / 256.)*256));
    s->y += ((int)((proj->qUnk4C[0]) >> 8));
    oldWorldX = proj->s.x;
    oldWorldY = proj->s.y;
    ...
    if ((((u16)(s->x + (40 / 2)) > 320 + 36) || (s->y + (40 / 2) < 0) || (s->y > 240 + 80))) {
        TaskDestroy(gCurTask);
        return;
    }

    sb = sa2__sub_801F07C(oldWorldY, oldWorldX, 1, +8, &sp08, sa2__sub_801EE64);
    ...
    if (sb <= 0 || playerWasHit) {
        ...
        for (i = 0; i < 6; i++) {
            s32 r4 = qUnk4C * 10;
            s32 modRes = ({((4) != 0) ? ((s32)(({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; })) % (s32)(4)) : 0;}) + 0x10;
            s32 r0 = ({((modRes) != 0) ? ((s32)(-r4) / (s32)(modRes)) : 0;});

            proj->qUnk4C[i] = (r0 * (gSineTable[(((sp08 * 4) & 0x7F) + 0x100)])) / 20000;
            proj->unk58[i] = oldWorldX;
            proj->unk64[i] = oldWorldY + sb;
            proj->qUnk34[i] = unk34;
            proj->unk70[i] = ({((30) != 0) ? ((s32)((gSineTable[(((sp08 - 24 + i * 8) * 4) & (1024 - 1))])) / (s32)(30)) : 0;});
            proj->unk88[i] = 1;
        }

        s->prevVariant = -1;
        s->graphics.dest = (void *)(&VRAM[0x10000] + 0x2680);
        s->graphics.anim = 421;
        s->variant = 0;
...
void sub_806E7E0()
{
    ...
    for (i = 0; i < 6; i++) {
        if (proj->unk88[i] != 0) {
            ...
            proj->qUnk4C[i] = ({((1045 - proj->unk30) != 0) ? ((s32)(proj->qUnk4C[i] * 1000) / (s32)(1045 - proj->unk30)) : 0;});
            proj->qUnk34[i] += proj->unk70[i];
            proj->unk58[i] = ((int)((proj->qUnk34[i]) >> 8));
            proj->qUnk4C[i] += ((s32)((40. / 256.)*256));
            proj->unk64[i] += ((int)((proj->qUnk4C[i]) >> 8));
            ...
            res = sa2__sub_801F07C(worldY, worldX, 1, +8, &sp08, sa2__sub_801EE64);

            if (res <= 0) {
                proj->unk64[i] += res;
                proj->qUnk4C[i] = ({((21) != 0) ? ((s32)(-(proj->qUnk4C[i] * 10)) / (s32)(21)) : 0;});
                proj->unk70[i] += ({((30) != 0) ? ((s32)((gSineTable[(sp08 * 4)])) / (s32)(30)) : 0;});
            }
