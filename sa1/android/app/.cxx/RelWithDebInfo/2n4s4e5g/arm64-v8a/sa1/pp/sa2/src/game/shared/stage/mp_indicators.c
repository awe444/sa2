# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_indicators.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_indicators.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_indicators.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_indicators.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_indicators.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_indicators.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_indicators.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_indicators.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_indicators.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_indicators.c" 2
# 165 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_indicators.c"
typedef struct {
               u8 playerId;
               SpriteTransform transform;
               Sprite spr;
...
static void sa2__Task_801951C(void);
static void sa2__Task_8019898(void);
...
void CreateOpponentPositionIndicator(u8 sid)
{
    ...
    t = TaskCreate(sa2__Task_801951C, sizeof(OpponentIndicator), 0x2001, 0, TaskDestructor_OpponentPositionIndicator);
# 200 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_indicators.c"
    pi = (void *)((t)->data);
    ...
    spr->graphics.dest = (void *)(&VRAM[0x10000] + 0x2500);
    spr->oamFlags = ((1) << 6);
    spr->graphics.size = 0;
    spr->animCursor = 0;
    spr->qAnimDelay = 0;
    spr->prevVariant = -1;
    spr->animSpeed = ((int)((float)(1.0)*0x10));
...
# 272 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_indicators.c"
static void sa2__Task_801951C(void)
{
    OpponentIndicator *pi = (void *)((gCurTask)->data);
    ...
    if (((mpp->pos.x) - (gCamera.x) >= 0) && ((mpp->pos.x) - (gCamera.x) <= 320)) { if ((((mpp->pos.y) - (gCamera.y)) >= 0)) { if ((((mpp->pos.y) - (gCamera.y)) <= 240)) { return; } } };

    opponentX2 = (unsigned)(mpp->pos.x - (320 / 2) - gCamera.x);
    opponentY2 = (unsigned)(mpp->pos.y - (240 / 2) - gCamera.y);

    ({ s32 opponentDistSq; s16 rot, tfx, tfy; s16 r1 = (opponentX2); s16 r4 = (opponentY2); if (((opponentX2) != 0) && ((opponentY2) != 0)) { while ((((r1) >= 0 ? (r1) : -(r1)) >= 128) || (((r4) >= 0 ? (r4) : -(r4)) >= 128)) { r1 = r1 / 2; r4 = r4 / 2; if (((r1) >= 0 ? (r1) : -(r1)) < 2) { break; } if (((r4) >= 0 ? (r4) : -(r4)) < 2) { break; } } } if (((r1) >= 0 ? (r1) : -(r1)) < 2) { if (r4 > 0) { rot = 256; } else { rot = 768; } } else if (((r4) >= 0 ? (r4) : -(r4)) < 2) { rot = 512; if (r1 > 0) { rot = 0; } } else { rot = sa2__sub_8004418(r4, r1); } (transform)->rotation = (rot + 256) & (1024 - 1); opponentDistSq = (((opponentX2)) * ((opponentX2))) + (((opponentY2)) * ((opponentY2))); if (opponentDistSq < 0x10000) { (spr)->animSpeed = opponentDistSq < 0x10000 ? ((int)((float)(1.5)*0x10)) : ((int)((float)(1.0)*0x10)); } else { (spr)->animSpeed = ((int)((float)(1.0)*0x10)); } if (opponentDistSq > 0x06000000) { (transform)->qScaleX = ((s32)((0.25)*256)); (transform)->qScaleY = ((s32)((0.25)*256)); } else if (opponentDistSq < ((256) * (256))) { (transform)->qScaleX = ((s32)((1.875)*256)); (transform)->qScaleY = ((s32)((1.875)*256)); } else { s32 dist = (0x06000000 - opponentDistSq) >> 16; s32 scale = ({((((s32)((5.99609375)*256))) != 0) ? ((s32)(dist * ((s32)((1.625)*256))) / (s32)(((s32)((5.99609375)*256)))) : 0;}) + ((s32)((0.25)*256)); (transform)->qScaleX = scale; (transform)->qScaleY = scale; } if (rot == 0) { tfy = (240 / 2); tfx = 320; } else if (rot == 256) { tfy = 240; tfx = (320 / 2); } else if (rot == 512) { tfy = (240 / 2); tfx = 0; } else if (rot == 768) { tfy = 0; tfx = (320 / 2); } else { if ((opponentX2) > 0) { s16 divRes = ({((((int)(((gSineTable[(rot) + 256])) >> 6))) != 0) ? ((s32)(((int)(((gSineTable[(rot)])) >> 6)) * 256) / (s32)(((int)(((gSineTable[(rot) + 256])) >> 6)))) : 0;}); tfy = ((divRes * 15) >> 5) + (240 / 2); if ((opponentY2) > 0) { if (tfy >= 240) { s32 sinVal; tfy = 240; sinVal = (256 - rot) & (1024 - 1); divRes = ({((((int)(((gSineTable[(sinVal) + 256])) >> 6))) != 0) ? ((s32)(((int)(((gSineTable[(sinVal)])) >> 6)) * 256) / (s32)(((int)(((gSineTable[(sinVal) + 256])) >> 6)))) : 0;}); tfx = ((divRes * 5) >> 4) + (320 / 2); } else { tfx = 320; } } else { if (tfy < 0) { s32 sinVal; tfy = 0; sinVal = (256 - rot) & (1024 - 1); divRes = ({((((int)(((gSineTable[(sinVal) + 256])) >> 6))) != 0) ? ((s32)(((int)(((gSineTable[(sinVal)])) >> 6)) * 256) / (s32)(((int)(((gSineTable[(sinVal) + 256])) >> 6)))) : 0;}); tfx = (320 / 2) - ((divRes * 5) >> 4); } else { tfx = 320; } } } else { s16 divRes = ({(((((int)(((gSineTable[((rot - (1024 / 2)) & (1024 - 1)) + 256])) >> 6)))) != 0) ? ((s32)((((int)(((gSineTable[((rot - (1024 / 2)) & (1024 - 1))])) >> 6))) * 0x100) / (s32)((((int)(((gSineTable[((rot - (1024 / 2)) & (1024 - 1)) + 256])) >> 6))))) : 0;}); tfy = (240 / 2) - ((divRes * 15) >> 5); if ((opponentY2) > 0) { if (tfy >= 240) { s32 sinVal; tfy = 240; sinVal = (768 - rot) & (1024 - 1); divRes = ({((((int)(((gSineTable[(sinVal) + 256])) >> 6))) != 0) ? ((s32)(((int)(((gSineTable[(sinVal)])) >> 6)) * 256) / (s32)(((int)(((gSineTable[(sinVal) + 256])) >> 6)))) : 0;}); tfx = ((divRes * 5) >> 4) + (320 / 2); } else { tfx = 0; } } else { if (tfy < 0) { s32 sinVal; tfy = 0; sinVal = (768 - rot) & (1024 - 1); divRes = ({((((int)(((gSineTable[(sinVal) + 256])) >> 6))) != 0) ? ((s32)(((int)(((gSineTable[(sinVal)])) >> 6)) * 256) / (s32)(((int)(((gSineTable[(sinVal) + 256])) >> 6)))) : 0;}); tfx = (320 / 2) - ((divRes * 5) >> 4); } else { tfx = 0; } } } } (transform)->x = tfx; (transform)->y = tfy; (spr)->frameFlags &= ~((0x1F) << (0)); (spr)->frameFlags |= gOamMatrixIndex++; UpdateSpriteAnimation((spr)); TransformSprite((spr), (transform)); DisplaySprite((spr)); });
}
# 338 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/mp_indicators.c"
