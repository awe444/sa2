# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/music_manager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/music_manager.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/music_manager.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/music_manager.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/music_manager.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/music_manager.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/music_manager.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/music_manager.c" 2


# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/music_manager.c" 2
...
const u16 gLevelSongs[] = {
    ...
    16,
    23,
# 84 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/music_manager.c"
};
...
void Task_StageMusicManager(void)
{
    ...
    if ((gMusicManagerState.unk0 == 0) && (!(gPlayer.moveState & 0x00000080))) {
# 118 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/music_manager.c"
            if ((songHeader == gSongTable[27].header) && (gMPlayInfo_BGM.status & 0x0000ffff)
                && !(gMPlayInfo_BGM.status & 0x80000000)) {
                       ;
            ...
            m4aSongNumStart(27);
        } else if ((songHeader == gSongTable[28].header) && (gMPlayInfo_BGM.status & 0x0000ffff)
                   && !(gMPlayInfo_BGM.status & 0x80000000) && !(gPlayer.itemEffect & 0x02)) {
                       ;
            m4aSongNumStop(28);
        } else if ((songHeader != gSongTable[307].header) && (songHeader != gSongTable[28].header)
                   && (gPlayer.itemEffect & 0x02) && (gMusicManagerState.unk2 == 0)) {
            gMusicManagerState.unk2 = 0;
                       ;
            m4aSongNumStart(28);
        ...
        } else if (((gMPlayInfo_BGM.status & 0x0000ffff) == 0) || (gMPlayInfo_BGM.status & 0x80000000)) {
...
void CreateStageMusicManager(void)
{
    TaskCreate(Task_StageMusicManager, 0, 0x4000, 0, ((void*)0));
