# 1 "/home/awaszczak/git/sa2/sa1/src/data/sa1/sprite_tables.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/src/data/sa1/sprite_tables.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/src/data/sa1/sprite_tables.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/src/data/sa1/sprite_tables.c" 2

extern const u8 gObjTiles_4bpp[];
extern const u8 gObjTiles_8bpp[];

const struct SpriteTables gSpriteTables = { (const void *)gAnimations, gSpriteDimensions, (const u16 **const)gSpriteOamData,
                                            (const u16 *)gSpritePalettes, gObjTiles_4bpp, gObjTiles_8bpp };
