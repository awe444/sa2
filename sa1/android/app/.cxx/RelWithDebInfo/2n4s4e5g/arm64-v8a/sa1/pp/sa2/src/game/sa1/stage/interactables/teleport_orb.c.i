# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/teleport_orb.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/teleport_orb.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/teleport_orb.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/teleport_orb.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/teleport_orb.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/teleport_orb.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/teleport_orb.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/teleport_orb.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/teleport_orb.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/teleport_orb.c" 2
...
{
    struct Task *t = TaskCreate(Task_TeleportOrb, sizeof(TeleportOrb), 0x2000, 0, ((void*)0));
    TeleportOrb *orb = (void *)((t)->data);
    ...
    orb->v1x = ((s32)((me->d.sData[0])*256));
    orb->v1y = ((s32)((me->d.sData[1])*256));
    orb->v2x = ((s32)((me->d.uData[2])*256));
    orb->v2y = ((s32)((me->d.uData[3])*256));
...
void Task_TeleportOrb(void)
{
    TeleportOrb *orb = (void *)((gCurTask)->data);
    ...
    worldX = ((orb->base.meX)*8 + (orb->base.regionX)*256);
    worldY = ((me->y)*8 + (orb->base.regionY)*256);
    ...
    do {
        if ((((orb->unk44) >> (i)) & 1)) {
            ...
            if ((gCamera.x == orb->unk40 && gCamera.y == orb->unk42) && (gCamera.x <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)))
                && (gCamera.x + 320 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (gCamera.y <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))
                && (gCamera.y + 240 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) {
            ...
            if (((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
                ...
                if ((*(((i) != 0) ? &gPartner : &gPlayer)).playerID == 0) {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((gCamera.y + (240 / 2))*256));
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = ((s32)((gCamera.x + (320 / 2))*256));
                    gCamera.sa2__unkC = 0;
                    gCamera.sa2__unk8 = 0;
                }
            }
            ...
            if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
                if ((worldX - 12 <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldX + 12 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldY - 12 <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))
                    && (worldY + 12 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) {
                    Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000004;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00400000;

                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = ((s32)((orb->v1x)*256)) + orb->v2x;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((orb->v1y)*256)) + orb->v2y;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = ((s32)((0)*256));
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = ((s32)((0)*256));
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = ((s32)((0)*256));
                    (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 5;
