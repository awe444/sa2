# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_amy.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_amy.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_amy.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_amy.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_amy.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_amy.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_amy.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_amy.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_amy.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_amy.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_amy.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_amy.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_amy.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_amy.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_amy.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_amy.c" 2
...
bool32 Player_Amy_8049370(Player *p)
{
    ...
    if ((p->frameInput & gPlayerControls.attack) && !(p->moveState & 0x00008000)) {
        rot = p->rotation;

        if (!(p->heldInput & 0x0080)) {
            if (((p->rotation + ((s32)((0.25)*256))) << 24 > ((s32)((0)*256))) && !(p->moveState & 0x00000020)) {
                p->sa2__unk62 = 1;
                p->charState = 87;
    ...
    qSpeed = (p->moveState & 0x00000040) ? ((s32)((3.375)*256)) : ((s32)((6.0)*256));
...
void Player_Amy_804948C(Player *p)
{
    if ((p->sa2__unk62 == 0) && (p->frameInput & gPlayerControls.attack) && (p->charState != 15)) {
        p->sa2__unk62 = 1;
...
{
    if (p->sa2__unk62 == 0) {
        if ((gGameMode == 6) || (Player_Amy_8049370(p) == 0)) {
            if (!Player_TryJump(p)) {
        ...
        if (gGameMode != 6) {
            s8 unk62 = p->sa2__unk62;

            if ((unk62 == 1) && !(p->moveState & 0x00000400) && ((p->rotation + ((s32)((0.25)*256))) << 24 > ((s32)((0)*256)))
                && !(p->moveState & 0x00000020) && (p->sa2__unk63 == 0) && (p->frameInput & gPlayerControls.attack)) {
                p->sa2__unk63 = 1;
            }
        }
...
void Player_Amy_80495F0(Player *p)
{
    ...
    switch (p->sa2__unk62) {
        case 0: {
            if ((p->frameInput & gPlayerControls.attack) && (p->charState != 15)) {
                p->charState = 92;
                p->sa2__unk62 = 1;
            }
        ...
        case 1: {
            ...
            if (!(p->w.kf.flags & 0x2)) {
                ...
                u32 isInWater = p->moveState & 0x00000040;
                s32 qSpeed = ((s32)((2)*256));
        ...
        _08049720:
...

            {
                ...
                offsetY = sa2__sub_8029B88(p, &rot, ((void*)0));
                if (offsetY < 7) {
                    if ((gStageFlags & 0x0080)) {
                        offsetY = -offsetY;
                    }
...
void Player_Amy_80497AC(Player *p)
{
    switch (p->moveState & 0x00000002) {
        ...
        case 0x00000002: {
            switch (p->moveState & (0x02000000 | 0x04000000)) {
                case 0: {
