# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_unk_1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_unk_1.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_unk_1.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_unk_1.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_unk_1.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_unk_1.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_unk_1.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/ui/course_select.h" 1
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_unk_1.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/shared/menus/unused_level_select.h" 1



void CreateUnusedLevelSelect(void);
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_unk_1.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_unk_1.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_unk_1.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/stage/mp_unk_1.h" 1



void sub_801C9D8(void);
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_unk_1.c" 2
...
extern void LinkCommunicationError(void);
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_unk_1.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_unk_1.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_unk_1.c" 2
...
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_unk_1.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 19 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_unk_1.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/tilemaps.h" 1
# 20 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/mp_unk_1.c" 2
...
void sub_801C9D8(void)
{
    ...
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, VRAM + 0xA000 - 0x20, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((0x40)/(32/8)))); };
    t = TaskCreate(Task_801CB80, sizeof(MPStrc1), 0x2000U, 0U, ((void*)0));
    strc = (void *)((t)->data);
    strc->qUnk430 = 0;
    ...
    strc->bg0.graphics.dest = (void *)(&VRAM[0] + 0x8000);
    strc->bg0.graphics.anim = 0;
    strc->bg0.layoutVram = (u16 *)(&VRAM[0] + 0xF000);
    strc->bg0.unk18 = 0;
    strc->bg0.unk1A = 0;
    strc->bg0.tilemapId = 88;
    strc->bg0.unk1E = 0;
    strc->bg0.unk20 = 0;
    strc->bg0.unk22 = 0;
    strc->bg0.unk24 = 0;
    ...
    for (i = 0; i < (sizeof(strc->sprites) / sizeof((strc->sprites)[0])); i++) {
        SpriteStrc *spr = &strc->sprites[i];
        Sprite *s = &spr->s;

        s->x = (320 / 2);
        s->y = 20 + i * 0x28;
        s->graphics.dest = &VRAM[0x10000] + (i << 0xB);
        s->oamFlags = 0x400;
        s->graphics.size = 0;
...
void Task_801CB80()
{
    ...
    gDispCnt |= (0x1000 | 0x0800);
    if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
        for (pid = 0; pid < 4; pid++) {
            if (!(((gMultiplayerConnections) >> (pid)) & 1)) {
                break;
            }

            if (!((gMultiSioStatusFlags) & ((1 << (pid))))) {
    ...
    strc->qUnk430 += ((s32)((4)*256));
    if (strc->qUnk430 > ((s32)((320)*256))) {
        strc->qUnk430 = 0;
        sub_801D0CC();
    ...
    if (strc->unk432 != 0) {
        sa2__sub_80078D4(3U, 0U, strc->unk432, 0xF0U, 0U);
    }
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (1 & i) {
            sa2__sub_80078D4
            (3U, strc->unk432 + (i * 40), strc->unk432 + ((i + 1) * 40), (320 - ((int)((strc->qUnk430) >> 8))), (-strc->unk432) & 0xFF);
        } else {
            sa2__sub_80078D4
            (3U, strc->unk432 + (i * 40), strc->unk432 + ((i + 1) * 40), (((int)((strc->qUnk430) >> 8)) - 320), (-strc->unk432) & 0xFF);
        }
    }

    if (strc->unk432 != 0) {
        sa2__sub_80078D4(3U, (u8)(strc->unk432 + (i * 40)), 240, 320, 0U);
    }
}

void Task_801CD80()
{
    MPStrc1 *strc = (void *)((gCurTask)->data);
    u8 i;

    strc->qUnk430 += ((s32)((2)*256));
    if (strc->qUnk430 > ((s32)((16)*256))) {
        strc->qUnk430 = 0x1000;
        gBldRegs.bldY = 0x10;
        gFlags &= ~0x4;
        TasksDestroyInPriorityRange(0, 0xFFFF);
        ...
        if ((gGameMode == 2) || (gGameMode == 4)) {
            ...
            } else if ((gGameMode == 0) && ((&gLoadedSaveGame)->unlockedLevels[gSelectedCharacter] == 0)) {
                gCurrentLevel = 0;
        ...
        sub_801CF08();
        gBldRegs.bldY = ((int)((strc->qUnk430) >> 8));
    }
}
...
void sub_801CF08()
{
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
        for (pid = 0; pid < 4; pid++) {
            ...
            if (((gMultiSioStatusFlags) & ((1 << (pid)))) == 0) {
                if (gMultiplayerMissingHeartbeats[pid]++ >= 0xB5) {
    ...
    strc = (void *)((gCurTask)->data);
    if (strc->unk432 != 0) {
        sa2__sub_80078D4(3U, 0U, strc->unk432, 240, 0U);
    }
    ...
    for (i = 0; i < 4; i++) {
        ...
        sa2__sub_80078D4(3U, (strc->unk432 + (i * 0x28)), (strc->unk432 + ((i + 1) * 0x28)), 0U, (-strc->unk432) & 0xFF);

        if ((i == ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) || (((gMultiplayerConnections) >> (i)) & 1)) {
    ...
    if (strc->unk432 != 0) {
        sa2__sub_80078D4(3U, (strc->unk432 + (i * 0x28)), 0xA0U, 0xF0U, 0U);
    }
}
...
void sub_801D0CC(void)
{
    ...
    strc68 = (void *)((TaskCreate(Task_801D200, sizeof(MPStrc2), 0x2200U, 0U, TaskDestructor_801D3C8))->data);
    gfx.uiGfxID = 0;
    gfx.unk2B = 1;
...
void Task_801D200()
{
    ...
    for (var_r6 = 0; var_r6 < pid; var_r6++) {
        for (nameChar = 0; nameChar < 6; nameChar++) {
            ...
            if (((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id == var_r6) {
                u8 character = (&gLoadedSaveGame)->playerName[nameChar];
                if (character >= 0x70 && character < 0x8A) {
                    overB->unkC += 8;
                }
                sub_8052F78((const char *)&(&gLoadedSaveGame)->playerName[nameChar], overB);
            } else {
                u8 character = (&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[var_r6]].data.split.playerName[nameChar];
                if (character >= 0x70 && character < 0x8A) {
                    overB->unkC += 8;
                }
                sub_8052F78((const char *)&(&gLoadedSaveGame)->multiplayerScores[gUnknown_03005008[var_r6]].data.split.playerName[nameChar],
                            overB);
            }
        }
    }
...
void Task_801D34C()
{
    ...
    if (strc->qUnk430++ > ((s32)((60. / 256.)*256))) {
        strc->qUnk430 = 0;
