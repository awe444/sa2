# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_gravity.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_gravity.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_gravity.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_gravity.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_gravity.c" 2
...
void Task_ToggleGravity(void)
{
    ToggleGravity *ia = (void *)((gCurTask)->data);
    ...
    if ((!(gPlayer.moveState & 0x00000080))) {
        u8 kind = ia->kind;
        if (kind > 2) {
            left = worldX + me->d.sData[0] * 8;

            if ((left <= ((int)((gPlayer.qWorldX) >> 8))) && ((left + me->d.uData[2] * 8) >= ((int)((gPlayer.qWorldX) >> 8)))) {
                if (ia->qWorld > ((s32)((worldY)*256))) {
                    if (gPlayer.qWorldY < ((s32)((worldY)*256))) {
                        if (kind == 3) {
                            goto k_3;
                        } else if (kind == 4) {
                            goto k_4;
                ...
                } else if (ia->qWorld < ((s32)((worldY)*256))) {
                    if (gPlayer.qWorldY > ((s32)((worldY)*256))) {
                        if (kind == 3) {
                        k_3:
            ...
            s32 top = worldY + me->d.sData[1] * 8;

            if ((top <= ((int)((gPlayer.qWorldY) >> 8))) && ((top + me->d.uData[3] * 8) >= ((int)((gPlayer.qWorldY) >> 8)))) {
                if (ia->qWorld > ((s32)((worldX)*256))) {
                    if (gPlayer.qWorldX < ((s32)((worldX)*256))) {
                        if (kind == 0) {
                            goto test;
                        } else if (kind == 1) {
                            gStageFlags &= ~0x0080;
                ...
                } else if (ia->qWorld < ((s32)((worldX)*256))) {
                    if (gPlayer.qWorldX > ((s32)((worldX)*256))) {
                        if (kind == 0) {
                        test:
                            if (!(gStageFlags & 0x0080)) {
...
void CreateEntity_ToggleGravity(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    ToggleGravity *ia;
    t = TaskCreate(Task_ToggleGravity, sizeof(ToggleGravity), 0x2000, 0, ((void*)0));
    ia = (void *)((t)->data);
