# 1 "/home/awaszczak/git/sa2/sa1/../src/bg_triangles.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/bg_triangles.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/bg_triangles.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/bg_triangles.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/bg_triangles.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/bg_triangles.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/bg_triangles.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/bg_triangles.c" 2
# 22 "/home/awaszczak/git/sa2/sa1/../src/bg_triangles.c"
typedef struct {
    s16 x;
    s16 y;
} Unknown;
...
void sa2__sub_8006228(u8 bg, u8 param1, u8 param2, u8 param3, u8 param4, u8 param5)
{
    ...
    if (bg >= 2) {
        gHBlankCopySize = sizeof((*(reg_wint *)(REG_BASE + (0x40 + sizeof(winreg_t) * 0)))) * 2;

        if (bg & 1) {
            cursor = (int_vcount *)gBgOffsetsHBlankPrimary + sizeof((*(reg_wint *)(REG_BASE + (0x40 + sizeof(winreg_t) * 0))));
            gHBlankCopyTarget = (void *)&(*(reg_wint *)(REG_BASE + (0x40 + sizeof(winreg_t) * 0)));
        } else {
        ...
        gHBlankCopySize = sizeof((*(reg_wint *)(REG_BASE + (0x40 + sizeof(winreg_t) * 0))));
        cursor = (int_vcount *)gBgOffsetsHBlankPrimary;


        reg = &(*(reg_wint *)(REG_BASE + (0x40 + sizeof(winreg_t) * 1)));
        if (bg & 1) {
...
void sa2__sub_8006DB4(u8 bg, TriParam1 *arg1, s32 unused, s32 arg3)
{
    s16 sp0[2];
    s16 sp4[2] = { 1, 1 };
    s16 sp8[2];
    ...
    if (bg >= 2) {
        ...
        if (bg & 1) {
            gHBlankCopyTarget = (void *)&(*(reg_wint *)(REG_BASE + (0x40 + sizeof(winreg_t) * 1)));
        } else {
            gHBlankCopyTarget = (void *)&(*(reg_wint *)(REG_BASE + (0x40 + sizeof(winreg_t) * 0)));
        }
    }
...
void sa2__sub_800724C(u8 bg, TriParam1 *arg1)
{
    s16 sp0[2];
    s16 sp4[2] = { 1, 1 };
    s16 sp8[2];
...
void sa2__sub_80075D0(u8 bg, int_vcount param1, int_vcount param2, s16 param3, s16 param4, u16 param5)
{
    int_vcount *cursor;
    s16 r1;
    ...
    for (; param1 < param2; param1++) {
        ...
        cursor = (int_vcount *)(((u8 *)(cursor)) + (gHBlankCopySize - sizeof((*(reg_wint *)(REG_BASE + (0x40 + sizeof(winreg_t) * 0))))));
    }
}
                            ...
                            s16 param9, s16 param10)
{
    ...
    gHBlankCopyTarget = (void *)&((u8 *)&(*(reg_u16 *)(REG_BASE + 0x10)))[bg * 4];
    gHBlankCopySize = 2 * sizeof((*(reg_u16 *)(REG_BASE + 0x10)));
...
void sa2__sub_8007858(u8 param0, int_vcount minY, int_vcount maxY, u16 param3, u16 param4)
{
    ...
    gHBlankCopyTarget = (void *)&((u8 *)&(*(reg_u16 *)(REG_BASE + 0x10)))[param0 * 4];
    gHBlankCopySize = 2 * sizeof((*(reg_u16 *)(REG_BASE + 0x10)));
...
# 828 "/home/awaszczak/git/sa2/sa1/../src/bg_triangles.c"
...
void sa2__sub_8007AC0(u8 affineBg, int_vcount minY, int_vcount maxY)
{
    ...
    *ptr = (void *)((REG_BASE + 0x20) + bg);
    ...
    gHBlankCopySize = sizeof((*(reg_u16 *)(REG_BASE + 0x20)));
