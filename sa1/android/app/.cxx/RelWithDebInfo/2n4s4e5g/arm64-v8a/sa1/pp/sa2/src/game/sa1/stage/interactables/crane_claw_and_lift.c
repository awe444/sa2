# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/crane_claw_and_lift.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/crane_claw_and_lift.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/crane_claw_and_lift.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/crane_claw_and_lift.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/crane_claw_and_lift.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/crane_claw_and_lift.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/crane_claw_and_lift.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/crane_claw_and_lift.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/crane_claw_and_lift.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/crane_claw_and_lift.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/interactables.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/crane_claw_and_lift.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/crane_claw_and_lift.c" 2
...
void CreateEntity_CraneClaw(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    s2->graphics.dest = VramMalloc(((8 / 8) * (24 / 8)));
    s2->graphics.anim = 498;
    s2->variant = 3;
    s2->oamFlags = ((17) << 6);
    s2->graphics.size = 0;
    s2->animCursor = 0;
...
{
    s32 i = 0;
    CraneClaw *crane = (void *)((gCurTask)->data);
    ...
    worldX = ((crane->base.meX)*8 + (crane->base.regionX)*256);
    worldY = ((me->y)*8 + (crane->base.regionY)*256);
...
void Task_CraneClaw2(void)
{
    ...
    {
        Player *p = &(*(((crane->playerID) != 0) ? &gPartner : &gPlayer));

        if ((!((p)->moveState & 0x00000080))) {
            p->qWorldX = ((s32)((worldX)*256));
            p->qWorldY = ((s32)((worldY + 104)*256));
        }
...
void Task_CraneClaw3(void)
{
    ...
    sp08 = ({((30) != 0) ? ((s32)((30 - crane->unk9C) * 48) / (s32)(30)) : 0;});
...

    {
        ...
        if ((!((p)->moveState & 0x00000080))) {
            p->qWorldX = ((s32)((worldX)*256));
            p->qWorldY = ((s32)((worldY + sp08 + 56)*256));
        }
...
void Task_CraneClaw4(void)
{
...

    {
        ...
        if ((!((p)->moveState & 0x00000080))) {
            p->qWorldX = ((s32)((worldX + r3)*256));
            p->qWorldY = ((s32)((worldY + 56)*256));
        }

        if (r3 > me->d.uData[2] * 8) {
...
void Task_CraneClaw7(void)
{
    ...
    sp08 = 48 - ({((30) != 0) ? ((s32)((30 - crane->unk9C) * 48) / (s32)(30)) : 0;});
...
void CreateEntity_Lift(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    s2->graphics.dest = VramMalloc(((8 / 8) * (32 / 8)));
    s2->graphics.anim = 545;
    s2->variant = 0;
    s2->oamFlags = ((17) << 6);
    s2->graphics.size = 0;
    s2->animCursor = 0;
...
{
    s32 i = 0;
    Lift *lift = (void *)((gCurTask)->data);
    CamCoord worldX, worldY;
    MapEntity *me = lift->base.me;
    Sprite *s = &lift->s;
    Sprite *s2 = &lift->s2;

    worldX = ((lift->base.meX)*8 + (lift->base.regionX)*256);
    worldY = ((me->y)*8 + (lift->base.regionY)*256);
    ...
    DisplaySprite(s2);
    s2->y = worldY - gCamera.y - (48 + (0 * 32));
    DisplaySprite(s2);

    s2->y = worldY - gCamera.y - (48 + (1 * 32));
    DisplaySprite(s2);

    s2->y = worldY - gCamera.y - (48 + (2 * 32));
    DisplaySprite(s2);
}
...
void Task_Lift2(void)
{
    ...
    sp08 = 128 - ({((64) != 0) ? ((s32)((64 - lift->unk9C) * 128) / (s32)(64)) : 0;});
    ...
    {
        Player *p = &(*(((lift->playerID) != 0) ? &gPartner : &gPlayer));

        if ((!((p)->moveState & 0x00000080))) {
            if (!(p->moveState & 0x00000001)) {
                p->qWorldX = ((s32)((worldX - 3)*256));
            } else {
                p->qWorldX = ((s32)((worldX + 8)*256));
            }

            p->qWorldY = ((s32)((worldY - sp08 + 26)*256));
        } else {
            p->moveState &= ~0x00400000;
            gPlayer.itemEffect &= ~0x80;
        }
    ...
    DisplaySprite(s2);
    s2->y = worldY - gCamera.y - sp08 - (48 + (0 * 32));
    DisplaySprite(s2);

    s2->y = worldY - gCamera.y - sp08 - (48 + (1 * 32));
    DisplaySprite(s2);

    s2->y = worldY - gCamera.y - sp08 - (48 + (2 * 32));
    DisplaySprite(s2);
}
...
void Task_Lift4(void)
{
    ...
    offsetY = ({((30) != 0) ? ((s32)((30 - lift->unk9C) * 128) / (s32)(30)) : 0;});
