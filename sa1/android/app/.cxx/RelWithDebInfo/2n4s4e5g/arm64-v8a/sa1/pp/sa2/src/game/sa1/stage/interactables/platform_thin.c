# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_thin.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_thin.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_thin.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_thin.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_thin.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_thin.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_thin.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_thin.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_thin.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_thin.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_thin.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_thin.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_thin.c" 2
...
const AnimId sPlatformThinAnims[18] = {
    463, 463,
    506, 506,
    495, 495,
    523, 523,
...
void CreateEntity_PlatformThin(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    PlatformThin *platform = (void *)((t)->data);
    ...
    if (gGameMode != 6) {
        ...
        s->graphics.anim = sPlatformThinAnims[gCurrentLevel % (sizeof(sPlatformThinAnims) / sizeof((sPlatformThinAnims)[0]))];
...
void Task_PlatformThin(void)
{
    ...
    s32 sp04 = 0;
    s32 i = 0;
    PlatformThin *platform = (void *)((gCurTask)->data);
    Sprite *s = &platform->s;
    ...
    if (platform->qUnk48 != 0) {
        ...
        platform->qUnk40 = (((me->d.uData[2] << 11) * (gSineTable[(platform->qUnk48 * (((gStageTime + platform->unk3C) & 0xFF)) & 0x3FF)])) >> 14);
    ...
    if (platform->qUnk4A != 0) {
        ...
        platform->qUnk44 = (((me->d.uData[3] << 11) * (gSineTable[(platform->qUnk4A * (((gStageTime + platform->unk3C) & 0xFF)) & 0x3FF)])) >> 14);
    ...
    s->x = worldX - gCamera.x + ((int)((platform->qUnk40) >> 8));
    ...
    do {
        ...
        if ((p->moveState & 0x00000008) && (p->stoodObj == s)) {
            ...
            if (!(gStageFlags & 0x0080)) {
                p->qWorldY += +((s32)((1)*256)) + sp04;
            } else {
                p->qWorldY += -((s32)((2)*256)) + sp04;
            }
        }

        if (!(p->moveState & 0x00400000)) {
            Coll_Player_PlatformCrumbling(s, worldX + ((int)((platform->qUnk40) >> 8)), worldY + ((int)((platform->qUnk44) >> 8)), p);
        }
    ...
    if (!(gPlayer.moveState & 0x00400000)) {
        if (((gPlayer.moveState & 0x00000008) && (gPlayer.stoodObj == s))
            || ((gNumSingleplayerCharacters == 2) && (gPartner.moveState & 0x00000008)
                && (gPartner.stoodObj == s))) {
        ...
        if (!(gStageFlags & 0x0080)) {
            s->y += (gSineTable[(platform->unk4C)]) >> 12;
        } else {
            s->y -= (gSineTable[(platform->unk4C)]) >> 12;
        }
    }
    ...
    do {
        ...
        if ((p->moveState & 0x00000008) && (p->stoodObj == s)) {
            ...
            if (platform->unk3C > 32) {
                ...
                p->qWorldY += platform->qUnk4A + ((s32)((1)*256));
            }
        }

        if (platform->unk3C < 32) {
            Coll_Player_PlatformCrumbling(s, worldX, worldY + ((int)((platform->qUnk44) >> 8)), p);
        }
    } while (++i < gNumSingleplayerCharacters);
