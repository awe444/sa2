# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring_hiding.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring_hiding.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring_hiding.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring_hiding.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring_hiding.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring_hiding.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring_hiding.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring_hiding.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/spring_hiding.c" 2
...
void CreateEntity_Spring_Hiding(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    SpringHiding *spring = (void *)((t)->data);
    Sprite *s = &spring->s;
...
void Task_Spring_Hiding(void)
{
    SpringHiding *spring = (void *)((gCurTask)->data);
    Sprite *s = &spring->s;
        ...
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00400000)) {
                if (!Coll_Player_Entity_Intersection(s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                    sp0C = Coll_AmyHammer_Spring(s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)));
                    if (!sp0C) {
                        continue;
                    }
                }

                sa2__sub_8021BE0(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                ...
                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = -(me->d.uData[1] << 6);


                if (sp0C) {
                    s16 qSpeed = (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY >> 1;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY += qSpeed;
                }
