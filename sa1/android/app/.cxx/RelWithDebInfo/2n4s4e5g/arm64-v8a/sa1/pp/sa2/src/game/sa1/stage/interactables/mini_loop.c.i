# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/mini_loop.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/mini_loop.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/mini_loop.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/mini_loop.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/mini_loop.c" 2
...
void Task_MiniLoop_StartBoost(void)
{
    MiniLoop *loop = (void *)((gCurTask)->data);
    s32 i;
    ...
    do {
        ...
        worldX = ((int)((p->qWorldX) >> 8));
        worldY = ((int)((p->qWorldY) >> 8));

        if (((loop->worldX) > gCamera.x + (320 + (256 / 2)) || (loop->worldX) < gCamera.x - (256 / 2) || (loop->worldY) > gCamera.y + ((240) + ((256) / 2)) || (loop->worldY) < gCamera.y - (256 / 2))) {
...
{
    struct Task *t = TaskCreate(Task_MiniLoop_StartBoost, sizeof(MiniLoop), 0x2000, 0, ((void*)0));
    MiniLoop *loop = (void *)((t)->data);
    s32 worldX, worldY;
    ...
    loop->left = worldX + (me->d.sData[0] * 8);
    loop->top = worldY + (me->d.sData[1] * 8);
    loop->right = loop->left + (me->d.uData[2] * 8);
    loop->bottom = loop->top + (me->d.uData[3] * 8);
...
{
    struct Task *t = TaskCreate(Task_MiniLoop_Exit, sizeof(MiniLoop), 0x2000, 0, ((void*)0));
    MiniLoop *loop = (void *)((t)->data);
    s32 worldX, worldY;
...
{
    struct Task *t = TaskCreate(Task_MiniLoop_Entrance, sizeof(MiniLoop), 0x2000, 0, ((void*)0));
    MiniLoop *loop = (void *)((t)->data);
    s32 worldX, worldY;
