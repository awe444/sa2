# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/lava.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/lava.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/lava.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/lava.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/lava.c" 2
...
void Task_Lava(void)
{
    Lava *lava = (void *)((gCurTask)->data);
    MapEntity *me = lava->base.me;
    u8 meX = *(u8 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Lava, meX));
    u16 regionX = *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Lava, regionX));
    u16 regionY = *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Lava, regionY));
    Player *player;
    Player *partner;
    CamCoord x, y;
    s16 screenX, screenY;
    ...
    if ((((u16)(x + (256 / 2)) > 320 + 256) || (y + (256 / 2) < 0) || (y > 240 + (256 / 2)))) {
        ...
        do {
            if (*(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(Lava, unk3A)) == 1) {
        ...
        do {
            if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00400000) && (x <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)))
                && (x + (me->d.uData[2] * 8) >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (y <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))
                && (y + (me->d.uData[3] * 8) >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8))) && !((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
                if (me->d.sData[0] == 0) {
                    if (~(*(((i) != 0) ? &gPartner : &gPlayer)).itemEffect & 0x02) {
...
{
    struct Task *t = TaskCreate(Task_Lava, sizeof(Lava), 0x2000, 0, ((void*)0));

    *(u16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Lava, regionX)) = (regionX);;
    *(u16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Lava, regionY)) = (regionY);;
    *(u16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Lava, unk38)) = (0);;
    *(u16 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Lava, unk3A)) = (0);;





    *(MapEntity * *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Lava, base.me)) = (me);;
    *(u8 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Lava, unk3D)) = (0);;
    *(u8 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Lava, unk3E)) = (0);;
    *(u8 *)((unsigned char *)(void *)((t)->data) + __builtin_offsetof(Lava, meX)) = (me->x);;
