# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/boulder_spawner.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/boulder_spawner.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/boulder_spawner.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/boulder_spawner.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/boulder_spawner.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/boulder_spawner.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/boulder_spawner.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/boulder_spawner.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/boulder_spawner.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/boulder_spawner.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/boulder_spawner.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/boulder_spawner.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/boulder_spawner.c" 2
...
void Task_BoulderSpawnerMain(void)
{
    ...
    spawner = (void *)((gCurTask)->data);
    me = spawner->base.me;

    worldX = ((spawner->base.meX)*8 + (spawner->base.regionX)*256);
    worldY = ((me->y)*8 + (spawner->base.regionY)*256);

    if (({(((int)(((0 * 60.) + 2) * 60)) != 0) ? ((s32)(gStageTime) % (s32)((int)(((0 * 60.) + 2) * 60))) : 0;}) == 0) {
        struct Task *t = TaskCreate(Task_BoulderMain, sizeof(Boulder), 0x2000, 0, TaskDestructor_Boulder);

        Boulder *boulder = (void *)((t)->data);
        Sprite *s = &boulder->s;
        ...
        boulder->qUnk9C = ((s32)((0)*256));
        boulder->qUnkA0 = ((s32)((0.25)*256));
        boulder->qUnkA4 = ((s32)((0)*256));
        boulder->qUnkA8 = ((s32)((0)*256));
        boulder->qUnkAC = ((s32)((0)*256));
        boulder->unkB0 = 0;
    ...
    if (((worldX) > gCamera.x + (320 + (256 / 2)) || (worldX) < gCamera.x - (256 / 2) || (worldY) > gCamera.y + ((240) + ((256) / 2)) || (worldY) < gCamera.y - (256 / 2))) {
        { me->x = spawner->base.meX; };
...
void Task_BoulderMain(void)
{
    Boulder *boulder = (void *)((gCurTask)->data);
    Sprite *s = &boulder->s;
    ...
    s->x = unkB2 + ((int)((boulder->qUnkA8) >> 8)) - gCamera.x;
    s->y = unkB4 + ((int)((boulder->qUnkAC) >> 8)) - gCamera.y;

    if ((((u16)(unkB2 + (256 / 2)) > 320 + 256) || (unkB4 + (256 / 2) < 0) || (unkB4 > 240 + (256 / 2))) && (((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
        TaskDestroy(gCurTask);
        return;
    }
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            if (Coll_Player_Entity_Intersection(s, unkB2 + ((int)((boulder->qUnkA8) >> 8)), unkB4 + ((int)((boulder->qUnkAC) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
    ...
    if (boulder->unkB0) {
        res = sa2__sub_801F07C(unkB4 + ((int)((boulder->qUnkAC) >> 8)), unkB2 + ((int)((boulder->qUnkA8) >> 8)), 1, +8, ((void*)0), sa2__sub_801EE64);
        ...
        if (res >= 0) {
            ...
            if (boulder->unkB0 != 0) {
                ...
                if (boulder->unkB1 != 0) {
                    ...
                    CreateBoulderDebris(unkB2 + ((int)((boulder->qUnkA8) >> 8)) - gSpriteTransformX, unkB4 + ((int)((boulder->qUnkAC) >> 8)) - gSpriteTransformY);
        ...
        res = sa2__sub_801F07C(unkB4 + ((int)((boulder->qUnkAC) >> 8)), unkB2 + ((int)((boulder->qUnkA8) >> 8)), 1, +8, sp08, sa2__sub_801EE64);

        if (res > 5) {
            boulder->qUnkA4 += ((({((5) != 0) ? ((s32)(boulder->qUnkA0 * 2) / (s32)(5)) : 0;})) < 0 ? -(({((5) != 0) ? ((s32)(boulder->qUnkA0 * 2) / (s32)(5)) : 0;})) : (({((5) != 0) ? ((s32)(boulder->qUnkA0 * 2) / (s32)(5)) : 0;})));
            boulder->unkB0 = 1;
        } else {
            boulder->qUnkA0 += ({((1250) != 0) ? ((s32)((gSineTable[(sp08[0] * 4) + 256])) / (s32)(1250)) : 0;});
            boulder->qUnkAC += ((s32)((res + 2)*256));
        }
    }
...
void CreateBoulderDebris(s32 x, s32 y)
{
    ...
    BoulderDebris *debris = (void *)((t)->data);
...

    {
        ...
        DmaSet(3, s, &debris->sprites[1], (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(debris->sprites[1]))/(16/8))));
        s = &debris->sprites[1];
        DmaSet(3, tf, &debris->transforms[1], (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(debris->transforms[1]))/(16/8))));
    ...
    DmaSet(3, tf, &debris->transforms[2], (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(debris->transforms[1]))/(16/8))));
...

    {
        ...
        DmaSet(3, s, &debris->sprites[3], (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(debris->sprites[3]))/(16/8))));
        s = &debris->sprites[3];
        DmaSet(3, tf, &debris->transforms[3], (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(debris->transforms[3]))/(16/8))));
...
void Task_BoulderDebris(void)
{
    BoulderDebris *debris = (void *)((gCurTask)->data);
...

    {
        ...
        scale = tf->qScaleX + ((s32)((8. / 256.)*256));
        if (scale > ((s32)((2)*256))) {
            scale = ((s32)((2)*256));
        }
...
{
    struct Task *t = TaskCreate(Task_BoulderSpawnerMain, sizeof(BoulderSpawner), 0x2000, 0, ((void*)0));
    BoulderSpawner *spawner = (void *)((t)->data);
