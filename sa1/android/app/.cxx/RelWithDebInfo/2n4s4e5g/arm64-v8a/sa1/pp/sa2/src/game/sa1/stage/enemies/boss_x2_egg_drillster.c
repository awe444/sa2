# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x2_egg_drillster.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x2_egg_drillster.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x2_egg_drillster.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x2_egg_drillster.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x2_egg_drillster.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x2_egg_drillster.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x2_egg_drillster.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x2_egg_drillster.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x2_egg_drillster.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x2_egg_drillster.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_x2_egg_drillster.c" 2
...
{
    Component *drill = (void *)((gCurTask)->data);
    Sprite *s = &drill->s;
    ...
    if ((collPlayer == 2) || (collPartner == 2)) {
        EggDrillster *boss = (void *)(((struct Task *)((gCurTask)->parent))->data);
        Sprite *s2 = &boss->s2;
...
{
    EggDrillster *boss = (void *)((gCurTask)->data);
    Sprite *s = &boss->s;
    Sprite *s2 = &boss->s2;
...
void CreateEntity_EggDrillster(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    s->x = boss->worldX;
    s->y = boss->worldY;
    s->graphics.dest = VramMalloc(((72 / 8) * (48 / 8)));
    s->oamFlags = ((22) << 6);
    s->graphics.size = 0;
    s->graphics.anim = 682;
    s->variant = 0;
    ...
    switch (boss->unk8D) {
        case 0: {
            if (boss->worldX - (320 / 2) <= gCamera.x) {
                gCamera.minX = boss->worldX - (320 / 2) - 32;
                gCamera.maxX = boss->worldX + (320 / 2) + 32;
                boss->unk8D = 1;
            }
        } break;
        ...
        case 1: {
            if (boss->worldY - 224 <= gCamera.y) {
                CreatePreBossCameraPan((boss->worldY - 240), boss->worldY);
                boss->unk8D = 2;
            }
        } break;
    }
    ...
    switch (boss->unk8D) {
        ...
        case 1:
            if (--boss->unk84 == 0) {
                ...
                sub_8017540(((s32)((worldX + 0x10)*256)), ((s32)((worldY - 0x10)*256)));
                sub_8017540(((s32)((worldX - 0x10)*256)), ((s32)((worldY - 0x10)*256)));
                sub_8017540(((s32)((worldX + 0x14)*256)), ((s32)((worldY + 0x10)*256)));
                sub_8017540(((s32)((worldX - 0x14)*256)), ((s32)((worldY + 0x10)*256)));
                boss->unk84 = 320;
                boss->unk8D++;
            }
...
static void CreateFalloffComponents()
{
    ...
    component = (void *)((TaskCreate(Task_Drill, sizeof(Component), 0x2100U, 0U, TaskDestructor_Drill))->data);
    component->worldX = (boss->worldX + ((int)((boss->unk6C) >> 8)));
    component->worldY = (boss->worldY + ((int)((boss->unk70) >> 8)));
    ...
    for (i = 0; i < 4; i++) {
        component = (void *)((TaskCreate(sub_803673C, sizeof(Component), 0x2100 | i, 0U, TaskDestructor_Drill))->data);
        component->worldX = (boss->worldX + ((int)((boss->unk6C) >> 8)));
        component->worldY = (boss->worldY + ((int)((boss->unk70) >> 8)));
        component->unk34 = 0;
        component->unk38 = 0;
...
void sub_803673C(void)
{
    ...
    EggDrillster *boss;
    Component *component = (void *)((gCurTask)->data);
...
void Task_8036810()
{
    ...
    if (boss->unk8D != 0) {
        ...
        worldX = component->worldX + ((int)((component->unk34) >> 8));
        worldY = component->worldY + ((int)((component->unk38) >> 8));
        res = sa2__sub_801F100(worldY + 30, worldX, 1, 8, sa2__sub_801EC3C);

        if (res < 0) {
            component->unk38 += ((s32)((res)*256));
            component->qUnk3E = -component->qUnk3E + 4;

            if (((worldX < (gCamera.x - 32))) || (worldX > (gCamera.x + 320 + 32))) {
                TaskDestroy(gCurTask);
                return;
            }
        }
...
void Task_Drill()
{
    ...
    if (boss->unk86 > 2) {
        if (drill->unk30 != 0) {
            ...
            if ((worldX + 0x10) < ((int)((gPlayer.qWorldX) >> 8))) {
                sp4 = 1;
            }
        } else if ((worldX - 0x10) > ((int)((gPlayer.qWorldX) >> 8))) {
            sp4 = 1;
        }
        if (boss->unk86 > 3) {
            sp4 = 1;
...
void Task_8036B94()
{
    ...
    worldX = drill->worldX + ((int)((drill->unk34) >> 8));
    worldY = drill->worldY + ((int)((drill->unk38) >> 8));
    s->x = worldX - gCamera.x;
    s->y = worldY - gCamera.y;
    if (boss->unk86 < 4) {
        sub_8036CF4_inline(worldX, worldY);
    ...
    if ((u32)(drill->unk34 + ((s32)((192)*256))) > ((s32)((320 + (2 * 72))*256))) {
        TaskDestroy(gCurTask);
    }
}
