# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_3.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_3.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_3.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_3.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_3.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_3.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_3.c" 2
...
extern void LinkCommunicationError(void);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_3.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_3.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_3.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_3.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/game_2_3.c" 2
...
void sub_8062F90(void)
{
    ...
    strc5C = (void *)((TaskCreate(Task_80631E8, sizeof(Game_2_3_5C), 0x2000U, 0U, TaskDestructor_8063910))->data);
    strc5C->unk4C = 0;
    strc5C->unk57 = 0;
    strc5C->unk50 = 0x14;
    strc5C->unk52 = 0x14;
    ...
    t = TaskCreate(Task_8063914, sizeof(Game_2_3_54), 0x2030U, 0U, ((void*)0));
    strc54 = (void *)((t)->data);
    strc54->unk48 = 0;
    strc54->unk4C = 0;
    strc54->unk4E = 0;
    ...
    t = TaskCreate(Task_8063824, sizeof(Game_2_3_2DC), 0x2030U, 0U, ((void*)0));
    strc2DC = (void *)((t)->data);
    strc2DC->unk2D0 = 0;
    strc2DC->unk2D4 = 0;
    strc2DC->unk2D6 = 0;
    ...
    for (i = 0; i < (s32)(sizeof(strc2DC->sprites) / sizeof((strc2DC->sprites)[0])); i++) {
        s = &strc2DC->sprites[i];
    ...
    s->x = (320 / 2);
    s->y = (240 / 2);
    s->graphics.dest = &VRAM[0x10000] + 0xF00;
    s->oamFlags = 0x80;
    s->graphics.size = 0;
    s->graphics.anim = 905;
    s->variant = 0;
...
void Task_80631E8()
{
    ...
    s32 temp_r4;
    u8 *temp_r1_2;
    Game_2_3_5C *strc5C = (void *)((gCurTask)->data);
    Game_2_3_54 *strc54 = (void *)((strc5C->taskC)->data);
    Game_2_3_2DC *strc2DC = (void *)((strc5C->task10)->data);
...
void Task_80632B4()
{
    ...
    if (strc5C->unk55 > (({((24) != 0) ? ((s32)(strc5C->unk52) / (s32)(24)) : 0;}) + 5)) {
        strc5C->unk52 = ((strc5C->unk55 - 5) * 24) - 8;
    } else if (strc5C->unk55 <= ({((0x18) != 0) ? ((s32)(strc5C->unk52) / (s32)(0x18)) : 0;})) {
...
void Task_8063638()
{
    ...
    if (gMultiSioStatusFlags & 0x80) {
        ...
        if (i == 4) {
            ...
            while (gMultiSioSend.pat0.unk3 == ((({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) >> 8) & 7))
                ;
            while (gMultiSioSend.pat0.unk4 == ((({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) >> 8) & 7))
                ;
...
void Task_8063824()
{
    ...
    Game_2_3_2DC *strc2DC = (void *)((gCurTask)->data);
...
void Task_80638B0(void)
{
    ...
    gCurrentLevel = 14 + chaoHuntStageId;
