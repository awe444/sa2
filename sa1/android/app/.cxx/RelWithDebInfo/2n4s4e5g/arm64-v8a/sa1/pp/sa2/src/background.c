# 1 "/home/awaszczak/git/sa2/sa1/../src/background.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/background.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/background.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/background.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/background.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "/home/awaszczak/git/sa2/sa1/../src/background.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/background.c" 2
...

{
    ...
    while (gBackgroundsCopyQueueCursor != gBackgroundsCopyQueueIndex) {
        Background *bg;
# 114 "/home/awaszczak/git/sa2/sa1/../src/background.c"
        (*(reg_u16 *)(REG_BASE + 0x6));
        {
...
# 258 "/home/awaszczak/git/sa2/sa1/../src/background.c"
                        {
...
static AnimCmdResult animCmd_AddHitbox_BG(void *cursor, Sprite *s)
{
    ...
    if ((cmd->hitbox.b.left == 0) && (cmd->hitbox.b.top == 0) && (cmd->hitbox.b.right == 0) && (cmd->hitbox.b.bottom == 0)) {
        ...
        if (s->frameFlags & ((1) << (11))) {
            s->hitboxes[index].b.top ^= (u8)s->hitboxes[index].b.bottom; s->hitboxes[index].b.bottom ^= (u8)s->hitboxes[index].b.top; s->hitboxes[index].b.top = ((u8)s->hitboxes[index].b.bottom ^ (u8)s->hitboxes[index].b.top);;
        }

        if (s->frameFlags & ((1) << (10))) {
            s->hitboxes[index].b.left ^= (u8)s->hitboxes[index].b.right; s->hitboxes[index].b.right ^= (u8)s->hitboxes[index].b.left; s->hitboxes[index].b.left = ((u8)s->hitboxes[index].b.right ^ (u8)s->hitboxes[index].b.left);;
        }
    }
...
bool32 sa2__sub_80039E4(void)
{
    ...
    s32 sp28 = 5;
# 879 "/home/awaszczak/git/sa2/sa1/../src/background.c"
    gBgSpritesCount = 0;
    return 1;
...
# 1245 "/home/awaszczak/git/sa2/sa1/../src/background.c"
...
# 1292 "/home/awaszczak/git/sa2/sa1/../src/background.c"
