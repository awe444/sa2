# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/updraft.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/updraft.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/updraft.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/malloc_vram.h" 1
# 24 "/home/awaszczak/git/sa2/sa1/../include/malloc_vram.h"
void *VramMalloc(u32);
void VramResetHeapState(void);
void VramFree(void *);
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/updraft.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/updraft.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/updraft.c" 2
...
void CreateEntity_Interactable097(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    if (me->d.sData[0] == 0) {
        ...
        s->graphics.dest = VramMalloc(((8 / 8) * (16 / 8)));
        s->graphics.anim = 565;
        s->variant = 0;
    }
