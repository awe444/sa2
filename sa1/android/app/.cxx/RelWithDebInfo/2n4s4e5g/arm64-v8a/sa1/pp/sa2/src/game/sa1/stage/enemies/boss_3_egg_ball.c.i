# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_3_egg_ball.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_3_egg_ball.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_3_egg_ball.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_3_egg_ball.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/malloc_vram.h" 1
# 24 "/home/awaszczak/git/sa2/sa1/../include/malloc_vram.h"
void *VramMalloc(u32);
void VramResetHeapState(void);
void VramFree(void *);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_3_egg_ball.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_3_egg_ball.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_3_egg_ball.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_3_egg_ball.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_3_egg_ball.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_3_egg_ball.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_3_egg_ball.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_3_egg_ball.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_3_egg_ball.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_3_egg_ball.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_3_egg_ball.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 19 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/boss_3_egg_ball.c" 2
...
{
    EggBall_44 *boss_44 = (void *)((gCurTask)->data);
    Sprite *s = &boss_44->s;
    ...
    if ((collPlayer == 2) || (collPartner == 2)) {
        EggBall *boss = (void *)(((struct Task *)((gCurTask)->parent))->data);
        Sprite *s2 = &boss->s2;
...
{
    EggBall *boss = (void *)((gCurTask)->data);
    Sprite *s2 = &boss->s2;
...
void Task_802F0D0(void)
{
    ...
    if (boss->unk8B != 0) {
        if ((--boss->unk8B > 16) && !(boss->unk8B & 2) && (!(gPlayer.moveState & 0x00000080))) {
            s->frameFlags |= ((2) << (7));
            gDispCnt |= 0x8000;
...
void CreateEntity_EggBall(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    for (i = 0; i < 8; i++) {
        ...
        s = &strc->s;
        s->x = ((me->x)*8 + (regionX)*256) + unk3C;
        s->y = ((me->y)*8 + (regionY)*256) + unk3E;

        if ((i & -3) == 0) {
            void *vram = VramMalloc(((56 / 8) * (32 / 8)));
    ...
    Bosses_SetCamBounds(s0->y - (240 + 24), s0->y + 16, s0->x - (320 + 40), s0->x);
...
void Task_EggBallMain(void)
{
    ...
    if (boss->unk88++ > 120) {
        ...
        boss->qUnk70 = -((s32)((85)*256));
        boss->qUnk74 = 0;
        boss->qUnk7C = -((s32)((1)*256));

        worldX = ((boss->base.meX)*8 + (boss->base.regionX)*256) + ((int)((boss->qUnk70) >> 8));
        worldY = ((me->y)*8 + (boss->base.regionY)*256);
...
void Task_802F56C(void)
{
    ...
    EggBall *boss = (void *)((t)->data);
    Sprite *s = &boss->s;
    Sprite *s2 = &boss->s2;
    MapEntity *me = boss->base.me;

    if (boss->qUnk74 <= -((s32)((80)*256))) {
        if (--boss->unk88 == 0) {
            s2->variant = 1;
            boss->unk88 = 60;
...

    {
        ...
        worldX = ((boss->base.meX)*8 + (boss->base.regionX)*256) + ((int)((boss->qUnk70) >> 8));
        worldY = ((me->y)*8 + (boss->base.regionY)*256) + ((int)((boss->qUnk74) >> 8));
    ...
    if (boss->s2.variant == 0) {
        if (boss->unk88 == 0) {
            ...
            if (boss->qUnk74 <= -((s32)((208)*256))) {
                ...
                spr44->x = 0;
                spr44->y = 0;
                spr44->graphics.dest = VramMalloc(((48 / 8) * (48 / 8)));
                spr44->oamFlags = ((23) << 6);
                spr44->graphics.size = 0;
                spr44->graphics.anim = 625;
                spr44->variant = 0;
                spr44->animCursor = 0;
                spr44->qAnimDelay = 0;
                spr44->prevVariant = -1;
                spr44->animSpeed = ((int)((float)(1.0)*0x10));
                spr44->palId = 0;
...
void Task_802F804(void)
{
    ...
    me = boss->base.me;
    if (--boss->unk88 == 0) {
        EggBall_44 *strc = (void *)((boss->strc6C)->data);
        s32 a;
        s32 unk8E = ({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x7;
        boss->unk8E = unk8E;
...
void Task_802F9F8(void)
{
    ...
    if ((((u32)boss->qUnk70 + ((s32)((312)*256)) > ((s32)((344)*256))) || (boss->qUnk74 < -((s32)((208)*256)))) || (boss->qUnk74 > ((s32)((40)*256)))) {
        EggBall_44 *strc = (void *)((boss->strc6C)->data);
        boss->unk88 = 60;
        gCurTask->main = Task_802F804;
    }
...
void Task_802FC14(void)
{
    ...
    if (res < 0) {
        boss->qUnk74 += ((s32)((res)*256));
        boss->qUnk90 = (boss->qUnk90 >> 2) - boss->qUnk90;
        if (boss->qUnk90 > -((s32)((1)*256))) {
            boss->qUnk90 = 0U;
...
void Task_802FE88(void)
{
    ...
    if (boss->unk88++ > 240) {
        ...
        strc = (void *)((sub_80168F0(worldX, worldY, 0x10, 623, 0))->data);

        strc->qUnk46 = -((s32)((2)*256));
        strc->unk48 = +((s32)((0)*256));
        strc->unk42 = 0x80;
...
void Task_803020C(void)
{
    ...
    if ((((u32)boss_44->qUnk30 + ((s32)((312)*256)) > ((s32)((344)*256))) || (boss_44->qUnk34 < -((s32)((208)*256)))) || (boss_44->qUnk34 > ((s32)((40)*256)))) {
        gCurTask->main = Task_8030120;
    }
    worldX = ((boss->base.meX)*8 + (boss->base.regionX)*256) + ((int)((boss_44->qUnk30) >> 8));
    worldY = ((me->y)*8 + (boss->base.regionY)*256) + ((int)((boss_44->qUnk34) >> 8));
...
void Task_8030364(void)
{
    ...
    if (worldX < gCamera.x + (320 / 2)) {
        boss_44->qUnk38 = +((s32)((2)*256));
    } else {
        boss_44->qUnk38 = -((s32)((2)*256));
    }

    if (boss_44->qUnk3C == 0) {
        boss_44->qUnk3C = -((s32)((6)*256));
    } else if (boss_44->qUnk3C < 0) {
        boss_44->qUnk3C += -((s32)((3)*256));
    } else {
        boss_44->qUnk3C += +((s32)((3)*256));
    }
...
void Task_PipeInitialDelay(void)
{
    EggBall_Pipe *pipe = (void *)((gCurTask)->data);
...
void Task_PipeExtend()
{
    ...
    worldX = ((pipe->base.meX)*8 + (pipe->base.regionX)*256) + pipe->unk3C + pipe->unk40;
    worldY = ((me->y)*8 + (pipe->base.regionY)*256) + pipe->unk3E + pipe->unk42;
    s->x = worldX - gCamera.x;
    s->y = worldY - gCamera.y;
    if (!(6 & pipe->unk44)) {
...
void TaskDestructor_EggBall_44(struct Task *t)
{
    EggBall_44 *boss_44 = (void *)((t)->data);
