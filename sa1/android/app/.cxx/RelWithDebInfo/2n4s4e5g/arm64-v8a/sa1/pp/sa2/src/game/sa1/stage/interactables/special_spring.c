# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/special_spring.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/special_spring.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/special_spring.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/special_spring.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/special_spring.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/special_spring.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/special_spring.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/special_spring.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/special_spring.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/special_spring.c" 2
...
void CreateEntity_SpecialSpring(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
...

    {
        ...
        SpecialSpring *spring = (void *)((t)->data);
        Sprite *s = &spring->s;
...
{
    u32 res = 0;
    SpecialSpring *spring = (void *)((gCurTask)->data);
    Sprite *s = &spring->s;
    ...
    if ((s->variant == 0) && (s->frameFlags & ((1) << (14)))) {
        s->variant = 1;
        s->prevVariant = -1;
    }

    if (gNumSingleplayerCharacters == 2) {
        if (Coll_Player_Platform(s, worldX, worldY, &gPartner) & 0x00000008) {
            sa2__sub_8021BE0(&gPartner);
            gPartner.moveState &= ~0x00000008;
            gPartner.moveState |= 0x00000002;
            gPartner.moveState &= ~0x00000100;
            gPartner.qSpeedAirY = -((s32)((7.5)*256));
            gPartner.charState = 21;
            s->variant = 0;
            s->prevVariant = -1;
            { Player_HandleSpriteYOffsetChange(&gPartner, 14); { (&gPartner)->spriteOffsetX = 6; (&gPartner)->spriteOffsetY = 14; } };
            m4aSongNumStart(170);
        }
    }
    ...
    if ((!(gPlayer.moveState & 0x00000080))) {
        ...
        if ((Coll_Player_Platform(s, worldX, worldY, &gPlayer) & 0x00000008)
            ...
            gPlayer.qSpeedAirY = -((s32)((7.5)*256));
            if (res) {
...
void Task_TransitionSpStage(void)
{
    ...
    if (gPlayer.sa2__unk99[1] == 0) {
        ...
        gPlayer.qWorldY -= ((s32)((7.5)*256));

        if (((int)((gPlayer.qWorldY) >> 8)) - gCamera.y < -128) {
