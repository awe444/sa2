# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_1.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_1.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_1.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_1.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_1.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_1.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_1.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_1.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_1.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_1.c" 2


# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_1.c" 2
# 24 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_1.c"
u32 Coll_Player_Platform(Sprite *s, CamCoord x, CamCoord y, Player *p)
{
    ...
    playerIsInAir = p->moveState & 0x00000002;
    if ((p->moveState & 0x00000008) && (p->stoodObj == s)) {

        p->moveState &= ~0x00000008;
        playerIsInAir |= 0x00000002;
        stoodOnSprite = 1;
...
# 69 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_1.c"
        if (stoodOnSprite && !(p->moveState & 0x00000008)) {
            p->moveState &= ~0x00000020;
            p->moveState |= 0x00000002;
# 80 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_1.c"
        }
    }

    return result;
}
# 218 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_1.c"
u32 sa2__sub_800D0A0(Sprite *s, s16 worldX, s16 worldY, s16 qSpeedX, s16 qSpeedY, u8 layer, u32 arg6)

{
    ...
    MultiplayerPlayer *mpPlayer = (void *)((gCurTask)->data);
    ...
    if ((s->hitboxes[0].index == -1) || (gPlayer.moveState & 0x80) || ((worldX == ((int)((gPlayer.qWorldX) >> 8))) && (worldY == ((int)((gPlayer.qWorldY) >> 8))))) {
        return 0;
    }
    ...
    if (worldY == ((int)((gPlayer.qWorldY) >> 8))) {
        goto block_105;
    }
    temp_r3_3 = sp10[0];
...
block_17:
    ...
    temp_r6_2 = (&sp8[0])[1];
    temp_r1_3 = ((int)((gPlayer.qWorldY) >> 8)) + temp_r6_2;
...
block_23:
    ...
    {
        if ((((int)((gPlayer.qWorldY) >> 8)) > worldY) || ((gPlayer.qSpeedAirY - qSpeedY) < 0)) {
            goto block_72;
        }
        ...
        if (sp40 == 0) {
            ...
            if (res < 0) {
                ...
                if (((gPlayer.character != 2)
                    ...
                    && ((gPlayer.character != 3) || !(temp_r1_17 & 0x04000000) || (gPlayer.sa2__unk62 == 0))) {
                    gPlayer.moveState &= ~2;
                }
            ...
            if (((gPlayer.character != 2) || ((temp_r0_23 = (s8) * (&gPlayer.character - 0x1C), (temp_r0_23 != 1)) && (temp_r0_23 != 3)))
                && ((gPlayer.character != 3) || !(gPlayer.moveState & 0x04000000) || (gPlayer.sa2__unk62 == 0))) {
                gPlayer.moveState &= ~2;
            }
            gPlayer.stoodObj = s;
            ...
            sp3C += (((s32)((worldY + sp10[3] - sp8[3])*256)) - (gPlayer.qWorldY & 0xFFFFFF00));
            ...
            if (res < 0) {
                ...
                if (((temp_r2_12 != 2) || ((temp_r0_19 = (s8) * (&gPlayer.character - 0x1C), (temp_r0_19 != 1)) && (temp_r0_19 != 3)))
                    && ((temp_r2_12 != 3) || !(temp_r1_15 & 0x04000000) || (gPlayer.sa2__unk62 == 0))) {
                    gPlayer.moveState &= ~2;
                }
                { Player_HandleSpriteYOffsetChange(&gPlayer, 14); { (&gPlayer)->spriteOffsetX = 6; (&gPlayer)->spriteOffsetY = 14; } };
                gPlayer.qSpeedAirY = 0;
    ...
    block_80:
        if (sp40 == 0) {
            res = sa2__sub_801F100(gPlayer.spriteOffsetY + ((int)((gPlayer.qWorldY) >> 8)), temp_r0_7, layer, 8, sa2__sub_801EC3C);
            if (res < 0) {
                gPlayer.moveState &= ~4;
                ;
            ...
            res = sa2__sub_801F100(((int)((gPlayer.qWorldY) >> 8)) - gPlayer.spriteOffsetY, temp_r0_7, layer, -8, sa2__sub_801EC3C);
            if (res < 0) {
                ...
                if (((temp_r2_5 != 2) || ((temp_r0_11 = (s8) * (&gPlayer.character - 0x1C), (temp_r0_11 != 1)) && (temp_r0_11 != 3)))
                    && ((temp_r2_5 != 3) || !(temp_r1_5 & 0x04000000) || (gPlayer.sa2__unk62 == 0))) {
                    gPlayer.moveState &= ~2;
                }
        ...
        block_105:
            ...
            if (((((p->rotation + 0x20) & 0xC0) >> 6) & 1) == 0) {
                if ((((((worldX) + ((Rect8 *)&spC[0])->left) <= ((((int)((gPlayer.qWorldX) >> 8))) + ((Rect8 *)&sp4[0])->left) && (((worldX) + ((Rect8 *)&spC[0])->left) + (((Rect8 *)&spC[0])->right - ((Rect8 *)&spC[0])->left)) >= ((((int)((gPlayer.qWorldX) >> 8))) + ((Rect8 *)&sp4[0])->left)) || (((worldX) + ((Rect8 *)&spC[0])->left) >= ((((int)((gPlayer.qWorldX) >> 8))) + ((Rect8 *)&sp4[0])->left) && (((((int)((gPlayer.qWorldX) >> 8))) + ((Rect8 *)&sp4[0])->left) + (((Rect8 *)&sp4[0])->right - ((Rect8 *)&sp4[0])->left)) >= ((worldX) + ((Rect8 *)&spC[0])->left))) && (((((worldY)) + ((Rect8 *)&spC[0])->top) <= (((((int)((gPlayer.qWorldY) >> 8)))) + ((Rect8 *)&sp4[0])->top) && ((((worldY)) + ((Rect8 *)&spC[0])->top) + (((Rect8 *)&spC[0])->bottom - ((Rect8 *)&spC[0])->top)) >= (((((int)((gPlayer.qWorldY) >> 8)))) + ((Rect8 *)&sp4[0])->top)) || ((((worldY)) + ((Rect8 *)&spC[0])->top) >= (((((int)((gPlayer.qWorldY) >> 8)))) + ((Rect8 *)&sp4[0])->top) && ((((((int)((gPlayer.qWorldY) >> 8)))) + ((Rect8 *)&sp4[0])->top) + (((Rect8 *)&sp4[0])->bottom - ((Rect8 *)&sp4[0])->top)) >= (((worldY)) + ((Rect8 *)&spC[0])->top))))) {
                    if (temp_r1_6 <= worldX) {
                        if (!(p->moveState & 0x00000001)) {
                            ...
                            if (p->sa2__unk62 != 0) {
                                ...
                                sp38 = ((s32)(((worldX + spC[2]) - (s8)sp4[0])*256));
                                if (((p->qSpeedAirX) >= 0 ? (p->qSpeedAirX) : -(p->qSpeedAirX)) > ((s32)((4.5)*256))) {
                                    sp30 |= 0x200000;
                                    if (qSpeedX < 0) {
                                        if (arg6 != 0) {
                                    ...
                                    res = sa2__sub_801F100(((int)((sp38) >> 8)), ((int)((gPlayer.qWorldY) >> 8)) + p->spriteOffsetX, layer, -8, sa2__sub_801EB44);
                                    if (res < 0) {
                                        p->moveState &= ~4;
                            ...
                            if (p->sa2__unk62 != 0) {
                                ...
                                if (((qSpeedX) >= 0 ? (qSpeedX) : -(qSpeedX)) > ((s32)((4.5)*256))) {
                                    sp30 |= 0x200000;
                                    if (qSpeedX < 0) {
                                        if (arg6 != 0) {
                                            p->qSpeedGround = qSpeedX;
                        ...
                        if (p->moveState & 0x1) {
                            ...
                            if (gPlayer.sa2__unk62 != 0) {
                                ...
                                if (((p->qSpeedAirX) >= 0 ? (p->qSpeedAirX) : -(p->qSpeedAirX)) > ((s32)((4.5)*256))) {
                                    ...
                                    res = sa2__sub_801F100(sp38 >> 8, p->spriteOffsetX + ((int)((gPlayer.qWorldY) >> 8)), layer, +8, sa2__sub_801EB44);
                                    if (res < 0) {
                                        temp_r1_10 = p->moveState & ~4;
                                        p->moveState = temp_r1_10;
                                        temp_r0_13 = &p->character;
                                        temp_r2_9 = *temp_r0_13;
                                        if (((p->character != 2) || (((p->sa2__unk61 != 1)) && (p->sa2__unk61 != 3)))
                                            && ((p->character != 3) || !(temp_r1_10 & 0x04000000)
                                                || (p2 = p, (gPlayer.sa2__unk62 == 0)))) {
                                            gPlayer.moveState &= ~2;
                                        }

                                        { Player_HandleSpriteYOffsetChange(p, 14); { (p)->spriteOffsetX = 6; (p)->spriteOffsetY = 14; } };
                                        gPlayer.qSpeedAirX = 0;
                                        gPlayer.qWorldX += ((s32)((res)*256));
                                    } else {
                            ...
                            temp_r7 = &p->sa2__unk62;
                            temp_r6_4 = *temp_r7;
                            if (temp_r6_4 != 0) {
                                p->qSpeedAirX = 0;
                            } else {
                                if (((qSpeedX) >= 0 ? (qSpeedX) : -(qSpeedX)) > 0x480) {
                                    sp30 |= 0x200000;
                                    if (qSpeedX > 0) {
                                        if (arg6 != 0) {
                                            p->qSpeedGround = qSpeedX;
...
# 724 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_1.c"
u32 sa2__sub_800DA4C(Sprite *opponent, s16 qOppX, s16 qOppY, __attribute__((unused)) s32 param3, __attribute__((unused)) s32 param4, u8 layer)
{
    ...
    if ((p->qSpeedAirX == 0 && p->qSpeedAirY == 0) && ((opponent->hitboxes[1]).index != -1)) {
        if ((((((qOppX) + opponent->hitboxes[1].b.left) <= ((mpp->pos.x) + mpPlayerSprite->hitboxes[0].b.left) && ((((qOppX)) + (opponent->hitboxes[1].b).left) + ((opponent->hitboxes[1].b).right - (opponent->hitboxes[1].b).left)) >= ((mpp->pos.x) + mpPlayerSprite->hitboxes[0].b.left)) || (((qOppX) + opponent->hitboxes[1].b.left) >= ((mpp->pos.x) + mpPlayerSprite->hitboxes[0].b.left) && ((((mpp->pos.x)) + (mpPlayerSprite->hitboxes[0].b).left) + ((mpPlayerSprite->hitboxes[0].b).right - (mpPlayerSprite->hitboxes[0].b).left)) >= ((qOppX) + opponent->hitboxes[1].b.left))) && (((((qOppY)) + opponent->hitboxes[1].b.top) <= (((mpp->pos.y)) + mpPlayerSprite->hitboxes[0].b.top) && ((((qOppY)) + opponent->hitboxes[1].b.top) + ((opponent->hitboxes[1].b).bottom - (opponent->hitboxes[1].b).top)) >= (((mpp->pos.y)) + mpPlayerSprite->hitboxes[0].b.top)) || ((((qOppY)) + opponent->hitboxes[1].b.top) >= (((mpp->pos.y)) + mpPlayerSprite->hitboxes[0].b.top) && ((((mpp->pos.y)) + mpPlayerSprite->hitboxes[0].b.top) + ((mpPlayerSprite->hitboxes[0].b).bottom - (mpPlayerSprite->hitboxes[0].b).top)) >= (((qOppY)) + opponent->hitboxes[1].b.top))))) {

            result |= 0x00000002;
        }
    }

    if (((mpPlayerSprite->hitboxes[1]).index != -1) && ((opponent->hitboxes[0]).index != -1)
        && (((((qOppX) + opponent->hitboxes[0].b.left) <= ((mpp->pos.x) + mpPlayerSprite->hitboxes[1].b.left) && ((((qOppX)) + (opponent->hitboxes[0].b).left) + ((opponent->hitboxes[0].b).right - (opponent->hitboxes[0].b).left)) >= ((mpp->pos.x) + mpPlayerSprite->hitboxes[1].b.left)) || (((qOppX) + opponent->hitboxes[0].b.left) >= ((mpp->pos.x) + mpPlayerSprite->hitboxes[1].b.left) && ((((mpp->pos.x)) + (mpPlayerSprite->hitboxes[1].b).left) + ((mpPlayerSprite->hitboxes[1].b).right - (mpPlayerSprite->hitboxes[1].b).left)) >= ((qOppX) + opponent->hitboxes[0].b.left))) && (((((qOppY)) + opponent->hitboxes[0].b.top) <= (((mpp->pos.y)) + mpPlayerSprite->hitboxes[1].b.top) && ((((qOppY)) + opponent->hitboxes[0].b.top) + ((opponent->hitboxes[0].b).bottom - (opponent->hitboxes[0].b).top)) >= (((mpp->pos.y)) + mpPlayerSprite->hitboxes[1].b.top)) || ((((qOppY)) + opponent->hitboxes[0].b.top) >= (((mpp->pos.y)) + mpPlayerSprite->hitboxes[1].b.top) && ((((mpp->pos.y)) + mpPlayerSprite->hitboxes[1].b.top) + ((mpPlayerSprite->hitboxes[1].b).bottom - (mpPlayerSprite->hitboxes[1].b).top)) >= (((qOppY)) + opponent->hitboxes[0].b.top))))) {
        ...
        result |= 0x00000001;
    } else if (((mpPlayerSprite->hitboxes[0]).index != -1) && ((opponent->hitboxes[1]).index != -1)
               && (((((qOppX) + opponent->hitboxes[1].b.left) <= ((mpp->pos.x) + mpPlayerSprite->hitboxes[0].b.left) && ((((qOppX)) + (opponent->hitboxes[1].b).left) + ((opponent->hitboxes[1].b).right - (opponent->hitboxes[1].b).left)) >= ((mpp->pos.x) + mpPlayerSprite->hitboxes[0].b.left)) || (((qOppX) + opponent->hitboxes[1].b.left) >= ((mpp->pos.x) + mpPlayerSprite->hitboxes[0].b.left) && ((((mpp->pos.x)) + (mpPlayerSprite->hitboxes[0].b).left) + ((mpPlayerSprite->hitboxes[0].b).right - (mpPlayerSprite->hitboxes[0].b).left)) >= ((qOppX) + opponent->hitboxes[1].b.left))) && (((((qOppY)) + opponent->hitboxes[1].b.top) <= (((mpp->pos.y)) + mpPlayerSprite->hitboxes[0].b.top) && ((((qOppY)) + opponent->hitboxes[1].b.top) + ((opponent->hitboxes[1].b).bottom - (opponent->hitboxes[1].b).top)) >= (((mpp->pos.y)) + mpPlayerSprite->hitboxes[0].b.top)) || ((((qOppY)) + opponent->hitboxes[1].b.top) >= (((mpp->pos.y)) + mpPlayerSprite->hitboxes[0].b.top) && ((((mpp->pos.y)) + mpPlayerSprite->hitboxes[0].b.top) + ((mpPlayerSprite->hitboxes[0].b).bottom - (mpPlayerSprite->hitboxes[0].b).top)) >= (((qOppY)) + opponent->hitboxes[1].b.top))))) {
        result |= 0x00000002;
    }
