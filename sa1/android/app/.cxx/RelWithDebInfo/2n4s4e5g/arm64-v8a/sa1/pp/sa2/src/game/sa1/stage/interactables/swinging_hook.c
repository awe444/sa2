# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swinging_hook.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swinging_hook.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swinging_hook.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swinging_hook.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swinging_hook.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swinging_hook.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swinging_hook.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swinging_hook.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swinging_hook.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swinging_hook.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swinging_hook.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swinging_hook.c" 2
...
void CreateEntity_SwingingHook(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    {
        s1->x = ((me->x)*8 + (regionX)*256) - gCamera.x;
        s1->y = ((me->y)*8 + (regionY)*256) - gCamera.y;

        (me)->x = (-2);;

        s1->graphics.dest = VramMalloc(((32 / 8) * (32 / 8)));
        s1->oamFlags = ((18) << 6);
        s1->graphics.size = 0;
        s1->graphics.anim = 504;
        s1->variant = 1;
        s1->animCursor = 0;
        ...
        if (me->d.sData[0]) {
            s1->frameFlags = ((gOamMatrixIndex++) << (12)) | (((30) << (0)) | ((1) << (5)) | ((1) << (6)));
        } else {
            s1->frameFlags = ((gOamMatrixIndex++) << (12)) | (((31) << (0)) | ((1) << (5)) | ((1) << (6)));
        }
    }

    {
        s3->x = ((me->x)*8 + (regionX)*256) - gCamera.x;
        s3->y = ((me->y)*8 + (regionY)*256) - gCamera.y - 8;

        s3->graphics.dest = VramMalloc(((8 / 8) * (8 / 8)));
        s3->oamFlags = ((18) << 6);
        s3->graphics.size = 0;
        s3->graphics.anim = 503;
        s3->variant = 2;
        s3->animCursor = 0;
        s3->qAnimDelay = ((s32)((0)*256));
        s3->prevVariant = -1;
        s3->animSpeed = ((int)((float)(1.0)*0x10));
        s3->palId = 0;
    ...
    {
        s2->x = ((me->x)*8 + (regionX)*256) - gCamera.x;
        s2->y = ((me->y)*8 + (regionY)*256) - gCamera.y;

        s2->graphics.dest = VramMalloc(((8 / 8) * (8 / 8)));
        s2->oamFlags = ((18) << 6);
        s2->graphics.size = 0;
        s2->graphics.anim = 503;
        s2->variant = 1;
        s2->animCursor = 0;
    ...
    worldX = ((hook->base.meX)*8 + (hook->base.regionX)*256);
    worldY = ((me->y)*8 + (hook->base.regionY)*256);
...
void Task_SwingingHook(void)
{
    ...
    modRes = ({((((s32)((2)*256))) != 0) ? ((s32)(({((3) != 0) ? ((s32)(gStageTime * 8) / (s32)(3)) : 0;}) + hook->unkB2) % (s32)(((s32)((2)*256)))) : 0;});

    if (modRes > ((s32)((1)*256))) {
        modRes -= ((s32)((1)*256));
        modRes = ((s32)((1)*256)) - modRes;

        r2 = +((gSineTable[(modRes * 2)]) >> 8);
    } else {
    ...
    modRes = (gSineTable[(((modRes - 0x7E) & 0x1FF) * 2)]) >> 7;
    modRes &= 0x1FF;

    if (modRes < ((s32)((1)*256))) {
        modRes >>= 1;
    } else {
        modRes = (((s32)((2)*256)) - ((((s32)((2)*256)) - modRes) >> 1));
    }


    modRes <<= 1;

    sinVal = ((gSineTable[(modRes & (1024 - 1))]) + r2);
    cosVal = ((gSineTable[(modRes & (1024 - 1)) + 256]) + r2);
    ...
    if (((worldX2) > gCamera.x + (320 + (256 / 2)) || (worldX2) < gCamera.x - (256 / 2) || (worldY2) > gCamera.y + ((240) + ((256) / 2)) || (worldY2) < gCamera.y - (256 / 2)) && (((u16)(s1->x + (256 / 2)) > 320 + 256) || (s1->y + (256 / 2) < 0) || (s1->y > 240 + (256 / 2)))) {

        i = 0;
        do {


            if ((((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000008) && ((*(((i) != 0) ? &gPartner : &gPlayer)).stoodObj == (s1)))) {
...

        {
            ...
            for (i = 0; i < 3; i++) {
                ...
                sp18 += ({((100) != 0) ? ((s32)(sinVal * 90) / (s32)(100)) : 0;});
                sp1C += ({((100) != 0) ? ((s32)(cosVal * 90) / (s32)(100)) : 0;});
        ...
        sp18 += ({((100) != 0) ? ((s32)(sinVal * 110) / (s32)(100)) : 0;});
        sp1C += ({((100) != 0) ? ((s32)(cosVal * 110) / (s32)(100)) : 0;});
        ...
        do {
            ...
            if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
                if ((((hook->unkB4) >> (i)) & 1)) {
                    ...
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = ((s32)((worldX + ({((780) != 0) ? ((s32)(sp18) / (s32)(780)) : 0;}) - 4)*256));

                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000001) {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX += ((s32)((10)*256));
                    }


                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((worldY + ({((680) != 0) ? ((s32)(sp1C) / (s32)(680)) : 0;}) + 2)*256));
                    (*(((i) != 0) ? &gPartner : &gPlayer)).rotation = 0;
                    ...
                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).frameInput & gPlayerControls.jump) {
                        ...
                        if ((*(((i) != 0) ? &gPartner : &gPlayer)).heldInput & (0x0020 | 0x0010)) {

                            if ((*(((i) != 0) ? &gPartner : &gPlayer)).heldInput & 0x0020) {
                                (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000001;
                                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = -((s32)((2)*256));
                                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = -((s32)((2)*256));
                            } else {
                    ...
                    if (hook->unkB0[i]) {
                        ...
                        if ((worldX + ({((950) != 0) ? ((s32)(sp18) / (s32)(950)) : 0;}) - 16 <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldX + ({((950) != 0) ? ((s32)(sp18) / (s32)(950)) : 0;}) + 16 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)))
                            && (worldY + ({((950) != 0) ? ((s32)(sp1C) / (s32)(950)) : 0;}) - 16 <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))
                            && (worldY + ({((950) != 0) ? ((s32)(sp1C) / (s32)(950)) : 0;}) + 16 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) {

                            (hook->unkB4) |= (1 << (i));
                            Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                            (*(((i) != 0) ? &gPartner : &gPlayer)).stoodObj = s1;
                            (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000008;
                            (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00400000;
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = ((s32)((0)*256));
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = ((s32)((0)*256));
                            ...
                            (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 38;
                            (*(((i) != 0) ? &gPartner : &gPlayer)).itemEffect |= 0x80;
...
# 393 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/swinging_hook.c"
