# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/run_wheel.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/run_wheel.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/run_wheel.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/run_wheel.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/run_wheel.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/run_wheel.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/run_wheel.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/run_wheel.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/run_wheel.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/run_wheel.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/run_wheel.c" 2
...
void CreateEntity_RunWheel(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    wheel->qUnk3C = me->d.uData[2] * ((s32)((16.875)*256));
    wheel->qUnk40 = ((s32)((0)*256));
    wheel->unk4E = me->d.sData[0];
    wheel->qUnk44 = ((s32)((0)*256));
    wheel->unk4C = 0;
...
void Task_RunWheel(void)
{
    RunWheel *wheel = (void *)((gCurTask)->data);
    Sprite *s = &wheel->s;
    ...
    worldX = ((wheel->base.meX)*8 + (wheel->base.regionX)*256);
    worldY = ((me->y)*8 + (wheel->base.regionY)*256);

    theta = (wheel->unk4E << 7) & (1024 - 1);
    worldX32 = worldX + ({((0x1770) != 0) ? ((s32)((gSineTable[(theta) + 256])) / (s32)(0x1770)) : 0;}) * ({((0xC80) != 0) ? ((s32)(wheel->qUnk40) / (s32)(0xC80)) : 0;});

    theta = (wheel->unk4E << 7) & (1024 - 1);
    worldY32 = worldY + ({((0x1770) != 0) ? ((s32)((gSineTable[(theta)])) / (s32)(0x1770)) : 0;}) * ({((0xC80) != 0) ? ((s32)(wheel->qUnk40) / (s32)(0xC80)) : 0;});
    ...
    do {
        if (((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000008) && (*(((i) != 0) ? &gPartner : &gPlayer)).stoodObj == s) {
            sub_808EC84(wheel, s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)));
        } else {
            sub_808EA80(wheel, s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)));
        }
...
bool32 sub_808EA80(RunWheel *wheel, Sprite *s, s32 worldX, s32 worldY, Player *p)
{
    ...
    if ((!((p)->moveState & 0x00000080))) {
        if (sub_80549FC()) {
            worldX32 = (CamCoord)(worldX + ({((0x1770) != 0) ? ((s32)((gSineTable[(((wheel->unk4E * 0x80) & (1024 - 1))) + 256])) / (s32)(0x1770)) : 0;}) * ({((0xC80) != 0) ? ((s32)(wheel->qUnk40) / (s32)(0xC80)) : 0;}));
            worldY32 = (CamCoord)(worldY + ({((0x1770) != 0) ? ((s32)((gSineTable[(((wheel->unk4E * 0x80) & (1024 - 1)))])) / (s32)(0x1770)) : 0;}) * ({((0xC80) != 0) ? ((s32)(wheel->qUnk40) / (s32)(0xC80)) : 0;}));

            Coll_Player_Platform(s, worldX32, worldY32, p);
        } else {
            if (Coll_Player_Platform(s, s->x + gCamera.x, s->y + gCamera.y, p) & 0x00000008) {
    ...
    if (p->playerID == 0) {
        s32 v;
        if (({((0x1C) != 0) ? ((s32)(wheel->qUnk44) / (s32)(0x1C)) : 0;}) < 0) {
            v = -({((0x1C) != 0) ? ((s32)(wheel->qUnk44) / (s32)(0x1C)) : 0;});
        } else {
            v = +({((0x1C) != 0) ? ((s32)(wheel->qUnk44) / (s32)(0x1C)) : 0;});
        }
        s->animSpeed = v;

        wheel->qUnk44 -= ((s32)((12. / 256.)*256));
        ...
        if ((u32)wheel->qUnk44 + ((s32)((5)*256)) - 1 < ((s32)((10)*256)) - 1) {
            if (wheel->qUnk44 != ((s32)((0)*256))) {
                if (({((25) != 0) ? ((s32)(wheel->unk4C) % (s32)(25)) : 0;}) == 0) {
                    m4aSongNumStart(212);
                }
            }
        } else if ((u32)wheel->qUnk44 + 0x81F < 0x103F) {
            if (({((16) != 0) ? ((s32)(wheel->unk4C) % (s32)(16)) : 0;}) == 0) {
                m4aSongNumStart(213);
            }
        } else {
            if (({((8) != 0) ? ((s32)(wheel->unk4C) % (s32)(8)) : 0;}) == 0) {
                m4aSongNumStart(214);
            }
        }
    }
...

{
    ...
    if (p->charState != 15 && (!((p)->moveState & 0x00000080))) {
        if (sub_80549FC()) {
            worldX32 = (CamCoord)(worldX + ({((0x1770) != 0) ? ((s32)((gSineTable[(((wheel->unk4E * 0x80) & (1024 - 1))) + 256])) / (s32)(0x1770)) : 0;}) * ({((0xC80) != 0) ? ((s32)(wheel->qUnk40) / (s32)(0xC80)) : 0;}));
            worldY32 = (CamCoord)(worldY + ({((0x1770) != 0) ? ((s32)((gSineTable[(((wheel->unk4E * 0x80) & (1024 - 1)))])) / (s32)(0x1770)) : 0;}) * ({((0xC80) != 0) ? ((s32)(wheel->qUnk40) / (s32)(0xC80)) : 0;}));
            ...
            Coll_Player_Platform(s, worldX32, worldY32, p);
        } else if ((p->moveState & 0x00000008) && p->stoodObj == s) {
            p->qWorldY = ((s32)((s->y + gCamera.y + s->hitboxes[0].b.top - p->spriteOffsetY)*256));

            if ((p->moveState & 0x00000002) || p->sa2__unk62) {
                wheel->unk4C = 0;
                ...
                if (p->moveState & 0x00000002) {
                    ...
                    if ((p->character != CHARACTER_AMY) || !(p->moveState & 0x04000000)) {
                        const s32 qSpeedConst = ((s32)((1.125)*256));

                        s16 qSpeed = ({ s16 clamped; if ((p->qSpeedAirX) >= (-qSpeedConst)) { clamped = (p->qSpeedAirX) > (+qSpeedConst) ? (+qSpeedConst) : (p->qSpeedAirX); } else { clamped = (-qSpeedConst); } clamped; });
                        p->qSpeedAirX = qSpeed;
                    ...
                    if (Coll_Player_Platform(s, s->x + gCamera.x, s->y + gCamera.y, p) & 0x00000008) {
                        ...
                        qSpeed = ({ s16 clamped; if ((p->qSpeedGround) >= (-0x240)) { clamped = (p->qSpeedGround) > (+0x240) ? (+0x240) : (p->qSpeedGround); } else { clamped = (-0x240); } clamped; });
                ...
                p->qWorldX = ((s32)((worldX + ({((0x1770) != 0) ? ((s32)((gSineTable[(((wheel->unk4E * 0x80) & (1024 - 1))) + 256])) / (s32)(0x1770)) : 0;}) * ({((0xC80) != 0) ? ((s32)(wheel->qUnk40) / (s32)(0xC80)) : 0;}))*256)) - p->qSpeedAirX;
            }
            if (p->playerID == 0) {
                if (({((0x1C) != 0) ? ((s32)(wheel->qUnk44) / (s32)(0x1C)) : 0;}) < 0) {
                    s->animSpeed = -({((0x1C) != 0) ? ((s32)(wheel->qUnk44) / (s32)(0x1C)) : 0;});
                } else {
                    s->animSpeed = +({((0x1C) != 0) ? ((s32)(wheel->qUnk44) / (s32)(0x1C)) : 0;});
                }

                if ((p->character != CHARACTER_AMY) || (p->charState != 2)) {
                    wheel->qUnk44 = p->qSpeedGround - ((s32)((16. / 256.)*256));
                } else {
                ...
                if (wheel->qUnk44 > ((s32)((11.125)*256))) {
                    wheel->qUnk44 = ((s32)((11.125)*256));
                }
                ...
                if (wheel->qUnk44 < ((s32)((0)*256))) {
                    if (p->qSpeedGround <= ((s32)((0)*256))) {
                        if ((p->character != CHARACTER_SONIC) || (p->sa2__unk62 != 3)) {
                ...
                p->qSpeedGround = (p->qSpeedGround < -((s32)((9)*256))) ? -((s32)((9)*256)) : (qSpeed > +((s32)((4.5)*256))) ? ((s32)((4.5)*256)) : qSpeed;

                if (wheel->qUnk40 < ((s32)((0)*256))) {
                    wheel->qUnk40 = 0;
                    wheel->qUnk44 = 0;

                    if ((p->sa2__unk62 == 0) && (qSpeed << 16) < 0) {
                        p->qSpeedGround = 0;
                    }
