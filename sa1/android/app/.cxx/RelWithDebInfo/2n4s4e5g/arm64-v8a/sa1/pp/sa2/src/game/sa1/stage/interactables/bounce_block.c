# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bounce_block.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bounce_block.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bounce_block.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bounce_block.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bounce_block.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bounce_block.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bounce_block.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bounce_block.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bounce_block.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bounce_block.c" 2
...
extern const AnimId sBounceBlockAnims[18];
...
void Task_BounceBlock(void)
{
    BounceBlock *block = (void *)((gCurTask)->data);
    Sprite *s = &block->s;
    MapEntity *me = block->base.me;
    CamCoord worldX, worldY;

    worldX = ((block->base.meX)*8 + (block->base.regionX)*256);
    worldY = ((me->y)*8 + (block->base.regionY)*256);
...
void Task_80752A4(void)
{
    ...
    s->x = worldX - gCamera.x;
    newBounceOffset = ({((1024) != 0) ? ((s32)((gSineTable[(block->bounceOffset & (1024 - 1))])) / (s32)(1024)) : 0;});
    ...
    if ((((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
        ...
        block->bounceOffset += ((s32)((360. / 1024.)*256));
...
bool32 sub_80753D0(Sprite *s, s32 worldX, s32 worldY)
{
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            if ((Coll_Player_Platform(s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer))) & 0x8)) {
                ...
                (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 23;
