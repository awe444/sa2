# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bumpers.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bumpers.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bumpers.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bumpers.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bumpers.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bumpers.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bumpers.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bumpers.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bumpers.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bumpers.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bumpers.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/interactables.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bumpers.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bumpers.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 19 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/bumpers.c" 2
...
void CreateEntity_BumperHexagon(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    s->graphics.dest = VramMalloc(((48 / 8) * (40 / 8)));
    s->graphics.anim = 484;
    s->variant = 0;
    s->oamFlags = ((18) << 6);
    s->graphics.size = 0;
...
void Task_BumperHexagon(void)
{
    BumperA *bumper = (void *)((gCurTask)->data);
    Sprite *s = &bumper->s;
    MapEntity *me = bumper->base.me;
    CamCoord worldX, worldY;

    if (bumper->unk48 != 0) {
        s32 r2 = ((s32)((me->d.uData[2] * 8)*256));

        bumper->unk40 = (r2 * (gSineTable[(((bumper->unk48 * ((gStageTime + bumper->unk3C) & 0xFF)) & (1024 - 1)))])) >> 14;
    }

    worldX = ((bumper->base.meX)*8 + (bumper->base.regionX)*256);
    worldY = ((me->y)*8 + (bumper->base.regionY)*256);

    s->x = worldX - gCamera.x + ((int)((bumper->unk40) >> 8));
    s->y = worldY - gCamera.y + ((int)((bumper->unk44) >> 8));
...
void Task_BumperHexagon2(void)
{
    ...
    s->x = worldX - gCamera.x + ((int)((bumper->unk40) >> 8)) - ((gSineTable[(bumper->unk4E * 128) + 256]) >> 12);
    s->y = worldY - gCamera.y + ((int)((bumper->unk44) >> 8)) + ((gSineTable[(bumper->unk4E * 128)]) >> 12);
...
bool32 BumperCheckCollAndPosA1(BumperA *bumper, Sprite *s, s32 worldX, s32 worldY)
{
    ...
    i = 0;
    do {
        s32 qTempPlayerX = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX;

        if (Coll_Player_Entity_Intersection(s, worldX + ((int)((bumper->unk40) >> 8)), worldY + ((int)((bumper->unk44) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer)))
            && !((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00400000)) {
            if ((((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_TAILS) || ((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_KNUCKLES))
                && ((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk61 != 0)) {
            ...
            { (&(*(((i) != 0) ? &gPartner : &gPlayer)))->spriteOffsetX = 6; (&(*(((i) != 0) ? &gPartner : &gPlayer)))->spriteOffsetY = 9; };

            rot = sa2__sub_8004418(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) - worldY - ((int)((bumper->unk44) >> 8)),
                                         ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) - worldX - ((int)((bumper->unk40) >> 8)));

            if ((u32)(rot - 0x40) > (s32)(0.875 * 1024)) {
                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = +((s32)((6.3984375)*256));
            } else if ((u32)(rot - (s32)(0.4375 * 1024) - 1) <= (s32)(0.1328125 * 1024)) {
                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = -((s32)((6.3984375)*256));
            } else {
                if ((u32)rot > 0x249) {
                    if ((u32)rot > (s32)(0.75 * 1024)) {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = +0x297;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = -0x5D9;
                    } else {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = -0x297;
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = -0x5D9;
                    }
                } else if ((u32)rot > (s32)(0.25 * 1024)) {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = -0x297;
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = 0x5D9;
                } else {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = 0x297;
        ...
        (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = qTempPlayerX;
...
{
    struct Task *t = TaskCreate(Task_BumperRound_LinearMov, sizeof(BumperA), 0x2000, 0, ((void*)0));
    BumperA *bumper = (void *)((t)->data);
    Sprite *s = &bumper->s;
    ...
    s->graphics.dest = ((void *)&VRAM[0x10000] + 0x2E20);
    s->oamFlags = ((18) << 6);
    s->graphics.size = 0;
    s->graphics.anim = 485;
    s->variant = 0;
...
void Task_BumperRound_LinearMov(void)
{
    ...
    if (bumper->unk4A != 0) {
        s32 r2 = ((s32)((me->d.uData[3] * 8)*256));

        bumper->unk44 = (r2 * (gSineTable[(((bumper->unk4A * ((gStageTime + bumper->unk3C) & 0xFF)) & (1024 - 1)))])) >> 14;
    }
...
bool32 BumperCheckCollAndPosA2(BumperA *bumper, Sprite *s, s32 worldX, s32 worldY)
{
    ...
    do {
        ...
        if (Coll_Player_Entity_Intersection(s, worldX + ((int)((bumper->unk40) >> 8)), worldY + ((int)((bumper->unk44) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer)))
            ...
            (&(*(((i) != 0) ? &gPartner : &gPlayer)))->spriteOffsetX = 6;
            (&(*(((i) != 0) ? &gPartner : &gPlayer)))->spriteOffsetY = 9;

            rot = sa2__sub_8004418(
                ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) - worldY - ((int)((bumper->unk44) >> 8)),
                ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) - worldX - ((int)((bumper->unk40) >> 8)));

            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = ({((15) != 0) ? ((s32)((gSineTable[(rot) + 256])) / (s32)(15)) : 0;});
            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = ({((15) != 0) ? ((s32)((gSineTable[(rot) + 256])) / (s32)(15)) : 0;});
            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = ({((15) != 0) ? ((s32)((gSineTable[(rot)])) / (s32)(15)) : 0;});

            if ((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX == ((s32)((0)*256))) {
                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = +((s32)((8. / 256.)*256));
            }

            { s32 divResA, divResB; s32 oldScore = gLevelScore; gLevelScore += 10; divResA = ({((50000) != 0) ? ((s32)(gLevelScore) / (s32)(50000)) : 0;}); divResB = ({((50000) != 0) ? ((s32)(oldScore) / (s32)(50000)) : 0;}); if ((divResA != divResB) && (gGameMode == 0)) { u16 lives = divResA - divResB; lives += gNumLives;; ({ if ((lives) > 255) (lives) = 255; gNumLives = (lives); }); if (1) gMusicManagerState.unk3 = 0x10 | 0x0; } };
...
{
    struct Task *t = TaskCreate(Task_BumperRound_CircularMov, sizeof(BumperB), 0x2000, 0, ((void*)0));
    BumperB *bumper = (void *)((t)->data);
    Sprite *s = &bumper->s;
    ...
    {
        bumper->unk3C = ((s32)((me->d.sData[0] & 0x7)*256));
...
void Task_BumperRound_CircularMov(void)
{
    BumperB *bumper = (void *)((gCurTask)->data);
    Sprite *s = &bumper->s;
    MapEntity *me = bumper->base.me;
    CamCoord worldX, worldY;

    if (bumper->unk4E != 0) {
        bumper->unk40 = ((gSineTable[((((+me->d.sData[1] * gStageTime) + bumper->unk3C) & 0x7FF) >> 1)])) * bumper->unk4F;
        bumper->unk44 = ((gSineTable[((((+(me->d.sData[1]) * gStageTime) + bumper->unk3C) & 0x7FF) >> 1) + 256])) * bumper->unk4F;
    } else {
        bumper->unk40 = ((gSineTable[((((-me->d.sData[1] * gStageTime) + bumper->unk3C) & 0x7FF) >> 1)])) * bumper->unk4F;
        bumper->unk44 = ((gSineTable[((((-(me->d.sData[1]) * gStageTime) + bumper->unk3C) & 0x7FF) >> 1) + 256])) * bumper->unk4F;
    }
    ...
    s->x = worldX - gCamera.x + (((int)((bumper->unk40) >> 8)) >> 3);
    s->y = worldY - gCamera.y + (((int)((bumper->unk44) >> 8)) >> 3);
    ...
    s->y += (gSineTable[(bumper->unk4C)]) >> 12;
...
void Task_BumperRound_CircularMov2(void)
{
    ...
    s->x = worldX - gCamera.x + ((int)((bumper->unk40 >> 3) >> 8)) - ((gSineTable[(bumper->unk51 * 128) + 256]) >> 12);
    s->y = worldY - gCamera.y + ((int)((bumper->unk44 >> 3) >> 8)) + ((gSineTable[(bumper->unk51 * 128)]) >> 12);
...
bool32 BumperCheckCollAndPosB(BumperB *bumper, Sprite *s, s32 worldX, s32 worldY)
{
    ...
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            if (Coll_Player_Entity_Intersection(s, worldX + ((int)((bumper->unk40 >> 3) >> 8)), worldY + ((int)((bumper->unk44 >> 3) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                if ((((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_TAILS) || ((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_KNUCKLES))
                    && ((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk61 != 0)) {
                    Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                    (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 5;
...
{
    Sprite *s = ((void*)0);
    struct Task *t = TaskCreate(Task_BumperTriHorizontal, sizeof(BumperC), 0x2000, 0, ((void*)0));
    BumperC *bumper = (void *)((t)->data);
    s = &bumper->s;
    ...
    s->graphics.dest = ((void *)&VRAM[0x10000] + 0x2B20);
    s->oamFlags = ((18) << 6);
    s->graphics.size = 0;
    s->graphics.anim = 476;
    s->variant = 0;
...
{
    Sprite *s = ((void*)0);
    struct Task *t = TaskCreate(Task_BumperTriVertical, sizeof(BumperC), 0x2000, 0, ((void*)0));
    BumperC *bumper = (void *)((t)->data);
    s = &bumper->s;
    ...
    s->graphics.dest = ((void *)&VRAM[0x10000] + 0x2CA0);
    s->graphics.anim = 477;
    s->variant = 0;
    s->oamFlags = ((18) << 6);
    s->graphics.size = 0;
...
{
    Sprite *s = ((void*)0);
    struct Task *t = TaskCreate(Task_BumperTriBig, sizeof(BumperC), 0x2000, 0, ((void*)0));
    BumperC *bumper = (void *)((t)->data);
    s = &bumper->s;
    ...
    s->graphics.dest = ((void *)&VRAM[0x10000] + 0x26A0);
    s->graphics.anim = 475;
    s->variant = 0;
    s->oamFlags = ((18) << 6);
    s->graphics.size = 0;
...
void Task_BumperTriHorizontal(void)
{
    BumperC *bumper = (void *)((gCurTask)->data);
    Sprite *s = &bumper->s;
    MapEntity *me = bumper->base.me;
    CamCoord worldX, worldY;
...
void Task_BumperTriHorizontal2(void)
{
    ...
    if (s->frameFlags & ((1) << (10))) {
        s->x = worldX - gCamera.x + ((gSineTable[(bumper->unk4C * 128) + 256]) >> 12);
    } else {
        s->x = worldX - gCamera.x - ((gSineTable[(bumper->unk4C * 128) + 256]) >> 12);
    }

    s->y = worldY - gCamera.y + ((gSineTable[(bumper->unk4C * 128)]) >> 12);
        ...
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
            if ((gGameMode == 3 || gGameMode == 5)) {
                ...
                for (j = 0; j < 4 && gMultiplayerPlayerTasks[j]; j++) {
                    if (j != ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) {
                        MultiplayerPlayer *mpp = (void *)((gMultiplayerPlayerTasks[j])->data);
                        if (mpp->unk5C & 0x4) {
                            sp10 = 1;
                        }
                    }
            ...
            if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00400000) || sp10) {
                if (Coll_Player_Entity_Intersection(s, worldX + ((int)((bumper->unk40) >> 8)), worldY + ((int)((bumper->unk44) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                    if ((((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_TAILS) || ((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_KNUCKLES))
                        && ((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk61 != 0)) {
                        Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                    ...
                    if (gGameMode == 3 || gGameMode == 5) {
                        (*(((i) != 0) ? &gPartner : &gPlayer)).timerInvulnerability = 30;
                    }
                    ...
                    if (s->frameFlags & ((1) << (11))) {
                        if ((u32)rot >= 0x200) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = -((s32)((6.3984375)*256));
                        ...
                        if ((u32)rot > (s32)(0.482421875 * 1024)) {
                            if ((u32)rot > (s32)(0.75 * 1024)) {
                                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = +0x297;
                                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = -0x5D9;
                            } else {
                ...
                if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00400000)) {
                    ...
                    if (s->frameFlags & ((1) << (10))) {
                        if ((u32)rot - 0xFD >= 0x207) {
                            ...
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = -0x5D9;
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = -0x297;
                        } else {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = -0x5D9;
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = +0x297;
                        }
                    } else {
                        if ((u32)(rot - 0x104) <= (s32)(0.4921875 * 1024)) {
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = -0x666;
                        } else {
                            if ((u32)rot > 0x200) {
                                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = +0x5D9;
                                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = -0x297;
...

{
    ...
    do {
        ...
        if (Coll_Player_Entity_Intersection(s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
            if ((gGameMode == 3 || gGameMode == 5)) {
                u8 j;
                for (j = 0; j < 4 && gMultiplayerPlayerTasks[j]; j++) {
                    if (j != ((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id) {
            ...
            if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00400000) || sp0C) {
                if (s->frameFlags & ((1) << (11))) {
                    if ((s->frameFlags & ((1) << (10)))) {
                        if ((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) - worldY) < 65 - (worldX - ((int)((qTempPlayerX) >> 8)))) {
                            if ((((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_TAILS) || ((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_KNUCKLES))
                                && ((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk61 != 0)) {
                                Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                                (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 5;
                            ...
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = -((s32)((4.6875)*256));
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = +((s32)((4.6875)*256));
                        ...
                        if ((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) - worldY) < 65 - (((int)((qTempPlayerX) >> 8)) - worldX)) {
                            if ((((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_TAILS) || ((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_KNUCKLES))
                                && ((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk61 != 0)) {
                                Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                                (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 5;
                    ...
                    if ((s->frameFlags & ((1) << (10)))) {
                        if ((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) - worldY) > worldX - ((int)((qTempPlayerX) >> 8)) - 60) {
                            if ((((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_TAILS) || ((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_KNUCKLES))
                                && ((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk61 != 0)) {
                                Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                                (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 5;
                        ...
                        if ((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) - worldY) > ((int)((qTempPlayerX) >> 8)) - worldX - 60) {
                            if ((((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_TAILS) || ((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_KNUCKLES))
                                && ((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk61 != 0)) {
                                Player_TransitionCancelFlyingAndBoost(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                                (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 5;
