# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platforms_085_089.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platforms_085_089.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platforms_085_089.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platforms_085_089.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platforms_085_089.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platforms_085_089.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platforms_085_089.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platforms_085_089.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platforms_085_089.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platforms_085_089.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platforms_085_089.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platforms_085_089.c" 2
...
const u16 gUnknown_086CEDC0[18][3] = {
    { 463, 0x0000, ((48 / 8) * (24 / 8)) },
    { 463, 0x0000, ((48 / 8) * (24 / 8)) },
    { 506, 0x0000, ((48 / 8) * (24 / 8)) },
    { 506, 0x0000, ((48 / 8) * (24 / 8)) },
    { 495, 0x0000, ((48 / 8) * (24 / 8)) },
    { 495, 0x0000, ((48 / 8) * (24 / 8)) },
    { 528, 0x0000, ((48 / 8) * (40 / 8)) },
    { 528, 0x0000, ((48 / 8) * (40 / 8)) },
    { 544, 0x0000, ((40 / 8) * (40 / 8)) },
    { 544, 0x0000, ((40 / 8) * (40 / 8)) },
    { 517, 0x0000, ((48 / 8) * (24 / 8)) },
    { 517, 0x0000, ((48 / 8) * (24 / 8)) },
    { 517, 0x0000, ((48 / 8) * (24 / 8)) },
    { 517, 0x0000, ((48 / 8) * (24 / 8)) },
    { 463, 0x0000, ((48 / 8) * (24 / 8)) },
...
void CreateEntity_Platform_SlowDescent(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    Platform085_089 *platform = (void *)((t)->data);
    Sprite *s = &platform->s;
...
void Task_Platform085(void)
{
    ...
    do {
        if (((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000008) && ((*(((i) != 0) ? &gPartner : &gPlayer)).stoodObj == s)) {
            s8 sl = sa2__sub_801F07C(worldY + ((int)((platform->unk44) >> 8)) + 22, worldX, (*(((i) != 0) ? &gPartner : &gPlayer)).layer, +8, ((void*)0), sa2__sub_801EE64);

            if (!Coll_Player_Entity_Intersection(s, worldX + ((int)((platform->unk40) >> 8)), worldY + ((int)((platform->unk44) >> 8)) - 4, &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                ...
                if (sl >= 0) {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY += ((s32)((0.75)*256));
                }

                res = sa2__sub_801F07C(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) + 16, ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) + 0, (*(((i) != 0) ? &gPartner : &gPlayer)).layer, +8, ((void*)0),
                                             sa2__sub_801EE64);
            ...
            if (Coll_Player_PlatformCrumbling(s, worldX, worldY + ((int)((platform->unk44) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer))) & 0x00000008) {
                if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & ((1) << (10)))) {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY -= ((s32)((2)*256));
                }
                (platform->unk50) |= (1 << (i));
            } else {
                (platform->unk50) &= ~(1 << (i));
    ...
    if (platform->unk50 != 0) {
        s8 res = sa2__sub_801F07C(worldY + ((int)((platform->unk44) >> 8)) + 22, worldX, layer, +8, ((void*)0), sa2__sub_801EE64);

        if (res >= 0) {
            platform->unk44 += ((s32)((0.75)*256));
        }
    } else {
        if (platform->unk44 != 0) {
            platform->unk44 -= ((s32)((0.75)*256));
    ...
    s->y = worldY - gCamera.y + ((int)((platform->unk44) >> 8));
    ...
    do {
        if (((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000008) && ((*(((i) != 0) ? &gPartner : &gPlayer)).stoodObj == s)) {
            ...
            if (!Coll_Player_Entity_Intersection(s, worldX + ((int)((platform->unk40) >> 8)), worldY - ((int)((platform->unk44) >> 8)) - 4, &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                ...
                if (((int)((platform->unk44) >> 8)) > me->d.uData[3] * 8) {
                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00000008;
