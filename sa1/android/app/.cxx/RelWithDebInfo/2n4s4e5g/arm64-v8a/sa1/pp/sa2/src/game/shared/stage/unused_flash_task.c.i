# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/unused_flash_task.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/unused_flash_task.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/unused_flash_task.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/unused_flash_task.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/unused_flash_task.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/unused_flash_task.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/unused_flash_task.c" 2





static const char __attribute__((aligned(4))) sTxtFlash[]
...
{
    gDispCnt = (0x0400 | 0x0040 | 0x0000);
    gBgCntRegs[2] = (((30) << 8) | 0x0000 | ((0) << 2) | (1));
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, VRAM, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((2 * 32)/(32/8)))); };
    ...
    TaskCreate(Task_UnusedFlashTask, 0, 0x1000, 0, ((void*)0));
...
void Task_UnusedFlashTask(void)
{
    RenderText((void *)(VRAM + 1 * 32), &Tileset_DebugAscii, 1, 10, 2, sTxtFlash, 0);
