# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/ice_block.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/ice_block.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/ice_block.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/ice_block.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/ice_block.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/ice_block.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/ice_block.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/ice_block.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/ice_block.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/ice_block.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/ice_block.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/ice_block.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/ice_block.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 19 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/ice_block.c" 2
...
void CreateEntity_IceBlock(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    s->graphics.dest = VramMalloc(((40 / 8) * (40 / 8)));
    s->oamFlags = ((8) << 6);
    s->graphics.size = 0;
    s->graphics.anim = 555;
    s->variant = 0;
...
void Task_IceBlock(void)
{
    ...
    block = (void *)((gCurTask)->data);
    s = &block->shared.s;
    me = block->shared.base.me;

    worldX = ((block->shared.base.meX)*8 + (block->shared.base.regionX)*256);
    worldY = ((me->y)*8 + (block->shared.base.regionY)*256);
...
void CreateIceBlockShards(CamCoord x, CamCoord y)
{
    ...
    IceBlockShards *debris = (void *)((t)->data);
...
void Task_IceBlockShards(void)
{
    IceBlockShards *debris = (void *)((gCurTask)->data);
...

    {
        ...
        scale = tf->qScaleX + ((s32)((1. / 256.)*256));
        if (scale > ((s32)((2)*256))) {
            scale = ((s32)((2)*256));
        }
