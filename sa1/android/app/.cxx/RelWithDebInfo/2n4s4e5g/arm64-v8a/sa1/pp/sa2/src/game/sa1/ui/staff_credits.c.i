# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/staff_credits.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/staff_credits.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/staff_credits.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/staff_credits.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/staff_credits.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/staff_credits.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/staff_credits.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/staff_credits.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/staff_credits.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/staff_credits.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/staff_credits.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/staff_credits.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/staff_credits.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/staff_credits.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/staff_credits.c" 2

extern const u8 gUnknown_0868483C[0x500];

const __attribute__((aligned(4))) u16 gUnknown_086886A0[12] = {
    22, 0,
    79, 0,
    139, 0,
    322, 0,
...
void Task_805E888(void);
void Task_805E758(void);
...
void sub_805E1E8(void)
{
    ...
    sp00.vramC = ((void *)&VRAM[0x10000] + 0x0400);
    sp00.tilesSize = 1 * 32;
...
void CreateStaffCredits()
{
    ...
    gBgScrollRegs[2][0] = 0;
    gBgScrollRegs[2][1] = 0;
    t1 = TaskCreate(Task_805E888, sizeof(StaffCredits), 0x6200U, 0U, ((void*)0));
    credits = (void *)((t1)->data);
    s = &credits->s;

    credits->unk78 = 0x30;
    credits->unk7C = 0;

    s->graphics.dest = ((void *)&VRAM[0x10000] + 0x4000);
    s->graphics.anim = 740;
    s->variant = 0;
    s->x = 0;
    s->y = 0;
    ...
    s->graphics.anim = 741;
    s->variant = 1;
    s->graphics.dest = ((void *)&VRAM[0x10000] + 0x6000);
    s->x = (320 / 2);
    s->y = 0;
    s->oamFlags = 0x480;
    s->graphics.size = 0;
    ...
    t2 = TaskCreate(Task_805E758, sizeof(StaffCredits), 0x6120U, 0U, ((void*)0));
    credits = (void *)((t2)->data);
    credits->unk78 = 0x30;
    credits->unk7C = 0;
    credits->unk6A = -0x50;
    credits->unk6C = 0;
    ...
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, (&VRAM[0] + ((gBgCntRegs[1] & ((0x3) << 2)) << 12)), (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((0x40)/(32/8)))); };
...
void Task_805E698(void)
{
    Credits_18 *credits_18 = (void *)((gCurTask)->data);
    StaffCredits *creditsB = (void *)((credits_18->task2)->data);
    StaffCredits *creditsA = (void *)((credits_18->task1)->data);
    u8 r2;
    ...
    if ((credits_18->unk14 > 8550) && r2) {
        ...
        if ((&gLoadedSaveGame)->chaosEmeralds != ((1 << (0)) | (1 << (1)) | (1 << (2)) | (1 << (3)) | (1 << (4)) | (1 << (5)) | (1 << (6)))) {
...
void Task_805E758()
{
    ...
    StaffCredits *credits = (void *)((gCurTask)->data);

    temp_r4 = credits->unk78;
    if (!(1 & temp_r4)) {
        credits->unk7C = temp_r4 * (({((0x201C) != 0) ? ((s32)(0x143000) / (s32)(0x201C)) : 0;}) + 1);
    }

    temp_r0 = ((int)((credits->unk7C) >> 8)) - 0xC;
    if (temp_r0 > 0x8AU) {
        var_r8 = (u32)(((int)((credits->unk7C) >> 8)) - 0x86) >> 4;
        var_sl = ({((0x10) != 0) ? ((s32)(((int)((credits->unk7C) >> 8)) - 0x96) % (s32)(0x10)) : 0;}) + 8;
    } else {
        var_r8 = 0;
        var_sl = 0;
    }
...
void Task_805E888()
{
    ...
    if (!(1 & temp_r5)) {
        credits->unk7C = temp_r5 * (({((0x201C) != 0) ? ((s32)(0x143000) / (s32)(0x201C)) : 0;}) + 1);
    }

    temp_r0_2 = ((int)((credits->unk7C) >> 8)) - 0xC;
    if (temp_r0_2 > 0x9AU) {
        temp_r0_3 = temp_r0_2 - 0x8A;
        temp_r6 = (u32)temp_r0_3 >> 4;
        temp_sl = ({((0x10) != 0) ? ((s32)(temp_r0_3 - 0x10) % (s32)(0x10)) : 0;}) + 4;
        var_r5 = 0xFF;
