# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c" 2
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c" 2
...
# 19 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 20 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c" 2
# 41 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c"
struct Task *gRingsScatterTask = ((void*)0);
...
# 89 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c"
...
void InitScatteringRings(s32 x, s32 y, s32 numRings)
{
    ...
    if ((!(((gGameMode == 0) || (gGameMode == 1)))) && (numRings > 32)) {
        numRings = 32;
    }
    ...
    for (i = 0, ip = 0; i < (signed)(sizeof(rs->rings) / sizeof((rs->rings)[0])); ring++, i++) {
        if (ring->unkC == 0) {
            ...
            if (r3 >= 0) {
                ...
                {
                    s32 index = (r3 & 0xFF) * 4;
                    velX = (gSineTable[(index)]);
                    velX >>= r2;
                    velY = (gSineTable[(index) + 256]);
                    velY >>= r2;
                }
            ...
            r3 = -r3;
            velX = -velX;
# 245 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c"
            ip++;
...
void InitScatteringRings_ExtraBossCapsule(s32 x, s32 y, s32 numRings)
{
    ...
    r7 = (((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0xFF000) >> 12) | 0x10;
    ...
    for (i = 0, ip = 0; i < (signed)(sizeof(rs->rings) / sizeof((rs->rings)[0])); ring++, i++) {
        if (ring->unkC == 0) {
            ...
            r3 = (((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x1000) >> 12) + 5;
            {
                s32 r0;
            ...
            {
                u32 rand = ({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; });
...

{
    ...
    ScatterRing *ring = &rs->rings[0];
    Sprite *s = &rs->sprRing;
    s32 sp08 = rs->sa2__unk2B0;
    s32 sp0C = rs->sa2__unk2B4;
    bool32 sp10 = 0;
    s32 i;
...
# 381 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c"
        ...
        if (ring->unkC <= sp0C && (p->charState != 15 || p->timerInvulnerability == 0) && (p->charState != 40) && (!((p)->moveState & 0x00000080)))
        ...
        if (ring->velY < 0 && 1) {
            s32 res = sa2__sub_801F100(ringIntY - (8 * 2), ringIntX, ring->unkE, -8, sa2__sub_801EC3C);
            if (res <= 0) {
                ring->y -= ((s32)((res)*256));
        ...
        if (rs->sa2__unk2B6 & 0x1 && ring->velY > 0 && 1) {
            s32 res = sa2__sub_801F100(ringIntY, ringIntX, ring->unkE, 8, sa2__sub_801EC3C);
            if (res <= 0) {
                ring->y += ((s32)((res)*256));
                ring->velY = (ring->velY >> 2) - ring->velY;
            }
        ...
        if ((screenX + 8) > 0 && screenX + 8 < (320 + (8 * 2)) && screenY > -8
            && screenY < (240 + 8)) {
...

{
    ...
    for (i = (sizeof(rs->rings) / sizeof((rs->rings)[0])) - 1; i >= 0; ring++, i--) {
        ...
        if (((gCurrentLevel) == ((6)*(2)) + (1))) {
            ...
            if (v >= 2688) {
                adjustedRingX = ({((2688) != 0) ? ((s32)(v) % (s32)(2688)) : 0;}) + 72;
            }
        }
        ...
        if (ring->velY > 0 && 1) {
            ...
            s32 res = sa2__sub_801F100(ringIntY, adjustedRingX, ring->unkE, +8, sa2__sub_801EC3C);
        ...
        if (rs->sa2__unk2B6 & 0x1 && ring->velY < 0 && 1) {
            ...
            s32 res = sa2__sub_801F100((ringIntY - 16), adjustedRingX, ring->unkE, -8, sa2__sub_801EC3C);
...
# 682 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c"
...

{
    ...
    for (i = 0; i < (signed)(sizeof(rs->rings) / sizeof((rs->rings)[0])); ring++, i++) {
        ...
        if ((ring->unkC <= sp0C) && ((p->charState != 15) || (p->timerInvulnerability == 0)) && ((!((p)->moveState & 0x00000080)))
            ...
            if ((ring->velY < 0) && 1) {
                s32 res = sa2__sub_801F100((ringIntY - 16), ringIntX, ring->unkE, -8, sa2__sub_801EC3C);
                if (res <= 0) {
                    ring->y -= ((s32)((res)*256));
                    ring->velY = (ring->velY >> 2) - ring->velY;
                }
...
# 810 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c"
...
# 1068 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_scatter.c"
void DestroyRingsScatterTask(void)
{
...
void TaskDestructor_RingsScatter(struct Task __attribute__((unused)) *t) { gRingsScatterTask = ((void*)0); }
