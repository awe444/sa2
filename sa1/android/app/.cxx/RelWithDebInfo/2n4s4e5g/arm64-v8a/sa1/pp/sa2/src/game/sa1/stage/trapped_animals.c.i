# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/trapped_animals.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/trapped_animals.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/trapped_animals.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/trapped_animals.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/trapped_animals.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/trapped_animals.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/trapped_animals.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/trapped_animals.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/trapped_animals.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/trapped_animals.c" 2
...
# 73 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/trapped_animals.c"
...
const TrappedAnimalData sAnimsTrappedAnimals[6][3] = {
    [0] = {
        { 192, 445, 0, 0},
        { 196, 450, 0, 0},
        { 200, 449, 0, 1},
...
# 164 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/trapped_animals.c"
static void CreateFlyingAnimal(SpawnOptions *init)
{
    struct Task *t = TaskCreate(Task_FlyingAnimal, sizeof(FlyingAnimal), 0x2000, 0, ((void*)0));
    FlyingAnimal *animal = (void *)((t)->data);
    Sprite *s;
    animal->x = ((s32)((init->x)*256));
    animal->y = ((s32)((init->y)*256));
    animal->unk38 = 576;
    animal->flyingUp = 1;
    ...
    s->x = init->x;
    s->y = init->y;
    s->graphics.dest = (void *)&VRAM[0x10000] + (init->vramOffset * 32);
    s->oamFlags = ((17) << 6);
    s->graphics.size = 0;
...
static void Task_FlyingAnimal(void)
{
    FlyingAnimal *animal = (void *)((gCurTask)->data);
    Sprite *s = &animal->s;
    ...
    x += ({((20) != 0) ? ((s32)((gSineTable[(animal->unk38 & (1024 - 1)) + 256])) / (s32)(20)) : 0;});
    y += ({((20) != 0) ? ((s32)((gSineTable[(animal->unk38 & (1024 - 1))])) / (s32)(20)) : 0;});
    ...
    s->x = ((int)((x) >> 8)) - gCamera.x;
    s->y = ((int)((y) >> 8)) - gCamera.y;

    if (((s->x < -(32)) || (s->x > 320 + (32)) || ((s->y) + (32) < 0) || (s->y > 240 + (32)))) {
...
{
    struct Task *t = TaskCreate(Task_BouncingAnimal, sizeof(BouncingAnimal), 0x2000, 0, ((void*)0));
    BouncingAnimal *animal = (void *)((t)->data);
    Sprite *s;
    animal->x = ((s32)((init->x)*256));
    animal->y = ((s32)((init->y)*256));
    animal->moveSpeed = ((s32)((0.00390625)*256));
    animal->fallSpeed = -((s32)((4)*256));
    animal->bouncing = 0;
...
static void Task_BouncingAnimal(void)
{
    BouncingAnimal *animal = (void *)((gCurTask)->data);
    Sprite *s = &animal->s;
    s32 y;

    animal->fallSpeed += ((s32)((0.1875)*256));
    ...
    if (animal->inAirTimer > 0) {
        ...
        s32 clampedY = y + ((s32)((sa2__sub_801F07C(((int)((animal->y) >> 8)), ((int)((animal->x) >> 8)), 1, 8, ((void*)0), sa2__sub_801EE64))*256));


        if (clampedY <= animal->y) {
            animal->fallSpeed = -((s32)((4)*256));
            animal->y = clampedY;
            if (animal->bouncing == 0) {
                animal->moveSpeed = -((s32)((2)*256));
            }
            animal->bouncing = 1;
        }
    }

    s->x = ((int)((animal->x) >> 8)) - gCamera.x;
    s->y = ((int)((animal->y) >> 8)) - gCamera.y;
...
{
    struct Task *t = TaskCreate(Task_StaticAnimalMain, sizeof(StaticAnimal), 0x2000, 0, ((void*)0));
    StaticAnimal *animal = (void *)((t)->data);
    Sprite *s;
    animal->x = ((s32)((init->x)*256));
    animal->y = ((s32)((init->y)*256));
...
static void Task_StaticAnimalMain(void)
{
    StaticAnimal *animal = (void *)((gCurTask)->data);
    Sprite *s = &animal->s;
    s32 y;
...
void CreateTrappedAnimal(s16 x, s16 y)
{
    ...
    s8 zone = ((gCurrentLevel) >> 1);
    s8 type;


    if (zone > (s32)(sizeof(sAnimsTrappedAnimals) / sizeof((sAnimsTrappedAnimals)[0]))) {
        zone = 6;
    }
