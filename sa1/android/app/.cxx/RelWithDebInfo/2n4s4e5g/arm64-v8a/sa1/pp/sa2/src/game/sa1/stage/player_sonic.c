# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_sonic.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_sonic.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_sonic.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_sonic.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_sonic.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_sonic.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_sonic.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_sonic.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_sonic.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_sonic.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/stage/player_sonic.h" 1



void Player_Sonic_InitInstaShield(Player *p);
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_sonic.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_sonic.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_sonic.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/player_sonic.c" 2
    ...
    switch (p->moveState & (0x00000002 | 0x00000004)) {
        case 0: {
            if (p->moveState & 0x01000000) {
                ...
                if (p->sa2__unk62 == 0) {
                    if ((gGameMode == 6) || (sub_8047668(p) == 0)) {
...
s32 sub_8047668(Player *p)
{
    switch (p->sa2__unk62) {
        ...
        case 3: {
            ...
            if (qSpeed > 0) {
                if ((qSpeed - ((s32)((32. / 256.)*256))) < 0) {
                    qSpeed = 0;
                } else {
                    qSpeed -= ((s32)((32. / 256.)*256));
                }
...
void sub_8047714(Player *p)
{
    if ((p->sa2__unk61 == 0) && (p->moveState & 0x00000100)) {
