# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/underwater_lava_platform.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/underwater_lava_platform.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/underwater_lava_platform.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/underwater_lava_platform.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/underwater_lava_platform.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/underwater_lava_platform.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/underwater_lava_platform.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/underwater_lava_platform.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/underwater_lava_platform.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/underwater_lava_platform.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/underwater_lava_platform.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/underwater_lava_platform.c" 2
...
void CreateEntity_UnderwaterLavaPlatform(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    UnderwaterLavaPlatform *platform = (void *)((t)->data);
    Sprite *s = &platform->s;
    ...
    s2->graphics.dest = VramMalloc(((48 / 8) * (24 / 8)));
    s2->graphics.anim = 525;
    s2->variant = 0;
    s2->oamFlags = ((17) << 6);
    s2->graphics.size = 0;
    s2->animCursor = 0;
...
void Task_UnderwaterLavaPlatform(void)
{
    ...
    i = 0;
    do {
        s32 qPrevPlayerX = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX;

        if (Coll_Player_PlatformCrumbling(s2, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer))) & 0x00000008) {
            (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((worldY - 27)*256));
    ...
    if (({(((int)(((0 * 60.) + 1.7) * 60)) != 0) ? ((s32)(gStageTime) % (s32)((int)(((0 * 60.) + 1.7) * 60))) : 0;}) == 0) {
        platform->unk84 = (int)(((0 * 60.) + 1.7) * 60);
        platform->unk74 = 0;
        platform->qUnk78 = -((s32)((5)*256));
        platform->qUnk7C = +((s32)((0)*256));
        platform->unk80 = 3;
...
void Task_80929A0(void)
{
    ...
    platform->qUnk78 += ((s32)((37. / 256.)*256));
    ...
    s2->x = worldX - gCamera.x;
    s2->y = worldY - gCamera.y + ((int)((platform->qUnk7C) >> 8));

    i = 0;
    do {

        if ((((platform->unk74) >> (i)) & 1)) {
            if (!Coll_Player_Entity_Intersection(s2, worldX, worldY + ((int)((platform->qUnk7C) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                (platform->unk74) &= ~(1 << (i));

            } else {
                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY += platform->qUnk78;
            }
        } else {

            if (Coll_Player_PlatformCrumbling(s2, worldX, worldY + ((int)((platform->qUnk7C) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((worldY + ((int)((platform->qUnk7C) >> 8)) - 27)*256));
                (platform->unk74) |= (1 << (i));
                ...
                if ((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY == ((s32)((0)*256))) {
                    if ((*(((i) != 0) ? &gPartner : &gPlayer)).charState != 4) {
    ...
    if (--platform->unk84 == 48) {
        ...
        i = 0;
        do {
            if (((i != 0) ? (&gPartnerBodyPSI.s.hitboxes[0]) : (&gPlayerBodyPSI.s.hitboxes[0]))->index != -1) {
                if ((((((worldX) + s->hitboxes[1].b.left) <= ((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) + ((i != 0) ? (&gPartnerBodyPSI.s.hitboxes[0]) : (&gPlayerBodyPSI.s.hitboxes[0]))->b.left) && ((((worldX)) + (s->hitboxes[1].b).left) + ((s->hitboxes[1].b).right - (s->hitboxes[1].b).left)) >= ((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) + ((i != 0) ? (&gPartnerBodyPSI.s.hitboxes[0]) : (&gPlayerBodyPSI.s.hitboxes[0]))->b.left)) || (((worldX) + s->hitboxes[1].b.left) >= ((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) + ((i != 0) ? (&gPartnerBodyPSI.s.hitboxes[0]) : (&gPlayerBodyPSI.s.hitboxes[0]))->b.left) && ((((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)))) + (((i != 0) ? (&gPartnerBodyPSI.s.hitboxes[0]) : (&gPlayerBodyPSI.s.hitboxes[0]))->b).left) + ((((i != 0) ? (&gPartnerBodyPSI.s.hitboxes[0]) : (&gPlayerBodyPSI.s.hitboxes[0]))->b).right - (((i != 0) ? (&gPartnerBodyPSI.s.hitboxes[0]) : (&gPlayerBodyPSI.s.hitboxes[0]))->b).left)) >= ((worldX) + s->hitboxes[1].b.left))) && (((((worldY)) + s->hitboxes[1].b.top) <= (((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) + ((i != 0) ? (&gPartnerBodyPSI.s.hitboxes[0]) : (&gPlayerBodyPSI.s.hitboxes[0]))->b.top) && ((((worldY)) + s->hitboxes[1].b.top) + ((s->hitboxes[1].b).bottom - (s->hitboxes[1].b).top)) >= (((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) + ((i != 0) ? (&gPartnerBodyPSI.s.hitboxes[0]) : (&gPlayerBodyPSI.s.hitboxes[0]))->b.top)) || ((((worldY)) + s->hitboxes[1].b.top) >= (((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) + ((i != 0) ? (&gPartnerBodyPSI.s.hitboxes[0]) : (&gPlayerBodyPSI.s.hitboxes[0]))->b.top) && ((((((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) + ((i != 0) ? (&gPartnerBodyPSI.s.hitboxes[0]) : (&gPlayerBodyPSI.s.hitboxes[0]))->b.top) + ((((i != 0) ? (&gPartnerBodyPSI.s.hitboxes[0]) : (&gPlayerBodyPSI.s.hitboxes[0]))->b).bottom - (((i != 0) ? (&gPartnerBodyPSI.s.hitboxes[0]) : (&gPlayerBodyPSI.s.hitboxes[0]))->b).top)) >= (((worldY)) + s->hitboxes[1].b.top))))) {
    ...
    if (platform->qUnk7C >= ((s32)((0)*256))) {
        if (--platform->unk80 != 0) {
            platform->qUnk78 = -({((5) != 0) ? ((s32)(platform->qUnk78 * 2) / (s32)(5)) : 0;});
            platform->unk74 = 0;
            platform->qUnk7C = ((s32)((0)*256));
        } else {
