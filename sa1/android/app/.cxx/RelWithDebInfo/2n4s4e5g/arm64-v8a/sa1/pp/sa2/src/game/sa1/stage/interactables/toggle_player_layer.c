# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_layer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_layer.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_layer.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_layer.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_layer.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_layer.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/interactables.h" 1
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_layer.c" 2
...
void Task_Toggle_PlayerLayer(void)
{
    TogglePlayerLayer *ia = (void *)((gCurTask)->data);
    MapEntity_Toggle_PlayerLayer *me = (MapEntity_Toggle_PlayerLayer *)ia->me;
    u8 meX = *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(TogglePlayerLayer, meX));
    u16 regionX = *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(TogglePlayerLayer, regionX));
    u16 regionY = *(u16 *)((unsigned char *)(void *)((gCurTask)->data) + __builtin_offsetof(TogglePlayerLayer, regionY));
    s32 i;

    CamCoord screenX = ((meX)*8 + (regionX)*256);
    CamCoord screenY = ((me->y)*8 + (regionY)*256);

    i = 0;
    do {
        if ((screenX <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (screenX + (me->width * 8) >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)))
            && (screenY <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8))) && (screenY + (me->height * 8) >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) {
            s32 frontIAIndex = 17;
...
{
    struct Task *t = TaskCreate(Task_Toggle_PlayerLayer, sizeof(TogglePlayerLayer), 0x2000, 0, ((void*)0));
    ...
    TogglePlayerLayer *ia = (void *)((t)->data);
