# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/temporary_sound_play_task.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/temporary_sound_play_task.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/temporary_sound_play_task.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/temporary_sound_play_task.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/temporary_sound_play_task.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/temporary_sound_play_task.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/player.h" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/temporary_sound_play_task.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/temporary_sound_play_task.c" 2
...
void Task_TempSound(void)
{
    TrickField *field = (void *)((gCurTask)->data);
    ...
    if (((s32)songStatus < 0) || ((songStatus & 0xFFFF) == 0)) {
        ...
        if (info2->songHeader == gSongTable[field->songId].header) {
            if ((field->songHeader == gSongTable[28].header) && !(gPlayer.itemEffect & 0x02)) {
                ...
                if (gPlayer.itemEffect & 0x04) {
                    m4aMPlayTempoControl(&gMPlayInfo_BGM, ((s32)((2)*256)));
                }
...
void CreateTempSoundTask(u16 songId)
{
    ...
    if (info->songHeader != gSongTable[songId].header) {
        struct Task *t = TaskCreate(Task_CallTempSoundTask, sizeof(TrickField), 0x3000, 0, ((void*)0));
        TrickField *field = (void *)((t)->data);
...
{
    struct MP2KPlayerState *info = gMPlayTable[3].info;
    struct MP2KSongHeader *songHeader = info->songHeader;

    if (songHeader != gSongTable[expectedSongId].header) {
        struct Task *t = TaskCreate(Task_CallSpStageTrickTask, sizeof(TrickField), 0x3000, 0, ((void*)0));
        TrickField *field = (void *)((t)->data);
