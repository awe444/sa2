# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/fireball.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/fireball.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/fireball.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/fireball.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/fireball.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/fireball.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/fireball.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/fireball.c" 2
...
void Task_Fireball(void)
{
    FireballSpawner *spawner = (void *)((gCurTask)->data);
    MapEntity *me = spawner->me;
    CamCoord worldX, worldY;
    s32 sb;

    worldX = ((spawner->meX)*8 + (spawner->regionX)*256);
    worldY = ((me->y)*8 + (spawner->regionY)*256);
    ...
    if (({(((int)(((0 * 60.) + 4) * 60)) != 0) ? ((s32)(gStageTime + spawner->unk4) % (s32)((int)(((0 * 60.) + 4) * 60))) : 0;}) == 0) {
        ...
        fireball->qUnk3C = -((s32)((6)*256));
        fireball->unk3E = worldX;
        fireball->unk40 = worldY + 24;
        fireball->unk44 = fireball->unk40;

        s->x = ((me->x)*8 + (spawner->regionX)*256);
        s->y = ((me->y)*8 + (spawner->regionY)*256);
...
void Task_FireballUpdateRise(void)
{
    Fireball *fireball = (void *)((gCurTask)->data);
    Sprite *s = &fireball->shared.s;
    MapEntity *me = fireball->shared.base.me;

    s->x = fireball->unk3E - gCamera.x;
    fireball->qUnk3C += ((s32)((0.25)*256));
    fireball->unk40 += ((int)((fireball->qUnk3C) >> 8));
    s->y = fireball->unk40 - gCamera.y;

    if (((fireball->unk3E) > gCamera.x + (320 + (256 / 2)) || (fireball->unk3E) < gCamera.x - (256 / 2) || (fireball->unk44) > gCamera.y + ((240) + ((256) / 2)) || (fireball->unk44) < gCamera.y - (256 / 2)) && (((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
        { me->x = fireball->shared.base.meX; };
        TaskDestroy(gCurTask);
        return;
    }
...
void CreateFireballSparks(s16 screenX, s16 screenY)
{
    ...
    for (i = 0; i < 2; i++) {
        t = TaskCreate(Task_FireballSpark, sizeof(FireballSpark), 0x3000, 0, ((void*)0));
        spark = (void *)((t)->data);
        s = &spark->s;

        v = screenX * 4;
        spark->unk30 = v;
        spark->qUnk34 = -((s32)((2)*256));
        spark->unk32 = 6;
...
void Task_FireballSpark(void)
{
    FireballSpark *fireball = (void *)((gCurTask)->data);
    Sprite *s = &fireball->s;
    ...
    fireball->qUnk34 += ((s32)((40. / 256.)*256));
    s->y += ((int)((fireball->qUnk34) >> 8));
...
{
    struct Task *t = TaskCreate(Task_Fireball, sizeof(FireballSpawner), 0x2000, 0, ((void*)0));
    FireballSpawner *spawner = (void *)((t)->data);
