# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_visibility.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_visibility.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_visibility.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_visibility.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/toggle_player_visibility.c" 2
...
void Task_Toggle_PlayerVisibility(void)
{
    TogglePlayerVisibility *ia = (void *)((gCurTask)->data);
...
{
    struct Task *t = TaskCreate(Task_Toggle_PlayerVisibility, sizeof(TogglePlayerVisibility), 0x2000 | me->d.uData[3], 0, ((void*)0));
    TogglePlayerVisibility *ia = (void *)((t)->data);
