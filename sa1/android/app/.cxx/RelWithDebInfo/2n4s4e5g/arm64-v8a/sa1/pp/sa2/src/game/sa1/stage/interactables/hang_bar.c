# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hang_bar.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hang_bar.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hang_bar.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hang_bar.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hang_bar.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hang_bar.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hang_bar.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hang_bar.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hang_bar.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hang_bar.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hang_bar.c" 2
...
void Task_HangBar(void)
{
    ...
    bar = (void *)((gCurTask)->data);
    me = bar->base.me;


    barX = ((bar->base.meX)*8 + (bar->base.regionX)*256);
    barY = ((me->y)*8 + (bar->base.regionY)*256);

    i = 0;
    do {
        if ((((bar->isPlayerOnBits) >> (i)) & 1)) {
            if (((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
                (bar->isPlayerOnBits) &= ~(1 << (i));
                continue;
            }


            if ((*(((i) != 0) ? &gPartner : &gPlayer)).heldInput & 0x0010) {
                (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 36;
                (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00000001;
                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = bar->qPlayerWorldX[i] + ((s32)((2)*256));
                ...
                (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 35;
            }


            (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((barY + sBarCharacterYOffsets[(*(((i) != 0) ? &gPartner : &gPlayer)).character])*256));


            bar->qPlayerWorldX[i] = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX;

            if (((*(((i) != 0) ? &gPartner : &gPlayer)).frameInput & gPlayerControls.jump)
                || ((barX + (me->d.sData[0] * 8) > ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)))
                    || (barX + (me->d.sData[0] * 8) + (me->d.uData[2] * 8) < ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))))) {
                ...
                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((barY)*256)) + ((s32)((22)*256));
                (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000002;
                (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 18;
            ...
            if ((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY > ((s32)((0)*256))) {
                if ((barX + (me->d.sData[0] * 8) <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)))
                    && (barX + (me->d.sData[0] * 8) + (me->d.uData[2] * 8) >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)))
                    && (barY + (me->d.sData[1] * 8) <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))
                    && (barY + (me->d.sData[1] * 8) + (me->d.uData[3] * 8) >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) {
                    ...
                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((barY)*256)) + ((s32)((18)*256));
                    (bar->isPlayerOnBits) |= (1 << (i));
                    bar->qPlayerWorldX[i] = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX;
    ...
    if ((bar->isPlayerOnBits & ((1 << 2) - 1)) == 0) {

        barX -= gCamera.x;
        barY -= gCamera.y;

        if ((((u16)(barX + (256 / 2)) > 320 + 256) || (barY + (256 / 2) < 0) || (barY > 240 + (256 / 2)))) {
            { me->x = bar->base.meX; };
...
{
    struct Task *t = TaskCreate(Task_HangBar, sizeof(HangBar), 0x8000, 0, ((void*)0));
    HangBar *bar = (void *)((t)->data);
