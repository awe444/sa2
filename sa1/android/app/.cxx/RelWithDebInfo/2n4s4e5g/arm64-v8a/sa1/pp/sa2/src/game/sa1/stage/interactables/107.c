# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/107.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/107.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/107.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/107.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/107.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/107.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/107.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/107.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/107.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/107.c" 2
...
void CreateEntity_Interactable107(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    t = TaskCreate(Task_Interactable107, sizeof(IA107), 0x2000, 0, ((void*)0));
...
void Task_Interactable107(void)
{
    ...
    worldX = ((ia->base.meX)*8 + (ia->base.regionX)*256);
    worldY = ((me->y)*8 + (ia->base.regionY)*256);
    ...
    do {
        ...
        if ((((ia->unk3C) >> (i)) & 1)) {
            if (ia->unk3D == 0) {
                ...
                if ((*(((i) != 0) ? &gPartner : &gPlayer)).frameInput & 0x0010) {
                    sp10 = ((s32)((9)*256));
                } else if ((*(((i) != 0) ? &gPartner : &gPlayer)).frameInput & 0x0080) {
                    sp14 = ((s32)((9)*256));
                }
            } else if (ia->unk3D == 1) {
                sp18 = 0;
                ...
                if ((*(((i) != 0) ? &gPartner : &gPlayer)).frameInput & 0x0010) {
                    sp10 = ((s32)((7)*256));
                    sp14 = ((s32)((8)*256));
                } else if ((*(((i) != 0) ? &gPartner : &gPlayer)).frameInput & 0x0020) {
                    sp10 = -((s32)((9)*256));
                    sp14 = ((s32)((7)*256));
                }
            } else if (ia->unk3D == 2) {
                ...
                if ((*(((i) != 0) ? &gPartner : &gPlayer)).frameInput & 0x0080) {
                    sp14 = ((s32)((9)*256));
                }
            }
            ...
            (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = ((s32)((worldX)*256)) + ({((16) != 0) ? ((s32)((gSineTable[((ia->unk40[i] * 8) & (1024 - 1)) + 256])) / (s32)(16)) : 0;});
            (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = ((s32)((worldY - sp18)*256)) + ({((16) != 0) ? ((s32)((gSineTable[((ia->unk40[i] * 8) & (1024 - 1))])) / (s32)(16)) : 0;});
            ...
            if (sp10 != 0 || sp14 != 0) {
                ...
                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = sp14;
                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = sp10;
                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = sp10;
            }
