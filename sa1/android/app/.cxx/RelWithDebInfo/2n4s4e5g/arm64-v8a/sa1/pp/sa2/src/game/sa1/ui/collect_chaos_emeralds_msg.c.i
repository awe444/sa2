# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/collect_chaos_emeralds_msg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/collect_chaos_emeralds_msg.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/collect_chaos_emeralds_msg.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/collect_chaos_emeralds_msg.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/collect_chaos_emeralds_msg.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/collect_chaos_emeralds_msg.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/collect_chaos_emeralds_msg.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/collect_chaos_emeralds_msg.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/collect_chaos_emeralds_msg.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/collect_chaos_emeralds_msg.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/collect_chaos_emeralds_msg.c" 2
...
void CreateGetAllChaosEmeraldsMessage()
{
    ...
    gBgScrollRegs[0][1] = 0;
    sub_806968C();
    strc = (void *)((TaskCreate(Task_80698F4, sizeof(CollectEmeraldsScreen), 0x2000U, 0U, ((void*)0)))->data);
    temp_r6 = &strc->strc90;

    s = &strc->sprites[0];
    s->graphics.dest = (void *)(&VRAM[0x10000] + 0);
    s->graphics.anim = gUnknown_0868B654[(&gLoadedSaveGame)->uiLanguage];
    s->variant = gUnknown_0868B658[(&gLoadedSaveGame)->uiLanguage];
    s->x = 120;
    s->y = 120;
    s->graphics.size = 0;
    s->animCursor = 0;
    ...
    s = &strc->sprites[1];
    s->graphics.dest = (void *)(&VRAM[0x10000] + 0x2000);
    s->graphics.anim = 739;
...
void Task_80698F4()
{
    CollectEmeraldsScreen *strc = (void *)((gCurTask)->data);
...
void sub_8069964()
{
    ...
    for (i = 0; i < (s32)(sizeof(strc->sprites) / sizeof((strc->sprites)[0])); i++) {
