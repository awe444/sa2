# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/shrubbery.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/shrubbery.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/shrubbery.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/shrubbery.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/shrubbery.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/shrubbery.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/shrubbery.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/shrubbery.c" 2
...
void Task_ShrubberyMain(void)
{
    Shrubbery *shrubbery = (void *)((gCurTask)->data);
    Sprite *s = &shrubbery->s;
    MapEntity *me = shrubbery->base.me;
    s32 worldX, worldY;
    s32 i;

    worldX = ((shrubbery->base.meX)*8 + (shrubbery->base.regionX)*256);
    worldY = ((me->y)*8 + (shrubbery->base.regionY)*256);
    ...
    i = 0;
    do {
        if ((worldX <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (worldX + (me->d.uData[2] * 8) >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)))
            && (worldY <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8))) && (worldY + (me->d.uData[3] * 8) >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))) {
            if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
                if (!(((shrubbery->unk3C) >> (i)) & 1)) {
                    CreateShrubberyParticles(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) + (((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x1F00) >> 8) - 16,
                                             ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) + (((u32)({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; }) & 0x0F00) >> 8) - 8);
                    m4aSongNumStart(178);
                }
    ...
    if ((((u32)(worldX + (256 / 2)) > 320 + 256) || (worldY + (256 / 2) < 0) || (worldY > 240 + (256 / 2)))) {
        { me->x = shrubbery->base.meX; };
...
void CreateShrubberyParticles(CamCoord worldX, CamCoord worldY)
{
    ...
    ShrubberyParticles *parts = (void *)((t)->data);
    Sprite *s = &parts->s;
...
void Task_ShrubberyParticles(void)
{
    ShrubberyParticles *parts = (void *)((gCurTask)->data);
    Sprite *s = &parts->s;
...
{
    struct Task *t = TaskCreate(Task_ShrubberyMain, sizeof(Shrubbery), 0x2000, 0, ((void*)0));
    Shrubbery *shrubbery = (void *)((t)->data);
