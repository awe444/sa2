# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hook_rail.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hook_rail.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hook_rail.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hook_rail.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hook_rail.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hook_rail.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hook_rail.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hook_rail.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hook_rail.c" 2
...
# 42 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/hook_rail.c"
void CreateEntity_HookRail(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    if (((gCurrentLevel) >> 1) == 3) {
        s->graphics.dest = VramMalloc(((16 / 8) * (24 / 8)));
        s->graphics.anim = 569;
        s->variant = 0;
    } else {
        s->graphics.dest = VramMalloc(((16 / 8) * (24 / 8)));
...
void Task_HookRail_Type1(void)
{
    HookRail *hookRail = (void *)((gCurTask)->data);
    Sprite *s = &hookRail->s;
    MapEntity *me = hookRail->base.me;
    CamCoord worldX, worldY;

    worldX = ((hookRail->base.meX)*8 + (hookRail->base.regionX)*256);
    worldY = ((hookRail->base.me->y)*8 + (hookRail->base.regionY)*256);
    ...
    if ((!(gPlayer.moveState & 0x00000080))) {
        if (!(gPlayer.moveState & 0x00000008) || (gPlayer.stoodObj == s)) {
            if (Coll_Player_Entity_Intersection(s, worldX, worldY, &gPlayer)) {
                ...
                gPlayer.qWorldY = ((s32)((worldY + (+36))*256));
                gPlayer.qWorldX = ((s32)((worldX - (+6))*256));

                hookRail->qAcceleration = ((gPlayer.qSpeedGround) >= 0 ? (gPlayer.qSpeedGround) : -(gPlayer.qSpeedGround));

                if (hookRail->qAcceleration < ((s32)((1)*256))) {
                    hookRail->qAcceleration = ((s32)((1)*256));
                }
                hookRail->unk44 = 0;
                ...
                gPlayer.moveState |= gPlayer.moveState | 0x00000008;
                gPlayer.stoodObj = s;
...
void Task_HookRail_Type1_2(void)
{
    ...
    if ((!(gPlayer.moveState & 0x00000080))) {
        ...
        if (gPlayer.charState != 38) {
            Player_TransitionCancelFlyingAndBoost(&gPlayer);
            gPlayer.charState = 38;
        }

        gPlayer.qSpeedAirY = 0;
        if (((int)((gPlayer.qWorldX - hookRail->qStartX) >> 8)) > 480) {
            s32 rotation;
            m4aSongNumStop(180);
            Player_TransitionCancelFlyingAndBoost(&gPlayer);
            gPlayer.moveState &= ~0x00400000;
            ...
            hookRail->qAcceleration += ((s32)((16. / 256.)*256));
            hookRail->qVelocity += hookRail->qAcceleration;

            qWorldX = ((s32)((worldX)*256));
            qWorldX -= ((s32)(((+6))*256));
            gPlayer.qWorldX = qWorldX + hookRail->qVelocity;
            qWorldY = (((s32)((worldY)*256)) + ((s32)(((+36))*256)));
        ...
        if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
            struct MultiSioData_0_4 *sioData = &gMultiSioRecv[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id].pat4;
            s->x = (sioData->x - gCamera.x) + (+5);
            s->y = (sioData->y - gCamera.y) - (+36);
        } else {

            s->x = ((int)((gPlayer.qWorldX) >> 8)) - gCamera.x + (+5);
            s->y = ((int)((gPlayer.qWorldY) >> 8)) - gCamera.y - (+36);
        }

        screenX = ((int)((gPlayer.qWorldX) >> 8)) - gCamera.x + (+5);
        screenY = ((int)((gPlayer.qWorldY) >> 8)) - gCamera.y - (+36);
    } else {
        ...
        s->x = (worldX + (((int)((hookRail->qVelocity) >> 8)))) - gCamera.x;
        s->y = (worldY + (((int)((hookRail->qVelocity) >> 8)) >> 1)) - gCamera.y;

        screenX = s->x;
        screenY = s->y;

        if (((int)((hookRail->qVelocity) >> 8)) > ((s32)((1.875)*256))) {
            m4aSongNumStop(180);
            gCurTask->main = Task_HookRail_Shared0;
...
void Task_HookRail_Type0_2(void)
{
    ...
    if ((!(gPlayer.moveState & 0x00000080))) {
        ...
        if (hookRail->hitLowerRail) {
            hookRail->qAcceleration += ((s32)((20. / 256.)*256));
            hookRail->qVelocity += hookRail->qAcceleration;

            qWorldX = ((s32)((worldX)*256));
            qWorldX -= ((s32)((6)*256));
            gPlayer.qWorldX = qWorldX + hookRail->qVelocity;
            qWorldY = ((s32)((worldY + 276)*256));
            qWorldY += (hookRail->qVelocity >> 1);
            gPlayer.qWorldY = qWorldY;
            s->y = worldY + ((int)((hookRail->qVelocity >> 1) >> 8)) - gCamera.y + (240);

            if (((int)((hookRail->qVelocity) >> 8)) > 2) {
                m4aSongNumStop(180);
                Player_TransitionCancelFlyingAndBoost(&gPlayer);
                gPlayer.moveState &= ~0x00400000;
                gPlayer.charState = 4;
                ...
                gPlayer.qWorldY -= ((s32)((10)*256));
                s->y = worldY + ((int)((hookRail->qVelocity >> 1) >> 8)) - gCamera.y + 120;
                gPlayer.itemEffect &= ~0x80;
            ...
            s32 qWorldX, qWorldY;
            hookRail->qAcceleration -= ((s32)((9. / 256.)*256));

            if (hookRail->qAcceleration < -((s32)((6)*256))) {
                hookRail->qAcceleration = -((s32)((6)*256));
            }
            ...
            qWorldY = ((s32)((worldY + 38)*256));
            qWorldY -= (hookRail->qVelocity >> 1);
            gPlayer.qWorldY = qWorldY;
            s->y = worldY - ((int)((hookRail->qVelocity >> 1) >> 8)) - gCamera.y;

            if (((int)((gPlayer.qWorldX - hookRail->qStartX) >> 8)) < -244) {
                hookRail->hitLowerRail = 1;
            }
        }
        ...
        if (hookRail->hitLowerRail) {
            ...
            s->y = (worldY + (((int)((hookRail->qVelocity) >> 8)) >> 1)) - gCamera.y + 240;
            ...
            if (((int)((((s32)((worldX)*256)) + hookRail->qVelocity - hookRail->qStartX) >> 8)) < -(244)) {
                hookRail->hitLowerRail = 1;
            }
    ...
    if ((!(gPlayer.moveState & 0x00000080))) {
        if (!(gPlayer.moveState & 0x00000008) || (gPlayer.stoodObj == s)) {
            if (Coll_Player_Entity_Intersection(s, worldX, worldY, &gPlayer)) {
                ...
                gPlayer.qWorldY = ((s32)((worldY + (+38))*256));
                gPlayer.qWorldX = ((s32)((worldX)*256));
                hookRail->qStartX = gPlayer.qWorldX;
                gPlayer.rotation = 0;
                ...
                gPlayer.moveState = (0x00400000 | 0x00000001);
                gPlayer.qSpeedAirY = ((s32)((0)*256));
                gPlayer.charState = 38;
...
void Task_HookRail_Type2_0(void)
{
    ...
    if ((!(gPlayer.moveState & 0x00000080))) {
        ...
        gPlayer.qSpeedAirY = 0;
        if (((int)((hookRail->qStartX - gPlayer.qWorldX) >> 8)) > 480) {
            s32 rotation;
            m4aSongNumStop(180);
            Player_TransitionCancelFlyingAndBoost(&gPlayer);
            gPlayer.moveState &= ~0x00400000;
            ...
            qWorldX = ((s32)((worldX + (+6))*256));
            gPlayer.qWorldX = qWorldX - hookRail->qVelocity;
            qWorldY = (((s32)((worldY)*256)) + ((s32)(((+38))*256)));
            gPlayer.qWorldY = qWorldY + (hookRail->qVelocity >> 1);
            Player_TransitionCancelFlyingAndBoost(&gPlayer);
            gPlayer.charState = 38;
        }
        ...
        if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
            struct MultiSioData_0_4 *sioData = &gMultiSioRecv[((volatile struct SioMultiCnt *)(REG_BASE + 0x128))->id].pat4;
            s->x = (sioData->x - gCamera.x) - (+4);
            s->y = (sioData->y - gCamera.y) - 36;
        } else {
            s->x = ((int)((gPlayer.qWorldX) >> 8)) - gCamera.x - (+4);
            s->y = ((int)((gPlayer.qWorldY) >> 8)) - gCamera.y - (+36);
        }

        screenX = ((int)((gPlayer.qWorldX) >> 8)) - gCamera.x - (+4);
        screenY = ((int)((gPlayer.qWorldY) >> 8)) - gCamera.y - (+36);
    } else {
        hookRail->qAcceleration += ((s32)((16. / 256.)*256));
        hookRail->qVelocity += hookRail->qAcceleration;
        ...
        if (((int)((hookRail->qStartX - (((s32)((worldX)*256)) - hookRail->qVelocity)) >> 8)) > 480) {
            m4aSongNumStop(180);
            gCurTask->main = Task_HookRail_Type2_1;
