# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c" 2
...
void EwramFree(void *);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/collect_ring_effect.h" 1
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/magnetic_ring.h" 1



extern void CreateMagneticRing(s16 x, s16 y);
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/rings_manager.h" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c" 2


# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/assets/compressed/entities.h" 1
...
# 16 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c" 2
...
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c" 2
...
# 84 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c"
extern const u8 *const gSpritePosData_rings[];
# 126 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c"
void CreateStageRingsManager(void)
{
    struct Task *t;
    RingsManager *mgr;
...

    {
        ...
        t = TaskCreate(Task_RingsMgrMain, sizeof(RingsManager), 0x2000, 0, ((void*)0));

        compressedRingPosData = (u8 *)(*(u8 **)(EWRAM_START + 0x3300C));
        dataSize = (*(u32 *)compressedRingPosData) >> 8;
        dataSize = (dataSize + 3) >> 2;
        dataSize <<= 4;
        ewramBuffer = (u32 *)((u8 *)(EWRAM_START + 0x3F000) + dataSize);
        RLUnCompWram(((u8 **)(EWRAM_START + 0x33008))[0], ewramBuffer);
    }

    mgrRings = (void *)((t)->data) + __builtin_offsetof(RingsManager, rings);
    *mgrRings = ewramBuffer;
    ...
    s->graphics.dest = (void *)(&VRAM[0x10000] + 0x1D00);
    s->oamFlags = ((20) << 6);
    s->graphics.size = 0;
...
void Task_RingsMgrMain(void)
{
    ...
    if (!(gStageFlags & 0x0002)) {
        ...
        const
            ...
            s16 leftIndex
            = 0;
        rings = *(u32 **)((void *)((gCurTask)->data) + __builtin_offsetof(RingsManager, rings));
# 265 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c"
        rings = *(u32 **)((void *)((gCurTask)->data) + __builtin_offsetof(RingsManager, rings));
        rm = (void *)((gCurTask)->data);
        s = &rm->s;
        ...
        {
            p = &(*(((r4) != 0) ? &gPartner : &gPlayer));


            for (regionY = ({ s32 a = (((int)((p->qWorldY) >> 8))); s32 b = (rect[1]); ((a + b + 0) >> 8); });
                 regionY <= ({ s32 a = (((int)((p->qWorldY) >> 8))); s32 b = (rect[3]); ((a + b + (-8 * 2)) >> 8); }) && regionY < v_regionCount; regionY++) {

                for (regionX = ({ s32 a = (((int)((p->qWorldX) >> 8))); s32 b = (rect[leftIndex]); ((a + b + (-8)) >> 8); });
                     regionX <= ({ s32 a = (((int)((p->qWorldX) >> 8))); s32 b = (rect[2]); ((a + b + (-8)) >> 8); }) && regionX < h_regionCount; regionX++) {

                    u32 offset = (*((u32 *)((((u8 *)(rings)) + (((h_regionCount) * (regionY)) * (sizeof(u32)))) + ((regionX) * (sizeof(u32))))));
                    if (offset) {
                        meRing = (void *)((u8 *)(rings) - (sizeof(u32) * 2)) + offset;

                        while (meRing->x != (u8)(-1)) {
                            bool32 shouldSpawn = meRing->x != (u8)(-2);
                            if (shouldSpawn) {

                                rx = ((meRing->x)*8 + (regionX)*256);
                                ry = ((meRing->y)*8 + (regionY)*256);


                                if (((!((p)->moveState & 0x00000080)) && (p->charState != 15 || p->timerInvulnerability == 0)))
...

                                {
                                    ...
                                    if (((((rx - 8) <= (((((int)((p->qWorldX) >> 8)))) + ((Rect8 *)rect)->left) && (rx + 8) >= (((((int)((p->qWorldX) >> 8)))) + ((Rect8 *)rect)->left)) || ((rx - 8) >= (((((int)((p->qWorldX) >> 8)))) + ((Rect8 *)rect)->left) && ((((((int)((p->qWorldX) >> 8)))) + ((Rect8 *)rect)->left) + (((Rect8 *)rect)->right - ((Rect8 *)rect)->left)) >= (rx - 8))) && ((((ry - (8 * 2)) <= (((((int)((p->qWorldY) >> 8)))) + ((Rect8 *)rect)->top) && ry >= (((((int)((p->qWorldY) >> 8)))) + ((Rect8 *)rect)->top)) || ((ry - (8 * 2)) >= (((((int)((p->qWorldY) >> 8)))) + ((Rect8 *)rect)->top) && ((((((int)((p->qWorldY) >> 8)))) + ((Rect8 *)rect)->top) + (((Rect8 *)rect)->bottom - ((Rect8 *)rect)->top)) >= (ry - (8 * 2)))))))

                                    {

                                        { s32 prevLives, newLives; u16 oldRings = gRingCount; gRingCount = oldRings + (1); if (!(((gCurrentLevel) == ((6)*(2)) + (1)))) { newLives = ({((100) != 0) ? ((s32)(gRingCount) / (s32)(100)) : 0;}); prevLives = ({((100) != 0) ? ((s32)(oldRings) / (s32)(100)) : 0;}); if ((newLives != prevLives) && (gGameMode == 0)) { u16 lives = gNumLives + 1; gNumLives = ({ if ((lives) > 255) (lives) = 255; gNumLives = (lives); }); gMusicManagerState.unk3 = 0x10 | 0x0; } } };
# 332 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c"
                                        if (gGameMode == 6 && gRingCount > 255) {
                                            gRingCount = 255;
                                        }
        ...
        if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
            ...
            for (i = 0; i < 4; i++) {
                ...
                if (i != id && gMultiplayerPlayerTasks[i] != ((void*)0)) {
                    MultiplayerPlayer *mpp = (void *)((gMultiplayerPlayerTasks[i])->data);

                    for (regionY = ({ s32 a = (mpp->pos.y); s32 b = (mpp->s.hitboxes[0].b.top); ((a + b + 0) >> 8); });
                         regionY <= ({ s32 a = (mpp->pos.y); s32 b = (mpp->s.hitboxes[0].b.bottom); ((a + b + (-8 * 2)) >> 8); }) && regionY < v_regionCount;
                         regionY++) {

                        for (regionX = ({ s32 a = (mpp->pos.x); s32 b = (mpp->s.hitboxes[0].b.left); ((a + b + (-8)) >> 8); });
                             regionX <= ({ s32 a = (mpp->pos.x); s32 b = (mpp->s.hitboxes[0].b.right); ((a + b + (-8)) >> 8); })
                            ...
                            if (offset != 0) {
                                ...
                                while (meRing->x != (u8)(-1)) {
                                    ...
                                    rx = ((meRing->x)*8 + (regionX)*256);
                                    ry = ((meRing->y)*8 + (regionY)*256);
                                    if (((((rx - 8) <= (((mpp->pos.x)) + (&mpp->s.hitboxes[0].b)->left) && (rx + 8) >= (((mpp->pos.x)) + (&mpp->s.hitboxes[0].b)->left)) || ((rx - 8) >= (((mpp->pos.x)) + (&mpp->s.hitboxes[0].b)->left) && ((((mpp->pos.x)) + (&mpp->s.hitboxes[0].b)->left) + ((&mpp->s.hitboxes[0].b)->right - (&mpp->s.hitboxes[0].b)->left)) >= (rx - 8))) && ((((ry - (8 * 2)) <= (((mpp->pos.y)) + (&mpp->s.hitboxes[0].b)->top) && ry >= (((mpp->pos.y)) + (&mpp->s.hitboxes[0].b)->top)) || ((ry - (8 * 2)) >= (((mpp->pos.y)) + (&mpp->s.hitboxes[0].b)->top) && ((((mpp->pos.y)) + (&mpp->s.hitboxes[0].b)->top) + ((&mpp->s.hitboxes[0].b)->bottom - (&mpp->s.hitboxes[0].b)->top)) >= (ry - (8 * 2))))))) {
                                        u8 pAnim = mpp->s.graphics.anim;
                                        u8 anims = gPlayerCharacterIdleAnims[gMultiplayerCharacters[mpp->unk56]];
                                        u8 anim = pAnim - anims;
                                        if (!((anim) == 19 || (anim) == 21) || !(mpp->unk54 & 0x4)) {
                                            CreateCollectRingEffect(rx, ry);
                                            meRing->x = (u8)(-2);
                                        }
                                    }
        ...
        if (gPlayer.itemEffect & 0x08 && gGameMode != 6) {
            for (; ((0)*8 + (regionY)*256) < gCamera.y + 240 && regionY < v_regionCount; regionY++) {




                for (regionX = ((gCamera.x) >> 8); ((0)*8 + (regionX)*256) < gCamera.x + 320; regionX++) {
                    u32 offset = (*((u32 *)((((u8 *)(rings)) + (((h_regionCount) * (regionY)) * (sizeof(u32)))) + ((regionX) * (sizeof(u32))))));
                    ...
                    if (offset != 0) {
                        ...
                        while (meRing->x != (u8)(-1)) {
                            ...
                            ry = ((meRing->y)*8 + (regionY)*256);
                            if (rx - gCamera.x < -8 || (rx - gCamera.x) + 8 > 320 + 2 * 8
                                || ry - gCamera.y < 0 || (ry - gCamera.y) - 2 * 8 > 240) {
                                meRing++;
                                continue;
                            }


                            if (rx - 64 <= ((int)((gPlayer.qWorldX) >> 8)) && rx + 64 >= ((int)((gPlayer.qWorldX) >> 8)) && ry - 72 <= ((int)((gPlayer.qWorldY) >> 8))
                                && ry + 56 >= ((int)((gPlayer.qWorldY) >> 8))) {
                                ...
                                if ((drawCount == 0) || s->oamBaseIndex == 0xFF) {
                                    ...
                                    OamData *oamAllocated = OamMalloc(((((s)->oamFlags) & 0x7C0) >> 6));

                                    if (iwram_end == oamAllocated)
                                        return;

                                    DmaSet(3, oamDat, oamAllocated, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(OamDataShort))/(16/8))));
# 465 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c"
...

        {
            for (; ((0)*8 + (regionY)*256) < gCamera.y + 240 && regionY < v_regionCount; regionY++) {
                ...
                for (regionX = ((gCamera.x) >> 8); ((0)*8 + (regionX)*256) < gCamera.x + 320 && regionX < h_regionCount;
                     regionX++) {
                        ...
                        while (meRing->x != (u8)(-1)) {
                            ...
                            if (rx - gCamera.x < -8 || (rx - gCamera.x) + 8 > 320 + 2 * 8
                                ...
                                if ((drawCount == 0) || s->oamBaseIndex == 0xFF) {
                                    ...
                                    DmaSet(3, oamDat, oamAllocated, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof(OamDataShort))/(16/8))));
# 528 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/rings_manager.c"
                                    oamAllocated->split.x = ((rx - gCamera.x) - dimensions->offsetX);
                                    oamAllocated->split.y = ((ry - gCamera.y) - dimensions->offsetY);
...
{
    void *rings = *(void **)((void *)((t)->data) + __builtin_offsetof(RingsManager, rings));
    EwramFree(rings);
}
