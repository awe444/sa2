# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/dust_cloud.h" 1



void CreateDustCloud(s16 x, s16 y);
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/entities_manager.h" 1
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 8 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/entities_manager.h" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c" 2
...
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c" 2


# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/stage/trapped_animals.h" 1
...
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c" 2
...
# 20 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 21 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 22 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c" 2
# 34 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c"
...
u32 Coll_Player_Entity_RectIntersection(Sprite *s, CamCoord sx, CamCoord sy, Player *p, Rect8 *rectPlayer)
{
    ...
    if (!((s->hitboxes[0]).index != -1) || !(!((p)->moveState & 0x00000080))) {
        return result;
    }

    if ((((((sx) + (&s->hitboxes[0].b)->left) <= ((((int)((p->qWorldX) >> 8))) + (rectPlayer)->left) && (((sx) + (&s->hitboxes[0].b)->left) + ((&s->hitboxes[0].b)->right - (&s->hitboxes[0].b)->left)) >= ((((int)((p->qWorldX) >> 8))) + (rectPlayer)->left)) || (((sx) + (&s->hitboxes[0].b)->left) >= ((((int)((p->qWorldX) >> 8))) + (rectPlayer)->left) && (((((int)((p->qWorldX) >> 8))) + (rectPlayer)->left) + ((rectPlayer)->right - (rectPlayer)->left)) >= ((sx) + (&s->hitboxes[0].b)->left))) && (((((sy)) + (&s->hitboxes[0].b)->top) <= (((((int)((p->qWorldY) >> 8)))) + (rectPlayer)->top) && ((((sy)) + (&s->hitboxes[0].b)->top) + ((&s->hitboxes[0].b)->bottom - (&s->hitboxes[0].b)->top)) >= (((((int)((p->qWorldY) >> 8)))) + (rectPlayer)->top)) || ((((sy)) + (&s->hitboxes[0].b)->top) >= (((((int)((p->qWorldY) >> 8)))) + (rectPlayer)->top) && ((((((int)((p->qWorldY) >> 8)))) + (rectPlayer)->top) + ((rectPlayer)->bottom - (rectPlayer)->top)) >= (((sy)) + (&s->hitboxes[0].b)->top))))) {
        result |= 0x00080000;
    }
...
u32 Coll_AmyHammer_Spring(Sprite *s, s16 worldX, s16 worldY, Player *p)
{
    ...
    if (p->character == CHARACTER_AMY) {
        if ((p->charState == 87) || (p->charState == 88) || (p->charState == 89)
            || (p->charState == 90)) {
            if (p->spriteInfoBody->s.hitboxes[1].index != -1) {
                if ((((((worldX) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + p->spriteInfoBody->s.hitboxes[1].b.left) && ((((worldX)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + p->spriteInfoBody->s.hitboxes[1].b.left)) || (((worldX) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + p->spriteInfoBody->s.hitboxes[1].b.left) && ((((((int)((p->qWorldX) >> 8)))) + (p->spriteInfoBody->s.hitboxes[1].b).left) + ((p->spriteInfoBody->s.hitboxes[1].b).right - (p->spriteInfoBody->s.hitboxes[1].b).left)) >= ((worldX) + s->hitboxes[0].b.left))) && (((((worldY)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + p->spriteInfoBody->s.hitboxes[1].b.top) && ((((worldY)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + p->spriteInfoBody->s.hitboxes[1].b.top)) || ((((worldY)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + p->spriteInfoBody->s.hitboxes[1].b.top) && ((((((int)((p->qWorldY) >> 8)))) + p->spriteInfoBody->s.hitboxes[1].b.top) + ((p->spriteInfoBody->s.hitboxes[1].b).bottom - (p->spriteInfoBody->s.hitboxes[1].b).top)) >= (((worldY)) + s->hitboxes[0].b.top))))) {
                    isColliding = 1;
                }
            }
        }
...
u32 Coll_Player_Spring_Sideways(Sprite *s, CamCoord worldX, CamCoord worldY, Player *p)
{
    ...
    moveState = p->moveState & 0x00000002;
    rectPlayerB = (Rect8 *)&rectDataPlayerB[0];
    if ((p->moveState & 0x00000008) && (p->stoodObj == s)) {
        p->moveState &= ~0x00000008;
        moveState |= 0x00000002;
        stoodOnCurrent = 1;
    }

    if (moveState & 0x00000002) {
        if ((((((worldX) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + (*rectPlayerB).left) && ((((worldX)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + (*rectPlayerB).left)) || (((worldX) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + (*rectPlayerB).left) && ((((((int)((p->qWorldX) >> 8)))) + ((*rectPlayerB)).left) + (((*rectPlayerB)).right - ((*rectPlayerB)).left)) >= ((worldX) + s->hitboxes[0].b.left))) && (((((worldY)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + (*rectPlayerB).top) && ((((worldY)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + (*rectPlayerB).top)) || ((((worldY)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + (*rectPlayerB).top) && ((((((int)((p->qWorldY) >> 8)))) + (*rectPlayerB).top) + (((*rectPlayerB)).bottom - ((*rectPlayerB)).top)) >= (((worldY)) + s->hitboxes[0].b.top))))) {
            if (sub_800C934(s, worldX, worldY, (Rect8 *)&rectDataPlayerB, stoodOnCurrent, p, &moveState)) {
                return moveState;
            }
        } else if ((((((worldX) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + (*(Rect8 *)&rectDataPlayerA).left) && ((((worldX)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + (*(Rect8 *)&rectDataPlayerA).left)) || (((worldX) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + (*(Rect8 *)&rectDataPlayerA).left) && ((((((int)((p->qWorldX) >> 8)))) + ((*(Rect8 *)&rectDataPlayerA)).left) + (((*(Rect8 *)&rectDataPlayerA)).right - ((*(Rect8 *)&rectDataPlayerA)).left)) >= ((worldX) + s->hitboxes[0].b.left))) && (((((worldY)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)&rectDataPlayerA).top) && ((((worldY)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)&rectDataPlayerA).top)) || ((((worldY)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)&rectDataPlayerA).top) && ((((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)&rectDataPlayerA).top) + (((*(Rect8 *)&rectDataPlayerA)).bottom - ((*(Rect8 *)&rectDataPlayerA)).top)) >= (((worldY)) + s->hitboxes[0].b.top))))) {
            if (((int)((p->qWorldX) >> 8)) <= worldX) {
                if (p->qSpeedAirX >= 0) {
                    p->qSpeedAirX = 0;
                    p->qWorldX = ((s32)(((worldX + s->hitboxes[0].b.left) - rectDataPlayerA[2])*256));
                    moveState |= 0x00020000;
                }
            } else if (p->qSpeedAirX <= 0) {
                p->qSpeedAirX = 0;
                p->qWorldX = ((s32)((((worldX + s->hitboxes[0].b.right) - rectDataPlayerA[0]) + 1)*256));
                moveState |= 0x00040000;
            }
        }
    }
    ...
    if ((((((worldX) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + (*(Rect8 *)&rectDataPlayerA).left) && ((((worldX)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + (*(Rect8 *)&rectDataPlayerA).left)) || (((worldX) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + (*(Rect8 *)&rectDataPlayerA).left) && ((((((int)((p->qWorldX) >> 8)))) + ((*(Rect8 *)&rectDataPlayerA)).left) + (((*(Rect8 *)&rectDataPlayerA)).right - ((*(Rect8 *)&rectDataPlayerA)).left)) >= ((worldX) + s->hitboxes[0].b.left))) && (((((worldY)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)&rectDataPlayerA).top) && ((((worldY)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)&rectDataPlayerA).top)) || ((((worldY)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)&rectDataPlayerA).top) && ((((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)&rectDataPlayerA).top) + (((*(Rect8 *)&rectDataPlayerA)).bottom - ((*(Rect8 *)&rectDataPlayerA)).top)) >= (((worldY)) + s->hitboxes[0].b.top))))) {
        if (((int)((p->qWorldX) >> 8)) <= worldX) {
            if (p->qSpeedAirX >= 0) {
                ...
                if (p->qSpeedAirX > 0) {
                    moveState |= 0x00000020;
                    moveState &= ~0x00000001;
                    p->qWorldX = ((s32)(((worldX + s->hitboxes[0].b.left) - rectDataPlayerA[2])*256));
                }
            }
        } else {
...

{
    ...
    if (p->moveState & 0x00000002) {
        ...
        if ((((((worldX) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + (*rectPlayerB).left) && ((((worldX)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + (*rectPlayerB).left)) || (((worldX) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + (*rectPlayerB).left) && ((((((int)((p->qWorldX) >> 8)))) + ((*rectPlayerB)).left) + (((*rectPlayerB)).right - ((*rectPlayerB)).left)) >= ((worldX) + s->hitboxes[0].b.left))) && (((((worldY)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + (*rectPlayerB).top) && ((((worldY)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + (*rectPlayerB).top)) || ((((worldY)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + (*rectPlayerB).top) && ((((((int)((p->qWorldY) >> 8)))) + (*rectPlayerB).top) + (((*rectPlayerB)).bottom - ((*rectPlayerB)).top)) >= (((worldY)) + s->hitboxes[0].b.top))))) {
            if ((!(gStageFlags & 0x0080) && (((int)((p->qWorldY) >> 8)) <= middleY)) || ((gStageFlags & 0x0080) && (((int)((p->qWorldY) >> 8)) >= middleY))) {
                if ((p->character == 1) && (p->sa2__unk61 != 0)) {
                ...
                if (!(gStageFlags & 0x0080)) {
                    p->qWorldY = p->qWorldY + (((s32)(((worldY + s->hitboxes[0].b.bottom) - rectDataPlayerB[1])*256)) - (0xFFFFFF00 & p->qWorldY));
                } else {
                    p->qWorldY = p->qWorldY - (((s32)(((worldY + s->hitboxes[0].b.bottom) - rectDataPlayerB[1])*256)) - (0xFFFFFF00 & p->qWorldY));
                }
        ...
        } else if ((((((worldX) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + (*(Rect8 *)&rectDataPlayerA[0]).left) && ((((worldX)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + (*(Rect8 *)&rectDataPlayerA[0]).left)) || (((worldX) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + (*(Rect8 *)&rectDataPlayerA[0]).left) && ((((((int)((p->qWorldX) >> 8)))) + ((*(Rect8 *)&rectDataPlayerA[0])).left) + (((*(Rect8 *)&rectDataPlayerA[0])).right - ((*(Rect8 *)&rectDataPlayerA[0])).left)) >= ((worldX) + s->hitboxes[0].b.left))) && (((((worldY)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)&rectDataPlayerA[0]).top) && ((((worldY)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)&rectDataPlayerA[0]).top)) || ((((worldY)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)&rectDataPlayerA[0]).top) && ((((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)&rectDataPlayerA[0]).top) + (((*(Rect8 *)&rectDataPlayerA[0])).bottom - ((*(Rect8 *)&rectDataPlayerA[0])).top)) >= (((worldY)) + s->hitboxes[0].b.top))))) {
            if (((int)((p->qWorldX) >> 8)) <= middleX) {
                if (p->qSpeedAirX > 0) {
                    p->qSpeedAirX = 0;
                    p->qWorldX = ((s32)((worldX + s->hitboxes[0].b.left - rectDataPlayerA[2])*256));
                }
    ...
    else if (!(result & 0x00000020)) {
# 235 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c"
        ...
        if (!inAttackState && (((((s32)(p->rotation + 0x20) & 0xC0) >> 6) & 0x1) == 0)) {
            ...
            if ((((((worldX) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + (*rectA).left) && ((((worldX)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + (*rectA).left)) || (((worldX) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + (*rectA).left) && ((((((int)((p->qWorldX) >> 8)))) + ((*rectA)).left) + (((*rectA)).right - ((*rectA)).left)) >= ((worldX) + s->hitboxes[0].b.left))) && (((((worldY)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + (*rectA).top) && ((((worldY)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + (*rectA).top)) || ((((worldY)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + (*rectA).top) && ((((((int)((p->qWorldY) >> 8)))) + (*rectA).top) + (((*rectA)).bottom - ((*rectA)).top)) >= (((worldY)) + s->hitboxes[0].b.top))))) {
                s32 shbMiddleH = worldX + ((s->hitboxes[0].b.left + s->hitboxes[0].b.right) >> 1);

                if (((int)((p->qWorldX) >> 8)) <= shbMiddleH) {
                    if (p->qSpeedAirX > 0)
                        p->qSpeedAirX = 0;
                    if (p->qSpeedGround > 0)
                        p->qSpeedGround = 0;
                    p->qWorldX = ((s32)((worldX + s->hitboxes[0].b.left - rectA->right)*256));
                    result |= 0x00020000;
                    ...
                    if (p->qSpeedGround < 0)
                        p->qSpeedGround = 0;
                    p->qWorldX = ((s32)((worldX + s->hitboxes[0].b.right - rectA->left + 1)*256));
                    result |= 0x00040000;
...
u32 Coll_Player_Gate(Sprite *s, CamCoord worldX, CamCoord worldY, Player *p, u32 arg4)
{
    ...
    if (arg4 != 0) {
        if (p->spriteInfoBody->s.hitboxes[1].index != -1) {
            if ((((((worldX) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + p->spriteInfoBody->s.hitboxes[1].b.left) && ((((worldX)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + p->spriteInfoBody->s.hitboxes[1].b.left)) || (((worldX) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + p->spriteInfoBody->s.hitboxes[1].b.left) && ((((((int)((p->qWorldX) >> 8)))) + (p->spriteInfoBody->s.hitboxes[1].b).left) + ((p->spriteInfoBody->s.hitboxes[1].b).right - (p->spriteInfoBody->s.hitboxes[1].b).left)) >= ((worldX) + s->hitboxes[0].b.left))) && (((((worldY)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + p->spriteInfoBody->s.hitboxes[1].b.top) && ((((worldY)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + p->spriteInfoBody->s.hitboxes[1].b.top)) || ((((worldY)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + p->spriteInfoBody->s.hitboxes[1].b.top) && ((((((int)((p->qWorldY) >> 8)))) + p->spriteInfoBody->s.hitboxes[1].b.top) + ((p->spriteInfoBody->s.hitboxes[1].b).bottom - (p->spriteInfoBody->s.hitboxes[1].b).top)) >= (((worldY)) + s->hitboxes[0].b.top))))
                || (((((worldX) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + (*(Rect8 *)&rectPlayer[0]).left) && ((((worldX)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + (*(Rect8 *)&rectPlayer[0]).left)) || (((worldX) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + (*(Rect8 *)&rectPlayer[0]).left) && ((((((int)((p->qWorldX) >> 8)))) + ((*(Rect8 *)&rectPlayer[0])).left) + (((*(Rect8 *)&rectPlayer[0])).right - ((*(Rect8 *)&rectPlayer[0])).left)) >= ((worldX) + s->hitboxes[0].b.left))) && (((((worldY)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)&rectPlayer[0]).top) && ((((worldY)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)&rectPlayer[0]).top)) || ((((worldY)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)&rectPlayer[0]).top) && ((((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)&rectPlayer[0]).top) + (((*(Rect8 *)&rectPlayer[0])).bottom - ((*(Rect8 *)&rectPlayer[0])).top)) >= (((worldY)) + s->hitboxes[0].b.top))))) {

                result |= 8;
                if ((p->moveState & 0x00000002) && (p->qSpeedAirY > 0)) {
                    p->qSpeedAirY = -p->qSpeedAirY;
                }
...
u32 Coll_Player_SkatingStone(Sprite *s, CamCoord worldX, CamCoord worldY, Player *p)
{
    ...
    moveState = p->moveState & 0x00000002;
    if ((p->moveState & 0x00000008) && (p->stoodObj == s)) {
        p->moveState = p->moveState & ~0x00000008;
        moveState |= 0x00000002;
        var_sb = 1;
    }
    ...
    if (((moveState == 0) || !sub_800C934(s, worldX, worldY, (Rect8 *)rectPlayer, var_sb, p, &result))
        ...
        if (var_sb) {
            if (!(p->moveState & 0x00000008)) {
                p->moveState = (p->moveState & ~0x00000020) | 0x00000002;
            }
        }
    }
...
u32 Coll_Player_PlatformCrumbling(Sprite *s, CamCoord sx, CamCoord sy, Player *p)
{
    ...
    if (((((((s32)((sx) << 8)) + ((s32)(((&s->hitboxes[0].b)->left) << 8))) <= ((p->qWorldX) + ((s32)((((Rect8 *)rectPlayer)->left)*256))) && ((((s32)((sx) << 8)) + ((s32)(((&s->hitboxes[0].b)->left) << 8))) + ((s32)((((&s->hitboxes[0].b)->right - (&s->hitboxes[0].b)->left)) << 8))) >= ((p->qWorldX) + ((s32)((((Rect8 *)rectPlayer)->left)*256)))) || ((((s32)((sx) << 8)) + ((s32)(((&s->hitboxes[0].b)->left) << 8))) >= ((p->qWorldX) + ((s32)((((Rect8 *)rectPlayer)->left)*256))) && (((p->qWorldX) + ((s32)((((Rect8 *)rectPlayer)->left)*256))) + ((s32)(((((Rect8 *)rectPlayer)->right - ((Rect8 *)rectPlayer)->left)) << 8))) >= (((s32)((sx) << 8)) + ((s32)(((&s->hitboxes[0].b)->left) << 8))))) && (((((s32)(((sy)) << 8)) + ((s32)(((&s->hitboxes[0].b)->top) << 8))) <= ((((p->qWorldY)) + ((s32)((((Rect8 *)rectPlayer)->top)*256)))) && ((((s32)(((sy)) << 8)) + ((s32)(((&s->hitboxes[0].b)->top) << 8))) + ((s32)((((&s->hitboxes[0].b)->bottom - (&s->hitboxes[0].b)->top)) << 8))) >= ((((p->qWorldY)) + ((s32)((((Rect8 *)rectPlayer)->top)*256))))) || ((((s32)(((sy)) << 8)) + ((s32)(((&s->hitboxes[0].b)->top) << 8))) >= ((((p->qWorldY)) + ((s32)((((Rect8 *)rectPlayer)->top)*256)))) && (((((p->qWorldY)) + ((s32)((((Rect8 *)rectPlayer)->top)*256)))) + ((s32)(((((Rect8 *)rectPlayer)->bottom - ((Rect8 *)rectPlayer)->top)) << 8))) >= (((s32)(((sy)) << 8)) + ((s32)(((&s->hitboxes[0].b)->top) << 8)))))) && (p->qSpeedAirY >= 0)) {
# 398 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c"
        s32 y;
        ...
        if (((p->character != CHARACTER_KNUCKLES) || (p->sa2__unk61 != 1 && p->sa2__unk61 != 3))
            && ((p->character != CHARACTER_AMY) || !(p->moveState & 0x04000000) || (p->sa2__unk62 == 0))) {
        ...
        if (!(gStageFlags & 0x0080)) {
            y = ((s32)(((sy + s->hitboxes[0].b.top) - rectPlayer[3])*256));
        } else {
            y = ((s32)(((sy + s->hitboxes[0].b.bottom) + rectPlayer[3])*256));
        }
# 443 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c"
        p->qWorldY = ((u8)(p->qWorldY)) + (y);

    } else if (ip && !(p->moveState & 0x00000008)) {
...
# 534 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c"
...

{
    ...
    eb = (void *)((gCurTask)->data);

    do

    {
        player = &(*(((i) != 0) ? &gPartner : &gPlayer));
        sprPlayer = &player->spriteInfoBody->s;

        if (!(player->moveState & 0x00000080)) {
            if ((!(((gGameMode == 0) || (gGameMode == 1)))) && ((s8)eb->base.me->x == (-3))) {
...

            {
                if (((sprPlayer->hitboxes[1]).index != -1)) {
                    if ((((((sx) + s->hitboxes[hbIndex].b.left) <= ((((int)((player->qWorldX) >> 8))) + sprPlayer->hitboxes[1].b.left) && ((((sx)) + (s->hitboxes[hbIndex].b).left) + ((s->hitboxes[hbIndex].b).right - (s->hitboxes[hbIndex].b).left)) >= ((((int)((player->qWorldX) >> 8))) + sprPlayer->hitboxes[1].b.left)) || (((sx) + s->hitboxes[hbIndex].b.left) >= ((((int)((player->qWorldX) >> 8))) + sprPlayer->hitboxes[1].b.left) && ((((((int)((player->qWorldX) >> 8)))) + (sprPlayer->hitboxes[1].b).left) + ((sprPlayer->hitboxes[1].b).right - (sprPlayer->hitboxes[1].b).left)) >= ((sx) + s->hitboxes[hbIndex].b.left))) && (((((sy)) + s->hitboxes[hbIndex].b.top) <= (((((int)((player->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].b.top) && ((((sy)) + s->hitboxes[hbIndex].b.top) + ((s->hitboxes[hbIndex].b).bottom - (s->hitboxes[hbIndex].b).top)) >= (((((int)((player->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].b.top)) || ((((sy)) + s->hitboxes[hbIndex].b.top) >= (((((int)((player->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].b.top) && ((((((int)((player->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].b.top) + ((sprPlayer->hitboxes[1].b).bottom - (sprPlayer->hitboxes[1].b).top)) >= (((sy)) + s->hitboxes[hbIndex].b.top))))) {
                ...
                if (((sprPlayer->hitboxes[0]).index != -1)
                    && ((((((sx) + s->hitboxes[hbIndex].b.left) <= ((((int)((player->qWorldX) >> 8))) + sprPlayer->hitboxes[0].b.left) && ((((sx)) + (s->hitboxes[hbIndex].b).left) + ((s->hitboxes[hbIndex].b).right - (s->hitboxes[hbIndex].b).left)) >= ((((int)((player->qWorldX) >> 8))) + sprPlayer->hitboxes[0].b.left)) || (((sx) + s->hitboxes[hbIndex].b.left) >= ((((int)((player->qWorldX) >> 8))) + sprPlayer->hitboxes[0].b.left) && ((((((int)((player->qWorldX) >> 8)))) + (sprPlayer->hitboxes[0].b).left) + ((sprPlayer->hitboxes[0].b).right - (sprPlayer->hitboxes[0].b).left)) >= ((sx) + s->hitboxes[hbIndex].b.left))) && (((((sy)) + s->hitboxes[hbIndex].b.top) <= (((((int)((player->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top) && ((((sy)) + s->hitboxes[hbIndex].b.top) + ((s->hitboxes[hbIndex].b).bottom - (s->hitboxes[hbIndex].b).top)) >= (((((int)((player->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top)) || ((((sy)) + s->hitboxes[hbIndex].b.top) >= (((((int)((player->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top) && ((((((int)((player->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top) + ((sprPlayer->hitboxes[0].b).bottom - (sprPlayer->hitboxes[0].b).top)) >= (((sy)) + s->hitboxes[hbIndex].b.top)))))) {
                    if (player->itemEffect & 0x02) {
                        if ((!(((gGameMode == 0) || (gGameMode == 1))))) {
                            RoomEvent_EnemyDestroy *roomEvent = CreateRoomEvent();
                            roomEvent->type = 3;
                            roomEvent->x = eb->base.regionX;
...
# 638 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c"
        }
    }
...
bool32 Coll_Player_Projectile(Sprite *s, CamCoord sx, CamCoord sy)
{
    ...
    if (((s->hitboxes[0]).index != -1)) {
        ...
        {
            p = &(*(((i) != 0) ? &gPartner : &gPlayer));
            sprPlayer = &p->spriteInfoBody->s;

            if (!(!((p)->moveState & 0x00000080)) || !((sprPlayer->hitboxes[0]).index != -1)) {
            ...
            if (((((((sx) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[0].b.left) && ((((sx)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[0].b.left)) || (((sx) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[0].b.left) && ((((((int)((p->qWorldX) >> 8)))) + (sprPlayer->hitboxes[0].b).left) + ((sprPlayer->hitboxes[0].b).right - (sprPlayer->hitboxes[0].b).left)) >= ((sx) + s->hitboxes[0].b.left))) && (((((sy)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top) && ((((sy)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top)) || ((((sy)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top) && ((((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top) + ((sprPlayer->hitboxes[0].b).bottom - (sprPlayer->hitboxes[0].b).top)) >= (((sy)) + s->hitboxes[0].b.top)))))) {
                Coll_DamagePlayer(p);
                result = 1;
            }
        }
...
# 713 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c"
...

    {
        if ((!((p)->moveState & 0x00000080))) {
...

            {
                ...
                if (((sprPlayer->hitboxes[1]).index != -1)
                    && (((((sx) + s->hitboxes[hbIndex].b.left) <= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[1].b.left) && ((((sx)) + (s->hitboxes[hbIndex].b).left) + ((s->hitboxes[hbIndex].b).right - (s->hitboxes[hbIndex].b).left)) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[1].b.left)) || (((sx) + s->hitboxes[hbIndex].b.left) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[1].b.left) && ((((((int)((p->qWorldX) >> 8)))) + (sprPlayer->hitboxes[1].b).left) + ((sprPlayer->hitboxes[1].b).right - (sprPlayer->hitboxes[1].b).left)) >= ((sx) + s->hitboxes[hbIndex].b.left))) && (((((sy)) + s->hitboxes[hbIndex].b.top) <= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].b.top) && ((((sy)) + s->hitboxes[hbIndex].b.top) + ((s->hitboxes[hbIndex].b).bottom - (s->hitboxes[hbIndex].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].b.top)) || ((((sy)) + s->hitboxes[hbIndex].b.top) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].b.top) && ((((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].b.top) + ((sprPlayer->hitboxes[1].b).bottom - (sprPlayer->hitboxes[1].b).top)) >= (((sy)) + s->hitboxes[hbIndex].b.top))))) {
                    if (p->character != CHARACTER_AMY) {
                ...
                if ((((sprPlayer->hitboxes[0]).index != -1))
                    && (((((sx) + s->hitboxes[hbIndex].b.left) <= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[0].b.left) && ((((sx)) + (s->hitboxes[hbIndex].b).left) + ((s->hitboxes[hbIndex].b).right - (s->hitboxes[hbIndex].b).left)) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[0].b.left)) || (((sx) + s->hitboxes[hbIndex].b.left) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[0].b.left) && ((((((int)((p->qWorldX) >> 8)))) + (sprPlayer->hitboxes[0].b).left) + ((sprPlayer->hitboxes[0].b).right - (sprPlayer->hitboxes[0].b).left)) >= ((sx) + s->hitboxes[hbIndex].b.left))) && (((((sy)) + s->hitboxes[hbIndex].b.top) <= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top) && ((((sy)) + s->hitboxes[hbIndex].b.top) + ((s->hitboxes[hbIndex].b).bottom - (s->hitboxes[hbIndex].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top)) || ((((sy)) + s->hitboxes[hbIndex].b.top) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top) && ((((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top) + ((sprPlayer->hitboxes[0].b).bottom - (sprPlayer->hitboxes[0].b).top)) >= (((sy)) + s->hitboxes[hbIndex].b.top))))) {
                    Coll_DamagePlayer(p);
...
# 791 "/home/awaszczak/git/sa2/sa1/../src/game/shared/stage/collision_3.c"
EHit Coll_Player_Boss_1(Sprite *s, CamCoord worldX, CamCoord worldY, Player *p)
{
    Sprite *sprPlayer;
    ...
    if (sprPlayer->hitboxes[1].index != -1) {
        if ((((((worldX) + s->hitboxes[1].b.left) <= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[0].b.left) && ((((worldX)) + (s->hitboxes[1].b).left) + ((s->hitboxes[1].b).right - (s->hitboxes[1].b).left)) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[0].b.left)) || (((worldX) + s->hitboxes[1].b.left) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[0].b.left) && ((((((int)((p->qWorldX) >> 8)))) + (sprPlayer->hitboxes[0].b).left) + ((sprPlayer->hitboxes[0].b).right - (sprPlayer->hitboxes[0].b).left)) >= ((worldX) + s->hitboxes[1].b.left))) && (((((worldY)) + s->hitboxes[1].b.top) <= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top) && ((((worldY)) + s->hitboxes[1].b.top) + ((s->hitboxes[1].b).bottom - (s->hitboxes[1].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top)) || ((((worldY)) + s->hitboxes[1].b.top) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top) && ((((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top) + ((sprPlayer->hitboxes[0].b).bottom - (sprPlayer->hitboxes[0].b).top)) >= (((worldY)) + s->hitboxes[1].b.top))))) {
            Coll_DamagePlayer(p);
            return 2;
        }

        if ((((((worldX) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[1].b.left) && ((((worldX)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[1].b.left)) || (((worldX) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[1].b.left) && ((((((int)((p->qWorldX) >> 8)))) + (sprPlayer->hitboxes[1].b).left) + ((sprPlayer->hitboxes[1].b).right - (sprPlayer->hitboxes[1].b).left)) >= ((worldX) + s->hitboxes[0].b.left))) && (((((worldY)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].b.top) && ((((worldY)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].b.top)) || ((((worldY)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].b.top) && ((((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].b.top) + ((sprPlayer->hitboxes[1].b).bottom - (sprPlayer->hitboxes[1].b).top)) >= (((worldY)) + s->hitboxes[0].b.top))))) {
            if (p->character != CHARACTER_AMY) {
                p->qSpeedAirX = -p->qSpeedAirX;
                p->qSpeedAirY = -p->qSpeedAirY;
            } else {
    ...
    if (sprPlayer->hitboxes[0].index != -1) {
        if ((((((worldX) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[0].b.left) && ((((worldX)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[0].b.left)) || (((worldX) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[0].b.left) && ((((((int)((p->qWorldX) >> 8)))) + (sprPlayer->hitboxes[0].b).left) + ((sprPlayer->hitboxes[0].b).right - (sprPlayer->hitboxes[0].b).left)) >= ((worldX) + s->hitboxes[0].b.left))) && (((((worldY)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top) && ((((worldY)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top)) || ((((worldY)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top) && ((((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[0].b.top) + ((sprPlayer->hitboxes[0].b).bottom - (sprPlayer->hitboxes[0].b).top)) >= (((worldY)) + s->hitboxes[0].b.top))))) {
            Coll_DamagePlayer(p);
            return HIT_PLAYER;
        }
    }
...
EHit Coll_Player_Bosses_2_6(Sprite *s, s16 worldX, s16 worldY, Player *p)
{
    ...
    if ((sprPlayer->hitboxes[1].index != -1) && (s->hitboxes[0].index != -1) && (p->moveState & 0x00000002)) {
        if ((((((worldX) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[1].b.left) && ((((worldX)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[1].b.left)) || (((worldX) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + sprPlayer->hitboxes[1].b.left) && ((((((int)((p->qWorldX) >> 8)))) + (sprPlayer->hitboxes[1].b).left) + ((sprPlayer->hitboxes[1].b).right - (sprPlayer->hitboxes[1].b).left)) >= ((worldX) + s->hitboxes[0].b.left))) && (((((worldY)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].b.top) && ((((worldY)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].b.top)) || ((((worldY)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].b.top) && ((((((int)((p->qWorldY) >> 8)))) + sprPlayer->hitboxes[1].b.top) + ((sprPlayer->hitboxes[1].b).bottom - (sprPlayer->hitboxes[1].b).top)) >= (((worldY)) + s->hitboxes[0].b.top))))) {
            if (p->character != CHARACTER_AMY) {
                p->qSpeedAirX = -p->qSpeedAirX;
                p->qSpeedAirY = -p->qSpeedAirY;
...
EHit sub_800BF10(Sprite *s, CamCoord screenX, CamCoord screenY, Player *p)
{
    ...
    if (((s->hitboxes[0]).index != -1) && (!((p)->moveState & 0x00000080)) && ((sprBody->hitboxes[0]).index != -1)) {
        if ((((((screenX) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + sprBody->hitboxes[0].b.left) && ((((screenX)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + sprBody->hitboxes[0].b.left)) || (((screenX) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + sprBody->hitboxes[0].b.left) && ((((((int)((p->qWorldX) >> 8)))) + (sprBody->hitboxes[0].b).left) + ((sprBody->hitboxes[0].b).right - (sprBody->hitboxes[0].b).left)) >= ((screenX) + s->hitboxes[0].b.left))) && (((((screenY)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[0].b.top) && ((((screenY)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[0].b.top)) || ((((screenY)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[0].b.top) && ((((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[0].b.top) + ((sprBody->hitboxes[0].b).bottom - (sprBody->hitboxes[0].b).top)) >= (((screenY)) + s->hitboxes[0].b.top))))) {
            Coll_DamagePlayer(p);
...
EHit sub_800BFEC(Sprite *s, CamCoord screenX, CamCoord screenY, Player *p)
{
    ...
    if (((s->hitboxes[1]).index != -1) && ((sprBody->hitboxes[0]).index != -1) && (!((p)->moveState & 0x00000080))) {
        if ((((((screenX) + s->hitboxes[1].b.left) <= ((((int)((p->qWorldX) >> 8))) + sprBody->hitboxes[0].b.left) && ((((screenX)) + (s->hitboxes[1].b).left) + ((s->hitboxes[1].b).right - (s->hitboxes[1].b).left)) >= ((((int)((p->qWorldX) >> 8))) + sprBody->hitboxes[0].b.left)) || (((screenX) + s->hitboxes[1].b.left) >= ((((int)((p->qWorldX) >> 8))) + sprBody->hitboxes[0].b.left) && ((((((int)((p->qWorldX) >> 8)))) + (sprBody->hitboxes[0].b).left) + ((sprBody->hitboxes[0].b).right - (sprBody->hitboxes[0].b).left)) >= ((screenX) + s->hitboxes[1].b.left))) && (((((screenY)) + s->hitboxes[1].b.top) <= (((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[0].b.top) && ((((screenY)) + s->hitboxes[1].b.top) + ((s->hitboxes[1].b).bottom - (s->hitboxes[1].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[0].b.top)) || ((((screenY)) + s->hitboxes[1].b.top) >= (((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[0].b.top) && ((((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[0].b.top) + ((sprBody->hitboxes[0].b).bottom - (sprBody->hitboxes[0].b).top)) >= (((screenY)) + s->hitboxes[1].b.top))))) {
            if (!((gCurrentLevel) == ((6)*(2)) + (1))) {
                Coll_DamagePlayer(p);
            } else {
...
EHit sub_800C0E0(Sprite *s, CamCoord screenX, CamCoord screenY, Player *p)
{
    ...
    if (((s->hitboxes[0]).index != -1) && ((sprBody->hitboxes[1]).index != -1) && (!((p)->moveState & 0x00000080))) {
        if ((((((screenX) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + sprBody->hitboxes[1].b.left) && ((((screenX)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + sprBody->hitboxes[1].b.left)) || (((screenX) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + sprBody->hitboxes[1].b.left) && ((((((int)((p->qWorldX) >> 8)))) + (sprBody->hitboxes[1].b).left) + ((sprBody->hitboxes[1].b).right - (sprBody->hitboxes[1].b).left)) >= ((screenX) + s->hitboxes[0].b.left))) && (((((screenY)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[1].b.top) && ((((screenY)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[1].b.top)) || ((((screenY)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[1].b.top) && ((((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[1].b.top) + ((sprBody->hitboxes[1].b).bottom - (sprBody->hitboxes[1].b).top)) >= (((screenY)) + s->hitboxes[0].b.top))))) {
            if (!((gCurrentLevel) == ((6)*(2)) + (1))) {
                if (p->character != CHARACTER_AMY) {
                    p->qSpeedAirX = -p->qSpeedAirX;
                    p->qSpeedAirY = -p->qSpeedAirY;
...

{
    ...
    if ((!((p)->moveState & 0x00000080)) && (((sprBody->hitboxes[0]).index != -1))) {
        if ((((((sx) + rectB.left) <= ((((int)((p->qWorldX) >> 8))) + sprBody->hitboxes[0].b.left) && ((((sx)) + (rectB).left) + ((rectB).right - (rectB).left)) >= ((((int)((p->qWorldX) >> 8))) + sprBody->hitboxes[0].b.left)) || (((sx) + rectB.left) >= ((((int)((p->qWorldX) >> 8))) + sprBody->hitboxes[0].b.left) && ((((((int)((p->qWorldX) >> 8)))) + (sprBody->hitboxes[0].b).left) + ((sprBody->hitboxes[0].b).right - (sprBody->hitboxes[0].b).left)) >= ((sx) + rectB.left))) && (((((sy)) + rectB.top) <= (((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[0].b.top) && ((((sy)) + rectB.top) + ((rectB).bottom - (rectB).top)) >= (((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[0].b.top)) || ((((sy)) + rectB.top) >= (((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[0].b.top) && ((((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[0].b.top) + ((sprBody->hitboxes[0].b).bottom - (sprBody->hitboxes[0].b).top)) >= (((sy)) + rectB.top))))) {
            Coll_DamagePlayer(p);
            return HIT_PLAYER;
        }
    }
...
EHit sub_800C2B8(Sprite *s, s16 sx, s16 sy, Player *p)
{
    ...
    if (((s->hitboxes[0]).index != -1) && (!((p)->moveState & 0x00000080)) && ((p->timerInvulnerability == 0) && (p->timerInvincibility == 0))
        && (((sprBody->hitboxes[0]).index != -1))) {
        if ((((((sx) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + sprBody->hitboxes[0].b.left) && ((((sx)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + sprBody->hitboxes[0].b.left)) || (((sx) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + sprBody->hitboxes[0].b.left) && ((((((int)((p->qWorldX) >> 8)))) + (sprBody->hitboxes[0].b).left) + ((sprBody->hitboxes[0].b).right - (sprBody->hitboxes[0].b).left)) >= ((sx) + s->hitboxes[0].b.left))) && (((((sy)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[0].b.top) && ((((sy)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[0].b.top)) || ((((sy)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[0].b.top) && ((((((int)((p->qWorldY) >> 8)))) + sprBody->hitboxes[0].b.top) + ((sprBody->hitboxes[0].b).bottom - (sprBody->hitboxes[0].b).top)) >= (((sy)) + s->hitboxes[0].b.top))))) {
            return 2;
        }
    }
...
u32 sub_800C394(Sprite *s, s16 sx, s16 sy, Player *p)
{
    ...
    if ((((p->moveState & (0x00000002 | 0x00000004)) == (0x00000002 | 0x00000004)) && (p->qSpeedAirY > 0)
         && (((((sx) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + (*(Rect8 *)rectPlayer).left) && ((((sx)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + (*(Rect8 *)rectPlayer).left)) || (((sx) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + (*(Rect8 *)rectPlayer).left) && ((((((int)((p->qWorldX) >> 8)))) + ((*(Rect8 *)rectPlayer)).left) + (((*(Rect8 *)rectPlayer)).right - ((*(Rect8 *)rectPlayer)).left)) >= ((sx) + s->hitboxes[0].b.left))) && (((((sy)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)rectPlayer).top) && ((((sy)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)rectPlayer).top)) || ((((sy)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)rectPlayer).top) && ((((((int)((p->qWorldY) >> 8)))) + (*(Rect8 *)rectPlayer).top) + (((*(Rect8 *)rectPlayer)).bottom - ((*(Rect8 *)rectPlayer)).top)) >= (((sy)) + s->hitboxes[0].b.top)))))
        || (p->spriteInfoBody->s.hitboxes[1].index != -1
            && (((((sx) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + p->spriteInfoBody->s.hitboxes[1].b.left) && ((((sx)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + p->spriteInfoBody->s.hitboxes[1].b.left)) || (((sx) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + p->spriteInfoBody->s.hitboxes[1].b.left) && ((((((int)((p->qWorldX) >> 8)))) + (p->spriteInfoBody->s.hitboxes[1].b).left) + ((p->spriteInfoBody->s.hitboxes[1].b).right - (p->spriteInfoBody->s.hitboxes[1].b).left)) >= ((sx) + s->hitboxes[0].b.left))) && (((((sy)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + p->spriteInfoBody->s.hitboxes[1].b.top) && ((((sy)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + p->spriteInfoBody->s.hitboxes[1].b.top)) || ((((sy)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + p->spriteInfoBody->s.hitboxes[1].b.top) && ((((((int)((p->qWorldY) >> 8)))) + p->spriteInfoBody->s.hitboxes[1].b.top) + ((p->spriteInfoBody->s.hitboxes[1].b).bottom - (p->spriteInfoBody->s.hitboxes[1].b).top)) >= (((sy)) + s->hitboxes[0].b.top))))
            && !(p->moveState & ((0x00000002 | 0x00000004))))) {
        if (p->qSpeedAirY > 0) {
            p->qSpeedAirY = -p->qSpeedAirY;
        }
        return 1;
...
bool32 Coll_DamagePlayer(Player *p)
{
    ...
    p->timerInvulnerability = (int)(((0 * 60.) + 2) * 60);


    if ((p->qSpeedAirX < 0) || (p->qSpeedAirX == 0 && (p->moveState & 0x00000001))) {
    ...
    if (p->moveState & 0x01000000) {
        ...
        p->layer ^= 0x01;
        if (sa2__sub_8022F58(p->rotation + ((s32)((0.5)*256)), p) < 4) {
            p->layer ^= 0x01;
        } else
...

    {
        if (!((p)->itemEffect & (0x08 | 0x01))) {
            if (gRingCount > 0) {
                ...
                InitScatteringRings(((int)((p->qWorldX) >> 8)), ((int)((p->qWorldY) >> 8)), rings);
...
bool32 Coll_DamageSuperSonic(Player *p)
{
    ...
    p->qSpeedAirX = -((s32)((3)*256));
    p->qSpeedGround = -((s32)((3)*256));
