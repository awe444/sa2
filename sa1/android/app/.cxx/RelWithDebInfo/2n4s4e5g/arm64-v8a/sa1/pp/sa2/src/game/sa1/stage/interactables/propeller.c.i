# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/propeller.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/propeller.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/propeller.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/malloc_vram.h" 1
# 24 "/home/awaszczak/git/sa2/sa1/../include/malloc_vram.h"
void *VramMalloc(u32);
void VramResetHeapState(void);
void VramFree(void *);
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/propeller.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/entity.h" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/propeller.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/propeller.c" 2
...
void CreateEntity_Propeller(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    Propeller *propeller = (void *)((t)->data);
    ...
    s->graphics.dest = VramMalloc(((144 / 8) * (24 / 8)));
    s->oamFlags = ((18) << 6);
    s->graphics.size = 0;
    s->graphics.anim = 515;
    s->variant = 0;
...
void Task_PropellerMain(void)
{
    Propeller *propeller = (void *)((gCurTask)->data);
    Sprite *s = &propeller->s;
    MapEntity *me = propeller->base.me;

    s16 screenX, screenY;
    screenX = ((propeller->base.meX)*8 + (propeller->base.regionX)*256);
    screenY = ((me->y)*8 + (propeller->base.regionY)*256);

    s->x = screenX - gCamera.x;
    s->y = screenY - gCamera.y;

    if ((((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
        { me->x = propeller->base.meX; };
