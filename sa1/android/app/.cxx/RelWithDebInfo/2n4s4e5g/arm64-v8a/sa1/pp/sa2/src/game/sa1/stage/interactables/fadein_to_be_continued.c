# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/fadein_to_be_continued.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/fadein_to_be_continued.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/fadein_to_be_continued.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/fadein_to_be_continued.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/fadein_to_be_continued.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/fadein_to_be_continued.c" 2
...
void Task_ToBeContinuedText(void)
{
    TextTBC *tbc = (void *)((gCurTask)->data);
    MapEntity *me = tbc->me;

    s16 worldX = ((tbc->meX)*8 + (tbc->regionX)*256);
    s16 worldY = ((me->y)*8 + (tbc->regionY)*256);
    s32 playerX = ((int)((gPlayer.qWorldX) >> 8));

    if (playerX > worldX) {
        gStageFlags |= 0x0001;
        gBldRegs.bldCnt = ((3 << 6) | ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3) | (1 << 4) | (1 << 5)));
        gBldRegs.bldY = 0;
    ...
    } else if (((worldX) > gCamera.x + (320 + (256 / 2)) || (worldX) < gCamera.x - (256 / 2) || (worldY) > gCamera.y + ((240) + ((256) / 2)) || (worldY) < gCamera.y - (256 / 2))) {
        { me->x = tbc->meX; };
...
{
    TextTBC *tbc = (void *)((gCurTask)->data);
    tbc->blend += ((s32)((0.25)*256));
    gBldRegs.bldY = ((int)((tbc->blend) >> 8));

    if (tbc->blend >= ((s32)((16)*256))) {
        gBldRegs.bldY = 16;
...
{
    struct Task *t = TaskCreate(Task_ToBeContinuedText, sizeof(TextTBC), 0x2000, 0, ((void*)0));
    TextTBC *tbc = (void *)((t)->data);
