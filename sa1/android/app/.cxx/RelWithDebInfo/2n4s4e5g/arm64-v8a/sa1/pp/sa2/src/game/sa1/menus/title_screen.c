# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/ui/character_select.h" 1
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/menus/options_screen.h" 1
...
# 7 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/menus/options_screen.h" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/menus/options_screen.h" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/text.h" 1
# 10 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/menus/options_screen.h" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/demo_manager.h" 1
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2
...
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2
...
# 19 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/menus/time_attack.h" 1



void CreateTimeAttackMenu(void);
# 20 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2
...
# 21 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2
...
# 22 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/data/sa1/recordings.h" 1
...
# 24 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2


# 1 "/home/awaszczak/git/sa2/sa1/../include/../chao_garden/include/program_params.h" 1
# 27 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/assets/compressed/roms.h" 1
...
# 28 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2
...
# 30 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 31 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 33 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/tilemaps.h" 1
# 34 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c" 2
...
const __attribute__((aligned(4))) AnimId gUnknown_080BB310[2] = { 778, 779 };
...
const VoidFn sMainMenuSecondaryItems[5 - 1]
...
void CreateSegaLogo(void)
{
    ...
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, VRAM, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((64)/(32/8)))); };
    ...
    t = TaskCreate(Task_SetSegaLogoTask, sizeof(SegaLogo), 0x2000, 0, ((void*)0));

    logo = (void *)((t)->data);
    logo->unk0 = 0;

    bg = &logo->bg;
    bg->graphics.dest = (void *)(((u8*)&VRAM[0]) + (0x4000 * (0)));
    bg->graphics.anim = 0;
    bg->layoutVram = (void *)(((u8*)&VRAM[0]) + (0x800 * (30)));
    bg->unk18 = 0;
    bg->unk1A = 0;
    bg->tilemapId = 86;
    bg->unk1E = 0;
...
void Task_SegaLogoInit(void)
{
    ...
    logo = (void *)((gCurTask)->data);
    gDispCnt |= 0x0400;
    logo->unk0++;
    sa2__sub_8007858(2U, 0U, (160 - logo->unk0), gBgScrollRegs[2][0], (gBgScrollRegs[2][1] + 160) - logo->unk0);
    sa2__sub_80078D4(2U, (160 - logo->unk0), 160, (u16)gBgScrollRegs[2][0], gBgScrollRegs[2][1]);
...
void Task_800D11C(void)
{
    ...
    logo = (void *)((gCurTask)->data);
    logo->unk0++;
    sa2__sub_80078D4(2U, 0U, (160 - logo->unk0), gBgScrollRegs[2][0], gBgScrollRegs[2][1]);
    sa2__sub_8007858
...
void CreateSonicTeamLogo(void)
{
    ...
    t = TaskCreate(Task_SonicTeamLogoInit, sizeof(SonicTeamLogo), 0x2000, 0, ((void*)0));
...
void Task_800D268(void)
{
    ...
    logo->unk0 += 2;
    if (logo->unk0 < 280) {
        sa2__sub_80078D4(2, 0, 40, gBgScrollRegs[2][0], gBgScrollRegs[2][1]);
        sa2__sub_80078D4(2, 120, 160, gBgScrollRegs[2][0], gBgScrollRegs[2][1]);
# 245 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/menus/title_screen.c"
    } else {
        m4aSongNumStart(102);
        gFlags &= ~0x4;
...
{
    SonicTeamLogo *logo = (void *)((gCurTask)->data);
    ...
    logo->qFade += ((s32)((0.5)*256));

    if (logo->qFade > ((s32)((16)*256))) {
        gBldRegs.bldY = ((s32)((16)*256));
        sub_800D498();
        return;
    }
    gBldRegs.bldY = ((int)((logo->qFade) >> 8));
}
...
{
    SegaLogo *logo = (void *)((gCurTask)->data);
...
void CreateTitleScreen(u32 playMusic)
{
    ...
    Sprite *s;
    Background *bg;
    AnimId animsPressStart[2] = { 778, 779 };

    gDispCnt = 0x41;
    gBgCntRegs[2] = 0x568C | (1);
    gBgCntRegs[0] = 0x1480 | (2);
    gBgScrollRegs[0][0] = 0;
    gBgScrollRegs[0][1] = 0;
    gBgScrollRegs[1][0] = 0;
    gBgScrollRegs[1][1] = 0;
    ...
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, &VRAM[0], (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((64)/(32/8)))); };
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, &VRAM[0] + 0xFFC0, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((0x80)/(32/8)))); };

    t = TaskCreate(Task_LoadGameLogo, sizeof(TitleScreen), 0x2000U, 0U, TaskDestructor_TitleScreen);
    title = (void *)((t)->data);
    s = &title->s;
    title->unkE2 = 0;
    title->qBlend = ((s32)((16)*256));
    title->playMusic = playMusic;
    gBldRegs.bldCnt = 0x20A5;
    gBldRegs.bldY = ((int)((title->qBlend) >> 8));
    s->x = 120;
    s->y = 113;
    s->graphics.dest = VramMalloc(((184 / 8) * (16 / 8)));

    s->graphics.size = 0;
    s->graphics.anim = animsPressStart[(&gLoadedSaveGame)->uiLanguage];
    s->variant = 0;
    s->animCursor = 0;
    s->prevVariant = -1;
    ...
    s->x = 0;
    s->y = 134;
    s->graphics.dest = VramMalloc(((24 / 8) * (240 / 8)));
    s->graphics.size = 0;
    s->graphics.anim = 780;
    s->variant = 1;
    s->animCursor = 0;
    ...
    bg->graphics.dest = (void *)(((u8*)&VRAM[0]) + (0x4000 * (0)));
    bg->graphics.anim = 0;
    bg->layoutVram = (void *)(((u8*)&VRAM[0]) + (0x800 * (20)));
    bg->unk18 = 0;
    bg->unk1A = 0;
    bg->tilemapId = 75;
    bg->unk1E = 0;
...
void Task_LoadGameLogo(void)
{
    ...
    gDispCnt |= 0x0100 | 0x1000;
    title = (void *)((gCurTask)->data);

    if (title->qBlend == ((s32)((16)*256))) {
        bg = &title->bg2;
        ...
        bg->unk18 = 0;
        bg->unk1A = 0;
        bg->tilemapId = (73 + (&gLoadedSaveGame)->uiLanguage);
        bg->unk1E = 0;
        bg->unk20 = 0;
        bg->unk22 = 0;
        bg->unk24 = 0;
...
{
    TitleScreen *title = (void *)((gCurTask)->data);
    ...
    sa2__sub_8003EE4(0, title->unkE4, title->unkE4, 0x8D, 0x1A, 0xC0, 30, gBgAffineRegs);
}
...
void CreateMainMenu(u32 param0)
{
    ...
    t = TaskCreate(Task_MainMenuInit, sizeof(MainMenu), 0x2000, 0, ((void*)0));
    menu = (void *)((t)->data);
    s = &menu->s;
    menu->unk1AC = 0;
    menu->unk1AF = param0;
    ...
    s->x = (320 / 2);
    s->y = (240 / 2);
    s->graphics.dest = (void *)&VRAM[0] + 0x40;
    s->graphics.size = 0;
    s->graphics.anim = 1;
    s->variant = 0;
    s->animCursor = 0;
    ...
    if (menu->unk1AF != 0) {
        ...
        { u32 tmp = (u32)(0); DmaSet(3, &tmp, (&VRAM[0] + ((gBgCntRegs[0] & ((0x3) << 2)) << 12)), (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((0x40)/(32/8)))); };
        { u32 tmp = (u32)(0); DmaSet(3, &tmp, (&VRAM[0] + ((gBgCntRegs[2] & ((0x3) << 2)) << 12)) + 0x3FC0, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((0x80)/(32/8)))); };
    }
...
void Task_MainMenuInit(void)
{
    ...
    MainMenu *menu = (void *)((gCurTask)->data);
    Sprite *s = &menu->s;
    StrcUi_805423C *strc = &menu->unk1A0;

    someBool = 1;
    if (menu->unk1AF != 0) {
        someBool = sub_805423C(strc) ? 1 : 0;
    }
    ...
    if (someBool) {
        if (s->graphics.size == 0) {
            s->x = 0;
            s->y = 0;
            s->graphics.dest = (void *)(((u8*)&VRAM[0]) + (0x4000 * (4)));
            s->oamFlags = 0x3C0;
            s->graphics.size = 0;
            s->graphics.anim = 699;
            s->variant = 0;
        ...
        for (i = 0; (i < (sizeof(gKeysFirstRepeatIntervals) / sizeof((gKeysFirstRepeatIntervals)[0]))); i++) {
...
void Task_800DE44(void)
{
    ...
    if (menu->unk1B0 >= ((s32)((16)*256))) {
        menu->unk1B0 = ((s32)((16)*256));
    ...
    gBldRegs.bldY = ((int)((menu->unk1B0) >> 8));
...
void LoadTinyChaoGarden(void)
{
    ...
    ((u32 *)(EWRAM_START + 0x8))[0] = (&gLoadedSaveGame)->score;
    ((u32 *)(EWRAM_START + 0x8))[1] = (&gLoadedSaveGame)->language;

    ((u32 *)(EWRAM_START + 0x8))[2] = gFrameCount + (&gLoadedSaveGame)->checksum;
