# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/vs_record.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/vs_record.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/vs_record.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/vs_record.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/vs_record.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/vs_record.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/vs_record.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/vs_record.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/vs_record.c" 2
...
void SwapRecords(VsRecord_10 *a, VsRecord_10 *b)
{
    ...
    temp.unkD = a->unkD;
    temp.unkE = a->unkE;
    for (i = 0; i < (sizeof(temp.unk4) / sizeof((temp.unk4)[0])); i++) {
    ...
    a->unkD = b->unkD;
    a->unkE = b->unkE;
    for (i = 0; i < (sizeof(a->unk4) / sizeof((a->unk4)[0])); i++) {
        a->unk4[i] = b->unk4[i];
    }
    ...
    b->unkD = temp.unkD;
    b->unkE = temp.unkE;
    for (i = 0; i < (sizeof(b->unk4) / sizeof((b->unk4)[0])); i++) {
...
void CreateVsRecord()
{
    ...
    record48 = (void *)((TaskCreate(Task_VsRecordInit, sizeof(VsRecord_48), 0x2000U, 0U, TaskDestructor_VsRecord))->data);
    record48->unk40 = 0;
    record48->unk44 = 0;
    ...
    t = TaskCreate(Task_8060874, sizeof(VsRecord_F0), 0x2030U, 0U, ((void*)0));
    recordF0 = (void *)((t)->data);
    recordF0->unkEC = 0;
    ...
    DmaSet(3, (&gLoadedSaveGame)->multiplayerScores, recordF0, (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0xA0)/(16/8))));
...
void Task_VsRecordInit()
{
    ...
    VsRecord_48 *record48 = (void *)((gCurTask)->data);
    VsRecord_F0 *recordF0 = (void *)((record48->task3C)->data);

    var_r5 = record48->unk44;
    unk40 = record48->unk40;
    unk40++;
    if ((var_r5 != 0) && (0x0040 & gInput)) {
        var_r1 = var_r5 - ((s32)((1)*256));
        var_r0 = ((int)((var_r1) >> 8));
        var_r5 = 0;
        if (var_r0 != 0) {
            var_r5 = var_r1;
        }
    } else if (((u32)var_r5 < 0x4200) && (0x0080 & gInput)) {
        var_r1 = var_r5 + ((s32)((1)*256));
        var_r0 = ((int)((var_r1) >> 8));
        var_r5 = 0x4200;
        if (var_r0 < 0x4200) {
    ...
    if (record48->strc.unk6 > 0x1800) {
        if ((0x0002 & gPressedKeys) && (record48->strc.unk4 != 1)) {
...
void Task_8060874()
{
    ...
    VsRecord_F0 *recordF0 = (void *)((gCurTask)->data);
    ...
    if (save->unk425 > 9U) {
        subroutine_arg0[0] = (({((10) != 0) ? ((s32)(save->unk425) / (s32)(10)) : 0;}) + 48);
        subroutine_arg0[1] = (({((10) != 0) ? ((s32)(save->unk425) % (s32)(10)) : 0;}) + 48);
        if (save->uiLanguage != 0) {
    ...
    if (save->unk426 > 9U) {
        recordF0->unkA0.unkE = 2;
        subroutine_arg0[0] = ({((0xA) != 0) ? ((s32)(save->unk426) / (s32)(0xA)) : 0;}) + 48;
        subroutine_arg0[1] = ({((0xA) != 0) ? ((s32)(save->unk426) % (s32)(0xA)) : 0;}) + 48;
        if (save->uiLanguage != 0) {
    ...
    if (save->unk427 > 9U) {
        recordF0->unkA0.unkE = 2;
        subroutine_arg0[0] = (({((10) != 0) ? ((s32)(save->unk427) / (s32)(10)) : 0;}) + 48);
        subroutine_arg0[1] = (({((10) != 0) ? ((s32)(save->unk427) % (s32)(10)) : 0;}) + 48);
    ...
    for (var_r5 = 0; var_r5 < 9; var_r5++) {
        ...
        if (temp_r0_5 == 0xFF) {
            ...
            if (recordF0->records[v].unkC > 9U) {
                subroutine_arg0[0] = ({((10) != 0) ? ((s32)((u8)recordF0->records[v].unkC) / (s32)(10)) : 0;}) + 48;
                subroutine_arg0[1] = ({((10) != 0) ? ((s32)((u8)recordF0->records[v].unkC) % (s32)(10)) : 0;}) + 48;
            } else {
                subroutine_arg0[0] = 32;
                subroutine_arg0[1] = (u8)recordF0->records[v].unkC + 48;
            }
        }
        recordF0->unkA0.qUnkA = ((s32)((0.5)*256));
        recordF0->unkA0.unkE = 2;
        sub_805345C(subroutine_arg0, &recordF0->unkA0);

        if (recordF0->records[v].unkD > 9U) {
            subroutine_arg0[0] = ({((10) != 0) ? ((s32)(recordF0->records[v].unkD) / (s32)(10)) : 0;}) + 48;
            subroutine_arg0[1] = ({((10) != 0) ? ((s32)(recordF0->records[v].unkD) % (s32)(10)) : 0;}) + 48;
        } else {
            subroutine_arg0[0] = 0x20;
            subroutine_arg0[1] = recordF0->records[v].unkD + 48;
        }
        recordF0->unkA0.qUnkA = ((s32)((160. / 256.)*256));
        sub_805345C(subroutine_arg0, &recordF0->unkA0);

        if (recordF0->records[v].unkE > 9U) {
            subroutine_arg0[0] = ({((10) != 0) ? ((s32)(recordF0->records[v].unkE) / (s32)(10)) : 0;}) + 48;
            subroutine_arg0[1] = ({((10) != 0) ? ((s32)(recordF0->records[v].unkE) % (s32)(10)) : 0;}) + 48;
        } else {
            subroutine_arg0[0] = 0x20;
