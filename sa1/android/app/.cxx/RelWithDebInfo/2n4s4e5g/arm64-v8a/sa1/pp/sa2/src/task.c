# 1 "/home/awaszczak/git/sa2/sa1/../src/task.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/task.c" 2




# 1 "/home/awaszczak/Android/Sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/assert.h" 1 3 4
# 43 "/home/awaszczak/Android/Sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/assert.h" 3 4
...
# 44 "/home/awaszczak/Android/Sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/assert.h" 2 3 4
# 78 "/home/awaszczak/Android/Sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/assert.h" 3 4
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/task.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/task.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/task.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/task.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/task.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 14 "/home/awaszczak/git/sa2/sa1/../src/task.c" 2
...
u32 TasksInit(void)
{
    ...
    gNextTask = ((void*)0);
    gNumTasks = 0;
# 37 "/home/awaszczak/git/sa2/sa1/../src/task.c"
    { u32 tmp = (u32)(0); DmaSet(3, &tmp, gTasks, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((sizeof(gTasks))/(32/8)))); };
    ...
    cur->priority = 0;
    cur->flags = 0;
    cur->parent = (TaskPtr32)((void*)0);
    cur->prev = (TaskPtr32)((void*)0);
    cur->next = (TaskPtr32)TaskGetNextSlot();




    if ((((void *)(cur->next)) == ((void*)0))) {
        return 0;
    }

    ((struct Task *)(cur->next))->prev = (TaskPtr32)cur;
    cur = (struct Task *)(cur->next);
...
# 93 "/home/awaszczak/git/sa2/sa1/../src/task.c"
struct Task *TaskCreate(TaskMain taskMain, u16 structSize, u16 priority, u16 flags, TaskDestructor taskDestructor)

{
    ...
    task->dataSize = (task->data != (TaskPtr32)((void*)0)) ? structSize : 0;
    ...
    slow = gTaskPtrs[0];
    fast = slow->next;
    while (!(((void *)(fast)) == ((void*)0))) {
        if (((struct Task *)(fast))->priority > priority) {
            ((struct Task *)(fast))->prev = (TaskPtr32)task;
            task->next = slow->next;
            task->prev = (TaskPtr32)slow;
            slow->next = (TaskPtr32)task;
            break;
        }
        slow = (struct Task *)(fast);
        fast = ((struct Task *)(fast))->next;
    }
    return task;
}
...
void TaskDestroy(struct Task *task)
{
    ...
    if (!(task->flags & 0x0002)) {
        ...
        if (!(((struct Task *)prev) == ((void*)0))) {
            if (!(((struct Task *)next) == ((void*)0))) {
                if (task->dtor != ((void*)0)) {
                    task->dtor(task);
                }

                if (task == gNextTask) {
                    gNextTask = (struct Task *)((task)->next);
                }
# 181 "/home/awaszczak/git/sa2/sa1/../src/task.c"
                prev = (task->prev);
                next = (task->next);
                ((struct Task *)prev)->next = next;
                ((struct Task *)next)->prev = prev;

                if (task->data != (IwramData)((void*)0)) {


                    memset((void *)((task)->data), 0, task->dataSize);

                    IwramFree((void *)((task)->data));
                }

                gTaskPtrs[--gNumTasks] = task;
                task->parent = (TaskPtr)((void*)0);
                task->prev = (TaskPtr)((void*)0);
                task->main = TaskMainDummy3;
                task->priority = 0;
                task->flags = 0;
                task->data = (IwramData)((void*)0);
...
void TasksExec(void)
{
    ...
    if (!(gFlags & 0x800) && !((gTaskPtrs[0]) == ((void*)0))) {
        while (!((gCurTask) == ((void*)0))) {
            gNextTask = (struct Task *)(gCurTask->next);

            if (!(gCurTask->flags & 0x0001)) {
                gCurTask->main();
            }
    ...
    } else if (!((gTaskPtrs[0]) == ((void*)0))) {
        while (!((gCurTask) == ((void*)0))) {
            gNextTask = (struct Task *)(gCurTask->next);

            if ((gCurTask->flags & 0x0004) && !(gCurTask->flags & 0x0001)) {
                gCurTask->main();
            }
...
void *IwramMalloc(u16 req)
{
    ...
    ((result != ((void*)0)) ? ((void) (0)) : __assert2("/home/awaszczak/git/sa2/sa1/../src/task.c", 258, __PRETTY_FUNCTION__, "result != NULL"));
    return result;
# 303 "/home/awaszczak/git/sa2/sa1/../src/task.c"
}
...
# 350 "/home/awaszczak/git/sa2/sa1/../src/task.c"
}


static void __attribute__((unused)) sa2__sub_80028DC(void)
{
    ...
    while (!(((struct Task *)(cur->next)) == ((void*)0))) {
        if (cur->state >= 0) {
            cur->next += 0;
            nextNodeOffset = cur->next;
            if (((struct IwramNode *)(cur->next))->state >= 0) {
                cur->state += ((struct IwramNode *)(cur->next))->state;
                cur->next = ((struct IwramNode *)(cur->next))->next;
            } else {
                nextNodeSpace = (void *)(cur->next + (__builtin_offsetof(struct IwramNode, space)));
                ...
                cur->next = ((struct IwramNode *)(nextNodeOffset))->next;
                for (i = 0; i < 128; i++) {
                ...
                DmaSet(3, nextNodeSpace, space, (u32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((cur->state + sizeof(struct IwramNode))/(32/8))));
                {
                    struct IwramNode *newLoc = (struct IwramNode *)((u8 *)cur + cur->state);
                    newLoc->next = cur->next;
                    newLoc->state = curStateBackup;
                    cur = newLoc;
                    cur->next = (IwramNodePtr32)cur;
                }
            }
        } else {
            cur = (struct IwramNode *)(cur->next);
        }
    }
}
...
void TasksDestroyInPriorityRange(u16 lbound, u16 rbound)
{
    ...
    while (curOffset != 0) {
        ...
        curOffset = cur->next;
        cur = (struct Task *)(curOffset);
    }
}
# 499 "/home/awaszczak/git/sa2/sa1/../src/task.c"
static void TaskMainDummy1(void) { }
