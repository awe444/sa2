# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/breakable_wall.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/breakable_wall.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/breakable_wall.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/breakable_wall.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/breakable_wall.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/breakable_wall.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/breakable_wall.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/breakable_wall.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/breakable_wall.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/breakable_wall.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/breakable_wall.c" 2
...
extern u16 gUnknown_080BB544[18];
...
void CreateEntity_BreakableWall(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    s->graphics.dest = VramMalloc(((32 / 8) * (64 / 8)));
...
void Task_BreakableWall(void)
{
    ...
    Sprite *s;
    s32 i;
# 88 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/breakable_wall.c"
    Wall *wall;
    wall = (void *)((gCurTask)->data);
    s = &wall->s;

    me = wall->base.me;

    worldX = ((wall->base.meX)*8 + (wall->base.regionX)*256);
    worldY = ((me->y)*8 + (wall->base.regionY)*256);
    ...
    do {
        if ((!(((gGameMode == 0) || (gGameMode == 1)))) && ((s8)me->x == (-3))) {
            ...
            m4aSongNumStart(173);
        } else if (Coll_Player_Gate(s, worldX, worldY, &(*(((i) != 0) ? &gPartner : &gPlayer)), 1) & 0x00000008) {
            m4aSongNumStart(173);
            gCurTask->main = Task_BreakableWall2;

            wall->qUnk3C = 0;

            if ((wall->qUnk3E = (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX >> 1) == 0) {
                s16 qVal;
...
# 140 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/breakable_wall.c"
...
void Task_BreakableWall2(void)
{
    ...
    if (((worldX) > gCamera.x + ((320) + (256 / 2)) || (worldX) < gCamera.x - (256 / 2))
        && (((u16)(s->x + (256 / 2)) > 320 + 256))) {
        { me->x = wall->base.meX; };
        TaskDestroy(gCurTask);
        return;
    }

    oamData = gRefSpriteTables->oamData[((s)->graphics.anim)];
    ...
    for (i = 0; i < 8; i++) {
        for (j = 0; j < 4; j++) {
            ...
            temp = (wall->qUnk3C - r1 * 10) - ((8 - 1) - i) * 2;

            if (temp > 0) {
                r5 = ((int)((temp * ((temp * 42) - ((s32)((2)*256)))) >> 8));
                temp2 = ((int)((temp * wall->qUnk3E) >> 8));
            ...
            oamDataAlloc = (u16 *)OamMalloc(((((s)->oamFlags) & 0x7C0) >> 6));
            ...
            oamDataAlloc[2] = ((oamDataEntry[2] + s->palId) & ~0xFFF) | ((s->frameFlags & ((3) << (12))) >> 2)
                | ((((uintptr_t)((s->graphics.dest)) - (uintptr_t)&VRAM[0x10000]) / (32)) + r8);
        }
    }
}
