# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/forced_slide.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/forced_slide.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/forced_slide.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/forced_slide.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/forced_slide.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/forced_slide.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/forced_slide.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/forced_slide.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/forced_slide.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/forced_slide.c" 2
...
const AnimId __attribute__((aligned(4))) gAnimSlideSplashes[18] = {
    [((0)*(2)) + (0)] = 474,
    [((0)*(2)) + (1)] = 474,
    [((1)*(2)) + (0)] = 474,
    [((1)*(2)) + (1)] = 474,
...
void Task_ForcedSlide(void)
{
    ...
    sp14 = ((1 << 1) | (1 << 0));
    slide = (void *)((gCurTask)->data);
    s = &slide->s;
    me = slide->base.me;


    x = ((slide->base.meX)*8 + (slide->base.regionX)*256);
    y = ((me->y)*8 + (slide->base.regionY)*256);

    i = 0;
    do {
        if (i != 0) {
            if (gPartner.moveState & 0x00000080)
                continue;
        } else {
        ...
        if ((x <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (x + me->d.uData[2] * 8 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))) && (y <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)))
            ...
            if (slide->unk3D[i] == 0) {
                ...
                res = sa2__sub_801F07C(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)), ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)), (*(((i) != 0) ? &gPartner : &gPlayer)).layer, +8, 0, sa2__sub_801EE64);
            ...
            if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000008)) {
                if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000002)) {
                    if (slide->unk3D[i] == 0 && ((gCurrentLevel) >> 1) == 4) {
                        m4aSongNumStart(201);
                    }
                    ...
                    if (slide->unk3C != 0) {
                        ...
                        (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = -((s32)((4)*256));
                    ...
                    (*(((i) != 0) ? &gPartner : &gPlayer)).charState = 15;
                    ...
                    s->y = ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) - gCamera.y;
