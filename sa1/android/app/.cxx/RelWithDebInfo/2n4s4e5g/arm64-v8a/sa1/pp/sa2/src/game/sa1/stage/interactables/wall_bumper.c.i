# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/wall_bumper.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/wall_bumper.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/wall_bumper.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/wall_bumper.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/wall_bumper.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/wall_bumper.c" 2



# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/wall_bumper.c" 2
...
{
    WallBumper *bumper = (void *)((gCurTask)->data);
    ...
    i = 0;
    do {
        if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080) && worldX <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8))
            && worldX + me->d.uData[2] * 8 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) && worldY <= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8))
            && worldY + me->d.uData[3] * 8 >= ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8))) {
            m4aSongNumStart(184);
            ...
            if (bumper->unk3C & 0x1) {
                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = +((s32)((5)*256));
            } else {
                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirX = -((s32)((5)*256));
            }
            ...
            if (bumper->unk3C < 3) {
                (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY = -((s32)((7)*256));
            } else {
            ...
            if (((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_TAILS) || ((*(((i) != 0) ? &gPartner : &gPlayer)).character == CHARACTER_KNUCKLES)) {
                ...
                if ((*(((i) != 0) ? &gPartner : &gPlayer)).sa2__unk61) {
...
{
    struct Task *t = TaskCreate(Task_WallBumper, sizeof(WallBumper), 0x2000, 0, ((void*)0));
    WallBumper *bumper = (void *)((t)->data);
