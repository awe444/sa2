# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_over.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_over.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_over.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_over.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_over.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/sa1/ui/time_over.h" 1



void CreateTimeOver();
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_over.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_over.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_over.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_over.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/time_over.c" 2
...
void CreateTimeOver()
{
    ...
    TimeOverState *state = (void *)((t)->data);
    ...
    s = &state->s;
    s->graphics.dest = VramMalloc(((56 / 8) * (16 / 8)));
    s->graphics.size = 0;
    s->frameFlags = 0;
    s->x = 320 + 60;
    s->y = 60;
...
{
    TimeOverTimer *overTimer = (void *)((gCurTask)->data);
    TimeOverState *state = (void *)((overTimer->t)->data);

    state->timer = overTimer->timer;
    if (overTimer->timer > (int)(((0 * 60.) + 3.5) * 60)) {
    ...
    if (++overTimer->timer > (int)(((0 * 60.) + 5.5) * 60)) {
...
void Task_TimeOverStateUpdate()
{
    ...
    TimeOverState *state = (void *)((gCurTask)->data);

    timer = state->timer;
    if (timer > (int)(((0 * 60.) + 2.0) * 60)) {
        state->s2.x = state->s.x = (320 / 2);
    } else if (timer > (int)(((0 * 60.) + 0.5) * 60)) {
        state->s2.x = state->s.x = (320 + 60) - ((timer - (int)(((0 * 60.) + 0.5) * 60)) * 2);
    }
