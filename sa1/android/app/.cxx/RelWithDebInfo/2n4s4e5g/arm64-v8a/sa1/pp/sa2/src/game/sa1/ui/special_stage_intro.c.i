# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/special_stage_intro.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/special_stage_intro.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/special_stage_intro.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/special_stage_intro.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/special_stage_intro.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/special_stage_intro.c" 2
...
# 6 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/special_stage_intro.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/special_stage_intro.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/special_stage_intro.c" 2
...
# 9 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/special_stage_intro.c" 2
...
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/special_stage_intro.c" 2
...
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/special_stage_intro.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/ui_graphics.h" 1
# 13 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/special_stage_intro.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/zones.h" 1
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/ui/special_stage_intro.c" 2
...
extern u8 gUnknown_08487134[18];
...
void CreateSpecialStageIntro(void)
{
    ...
    task10 = TaskCreate(Task_SpecialStageIntroInit, sizeof(SpecialStageIntroC4), 0x2120U, 0U, ((void*)0));
    temp_r2 = (void *)((task10)->data);
    s = &temp_r2->s;
    ...
    temp_r2->unk30 = 0;
    temp_r2->qUnk3C = -((s32)((1)*256));
    temp_r2->qUnk40 = +((s32)((120)*256));
    temp_r2->qUnk34 = -((s32)((3.8125)*256));
    temp_r2->qUnk38 = +((s32)((180)*256));

    taskC = TaskCreate(Task_8068BB0, sizeof(SpecialStageIntroC4), 0x2120U, 0U, ((void*)0));
    temp_r2 = (void *)((taskC)->data);
    s = &temp_r2->s;
    ...
    for (var_r5 = 0; var_r5 < 16; var_r5++) {
        temp_r2->unk84[var_r5] = ({((40) != 0) ? ((s32)(({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; })) % (s32)(40)) : 0;}) - 20;
        temp_r2->unk44[var_r5] = ({((220) != 0) ? ((s32)(({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; })) % (s32)(220)) : 0;}) + 20;
    }

    s->graphics.dest = &VRAM[0x10000] + 0x820;
    s->graphics.anim = 776;
    s->variant = 0;
    s->x = 120;
    s->y = 80;
    ...
    temp_r0_6 = (void *)((TaskCreate(Task_8068948, sizeof(SpecialStageIntro20), 0x2100U, 0U, ((void*)0)))->data);
    temp_r0_6->unk18 = 0;
    temp_r0_6->unk1A = 1;
...
void Task_8068948()
{
    ...
    SpecialStageIntro20 *strc20 = (void *)((gCurTask)->data);

    temp_r7 = (void *)((strc20->task10)->data);
    ...
    if (temp_r5 > 90) {
        ...
        strc20->strc0.unkA = 1;
        t = TaskCreate(Task_8068CD4, sizeof(SpecialStageIntroC4), 0x2120U, 0U, ((void*)0));
        strc20->task14 = t;
        temp_r2 = (void *)((t)->data);
        s = &temp_r2->s;
        s->graphics.dest = &VRAM[0x10000] + 0xC80;
        ...
        if ((90 - ({((0x150) != 0) ? ((s32)(0x2000) / (s32)(0x150)) : 0;})) == temp_r5) {
            strc20->strc0.unk0 = 0;
            strc20->strc0.unk2 = 1;
            strc20->strc0.unk4 = 1;
            strc20->strc0.unk6 = 0;
...
void Task_8068A78()
{
    ...
    if (temp_r5 > 150) {
        ...
        if ((150 - ({((0x150) != 0) ? ((s32)(0x2000) / (s32)(0x150)) : 0;})) == temp_r5) {
            strc20->strc0.unk0 = 0;
            strc20->strc0.unk2 = 1;
            strc20->strc0.unk4 = 1;
            strc20->strc0.unk6 = 0;
...
void Task_8068B10()
{
    SpecialStageIntroC4 *strcC4 = (void *)((gCurTask)->data);
    Sprite *s = &strcC4->s;
    ...
    if (temp_r6 == 0) {
        ...
        s->prevVariant = -1;
        strcC4->qUnk34 += -((s32)((5)*256));
        strcC4->qUnk38 = ((s32)((180)*256));
        strcC4->qUnk40 = ((s32)((150)*256));
    }

    if (temp_r6 > 40) {
        strcC4->qUnk40 += strcC4->qUnk3C;
        strcC4->qUnk34 += ((s32)((0.25)*256));
        strcC4->qUnk38 += strcC4->qUnk34;
        strcC4->s.x = ((int)((strcC4->qUnk40) >> 8));
        strcC4->s.y = ((int)((strcC4->qUnk38) >> 8));
...
void Task_8068BB0(void)
{
    ...
    for (var_r8 = 0; var_r8 < 16; var_r8++) {
        if ((sp0 + var_r8) & 0xF) {
            ...
            strcC4->unk84[var_r8] = ({((0x28) != 0) ? ((s32)(({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; })) % (s32)(0x28)) : 0;}) - 0x14;
            strcC4->unk44[var_r8] = ({((0xDC) != 0) ? ((s32)(({ gPseudoRandom = (gPseudoRandom * 0x196225) + 0x3C6EF35F; gPseudoRandom; })) % (s32)(0xDC)) : 0;}) + 0x14;
        }
...
void Task_SpecialStageIntroInit(void)
{
    ...
    strcC4->qUnk38 -= ((s32)((3.8125)*256));
    s->x = ((int)((strcC4->qUnk40) >> 8));
    s->y = ((int)((strcC4->qUnk38) >> 8));
...
void Task_8068CD4(void)
{
    ...
    if ((({((30) != 0) ? ((s32)(++strcC4->unk30) / (s32)(30)) : 0;}) % 2u) == 0) {
        UpdateSpriteAnimation(s);
        DisplaySprite(s);
    }
}
...
void sub_8068D0C(void)
{
    ...
    gBgScrollRegs[0][0] = 0;
    gBgScrollRegs[0][1] = 0x128;
    t = TaskCreate(Task_nullsub_806954C, sizeof(SpecialStageIntro44), 0x2120U, 0U, ((void*)0));
    sp44 = t;
    temp_r2 = (void *)((t)->data);
    s = &temp_r2->s;
    s->graphics.dest = &VRAM[0x10000] + 0x20;
    ...
    temp_r2->unk30 = 0;
    temp_r2->qUnk3C = 0;
    temp_r2->qUnk40 = +((s32)((170)*256));
    temp_r2->qUnk34 = 0x4A0;
    temp_r2->qUnk38 = -((s32)((32)*256));

    t = TaskCreate(Task_strc44_806959C, sizeof(SpecialStageIntro44), 0x2120U, 0U, ((void*)0));
    sp48 = t;
    temp_r2 = (void *)((t)->data);
    s = &temp_r2->s;
    s->graphics.dest = &VRAM[0x10000] + 0x0820;
    ...
    temp_r2->unk30 = 0;
    temp_r2->qUnk3C = -((s32)((1)*256));
    temp_r2->qUnk40 = ((s32)((350)*256));
    temp_r2->qUnk34 = ((s32)((0)*256));
    temp_r2->qUnk38 = ((s32)((100)*256));

    t = TaskCreate(Task_strc44_806959C, sizeof(SpecialStageIntro44), 0x2120U, 0U, ((void*)0));
    sp4C = t;
    temp_r2 = (void *)((t)->data);
    s = &temp_r2->s;
    s->graphics.dest = &VRAM[0x10000] + 0x12A0;
    ...
    temp_r2->qUnk38 = ((s32)((100)*256));
    for (i = 0; i < 4; i++) {
        tasks[i] = TaskCreate(Task_8068360, sizeof(SpecialStageIntro64), 0x2120U, 0U, ((void*)0));
        temp_r1_2 = (void *)((tasks[i])->data);
        s = &temp_r1_2->s;
        temp_r1_2->qUnk3C = 0;
        if (i == 0) {
            temp_r1_2->unk44[4] = ((s32)((50)*256));
            temp_r1_2->unk44[0] = ((s32)((80)*256));
            temp_r1_2->unk44[1] = ((s32)((0.5)*256));
            temp_r1_2->unk44[5] = 0;
            s->graphics.dest = &VRAM[0x10000] + 0x6040;
            s->graphics.anim = 790;
            s->variant = 0;
        } else if (i == 1) {
            temp_r1_2->unk44[4] = ((s32)((100)*256));
            temp_r1_2->unk44[0] = ((s32)((40)*256));
            temp_r1_2->unk44[1] = ((s32)((0.25)*256));
            temp_r1_2->unk44[5] = 0U;
            s->graphics.dest = &VRAM[0x10000] + 0x6180;
            s->graphics.anim = 791;
            s->variant = 0;
        } else if (i == 2) {
            temp_r1_2->unk44[4] = ((s32)((120)*256));
            temp_r1_2->unk44[0] = ((s32)((120)*256));
            temp_r1_2->unk44[1] = ((s32)((1.0)*256));
            temp_r1_2->unk44[5] = 0U;
            s->graphics.dest = &VRAM[0x10000] + 0x6420;
            s->graphics.anim = 792;
            s->variant = 0;
        } else {
            temp_r1_2->unk44[4] = ((s32)((20)*256));
            temp_r1_2->unk44[0] = ((s32)((160)*256));
            temp_r1_2->unk44[1] = ((s32)((1.125)*256));
            temp_r1_2->unk44[5] = 0U;
            s->graphics.dest = &VRAM[0x10000] + 0x7080;
            s->graphics.anim = 793;
            s->variant = 0;
        }
        s->x = 180;
    ...
    temp_r1_4 = (void *)((TaskCreate(Task_80694E8, sizeof(SpecialStageIntro28), 0x2100U, 0U, ((void*)0)))->data);
...
void Task_8069100(void)
{
    ...
    SpecialStageIntro28 *strc28 = (void *)((gCurTask)->data);
    Sprite *s;

    temp_sl = (void *)((strc28->taskC)->data);
    sp4 = (void *)((strc28->task18)->data);
    sp8 = (void *)((strc28->task14)->data);
    temp_r0 = strc28->unk1C + 1;
    if (temp_r0 == 1) {
        strc44_0 = (void *)((TaskCreate(Task_8069634, sizeof(SpecialStageIntro44), 0x2120U, 0U, ((void*)0)))->data);
        s = &strc44_0->s;
        s->graphics.dest = &VRAM[0x10000] + 0x3820;
        ...
        UpdateSpriteAnimation(s);
        strc44_0->unk30 = 0;
        strc44_0->qUnk3C = -((s32)((1)*256));
        strc44_0->qUnk40 = temp_sl->qUnk40 - ((s32)((8)*256));
        strc44_0->qUnk34 = ((s32)((0)*256));
        strc44_0->qUnk38 = temp_sl->qUnk38 + ((s32)((10)*256));

        t = TaskCreate(Task_strc44_806959C, sizeof(SpecialStageIntro44), 0x2120U, 0U, ((void*)0));
        strc28->task10 = t;
        var_r7 = (void *)((t)->data);
        s = &var_r7->s;
        s->graphics.dest = &VRAM[0x10000] + 0xAA0;
        ...
        UpdateSpriteAnimation(s);
        var_r7->unk30 = 0;
        var_r7->qUnk3C = -((s32)((1)*256));
        var_r7->qUnk40 = temp_sl->qUnk40;
        var_r7->qUnk34 = 0;
        var_r7->qUnk38 = temp_sl->qUnk38;
    } else {
        var_r7 = (void *)((strc28->task10)->data);
    }

    if (temp_r0 > 7U) {
        if (sp8->qUnk38 >= ((s32)((100)*256))) {
            sp8->qUnk38 = (s32)(sp8->qUnk38 - ((s32)((1)*256)));
            sp4->qUnk38 = (s32)(sp4->qUnk38 - ((s32)((1)*256)));
            temp_sl->qUnk38 -= ((s32)((1)*256));
            var_r7->qUnk38 -= ((s32)((1)*256));
        }
    }
    if (temp_r0 == 1) {
    ...
    if ((0x12C - ({((0x128) != 0) ? ((s32)(0x2000) / (s32)(0x128)) : 0;})) == temp_r0) {
        strc28->strc0.unk0 = 0;
        strc28->strc0.unk2 = 1;
        strc28->strc0.unk4 = 4;
        strc28->strc0.unk6 = 0;
...
void Task_80693D0()
{
    SpecialStageIntro44 *strc44 = (void *)((gCurTask)->data);
    Sprite *s = &strc44->s;
    ...
    if (strc44->unk30 == 0) {
        ...
        s->prevVariant = -1;
        strc44->qUnk38 += ((s32)((16)*256));
    }

    strc44->qUnk40 -= ((s32)((1)*256));
    if (strc44->qUnk40 < -((s32)((100)*256))) {
        strc44->qUnk40 = -((s32)((100)*256));
    }

    s->x = ((int)((strc44->qUnk40) >> 8));
    s->y = ((int)((strc44->qUnk38) >> 8));
    UpdateSpriteAnimation(s);
    DisplaySprite(s);
}
...
{
    SpecialStageIntro28 *strc28 = (void *)((gCurTask)->data);
    SpecialStageIntro44 *temp_r6 = (void *)((strc28->taskC)->data);
    u32 temp_r4;
...
void Task_8069550()
{
    ...
    strc44->qUnk38 += 0x4A0;
    if (strc44->qUnk38 > ((s32)((80)*256))) {
        strc44->qUnk38 = ((s32)((80)*256));
    }
    s->x = ((int)((strc44->qUnk40) >> 8));
    s->y = ((int)((strc44->qUnk38) >> 8));
    UpdateSpriteAnimation(s);
