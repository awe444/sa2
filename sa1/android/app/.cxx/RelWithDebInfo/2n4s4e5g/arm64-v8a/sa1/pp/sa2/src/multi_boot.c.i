# 1 "/home/awaszczak/git/sa2/sa1/../src/multi_boot.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/multi_boot.c" 2
...
# 5 "/home/awaszczak/git/sa2/sa1/../include/multi_boot.h" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/multi_boot.c" 2
...
# 26 "/home/awaszczak/git/sa2/sa1/../src/multi_boot.c"
...
output_burst:
    if (mp->sendflag) {
        ...
        i = (*(reg_u16 *)(REG_BASE + 0x128)) & (0x0080 | 0x0040 | 0x0030 | 0x0008 | 0x0004);
        if (i != 0x0008) {
            (mp)->client_bit = 0; (mp)->probe_count = 0; (mp)->response_bit = 0; (mp)->check_wait = 15; (mp)->sendflag = 0; (mp)->handshake_timeout = 0; (*(reg_u16 *)(REG_BASE + 0x134)) = 0; (*(reg_u16 *)(REG_BASE + 0x128)) = 0x2000 | 0x0003; (*(reg_u16 *)(REG_BASE + 0x12a)) = 0;;
            return i ^ 0x0008;
        }
    }
    ...
    switch (mp->probe_count) {
        case 0:
            ...
            k = 0x0e;
            for (i = 3; i != 0; --i) {
                if (*(vu16 *)((REG_BASE + 0x120) + i * 2) != 0xffff) {
        ...
        case 0xd1:
            ...
            return 0x70;
        default:
# 262 "/home/awaszczak/git/sa2/sa1/../src/multi_boot.c"
            for (i = 3; i != 0; --i) {
                if (mp->probe_target_bit & (1 << i)) {
                    j = *(vu16 *)((REG_BASE + 0x120) + i * 2);
...
# 317 "/home/awaszczak/git/sa2/sa1/../src/multi_boot.c"
static s32 MultiBootSend(struct MultiBootParam *mp, u16 data)
{
    s32 i;
    ...
    i = (*(reg_u16 *)(REG_BASE + 0x128)) & (0x0080 | 0x0008 | 0x0004);
    if (i != 0x0008) {
        (mp)->client_bit = 0; (mp)->probe_count = 0; (mp)->response_bit = 0; (mp)->check_wait = 15; (mp)->sendflag = 0; (mp)->handshake_timeout = 0; (*(reg_u16 *)(REG_BASE + 0x134)) = 0; (*(reg_u16 *)(REG_BASE + 0x128)) = 0x2000 | 0x0003; (*(reg_u16 *)(REG_BASE + 0x12a)) = 0;;
        return i ^ 0x0008;
    }
    (*(reg_u16 *)(REG_BASE + 0x12a)) = data;
    (*(reg_u16 *)(REG_BASE + 0x128)) = 0x2000 | 0x0003 | 0x0080;
    mp->sendflag = 1;
    return 0;
}
...
static s32 MultiBootHandShake(struct MultiBootParam *mp)
{
    ...
    switch (mp->probe_count) {
        ...
        default:
# 423 "/home/awaszczak/git/sa2/sa1/../src/multi_boot.c"
            for (i = 3; i != 0; --i) {
                j = *(vu16 *)((REG_BASE + 0x120) + i * 2);
...
void MultiBootInit(struct MultiBootParam *mp) { (mp)->client_bit = 0; (mp)->probe_count = 0; (mp)->response_bit = 0; (mp)->check_wait = 15; (mp)->sendflag = 0; (mp)->handshake_timeout = 0; (*(reg_u16 *)(REG_BASE + 0x134)) = 0; (*(reg_u16 *)(REG_BASE + 0x128)) = 0x2000 | 0x0003; (*(reg_u16 *)(REG_BASE + 0x12a)) = 0;; }
...
{
# 524 "/home/awaszczak/git/sa2/sa1/../src/multi_boot.c"
}
...
{
    s32 i;
# 543 "/home/awaszczak/git/sa2/sa1/../src/multi_boot.c"
    for (i = 0; i < 31069; ++i)
        if (((*(reg_u16 *)(REG_BASE + 0x128)) & 0x0080) == 0)
            break;
