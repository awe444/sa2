# 1 "/home/awaszczak/git/sa2/sa1/src/game/shared/stage/entities_manager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/src/game/shared/stage/entities_manager.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/src/game/shared/stage/entities_manager.c" 2
...
void EwramFree(void *);
# 5 "/home/awaszczak/git/sa2/sa1/src/game/shared/stage/entities_manager.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 8 "/home/awaszczak/git/sa2/sa1/src/game/shared/stage/entities_manager.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/src/game/shared/stage/entities_manager.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 11 "/home/awaszczak/git/sa2/sa1/src/game/shared/stage/entities_manager.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/entities_manager.h" 1
# 10 "/home/awaszczak/git/sa2/sa1/../include/game/shared/stage/entities_manager.h"
typedef struct {
               SpriteBase base;
               Sprite s;
} EntityShared;
...
void TaskDestructor_EntityShared(struct Task *);
# 12 "/home/awaszczak/git/sa2/sa1/src/game/shared/stage/entities_manager.c" 2
...
# 13 "/home/awaszczak/git/sa2/sa1/src/game/shared/stage/entities_manager.c" 2
# 116 "/home/awaszczak/git/sa2/sa1/src/game/shared/stage/entities_manager.c"
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 117 "/home/awaszczak/git/sa2/sa1/src/game/shared/stage/entities_manager.c" 2
...
static void sa2__Task_8008DCC(void);
static void SpawnMapEntities();

void sa2__TaskDestructor_80095FC(struct Task *);




extern const RLCompressed *const gSpritePosData_interactables[18];
extern const RLCompressed *const gSpritePosData_itemboxes[18];
extern const RLCompressed *const gSpritePosData_enemies[18];
...
const MapEntityInit gSpriteInits_Interactables[116] = {
              ...
              CreateEntity_Spikes_Horizontal,
              CreateEntity_Spikes_Horizontal,
              ...
              CreateEntity_Spring_Horizontal,
              CreateEntity_Spring_Horizontal,
              CreateEntity_Spring_Big_Up,
              CreateEntity_Spring_Big_Up,
              ...
              CreateEntity_GrindRail_End,
              CreateEntity_PlatformThin,
              CreateEntity_PlatformThin_Falling,
              CreateEntity_Trampoline,
              CreateEntity_PlatformCrumbling,
              CreateEntity_BounceBlock,
              CreateEntity_InclineRamp,
              CreateEntity_Waterfall,
              CreateEntity_HalfPipeStart,
              CreateEntity_HalfPipeEnd,
              CreateEntity_Shrubbery,
              CreateEntity_Booster,
              CreateEntity_Booster_SlightLeft,
              CreateEntity_Booster_SlightRight,
              CreateEntity_Interactable034,
              CreateEntity_MiniLoop_Base,
              CreateEntity_MiniLoop_StartBoost,
              CreateEntity_MiniLoop_Exit,
              CreateEntity_MiniLoop_Entrance,
              CreateEntity_Interactable039,
              CreateEntity_WaterBridge,
              CreateEntity_ToBeContinuedText,
              CreateEntity_RedFlag,
              CreateEntity_WaterBridgeSplash,
              CreateEntity_WallPole_Left,
              CreateEntity_WallPole_Right,
              CreateEntity_ForcedSlide,
              CreateEntity_Booster_Wall,
              CreateEntity_BumperHexagon,
              CreateEntity_BumperRound_LinearMov,
              CreateEntity_BumperRound_CircularMov,
              CreateEntity_BumperTriHorizontal,
              CreateEntity_BumperTriVertical,
              CreateEntity_BumperTriBig,
              CreateEntity_Flipper,
              CreateEntity_Platform_Square,
              CreateEntity_Flipper_Vertical,
              CreateEntity_BarrelOfDoomMini,
              CreateEntity_SegaSonicLetter,
              CreateEntity_PartyBalloon,
              CreateEntity_ShipSwing,
              CreateEntity_Platform_Spiked,
              CreateEntity_Bowl,
              CreateEntity_PanelGate_Vertical,
              CreateEntity_PanelGate_Horizontal,
              CreateEntity_MarbleTrack_Dir,
              CreateEntity_MarbleTrack_Pipe,
              CreateEntity_MarbleTrack_Entrance,
              CreateEntity_MarbleTrack_Exit,
              CreateEntity_ConveyorBelt,
              CreateEntity_Toggle_PlayerVisibility,
              CreateEntity_WallBumper,
              CreateEntity_TeleportOrb,
              CreateEntity_Flipper_SmallBlue,
              CreateEntity_Carousel,
              CreateEntity_HookRail,
              CreateEntity_SwingingHook,
              CreateEntity_SecurityGate,
              CreateEntity_SwingRope,
              CreateEntity_SteamExhaust,
              CreateEntity_CraneClaw,
              CreateEntity_MovingSpring,
              CreateEntity_IronBall,
              CreateEntity_HangBar,
              CreateEntity_SkatingStone,
              CreateEntity_Platform_SlowDescent,
              CreateEntity_RunWheel,
              CreateEntity_Torch,
              CreateEntity_Lift,
              CreateEntity_Platform089,
              CreateEntity_Toggle_PlayerFloat,
              CreateEntity_FerrisWheel,
              CreateEntity_BoulderSpawner,
              CreateEntity_SpikedBarrel,
              CreateEntity_AirBubbles,
              CreateEntity_IceBlock,
              CreateEntity_Interactable096,
              CreateEntity_Interactable097,
              CreateEntity_UnderwaterLavaPlatform,
              CreateEntity_ConveyorBeltObject,
              CreateEntity_Booster_Steep,
              CreateEntity_Booster_Steep2,
              CreateEntity_SpecialSpring,
              CreateEntity_Propeller,
              CreateEntity_SmallFallBlock,
              CreateEntity_Lava,
              CreateEntity_Track,
              CreateEntity_Interactable107,
              CreateEntity_Spring_Hiding,
              CreateEntity_ToggleGravity,
              CreateEntity_PipeEntrance,
              CreateEntity_PipeExit,
              CreateEntity_TrackAirCorner,
...
const MapEntityInit gSpriteInits_Enemies[32] = {
              CreateEntity_Kiki,
              CreateEntity_Buzzer,
              CreateEntity_GamiGami,
              CreateEntity_Rhinotank,
              CreateEntity_KeroKero,
              CreateEntity_Senbon,
              CreateEntity_Tentou,
              CreateEntity_Fireball,
              CreateEntity_Hanabii,
              CreateEntity_Slot,
              CreateEntity_Pierrot,
              CreateEntity_Leon,
              CreateEntity_Mirror,
              CreateEntity_Wamu,
              CreateEntity_Oct,
              CreateEntity_Mole,
              CreateEntity_Yukimaru,
              CreateEntity_Yukimaru_Wall,
              CreateEntity_Drisame,
              CreateEntity_Kuraa,
              CreateEntity_PenMk1,


              CreateEntity_EggHammerTank_Intro,
              CreateEntity_EggHammerTank,
              CreateEntity_EggPress,
              CreateEntity_EggBall,
              CreateEntity_EggSpider,
              CreateEntity_MechaKnuckles,
              CreateEntity_EggSnake,
              CreateEntity_EggWrecker,
              CreateEntity_EggDrillster,
              CreateEntity_EggX,
              CreateEntity_SuperEggRobot,
};
...
# 800 "/home/awaszczak/git/sa2/sa1/src/game/shared/stage/entities_manager.c"
void CreateStageEntitiesManager(void)
{
    void *decompBuf;
    struct Task *t;
    EntitiesManager *em;
    if (gGameMode != 6) {
        t = TaskCreate(sa2__Task_8008DCC, sizeof(EntitiesManager), 0x2000, 0, sa2__TaskDestructor_80095FC);
    } else {
        t = TaskCreate(sa2__Task_8008DCC, sizeof(EntitiesManager), 0x2000, 0, ((void*)0));
    }
...
# 833 "/home/awaszczak/git/sa2/sa1/src/game/shared/stage/entities_manager.c"
    } else {
...
typedef u16 region;
# 866 "/home/awaszczak/git/sa2/sa1/src/game/shared/stage/entities_manager.c"
static void SpawnMapEntities()
{
    ...
    if ((gStageFlags & 2) == 0) {
        ...
        (range)[0] = gCamera.x - 128;
        (range)[2] = gCamera.x + (320 + 128);

        (range)[1] = gCamera.y - 128;
        (range)[3] = gCamera.y + (240 + 128);
        ...
        if ((u32)(range)[0] >= ((s32)((h_regionCount)*256))) {
            (range)[0] = ((s32)((h_regionCount)*256)) - 1;
        }
        if ((u32)(range)[1] >= ((s32)((v_regionCount)*256))) {
            (range)[1] = ((s32)((v_regionCount)*256)) - 1;
        }

        if ((u32)(range)[2] >= ((s32)((h_regionCount)*256))) {
            (range)[2] = ((s32)((h_regionCount)*256)) - 1;
        }

        if ((u32)(range)[3] >= ((s32)((v_regionCount)*256))) {
            (range)[3] = ((s32)((v_regionCount)*256)) - 1;
        }

        regionY = ((int)(((range)[1]) >> 8));
        while (((s32)((regionY)*256)) < (range)[3] && regionY < v_regionCount) {
            regionX = ((int)(((range)[0]) >> 8));
            while (((s32)((regionX)*256)) < (range)[2] && regionX < h_regionCount) {
                if (gGameMode != 6) {
                    ...
                    if (i != 0) {
                        ...
                        for (i = 0; (s8)me->x != -1; me++, i++) {
                            if ((s8)me->x >= -2) {
                                ...
                                if (x >= (range)[0] && x <= (range)[2] && y >= (range)[1]
                                    && y <= (range)[3]) {
        ...
        em->prevCamY = gCamera.y;
        em->sa2__unk14 = 0;
        gCurTask->main = sa2__Task_8008DCC;
    }
}
...
static void sa2__Task_8008DCC(void)
{
    if (!(gStageFlags & 2)) {
        ...
        CamCoord range1[4];
        CamCoord range2[4];
# 1043 "/home/awaszczak/git/sa2/sa1/src/game/shared/stage/entities_manager.c"
        u32 h_regionCount, v_regionCount;
        ...
        if (gCamera.x > em->prevCamX) {
            range1[0] = em->prevCamX + (320 + 128);
            range1[2] = gCamera.x + (320 + 128);
# 1108 "/home/awaszczak/git/sa2/sa1/src/game/shared/stage/entities_manager.c"
        } else {
        ...
        range1[3] = gCamera.y + (240 + 128);

        if (gCamera.y > em->prevCamY) {
            range2[1] = em->prevCamY + (240 + 128);
            range2[3] = gCamera.y + (240 + 128);
        } else {
        ...
        range2[2] = gCamera.x + (320 + 128);
# 1147 "/home/awaszczak/git/sa2/sa1/src/game/shared/stage/entities_manager.c"
        if (range1[0] < 0) {
            range1[0] = 0;
        }
        if (range1[1] < 0) {
        ...
        if (gCamera.x != em->prevCamX && range1[0] != range1[2] && range1[1] != range1[3]) {
            regionY = ((int)((range1[1]) >> 8));

            while (((s32)((regionY)*256)) < range1[3] && regionY < v_regionCount) {
                regionX = ((int)((range1[0]) >> 8));
                while (((s32)((regionX)*256)) < range1[2] && regionX < h_regionCount) {
                    if (gGameMode != 6) {
                        i = (*((u32 *)((((u8 *)(interactables)) + (((h_regionCount) * (regionY)) * (sizeof(u32)))) + ((regionX) * (sizeof(u32))))));
                        if (i != 0) {
                            MapEntity *me = ((void *)interactables + (i - 8));
        ...
        if (((gCamera.y != em->prevCamY) && ((range2)[1] != (range2)[3])) && (range2[0] != (range2)[2])) {
            regionY = ((int)(((range2)[1]) >> 8));
            while (({ ((s32)((regionY)*256)); }) < (range2)[3] && regionY < v_regionCount) {
                regionX = ((int)((range2[0]) >> 8));
                while (((s32)((regionX)*256)) < range2[2] && regionX < h_regionCount) {
                    if (gGameMode != 6) {
                        i = (*((u32 *)((((u8 *)(interactables)) + (((h_regionCount) * (regionY)) * (sizeof(u32)))) + ((regionX) * (sizeof(u32))))));
                        if (i != 0) {
                            MapEntity *me = ((void *)interactables + (i - 8));
