# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_spiked.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_spiked.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_spiked.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_spiked.c" 2
...
# 4 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_spiked.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_spiked.c" 2
...
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_spiked.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_spiked.c" 2
...
void m4aMPlayPitchControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s16 pitch);
void m4aMPlayPanpotControl(struct MP2KPlayerState *mplayInfo, u16 trackBits, s8 pan);
# 12 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_spiked.c" 2
...
# 14 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_spiked.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/char_states.h" 1
# 15 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_spiked.c" 2

# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/songs.h" 1
# 17 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_spiked.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 18 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/interactables/platform_spiked.c" 2
...
void CreateEntity_Platform_Spiked(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    ...
    PlatformSpiked *platform = (void *)((t)->data);
    Sprite *s = &platform->s;
    ...
    if ((((gCurrentLevel) >> 1) == 2) || (gCurrentLevel == (14 + 2))) {
...
void Task_Platform_Spiked(void)
{
    ...
    if (platform->qUnk44 != 0) {
        ...
        platform->qUnk3C = (((me->d.uData[2] << 11) * (gSineTable[(platform->qUnk44 * (((gStageTime + platform->unk4C) & 0xFF)) & 0x3FF)])) >> 14);
    ...
    if (platform->qUnk48 != 0) {
        ...
        platform->qUnk40 = (((me->d.uData[3] << 11) * (gSineTable[(platform->qUnk48 * (((gStageTime + platform->unk4C) & 0xFF)) & 0x3FF)])) >> 14);
    ...
    s->x = worldX - gCamera.x + ((int)((platform->qUnk3C) >> 8));
    s->y = worldY - gCamera.y + ((int)((platform->qUnk40) >> 8));

    i = 0;
    do {
        if ((!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) && !((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00400000)) {
            ...
            if ((((platform->unk4E) >> (i)) & 1)) {
                ...
                if (sp20 > ((s32)((0)*256))) {
                    res = sa2__sub_801F100(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) + 4, ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) + 0, (*(((i) != 0) ? &gPartner : &gPlayer)).layer, +8,
                                                 sa2__sub_801EB44);
                    ...
                    res = sa2__sub_801F100(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) + 0, ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) + 0, (*(((i) != 0) ? &gPartner : &gPlayer)).layer, -8,
                                                 sa2__sub_801EB44);
                ...
                res = sa2__sub_801F100(((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8)) - 5, ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX) >> 8)) + 0, (*(((i) != 0) ? &gPartner : &gPlayer)).layer, -8,
                                             sa2__sub_801EC3C);

                if (res < 0) {
                    if (platform->qUnk48 != ((s32)((0)*256))) {
                    ...
                    if (!Coll_Player_Entity_Intersection(s, worldX + ((int)((platform->qUnk3C) >> 8)), worldY + ((int)((platform->qUnk40) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer)))) {
                        (platform->unk4E) &= ~(1 << (i));
                    }
                }
            } else {
                ...
                sub_80805C8(s, worldX + ((int)((platform->qUnk3C) >> 8)), worldY + ((int)((platform->qUnk40) >> 8)), (Rect8 *)&arr[0], &(*(((i) != 0) ? &gPartner : &gPlayer)));

                qPrevWorldX = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX;
                qPrevWorldY = (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY;

                flags = Coll_Player_Platform(s, worldX + ((int)((platform->qUnk3C) >> 8)), worldY + ((int)((platform->qUnk40) >> 8)), &(*(((i) != 0) ? &gPartner : &gPlayer)));
                ...
                if (flags & 0x70000) {
                    ...
                    if (flags & 0x40000) {
                        if (platform->qUnk44 != ((s32)((0)*256))) {
                            if (gInput & 0x0020) {
                                if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000002)) {
                                    (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX -= ((s32)((2)*256));
                                    (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000020;
                                }
                            }
                        ...
                        if (platform->qUnk48 != ((s32)((0)*256))) {
                            ...
                            if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000002)) {
                                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldX = qPrevWorldX;
                                (*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY = qPrevWorldY;

                                (*(((i) != 0) ? &gPartner : &gPlayer)).moveState &= ~0x00000020;
                                (*(((i) != 0) ? &gPartner : &gPlayer)).moveState |= 0x00000080;
                            } else {
                                if (!platform->facingUp) {
                                    Coll_DamagePlayer(&(*(((i) != 0) ? &gPartner : &gPlayer)));
                                }
                            }
                        } else {
                            if (!platform->facingUp) {
                    ...
                    if ((((platform->unk4F) >> (i)) & 1)) {
                        if ((*(((i) != 0) ? &gPartner : &gPlayer)).charState == 14) {
                            (platform->unk4F) &= ~(1 << (i));
                            (*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedGround = 0;
            ...
            if (!((*(((i) != 0) ? &gPartner : &gPlayer)).moveState & 0x00000080)) {
                if ((*(((i) != 0) ? &gPartner : &gPlayer)).qSpeedAirY >= ((s32)((0)*256))) {
                    if (worldY + ((int)((platform->qUnk40) >> 8)) > ((int)(((*(((i) != 0) ? &gPartner : &gPlayer)).qWorldY) >> 8))) {
                        s8 arr[4] = { -((*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetX + 5), (1 - (*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetY), +((*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetX + 5),
                                      ((*(((i) != 0) ? &gPartner : &gPlayer)).spriteOffsetY - 1) };
                        u32 flags;
                        ...
                        flags = Coll_Player_Platform(s, worldX + ((int)((platform->qUnk3C) >> 8)), worldY + ((int)((platform->qUnk40) >> 8)) - 8, &(*(((i) != 0) ? &gPartner : &gPlayer)));
...

{
    if ((((((worldX) + s->hitboxes[0].b.left) <= ((((int)((p->qWorldX) >> 8))) + (*rect).left) && ((((worldX)) + (s->hitboxes[0].b).left) + ((s->hitboxes[0].b).right - (s->hitboxes[0].b).left)) >= ((((int)((p->qWorldX) >> 8))) + (*rect).left)) || (((worldX) + s->hitboxes[0].b.left) >= ((((int)((p->qWorldX) >> 8))) + (*rect).left) && ((((((int)((p->qWorldX) >> 8)))) + ((*rect)).left) + (((*rect)).right - ((*rect)).left)) >= ((worldX) + s->hitboxes[0].b.left))) && (((((worldY)) + s->hitboxes[0].b.top) <= (((((int)((p->qWorldY) >> 8)))) + (*rect).top) && ((((worldY)) + s->hitboxes[0].b.top) + ((s->hitboxes[0].b).bottom - (s->hitboxes[0].b).top)) >= (((((int)((p->qWorldY) >> 8)))) + (*rect).top)) || ((((worldY)) + s->hitboxes[0].b.top) >= (((((int)((p->qWorldY) >> 8)))) + (*rect).top) && ((((((int)((p->qWorldY) >> 8)))) + (*rect).top) + (((*rect)).bottom - ((*rect)).top)) >= (((worldY)) + s->hitboxes[0].b.top))))) {
        ...
        if (((int)((p->qWorldX) >> 8)) <= valX) {
            p->qWorldX = ((s32)((worldX + s->hitboxes[0].b.left - rect->right)*256));
            if (p->qSpeedAirX > ((s32)((0)*256))) {
                p->qSpeedGround = 0;
                p->qSpeedAirX = 0;
            }
        } else {
            ...
            if (((int)((p->qWorldX) >> 8)) >= valX - 8) {
                p->qWorldX = ((s32)((valX)*256));
        ...
        res = sa2__sub_801E4E4(((int)((p->qWorldY) >> 8)) + 9, ((int)((p->qWorldX) >> 8)), p->layer, +8, ((void*)0), sa2__sub_801EE64);
