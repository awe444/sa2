# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/mirror.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 384 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/mirror.c" 2
...
# 2 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/mirror.c" 2
...
# 3 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/mirror.c" 2
...
u32 Coll_Player_Entity_Intersection(Sprite *s, CamCoord x, CamCoord y, Player *p);
# 5 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/mirror.c" 2
...
void TaskDestructor_EntityShared(struct Task *);
# 7 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/mirror.c" 2
...
# 8 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/mirror.c" 2
...
# 10 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/mirror.c" 2
# 1 "/home/awaszczak/git/sa2/sa1/../include/constants/sa1/vram_hardcoded.h" 1
# 11 "/home/awaszczak/git/sa2/sa1/../src/game/sa1/stage/enemies/mirror.c" 2
...
void CreateEntity_Mirror(MapEntity *me, u16 regionX, u16 regionY, u8 id)
{
    if ((((gCurrentLevel) >> 1) != 5) || ((&gLoadedSaveGame)->difficultyLevel == 0)) {
        ...
        mirror->qUnk40 = -((s32)((0.625)*256));
        mirror->qUnk3C = ((s32)((0)*256));
        mirror->unk44 = 0;
        mirror->frames = 0;
        mirror->unk46 = 0;
        ...
        s->graphics.dest = VramMalloc(((40 / 8) * (32 / 8)));
        s->oamFlags = ((18) << 6);
        s->graphics.size = 0;
        s->graphics.anim = 432;
        s->variant = 0;
...
void Task_Mirror(void)
{
    Mirror *mirror = (void *)((gCurTask)->data);
    Sprite *s = &mirror->shared.s;
    MapEntity *me = mirror->shared.base.me;
    s32 prevWorldX, prevWorldY;
    CamCoord worldX, worldY;

    worldX = ((mirror->shared.base.meX)*8 + (mirror->shared.base.regionX)*256);
    worldY = ((me->y)*8 + (mirror->shared.base.regionY)*256);
    ...
    worldX += ((int)((mirror->qUnk3C) >> 8));
    s->x = worldX - gCamera.x;
    s->y = worldY - gCamera.y;

    if (((prevWorldX) > gCamera.x + (320 + (256 / 2)) || (prevWorldX) < gCamera.x - (256 / 2) || (prevWorldY) > gCamera.y + ((240) + ((256) / 2)) || (prevWorldY) < gCamera.y - (256 / 2)) && (((u16)(s->x + (256 / 2)) > 320 + 256) || (s->y + (256 / 2) < 0) || (s->y > 240 + (256 / 2)))) {
        { me->x = mirror->shared.base.meX; };
    ...
    if (((int)((mirror->qUnk3C) >> 8)) <= me->d.sData[0] * 8) {
        mirror->qUnk40 = +((s32)((0.625)*256));
    } else if (((int)((mirror->qUnk3C) >> 8)) >= (me->d.sData[0] + me->d.uData[2]) * 8) {
        mirror->qUnk40 = -((s32)((0.625)*256));
...
void Task_MirrorShoot(void)
{
    ...
    if (mirror->frames == (int)(((0 * 60.) + 1) * 60)) {
        s->variant = 0;
...
{
    struct Task *t = TaskCreate(Task_MirrorProjectile, sizeof(MirrorProjectile), 0x3000, 0, ((void*)0));
    MirrorProjectile *proj = (void *)((t)->data);
    Sprite *s = &proj->s;

    if (dir != DIR_LEFT) {
        s->x = worldX;
        proj->qSpeed = +((s32)((2)*256));
    } else {
        s->x = worldX;
        proj->qSpeed = -((s32)((2)*256));
    }
...
void Task_MirrorProjectile(void)
{
    MirrorProjectile *proj = (void *)((gCurTask)->data);
    Sprite *s = &proj->s;
