...
SONGS_DIR = 'sound/sa1/songs'
NON_MATCHED_MIDIS = 'sound/sa1/songs/midi/non_matching'
MATCHED_MIDIS = 'sound/sa1/songs/midi'
...
for next_song in to_match:
    ...
    ldscript_data = ldscript_data.replace("sound/sa1/songs/" + next_song + ".o", "sound/sa1/songs/midi/" + next_song + ".o")
    ...
    try: os.removedirs("build/gba/sa1/sound")
    except: pass

    print('Verifying build')
    error = os.system("make -j8")
    if not error:
        print('success!')
        os.system('git add -A')
    else:      
