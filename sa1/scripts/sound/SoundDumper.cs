...
namespace dump_sound
{
    class SoundDumper
    {
        ...
        static void DumpProgrammableWaveSample(int ofs, int len)
        {
            ...
            var outfilename = String.Format("sound/sa1/programmable_wave_samples/{0}", filename);

            sb.Append("\t.align 2\n");
            sb.AppendFormat("\t.global ProgrammableWaveData_{0:X7}\n", ofs);
            sb.AppendFormat("ProgrammableWaveData_{0:X7}:\n", ofs);
            sb.AppendFormat("\t.incbin \"sound/sa1/programmable_wave_samples/{0}\"\n", filename);
            soundInfo.Add(ofs, sb.ToString());

            Directory.CreateDirectory("sound/sa1/programmable_wave_samples/");
        ...
        static void DumpDirectSoundSample(int ofs)
        {
            ...
            var outfilename = String.Format("sound/sa1/direct_sound_samples/{0}", filename);

            sb.Append("\t.align 2\n");
            sb.AppendFormat("\t.global gUnknown_{0:X8}\n", ofs);
            sb.AppendFormat("gUnknown_{0:X8}:\n", ofs);
            sb.AppendFormat("\t.incbin \"sound/sa1/direct_sound_samples/{0}\"\n", filename);
            soundInfo.Add(ofs, sb.ToString());

            Directory.CreateDirectory("sound/sa1/direct_sound_samples/");
        ...
        static string PrintVoiceGroup(int ofs, int len, int id)
        {
            ...
            var outfilename = String.Format("sound/sa1/voicegroups/{0}", filename);
            ...
            Directory.CreateDirectory("sound/sa1/voicegroups/");
        ...
        static string PrintSong(int ofs, int id)
        {
            ...
            var outfilename = String.Format("sound/sa1/songs/{0}", filename);
            ...
            if (String.Compare(realName, currName) == 0)
            {
                ...
                if (goodSongs.Contains(id) || true) {
                    Directory.CreateDirectory("sound/sa1/songs/");
        ...
        static void Main(string[] args)
        {
            ...
            foreach (var adr in soundInfo)
            {
                if (adr.Value.Contains(".global voicegroup"))
                {
                    ...
                    sb.AppendFormat(".include \"sound/sa1/voicegroups/{0}.inc\"\n", adr.Value.Substring(pos + 8, 13));
                    continue;
                }
                ...
                if (adr.Value.Contains(".global song"))
                {
                    ...
                    if (String.Compare(curr, prev) != 0) {
                        sb.AppendFormat(".include \"sound/sa1/songs/{0}.inc\"\n", curr);
                        prev = curr;
                    }
                    continue;
                }
